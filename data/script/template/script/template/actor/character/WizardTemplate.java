...
public class WizardTemplate extends HumanMysticTemplate {
	@Inject
	public WizardTemplate(CharacterTemplateIDProvider factory) {
		super(factory.createID(CharacterClass.WIZARD.id), CharacterClass.WIZARD,	Point.fromXYZ(-90890, 248027, -3570));
		// ATTRIBUTES
