 ...
 */
public class KirikachinTemplate extends NPCTemplate {
	public static final int ID = 32116;

	@Inject
	protected KirikachinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kirikachin";
