 ...
 */
public class GroupGatekeeper8Template extends NPCTemplate {
	public static final int ID = 35617;

	@Inject
	protected GroupGatekeeper8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
