 ...
 */
public class IconOfThePastTemplate extends NPCTemplate {
	public static final int ID = 32255;

	@Inject
	protected IconOfThePastTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Icon of the Past";
