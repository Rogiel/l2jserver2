 ...
 */
public class Trap171Template extends NPCTemplate {
	public static final int ID = 18748;

	@Inject
	protected Trap171Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
