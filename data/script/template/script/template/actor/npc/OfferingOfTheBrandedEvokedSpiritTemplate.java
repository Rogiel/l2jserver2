 ...
 */
public class OfferingOfTheBrandedEvokedSpiritTemplate extends NPCTemplate {
	public static final int ID = 18300;

	@Inject
	protected OfferingOfTheBrandedEvokedSpiritTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
