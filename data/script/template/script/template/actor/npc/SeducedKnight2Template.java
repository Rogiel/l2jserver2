 ...
 */
public class SeducedKnight2Template extends NPCTemplate {
	public static final int ID = 36566;

	@Inject
	protected SeducedKnight2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Seduced Knight";
