 ...
 */
public class ControlUnit3Template extends NPCTemplate {
	public static final int ID = 35878;

	@Inject
	protected ControlUnit3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
