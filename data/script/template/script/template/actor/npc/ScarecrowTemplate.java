 ...
 */
public class ScarecrowTemplate extends NPCTemplate {
	public static final int ID = 13161;

	@Inject
	protected ScarecrowTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
