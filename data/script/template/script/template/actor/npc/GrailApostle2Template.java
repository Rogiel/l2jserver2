 ...
 */
public class GrailApostle2Template extends NPCTemplate {
	public static final int ID = 13080;

	@Inject
	protected GrailApostle2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
