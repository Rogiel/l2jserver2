 ...
 */
public class PreacherOfDoom20Template extends NPCTemplate {
	public static final int ID = 31234;

	@Inject
	protected PreacherOfDoom20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
