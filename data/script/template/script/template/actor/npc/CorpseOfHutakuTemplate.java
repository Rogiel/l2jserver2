 ...
 */
public class CorpseOfHutakuTemplate extends NPCTemplate {
	public static final int ID = 31074;

	@Inject
	protected CorpseOfHutakuTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Corpse of Hutaku";
