 ...
 */
public class Trap43Template extends NPCTemplate {
	public static final int ID = 13207;

	@Inject
	protected Trap43Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
