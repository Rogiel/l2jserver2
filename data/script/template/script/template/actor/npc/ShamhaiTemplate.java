 ...
 */
public class ShamhaiTemplate extends NPCTemplate {
	public static final int ID = 30752;

	@Inject
	protected ShamhaiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
