 ...
 */
public class LeoTemplate extends NPCTemplate {
	public static final int ID = 32515;

	@Inject
	protected LeoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
