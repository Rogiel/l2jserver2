 ...
 */
public class KartiaTemplate extends NPCTemplate {
	public static final int ID = 30133;

	@Inject
	protected KartiaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
