 ...
 */
public class CelesTemplate extends MysticVillageMasterNPCTemplate {
	public static final int ID = 32098;

	@Inject
	protected CelesTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
