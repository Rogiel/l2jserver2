 ...
 */
public class FairenTemplate extends MysticVillageMasterNPCTemplate {
	public static final int ID = 30175;

	@Inject
	protected FairenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
