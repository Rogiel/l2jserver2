 ...
 */
public class JavierTemplate extends MysticVillageMasterNPCTemplate {
	public static final int ID = 31996;

	@Inject
	protected JavierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
