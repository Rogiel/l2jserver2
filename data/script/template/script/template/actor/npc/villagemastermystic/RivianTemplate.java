 ...
 */
package script.template.actor.npc.villagemastermystic;

import com.google.inject.Inject;
import com.l2jserver.model.id.template.provider.ItemTemplateIDProvider;
import com.l2jserver.model.id.template.provider.NPCTemplateIDProvider;
import com.l2jserver.model.template.npc.MysticVillageMasterNPCTemplate;
import com.l2jserver.model.world.Actor.ActorSex;

/**
 * @author <a href="http://www.rogiel.com">Rogiel</a>
 */
public class RivianTemplate extends MysticVillageMasterNPCTemplate {
	public static final int ID = 32147;

	@Inject
	protected RivianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
