 ...
 */
public class JurekTemplate extends MysticVillageMasterNPCTemplate {
	public static final int ID = 30115;

	@Inject
	protected JurekTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
