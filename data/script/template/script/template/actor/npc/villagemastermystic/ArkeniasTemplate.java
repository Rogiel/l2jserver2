 ...
 */
public class ArkeniasTemplate extends MysticVillageMasterNPCTemplate {
	public static final int ID = 30174;

	@Inject
	protected ArkeniasTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
