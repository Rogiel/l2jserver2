 ...
 */
public class ValdisTemplate extends MysticVillageMasterNPCTemplate {
	public static final int ID = 31331;

	@Inject
	protected ValdisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
