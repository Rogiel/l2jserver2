 ...
 */
public class DrikiyanTemplate extends MysticVillageMasterNPCTemplate {
	public static final int ID = 30854;

	@Inject
	protected DrikiyanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
