 ...
 */
public class HalasterTemplate extends MysticVillageMasterNPCTemplate {
	public static final int ID = 31755;

	@Inject
	protected HalasterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
