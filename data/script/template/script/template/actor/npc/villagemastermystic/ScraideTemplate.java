 ...
 */
public class ScraideTemplate extends MysticVillageMasterNPCTemplate {
	public static final int ID = 30694;

	@Inject
	protected ScraideTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
