 ...
 */
public class ValleriaTemplate extends MysticVillageMasterNPCTemplate {
	public static final int ID = 30176;

	@Inject
	protected ValleriaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
