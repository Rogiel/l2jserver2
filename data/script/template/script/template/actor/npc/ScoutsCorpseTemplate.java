 ...
 */
public class ScoutsCorpseTemplate extends NPCTemplate {
	public static final int ID = 32015;

	@Inject
	protected ScoutsCorpseTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Scout's Corpse";
