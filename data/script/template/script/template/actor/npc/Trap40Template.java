 ...
 */
public class Trap40Template extends NPCTemplate {
	public static final int ID = 13204;

	@Inject
	protected Trap40Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
