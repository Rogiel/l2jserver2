 ...
 */
public class EvasProtector4Template extends NPCTemplate {
	public static final int ID = 32287;

	@Inject
	protected EvasProtector4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
