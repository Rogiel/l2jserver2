 ...
 */
public class MerchantOfMammonTemplate extends SignsPriestNPCTemplate {
	public static final int ID = 31113;

	@Inject
	protected MerchantOfMammonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Merchant of Mammon";
