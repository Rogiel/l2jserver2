 ...
 */
package script.template.actor.npc.signspriest;

import com.google.inject.Inject;
import com.l2jserver.model.id.template.provider.ItemTemplateIDProvider;
import com.l2jserver.model.id.template.provider.NPCTemplateIDProvider;
import com.l2jserver.model.template.npc.SignsPriestNPCTemplate;
import com.l2jserver.model.world.Actor.ActorSex;

/**
 * @author <a href="http://www.rogiel.com">Rogiel</a>
 */
public class BlackMarketeerOfMammonTemplate extends SignsPriestNPCTemplate {
	public static final int ID = 31092;

	@Inject
	protected BlackMarketeerOfMammonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Black Marketeer of Mammon";
