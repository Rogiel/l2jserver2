 ...
 */
public class BlacksmithOfMammonTemplate extends SignsPriestNPCTemplate {
	public static final int ID = 31126;

	@Inject
	protected BlacksmithOfMammonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Blacksmith of Mammon";
