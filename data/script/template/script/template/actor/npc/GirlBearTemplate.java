 ...
 */
public class GirlBearTemplate extends NPCTemplate {
	public static final int ID = 16060;

	@Inject
	protected GirlBearTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
