 ...
 */
public class HotSpringsGourd2Template extends NPCTemplate {
	public static final int ID = 35589;

	@Inject
	protected HotSpringsGourd2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
