 ...
 */
public class KamaelMaleMercenaryTemplate extends NPCTemplate {
	public static final int ID = 13174;

	@Inject
	protected KamaelMaleMercenaryTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kamael Male Mercenary";
