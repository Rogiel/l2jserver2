 ...
 */
public class InspectorAdlerTemplate extends NPCTemplate {
	public static final int ID = 32497;

	@Inject
	protected InspectorAdlerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
