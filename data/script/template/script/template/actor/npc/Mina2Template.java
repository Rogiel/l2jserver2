 ...
 */
public class Mina2Template extends NPCTemplate {
	public static final int ID = 31388;

	@Inject
	protected Mina2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
