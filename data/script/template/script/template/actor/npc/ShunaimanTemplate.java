 ...
 */
public class ShunaimanTemplate extends NPCTemplate {
	public static final int ID = 32586;

	@Inject
	protected ShunaimanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
