 ...
 */
public class SallyTemplate extends NPCTemplate {
	public static final int ID = 32743;

	@Inject
	protected SallyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
