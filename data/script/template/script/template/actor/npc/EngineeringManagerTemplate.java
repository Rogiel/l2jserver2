 ...
 */
public class EngineeringManagerTemplate extends NPCTemplate {
	public static final int ID = 35663;

	@Inject
	protected EngineeringManagerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
