 ...
 */
public class MachineTemplate extends NPCTemplate {
	public static final int ID = 32303;

	@Inject
	protected MachineTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
