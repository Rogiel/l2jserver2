 ...
 */
public class JacobTemplate extends GuardNPCTemplate {
	public static final int ID = 30073;

	@Inject
	protected JacobTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
