 ...
 */
public class TimosTemplate extends GuardNPCTemplate {
	public static final int ID = 30921;

	@Inject
	protected TimosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
