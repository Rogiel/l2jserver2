 ...
 */
public class StardenTemplate extends GuardNPCTemplate {
	public static final int ID = 30220;

	@Inject
	protected StardenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
