 ...
 */
public class ViktorVanDakeTemplate extends GuardNPCTemplate {
	public static final int ID = 30880;

	@Inject
	protected ViktorVanDakeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Viktor Van Dake";
