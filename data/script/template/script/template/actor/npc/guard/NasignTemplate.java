 ...
 */
public class NasignTemplate extends GuardNPCTemplate {
	public static final int ID = 30708;

	@Inject
	protected NasignTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
