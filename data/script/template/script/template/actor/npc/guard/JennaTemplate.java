 ...
 */
public class JennaTemplate extends GuardNPCTemplate {
	public static final int ID = 30349;

	@Inject
	protected JennaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
