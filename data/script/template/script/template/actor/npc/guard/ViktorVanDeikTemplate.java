 ...
 */
public class ViktorVanDeikTemplate extends GuardNPCTemplate {
	public static final int ID = 31675;

	@Inject
	protected ViktorVanDeikTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Viktor Van Deik";
