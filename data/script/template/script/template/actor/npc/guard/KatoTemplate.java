 ...
 */
public class KatoTemplate extends GuardNPCTemplate {
	public static final int ID = 32180;

	@Inject
	protected KatoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
