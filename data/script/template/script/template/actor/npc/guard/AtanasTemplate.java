 ...
 */
public class AtanasTemplate extends GuardNPCTemplate {
	public static final int ID = 30128;

	@Inject
	protected AtanasTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
