 ...
 */
public class VeltressTemplate extends GuardNPCTemplate {
	public static final int ID = 30219;

	@Inject
	protected VeltressTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
