 ...
 */
public class ParosTemplate extends GuardNPCTemplate {
	public static final int ID = 30714;

	@Inject
	protected ParosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
