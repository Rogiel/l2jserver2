 ...
 */
public class MorelinTemplate extends GuardNPCTemplate {
	public static final int ID = 32188;

	@Inject
	protected MorelinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
