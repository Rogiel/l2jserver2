 ...
 */
public class ByronTemplate extends GuardNPCTemplate {
	public static final int ID = 30711;

	@Inject
	protected ByronTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
