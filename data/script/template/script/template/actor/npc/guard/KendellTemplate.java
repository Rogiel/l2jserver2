 ...
 */
public class KendellTemplate extends GuardNPCTemplate {
	public static final int ID = 30218;

	@Inject
	protected KendellTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
