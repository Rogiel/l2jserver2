 ...
 */
public class RunantTemplate extends GuardNPCTemplate {
	public static final int ID = 30542;

	@Inject
	protected RunantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
