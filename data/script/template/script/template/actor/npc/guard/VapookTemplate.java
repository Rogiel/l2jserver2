 ...
 */
public class VapookTemplate extends GuardNPCTemplate {
	public static final int ID = 30584;

	@Inject
	protected VapookTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
