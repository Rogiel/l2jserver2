 ...
 */
public class CenturionTemplate extends GuardNPCTemplate {
	public static final int ID = 31036;

	@Inject
	protected CenturionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
