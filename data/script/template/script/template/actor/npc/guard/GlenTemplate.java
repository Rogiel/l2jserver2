 ...
 */
public class GlenTemplate extends GuardNPCTemplate {
	public static final int ID = 31982;

	@Inject
	protected GlenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
