 ...
 */
public class Guard2Template extends GuardNPCTemplate {
	public static final int ID = 31032;

	@Inject
	protected Guard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
