 ...
 */
public class BorderPatrolTemplate extends GuardNPCTemplate {
	public static final int ID = 31677;

	@Inject
	protected BorderPatrolTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
