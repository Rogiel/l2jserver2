 ...
 */
public class PutinTemplate extends GuardNPCTemplate {
	public static final int ID = 32179;

	@Inject
	protected PutinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
