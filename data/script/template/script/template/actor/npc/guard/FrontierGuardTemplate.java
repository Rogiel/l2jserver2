 ...
 */
public class FrontierGuardTemplate extends GuardNPCTemplate {
	public static final int ID = 30882;

	@Inject
	protected FrontierGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
