 ...
 */
public class AltimaTemplate extends GuardNPCTemplate {
	public static final int ID = 30356;

	@Inject
	protected AltimaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
