 ...
 */
public class Patrol2Template extends GuardNPCTemplate {
	public static final int ID = 31672;

	@Inject
	protected Patrol2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
