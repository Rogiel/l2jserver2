 ...
 */
public class SherringTemplate extends GuardNPCTemplate {
	public static final int ID = 31984;

	@Inject
	protected SherringTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.rightHand = itemProvider.createID(126);
		this.leftHand = itemProvider.createID(628);
		this.enchantLevel = 0;
