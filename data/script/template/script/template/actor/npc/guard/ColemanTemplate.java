 ...
 */
public class ColemanTemplate extends GuardNPCTemplate {
	public static final int ID = 30873;

	@Inject
	protected ColemanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
