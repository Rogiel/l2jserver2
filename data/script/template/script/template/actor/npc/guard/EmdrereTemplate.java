 ...
 */
public class EmdrereTemplate extends GuardNPCTemplate {
	public static final int ID = 32482;

	@Inject
	protected EmdrereTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
