 ...
 */
public class LeikanTemplate extends GuardNPCTemplate {
	public static final int ID = 30382;

	@Inject
	protected LeikanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
