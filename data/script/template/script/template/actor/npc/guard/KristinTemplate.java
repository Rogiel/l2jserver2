 ...
 */
public class KristinTemplate extends GuardNPCTemplate {
	public static final int ID = 30357;

	@Inject
	protected KristinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
