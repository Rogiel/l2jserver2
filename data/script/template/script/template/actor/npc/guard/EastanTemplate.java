 ...
 */
public class EastanTemplate extends GuardNPCTemplate {
	public static final int ID = 30876;

	@Inject
	protected EastanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
