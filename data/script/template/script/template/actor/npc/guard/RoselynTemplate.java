 ...
 */
public class RoselynTemplate extends GuardNPCTemplate {
	public static final int ID = 30355;

	@Inject
	protected RoselynTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
