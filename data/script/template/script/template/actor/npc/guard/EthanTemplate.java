 ...
 */
public class EthanTemplate extends GuardNPCTemplate {
	public static final int ID = 30543;

	@Inject
	protected EthanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
