 ...
 */
public class TikuTemplate extends GuardNPCTemplate {
	public static final int ID = 30582;

	@Inject
	protected TikuTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
