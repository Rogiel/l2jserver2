 ...
 */
public class GuardTemplate extends GuardNPCTemplate {
	public static final int ID = 30733;

	@Inject
	protected GuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
