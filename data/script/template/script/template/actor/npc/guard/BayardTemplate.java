 ...
 */
public class BayardTemplate extends GuardNPCTemplate {
	public static final int ID = 31297;

	@Inject
	protected BayardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
