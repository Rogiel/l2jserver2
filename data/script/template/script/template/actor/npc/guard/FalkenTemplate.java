 ...
 */
public class FalkenTemplate extends GuardNPCTemplate {
	public static final int ID = 32192;

	@Inject
	protected FalkenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
