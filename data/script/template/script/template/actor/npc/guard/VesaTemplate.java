 ...
 */
public class VesaTemplate extends GuardNPCTemplate {
	public static final int ID = 30123;

	@Inject
	protected VesaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
