 ...
 */
public class FrontierGuard2Template extends GuardNPCTemplate {
	public static final int ID = 30883;

	@Inject
	protected FrontierGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
