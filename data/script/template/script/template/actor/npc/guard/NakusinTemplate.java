 ...
 */
public class NakusinTemplate extends GuardNPCTemplate {
	public static final int ID = 30578;

	@Inject
	protected NakusinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
