 ...
 */
public class BorderPatrol2Template extends GuardNPCTemplate {
	public static final int ID = 31678;

	@Inject
	protected BorderPatrol2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Border Patrol";
