 ...
 */
public class GotterTemplate extends GuardNPCTemplate {
	public static final int ID = 31987;

	@Inject
	protected GotterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
