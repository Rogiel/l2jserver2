 ...
 */
public class TrionellTemplate extends GuardNPCTemplate {
	public static final int ID = 30430;

	@Inject
	protected TrionellTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
