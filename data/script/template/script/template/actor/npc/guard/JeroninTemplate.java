 ...
 */
public class JeroninTemplate extends GuardNPCTemplate {
	public static final int ID = 30121;

	@Inject
	protected JeroninTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
