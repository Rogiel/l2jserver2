 ...
 */
public class KentTemplate extends GuardNPCTemplate {
	public static final int ID = 30918;

	@Inject
	protected KentTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
