 ...
 */
public class WheelerTemplate extends GuardNPCTemplate {
	public static final int ID = 30216;

	@Inject
	protected WheelerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
