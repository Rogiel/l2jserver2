 ...
 */
public class RichtorTemplate extends GuardNPCTemplate {
	public static final int ID = 31341;

	@Inject
	protected RichtorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
