 ...
 */
public class ProtonTemplate extends GuardNPCTemplate {
	public static final int ID = 30545;

	@Inject
	protected ProtonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
