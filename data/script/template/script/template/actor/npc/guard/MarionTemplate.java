 ...
 */
public class MarionTemplate extends GuardNPCTemplate {
	public static final int ID = 30347;

	@Inject
	protected MarionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
