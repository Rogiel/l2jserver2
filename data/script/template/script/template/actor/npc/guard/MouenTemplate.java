 ...
 */
public class MouenTemplate extends GuardNPCTemplate {
	public static final int ID = 30196;

	@Inject
	protected MouenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
