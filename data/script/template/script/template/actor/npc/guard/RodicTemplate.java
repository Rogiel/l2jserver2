 ...
 */
public class RodicTemplate extends GuardNPCTemplate {
	public static final int ID = 30919;

	@Inject
	protected RodicTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
