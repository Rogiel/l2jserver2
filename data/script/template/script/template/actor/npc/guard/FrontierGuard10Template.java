 ...
 */
public class FrontierGuard10Template extends GuardNPCTemplate {
	public static final int ID = 31682;

	@Inject
	protected FrontierGuard10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Frontier Guard";
