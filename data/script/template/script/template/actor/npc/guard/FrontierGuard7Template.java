 ...
 */
public class FrontierGuard7Template extends GuardNPCTemplate {
	public static final int ID = 30888;

	@Inject
	protected FrontierGuard7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
