 ...
 */
public class MaddyTemplate extends GuardNPCTemplate {
	public static final int ID = 32174;

	@Inject
	protected MaddyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
