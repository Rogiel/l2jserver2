 ...
 */
public class ConroyTemplate extends GuardNPCTemplate {
	public static final int ID = 30872;

	@Inject
	protected ConroyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
