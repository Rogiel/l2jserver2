 ...
 */
public class RathTemplate extends GuardNPCTemplate {
	public static final int ID = 30126;

	@Inject
	protected RathTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
