 ...
 */
public class KurtizTemplate extends GuardNPCTemplate {
	public static final int ID = 30870;

	@Inject
	protected KurtizTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
