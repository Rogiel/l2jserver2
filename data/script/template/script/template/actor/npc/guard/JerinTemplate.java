 ...
 */
public class JerinTemplate extends GuardNPCTemplate {
	public static final int ID = 30198;

	@Inject
	protected JerinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
