 ...
 */
public class Patrol3Template extends GuardNPCTemplate {
	public static final int ID = 31673;

	@Inject
	protected Patrol3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
