 ...
 */
public class RaylaTemplate extends GuardNPCTemplate {
	public static final int ID = 30224;

	@Inject
	protected RaylaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rayla";
		this.serverSideName = false;
		this.title = "Sentry Knight";
