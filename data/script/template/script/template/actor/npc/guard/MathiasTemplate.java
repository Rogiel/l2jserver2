 ...
 */
public class MathiasTemplate extends GuardNPCTemplate {
	public static final int ID = 31340;

	@Inject
	protected MathiasTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
