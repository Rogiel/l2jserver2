 ...
 */
public class SingaTemplate extends GuardNPCTemplate {
	public static final int ID = 31988;

	@Inject
	protected SingaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
