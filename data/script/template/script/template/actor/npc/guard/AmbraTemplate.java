 ...
 */
public class AmbraTemplate extends GuardNPCTemplate {
	public static final int ID = 32176;

	@Inject
	protected AmbraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
