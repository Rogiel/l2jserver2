 ...
 */
public class FrontierGuard6Template extends GuardNPCTemplate {
	public static final int ID = 30887;

	@Inject
	protected FrontierGuard6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
