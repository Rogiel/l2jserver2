 ...
 */
public class PatrolTemplate extends GuardNPCTemplate {
	public static final int ID = 31671;

	@Inject
	protected PatrolTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
