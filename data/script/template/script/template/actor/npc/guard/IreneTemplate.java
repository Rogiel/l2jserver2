 ...
 */
public class IreneTemplate extends GuardNPCTemplate {
	public static final int ID = 30432;

	@Inject
	protected IreneTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
