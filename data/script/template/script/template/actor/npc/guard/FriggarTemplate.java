 ...
 */
public class FriggarTemplate extends GuardNPCTemplate {
	public static final int ID = 31983;

	@Inject
	protected FriggarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
