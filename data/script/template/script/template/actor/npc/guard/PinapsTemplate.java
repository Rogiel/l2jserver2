 ...
 */
public class PinapsTemplate extends GuardNPCTemplate {
	public static final int ID = 30201;

	@Inject
	protected PinapsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
