 ...
 */
public class AlvahTemplate extends GuardNPCTemplate {
	public static final int ID = 30381;

	@Inject
	protected AlvahTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
