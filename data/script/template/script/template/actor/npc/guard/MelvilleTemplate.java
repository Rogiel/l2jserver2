 ...
 */
public class MelvilleTemplate extends GuardNPCTemplate {
	public static final int ID = 30338;

	@Inject
	protected MelvilleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
