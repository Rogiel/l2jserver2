 ...
 */
public class CromwellTemplate extends GuardNPCTemplate {
	public static final int ID = 30544;

	@Inject
	protected CromwellTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.rightHand = itemProvider.createID(296);
		this.leftHand = null;
		this.enchantLevel = 0;
