 ...
 */
public class SucreteTemplate extends GuardNPCTemplate {
	public static final int ID = 32137;

	@Inject
	protected SucreteTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
