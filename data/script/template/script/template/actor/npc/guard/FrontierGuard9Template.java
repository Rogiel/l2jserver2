 ...
 */
public class FrontierGuard9Template extends GuardNPCTemplate {
	public static final int ID = 31681;

	@Inject
	protected FrontierGuard9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
