 ...
 */
public class SandersTemplate extends GuardNPCTemplate {
	public static final int ID = 30881;

	@Inject
	protected SandersTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sanders";
		this.serverSideName = false;
		this.title = "Border Outpost Aide";
