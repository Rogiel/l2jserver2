 ...
 */
public class ZeromeTemplate extends GuardNPCTemplate {
	public static final int ID = 30124;

	@Inject
	protected ZeromeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
