 ...
 */
public class BaneTemplate extends GuardNPCTemplate {
	public static final int ID = 30122;

	@Inject
	protected BaneTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
