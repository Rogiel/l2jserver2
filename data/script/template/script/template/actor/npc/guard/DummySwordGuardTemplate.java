 ...
 */
public class DummySwordGuardTemplate extends GuardNPCTemplate {
	public static final int ID = 31400;

	@Inject
	protected DummySwordGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dummy - Sword Guard";
