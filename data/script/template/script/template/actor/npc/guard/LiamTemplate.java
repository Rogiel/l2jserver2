 ...
 */
public class LiamTemplate extends GuardNPCTemplate {
	public static final int ID = 30076;

	@Inject
	protected LiamTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
