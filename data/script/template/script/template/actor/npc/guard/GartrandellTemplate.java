 ...
 */
public class GartrandellTemplate extends GuardNPCTemplate {
	public static final int ID = 30285;

	@Inject
	protected GartrandellTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gartrandell";
