 ...
 */
public class AlberiusTemplate extends GuardNPCTemplate {
	public static final int ID = 30284;

	@Inject
	protected AlberiusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Alberius";
		this.serverSideName = false;
		this.title = "Sentinel Knight";
