 ...
 */
public class WeiszTemplate extends GuardNPCTemplate {
	public static final int ID = 30385;

	@Inject
	protected WeiszTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
