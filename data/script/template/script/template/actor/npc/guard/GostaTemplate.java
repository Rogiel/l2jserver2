 ...
 */
public class GostaTemplate extends GuardNPCTemplate {
	public static final int ID = 30916;

	@Inject
	protected GostaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
