 ...
 */
public class DinkeyTemplate extends GuardNPCTemplate {
	public static final int ID = 30546;

	@Inject
	protected DinkeyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
