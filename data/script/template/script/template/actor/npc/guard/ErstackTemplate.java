 ...
 */
public class ErstackTemplate extends GuardNPCTemplate {
	public static final int ID = 31986;

	@Inject
	protected ErstackTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
