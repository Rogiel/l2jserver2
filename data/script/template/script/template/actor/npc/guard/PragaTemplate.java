 ...
 */
public class PragaTemplate extends GuardNPCTemplate {
	public static final int ID = 30333;

	@Inject
	protected PragaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
