 ...
 */
public class BurkeTemplate extends GuardNPCTemplate {
	public static final int ID = 31347;

	@Inject
	protected BurkeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
