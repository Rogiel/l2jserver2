 ...
 */
public class FrontierGuard5Template extends GuardNPCTemplate {
	public static final int ID = 30886;

	@Inject
	protected FrontierGuard5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
