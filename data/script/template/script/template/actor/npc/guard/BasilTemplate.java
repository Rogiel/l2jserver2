 ...
 */
public class BasilTemplate extends GuardNPCTemplate {
	public static final int ID = 32136;

	@Inject
	protected BasilTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
