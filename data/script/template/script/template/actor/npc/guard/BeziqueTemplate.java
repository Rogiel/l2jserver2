 ...
 */
public class BeziqueTemplate extends GuardNPCTemplate {
	public static final int ID = 30379;

	@Inject
	protected BeziqueTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
