 ...
 */
public class KurtTemplate extends GuardNPCTemplate {
	public static final int ID = 30452;

	@Inject
	protected KurtTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
