 ...
 */
public class GraysonTemplate extends GuardNPCTemplate {
	public static final int ID = 30877;

	@Inject
	protected GraysonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
