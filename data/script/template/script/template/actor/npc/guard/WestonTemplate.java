 ...
 */
public class WestonTemplate extends GuardNPCTemplate {
	public static final int ID = 30710;

	@Inject
	protected WestonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
