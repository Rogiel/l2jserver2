 ...
 */
public class TomaTemplate extends GuardNPCTemplate {
	public static final int ID = 30331;

	@Inject
	protected TomaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
