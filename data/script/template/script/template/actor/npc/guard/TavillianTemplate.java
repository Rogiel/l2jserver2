 ...
 */
public class TavillianTemplate extends GuardNPCTemplate {
	public static final int ID = 30724;

	@Inject
	protected TavillianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
