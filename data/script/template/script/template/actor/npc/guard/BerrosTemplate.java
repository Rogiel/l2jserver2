 ...
 */
public class BerrosTemplate extends GuardNPCTemplate {
	public static final int ID = 30217;

	@Inject
	protected BerrosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
