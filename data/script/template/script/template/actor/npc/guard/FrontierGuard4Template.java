 ...
 */
public class FrontierGuard4Template extends GuardNPCTemplate {
	public static final int ID = 30885;

	@Inject
	protected FrontierGuard4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
