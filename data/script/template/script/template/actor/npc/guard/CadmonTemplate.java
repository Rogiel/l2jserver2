 ...
 */
public class CadmonTemplate extends GuardNPCTemplate {
	public static final int ID = 31296;

	@Inject
	protected CadmonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
