 ...
 */
public class OrinakTemplate extends GuardNPCTemplate {
	public static final int ID = 30581;

	@Inject
	protected OrinakTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
