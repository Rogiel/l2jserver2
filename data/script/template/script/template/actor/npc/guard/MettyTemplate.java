 ...
 */
public class MettyTemplate extends GuardNPCTemplate {
	public static final int ID = 30072;

	@Inject
	protected MettyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
