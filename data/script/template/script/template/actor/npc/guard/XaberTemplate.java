 ...
 */
public class XaberTemplate extends GuardNPCTemplate {
	public static final int ID = 30075;

	@Inject
	protected XaberTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
