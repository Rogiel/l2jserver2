 ...
 */
public class BabencoTemplate extends GuardNPCTemplate {
	public static final int ID = 30334;

	@Inject
	protected BabencoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
