 ...
 */
public class BellardTemplate extends GuardNPCTemplate {
	public static final int ID = 31343;

	@Inject
	protected BellardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
