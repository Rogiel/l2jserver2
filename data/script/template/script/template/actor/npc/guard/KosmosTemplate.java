 ...
 */
public class KosmosTemplate extends GuardNPCTemplate {
	public static final int ID = 31985;

	@Inject
	protected KosmosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
