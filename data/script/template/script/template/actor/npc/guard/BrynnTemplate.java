 ...
 */
public class BrynnTemplate extends GuardNPCTemplate {
	public static final int ID = 30335;

	@Inject
	protected BrynnTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
