 ...
 */
public class TeboseTemplate extends GuardNPCTemplate {
	public static final int ID = 30726;

	@Inject
	protected TeboseTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
