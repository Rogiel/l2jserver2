 ...
 */
public class CurtisTemplate extends GuardNPCTemplate {
	public static final int ID = 30336;

	@Inject
	protected CurtisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
