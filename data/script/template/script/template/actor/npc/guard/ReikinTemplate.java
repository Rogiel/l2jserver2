 ...
 */
public class ReikinTemplate extends GuardNPCTemplate {
	public static final int ID = 30478;

	@Inject
	protected ReikinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
