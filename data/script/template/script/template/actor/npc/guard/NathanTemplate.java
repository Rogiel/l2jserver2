 ...
 */
public class NathanTemplate extends GuardNPCTemplate {
	public static final int ID = 30548;

	@Inject
	protected NathanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
