 ...
 */
public class RoyTemplate extends GuardNPCTemplate {
	public static final int ID = 30723;

	@Inject
	protected RoyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
