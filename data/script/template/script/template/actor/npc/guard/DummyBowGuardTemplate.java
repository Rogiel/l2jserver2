 ...
 */
public class DummyBowGuardTemplate extends GuardNPCTemplate {
	public static final int ID = 31401;

	@Inject
	protected DummyBowGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dummy - Bow Guard";
