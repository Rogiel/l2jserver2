 ...
 */
public class CageTemplate extends GuardNPCTemplate {
	public static final int ID = 30922;

	@Inject
	protected CageTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
