 ...
 */
public class YeningTemplate extends GuardNPCTemplate {
	public static final int ID = 30725;

	@Inject
	protected YeningTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
