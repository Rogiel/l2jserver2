 ...
 */
public class GunterTemplate extends GuardNPCTemplate {
	public static final int ID = 31293;

	@Inject
	protected GunterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
