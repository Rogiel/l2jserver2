 ...
 */
public class CarverTemplate extends GuardNPCTemplate {
	public static final int ID = 32178;

	@Inject
	protected CarverTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
