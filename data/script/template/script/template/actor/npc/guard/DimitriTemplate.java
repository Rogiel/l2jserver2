 ...
 */
public class DimitriTemplate extends GuardNPCTemplate {
	public static final int ID = 31342;

	@Inject
	protected DimitriTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
