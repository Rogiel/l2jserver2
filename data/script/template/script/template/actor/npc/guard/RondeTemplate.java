 ...
 */
public class RondeTemplate extends GuardNPCTemplate {
	public static final int ID = 32480;

	@Inject
	protected RondeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
