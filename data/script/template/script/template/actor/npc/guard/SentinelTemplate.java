 ...
 */
public class SentinelTemplate extends GuardNPCTemplate {
	public static final int ID = 31033;

	@Inject
	protected SentinelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
