 ...
 */
public class GardnerTemplate extends GuardNPCTemplate {
	public static final int ID = 30713;

	@Inject
	protected GardnerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
