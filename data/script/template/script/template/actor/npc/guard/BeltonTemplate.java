 ...
 */
public class BeltonTemplate extends GuardNPCTemplate {
	public static final int ID = 30125;

	@Inject
	protected BeltonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
