 ...
 */
public class RukainTemplate extends GuardNPCTemplate {
	public static final int ID = 30577;

	@Inject
	protected RukainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
