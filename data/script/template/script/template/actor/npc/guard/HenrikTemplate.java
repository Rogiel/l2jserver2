 ...
 */
public class HenrikTemplate extends GuardNPCTemplate {
	public static final int ID = 31295;

	@Inject
	protected HenrikTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
