 ...
 */
public class SchmidtTemplate extends GuardNPCTemplate {
	public static final int ID = 31344;

	@Inject
	protected SchmidtTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
