 ...
 */
public class KathawayTemplate extends GuardNPCTemplate {
	public static final int ID = 30433;

	@Inject
	protected KathawayTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
