 ...
 */
public class KayleenTemplate extends GuardNPCTemplate {
	public static final int ID = 30346;

	@Inject
	protected KayleenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
