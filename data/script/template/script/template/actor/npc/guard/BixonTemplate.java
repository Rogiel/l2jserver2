 ...
 */
public class BixonTemplate extends GuardNPCTemplate {
	public static final int ID = 32175;

	@Inject
	protected BixonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
