 ...
 */
public class PaionTemplate extends GuardNPCTemplate {
	public static final int ID = 30541;

	@Inject
	protected PaionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Paion";
		this.serverSideName = false;
		this.title = "Protector";
