 ...
 */
public class Marksman2Template extends GuardNPCTemplate {
	public static final int ID = 32336;

	@Inject
	protected Marksman2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
