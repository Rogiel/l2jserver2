 ...
 */
public class FrontierGuard3Template extends GuardNPCTemplate {
	public static final int ID = 30884;

	@Inject
	protected FrontierGuard3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
