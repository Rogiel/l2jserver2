 ...
 */
public class UlrichTemplate extends GuardNPCTemplate {
	public static final int ID = 31298;

	@Inject
	protected UlrichTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
