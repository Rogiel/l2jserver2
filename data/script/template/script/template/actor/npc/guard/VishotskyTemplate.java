 ...
 */
public class VishotskyTemplate extends GuardNPCTemplate {
	public static final int ID = 31981;

	@Inject
	protected VishotskyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
