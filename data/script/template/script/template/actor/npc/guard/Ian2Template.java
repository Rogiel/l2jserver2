 ...
 */
public class Ian2Template extends GuardNPCTemplate {
	public static final int ID = 31345;

	@Inject
	protected Ian2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
