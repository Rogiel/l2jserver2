 ...
 */
public class DefenderTemplate extends GuardNPCTemplate {
	public static final int ID = 31035;

	@Inject
	protected DefenderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
