 ...
 */
public class SaigeTemplate extends GuardNPCTemplate {
	public static final int ID = 32481;

	@Inject
	protected SaigeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
