 ...
 */
public class SentryTemplate extends GuardNPCTemplate {
	public static final int ID = 31034;

	@Inject
	protected SentryTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
