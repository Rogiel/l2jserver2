 ...
 */
public class DunstTemplate extends GuardNPCTemplate {
	public static final int ID = 30923;

	@Inject
	protected DunstTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
