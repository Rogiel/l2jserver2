 ...
 */
public class DupuisTemplate extends GuardNPCTemplate {
	public static final int ID = 30917;

	@Inject
	protected DupuisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
