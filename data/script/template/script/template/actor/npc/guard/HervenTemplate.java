 ...
 */
public class HervenTemplate extends GuardNPCTemplate {
	public static final int ID = 30465;

	@Inject
	protected HervenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
