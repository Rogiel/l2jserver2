 ...
 */
public class KraisenTemplate extends GuardNPCTemplate {
	public static final int ID = 30920;

	@Inject
	protected KraisenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
