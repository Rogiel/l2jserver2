 ...
 */
public class MakhisTemplate extends GuardNPCTemplate {
	public static final int ID = 30712;

	@Inject
	protected MakhisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
