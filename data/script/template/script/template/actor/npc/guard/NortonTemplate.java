 ...
 */
public class NortonTemplate extends GuardNPCTemplate {
	public static final int ID = 30709;

	@Inject
	protected NortonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
