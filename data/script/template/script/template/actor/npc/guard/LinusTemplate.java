 ...
 */
public class LinusTemplate extends GuardNPCTemplate {
	public static final int ID = 30384;

	@Inject
	protected LinusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
