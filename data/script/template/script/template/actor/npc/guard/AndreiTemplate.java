 ...
 */
public class AndreiTemplate extends GuardNPCTemplate {
	public static final int ID = 31292;

	@Inject
	protected AndreiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
