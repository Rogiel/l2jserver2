 ...
 */
public class PetukaiTemplate extends GuardNPCTemplate {
	public static final int ID = 30583;

	@Inject
	protected PetukaiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
