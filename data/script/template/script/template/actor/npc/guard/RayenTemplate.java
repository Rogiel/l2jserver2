 ...
 */
public class RayenTemplate extends GuardNPCTemplate {
	public static final int ID = 30221;

	@Inject
	protected RayenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
