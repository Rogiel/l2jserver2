 ...
 */
public class ScottTemplate extends GuardNPCTemplate {
	public static final int ID = 30383;

	@Inject
	protected ScottTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
