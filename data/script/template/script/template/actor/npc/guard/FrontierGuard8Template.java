 ...
 */
public class FrontierGuard8Template extends GuardNPCTemplate {
	public static final int ID = 30889;

	@Inject
	protected FrontierGuard8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
