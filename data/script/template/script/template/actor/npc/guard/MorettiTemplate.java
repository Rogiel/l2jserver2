 ...
 */
public class MorettiTemplate extends GuardNPCTemplate {
	public static final int ID = 30337;

	@Inject
	protected MorettiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
