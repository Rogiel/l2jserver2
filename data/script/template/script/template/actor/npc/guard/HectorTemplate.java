 ...
 */
public class HectorTemplate extends GuardNPCTemplate {
	public static final int ID = 30197;

	@Inject
	protected HectorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
