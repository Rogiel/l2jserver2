 ...
 */
public class PeregrineTemplate extends GuardNPCTemplate {
	public static final int ID = 32185;

	@Inject
	protected PeregrineTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
