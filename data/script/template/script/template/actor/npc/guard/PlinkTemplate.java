 ...
 */
public class PlinkTemplate extends GuardNPCTemplate {
	public static final int ID = 30380;

	@Inject
	protected PlinkTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
