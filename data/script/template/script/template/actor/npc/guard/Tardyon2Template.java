 ...
 */
public class Tardyon2Template extends GuardNPCTemplate {
	public static final int ID = 30547;

	@Inject
	protected Tardyon2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
