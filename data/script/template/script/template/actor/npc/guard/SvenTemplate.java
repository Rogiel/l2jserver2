 ...
 */
public class SvenTemplate extends GuardNPCTemplate {
	public static final int ID = 31294;

	@Inject
	protected SvenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
