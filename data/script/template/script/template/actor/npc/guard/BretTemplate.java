 ...
 */
public class BretTemplate extends GuardNPCTemplate {
	public static final int ID = 30871;

	@Inject
	protected BretTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
