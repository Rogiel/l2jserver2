 ...
 */
public class YatesTemplate extends GuardNPCTemplate {
	public static final int ID = 30199;

	@Inject
	protected YatesTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
