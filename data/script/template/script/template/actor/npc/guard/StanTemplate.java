 ...
 */
public class StanTemplate extends GuardNPCTemplate {
	public static final int ID = 30200;

	@Inject
	protected StanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
