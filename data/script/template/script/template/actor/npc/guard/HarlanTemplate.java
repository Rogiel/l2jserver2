 ...
 */
public class HarlanTemplate extends GuardNPCTemplate {
	public static final int ID = 30074;

	@Inject
	protected HarlanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
