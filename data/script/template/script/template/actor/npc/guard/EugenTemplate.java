 ...
 */
public class EugenTemplate extends GuardNPCTemplate {
	public static final int ID = 31299;

	@Inject
	protected EugenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
