 ...
 */
public class LucasTemplate extends GuardNPCTemplate {
	public static final int ID = 30071;

	@Inject
	protected LucasTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
