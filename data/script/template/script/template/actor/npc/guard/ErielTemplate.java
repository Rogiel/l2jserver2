 ...
 */
public class ErielTemplate extends GuardNPCTemplate {
	public static final int ID = 30431;

	@Inject
	protected ErielTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
