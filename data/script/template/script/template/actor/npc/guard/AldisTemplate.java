 ...
 */
public class AldisTemplate extends GuardNPCTemplate {
	public static final int ID = 30874;

	@Inject
	protected AldisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
