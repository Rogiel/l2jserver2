 ...
 */
public class BrightTemplate extends GuardNPCTemplate {
	public static final int ID = 30466;

	@Inject
	protected BrightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
