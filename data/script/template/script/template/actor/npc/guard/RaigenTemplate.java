 ...
 */
public class RaigenTemplate extends GuardNPCTemplate {
	public static final int ID = 30707;

	@Inject
	protected RaigenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
