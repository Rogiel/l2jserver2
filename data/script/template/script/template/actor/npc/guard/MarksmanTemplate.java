 ...
 */
public class MarksmanTemplate extends GuardNPCTemplate {
	public static final int ID = 32335;

	@Inject
	protected MarksmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
