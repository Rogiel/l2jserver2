 ...
 */
public class AdiosTemplate extends GuardNPCTemplate {
	public static final int ID = 32479;

	@Inject
	protected AdiosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
