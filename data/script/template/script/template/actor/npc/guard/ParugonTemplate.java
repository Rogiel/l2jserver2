 ...
 */
public class ParugonTemplate extends GuardNPCTemplate {
	public static final int ID = 30580;

	@Inject
	protected ParugonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
