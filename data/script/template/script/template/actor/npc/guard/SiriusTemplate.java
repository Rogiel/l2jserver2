 ...
 */
public class SiriusTemplate extends GuardNPCTemplate {
	public static final int ID = 31346;

	@Inject
	protected SiriusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
