 ...
 */
public class LuisTemplate extends GuardNPCTemplate {
	public static final int ID = 30386;

	@Inject
	protected LuisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
