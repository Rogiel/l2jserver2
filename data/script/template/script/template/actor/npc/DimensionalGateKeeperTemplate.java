 ...
 */
public class DimensionalGateKeeperTemplate extends NPCTemplate {
	public static final int ID = 31494;

	@Inject
	protected DimensionalGateKeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
