 ...
 */
public class GuardCaptain7Template extends NPCTemplate {
	public static final int ID = 35760;

	@Inject
	protected GuardCaptain7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
