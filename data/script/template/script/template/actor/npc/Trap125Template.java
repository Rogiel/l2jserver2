 ...
 */
public class Trap125Template extends NPCTemplate {
	public static final int ID = 18410;

	@Inject
	protected Trap125Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
