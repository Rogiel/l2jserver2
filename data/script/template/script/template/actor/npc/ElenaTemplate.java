 ...
 */
public class ElenaTemplate extends NPCTemplate {
	public static final int ID = 31284;

	@Inject
	protected ElenaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
