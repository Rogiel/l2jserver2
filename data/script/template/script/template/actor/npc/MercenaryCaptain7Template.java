 ...
 */
public class MercenaryCaptain7Template extends NPCTemplate {
	public static final int ID = 35893;

	@Inject
	protected MercenaryCaptain7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
