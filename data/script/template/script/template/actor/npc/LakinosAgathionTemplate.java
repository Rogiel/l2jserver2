 ...
 */
public class LakinosAgathionTemplate extends NPCTemplate {
	public static final int ID = 1543;

	@Inject
	protected LakinosAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lakinos Agathion";
