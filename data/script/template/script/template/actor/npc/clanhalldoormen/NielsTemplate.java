 ...
 */
public class NielsTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35446;

	@Inject
	protected NielsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
