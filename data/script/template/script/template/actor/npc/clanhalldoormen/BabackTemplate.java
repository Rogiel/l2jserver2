 ...
 */
public class BabackTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35387;

	@Inject
	protected BabackTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
