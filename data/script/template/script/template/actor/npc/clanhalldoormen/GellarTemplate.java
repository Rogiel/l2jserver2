 ...
 */
public class GellarTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35450;

	@Inject
	protected GellarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
