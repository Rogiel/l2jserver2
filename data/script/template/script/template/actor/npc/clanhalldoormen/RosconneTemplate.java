 ...
 */
public class RosconneTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35454;

	@Inject
	protected RosconneTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
