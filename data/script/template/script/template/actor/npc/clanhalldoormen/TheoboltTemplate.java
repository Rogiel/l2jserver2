 ...
 */
public class TheoboltTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35452;

	@Inject
	protected TheoboltTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
