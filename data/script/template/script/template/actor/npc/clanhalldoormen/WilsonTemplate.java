 ...
 */
public class WilsonTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 30772;

	@Inject
	protected WilsonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
