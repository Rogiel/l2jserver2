 ...
 */
public class AmielTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35401;

	@Inject
	protected AmielTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
