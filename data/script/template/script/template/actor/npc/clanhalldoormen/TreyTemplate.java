 ...
 */
public class TreyTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35460;

	@Inject
	protected TreyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
