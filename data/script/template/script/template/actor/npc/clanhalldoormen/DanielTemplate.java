 ...
 */
public class DanielTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35440;

	@Inject
	protected DanielTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
