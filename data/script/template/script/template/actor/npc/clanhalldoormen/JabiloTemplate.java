 ...
 */
public class JabiloTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35406;

	@Inject
	protected JabiloTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
