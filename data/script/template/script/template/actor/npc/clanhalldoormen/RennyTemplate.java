 ...
 */
public class RennyTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35385;

	@Inject
	protected RennyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
