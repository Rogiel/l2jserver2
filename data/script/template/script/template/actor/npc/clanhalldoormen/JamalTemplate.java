 ...
 */
public class JamalTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35404;

	@Inject
	protected JamalTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
