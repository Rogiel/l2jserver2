 ...
 */
public class ToddTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 30773;

	@Inject
	protected ToddTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
