 ...
 */
public class LambertTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35468;

	@Inject
	protected LambertTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
