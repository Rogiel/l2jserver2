 ...
 */
public class StewartTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35456;

	@Inject
	protected StewartTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
