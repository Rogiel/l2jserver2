 ...
 */
public class OshoTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35581;

	@Inject
	protected OshoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
