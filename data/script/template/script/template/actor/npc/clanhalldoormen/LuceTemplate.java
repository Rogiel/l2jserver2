 ...
 */
public class LuceTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35399;

	@Inject
	protected LuceTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
