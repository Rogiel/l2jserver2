 ...
 */
public class MertonTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35397;

	@Inject
	protected MertonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
