 ...
 */
public class KoganTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35395;

	@Inject
	protected KoganTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
