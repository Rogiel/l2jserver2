 ...
 */
public class EgonTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35579;

	@Inject
	protected EgonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
