 ...
 */
public class ShawnTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35573;

	@Inject
	protected ShawnTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
