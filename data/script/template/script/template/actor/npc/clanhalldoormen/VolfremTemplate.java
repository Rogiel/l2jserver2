 ...
 */
public class VolfremTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35464;

	@Inject
	protected VolfremTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
