 ...
 */
public class GerardTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35466;

	@Inject
	protected GerardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
