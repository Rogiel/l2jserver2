 ...
 */
public class JacquesTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35442;

	@Inject
	protected JacquesTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
