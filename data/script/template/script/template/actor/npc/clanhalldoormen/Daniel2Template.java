 ...
 */
public class Daniel2Template extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35569;

	@Inject
	protected Daniel2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
