 ...
 */
public class HarryTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35577;

	@Inject
	protected HarryTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
