 ...
 */
public class LatifTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35391;

	@Inject
	protected LatifTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
