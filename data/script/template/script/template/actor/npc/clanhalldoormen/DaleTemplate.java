 ...
 */
public class DaleTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35571;

	@Inject
	protected DaleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
