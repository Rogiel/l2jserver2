 ...
 */
public class LoringTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35389;

	@Inject
	protected LoringTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
