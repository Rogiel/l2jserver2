 ...
 */
public class KalmerTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35462;

	@Inject
	protected KalmerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
