 ...
 */
public class WalterTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35583;

	@Inject
	protected WalterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
