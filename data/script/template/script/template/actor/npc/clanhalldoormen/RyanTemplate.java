 ...
 */
public class RyanTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35575;

	@Inject
	protected RyanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
