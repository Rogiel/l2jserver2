 ...
 */
public class FaolanTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35393;

	@Inject
	protected FaolanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
