 ...
 */
public class EmilTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35567;

	@Inject
	protected EmilTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
