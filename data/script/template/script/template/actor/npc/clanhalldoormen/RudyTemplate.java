 ...
 */
public class RudyTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35448;

	@Inject
	protected RudyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
