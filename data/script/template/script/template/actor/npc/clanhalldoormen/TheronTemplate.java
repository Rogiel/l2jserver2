 ...
 */
public class TheronTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35458;

	@Inject
	protected TheronTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
