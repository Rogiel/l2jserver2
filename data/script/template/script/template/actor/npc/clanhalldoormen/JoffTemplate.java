 ...
 */
public class JoffTemplate extends ClanhallDoormenNPCTemplate {
	public static final int ID = 35444;

	@Inject
	protected JoffTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
