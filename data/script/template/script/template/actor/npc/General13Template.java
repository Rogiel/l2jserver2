 ...
 */
public class General13Template extends NPCTemplate {
	public static final int ID = 36076;

	@Inject
	protected General13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
