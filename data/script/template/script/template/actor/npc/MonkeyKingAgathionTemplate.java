 ...
 */
public class MonkeyKingAgathionTemplate extends NPCTemplate {
	public static final int ID = 1532;

	@Inject
	protected MonkeyKingAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Monkey King Agathion";
