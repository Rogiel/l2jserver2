 ...
 */
public class ScrydeHeartseekerTemplate extends NPCTemplate {
	public static final int ID = 31611;

	@Inject
	protected ScrydeHeartseekerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Scryde Heartseeker";
