 ...
 */
public class MercenaryPrivate8Template extends NPCTemplate {
	public static final int ID = 35925;

	@Inject
	protected MercenaryPrivate8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
