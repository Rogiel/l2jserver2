 ...
 */
public class FilaurTemplate extends NPCTemplate {
	public static final int ID = 30535;

	@Inject
	protected FilaurTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Filaur";
		this.serverSideName = false;
		this.title = "Gray Pillar Member";
