 ...
 */
public class WisdomChestTemplate extends NPCTemplate {
	public static final int ID = 30743;

	@Inject
	protected WisdomChestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Wisdom Chest";
