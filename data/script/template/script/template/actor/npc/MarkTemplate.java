 ...
 */
public class MarkTemplate extends NPCTemplate {
	public static final int ID = 32487;

	@Inject
	protected MarkTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
