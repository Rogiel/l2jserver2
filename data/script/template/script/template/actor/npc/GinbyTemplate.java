 ...
 */
public class GinbyTemplate extends NPCTemplate {
	public static final int ID = 32566;

	@Inject
	protected GinbyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
