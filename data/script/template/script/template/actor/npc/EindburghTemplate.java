 ...
 */
public class EindburghTemplate extends NPCTemplate {
	public static final int ID = 32469;

	@Inject
	protected EindburghTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
