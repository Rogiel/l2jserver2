 ...
 */
public class WhiteCupidAgathionTemplate extends NPCTemplate {
	public static final int ID = 1508;

	@Inject
	protected WhiteCupidAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "White Cupid Agathion";
