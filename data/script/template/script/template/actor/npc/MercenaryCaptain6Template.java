 ...
 */
public class MercenaryCaptain6Template extends NPCTemplate {
	public static final int ID = 35855;

	@Inject
	protected MercenaryCaptain6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
