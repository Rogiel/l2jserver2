 ...
 */
public class LargeRainHoneyWatermelonTemplate extends NPCTemplate {
	public static final int ID = 13278;

	@Inject
	protected LargeRainHoneyWatermelonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Large Rain Honey Watermelon";
