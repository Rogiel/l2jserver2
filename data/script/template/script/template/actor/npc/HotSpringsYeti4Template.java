 ...
 */
public class HotSpringsYeti4Template extends NPCTemplate {
	public static final int ID = 35598;

	@Inject
	protected HotSpringsYeti4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
