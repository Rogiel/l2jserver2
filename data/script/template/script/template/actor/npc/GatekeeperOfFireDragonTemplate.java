 ...
 */
public class GatekeeperOfFireDragonTemplate extends NPCTemplate {
	public static final int ID = 31384;

	@Inject
	protected GatekeeperOfFireDragonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
