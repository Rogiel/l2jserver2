 ...
 */
public class TeleportDeviceTemplate extends NPCTemplate {
	public static final int ID = 32745;

	@Inject
	protected TeleportDeviceTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
