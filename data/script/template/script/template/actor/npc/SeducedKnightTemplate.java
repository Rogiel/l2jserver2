 ...
 */
public class SeducedKnightTemplate extends NPCTemplate {
	public static final int ID = 36562;

	@Inject
	protected SeducedKnightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
