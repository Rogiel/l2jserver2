 ...
 */
public class GloomyBabyWhiteTigerCaptainTemplate extends NPCTemplate {
	public static final int ID = 13289;

	@Inject
	protected GloomyBabyWhiteTigerCaptainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gloomy Baby White Tiger Captain";
