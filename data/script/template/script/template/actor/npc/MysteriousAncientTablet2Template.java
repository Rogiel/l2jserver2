 ...
 */
public class MysteriousAncientTablet2Template extends NPCTemplate {
	public static final int ID = 31549;

	@Inject
	protected MysteriousAncientTablet2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mysterious Ancient Tablet";
