 ...
 */
public class MysteriousAncientTablet3Template extends NPCTemplate {
	public static final int ID = 31550;

	@Inject
	protected MysteriousAncientTablet3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
