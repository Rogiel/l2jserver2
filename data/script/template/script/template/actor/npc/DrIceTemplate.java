 ...
 */
public class DrIceTemplate extends NPCTemplate {
	public static final int ID = 32726;

	@Inject
	protected DrIceTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
