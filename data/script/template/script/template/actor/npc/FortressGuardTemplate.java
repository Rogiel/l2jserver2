 ...
 */
public class FortressGuardTemplate extends NPCTemplate {
	public static final int ID = 35641;

	@Inject
	protected FortressGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
