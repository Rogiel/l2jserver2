 ...
 */
public class MatildTemplate extends NPCTemplate {
	public static final int ID = 30738;

	@Inject
	protected MatildTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Matild";
		this.serverSideName = false;
		this.title = "Alchemist";
