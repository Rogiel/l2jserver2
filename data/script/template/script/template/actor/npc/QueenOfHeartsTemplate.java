 ...
 */
public class QueenOfHeartsTemplate extends NPCTemplate {
	public static final int ID = 4301;

	@Inject
	protected QueenOfHeartsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Queen of Hearts";
		this.serverSideName = false;
		this.title = "Valentine Messenger";
