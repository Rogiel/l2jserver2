 ...
 */
public class SwaySkyLanternTemplate extends NPCTemplate {
	public static final int ID = 24;

	@Inject
	protected SwaySkyLanternTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sway Sky Lantern";
