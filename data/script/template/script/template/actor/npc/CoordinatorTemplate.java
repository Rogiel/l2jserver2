 ...
 */
public class CoordinatorTemplate extends NPCTemplate {
	public static final int ID = 35603;

	@Inject
	protected CoordinatorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
