 ...
 */
public class TonyTheCat4Template extends NPCTemplate {
	public static final int ID = 32102;

	@Inject
	protected TonyTheCat4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
