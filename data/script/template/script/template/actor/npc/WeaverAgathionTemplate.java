 ...
 */
public class WeaverAgathionTemplate extends NPCTemplate {
	public static final int ID = 1528;

	@Inject
	protected WeaverAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Weaver Agathion";
