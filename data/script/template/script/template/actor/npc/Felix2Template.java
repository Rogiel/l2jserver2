 ...
 */
public class Felix2Template extends NPCTemplate {
	public static final int ID = 32565;

	@Inject
	protected Felix2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
