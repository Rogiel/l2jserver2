 ...
 */
public class SwoopCannon31Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14869;

	@Inject
	protected SwoopCannon31Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 17.00000;
