 ...
 */
public class SwoopCannon21Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14859;

	@Inject
	protected SwoopCannon21Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 15.37670;
