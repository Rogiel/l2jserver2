 ...
 */
public class SiegeGolem16Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14752;

	@Inject
	protected SiegeGolem16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1725.00000;
