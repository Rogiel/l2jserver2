 ...
 */
public class WildHogCannon22Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14789;

	@Inject
	protected WildHogCannon22Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.magicalAttack = 651.42429;
		attributes.physicalDefense = 354.88311;
		attributes.magicalDefense = 259.68806;
