 ...
 */
public class SwoopCannon12Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14850;

	@Inject
	protected SwoopCannon12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 13.83539;
