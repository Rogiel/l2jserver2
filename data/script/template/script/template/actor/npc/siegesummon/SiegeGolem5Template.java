 ...
 */
public class SiegeGolem5Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14741;

	@Inject
	protected SiegeGolem5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1560.00000;
