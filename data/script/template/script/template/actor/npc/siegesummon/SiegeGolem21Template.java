 ...
 */
public class SiegeGolem21Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14757;

	@Inject
	protected SiegeGolem21Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1800.00000;
