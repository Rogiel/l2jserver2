 ...
 */
public class SiegeGolem9Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14745;

	@Inject
	protected SiegeGolem9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1620.00000;
