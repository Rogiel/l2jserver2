 ...
 */
public class SiegeGolem3Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14739;

	@Inject
	protected SiegeGolem3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1530.00000;
