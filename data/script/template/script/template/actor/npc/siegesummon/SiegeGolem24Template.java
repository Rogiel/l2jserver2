 ...
 */
public class SiegeGolem24Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14760;

	@Inject
	protected SiegeGolem24Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1845.00000;
