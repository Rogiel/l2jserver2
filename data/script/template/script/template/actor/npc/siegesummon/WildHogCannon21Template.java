 ...
 */
public class WildHogCannon21Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14788;

	@Inject
	protected WildHogCannon21Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 2978.073585000000000;
		this.maxMP = 1768.650000000000000;
		...
		attributes.physicalAttack = 945.52267;
