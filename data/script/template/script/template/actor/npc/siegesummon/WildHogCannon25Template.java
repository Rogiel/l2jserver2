 ...
 */
public class WildHogCannon25Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14792;

	@Inject
	protected WildHogCannon25Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 3010.179215000000000;
		this.maxMP = 1803.200000000000000;
		...
		attributes.physicalAttack = 962.80244;
