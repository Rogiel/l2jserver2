 ...
 */
public class SwoopCannon6Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14844;

	@Inject
	protected SwoopCannon6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 12.82311;
