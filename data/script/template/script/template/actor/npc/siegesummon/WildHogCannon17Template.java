 ...
 */
public class WildHogCannon17Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14784;

	@Inject
	protected WildHogCannon17Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 2944.290935000000000;
		this.maxMP = 1734.300000000000000;
		...
		attributes.physicalAttack = 927.64092;
