 ...
 */
public class SiegeGolem25Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14761;

	@Inject
	protected SiegeGolem25Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1860.00000;
