 ...
 */
public class SiegeGolem11Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14747;

	@Inject
	protected SiegeGolem11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1650.00000;
