 ...
 */
public class SiegeGolem8Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14744;

	@Inject
	protected SiegeGolem8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1605.00000;
