 ...
 */
public class WildHogCannon10Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14777;

	@Inject
	protected WildHogCannon10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.magicalAttack = 614.29227;
		attributes.physicalDefense = 342.45123;
		attributes.magicalDefense = 250.59095;
