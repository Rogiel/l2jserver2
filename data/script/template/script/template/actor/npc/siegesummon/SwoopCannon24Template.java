 ...
 */
public class SwoopCannon24Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14862;

	@Inject
	protected SwoopCannon24Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Swoop Cannon";
		...
		this.attackRange = 80;
		this.maxHP = 50000.000000000000000;
		...
		attributes.physicalAttack = 15.91784;
