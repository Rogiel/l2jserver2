 ...
 */
public class SiegeGolem2Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14738;

	@Inject
	protected SiegeGolem2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1515.00000;
