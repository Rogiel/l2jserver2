 ...
 */
public class SwoopCannonTemplate extends SiegeSummonNPCTemplate {
	public static final int ID = 14839;

	@Inject
	protected SwoopCannonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
