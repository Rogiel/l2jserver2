 ...
 */
public class SiegeGolem12Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14748;

	@Inject
	protected SiegeGolem12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1665.00000;
