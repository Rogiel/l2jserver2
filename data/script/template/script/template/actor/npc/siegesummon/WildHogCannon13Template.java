 ...
 */
public class WildHogCannon13Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14780;

	@Inject
	protected WildHogCannon13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 2908.893087500000000;
		this.maxMP = 1700.150000000000000;
		...
		attributes.physicalAttack = 909.20425;
		attributes.magicalAttack = 623.83518;
