 ...
 */
public class SiegeGolem31Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14767;

	@Inject
	protected SiegeGolem31Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1950.00000;
