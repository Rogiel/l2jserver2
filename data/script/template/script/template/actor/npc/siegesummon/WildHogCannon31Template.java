 ...
 */
public class WildHogCannon31Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14798;

	@Inject
	protected WildHogCannon31Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 3066.635256666670000;
		this.maxMP = 1870.000000000000000;
		...
		attributes.physicalAttack = 994.00287;
