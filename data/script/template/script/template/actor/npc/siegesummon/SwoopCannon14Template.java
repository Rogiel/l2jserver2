 ...
 */
public class SwoopCannon14Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14852;

	@Inject
	protected SwoopCannon14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 14.37969;
