 ...
 */
public class SwoopCannon18Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14856;

	@Inject
	protected SwoopCannon18Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 14.92399;
