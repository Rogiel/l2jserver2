 ...
 */
public class SiegeGolem22Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14758;

	@Inject
	protected SiegeGolem22Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1815.00000;
