 ...
 */
public class SiegeGolem7Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14743;

	@Inject
	protected SiegeGolem7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1590.00000;
