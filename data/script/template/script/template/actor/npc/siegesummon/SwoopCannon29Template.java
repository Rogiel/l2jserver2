 ...
 */
public class SwoopCannon29Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14867;

	@Inject
	protected SwoopCannon29Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 16.45892;
