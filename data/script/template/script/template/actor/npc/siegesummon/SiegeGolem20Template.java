 ...
 */
public class SiegeGolem20Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14756;

	@Inject
	protected SiegeGolem20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1785.00000;
