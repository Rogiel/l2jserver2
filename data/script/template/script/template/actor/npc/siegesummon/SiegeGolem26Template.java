 ...
 */
public class SiegeGolem26Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14762;

	@Inject
	protected SiegeGolem26Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1875.00000;
