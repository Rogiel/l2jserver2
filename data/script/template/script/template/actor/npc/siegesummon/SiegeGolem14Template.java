 ...
 */
public class SiegeGolem14Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14750;

	@Inject
	protected SiegeGolem14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1695.00000;
