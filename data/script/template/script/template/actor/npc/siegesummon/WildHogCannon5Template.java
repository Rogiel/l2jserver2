 ...
 */
public class WildHogCannon5Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14772;

	@Inject
	protected WildHogCannon5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 2832.490375000000000;
		this.maxMP = 1632.600000000000000;
		...
		attributes.physicalAttack = 870.57666;
		attributes.magicalAttack = 597.85136;
