 ...
 */
public class SiegeGolem27Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14763;

	@Inject
	protected SiegeGolem27Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1890.00000;
