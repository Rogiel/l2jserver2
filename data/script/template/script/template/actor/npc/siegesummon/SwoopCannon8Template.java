 ...
 */
public class SwoopCannon8Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14846;

	@Inject
	protected SwoopCannon8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
