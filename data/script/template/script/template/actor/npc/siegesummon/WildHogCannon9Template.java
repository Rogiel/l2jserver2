 ...
 */
public class WildHogCannon9Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14776;

	@Inject
	protected WildHogCannon9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 2871.944355000000000;
		this.maxMP = 1666.200000000000000;
		...
		attributes.physicalAttack = 890.26038;
