 ...
 */
public class SiegeGolem10Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14746;

	@Inject
	protected SiegeGolem10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1635.00000;
