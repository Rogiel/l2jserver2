 ...
 */
public class SiegeGolem15Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14751;

	@Inject
	protected SiegeGolem15Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1710.00000;
