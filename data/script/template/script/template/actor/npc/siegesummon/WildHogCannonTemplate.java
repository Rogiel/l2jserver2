 ...
 */
public class WildHogCannonTemplate extends SiegeSummonNPCTemplate {
	public static final int ID = 14768;

	@Inject
	protected WildHogCannonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
