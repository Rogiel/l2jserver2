 ...
 */
public class SiegeGolem13Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14749;

	@Inject
	protected SiegeGolem13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1680.00000;
