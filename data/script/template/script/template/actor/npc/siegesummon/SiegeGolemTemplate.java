 ...
 */
public class SiegeGolemTemplate extends SiegeSummonNPCTemplate {
	public static final int ID = 14737;

	@Inject
	protected SiegeGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1500.00000;
