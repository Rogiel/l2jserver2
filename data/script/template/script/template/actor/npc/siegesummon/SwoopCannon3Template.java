 ...
 */
public class SwoopCannon3Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14841;

	@Inject
	protected SwoopCannon3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
