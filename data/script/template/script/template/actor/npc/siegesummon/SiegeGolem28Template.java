 ...
 */
public class SiegeGolem28Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14764;

	@Inject
	protected SiegeGolem28Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1905.00000;
