 ...
 */
public class SwoopCannon4Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14842;

	@Inject
	protected SwoopCannon4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
