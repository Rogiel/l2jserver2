 ...
 */
public class WildHogCannon2Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14769;

	@Inject
	protected WildHogCannon2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.magicalAttack = 587.77030;
		attributes.physicalDefense = 333.79298;
		attributes.magicalDefense = 244.25522;
