 ...
 */
public class SiegeGolem17Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14753;

	@Inject
	protected SiegeGolem17Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1740.00000;
