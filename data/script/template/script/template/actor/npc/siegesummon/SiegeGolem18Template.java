 ...
 */
public class SiegeGolem18Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14754;

	@Inject
	protected SiegeGolem18Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1755.00000;
