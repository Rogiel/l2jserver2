 ...
 */
public class SwoopCannon10Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14848;

	@Inject
	protected SwoopCannon10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 13.37067;
