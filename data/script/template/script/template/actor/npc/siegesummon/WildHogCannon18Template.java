 ...
 */
public class WildHogCannon18Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14785;

	@Inject
	protected WildHogCannon18Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.magicalAttack = 639.43106;
		attributes.physicalDefense = 350.81565;
		attributes.magicalDefense = 256.71167;
