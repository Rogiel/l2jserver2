 ...
 */
public class SiegeGolem29Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14765;

	@Inject
	protected SiegeGolem29Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1920.00000;
