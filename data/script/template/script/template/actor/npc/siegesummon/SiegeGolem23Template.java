 ...
 */
public class SiegeGolem23Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14759;

	@Inject
	protected SiegeGolem23Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1830.00000;
