 ...
 */
public class SiegeGolem6Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14742;

	@Inject
	protected SiegeGolem6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1575.00000;
