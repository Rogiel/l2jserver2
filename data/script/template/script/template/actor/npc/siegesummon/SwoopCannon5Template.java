 ...
 */
public class SwoopCannon5Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14843;

	@Inject
	protected SwoopCannon5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
