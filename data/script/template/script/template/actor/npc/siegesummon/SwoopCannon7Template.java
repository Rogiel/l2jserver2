 ...
 */
public class SwoopCannon7Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14845;

	@Inject
	protected SwoopCannon7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
