 ...
 */
public class SiegeGolem4Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14740;

	@Inject
	protected SiegeGolem4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1545.00000;
