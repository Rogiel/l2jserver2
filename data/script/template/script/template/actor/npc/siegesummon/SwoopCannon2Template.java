 ...
 */
public class SwoopCannon2Template extends SiegeSummonNPCTemplate {
	public static final int ID = 14840;

	@Inject
	protected SwoopCannon2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 12.47500;
