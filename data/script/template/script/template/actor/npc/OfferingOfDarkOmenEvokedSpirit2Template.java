 ...
 */
public class OfferingOfDarkOmenEvokedSpirit2Template extends NPCTemplate {
	public static final int ID = 18316;

	@Inject
	protected OfferingOfDarkOmenEvokedSpirit2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Offering of Dark Omen Evoked Spirit";
		...
		attributes.magicalDefense = 167.63575;
