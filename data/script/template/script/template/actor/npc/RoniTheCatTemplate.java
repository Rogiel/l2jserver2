 ...
 */
public class RoniTheCatTemplate extends NPCTemplate {
	public static final int ID = 32638;

	@Inject
	protected RoniTheCatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Roni the cat";
		this.serverSideName = false;
		this.title = "PC Cafe Event";
