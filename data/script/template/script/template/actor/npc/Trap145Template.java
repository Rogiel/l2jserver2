 ...
 */
public class Trap145Template extends NPCTemplate {
	public static final int ID = 18722;

	@Inject
	protected Trap145Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
