 ...
 */
public class EvilAltar2Template extends NPCTemplate {
	public static final int ID = 31513;

	@Inject
	protected EvilAltar2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
