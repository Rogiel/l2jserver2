 ...
 */
public class GuardCaptain13Template extends NPCTemplate {
	public static final int ID = 35860;

	@Inject
	protected GuardCaptain13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
