 ...
 */
public class SaintsFollower3Template extends NPCTemplate {
	public static final int ID = 31702;

	@Inject
	protected SaintsFollower3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
