 ...
 */
public class SoulCrystalPillarTemplate extends NPCTemplate {
	public static final int ID = 18506;

	@Inject
	protected SoulCrystalPillarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Soul Crystal Pillar";
