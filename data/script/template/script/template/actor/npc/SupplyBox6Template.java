 ...
 */
public class SupplyBox6Template extends NPCTemplate {
	public static final int ID = 35834;

	@Inject
	protected SupplyBox6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
