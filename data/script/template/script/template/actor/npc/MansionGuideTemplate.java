 ...
 */
public class MansionGuideTemplate extends NPCTemplate {
	public static final int ID = 18594;

	@Inject
	protected MansionGuideTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mansion Guide";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 9.00;
		this.collisionHeight = 21.60;
		this.level = 81;
