 ...
 */
public class Trap173Template extends NPCTemplate {
	public static final int ID = 18750;

	@Inject
	protected Trap173Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
