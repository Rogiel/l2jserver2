 ...
 */
public class SymbolOfTruthTemplate extends NPCTemplate {
	public static final int ID = 32291;

	@Inject
	protected SymbolOfTruthTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Symbol of Truth";
