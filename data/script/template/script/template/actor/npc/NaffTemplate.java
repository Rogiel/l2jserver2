 ...
 */
public class NaffTemplate extends NPCTemplate {
	public static final int ID = 31544;

	@Inject
	protected NaffTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
