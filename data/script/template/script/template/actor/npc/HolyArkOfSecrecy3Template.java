 ...
 */
public class HolyArkOfSecrecy3Template extends NPCTemplate {
	public static final int ID = 30979;

	@Inject
	protected HolyArkOfSecrecy3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Holy Ark of Secrecy 3";
