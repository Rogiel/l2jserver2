 ...
 */
public class MercenaryCaptain2Template extends NPCTemplate {
	public static final int ID = 35724;

	@Inject
	protected MercenaryCaptain2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
