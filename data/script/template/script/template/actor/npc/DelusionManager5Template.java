 ...
 */
public class DelusionManager5Template extends NPCTemplate {
	public static final int ID = 32668;

	@Inject
	protected DelusionManager5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
