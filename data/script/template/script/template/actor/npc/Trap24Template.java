 ...
 */
public class Trap24Template extends NPCTemplate {
	public static final int ID = 13060;

	@Inject
	protected Trap24Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
