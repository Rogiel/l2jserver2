 ...
 */
public class RatHoleTemplate extends NPCTemplate {
	public static final int ID = 32312;

	@Inject
	protected RatHoleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
