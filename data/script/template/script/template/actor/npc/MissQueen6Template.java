 ...
 */
public class MissQueen6Template extends NPCTemplate {
	public static final int ID = 31764;

	@Inject
	protected MissQueen6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
