 ...
 */
public class EvertTemplate extends NPCTemplate {
	public static final int ID = 30633;

	@Inject
	protected EvertTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
