 ...
 */
public class KierTemplate extends NPCTemplate {
	public static final int ID = 32022;

	@Inject
	protected KierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
