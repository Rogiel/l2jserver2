 ...
 */
public class MysteriousAncientTablet5Template extends NPCTemplate {
	public static final int ID = 31552;

	@Inject
	protected MysteriousAncientTablet5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
