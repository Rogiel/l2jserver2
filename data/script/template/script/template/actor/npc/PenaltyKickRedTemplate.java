 ...
 */
public class PenaltyKickRedTemplate extends NPCTemplate {
	public static final int ID = 1584;

	@Inject
	protected PenaltyKickRedTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Penalty Kick (red)";
