 ...
 */
public class NewbieGuide4Template extends NPCTemplate {
	public static final int ID = 30601;

	@Inject
	protected NewbieGuide4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
