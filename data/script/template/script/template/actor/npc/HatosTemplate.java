 ...
 */
public class HatosTemplate extends NPCTemplate {
	public static final int ID = 30568;

	@Inject
	protected HatosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hatos";
		this.serverSideName = false;
		this.title = "Urutu Chief";
