 ...
 */
public class KetraVanCommanderTemplate extends NPCTemplate {
	public static final int ID = 31710;

	@Inject
	protected KetraVanCommanderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ketra Van Commander";
