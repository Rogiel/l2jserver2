 ...
 */
public class DummyBoyATemplate extends NPCTemplate {
	public static final int ID = 31390;

	@Inject
	protected DummyBoyATemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dummy - Boy A";
