 ...
 */
public class GordonTemplate extends NPCTemplate {
	public static final int ID = 13102;

	@Inject
	protected GordonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
