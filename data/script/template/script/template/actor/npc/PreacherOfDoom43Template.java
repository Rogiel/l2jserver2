 ...
 */
public class PreacherOfDoom43Template extends NPCTemplate {
	public static final int ID = 32001;

	@Inject
	protected PreacherOfDoom43Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
