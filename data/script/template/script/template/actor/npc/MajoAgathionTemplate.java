 ...
 */
public class MajoAgathionTemplate extends NPCTemplate {
	public static final int ID = 1501;

	@Inject
	protected MajoAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Majo Agathion";
