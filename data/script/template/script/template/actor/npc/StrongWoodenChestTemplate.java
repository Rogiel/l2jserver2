 ...
 */
public class StrongWoodenChestTemplate extends NPCTemplate {
	public static final int ID = 30628;

	@Inject
	protected StrongWoodenChestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Strong Wooden Chest";
