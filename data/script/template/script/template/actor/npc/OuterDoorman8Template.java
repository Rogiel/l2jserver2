 ...
 */
public class OuterDoorman8Template extends NPCTemplate {
	public static final int ID = 35435;

	@Inject
	protected OuterDoorman8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
