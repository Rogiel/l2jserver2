 ...
 */
public class GuardianOfEasternSealTemplate extends NPCTemplate {
	public static final int ID = 32658;

	@Inject
	protected GuardianOfEasternSealTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guardian of Eastern Seal";
