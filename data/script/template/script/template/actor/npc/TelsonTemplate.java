 ...
 */
public class TelsonTemplate extends NPCTemplate {
	public static final int ID = 31592;

	@Inject
	protected TelsonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Telson";
		this.serverSideName = false;
		this.title = "Chief Golem Crafter";
