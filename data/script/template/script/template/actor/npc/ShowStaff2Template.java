 ...
 */
public class ShowStaff2Template extends NPCTemplate {
	public static final int ID = 32425;

	@Inject
	protected ShowStaff2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
