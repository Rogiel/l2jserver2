 ...
 */
public class TullysGatekeeper6Template extends NPCTemplate {
	public static final int ID = 18450;

	@Inject
	protected TullysGatekeeper6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
