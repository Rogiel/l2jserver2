 ...
 */
public class Trap96Template extends NPCTemplate {
	public static final int ID = 18381;

	@Inject
	protected Trap96Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
