 ...
 */
public class RiftPostRecruitTemplate extends NPCTemplate {
	public static final int ID = 31488;

	@Inject
	protected RiftPostRecruitTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rift Post Recruit";
