 ...
 */
public class DudaMaraTotemSpirit2Template extends NPCTemplate {
	public static final int ID = 31589;

	@Inject
	protected DudaMaraTotemSpirit2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Duda-Mara Totem Spirit";
