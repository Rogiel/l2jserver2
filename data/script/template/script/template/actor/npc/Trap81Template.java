 ...
 */
public class Trap81Template extends NPCTemplate {
	public static final int ID = 13245;

	@Inject
	protected Trap81Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
