 ...
 */
public class NativePrisonerTemplate extends NPCTemplate {
	public static final int ID = 32358;

	@Inject
	protected NativePrisonerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Native Prisoner";
