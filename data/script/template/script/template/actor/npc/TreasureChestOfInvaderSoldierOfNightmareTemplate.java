 ...
 */
public class TreasureChestOfInvaderSoldierOfNightmareTemplate extends NPCTemplate {
	public static final int ID = 18838;

	@Inject
	protected TreasureChestOfInvaderSoldierOfNightmareTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Treasure Chest of Invader Soldier of Nightmare";
