 ...
 */
public class TalienTemplate extends NPCTemplate {
	public static final int ID = 31739;

	@Inject
	protected TalienTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
