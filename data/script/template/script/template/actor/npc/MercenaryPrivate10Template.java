 ...
 */
public class MercenaryPrivate10Template extends NPCTemplate {
	public static final int ID = 36001;

	@Inject
	protected MercenaryPrivate10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
