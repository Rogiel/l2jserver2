 ...
 */
public class StatueOfWaterTemplate extends NPCTemplate {
	public static final int ID = 30962;

	@Inject
	protected StatueOfWaterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Statue of Water";
