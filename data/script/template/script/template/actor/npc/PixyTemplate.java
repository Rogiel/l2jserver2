 ...
 */
public class PixyTemplate extends NPCTemplate {
	public static final int ID = 13095;

	@Inject
	protected PixyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
