 ...
 */
public class DetentionCampWarden12Template extends NPCTemplate {
	public static final int ID = 36043;

	@Inject
	protected DetentionCampWarden12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
