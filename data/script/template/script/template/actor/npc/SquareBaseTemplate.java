 ...
 */
public class SquareBaseTemplate extends NPCTemplate {
	public static final int ID = 18921;

	@Inject
	protected SquareBaseTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Square Base";
