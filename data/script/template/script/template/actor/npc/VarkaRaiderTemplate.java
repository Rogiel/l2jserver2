 ...
 */
public class VarkaRaiderTemplate extends NPCTemplate {
	public static final int ID = 31712;

	@Inject
	protected VarkaRaiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Varka Raider";
