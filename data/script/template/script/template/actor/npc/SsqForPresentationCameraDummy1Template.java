 ...
 */
public class SsqForPresentationCameraDummy1Template extends NPCTemplate {
	public static final int ID = 18830;

	@Inject
	protected SsqForPresentationCameraDummy1Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "ssq For Presentation Camera Dummy 1";
