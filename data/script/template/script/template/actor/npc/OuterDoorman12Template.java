 ...
 */
public class OuterDoorman12Template extends NPCTemplate {
	public static final int ID = 35625;

	@Inject
	protected OuterDoorman12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
