 ...
 */
public class KarakaweiTemplate extends NPCTemplate {
	public static final int ID = 32117;

	@Inject
	protected KarakaweiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
