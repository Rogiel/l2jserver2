 ...
 */
public class DelusionManager3Template extends NPCTemplate {
	public static final int ID = 32666;

	@Inject
	protected DelusionManager3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
