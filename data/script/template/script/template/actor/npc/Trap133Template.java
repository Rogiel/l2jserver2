 ...
 */
public class Trap133Template extends NPCTemplate {
	public static final int ID = 18434;

	@Inject
	protected Trap133Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
