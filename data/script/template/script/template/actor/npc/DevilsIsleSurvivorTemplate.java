 ...
 */
public class DevilsIsleSurvivorTemplate extends NPCTemplate {
	public static final int ID = 32498;

	@Inject
	protected DevilsIsleSurvivorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Devil's Isle Survivor";
