 ...
 */
public class DarknessOfDawnTemplate extends NPCTemplate {
	public static final int ID = 32579;

	@Inject
	protected DarknessOfDawnTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Darkness of Dawn";
