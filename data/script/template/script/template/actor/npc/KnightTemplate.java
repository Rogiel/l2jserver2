 ...
 */
public class KnightTemplate extends NPCTemplate {
	public static final int ID = 16062;

	@Inject
	protected KnightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Knight";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 4.50;
