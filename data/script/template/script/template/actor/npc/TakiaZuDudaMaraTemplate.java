 ...
 */
public class TakiaZuDudaMaraTemplate extends NPCTemplate {
	public static final int ID = 30588;

	@Inject
	protected TakiaZuDudaMaraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Takia Zu Duda-Mara";
