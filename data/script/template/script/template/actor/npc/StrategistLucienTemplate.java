 ...
 */
public class StrategistLucienTemplate extends NPCTemplate {
	public static final int ID = 32130;

	@Inject
	protected StrategistLucienTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Strategist Lucien";
