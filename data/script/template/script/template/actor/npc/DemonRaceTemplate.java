 ...
 */
public class DemonRaceTemplate extends NPCTemplate {
	public static final int ID = 13154;

	@Inject
	protected DemonRaceTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Demon Race";
