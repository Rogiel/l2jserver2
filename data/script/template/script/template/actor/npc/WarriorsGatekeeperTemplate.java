 ...
 */
public class WarriorsGatekeeperTemplate extends NPCTemplate {
	public static final int ID = 18414;

	@Inject
	protected WarriorsGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Warrior's Gatekeeper";
