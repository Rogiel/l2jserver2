 ...
 */
public class ExarionTemplate extends NPCTemplate {
	public static final int ID = 30748;

	@Inject
	protected ExarionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
