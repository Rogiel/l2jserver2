 ...
 */
public class AetonicTemplate extends KamaelVillageMasterNPCTemplate {
	public static final int ID = 32205;

	@Inject
	protected AetonicTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
