 ...
 */
public class PiecheTemplate extends KamaelVillageMasterNPCTemplate {
	public static final int ID = 32206;

	@Inject
	protected PiecheTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
