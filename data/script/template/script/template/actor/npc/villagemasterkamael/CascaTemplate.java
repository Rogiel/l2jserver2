 ...
 */
public class CascaTemplate extends KamaelVillageMasterNPCTemplate {
	public static final int ID = 32139;

	@Inject
	protected CascaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
