 ...
 */
public class HolstTemplate extends KamaelVillageMasterNPCTemplate {
	public static final int ID = 32199;

	@Inject
	protected HolstTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
