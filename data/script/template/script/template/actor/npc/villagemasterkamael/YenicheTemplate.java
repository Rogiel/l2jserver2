 ...
 */
public class YenicheTemplate extends KamaelVillageMasterNPCTemplate {
	public static final int ID = 32193;

	@Inject
	protected YenicheTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
