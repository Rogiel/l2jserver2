 ...
 */
public class TaineTemplate extends KamaelVillageMasterNPCTemplate {
	public static final int ID = 32225;

	@Inject
	protected TaineTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
