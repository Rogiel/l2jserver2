 ...
 */
public class GershwinTemplate extends KamaelVillageMasterNPCTemplate {
	public static final int ID = 32196;

	@Inject
	protected GershwinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
