 ...
 */
public class MaynardTemplate extends KamaelVillageMasterNPCTemplate {
	public static final int ID = 32145;

	@Inject
	protected MaynardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
