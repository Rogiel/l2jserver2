 ...
 */
public class CeciTemplate extends KamaelVillageMasterNPCTemplate {
	public static final int ID = 32230;

	@Inject
	protected CeciTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
