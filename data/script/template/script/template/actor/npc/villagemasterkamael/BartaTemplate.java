 ...
 */
public class BartaTemplate extends KamaelVillageMasterNPCTemplate {
	public static final int ID = 32217;

	@Inject
	protected BartaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
