 ...
 */
public class LianeTemplate extends KamaelVillageMasterNPCTemplate {
	public static final int ID = 32222;

	@Inject
	protected LianeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
