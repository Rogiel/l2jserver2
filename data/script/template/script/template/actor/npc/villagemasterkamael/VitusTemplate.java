 ...
 */
public class VitusTemplate extends KamaelVillageMasterNPCTemplate {
	public static final int ID = 32213;

	@Inject
	protected VitusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
