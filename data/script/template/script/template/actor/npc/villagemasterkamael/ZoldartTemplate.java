 ...
 */
public class ZoldartTemplate extends KamaelVillageMasterNPCTemplate {
	public static final int ID = 32233;

	@Inject
	protected ZoldartTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
