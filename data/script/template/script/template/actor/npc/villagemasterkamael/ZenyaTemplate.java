 ...
 */
public class ZenyaTemplate extends KamaelVillageMasterNPCTemplate {
	public static final int ID = 32140;

	@Inject
	protected ZenyaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Zenya";
		this.serverSideName = false;
		this.title = "Vice Hierarch";
