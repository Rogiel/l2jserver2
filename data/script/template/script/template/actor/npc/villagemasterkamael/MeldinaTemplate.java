 ...
 */
public class MeldinaTemplate extends KamaelVillageMasterNPCTemplate {
	public static final int ID = 32214;

	@Inject
	protected MeldinaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
