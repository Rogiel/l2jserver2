 ...
 */
public class HagelTemplate extends KamaelVillageMasterNPCTemplate {
	public static final int ID = 32229;

	@Inject
	protected HagelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
