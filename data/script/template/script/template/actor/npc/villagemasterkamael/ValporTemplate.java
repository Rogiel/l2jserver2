 ...
 */
public class ValporTemplate extends KamaelVillageMasterNPCTemplate {
	public static final int ID = 32146;

	@Inject
	protected ValporTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
