 ...
 */
public class BromeTemplate extends KamaelVillageMasterNPCTemplate {
	public static final int ID = 32221;

	@Inject
	protected BromeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
