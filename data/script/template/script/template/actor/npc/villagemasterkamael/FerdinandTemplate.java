 ...
 */
public class FerdinandTemplate extends KamaelVillageMasterNPCTemplate {
	public static final int ID = 32209;

	@Inject
	protected FerdinandTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.rightHand = itemProvider.createID(9645);
		this.leftHand = null;
		this.enchantLevel = 0;
