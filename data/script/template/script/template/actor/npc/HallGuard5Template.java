 ...
 */
public class HallGuard5Template extends NPCTemplate {
	public static final int ID = 18475;

	@Inject
	protected HallGuard5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
