 ...
 */
public class PumpkinGhostTemplate extends NPCTemplate {
	public static final int ID = 13135;

	@Inject
	protected PumpkinGhostTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Pumpkin Ghost";
