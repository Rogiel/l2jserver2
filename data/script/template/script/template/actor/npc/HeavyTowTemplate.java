 ...
 */
public class HeavyTowTemplate extends NPCTemplate {
	public static final int ID = 13165;

	@Inject
	protected HeavyTowTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Heavy Tow";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 4.40;
		this.collisionHeight = 8.25;
		this.level = 55;
		...
		attributes.walkSpeed = 165.00000;
