 ...
 */
public class ExplosiveSpiritOfFireTemplate extends NPCTemplate {
	public static final int ID = 9;

	@Inject
	protected ExplosiveSpiritOfFireTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Explosive Spirit of Fire";
