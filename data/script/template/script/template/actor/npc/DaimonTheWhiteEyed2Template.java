 ...
 */
public class DaimonTheWhiteEyed2Template extends NPCTemplate {
	public static final int ID = 31705;

	@Inject
	protected DaimonTheWhiteEyed2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
