 ...
 */
public class WellTemplate extends NPCTemplate {
	public static final int ID = 31527;

	@Inject
	protected WellTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
