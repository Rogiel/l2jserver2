 ...
 */
public class DelusionManager36Template extends NPCTemplate {
	public static final int ID = 32699;

	@Inject
	protected DelusionManager36Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
