 ...
 */
public class KatensaTemplate extends NPCTemplate {
	public static final int ID = 32646;

	@Inject
	protected KatensaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
