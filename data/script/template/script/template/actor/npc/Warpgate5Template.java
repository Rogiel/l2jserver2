 ...
 */
public class Warpgate5Template extends NPCTemplate {
	public static final int ID = 32318;

	@Inject
	protected Warpgate5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
