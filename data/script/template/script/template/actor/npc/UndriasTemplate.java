 ...
 */
public class UndriasTemplate extends NPCTemplate {
	public static final int ID = 30130;

	@Inject
	protected UndriasTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
