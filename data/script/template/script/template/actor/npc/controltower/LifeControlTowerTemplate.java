 ...
 */
public class LifeControlTowerTemplate extends ControlTowerNPCTemplate {
	public static final int ID = 13002;

	@Inject
	protected LifeControlTowerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
