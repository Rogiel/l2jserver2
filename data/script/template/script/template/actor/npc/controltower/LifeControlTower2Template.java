 ...
 */
package script.template.actor.npc.controltower;

import com.google.inject.Inject;
import com.l2jserver.model.id.template.provider.ItemTemplateIDProvider;
import com.l2jserver.model.id.template.provider.NPCTemplateIDProvider;
import com.l2jserver.model.template.npc.ControlTowerNPCTemplate;

/**
 * @author <a href="http://www.rogiel.com">Rogiel</a>
 */
public class LifeControlTower2Template extends ControlTowerNPCTemplate {
	public static final int ID = 13003;

	@Inject
	protected LifeControlTower2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Life Control Tower";
