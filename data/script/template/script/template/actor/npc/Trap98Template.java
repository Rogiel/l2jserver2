 ...
 */
public class Trap98Template extends NPCTemplate {
	public static final int ID = 18383;

	@Inject
	protected Trap98Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
