 ...
 */
public class CleoTemplate extends NPCTemplate {
	public static final int ID = 30766;

	@Inject
	protected CleoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
