 ...
 */
public class Trap5Template extends NPCTemplate {
	public static final int ID = 13041;

	@Inject
	protected Trap5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
