 ...
 */
public class FlauronTemplate extends NPCTemplate {
	public static final int ID = 32010;

	@Inject
	protected FlauronTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
