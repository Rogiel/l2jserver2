 ...
 */
public class Yeti2Template extends NPCTemplate {
	public static final int ID = 13134;

	@Inject
	protected Yeti2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
