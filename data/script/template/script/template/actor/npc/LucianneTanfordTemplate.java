 ...
 */
public class LucianneTanfordTemplate extends NPCTemplate {
	public static final int ID = 30946;

	@Inject
	protected LucianneTanfordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lucianne Tanford";
