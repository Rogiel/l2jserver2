 ...
 */
public class JiniaTemplate extends NPCTemplate {
	public static final int ID = 18850;

	@Inject
	protected JiniaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
