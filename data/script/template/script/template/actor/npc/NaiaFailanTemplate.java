 ...
 */
public class NaiaFailanTemplate extends NPCTemplate {
	public static final int ID = 18484;

	@Inject
	protected NaiaFailanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Naia Failan";
