 ...
 */
public class GroupGatekeeper7Template extends NPCTemplate {
	public static final int ID = 35616;

	@Inject
	protected GroupGatekeeper7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
