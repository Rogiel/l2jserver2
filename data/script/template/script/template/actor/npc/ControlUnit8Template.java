 ...
 */
public class ControlUnit8Template extends NPCTemplate {
	public static final int ID = 36192;

	@Inject
	protected ControlUnit8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
