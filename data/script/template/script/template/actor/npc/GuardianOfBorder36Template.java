 ...
 */
public class GuardianOfBorder36Template extends NPCTemplate {
	public static final int ID = 31900;

	@Inject
	protected GuardianOfBorder36Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
