 ...
 */
public class DaewoonsoAgathionTemplate extends NPCTemplate {
	public static final int ID = 1526;

	@Inject
	protected DaewoonsoAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Daewoonso Agathion";
