 ...
 */
public class CybellinTemplate extends NPCTemplate {
	public static final int ID = 30746;

	@Inject
	protected CybellinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
