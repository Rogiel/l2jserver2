 ...
 */
public class MushikaTemplate extends NPCTemplate {
	public static final int ID = 32114;

	@Inject
	protected MushikaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
