 ...
 */
public class TorukuTemplate extends NPCTemplate {
	public static final int ID = 30591;

	@Inject
	protected TorukuTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
