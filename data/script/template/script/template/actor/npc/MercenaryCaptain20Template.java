 ...
 */
public class MercenaryCaptain20Template extends NPCTemplate {
	public static final int ID = 36352;

	@Inject
	protected MercenaryCaptain20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
