 ...
 */
public class MonsterRaceGuide2Template extends NPCTemplate {
	public static final int ID = 31405;

	@Inject
	protected MonsterRaceGuide2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Monster Race Guide";
		this.serverSideName = false;
		this.title = "Town of Dion";
