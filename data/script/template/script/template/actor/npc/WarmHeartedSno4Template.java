 ...
 */
public class WarmHeartedSno4Template extends NPCTemplate {
	public static final int ID = 16;

	@Inject
	protected WarmHeartedSno4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
