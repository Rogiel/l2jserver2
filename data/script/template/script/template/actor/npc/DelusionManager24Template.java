 ...
 */
public class DelusionManager24Template extends NPCTemplate {
	public static final int ID = 32687;

	@Inject
	protected DelusionManager24Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
