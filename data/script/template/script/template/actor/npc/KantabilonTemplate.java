 ...
 */
public class KantabilonTemplate extends NPCTemplate {
	public static final int ID = 31042;

	@Inject
	protected KantabilonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kantabilon";
		this.serverSideName = false;
		this.title = "Melody Maestro";
