 ...
 */
public class DestroyedTumor4Template extends NPCTemplate {
	public static final int ID = 32536;

	@Inject
	protected DestroyedTumor4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
