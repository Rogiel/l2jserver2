 ...
 */
public class FensterTemplate extends NPCTemplate {
	public static final int ID = 30928;

	@Inject
	protected FensterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
