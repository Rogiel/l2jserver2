 ...
 */
public class TullysGatekeeper17Template extends NPCTemplate {
	public static final int ID = 18461;

	@Inject
	protected TullysGatekeeper17Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
