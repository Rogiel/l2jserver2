 ...
 */
public class PreacherOfDoom41Template extends NPCTemplate {
	public static final int ID = 31999;

	@Inject
	protected PreacherOfDoom41Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
