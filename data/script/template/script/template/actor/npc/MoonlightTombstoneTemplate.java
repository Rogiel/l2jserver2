 ...
 */
public class MoonlightTombstoneTemplate extends NPCTemplate {
	public static final int ID = 32343;

	@Inject
	protected MoonlightTombstoneTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Moonlight Tombstone";
