 ...
 */
public class KurfaGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 31376;

	@Inject
	protected KurfaGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
