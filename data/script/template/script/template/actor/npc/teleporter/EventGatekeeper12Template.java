 ...
 */
public class EventGatekeeper12Template extends TeleporterNPCTemplate {
	public static final int ID = 31223;

	@Inject
	protected EventGatekeeper12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
