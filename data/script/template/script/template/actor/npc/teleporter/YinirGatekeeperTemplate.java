 ...
 */
public class YinirGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 32184;

	@Inject
	protected YinirGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
