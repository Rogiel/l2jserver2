 ...
 */
public class TeleportationCubicTemplate extends TeleporterNPCTemplate {
	public static final int ID = 29055;

	@Inject
	protected TeleportationCubicTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
