 ...
 */
public class TiramisaGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 30429;

	@Inject
	protected TiramisaGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
