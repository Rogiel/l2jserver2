 ...
 */
public class KarinGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 30162;

	@Inject
	protected KarinGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
