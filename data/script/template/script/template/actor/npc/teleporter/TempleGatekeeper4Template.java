 ...
 */
public class TempleGatekeeper4Template extends TeleporterNPCTemplate {
	public static final int ID = 32037;

	@Inject
	protected TempleGatekeeper4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
