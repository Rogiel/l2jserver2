 ...
 */
public class EventGatekeeper4Template extends TeleporterNPCTemplate {
	public static final int ID = 31215;

	@Inject
	protected EventGatekeeper4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
