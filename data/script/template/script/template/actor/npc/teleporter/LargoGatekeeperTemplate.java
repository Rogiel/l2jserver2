 ...
 */
public class LargoGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 32189;

	@Inject
	protected LargoGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
