 ...
 */
public class WirphyGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 30540;

	@Inject
	protected WirphyGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
