 ...
 */
public class MassGatekeeper11Template extends TeleporterNPCTemplate {
	public static final int ID = 35563;

	@Inject
	protected MassGatekeeper11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
