 ...
 */
public class RaceTrackGuideTemplate extends TeleporterNPCTemplate {
	public static final int ID = 31211;

	@Inject
	protected RaceTrackGuideTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Race Track Guide";
