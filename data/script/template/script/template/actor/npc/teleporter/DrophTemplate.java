 ...
 */
public class DrophTemplate extends TeleporterNPCTemplate {
	public static final int ID = 32711;

	@Inject
	protected DrophTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Droph";
		this.serverSideName = false;
		this.title = "Dwarf Adventurer";
