 ...
 */
public class CapellaGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 30485;

	@Inject
	protected CapellaGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
