 ...
 */
public class TriolsMirrorTemplate extends TeleporterNPCTemplate {
	public static final int ID = 32039;

	@Inject
	protected TriolsMirrorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
