 ...
 */
public class YungGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 32186;

	@Inject
	protected YungGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
