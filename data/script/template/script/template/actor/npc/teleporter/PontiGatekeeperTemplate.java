 ...
 */
public class PontiGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 30484;

	@Inject
	protected PontiGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
