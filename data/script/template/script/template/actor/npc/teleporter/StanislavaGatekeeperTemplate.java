 ...
 */
public class StanislavaGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 31699;

	@Inject
	protected StanislavaGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Stanislava";
