 ...
 */
public class TriolsMirror2Template extends TeleporterNPCTemplate {
	public static final int ID = 32040;

	@Inject
	protected TriolsMirror2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Triol's Mirror";
