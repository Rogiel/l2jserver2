 ...
 */
public class EventGatekeeper10Template extends TeleporterNPCTemplate {
	public static final int ID = 31221;

	@Inject
	protected EventGatekeeper10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
