 ...
 */
public class EventGatekeeper11Template extends TeleporterNPCTemplate {
	public static final int ID = 31222;

	@Inject
	protected EventGatekeeper11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
