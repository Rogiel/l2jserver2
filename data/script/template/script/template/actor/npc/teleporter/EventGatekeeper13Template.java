 ...
 */
public class EventGatekeeper13Template extends TeleporterNPCTemplate {
	public static final int ID = 31224;

	@Inject
	protected EventGatekeeper13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Event Gatekeeper";
