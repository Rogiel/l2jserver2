 ...
 */
public class EventGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 31212;

	@Inject
	protected EventGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
