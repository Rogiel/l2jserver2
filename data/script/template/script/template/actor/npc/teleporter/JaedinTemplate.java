 ...
 */
public class JaedinTemplate extends TeleporterNPCTemplate {
	public static final int ID = 32534;

	@Inject
	protected JaedinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Jaedin";
		this.serverSideName = false;
		this.title = "Guide of Infinity";
