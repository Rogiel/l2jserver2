 ...
 */
public class ArishaGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 31698;

	@Inject
	protected ArishaGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
