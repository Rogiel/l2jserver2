 ...
 */
public class Lionel2Template extends TeleporterNPCTemplate {
	public static final int ID = 32782;

	@Inject
	protected Lionel2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
