 ...
 */
public class HannaGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 30486;

	@Inject
	protected HannaGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
