 ...
 */
public class AsherGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 32714;

	@Inject
	protected AsherGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
