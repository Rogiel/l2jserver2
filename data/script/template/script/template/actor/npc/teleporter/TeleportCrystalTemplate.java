 ...
 */
public class TeleportCrystalTemplate extends TeleporterNPCTemplate {
	public static final int ID = 32652;

	@Inject
	protected TeleportCrystalTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Teleport Crystal";
