 ...
 */
public class PenelopeGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 30487;

	@Inject
	protected PenelopeGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
