 ...
 */
public class Somulitan2Template extends TeleporterNPCTemplate {
	public static final int ID = 32712;

	@Inject
	protected Somulitan2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Somulitan";
		this.serverSideName = false;
		this.title = "Zaken Researcher";
