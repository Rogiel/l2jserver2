 ...
 */
public class AngelinaGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 30878;

	@Inject
	protected AngelinaGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
