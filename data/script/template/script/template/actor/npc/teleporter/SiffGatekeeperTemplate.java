 ...
 */
public class SiffGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 30427;

	@Inject
	protected SiffGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
