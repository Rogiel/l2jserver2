 ...
 */
public class VeronaGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 30727;

	@Inject
	protected VeronaGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
