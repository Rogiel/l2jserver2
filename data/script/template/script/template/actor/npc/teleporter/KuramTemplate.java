 ...
 */
public class KuramTemplate extends TeleporterNPCTemplate {
	public static final int ID = 32377;

	@Inject
	protected KuramTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
