 ...
 */
public class EventGatekeeper8Template extends TeleporterNPCTemplate {
	public static final int ID = 31219;

	@Inject
	protected EventGatekeeper8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
