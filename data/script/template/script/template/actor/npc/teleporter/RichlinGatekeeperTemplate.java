 ...
 */
public class RichlinGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 30320;

	@Inject
	protected RichlinGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
