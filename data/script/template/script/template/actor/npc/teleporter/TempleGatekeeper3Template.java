 ...
 */
public class TempleGatekeeper3Template extends TeleporterNPCTemplate {
	public static final int ID = 32036;

	@Inject
	protected TempleGatekeeper3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Temple Gatekeeper";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 80.00;
		this.collisionHeight = 203.50;
		this.level = 70;
		this.sex = null;
		this.attackRange = 40;
