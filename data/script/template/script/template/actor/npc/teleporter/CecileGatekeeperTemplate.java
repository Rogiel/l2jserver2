 ...
 */
public class CecileGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 30716;

	@Inject
	protected CecileGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
