 ...
 */
public class FlauenGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 30899;

	@Inject
	protected FlauenGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
