 ...
 */
public class LamcedasGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 32614;

	@Inject
	protected LamcedasGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
