 ...
 */
public class MariellGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 30719;

	@Inject
	protected MariellGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
