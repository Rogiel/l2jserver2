 ...
 */
public class EventGatekeeper7Template extends TeleporterNPCTemplate {
	public static final int ID = 31218;

	@Inject
	protected EventGatekeeper7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
