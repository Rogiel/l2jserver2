 ...
 */
public class ValentinaGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 30177;

	@Inject
	protected ValentinaGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
