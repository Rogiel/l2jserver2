 ...
 */
public class MassGatekeeper10Template extends TeleporterNPCTemplate {
	public static final int ID = 35562;

	@Inject
	protected MassGatekeeper10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
