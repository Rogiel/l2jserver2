 ...
 */
public class TatianaGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 31275;

	@Inject
	protected TatianaGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
