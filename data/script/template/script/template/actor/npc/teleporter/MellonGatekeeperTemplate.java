 ...
 */
public class MellonGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 32181;

	@Inject
	protected MellonGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
