 ...
 */
public class TempleGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 32034;

	@Inject
	protected TempleGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
