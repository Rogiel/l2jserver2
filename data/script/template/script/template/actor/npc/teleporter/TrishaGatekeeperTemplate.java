 ...
 */
public class TrishaGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 30059;

	@Inject
	protected TrishaGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
