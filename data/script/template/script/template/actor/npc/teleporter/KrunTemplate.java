 ...
 */
public class KrunTemplate extends TeleporterNPCTemplate {
	public static final int ID = 32653;

	@Inject
	protected KrunTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
