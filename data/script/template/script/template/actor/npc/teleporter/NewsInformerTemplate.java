 ...
 */
public class NewsInformerTemplate extends TeleporterNPCTemplate {
	public static final int ID = 32648;

	@Inject
	protected NewsInformerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "News Informer";
