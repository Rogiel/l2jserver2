 ...
 */
public class EnceinteInsurgentTemplate extends TeleporterNPCTemplate {
	public static final int ID = 32351;

	@Inject
	protected EnceinteInsurgentTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Enceinte Insurgent";
