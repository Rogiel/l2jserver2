 ...
 */
public class TeleportationCubic2Template extends TeleporterNPCTemplate {
	public static final int ID = 29061;

	@Inject
	protected TeleportationCubic2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
