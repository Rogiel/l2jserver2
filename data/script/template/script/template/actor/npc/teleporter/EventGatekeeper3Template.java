 ...
 */
public class EventGatekeeper3Template extends TeleporterNPCTemplate {
	public static final int ID = 31214;

	@Inject
	protected EventGatekeeper3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
