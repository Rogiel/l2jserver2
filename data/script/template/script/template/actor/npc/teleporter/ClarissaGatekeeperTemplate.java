 ...
 */
public class ClarissaGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 30080;

	@Inject
	protected ClarissaGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
