 ...
 */
public class EventGatekeeper9Template extends TeleporterNPCTemplate {
	public static final int ID = 31220;

	@Inject
	protected EventGatekeeper9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
