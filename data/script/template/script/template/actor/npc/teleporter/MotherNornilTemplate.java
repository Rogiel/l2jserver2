 ...
 */
public class MotherNornilTemplate extends TeleporterNPCTemplate {
	public static final int ID = 32239;

	@Inject
	protected MotherNornilTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mother Nornil";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 50.00;
		this.collisionHeight = 253.00;
		this.level = 70;
