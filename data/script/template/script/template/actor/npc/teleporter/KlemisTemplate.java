 ...
 */
public class KlemisTemplate extends TeleporterNPCTemplate {
	public static final int ID = 32734;

	@Inject
	protected KlemisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
