 ...
 */
public class MozellaGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 30483;

	@Inject
	protected MozellaGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
