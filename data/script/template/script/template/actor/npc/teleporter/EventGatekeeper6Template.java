 ...
 */
public class EventGatekeeper6Template extends TeleporterNPCTemplate {
	public static final int ID = 31217;

	@Inject
	protected EventGatekeeper6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
