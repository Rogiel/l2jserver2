 ...
 */
public class IlyanaGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 31320;

	@Inject
	protected IlyanaGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
