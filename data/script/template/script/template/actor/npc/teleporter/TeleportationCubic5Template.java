 ...
 */
public class TeleportationCubic5Template extends TeleporterNPCTemplate {
	public static final int ID = 31843;

	@Inject
	protected TeleportationCubic5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
