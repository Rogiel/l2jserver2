 ...
 */
public class BellaGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 30256;

	@Inject
	protected BellaGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
