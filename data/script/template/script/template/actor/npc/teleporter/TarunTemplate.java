 ...
 */
public class TarunTemplate extends TeleporterNPCTemplate {
	public static final int ID = 32654;

	@Inject
	protected TarunTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
