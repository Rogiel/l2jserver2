 ...
 */
public class SoblingTemplate extends TeleporterNPCTemplate {
	public static final int ID = 31147;

	@Inject
	protected SoblingTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sobling";
		this.serverSideName = false;
		this.title = "Head Researcher";
