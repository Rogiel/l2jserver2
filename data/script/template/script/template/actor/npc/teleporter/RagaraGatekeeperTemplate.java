 ...
 */
public class RagaraGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 32163;

	@Inject
	protected RagaraGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
