 ...
 */
public class FantasyIslePaddiesGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 32378;

	@Inject
	protected FantasyIslePaddiesGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fantasy Isle Paddies";
