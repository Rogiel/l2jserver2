 ...
 */
public class TeleportationCubic4Template extends TeleporterNPCTemplate {
	public static final int ID = 31842;

	@Inject
	protected TeleportationCubic4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Teleportation Cubic";
