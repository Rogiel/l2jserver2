 ...
 */
public class EsmeraldaGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 30233;

	@Inject
	protected EsmeraldaGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
