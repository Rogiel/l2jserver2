 ...
 */
public class ChandraTemplate extends TeleporterNPCTemplate {
	public static final int ID = 32645;

	@Inject
	protected ChandraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Chandra";
		this.serverSideName = false;
		this.title = "Transport Post";
