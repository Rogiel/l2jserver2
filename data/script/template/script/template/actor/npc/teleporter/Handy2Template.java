 ...
 */
public class Handy2Template extends TeleporterNPCTemplate {
	public static final int ID = 32613;

	@Inject
	protected Handy2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Handy";
		this.serverSideName = false;
		this.title = "Game Manager";
