 ...
 */
public class DwyphTemplate extends TeleporterNPCTemplate {
	public static final int ID = 32649;

	@Inject
	protected DwyphTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
