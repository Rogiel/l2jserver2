 ...
 */
public class MassGatekeeper9Template extends TeleporterNPCTemplate {
	public static final int ID = 35561;

	@Inject
	protected MassGatekeeper9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
