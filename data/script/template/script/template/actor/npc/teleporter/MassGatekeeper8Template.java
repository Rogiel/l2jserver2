 ...
 */
public class MassGatekeeper8Template extends TeleporterNPCTemplate {
	public static final int ID = 35560;

	@Inject
	protected MassGatekeeper8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
