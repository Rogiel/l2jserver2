 ...
 */
public class EventGatekeeper5Template extends TeleporterNPCTemplate {
	public static final int ID = 31216;

	@Inject
	protected EventGatekeeper5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
