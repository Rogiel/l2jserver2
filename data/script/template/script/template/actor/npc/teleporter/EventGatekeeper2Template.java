 ...
 */
public class EventGatekeeper2Template extends TeleporterNPCTemplate {
	public static final int ID = 31213;

	@Inject
	protected EventGatekeeper2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
