 ...
 */
public class TeranuMarduiGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 31383;

	@Inject
	protected TeranuMarduiGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Teranu Mardui";
