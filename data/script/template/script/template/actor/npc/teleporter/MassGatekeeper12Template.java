 ...
 */
public class MassGatekeeper12Template extends TeleporterNPCTemplate {
	public static final int ID = 35564;

	@Inject
	protected MassGatekeeper12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
