 ...
 */
public class EmeryCompressorTemplate extends TeleporterNPCTemplate {
	public static final int ID = 36570;

	@Inject
	protected EmeryCompressorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Emery Compressor";
		this.serverSideName = false;
		this.title = "Aerial Cleft";
		this.serverSideTitle = false;
		this.collisionRadius = 62.00;
