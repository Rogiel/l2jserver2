 ...
 */
public class MinervaGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 30836;

	@Inject
	protected MinervaGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
