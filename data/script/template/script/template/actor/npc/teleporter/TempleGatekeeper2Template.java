 ...
 */
public class TempleGatekeeper2Template extends TeleporterNPCTemplate {
	public static final int ID = 32035;

	@Inject
	protected TempleGatekeeper2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
