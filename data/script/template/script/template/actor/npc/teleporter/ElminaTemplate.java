 ...
 */
public class ElminaTemplate extends TeleporterNPCTemplate {
	public static final int ID = 32774;

	@Inject
	protected ElminaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
