 ...
 */
public class GatekeeperOfAbyssTemplate extends TeleporterNPCTemplate {
	public static final int ID = 32539;

	@Inject
	protected GatekeeperOfAbyssTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gatekeeper of Abyss";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 70.00;
		this.collisionHeight = 119.00;
		this.level = 70;
