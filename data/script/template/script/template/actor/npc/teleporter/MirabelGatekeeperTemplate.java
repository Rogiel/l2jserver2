 ...
 */
public class MirabelGatekeeperTemplate extends TeleporterNPCTemplate {
	public static final int ID = 30146;

	@Inject
	protected MirabelGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
