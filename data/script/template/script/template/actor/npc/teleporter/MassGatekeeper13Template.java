 ...
 */
public class MassGatekeeper13Template extends TeleporterNPCTemplate {
	public static final int ID = 35565;

	@Inject
	protected MassGatekeeper13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
