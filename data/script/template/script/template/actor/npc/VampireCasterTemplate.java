 ...
 */
public class VampireCasterTemplate extends NPCTemplate {
	public static final int ID = 35634;

	@Inject
	protected VampireCasterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.maxHP = 8029.975620000000000;
		...
		attributes.physicalAttack = 3526.34866;
