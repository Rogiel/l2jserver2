 ...
 */
public class Trap176Template extends NPCTemplate {
	public static final int ID = 18753;

	@Inject
	protected Trap176Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
