 ...
 */
public class Trap85Template extends NPCTemplate {
	public static final int ID = 13249;

	@Inject
	protected Trap85Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
