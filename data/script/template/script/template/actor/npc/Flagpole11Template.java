 ...
 */
public class Flagpole11Template extends NPCTemplate {
	public static final int ID = 36002;

	@Inject
	protected Flagpole11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
