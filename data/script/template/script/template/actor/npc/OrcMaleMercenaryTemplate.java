 ...
 */
public class OrcMaleMercenaryTemplate extends NPCTemplate {
	public static final int ID = 13172;

	@Inject
	protected OrcMaleMercenaryTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Orc Male Mercenary";
