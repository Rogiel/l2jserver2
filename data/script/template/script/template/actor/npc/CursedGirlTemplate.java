 ...
 */
public class CursedGirlTemplate extends NPCTemplate {
	public static final int ID = 18580;

	@Inject
	protected CursedGirlTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
