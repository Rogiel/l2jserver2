 ...
 */
public class MorelynTemplate extends NPCTemplate {
	public static final int ID = 30925;

	@Inject
	protected MorelynTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
