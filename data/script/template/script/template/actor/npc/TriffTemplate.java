 ...
 */
public class TriffTemplate extends NPCTemplate {
	public static final int ID = 30611;

	@Inject
	protected TriffTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
