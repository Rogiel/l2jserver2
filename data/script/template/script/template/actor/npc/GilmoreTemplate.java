 ...
 */
public class GilmoreTemplate extends NPCTemplate {
	public static final int ID = 30754;

	@Inject
	protected GilmoreTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
