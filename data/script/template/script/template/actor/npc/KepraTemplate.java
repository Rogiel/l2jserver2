 ...
 */
public class KepraTemplate extends NPCTemplate {
	public static final int ID = 30616;

	@Inject
	protected KepraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kepra";
		this.serverSideName = false;
		this.title = "Enku Chief";
