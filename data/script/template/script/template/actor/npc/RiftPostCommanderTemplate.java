 ...
 */
public class RiftPostCommanderTemplate extends NPCTemplate {
	public static final int ID = 31492;

	@Inject
	protected RiftPostCommanderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rift Post Commander";
		...
		this.leftHand = itemProvider.createID(655);
		this.enchantLevel = 0;
