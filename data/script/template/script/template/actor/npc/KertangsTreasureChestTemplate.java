 ...
 */
public class KertangsTreasureChestTemplate extends NPCTemplate {
	public static final int ID = 18534;

	@Inject
	protected KertangsTreasureChestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
