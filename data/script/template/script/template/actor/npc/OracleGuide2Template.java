 ...
 */
public class OracleGuide2Template extends NPCTemplate {
	public static final int ID = 32274;

	@Inject
	protected OracleGuide2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
