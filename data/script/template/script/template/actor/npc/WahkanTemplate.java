 ...
 */
public class WahkanTemplate extends NPCTemplate {
	public static final int ID = 31371;

	@Inject
	protected WahkanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Wahkan";
		this.serverSideName = false;
		this.title = "Ketra's Messenger";
