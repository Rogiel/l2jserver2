 ...
 */
public class CorpseOfAngelTemplate extends NPCTemplate {
	public static final int ID = 31752;

	@Inject
	protected CorpseOfAngelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Corpse of Angel";
