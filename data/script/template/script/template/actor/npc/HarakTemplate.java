 ...
 */
public class HarakTemplate extends NPCTemplate {
	public static final int ID = 30618;

	@Inject
	protected HarakTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Harak";
		this.serverSideName = false;
		this.title = "Leunt Chief";
