 ...
 */
public class Trap42Template extends NPCTemplate {
	public static final int ID = 13206;

	@Inject
	protected Trap42Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
