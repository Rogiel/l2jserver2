 ...
 */
public class CursedGardenerTemplate extends NPCTemplate {
	public static final int ID = 18589;

	@Inject
	protected CursedGardenerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
