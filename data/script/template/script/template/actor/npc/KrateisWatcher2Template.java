 ...
 */
public class KrateisWatcher2Template extends NPCTemplate {
	public static final int ID = 18602;

	@Inject
	protected KrateisWatcher2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kratei's Watcher";
