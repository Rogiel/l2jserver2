 ...
 */
public class Antharas2Template extends GrandBossNPCTemplate {
	public static final int ID = 29066;

	@Inject
	protected Antharas2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 6100000.000000000000000;
