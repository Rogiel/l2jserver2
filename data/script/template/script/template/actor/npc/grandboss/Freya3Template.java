 ...
 */
public class Freya3Template extends GrandBossNPCTemplate {
	public static final int ID = 29177;

	@Inject
	protected Freya3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
