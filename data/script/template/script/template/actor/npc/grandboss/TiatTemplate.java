 ...
 */
public class TiatTemplate extends GrandBossNPCTemplate {
	public static final int ID = 29163;

	@Inject
	protected TiatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
