 ...
 */
public class CoreTemplate extends GrandBossNPCTemplate {
	public static final int ID = 29006;

	@Inject
	protected CoreTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Core";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 140.00;
