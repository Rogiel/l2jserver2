 ...
 */
public class TangTangAgathionTemplate extends NPCTemplate {
	public static final int ID = 1530;

	@Inject
	protected TangTangAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tang-tang Agathion";
