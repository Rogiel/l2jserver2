 ...
 */
public class Trap57Template extends NPCTemplate {
	public static final int ID = 13221;

	@Inject
	protected Trap57Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
