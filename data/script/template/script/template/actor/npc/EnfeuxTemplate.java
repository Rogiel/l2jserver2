 ...
 */
public class EnfeuxTemplate extends NPCTemplate {
	public static final int ID = 31519;

	@Inject
	protected EnfeuxTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
