 ...
 */
public class SerianTemplate extends NPCTemplate {
	public static final int ID = 32247;

	@Inject
	protected SerianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
