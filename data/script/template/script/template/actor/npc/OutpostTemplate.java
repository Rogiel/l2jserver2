 ...
 */
public class OutpostTemplate extends NPCTemplate {
	public static final int ID = 36590;

	@Inject
	protected OutpostTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
