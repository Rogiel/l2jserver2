 ...
 */
public class KeucereusTemplate extends NPCTemplate {
	public static final int ID = 32548;

	@Inject
	protected KeucereusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
