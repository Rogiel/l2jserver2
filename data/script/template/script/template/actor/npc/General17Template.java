 ...
 */
public class General17Template extends NPCTemplate {
	public static final int ID = 36214;

	@Inject
	protected General17Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
