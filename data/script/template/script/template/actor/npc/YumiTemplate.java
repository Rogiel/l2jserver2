 ...
 */
public class YumiTemplate extends NPCTemplate {
	public static final int ID = 32041;

	@Inject
	protected YumiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
