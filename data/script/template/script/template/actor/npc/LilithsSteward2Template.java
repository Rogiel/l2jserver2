 ...
 */
public class LilithsSteward2Template extends NPCTemplate {
	public static final int ID = 32716;

	@Inject
	protected LilithsSteward2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
