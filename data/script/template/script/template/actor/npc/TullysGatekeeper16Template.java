 ...
 */
public class TullysGatekeeper16Template extends NPCTemplate {
	public static final int ID = 18460;

	@Inject
	protected TullysGatekeeper16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
