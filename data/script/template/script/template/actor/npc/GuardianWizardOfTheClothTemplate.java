 ...
 */
public class GuardianWizardOfTheClothTemplate extends NPCTemplate {
	public static final int ID = 32128;

	@Inject
	protected GuardianWizardOfTheClothTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guardian Wizard of the Cloth";
		...
		this.rightHand = itemProvider.createID(4900);
		this.leftHand = null;
		this.enchantLevel = 0;
