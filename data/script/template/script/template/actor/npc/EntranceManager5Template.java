 ...
 */
public class EntranceManager5Template extends NPCTemplate {
	public static final int ID = 32524;

	@Inject
	protected EntranceManager5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Entrance Manager";
		this.serverSideName = false;
		this.title = "Handy's Block Checker - Arena 4";
