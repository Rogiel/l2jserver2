 ...
 */
public class HolyArkOfSecrecy1Template extends NPCTemplate {
	public static final int ID = 30977;

	@Inject
	protected HolyArkOfSecrecy1Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Holy Ark of Secrecy 1";
