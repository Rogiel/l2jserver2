 ...
 */
public class MonsterRaceGuide6Template extends NPCTemplate {
	public static final int ID = 31409;

	@Inject
	protected MonsterRaceGuide6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Monster Race Guide";
		this.serverSideName = false;
		this.title = "Hunters Village";
