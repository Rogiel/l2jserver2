 ...
 */
public class PathfinderWorkerTemplate extends NPCTemplate {
	public static final int ID = 32484;

	@Inject
	protected PathfinderWorkerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
