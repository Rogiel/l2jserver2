 ...
 */
public class TimitranTemplate extends NPCTemplate {
	public static final int ID = 13132;

	@Inject
	protected TimitranTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
