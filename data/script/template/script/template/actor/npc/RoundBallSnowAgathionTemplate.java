 ...
 */
public class RoundBallSnowAgathionTemplate extends NPCTemplate {
	public static final int ID = 1558;

	@Inject
	protected RoundBallSnowAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Round Ball Snow Agathion";
