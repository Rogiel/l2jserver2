 ...
 */
public class AlpineKookaburra6Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21456;

	@Inject
	protected AlpineKookaburra6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
