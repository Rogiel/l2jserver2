 ...
 */
public class AlpineKookaburra2Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21452;

	@Inject
	protected AlpineKookaburra2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
