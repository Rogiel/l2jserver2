 ...
 */
public class AlpineCougar9Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21497;

	@Inject
	protected AlpineCougar9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
