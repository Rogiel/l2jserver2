 ...
 */
public class YoungGrendelTemplate extends FeedableBeastNPCTemplate {
	public static final int ID = 18895;

	@Inject
	protected YoungGrendelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
