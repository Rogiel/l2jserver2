 ...
 */
public class AlpineBuffalo20Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21826;

	@Inject
	protected AlpineBuffalo20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
