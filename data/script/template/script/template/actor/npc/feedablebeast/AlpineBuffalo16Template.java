 ...
 */
public class AlpineBuffalo16Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21485;

	@Inject
	protected AlpineBuffalo16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
