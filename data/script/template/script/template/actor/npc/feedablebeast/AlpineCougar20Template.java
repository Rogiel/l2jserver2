 ...
 */
public class AlpineCougar20Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21828;

	@Inject
	protected AlpineCougar20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
