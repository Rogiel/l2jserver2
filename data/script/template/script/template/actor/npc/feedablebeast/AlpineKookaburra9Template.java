 ...
 */
public class AlpineKookaburra9Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21459;

	@Inject
	protected AlpineKookaburra9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
