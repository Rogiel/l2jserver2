 ...
 */
public class BabyAlpineCougarTemplate extends FeedableBeastNPCTemplate {
	public static final int ID = 18880;

	@Inject
	protected BabyAlpineCougarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Baby Alpine Cougar";
