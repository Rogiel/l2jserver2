 ...
 */
public class YoungCougar2Template extends FeedableBeastNPCTemplate {
	public static final int ID = 18882;

	@Inject
	protected YoungCougar2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Young Cougar";
