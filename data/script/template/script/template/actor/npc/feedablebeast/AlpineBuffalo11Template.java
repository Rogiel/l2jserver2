 ...
 */
public class AlpineBuffalo11Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21480;

	@Inject
	protected AlpineBuffalo11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
