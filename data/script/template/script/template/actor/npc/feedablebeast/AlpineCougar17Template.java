 ...
 */
public class AlpineCougar17Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21505;

	@Inject
	protected AlpineCougar17Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
