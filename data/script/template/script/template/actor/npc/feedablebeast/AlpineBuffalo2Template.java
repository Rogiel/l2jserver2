 ...
 */
public class AlpineBuffalo2Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21471;

	@Inject
	protected AlpineBuffalo2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
