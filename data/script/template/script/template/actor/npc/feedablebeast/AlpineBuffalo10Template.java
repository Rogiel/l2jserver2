 ...
 */
public class AlpineBuffalo10Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21479;

	@Inject
	protected AlpineBuffalo10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
