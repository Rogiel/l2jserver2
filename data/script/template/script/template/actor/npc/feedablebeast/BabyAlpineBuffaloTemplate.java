 ...
 */
public class BabyAlpineBuffaloTemplate extends FeedableBeastNPCTemplate {
	public static final int ID = 18887;

	@Inject
	protected BabyAlpineBuffaloTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Baby Alpine Buffalo";
