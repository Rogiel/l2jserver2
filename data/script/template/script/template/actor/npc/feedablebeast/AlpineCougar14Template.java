 ...
 */
public class AlpineCougar14Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21502;

	@Inject
	protected AlpineCougar14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
