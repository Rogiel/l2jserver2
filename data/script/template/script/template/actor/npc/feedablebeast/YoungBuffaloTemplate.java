 ...
 */
public class YoungBuffaloTemplate extends FeedableBeastNPCTemplate {
	public static final int ID = 18888;

	@Inject
	protected YoungBuffaloTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
