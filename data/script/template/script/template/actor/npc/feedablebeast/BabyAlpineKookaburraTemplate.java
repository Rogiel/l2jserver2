 ...
 */
public class BabyAlpineKookaburraTemplate extends FeedableBeastNPCTemplate {
	public static final int ID = 18873;

	@Inject
	protected BabyAlpineKookaburraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Baby Alpine Kookaburra";
