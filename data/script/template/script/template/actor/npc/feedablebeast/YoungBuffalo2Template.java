 ...
 */
public class YoungBuffalo2Template extends FeedableBeastNPCTemplate {
	public static final int ID = 18889;

	@Inject
	protected YoungBuffalo2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Young Buffalo";
