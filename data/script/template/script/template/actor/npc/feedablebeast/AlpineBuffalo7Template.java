 ...
 */
public class AlpineBuffalo7Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21476;

	@Inject
	protected AlpineBuffalo7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
