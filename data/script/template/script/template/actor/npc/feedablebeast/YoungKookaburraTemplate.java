 ...
 */
public class YoungKookaburraTemplate extends FeedableBeastNPCTemplate {
	public static final int ID = 18874;

	@Inject
	protected YoungKookaburraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
