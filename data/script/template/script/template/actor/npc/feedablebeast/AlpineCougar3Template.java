 ...
 */
public class AlpineCougar3Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21491;

	@Inject
	protected AlpineCougar3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
