 ...
 */
public class AlpineCougar18Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21506;

	@Inject
	protected AlpineCougar18Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
