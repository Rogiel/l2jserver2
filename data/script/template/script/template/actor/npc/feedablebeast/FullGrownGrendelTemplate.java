 ...
 */
public class FullGrownGrendelTemplate extends FeedableBeastNPCTemplate {
	public static final int ID = 18899;

	@Inject
	protected FullGrownGrendelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
