 ...
 */
public class AlpineCougar6Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21494;

	@Inject
	protected AlpineCougar6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
