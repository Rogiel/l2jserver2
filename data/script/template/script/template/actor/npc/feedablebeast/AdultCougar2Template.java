 ...
 */
public class AdultCougar2Template extends FeedableBeastNPCTemplate {
	public static final int ID = 18884;

	@Inject
	protected AdultCougar2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Adult Cougar";
