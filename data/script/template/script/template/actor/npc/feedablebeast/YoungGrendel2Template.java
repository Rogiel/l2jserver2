 ...
 */
public class YoungGrendel2Template extends FeedableBeastNPCTemplate {
	public static final int ID = 18896;

	@Inject
	protected YoungGrendel2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Young Grendel";
