 ...
 */
public class AdultCougarTemplate extends FeedableBeastNPCTemplate {
	public static final int ID = 18883;

	@Inject
	protected AdultCougarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
