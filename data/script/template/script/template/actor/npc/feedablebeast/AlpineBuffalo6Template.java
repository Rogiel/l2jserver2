 ...
 */
public class AlpineBuffalo6Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21475;

	@Inject
	protected AlpineBuffalo6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
