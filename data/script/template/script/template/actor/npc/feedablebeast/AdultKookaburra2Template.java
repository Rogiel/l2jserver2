 ...
 */
public class AdultKookaburra2Template extends FeedableBeastNPCTemplate {
	public static final int ID = 18877;

	@Inject
	protected AdultKookaburra2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
