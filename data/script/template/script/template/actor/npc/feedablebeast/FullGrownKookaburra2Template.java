 ...
 */
public class FullGrownKookaburra2Template extends FeedableBeastNPCTemplate {
	public static final int ID = 18879;

	@Inject
	protected FullGrownKookaburra2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Full Grown Kookaburra";
