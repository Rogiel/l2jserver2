 ...
 */
public class FullGrownKookaburraTemplate extends FeedableBeastNPCTemplate {
	public static final int ID = 18878;

	@Inject
	protected FullGrownKookaburraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
