 ...
 */
public class AlpineCougar4Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21492;

	@Inject
	protected AlpineCougar4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
