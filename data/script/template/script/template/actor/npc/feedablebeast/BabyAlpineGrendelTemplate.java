 ...
 */
public class BabyAlpineGrendelTemplate extends FeedableBeastNPCTemplate {
	public static final int ID = 18894;

	@Inject
	protected BabyAlpineGrendelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Baby Alpine Grendel";
