 ...
 */
public class AlpineCougarTemplate extends FeedableBeastNPCTemplate {
	public static final int ID = 21489;

	@Inject
	protected AlpineCougarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
