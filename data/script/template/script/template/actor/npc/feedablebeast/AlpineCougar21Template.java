 ...
 */
public class AlpineCougar21Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21829;

	@Inject
	protected AlpineCougar21Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
