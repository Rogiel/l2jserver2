 ...
 */
public class AlpineBuffalo8Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21477;

	@Inject
	protected AlpineBuffalo8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
