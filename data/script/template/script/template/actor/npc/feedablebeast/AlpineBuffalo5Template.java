 ...
 */
public class AlpineBuffalo5Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21474;

	@Inject
	protected AlpineBuffalo5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
