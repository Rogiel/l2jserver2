 ...
 */
public class AlpineCougar16Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21504;

	@Inject
	protected AlpineCougar16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
