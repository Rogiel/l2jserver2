 ...
 */
public class AlpineCougar5Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21493;

	@Inject
	protected AlpineCougar5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
