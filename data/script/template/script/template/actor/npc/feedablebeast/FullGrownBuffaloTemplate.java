 ...
 */
public class FullGrownBuffaloTemplate extends FeedableBeastNPCTemplate {
	public static final int ID = 18892;

	@Inject
	protected FullGrownBuffaloTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
