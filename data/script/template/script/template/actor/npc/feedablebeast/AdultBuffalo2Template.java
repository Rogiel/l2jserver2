 ...
 */
public class AdultBuffalo2Template extends FeedableBeastNPCTemplate {
	public static final int ID = 18891;

	@Inject
	protected AdultBuffalo2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Adult Buffalo";
