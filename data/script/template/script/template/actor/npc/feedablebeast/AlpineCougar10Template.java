 ...
 */
public class AlpineCougar10Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21498;

	@Inject
	protected AlpineCougar10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
