 ...
 */
public class AlpineCougar11Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21499;

	@Inject
	protected AlpineCougar11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
