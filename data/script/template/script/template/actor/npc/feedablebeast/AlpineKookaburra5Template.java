 ...
 */
public class AlpineKookaburra5Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21455;

	@Inject
	protected AlpineKookaburra5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
