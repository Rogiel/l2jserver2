 ...
 */
public class AlpineBuffalo19Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21488;

	@Inject
	protected AlpineBuffalo19Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
