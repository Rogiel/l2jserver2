 ...
 */
public class AdultGrendel2Template extends FeedableBeastNPCTemplate {
	public static final int ID = 18898;

	@Inject
	protected AdultGrendel2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Adult Grendel";
