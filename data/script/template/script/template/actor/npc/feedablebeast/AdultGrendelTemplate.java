 ...
 */
public class AdultGrendelTemplate extends FeedableBeastNPCTemplate {
	public static final int ID = 18897;

	@Inject
	protected AdultGrendelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
