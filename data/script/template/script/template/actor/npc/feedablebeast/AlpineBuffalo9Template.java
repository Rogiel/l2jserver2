 ...
 */
public class AlpineBuffalo9Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21478;

	@Inject
	protected AlpineBuffalo9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
