 ...
 */
public class AlpineCougar15Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21503;

	@Inject
	protected AlpineCougar15Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
