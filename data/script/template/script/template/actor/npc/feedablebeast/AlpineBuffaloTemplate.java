 ...
 */
public class AlpineBuffaloTemplate extends FeedableBeastNPCTemplate {
	public static final int ID = 21470;

	@Inject
	protected AlpineBuffaloTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
