 ...
 */
public class FullGrownCougarTemplate extends FeedableBeastNPCTemplate {
	public static final int ID = 18885;

	@Inject
	protected FullGrownCougarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
