 ...
 */
public class AlpineKookaburra3Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21453;

	@Inject
	protected AlpineKookaburra3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
