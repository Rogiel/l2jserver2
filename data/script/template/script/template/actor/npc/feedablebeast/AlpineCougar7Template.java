 ...
 */
public class AlpineCougar7Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21495;

	@Inject
	protected AlpineCougar7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
