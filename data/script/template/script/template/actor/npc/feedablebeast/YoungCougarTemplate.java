 ...
 */
public class YoungCougarTemplate extends FeedableBeastNPCTemplate {
	public static final int ID = 18881;

	@Inject
	protected YoungCougarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
