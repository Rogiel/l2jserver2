 ...
 */
public class FullGrownCougar2Template extends FeedableBeastNPCTemplate {
	public static final int ID = 18886;

	@Inject
	protected FullGrownCougar2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Full Grown Cougar";
