 ...
 */
public class AlpineBuffalo3Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21472;

	@Inject
	protected AlpineBuffalo3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
