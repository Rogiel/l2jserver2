 ...
 */
public class YoungKookaburra2Template extends FeedableBeastNPCTemplate {
	public static final int ID = 18875;

	@Inject
	protected YoungKookaburra2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Young Kookaburra";
