 ...
 */
public class AlpineBuffalo17Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21486;

	@Inject
	protected AlpineBuffalo17Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
