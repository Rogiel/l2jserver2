 ...
 */
public class AdultBuffaloTemplate extends FeedableBeastNPCTemplate {
	public static final int ID = 18890;

	@Inject
	protected AdultBuffaloTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
