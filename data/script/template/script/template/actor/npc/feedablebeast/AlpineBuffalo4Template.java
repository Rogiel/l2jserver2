 ...
 */
public class AlpineBuffalo4Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21473;

	@Inject
	protected AlpineBuffalo4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
