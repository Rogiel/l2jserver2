 ...
 */
public class AlpineCougar2Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21490;

	@Inject
	protected AlpineCougar2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
