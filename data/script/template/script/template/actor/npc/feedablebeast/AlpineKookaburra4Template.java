 ...
 */
public class AlpineKookaburra4Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21454;

	@Inject
	protected AlpineKookaburra4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
