 ...
 */
public class AlpineCougar13Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21501;

	@Inject
	protected AlpineCougar13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
