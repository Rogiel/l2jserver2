 ...
 */
public class AlpineCougar8Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21496;

	@Inject
	protected AlpineCougar8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
