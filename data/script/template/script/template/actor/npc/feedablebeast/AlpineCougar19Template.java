 ...
 */
public class AlpineCougar19Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21507;

	@Inject
	protected AlpineCougar19Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
