 ...
 */
public class AlpineKookaburraTemplate extends FeedableBeastNPCTemplate {
	public static final int ID = 21451;

	@Inject
	protected AlpineKookaburraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
