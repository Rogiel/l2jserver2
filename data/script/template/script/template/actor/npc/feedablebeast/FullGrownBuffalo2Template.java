 ...
 */
public class FullGrownBuffalo2Template extends FeedableBeastNPCTemplate {
	public static final int ID = 18893;

	@Inject
	protected FullGrownBuffalo2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Full Grown Buffalo";
