 ...
 */
public class AlpineKookaburra8Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21458;

	@Inject
	protected AlpineKookaburra8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
