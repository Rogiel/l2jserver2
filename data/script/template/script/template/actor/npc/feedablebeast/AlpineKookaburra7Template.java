 ...
 */
public class AlpineKookaburra7Template extends FeedableBeastNPCTemplate {
	public static final int ID = 21457;

	@Inject
	protected AlpineKookaburra7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
