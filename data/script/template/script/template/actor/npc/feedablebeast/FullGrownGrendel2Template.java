 ...
 */
public class FullGrownGrendel2Template extends FeedableBeastNPCTemplate {
	public static final int ID = 18900;

	@Inject
	protected FullGrownGrendel2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Full Grown Grendel";
