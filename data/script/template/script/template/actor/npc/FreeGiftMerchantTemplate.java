 ...
 */
public class FreeGiftMerchantTemplate extends NPCTemplate {
	public static final int ID = 13182;

	@Inject
	protected FreeGiftMerchantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Free Gift Merchant";
