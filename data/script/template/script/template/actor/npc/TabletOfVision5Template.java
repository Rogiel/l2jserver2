 ...
 */
public class TabletOfVision5Template extends NPCTemplate {
	public static final int ID = 31650;

	@Inject
	protected TabletOfVision5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
