 ...
 */
public class Trap72Template extends NPCTemplate {
	public static final int ID = 13236;

	@Inject
	protected Trap72Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
