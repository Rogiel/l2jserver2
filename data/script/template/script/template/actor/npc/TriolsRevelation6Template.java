 ...
 */
public class TriolsRevelation6Template extends NPCTemplate {
	public static final int ID = 32063;

	@Inject
	protected TriolsRevelation6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
