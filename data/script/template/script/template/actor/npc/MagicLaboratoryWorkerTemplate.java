 ...
 */
public class MagicLaboratoryWorkerTemplate extends NPCTemplate {
	public static final int ID = 32131;

	@Inject
	protected MagicLaboratoryWorkerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Magic Laboratory Worker";
