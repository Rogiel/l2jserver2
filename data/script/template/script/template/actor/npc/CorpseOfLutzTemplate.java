 ...
 */
public class CorpseOfLutzTemplate extends NPCTemplate {
	public static final int ID = 30762;

	@Inject
	protected CorpseOfLutzTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Corpse Of Lutz";
