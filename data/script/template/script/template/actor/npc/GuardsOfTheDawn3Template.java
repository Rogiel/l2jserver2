 ...
 */
public class GuardsOfTheDawn3Template extends NPCTemplate {
	public static final int ID = 18835;

	@Inject
	protected GuardsOfTheDawn3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
