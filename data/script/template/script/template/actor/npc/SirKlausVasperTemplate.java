 ...
 */
public class SirKlausVasperTemplate extends NPCTemplate {
	public static final int ID = 30417;

	@Inject
	protected SirKlausVasperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sir Klaus Vasper";
