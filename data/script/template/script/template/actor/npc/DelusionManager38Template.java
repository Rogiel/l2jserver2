 ...
 */
public class DelusionManager38Template extends NPCTemplate {
	public static final int ID = 32701;

	@Inject
	protected DelusionManager38Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
