 ...
 */
public class DragonBomberTemplate extends NPCTemplate {
	public static final int ID = 13085;

	@Inject
	protected DragonBomberTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
