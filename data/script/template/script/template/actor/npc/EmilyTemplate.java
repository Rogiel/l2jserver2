 ...
 */
public class EmilyTemplate extends NPCTemplate {
	public static final int ID = 30620;

	@Inject
	protected EmilyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
