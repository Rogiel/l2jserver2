 ...
 */
public class EngineeringManager8Template extends NPCTemplate {
	public static final int ID = 35901;

	@Inject
	protected EngineeringManager8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
