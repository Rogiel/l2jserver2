 ...
 */
public class DetentionCampWarden4Template extends NPCTemplate {
	public static final int ID = 35767;

	@Inject
	protected DetentionCampWarden4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
