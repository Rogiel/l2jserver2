 ...
 */
public class WendyTemplate extends NPCTemplate {
	public static final int ID = 32047;

	@Inject
	protected WendyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
