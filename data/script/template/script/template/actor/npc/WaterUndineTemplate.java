 ...
 */
public class WaterUndineTemplate extends NPCTemplate {
	public static final int ID = 30413;

	@Inject
	protected WaterUndineTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Water Undine";
