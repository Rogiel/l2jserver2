 ...
 */
public class SwanTemplate extends NPCTemplate {
	public static final int ID = 30957;

	@Inject
	protected SwanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
