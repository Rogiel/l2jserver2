 ...
 */
public class Trap170Template extends NPCTemplate {
	public static final int ID = 18747;

	@Inject
	protected Trap170Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
