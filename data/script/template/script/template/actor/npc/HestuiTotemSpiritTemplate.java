 ...
 */
public class HestuiTotemSpiritTemplate extends NPCTemplate {
	public static final int ID = 30592;

	@Inject
	protected HestuiTotemSpiritTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hestui Totem Spirit";
