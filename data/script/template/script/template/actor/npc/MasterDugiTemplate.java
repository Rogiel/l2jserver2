 ...
 */
public class MasterDugiTemplate extends NPCTemplate {
	public static final int ID = 4302;

	@Inject
	protected MasterDugiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Master Dugi";
		this.serverSideName = false;
		this.title = "Soul Healer";
