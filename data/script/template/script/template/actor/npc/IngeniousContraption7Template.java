 ...
 */
public class IngeniousContraption7Template extends NPCTemplate {
	public static final int ID = 18500;

	@Inject
	protected IngeniousContraption7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
