 ...
 */
public class ItemBroker3Template extends NPCTemplate {
	public static final int ID = 32322;

	@Inject
	protected ItemBroker3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
