 ...
 */
public class MasonTemplate extends NPCTemplate {
	public static final int ID = 30625;

	@Inject
	protected MasonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
