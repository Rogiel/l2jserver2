 ...
 */
public class Legionnaire2Template extends NPCTemplate {
	public static final int ID = 32778;

	@Inject
	protected Legionnaire2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Legionnaire";
