 ...
 */
public class General19Template extends NPCTemplate {
	public static final int ID = 36252;

	@Inject
	protected General19Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
