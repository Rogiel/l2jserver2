 ...
 */
public class General7Template extends NPCTemplate {
	public static final int ID = 35931;

	@Inject
	protected General7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
