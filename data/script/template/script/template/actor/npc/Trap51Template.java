 ...
 */
public class Trap51Template extends NPCTemplate {
	public static final int ID = 13215;

	@Inject
	protected Trap51Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
