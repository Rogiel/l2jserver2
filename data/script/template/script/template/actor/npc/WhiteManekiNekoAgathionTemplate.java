 ...
 */
public class WhiteManekiNekoAgathionTemplate extends NPCTemplate {
	public static final int ID = 1510;

	@Inject
	protected WhiteManekiNekoAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "White Maneki Neko Agathion";
