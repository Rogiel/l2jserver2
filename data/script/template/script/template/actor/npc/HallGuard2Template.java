 ...
 */
public class HallGuard2Template extends NPCTemplate {
	public static final int ID = 18470;

	@Inject
	protected HallGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
