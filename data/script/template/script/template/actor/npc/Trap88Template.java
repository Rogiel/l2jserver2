 ...
 */
public class Trap88Template extends NPCTemplate {
	public static final int ID = 13252;

	@Inject
	protected Trap88Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
