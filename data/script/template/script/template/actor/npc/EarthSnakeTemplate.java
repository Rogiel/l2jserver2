 ...
 */
public class EarthSnakeTemplate extends NPCTemplate {
	public static final int ID = 30409;

	@Inject
	protected EarthSnakeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Earth Snake";
