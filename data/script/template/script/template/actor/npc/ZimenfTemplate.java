 ...
 */
public class ZimenfTemplate extends NPCTemplate {
	public static final int ID = 30538;

	@Inject
	protected ZimenfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
