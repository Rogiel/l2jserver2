 ...
 */
public class PreacherOfDoom42Template extends NPCTemplate {
	public static final int ID = 32000;

	@Inject
	protected PreacherOfDoom42Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
