 ...
 */
public class FinalFormTemplate extends NPCTemplate {
	public static final int ID = 13088;

	@Inject
	protected FinalFormTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
