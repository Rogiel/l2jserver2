 ...
 */
public class KanisTemplate extends NPCTemplate {
	public static final int ID = 32264;

	@Inject
	protected KanisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
