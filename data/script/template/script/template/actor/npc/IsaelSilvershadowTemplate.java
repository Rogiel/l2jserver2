 ...
 */
public class IsaelSilvershadowTemplate extends NPCTemplate {
	public static final int ID = 30655;

	@Inject
	protected IsaelSilvershadowTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Isael Silvershadow";
