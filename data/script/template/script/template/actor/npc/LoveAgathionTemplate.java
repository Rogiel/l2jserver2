 ...
 */
public class LoveAgathionTemplate extends NPCTemplate {
	public static final int ID = 16049;

	@Inject
	protected LoveAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Love Agathion";
