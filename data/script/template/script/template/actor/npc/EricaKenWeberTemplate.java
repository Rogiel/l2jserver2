 ...
 */
public class EricaKenWeberTemplate extends NPCTemplate {
	public static final int ID = 31619;

	@Inject
	protected EricaKenWeberTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Erica Ken Weber";
