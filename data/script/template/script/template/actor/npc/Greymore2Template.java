 ...
 */
public class Greymore2Template extends NPCTemplate {
	public static final int ID = 32757;

	@Inject
	protected Greymore2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
