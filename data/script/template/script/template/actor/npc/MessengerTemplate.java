 ...
 */
public class MessengerTemplate extends NPCTemplate {
	public static final int ID = 35437;

	@Inject
	protected MessengerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
