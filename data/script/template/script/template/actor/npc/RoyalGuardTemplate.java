 ...
 */
public class RoyalGuardTemplate extends NPCTemplate {
	public static final int ID = 32626;

	@Inject
	protected RoyalGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
