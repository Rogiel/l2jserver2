 ...
 */
public class GatekeeperOfFireDragon2Template extends NPCTemplate {
	public static final int ID = 31686;

	@Inject
	protected GatekeeperOfFireDragon2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
