 ...
 */
public class PowerControlUnitTemplate extends NPCTemplate {
	public static final int ID = 35675;

	@Inject
	protected PowerControlUnitTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
