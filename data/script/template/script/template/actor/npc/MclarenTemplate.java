 ...
 */
public class MclarenTemplate extends NPCTemplate {
	public static final int ID = 32767;

	@Inject
	protected MclarenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
