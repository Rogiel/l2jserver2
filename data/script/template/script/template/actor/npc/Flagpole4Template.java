 ...
 */
public class Flagpole4Template extends NPCTemplate {
	public static final int ID = 35757;

	@Inject
	protected Flagpole4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
