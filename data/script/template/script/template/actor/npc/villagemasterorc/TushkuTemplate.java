 ...
 */
public class TushkuTemplate extends OrcVillageMasterNPCTemplate {
	public static final int ID = 30913;

	@Inject
	protected TushkuTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
