 ...
 */
public class DrikusTemplate extends OrcVillageMasterNPCTemplate {
	public static final int ID = 30505;

	@Inject
	protected DrikusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
