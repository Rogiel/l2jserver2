 ...
 */
public class OsbornTemplate extends OrcVillageMasterNPCTemplate {
	public static final int ID = 30500;

	@Inject
	protected OsbornTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
