 ...
 */
public class CastorTemplate extends OrcVillageMasterNPCTemplate {
	public static final int ID = 30508;

	@Inject
	protected CastorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
