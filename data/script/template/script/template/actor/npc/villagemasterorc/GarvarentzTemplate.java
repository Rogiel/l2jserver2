 ...
 */
public class GarvarentzTemplate extends OrcVillageMasterNPCTemplate {
	public static final int ID = 30704;

	@Inject
	protected GarvarentzTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Garvarentz";
		this.serverSideName = false;
		this.title = "High Prefect";
