 ...
 */
public class ShakaTemplate extends OrcVillageMasterNPCTemplate {
	public static final int ID = 31977;

	@Inject
	protected ShakaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
