 ...
 */
public class LadanzaTemplate extends OrcVillageMasterNPCTemplate {
	public static final int ID = 30865;

	@Inject
	protected LadanzaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
