 ...
 */
public class PenatusTemplate extends OrcVillageMasterNPCTemplate {
	public static final int ID = 30513;

	@Inject
	protected PenatusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
