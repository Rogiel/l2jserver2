 ...
 */
public class TookTemplate extends OrcVillageMasterNPCTemplate {
	public static final int ID = 32150;

	@Inject
	protected TookTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
