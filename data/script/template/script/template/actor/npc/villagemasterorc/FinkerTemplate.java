 ...
 */
public class FinkerTemplate extends OrcVillageMasterNPCTemplate {
	public static final int ID = 32097;

	@Inject
	protected FinkerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
