 ...
 */
public class AklanTemplate extends OrcVillageMasterNPCTemplate {
	public static final int ID = 31288;

	@Inject
	protected AklanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
