 ...
 */
public class LambacTemplate extends OrcVillageMasterNPCTemplate {
	public static final int ID = 31326;

	@Inject
	protected LambacTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
