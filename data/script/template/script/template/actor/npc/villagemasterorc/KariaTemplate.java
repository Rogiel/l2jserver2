 ...
 */
public class KariaTemplate extends OrcVillageMasterNPCTemplate {
	public static final int ID = 30681;

	@Inject
	protected KariaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
