 ...
 */
public class OfferingOfDarkOmenEvokedSpiritTemplate extends NPCTemplate {
	public static final int ID = 18306;

	@Inject
	protected OfferingOfDarkOmenEvokedSpiritTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
