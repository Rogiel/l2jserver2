 ...
 */
public class TeleportationCubic7Template extends NPCTemplate {
	public static final int ID = 32107;

	@Inject
	protected TeleportationCubic7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
