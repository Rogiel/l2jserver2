 ...
 */
public class ShowStaffTemplate extends NPCTemplate {
	public static final int ID = 32424;

	@Inject
	protected ShowStaffTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
