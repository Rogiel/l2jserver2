 ...
 */
public class TabletOfVisionTemplate extends NPCTemplate {
	public static final int ID = 31646;

	@Inject
	protected TabletOfVisionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
