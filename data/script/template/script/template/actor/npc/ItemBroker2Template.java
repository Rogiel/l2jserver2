 ...
 */
public class ItemBroker2Template extends NPCTemplate {
	public static final int ID = 32321;

	@Inject
	protected ItemBroker2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Item Broker";
