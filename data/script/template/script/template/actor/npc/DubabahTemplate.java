 ...
 */
public class DubabahTemplate extends NPCTemplate {
	public static final int ID = 30672;

	@Inject
	protected DubabahTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
