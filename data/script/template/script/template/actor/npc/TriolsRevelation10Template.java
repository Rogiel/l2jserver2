 ...
 */
public class TriolsRevelation10Template extends NPCTemplate {
	public static final int ID = 32067;

	@Inject
	protected TriolsRevelation10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Triol's Revelation";
