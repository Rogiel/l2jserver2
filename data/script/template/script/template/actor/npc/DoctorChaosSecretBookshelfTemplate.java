 ...
 */
public class DoctorChaosSecretBookshelfTemplate extends NPCTemplate {
	public static final int ID = 32045;

	@Inject
	protected DoctorChaosSecretBookshelfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Doctor Chaos' Secret Bookshelf";
