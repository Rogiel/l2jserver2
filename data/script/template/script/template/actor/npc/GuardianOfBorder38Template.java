 ...
 */
public class GuardianOfBorder38Template extends NPCTemplate {
	public static final int ID = 31902;

	@Inject
	protected GuardianOfBorder38Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
