 ...
 */
public class Trap195Template extends NPCTemplate {
	public static final int ID = 18772;

	@Inject
	protected Trap195Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
