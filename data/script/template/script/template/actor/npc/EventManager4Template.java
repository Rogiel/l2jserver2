 ...
 */
public class EventManager4Template extends NPCTemplate {
	public static final int ID = 31857;

	@Inject
	protected EventManager4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
