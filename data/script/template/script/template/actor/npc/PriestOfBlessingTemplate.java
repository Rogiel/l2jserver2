 ...
 */
public class PriestOfBlessingTemplate extends NPCTemplate {
	public static final int ID = 32783;

	@Inject
	protected PriestOfBlessingTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Priest of Blessing";
