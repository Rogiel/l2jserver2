 ...
 */
public class Trap15Template extends NPCTemplate {
	public static final int ID = 13051;

	@Inject
	protected Trap15Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
