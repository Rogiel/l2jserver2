 ...
 */
public class DivineWarriorTemplate extends NPCTemplate {
	public static final int ID = 13113;

	@Inject
	protected DivineWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Divine Warrior";
