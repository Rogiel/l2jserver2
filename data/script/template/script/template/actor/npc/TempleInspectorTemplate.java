 ...
 */
public class TempleInspectorTemplate extends NPCTemplate {
	public static final int ID = 32507;

	@Inject
	protected TempleInspectorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Temple Inspector";
