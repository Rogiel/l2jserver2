 ...
 */
public class JacquardTemplate extends NPCTemplate {
	public static final int ID = 35639;

	@Inject
	protected JacquardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
