 ...
 */
public class SaintsFollower5Template extends NPCTemplate {
	public static final int ID = 31704;

	@Inject
	protected SaintsFollower5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Saint's Follower";
