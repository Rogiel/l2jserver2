 ...
 */
public class HuntingGroundKeeper2Template extends NPCTemplate {
	public static final int ID = 18588;

	@Inject
	protected HuntingGroundKeeper2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hunting Ground Keeper";
		...
		this.rightHand = itemProvider.createID(13062);
		this.leftHand = null;
		this.enchantLevel = 0;
