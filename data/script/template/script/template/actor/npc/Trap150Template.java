 ...
 */
public class Trap150Template extends NPCTemplate {
	public static final int ID = 18727;

	@Inject
	protected Trap150Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
