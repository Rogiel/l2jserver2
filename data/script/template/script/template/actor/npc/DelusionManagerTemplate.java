 ...
 */
public class DelusionManagerTemplate extends NPCTemplate {
	public static final int ID = 32664;

	@Inject
	protected DelusionManagerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
