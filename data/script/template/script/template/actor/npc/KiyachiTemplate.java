 ...
 */
public class KiyachiTemplate extends NPCTemplate {
	public static final int ID = 13104;

	@Inject
	protected KiyachiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
