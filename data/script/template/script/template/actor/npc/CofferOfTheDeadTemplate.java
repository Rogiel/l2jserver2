 ...
 */
public class CofferOfTheDeadTemplate extends NPCTemplate {
	public static final int ID = 31027;

	@Inject
	protected CofferOfTheDeadTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Coffer of the Dead";
