 ...
 */
public class DevilsIsleSupporterTemplate extends NPCTemplate {
	public static final int ID = 32501;

	@Inject
	protected DevilsIsleSupporterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Devil's Isle Supporter";
