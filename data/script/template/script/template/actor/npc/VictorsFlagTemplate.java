 ...
 */
public class VictorsFlagTemplate extends NPCTemplate {
	public static final int ID = 35606;

	@Inject
	protected VictorsFlagTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Victor's Flag";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 63.50;
		this.collisionHeight = 97.50;
		this.level = 75;
		this.sex = null;
		this.attackRange = 40;
