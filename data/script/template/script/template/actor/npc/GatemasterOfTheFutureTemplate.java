 ...
 */
public class GatemasterOfTheFutureTemplate extends NPCTemplate {
	public static final int ID = 32262;

	@Inject
	protected GatemasterOfTheFutureTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gatemaster of the Future";
