 ...
 */
public class WharfPatrolTemplate extends NPCTemplate {
	public static final int ID = 32628;

	@Inject
	protected WharfPatrolTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
