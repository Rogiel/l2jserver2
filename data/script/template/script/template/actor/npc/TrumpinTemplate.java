 ...
 */
public class TrumpinTemplate extends NPCTemplate {
	public static final int ID = 30935;

	@Inject
	protected TrumpinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
