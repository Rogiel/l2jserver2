 ...
 */
public class KatzTemplate extends TownPetNPCTemplate {
	public static final int ID = 31205;

	@Inject
	protected KatzTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
