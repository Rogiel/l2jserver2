 ...
 */
public class SardiniaTemplate extends TownPetNPCTemplate {
	public static final int ID = 31207;

	@Inject
	protected SardiniaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
