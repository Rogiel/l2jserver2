 ...
 */
public class RubyTemplate extends TownPetNPCTemplate {
	public static final int ID = 31955;

	@Inject
	protected RubyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
