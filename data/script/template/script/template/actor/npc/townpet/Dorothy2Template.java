 ...
 */
public class Dorothy2Template extends TownPetNPCTemplate {
	public static final int ID = 31593;

	@Inject
	protected Dorothy2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dorothy";
		this.serverSideName = false;
		this.title = "Golem of Telson";
