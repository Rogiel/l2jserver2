 ...
 */
public class LaGrangeTemplate extends TownPetNPCTemplate {
	public static final int ID = 31208;

	@Inject
	protected LaGrangeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
