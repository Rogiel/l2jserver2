 ...
 */
public class TenTenTemplate extends TownPetNPCTemplate {
	public static final int ID = 31206;

	@Inject
	protected TenTenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
