 ...
 */
public class RafiTemplate extends TownPetNPCTemplate {
	public static final int ID = 31758;

	@Inject
	protected RafiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
