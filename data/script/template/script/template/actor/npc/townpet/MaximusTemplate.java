 ...
 */
public class MaximusTemplate extends TownPetNPCTemplate {
	public static final int ID = 31202;

	@Inject
	protected MaximusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
