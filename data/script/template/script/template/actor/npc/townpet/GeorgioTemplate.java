 ...
 */
public class GeorgioTemplate extends TownPetNPCTemplate {
	public static final int ID = 31204;

	@Inject
	protected GeorgioTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
