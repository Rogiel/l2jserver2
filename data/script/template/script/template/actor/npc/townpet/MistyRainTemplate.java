 ...
 */
public class MistyRainTemplate extends TownPetNPCTemplate {
	public static final int ID = 31209;

	@Inject
	protected MistyRainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Misty Rain";
