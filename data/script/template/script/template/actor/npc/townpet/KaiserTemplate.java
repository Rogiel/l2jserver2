 ...
 */
public class KaiserTemplate extends TownPetNPCTemplate {
	public static final int ID = 31266;

	@Inject
	protected KaiserTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
