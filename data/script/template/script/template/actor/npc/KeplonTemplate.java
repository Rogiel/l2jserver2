 ...
 */
public class KeplonTemplate extends NPCTemplate {
	public static final int ID = 30949;

	@Inject
	protected KeplonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
