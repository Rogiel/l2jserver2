 ...
 */
public class MarshaTemplate extends NPCTemplate {
	public static final int ID = 30934;

	@Inject
	protected MarshaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
