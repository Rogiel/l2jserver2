 ...
 */
public class MainMachine5Template extends NPCTemplate {
	public static final int ID = 35983;

	@Inject
	protected MainMachine5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
