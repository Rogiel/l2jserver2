 ...
 */
public class SuspiciousLookingPileOfStonesTemplate extends NPCTemplate {
	public static final int ID = 32046;

	@Inject
	protected SuspiciousLookingPileOfStonesTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Suspicious-Looking Pile of Stones";
