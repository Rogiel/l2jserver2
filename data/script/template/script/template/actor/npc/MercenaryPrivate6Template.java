 ...
 */
public class MercenaryPrivate6Template extends NPCTemplate {
	public static final int ID = 35856;

	@Inject
	protected MercenaryPrivate6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
