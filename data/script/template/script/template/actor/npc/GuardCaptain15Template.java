 ...
 */
public class GuardCaptain15Template extends NPCTemplate {
	public static final int ID = 35898;

	@Inject
	protected GuardCaptain15Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
