 ...
 */
public class LuciensAltar3Template extends NPCTemplate {
	public static final int ID = 32708;

	@Inject
	protected LuciensAltar3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
