 ...
 */
public class DetentionCampWarden5Template extends NPCTemplate {
	public static final int ID = 35804;

	@Inject
	protected DetentionCampWarden5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
