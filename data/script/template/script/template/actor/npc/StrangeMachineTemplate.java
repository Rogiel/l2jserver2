 ...
 */
public class StrangeMachineTemplate extends NPCTemplate {
	public static final int ID = 32032;

	@Inject
	protected StrangeMachineTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Strange Machine";
