 ...
 */
public class ThomasDTurkeyTemplate extends NPCTemplate {
	public static final int ID = 1;

	@Inject
	protected ThomasDTurkeyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Thomas D. Turkey";
		this.serverSideName = false;
		this.title = "Misguided Holiday Scrooge";
