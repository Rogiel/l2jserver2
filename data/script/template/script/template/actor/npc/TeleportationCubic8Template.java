 ...
 */
public class TeleportationCubic8Template extends NPCTemplate {
	public static final int ID = 32374;

	@Inject
	protected TeleportationCubic8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
