 ...
 */
public class SymbolOfAdversityTemplate extends NPCTemplate {
	public static final int ID = 32289;

	@Inject
	protected SymbolOfAdversityTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Symbol of Adversity";
