 ...
 */
public class MercenaryPrivate20Template extends NPCTemplate {
	public static final int ID = 36353;

	@Inject
	protected MercenaryPrivate20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
