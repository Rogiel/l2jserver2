 ...
 */
public class JudeTemplate extends NPCTemplate {
	public static final int ID = 32356;

	@Inject
	protected JudeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
