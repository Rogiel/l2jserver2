 ...
 */
public class General11Template extends NPCTemplate {
	public static final int ID = 36038;

	@Inject
	protected General11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
