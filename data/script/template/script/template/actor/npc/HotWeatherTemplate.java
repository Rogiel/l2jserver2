 ...
 */
public class HotWeatherTemplate extends NPCTemplate {
	public static final int ID = 13269;

	@Inject
	protected HotWeatherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hot Weather";
		...
		attributes.physicalAttack = 10.00000;
