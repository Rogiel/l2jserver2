 ...
 */
public class TinPlateGolemTemplate extends NPCTemplate {
	public static final int ID = 13162;

	@Inject
	protected TinPlateGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tin Plate Golem";
