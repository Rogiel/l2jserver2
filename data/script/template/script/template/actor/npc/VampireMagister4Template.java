 ...
 */
public class VampireMagister4Template extends NPCTemplate {
	public static final int ID = 35635;

	@Inject
	protected VampireMagister4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vampire Magister";
		...
		this.attackRange = 40;
		this.maxHP = 8274.177699840000000;
		...
		attributes.physicalAttack = 1922.69132;
