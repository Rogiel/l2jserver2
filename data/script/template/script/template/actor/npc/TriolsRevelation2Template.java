 ...
 */
public class TriolsRevelation2Template extends NPCTemplate {
	public static final int ID = 32059;

	@Inject
	protected TriolsRevelation2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
