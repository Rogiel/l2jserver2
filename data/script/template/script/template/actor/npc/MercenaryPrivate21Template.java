 ...
 */
public class MercenaryPrivate21Template extends NPCTemplate {
	public static final int ID = 36391;

	@Inject
	protected MercenaryPrivate21Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mercenary Private";
