 ...
 */
public class SupplyBox5Template extends NPCTemplate {
	public static final int ID = 35803;

	@Inject
	protected SupplyBox5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
