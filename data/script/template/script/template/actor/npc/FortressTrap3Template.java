 ...
 */
public class FortressTrap3Template extends NPCTemplate {
	public static final int ID = 36414;

	@Inject
	protected FortressTrap3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
