 ...
 */
public class InnerDoorman10Template extends NPCTemplate {
	public static final int ID = 35433;

	@Inject
	protected InnerDoorman10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
