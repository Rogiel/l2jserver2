 ...
 */
public class Freya2Template extends NPCTemplate {
	public static final int ID = 18847;

	@Inject
	protected Freya2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 2388699.675054090000000;
		this.maxMP = 1846.800000000000000;
		this.hpRegeneration = 918.195504075765000;
