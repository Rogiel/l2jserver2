 ...
 */
public class VerceTemplate extends NPCTemplate {
	public static final int ID = 30988;

	@Inject
	protected VerceTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Verce";
		this.serverSideName = false;
		this.title = "Leathersmith";
