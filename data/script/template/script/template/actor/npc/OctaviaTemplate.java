 ...
 */
public class OctaviaTemplate extends NPCTemplate {
	public static final int ID = 31043;

	@Inject
	protected OctaviaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
