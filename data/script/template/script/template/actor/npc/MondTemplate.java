 ...
 */
public class MondTemplate extends NPCTemplate {
	public static final int ID = 31594;

	@Inject
	protected MondTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mond";
		this.serverSideName = false;
		this.title = "Chief Inspector";
