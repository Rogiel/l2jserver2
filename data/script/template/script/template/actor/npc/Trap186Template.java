 ...
 */
public class Trap186Template extends NPCTemplate {
	public static final int ID = 18763;

	@Inject
	protected Trap186Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
