 ...
 */
public class VampireSoldier2Template extends NPCTemplate {
	public static final int ID = 35633;

	@Inject
	protected VampireSoldier2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vampire Soldier";
		...
		this.attackRange = 40;
		this.maxHP = 7896.589080000000000;
		...
		attributes.physicalAttack = 1709.62599;
