 ...
 */
public class KatenarTemplate extends NPCTemplate {
	public static final int ID = 32235;

	@Inject
	protected KatenarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
