 ...
 */
public class CommanderEliteMercenaryTemplate extends NPCTemplate {
	public static final int ID = 13180;

	@Inject
	protected CommanderEliteMercenaryTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Commander Elite Mercenary";
