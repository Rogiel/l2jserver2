 ...
 */
public class NewbieHelper11Template extends NPCTemplate {
	public static final int ID = 32134;

	@Inject
	protected NewbieHelper11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Newbie Helper";
