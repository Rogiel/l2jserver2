 ...
 */
public class MissQueen2Template extends NPCTemplate {
	public static final int ID = 31760;

	@Inject
	protected MissQueen2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
