 ...
 */
public class GreenFlag2Template extends NPCTemplate {
	public static final int ID = 35609;

	@Inject
	protected GreenFlag2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
