 ...
 */
public class DetentionCampWarden7Template extends NPCTemplate {
	public static final int ID = 35867;

	@Inject
	protected DetentionCampWarden7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
