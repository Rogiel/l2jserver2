 ...
 */
public class MorenkiTemplate extends NPCTemplate {
	public static final int ID = 32623;

	@Inject
	protected MorenkiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
