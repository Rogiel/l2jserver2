 ...
 */
public class DummyLadyHTemplate extends NPCTemplate {
	public static final int ID = 31397;

	@Inject
	protected DummyLadyHTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dummy - Lady H";
