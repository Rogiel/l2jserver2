 ...
 */
public class DelusionManager30Template extends NPCTemplate {
	public static final int ID = 32693;

	@Inject
	protected DelusionManager30Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
