 ...
 */
public class MaoTemplate extends NPCTemplate {
	public static final int ID = 32190;

	@Inject
	protected MaoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
