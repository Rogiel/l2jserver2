 ...
 */
public class General3Template extends NPCTemplate {
	public static final int ID = 35762;

	@Inject
	protected General3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
