 ...
 */
public class Trap36Template extends NPCTemplate {
	public static final int ID = 13126;

	@Inject
	protected Trap36Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
