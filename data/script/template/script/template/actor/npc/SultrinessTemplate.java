 ...
 */
public class SultrinessTemplate extends NPCTemplate {
	public static final int ID = 13270;

	@Inject
	protected SultrinessTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sultriness";
