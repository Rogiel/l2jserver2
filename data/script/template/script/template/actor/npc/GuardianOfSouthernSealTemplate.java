 ...
 */
public class GuardianOfSouthernSealTemplate extends NPCTemplate {
	public static final int ID = 32660;

	@Inject
	protected GuardianOfSouthernSealTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guardian of Southern Seal";
