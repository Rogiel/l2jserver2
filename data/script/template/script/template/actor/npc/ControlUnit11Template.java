 ...
 */
public class ControlUnit11Template extends NPCTemplate {
	public static final int ID = 36337;

	@Inject
	protected ControlUnit11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
