 ...
 */
public class TantusTemplate extends NPCTemplate {
	public static final int ID = 30567;

	@Inject
	protected TantusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tantus";
		this.serverSideName = false;
		this.title = "Neruga Chief";
