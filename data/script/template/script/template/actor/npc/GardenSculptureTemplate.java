 ...
 */
public class GardenSculptureTemplate extends NPCTemplate {
	public static final int ID = 32030;

	@Inject
	protected GardenSculptureTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Garden Sculpture";
