 ...
 */
public class MerchantOfMammon2Template extends NPCTemplate {
	public static final int ID = 32584;

	@Inject
	protected MerchantOfMammon2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
