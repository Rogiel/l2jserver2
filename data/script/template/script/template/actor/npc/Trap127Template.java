 ...
 */
public class Trap127Template extends NPCTemplate {
	public static final int ID = 18412;

	@Inject
	protected Trap127Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
