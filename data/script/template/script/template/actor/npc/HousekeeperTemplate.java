 ...
 */
public class HousekeeperTemplate extends NPCTemplate {
	public static final int ID = 18583;

	@Inject
	protected HousekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
