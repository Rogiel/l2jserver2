 ...
 */
public class SophyaTemplate extends NPCTemplate {
	public static final int ID = 30735;

	@Inject
	protected SophyaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
