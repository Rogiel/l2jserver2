 ...
 */
public class JohnnyTemplate extends NPCTemplate {
	public static final int ID = 32744;

	@Inject
	protected JohnnyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Johnny";
		this.serverSideName = false;
		this.title = "Chief Investigator";
