 ...
 */
public class HugePig2Template extends NPCTemplate {
	public static final int ID = 13032;

	@Inject
	protected HugePig2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
