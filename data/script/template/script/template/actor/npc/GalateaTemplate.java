 ...
 */
public class GalateaTemplate extends NPCTemplate {
	public static final int ID = 30634;

	@Inject
	protected GalateaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Galatea";
		this.serverSideName = false;
		this.title = "High Summoner";
