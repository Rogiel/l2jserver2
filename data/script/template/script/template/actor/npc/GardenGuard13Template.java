 ...
 */
public class GardenGuard13Template extends NPCTemplate {
	public static final int ID = 25530;

	@Inject
	protected GardenGuard13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 1244.271563523930000;
