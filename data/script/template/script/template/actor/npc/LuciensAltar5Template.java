 ...
 */
public class LuciensAltar5Template extends NPCTemplate {
	public static final int ID = 32710;

	@Inject
	protected LuciensAltar5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
