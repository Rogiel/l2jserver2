 ...
 */
public class EvasObeliskTemplate extends NPCTemplate {
	public static final int ID = 11;

	@Inject
	protected EvasObeliskTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Eva's Obelisk";
