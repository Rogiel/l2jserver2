 ...
 */
public class EvilAltar5Template extends NPCTemplate {
	public static final int ID = 31516;

	@Inject
	protected EvilAltar5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
