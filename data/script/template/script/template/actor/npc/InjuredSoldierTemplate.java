 ...
 */
public class InjuredSoldierTemplate extends NPCTemplate {
	public static final int ID = 32738;

	@Inject
	protected InjuredSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Injured Soldier";
