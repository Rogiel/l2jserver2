 ...
 */
public class MithrilMillipedeTemplate extends NPCTemplate {
	public static final int ID = 22766;

	@Inject
	protected MithrilMillipedeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mithril Millipede";
