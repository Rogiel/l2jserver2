 ...
 */
public class DelusionManager15Template extends NPCTemplate {
	public static final int ID = 32678;

	@Inject
	protected DelusionManager15Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
