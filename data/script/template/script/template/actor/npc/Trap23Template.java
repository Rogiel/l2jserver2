 ...
 */
public class Trap23Template extends NPCTemplate {
	public static final int ID = 13059;

	@Inject
	protected Trap23Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
