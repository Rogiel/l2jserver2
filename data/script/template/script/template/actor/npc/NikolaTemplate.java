 ...
 */
public class NikolaTemplate extends NPCTemplate {
	public static final int ID = 30621;

	@Inject
	protected NikolaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
