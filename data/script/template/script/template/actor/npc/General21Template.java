 ...
 */
public class General21Template extends NPCTemplate {
	public static final int ID = 36321;

	@Inject
	protected General21Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
