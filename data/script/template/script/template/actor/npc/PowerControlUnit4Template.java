 ...
 */
public class PowerControlUnit4Template extends NPCTemplate {
	public static final int ID = 35779;

	@Inject
	protected PowerControlUnit4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
