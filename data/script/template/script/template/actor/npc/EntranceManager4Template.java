 ...
 */
public class EntranceManager4Template extends NPCTemplate {
	public static final int ID = 32523;

	@Inject
	protected EntranceManager4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Entrance Manager";
		this.serverSideName = false;
		this.title = "Handy's Block Checker - Arena 3";
