 ...
 */
public class SkullTemplate extends NPCTemplate {
	public static final int ID = 32494;

	@Inject
	protected SkullTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
