 ...
 */
public class InnerDoorman7Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35313;

	@Inject
	protected InnerDoorman7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
