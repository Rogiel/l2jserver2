 ...
 */
public class HallDoormanTemplate extends CastleDoormenNPCTemplate {
	public static final int ID = 35269;

	@Inject
	protected HallDoormanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hall Doorman";
