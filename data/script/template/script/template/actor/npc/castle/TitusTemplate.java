 ...
 */
public class TitusTemplate extends CastleWyvernManagerNPCTemplate {
	public static final int ID = 35510;

	@Inject
	protected TitusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
