 ...
 */
public class OuterDoorman5Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35267;

	@Inject
	protected OuterDoorman5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
