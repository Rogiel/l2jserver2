 ...
 */
public class Doorman3Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35551;

	@Inject
	protected Doorman3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
