 ...
 */
public class MassGatekeeper7Template extends CastleTeleporterNPCTemplate {
	public static final int ID = 35355;

	@Inject
	protected MassGatekeeper7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
