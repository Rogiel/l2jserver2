 ...
 */
public class Blacksmith5Template extends CastleBlacksmithNPCTemplate {
	public static final int ID = 35272;

	@Inject
	protected Blacksmith5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
