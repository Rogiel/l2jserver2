 ...
 */
public class Blacksmith6Template extends CastleBlacksmithNPCTemplate {
	public static final int ID = 35314;

	@Inject
	protected Blacksmith6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
