 ...
 */
public class CourtMagician9Template extends CastleMagicianNPCTemplate {
	public static final int ID = 35655;

	@Inject
	protected CourtMagician9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
