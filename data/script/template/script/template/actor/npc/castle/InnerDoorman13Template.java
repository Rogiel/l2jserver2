 ...
 */
public class InnerDoorman13Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35505;

	@Inject
	protected InnerDoorman13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
