 ...
 */
public class Gatekeeper13Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35220;

	@Inject
	protected Gatekeeper13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
