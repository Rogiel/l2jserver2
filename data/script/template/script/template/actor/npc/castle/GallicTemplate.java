 ...
 */
public class GallicTemplate extends CastleWyvernManagerNPCTemplate {
	public static final int ID = 35556;

	@Inject
	protected GallicTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
