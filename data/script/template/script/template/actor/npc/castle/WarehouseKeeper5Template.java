 ...
 */
public class WarehouseKeeper5Template extends CastleWarehouseNPCTemplate {
	public static final int ID = 35273;

	@Inject
	protected WarehouseKeeper5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
