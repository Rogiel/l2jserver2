 ...
 */
public class OuterDoorman10Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35503;

	@Inject
	protected OuterDoorman10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
