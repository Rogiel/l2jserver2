 ...
 */
public class WarehouseKeeper7Template extends CastleWarehouseNPCTemplate {
	public static final int ID = 35362;

	@Inject
	protected WarehouseKeeper7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
