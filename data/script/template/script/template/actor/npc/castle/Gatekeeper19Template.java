 ...
 */
public class Gatekeeper19Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35271;

	@Inject
	protected Gatekeeper19Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
