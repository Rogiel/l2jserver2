 ...
 */
public class NeurathTemplate extends CastleChamberlainNPCTemplate {
	public static final int ID = 35316;

	@Inject
	protected NeurathTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
