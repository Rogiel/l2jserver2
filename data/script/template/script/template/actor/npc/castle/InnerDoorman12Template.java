 ...
 */
public class InnerDoorman12Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35504;

	@Inject
	protected InnerDoorman12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
