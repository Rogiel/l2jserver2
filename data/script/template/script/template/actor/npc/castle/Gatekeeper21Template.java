 ...
 */
public class Gatekeeper21Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35309;

	@Inject
	protected Gatekeeper21Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
