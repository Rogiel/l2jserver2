 ...
 */
public class Gatekeeper7Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35136;

	@Inject
	protected Gatekeeper7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
