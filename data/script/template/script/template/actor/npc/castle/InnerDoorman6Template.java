 ...
 */
public class InnerDoorman6Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35270;

	@Inject
	protected InnerDoorman6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
