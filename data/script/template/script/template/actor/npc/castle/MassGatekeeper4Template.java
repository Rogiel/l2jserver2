 ...
 */
public class MassGatekeeper4Template extends CastleTeleporterNPCTemplate {
	public static final int ID = 35221;

	@Inject
	protected MassGatekeeper4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
