 ...
 */
public class OuterDoorman2Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35138;

	@Inject
	protected OuterDoorman2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
