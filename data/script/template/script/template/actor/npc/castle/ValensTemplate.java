 ...
 */
public class ValensTemplate extends CastleWyvernManagerNPCTemplate {
	public static final int ID = 35638;

	@Inject
	protected ValensTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
