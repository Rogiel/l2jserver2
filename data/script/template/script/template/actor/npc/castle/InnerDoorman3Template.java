 ...
 */
public class InnerDoorman3Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35181;

	@Inject
	protected InnerDoorman3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
