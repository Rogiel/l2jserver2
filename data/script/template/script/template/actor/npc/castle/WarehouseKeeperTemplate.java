 ...
 */
public class WarehouseKeeperTemplate extends CastleWarehouseNPCTemplate {
	public static final int ID = 35099;

	@Inject
	protected WarehouseKeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
