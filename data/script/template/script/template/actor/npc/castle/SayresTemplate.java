 ...
 */
public class SayresTemplate extends CastleChamberlainNPCTemplate {
	public static final int ID = 35100;

	@Inject
	protected SayresTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
