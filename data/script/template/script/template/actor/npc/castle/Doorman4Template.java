 ...
 */
public class Doorman4Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35552;

	@Inject
	protected Doorman4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
