 ...
 */
public class InnerDoorman14Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35549;

	@Inject
	protected InnerDoorman14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
