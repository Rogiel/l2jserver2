 ...
 */
public class OuterDoorman6Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35312;

	@Inject
	protected OuterDoorman6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
