 ...
 */
public class WarehouseKeeper2Template extends CastleWarehouseNPCTemplate {
	public static final int ID = 35141;

	@Inject
	protected WarehouseKeeper2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
