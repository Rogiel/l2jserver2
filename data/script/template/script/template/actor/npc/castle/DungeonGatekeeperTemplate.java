 ...
 */
public class DungeonGatekeeperTemplate extends CastleDoormenNPCTemplate {
	public static final int ID = 35506;

	@Inject
	protected DungeonGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dungeon Gatekeeper";
