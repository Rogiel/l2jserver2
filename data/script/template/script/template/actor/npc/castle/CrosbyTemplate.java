 ...
 */
public class CrosbyTemplate extends CastleChamberlainNPCTemplate {
	public static final int ID = 35142;

	@Inject
	protected CrosbyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
