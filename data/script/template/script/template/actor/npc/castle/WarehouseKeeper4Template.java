 ...
 */
public class WarehouseKeeper4Template extends CastleWarehouseNPCTemplate {
	public static final int ID = 35225;

	@Inject
	protected WarehouseKeeper4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
