 ...
 */
public class FinrodTemplate extends CastleWyvernManagerNPCTemplate {
	public static final int ID = 35227;

	@Inject
	protected FinrodTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
