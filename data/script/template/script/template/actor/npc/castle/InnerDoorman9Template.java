 ...
 */
public class InnerDoorman9Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35358;

	@Inject
	protected InnerDoorman9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
