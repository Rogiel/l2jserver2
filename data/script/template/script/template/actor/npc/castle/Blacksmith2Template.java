 ...
 */
public class Blacksmith2Template extends CastleBlacksmithNPCTemplate {
	public static final int ID = 35140;

	@Inject
	protected Blacksmith2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
