...
import com.l2jserver.model.template.npc.CastleDoormenNPCTemplate;
import com.l2jserver.model.world.Actor.ActorSex;

/**
 * @author <a href="http://www.rogiel.com">Rogiel</a>
 */
public class InnerDoorman15Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35550;

	@Inject
	protected InnerDoorman15Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Inner Doorman";
