 ...
 */
public class MassGatekeeperTemplate extends CastleTeleporterNPCTemplate {
	public static final int ID = 35095;

	@Inject
	protected MassGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
