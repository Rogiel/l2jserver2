 ...
 */
public class Blacksmith3Template extends CastleBlacksmithNPCTemplate {
	public static final int ID = 35182;

	@Inject
	protected Blacksmith3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
