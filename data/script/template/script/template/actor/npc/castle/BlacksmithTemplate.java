 ...
 */
public class BlacksmithTemplate extends CastleBlacksmithNPCTemplate {
	public static final int ID = 35098;

	@Inject
	protected BlacksmithTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
