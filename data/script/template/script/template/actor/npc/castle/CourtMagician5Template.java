 ...
 */
public class CourtMagician5Template extends CastleMagicianNPCTemplate {
	public static final int ID = 35651;

	@Inject
	protected CourtMagician5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
