 ...
 */
public class HodlerTemplate extends CastleWyvernManagerNPCTemplate {
	public static final int ID = 35143;

	@Inject
	protected HodlerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
