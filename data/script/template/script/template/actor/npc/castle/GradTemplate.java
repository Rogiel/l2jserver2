 ...
 */
public class GradTemplate extends CastleWyvernManagerNPCTemplate {
	public static final int ID = 35101;

	@Inject
	protected GradTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
