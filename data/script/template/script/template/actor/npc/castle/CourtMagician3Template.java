 ...
 */
public class CourtMagician3Template extends CastleMagicianNPCTemplate {
	public static final int ID = 35649;

	@Inject
	protected CourtMagician3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
