 ...
 */
public class HadleyTemplate extends CastleWyvernManagerNPCTemplate {
	public static final int ID = 35364;

	@Inject
	protected HadleyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
