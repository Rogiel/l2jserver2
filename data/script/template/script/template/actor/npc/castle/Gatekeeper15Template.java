 ...
 */
public class Gatekeeper15Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35262;

	@Inject
	protected Gatekeeper15Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
