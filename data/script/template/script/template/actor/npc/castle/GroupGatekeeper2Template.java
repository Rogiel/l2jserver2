...
import com.l2jserver.model.template.npc.CastleTeleporterNPCTemplate;
import com.l2jserver.model.world.Actor.ActorSex;

/**
 * @author <a href="http://www.rogiel.com">Rogiel</a>
 */
public class GroupGatekeeper2Template extends CastleTeleporterNPCTemplate {
	public static final int ID = 35547;

	@Inject
	protected GroupGatekeeper2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Group Gatekeeper";
