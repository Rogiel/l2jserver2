 ...
 */
public class Tate2Template extends CastleWyvernManagerNPCTemplate {
	public static final int ID = 35317;

	@Inject
	protected Tate2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
