 ...
 */
public class WarehouseKeeper8Template extends CastleWarehouseNPCTemplate {
	public static final int ID = 35508;

	@Inject
	protected WarehouseKeeper8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
