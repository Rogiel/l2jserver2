 ...
 */
public class CourtMagician2Template extends CastleMagicianNPCTemplate {
	public static final int ID = 35648;

	@Inject
	protected CourtMagician2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
