 ...
 */
public class Gatekeeper22Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35310;

	@Inject
	protected Gatekeeper22Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
