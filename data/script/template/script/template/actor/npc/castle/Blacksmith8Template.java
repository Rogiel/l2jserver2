 ...
 */
public class Blacksmith8Template extends CastleBlacksmithNPCTemplate {
	public static final int ID = 35507;

	@Inject
	protected Blacksmith8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
