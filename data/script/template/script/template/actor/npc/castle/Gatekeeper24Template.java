 ...
 */
public class Gatekeeper24Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35353;

	@Inject
	protected Gatekeeper24Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
