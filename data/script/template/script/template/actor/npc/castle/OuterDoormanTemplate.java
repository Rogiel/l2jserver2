 ...
 */
public class OuterDoormanTemplate extends CastleDoormenNPCTemplate {
	public static final int ID = 35096;

	@Inject
	protected OuterDoormanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
