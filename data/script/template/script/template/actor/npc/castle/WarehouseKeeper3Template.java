 ...
 */
public class WarehouseKeeper3Template extends CastleWarehouseNPCTemplate {
	public static final int ID = 35183;

	@Inject
	protected WarehouseKeeper3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
