 ...
 */
public class CourtMagician8Template extends CastleMagicianNPCTemplate {
	public static final int ID = 35654;

	@Inject
	protected CourtMagician8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
