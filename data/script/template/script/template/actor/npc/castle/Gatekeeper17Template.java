 ...
 */
public class Gatekeeper17Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35264;

	@Inject
	protected Gatekeeper17Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
