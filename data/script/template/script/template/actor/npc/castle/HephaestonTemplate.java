...
import com.l2jserver.model.template.npc.CastleWyvernManagerNPCTemplate;
import com.l2jserver.model.world.Actor.ActorSex;

/**
 * @author <a href="http://www.rogiel.com">Rogiel</a>
 */
public class HephaestonTemplate extends CastleWyvernManagerNPCTemplate {
	public static final int ID = 35419;

	@Inject
	protected HephaestonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hephaeston";
		this.serverSideName = false;
		this.title = "Wyvern Manager";
