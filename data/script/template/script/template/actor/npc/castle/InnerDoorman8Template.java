 ...
 */
public class InnerDoorman8Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35357;

	@Inject
	protected InnerDoorman8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
