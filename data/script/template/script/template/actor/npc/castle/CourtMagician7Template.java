 ...
 */
public class CourtMagician7Template extends CastleMagicianNPCTemplate {
	public static final int ID = 35653;

	@Inject
	protected CourtMagician7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
