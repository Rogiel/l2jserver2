 ...
 */
public class Gatekeeper30Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35499;

	@Inject
	protected Gatekeeper30Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
