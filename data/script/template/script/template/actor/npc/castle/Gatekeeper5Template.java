 ...
 */
public class Gatekeeper5Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35134;

	@Inject
	protected Gatekeeper5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
