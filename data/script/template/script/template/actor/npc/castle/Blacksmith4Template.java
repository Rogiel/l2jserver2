 ...
 */
public class Blacksmith4Template extends CastleBlacksmithNPCTemplate {
	public static final int ID = 35224;

	@Inject
	protected Blacksmith4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
