 ...
 */
public class OuterDoorman3Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35180;

	@Inject
	protected OuterDoorman3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
