 ...
 */
public class Gatekeeper3Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35093;

	@Inject
	protected Gatekeeper3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
