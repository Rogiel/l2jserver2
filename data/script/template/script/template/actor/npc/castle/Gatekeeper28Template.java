 ...
 */
public class Gatekeeper28Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35497;

	@Inject
	protected Gatekeeper28Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
