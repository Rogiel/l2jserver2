 ...
 */
public class BrasseurTemplate extends CastleChamberlainNPCTemplate {
	public static final int ID = 35226;

	@Inject
	protected BrasseurTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
