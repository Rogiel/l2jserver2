 ...
 */
public class Gatekeeper20Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35308;

	@Inject
	protected Gatekeeper20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
