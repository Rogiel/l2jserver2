 ...
 */
public class Gatekeeper10Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35178;

	@Inject
	protected Gatekeeper10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
