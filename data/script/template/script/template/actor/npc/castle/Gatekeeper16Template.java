 ...
 */
public class Gatekeeper16Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35263;

	@Inject
	protected Gatekeeper16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
