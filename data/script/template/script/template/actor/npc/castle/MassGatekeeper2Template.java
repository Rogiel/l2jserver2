 ...
 */
public class MassGatekeeper2Template extends CastleTeleporterNPCTemplate {
	public static final int ID = 35137;

	@Inject
	protected MassGatekeeper2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
