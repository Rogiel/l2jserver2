 ...
 */
public class MassGatekeeper6Template extends CastleTeleporterNPCTemplate {
	public static final int ID = 35311;

	@Inject
	protected MassGatekeeper6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mass Gatekeeper";
