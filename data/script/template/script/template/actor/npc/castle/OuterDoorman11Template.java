 ...
 */
public class OuterDoorman11Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35548;

	@Inject
	protected OuterDoorman11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Outer Doorman";
