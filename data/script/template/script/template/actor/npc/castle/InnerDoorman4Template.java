 ...
 */
public class InnerDoorman4Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35223;

	@Inject
	protected InnerDoorman4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
