 ...
 */
public class InnerDoorman5Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35268;

	@Inject
	protected InnerDoorman5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
