 ...
 */
public class InnerDoorman2Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35139;

	@Inject
	protected InnerDoorman2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
