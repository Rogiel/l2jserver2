 ...
 */
public class SaulTemplate extends CastleChamberlainNPCTemplate {
	public static final int ID = 35184;

	@Inject
	protected SaulTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
