 ...
 */
public class MassGatekeeper3Template extends CastleTeleporterNPCTemplate {
	public static final int ID = 35179;

	@Inject
	protected MassGatekeeper3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
