 ...
 */
public class LoganTemplate extends CastleChamberlainNPCTemplate {
	public static final int ID = 35274;

	@Inject
	protected LoganTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
