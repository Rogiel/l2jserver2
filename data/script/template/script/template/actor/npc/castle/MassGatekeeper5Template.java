 ...
 */
public class MassGatekeeper5Template extends CastleTeleporterNPCTemplate {
	public static final int ID = 35266;

	@Inject
	protected MassGatekeeper5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
