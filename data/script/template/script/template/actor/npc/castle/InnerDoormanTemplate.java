 ...
 */
public class InnerDoormanTemplate extends CastleDoormenNPCTemplate {
	public static final int ID = 35097;

	@Inject
	protected InnerDoormanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
