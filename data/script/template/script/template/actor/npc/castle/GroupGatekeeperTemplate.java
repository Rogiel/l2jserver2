 ...
 */
public class GroupGatekeeperTemplate extends CastleTeleporterNPCTemplate {
	public static final int ID = 35502;

	@Inject
	protected GroupGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
