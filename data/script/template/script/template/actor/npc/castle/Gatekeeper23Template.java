 ...
 */
public class Gatekeeper23Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35352;

	@Inject
	protected Gatekeeper23Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
