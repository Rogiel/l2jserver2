 ...
 */
public class Gatekeeper2Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35092;

	@Inject
	protected Gatekeeper2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
