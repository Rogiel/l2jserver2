 ...
 */
public class Gatekeeper14Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35261;

	@Inject
	protected Gatekeeper14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
