 ...
 */
public class BryceTemplate extends CastleWyvernManagerNPCTemplate {
	public static final int ID = 35185;

	@Inject
	protected BryceTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
