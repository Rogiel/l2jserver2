 ...
 */
public class Gatekeeper6Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35135;

	@Inject
	protected Gatekeeper6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
