 ...
 */
public class OuterDoorman4Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35222;

	@Inject
	protected OuterDoorman4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
