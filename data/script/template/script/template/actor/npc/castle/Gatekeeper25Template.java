 ...
 */
public class Gatekeeper25Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35354;

	@Inject
	protected Gatekeeper25Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
