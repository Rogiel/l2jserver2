 ...
 */
public class OuterDoorman7Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35356;

	@Inject
	protected OuterDoorman7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
