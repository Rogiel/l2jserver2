 ...
 */
public class Gatekeeper18Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35265;

	@Inject
	protected Gatekeeper18Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
