 ...
 */
public class AlfredTemplate extends CastleChamberlainNPCTemplate {
	public static final int ID = 35363;

	@Inject
	protected AlfredTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
