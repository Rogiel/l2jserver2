...
import com.l2jserver.model.template.npc.CastleWarehouseNPCTemplate;
import com.l2jserver.model.world.Actor.ActorSex;

/**
 * @author <a href="http://www.rogiel.com">Rogiel</a>
 */
public class WarehouseKeeper9Template extends CastleWarehouseNPCTemplate {
	public static final int ID = 35554;

	@Inject
	protected WarehouseKeeper9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Warehouse Keeper";
