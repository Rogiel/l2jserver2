 ...
 */
public class Gatekeeper8Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35176;

	@Inject
	protected Gatekeeper8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
