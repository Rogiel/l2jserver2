 ...
 */
public class AugustTemplate extends CastleChamberlainNPCTemplate {
	public static final int ID = 35555;

	@Inject
	protected AugustTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
