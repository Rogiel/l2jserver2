 ...
 */
public class WarehouseKeeper6Template extends CastleWarehouseNPCTemplate {
	public static final int ID = 35315;

	@Inject
	protected WarehouseKeeper6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
