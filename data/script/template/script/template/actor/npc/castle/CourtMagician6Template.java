 ...
 */
public class CourtMagician6Template extends CastleMagicianNPCTemplate {
	public static final int ID = 35652;

	@Inject
	protected CourtMagician6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
