 ...
 */
public class Gatekeeper27Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35360;

	@Inject
	protected Gatekeeper27Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
