 ...
 */
public class KrugerTemplate extends CastleWyvernManagerNPCTemplate {
	public static final int ID = 35275;

	@Inject
	protected KrugerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
