 ...
 */
public class Gatekeeper26Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35359;

	@Inject
	protected Gatekeeper26Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
