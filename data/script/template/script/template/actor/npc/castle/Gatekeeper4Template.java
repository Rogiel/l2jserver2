 ...
 */
public class Gatekeeper4Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35094;

	@Inject
	protected Gatekeeper4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
