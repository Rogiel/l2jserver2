 ...
 */
public class Gatekeeper32Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35501;

	@Inject
	protected Gatekeeper32Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
