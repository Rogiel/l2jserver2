 ...
 */
public class Blacksmith7Template extends CastleBlacksmithNPCTemplate {
	public static final int ID = 35361;

	@Inject
	protected Blacksmith7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
