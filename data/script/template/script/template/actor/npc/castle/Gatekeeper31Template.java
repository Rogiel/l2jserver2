 ...
 */
public class Gatekeeper31Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35500;

	@Inject
	protected Gatekeeper31Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
