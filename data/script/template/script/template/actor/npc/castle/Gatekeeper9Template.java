 ...
 */
public class Gatekeeper9Template extends CastleDoormenNPCTemplate {
	public static final int ID = 35177;

	@Inject
	protected Gatekeeper9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
