 ...
 */
public class Trap139Template extends NPCTemplate {
	public static final int ID = 18443;

	@Inject
	protected Trap139Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
