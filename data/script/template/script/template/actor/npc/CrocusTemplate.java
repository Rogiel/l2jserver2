 ...
 */
public class CrocusTemplate extends NPCTemplate {
	public static final int ID = 31545;

	@Inject
	protected CrocusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
