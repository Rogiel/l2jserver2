 ...
 */
public class DelusionManager22Template extends NPCTemplate {
	public static final int ID = 32685;

	@Inject
	protected DelusionManager22Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
