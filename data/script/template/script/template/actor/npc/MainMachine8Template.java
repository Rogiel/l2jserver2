 ...
 */
public class MainMachine8Template extends NPCTemplate {
	public static final int ID = 36190;

	@Inject
	protected MainMachine8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
