 ...
 */
public class OneEyedBatDroveAgathionTemplate extends NPCTemplate {
	public static final int ID = 1513;

	@Inject
	protected OneEyedBatDroveAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "One-Eyed Bat Drove Agathion";
