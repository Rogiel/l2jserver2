 ...
 */
public class MysteriousDarkElfTemplate extends NPCTemplate {
	public static final int ID = 30661;

	@Inject
	protected MysteriousDarkElfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mysterious Dark Elf";
