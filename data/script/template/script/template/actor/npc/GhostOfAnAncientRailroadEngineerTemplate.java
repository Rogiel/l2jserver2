 ...
 */
public class GhostOfAnAncientRailroadEngineerTemplate extends NPCTemplate {
	public static final int ID = 32055;

	@Inject
	protected GhostOfAnAncientRailroadEngineerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ghost of an Ancient Railroad Engineer";
