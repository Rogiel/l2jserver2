 ...
 */
public class JirroneTemplate extends NPCTemplate {
	public static final int ID = 32293;

	@Inject
	protected JirroneTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
