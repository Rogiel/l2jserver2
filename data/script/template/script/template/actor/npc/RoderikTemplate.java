 ...
 */
public class RoderikTemplate extends NPCTemplate {
	public static final int ID = 30631;

	@Inject
	protected RoderikTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
