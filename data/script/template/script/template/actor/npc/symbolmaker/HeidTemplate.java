 ...
 */
public class HeidTemplate extends SymbolMakerNPCTemplate {
	public static final int ID = 31052;

	@Inject
	protected HeidTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
