 ...
 */
public class RankarTemplate extends SymbolMakerNPCTemplate {
	public static final int ID = 31953;

	@Inject
	protected RankarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
