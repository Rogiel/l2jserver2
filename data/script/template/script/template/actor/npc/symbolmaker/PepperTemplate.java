 ...
 */
public class PepperTemplate extends SymbolMakerNPCTemplate {
	public static final int ID = 31049;

	@Inject
	protected PepperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
