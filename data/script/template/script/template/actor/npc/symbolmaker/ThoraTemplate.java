 ...
 */
public class ThoraTemplate extends SymbolMakerNPCTemplate {
	public static final int ID = 31050;

	@Inject
	protected ThoraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
