 ...
 */
public class AchimTemplate extends SymbolMakerNPCTemplate {
	public static final int ID = 31308;

	@Inject
	protected AchimTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
