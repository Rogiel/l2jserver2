 ...
 */
public class KellTemplate extends SymbolMakerNPCTemplate {
	public static final int ID = 31047;

	@Inject
	protected KellTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
