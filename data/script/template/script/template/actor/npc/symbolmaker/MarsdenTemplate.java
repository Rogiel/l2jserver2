 ...
 */
public class MarsdenTemplate extends SymbolMakerNPCTemplate {
	public static final int ID = 31046;

	@Inject
	protected MarsdenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
