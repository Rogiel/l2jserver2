 ...
 */
public class KidderTemplate extends SymbolMakerNPCTemplate {
	public static final int ID = 31053;

	@Inject
	protected KidderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
