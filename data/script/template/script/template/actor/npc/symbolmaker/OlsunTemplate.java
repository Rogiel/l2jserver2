 ...
 */
public class OlsunTemplate extends SymbolMakerNPCTemplate {
	public static final int ID = 31264;

	@Inject
	protected OlsunTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
