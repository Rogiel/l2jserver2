 ...
 */
package script.template.actor.npc.symbolmaker;

import com.google.inject.Inject;
import com.l2jserver.model.id.template.provider.ItemTemplateIDProvider;
import com.l2jserver.model.id.template.provider.NPCTemplateIDProvider;
import com.l2jserver.model.template.npc.SymbolMakerNPCTemplate;
import com.l2jserver.model.world.Actor.ActorSex;

/**
 * @author <a href="http://www.rogiel.com">Rogiel</a>
 */
public class McdermottTemplate extends SymbolMakerNPCTemplate {
	public static final int ID = 31048;

	@Inject
	protected McdermottTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "McDermott";
		this.serverSideName = false;
		this.title = "Symbol Maker";
