 ...
 */
public class KeachTemplate extends SymbolMakerNPCTemplate {
	public static final int ID = 31051;

	@Inject
	protected KeachTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
