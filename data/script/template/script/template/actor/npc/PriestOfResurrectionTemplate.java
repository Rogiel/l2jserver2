 ...
 */
public class PriestOfResurrectionTemplate extends NPCTemplate {
	public static final int ID = 32725;

	@Inject
	protected PriestOfResurrectionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Priest of Resurrection";
