 ...
 */
public class VelliorTemplate extends NPCTemplate {
	public static final int ID = 30305;

	@Inject
	protected VelliorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
