 ...
 */
public class EnergySeedWindTemplate extends NPCTemplate {
	public static final int ID = 18680;

	@Inject
	protected EnergySeedWindTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Energy Seed - Wind";
