 ...
 */
public class PilgrimOfDarkness2Template extends NPCTemplate {
	public static final int ID = 31641;

	@Inject
	protected PilgrimOfDarkness2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Pilgrim of Darkness";
		...
		this.rightHand = itemProvider.createID(318);
		this.leftHand = null;
		this.enchantLevel = 0;
