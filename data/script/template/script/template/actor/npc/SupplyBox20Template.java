 ...
 */
public class SupplyBox20Template extends NPCTemplate {
	public static final int ID = 36325;

	@Inject
	protected SupplyBox20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
