 ...
 */
public class RedfootTemplate extends NPCTemplate {
	public static final int ID = 30736;

	@Inject
	protected RedfootTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
