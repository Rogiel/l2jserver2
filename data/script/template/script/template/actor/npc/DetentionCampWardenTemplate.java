 ...
 */
public class DetentionCampWardenTemplate extends NPCTemplate {
	public static final int ID = 35666;

	@Inject
	protected DetentionCampWardenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
