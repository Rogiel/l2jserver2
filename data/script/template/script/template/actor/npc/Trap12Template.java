 ...
 */
public class Trap12Template extends NPCTemplate {
	public static final int ID = 13048;

	@Inject
	protected Trap12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
