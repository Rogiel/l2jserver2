 ...
 */
public class GlacierTemplate extends NPCTemplate {
	public static final int ID = 18853;

	@Inject
	protected GlacierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
