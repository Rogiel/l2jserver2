 ...
 */
public class ControlUnit5Template extends NPCTemplate {
	public static final int ID = 35985;

	@Inject
	protected ControlUnit5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
