 ...
 */
public class Trap83Template extends NPCTemplate {
	public static final int ID = 13247;

	@Inject
	protected Trap83Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
