 ...
 */
public class FurnaceTemplate extends NPCTemplate {
	public static final int ID = 18913;

	@Inject
	protected FurnaceTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
