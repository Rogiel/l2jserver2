 ...
 */
public class IceFairySculptureTemplate extends NPCTemplate {
	public static final int ID = 32031;

	@Inject
	protected IceFairySculptureTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ice Fairy Sculpture";
