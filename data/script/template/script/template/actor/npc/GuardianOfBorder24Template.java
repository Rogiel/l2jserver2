 ...
 */
public class GuardianOfBorder24Template extends NPCTemplate {
	public static final int ID = 31888;

	@Inject
	protected GuardianOfBorder24Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
