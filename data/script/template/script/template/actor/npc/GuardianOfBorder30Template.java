 ...
 */
public class GuardianOfBorder30Template extends NPCTemplate {
	public static final int ID = 31894;

	@Inject
	protected GuardianOfBorder30Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
