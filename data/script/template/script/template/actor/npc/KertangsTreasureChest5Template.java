 ...
 */
public class KertangsTreasureChest5Template extends NPCTemplate {
	public static final int ID = 18538;

	@Inject
	protected KertangsTreasureChest5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
