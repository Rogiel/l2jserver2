 ...
 */
public class LeopoldTemplate extends NPCTemplate {
	public static final int ID = 30435;

	@Inject
	protected LeopoldTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
