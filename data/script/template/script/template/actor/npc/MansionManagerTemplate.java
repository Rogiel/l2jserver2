 ...
 */
public class MansionManagerTemplate extends NPCTemplate {
	public static final int ID = 18599;

	@Inject
	protected MansionManagerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mansion Manager";
