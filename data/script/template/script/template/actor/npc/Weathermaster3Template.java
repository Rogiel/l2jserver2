 ...
 */
public class Weathermaster3Template extends NPCTemplate {
	public static final int ID = 32044;

	@Inject
	protected Weathermaster3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
