 ...
 */
public class Trap119Template extends NPCTemplate {
	public static final int ID = 18404;

	@Inject
	protected Trap119Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
