 ...
 */
public class GodOfFortuneTemplate extends NPCTemplate {
	public static final int ID = 1523;

	@Inject
	protected GodOfFortuneTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "God of Fortune";
