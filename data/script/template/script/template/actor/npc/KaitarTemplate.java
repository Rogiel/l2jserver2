 ...
 */
public class KaitarTemplate extends NPCTemplate {
	public static final int ID = 30359;

	@Inject
	protected KaitarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
