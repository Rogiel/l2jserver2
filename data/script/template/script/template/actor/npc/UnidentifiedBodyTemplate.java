 ...
 */
public class UnidentifiedBodyTemplate extends NPCTemplate {
	public static final int ID = 32568;

	@Inject
	protected UnidentifiedBodyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Unidentified Body";
