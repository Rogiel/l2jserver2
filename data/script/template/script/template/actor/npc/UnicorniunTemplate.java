 ...
 */
public class UnicorniunTemplate extends NPCTemplate {
	public static final int ID = 13155;

	@Inject
	protected UnicorniunTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Unicorniun";
