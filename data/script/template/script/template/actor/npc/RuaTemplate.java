 ...
 */
public class RuaTemplate extends NPCTemplate {
	public static final int ID = 32246;

	@Inject
	protected RuaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
