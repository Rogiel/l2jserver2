 ...
 */
public class Kegor2Template extends NPCTemplate {
	public static final int ID = 18851;

	@Inject
	protected Kegor2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
