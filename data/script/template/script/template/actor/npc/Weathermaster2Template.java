 ...
 */
public class Weathermaster2Template extends NPCTemplate {
	public static final int ID = 32043;

	@Inject
	protected Weathermaster2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Weathermaster";
