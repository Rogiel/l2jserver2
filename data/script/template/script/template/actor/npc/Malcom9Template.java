 ...
 */
public class Malcom9Template extends NPCTemplate {
	public static final int ID = 30944;

	@Inject
	protected Malcom9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Malcom9";
		this.serverSideName = false;
		this.title = "Human Prince";
