 ...
 */
public class RosellaTemplate extends NPCTemplate {
	public static final int ID = 30414;

	@Inject
	protected RosellaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
