 ...
 */
public class RosaliaTemplate extends NPCTemplate {
	public static final int ID = 4305;

	@Inject
	protected RosaliaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rosalia";
		this.serverSideName = false;
		this.title = "Hopeless Romantic";
