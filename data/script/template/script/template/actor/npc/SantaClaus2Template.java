 ...
 */
public class SantaClaus2Template extends NPCTemplate {
	public static final int ID = 13185;

	@Inject
	protected SantaClaus2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
