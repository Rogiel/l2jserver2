 ...
 */
public class EyeOfUdanMarduiTemplate extends NPCTemplate {
	public static final int ID = 31684;

	@Inject
	protected EyeOfUdanMarduiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Eye of Udan Mardui";
