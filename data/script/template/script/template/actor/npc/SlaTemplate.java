 ...
 */
public class SlaTemplate extends NPCTemplate {
	public static final int ID = 30666;

	@Inject
	protected SlaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
