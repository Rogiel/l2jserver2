 ...
 */
public class DwarfGolemTemplate extends NPCTemplate {
	public static final int ID = 13119;

	@Inject
	protected DwarfGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dwarf Golem";
