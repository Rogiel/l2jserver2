 ...
 */
public class SirCollinWindawoodTemplate extends NPCTemplate {
	public static final int ID = 30311;

	@Inject
	protected SirCollinWindawoodTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sir Collin Windawood";
