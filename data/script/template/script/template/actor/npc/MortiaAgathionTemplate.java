 ...
 */
public class MortiaAgathionTemplate extends NPCTemplate {
	public static final int ID = 1544;

	@Inject
	protected MortiaAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mortia Agathion";
