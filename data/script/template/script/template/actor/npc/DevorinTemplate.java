 ...
 */
public class DevorinTemplate extends NPCTemplate {
	public static final int ID = 32009;

	@Inject
	protected DevorinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
