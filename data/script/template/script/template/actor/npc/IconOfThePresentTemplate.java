 ...
 */
public class IconOfThePresentTemplate extends NPCTemplate {
	public static final int ID = 32256;

	@Inject
	protected IconOfThePresentTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Icon of the Present";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 54.00;
		this.collisionHeight = 245.00;
		this.level = 70;
