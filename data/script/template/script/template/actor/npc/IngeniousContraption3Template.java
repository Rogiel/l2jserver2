 ...
 */
public class IngeniousContraption3Template extends NPCTemplate {
	public static final int ID = 18496;

	@Inject
	protected IngeniousContraption3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
