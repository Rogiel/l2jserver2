 ...
 */
public class DimensionalVortex1Template extends NPCTemplate {
	public static final int ID = 30952;

	@Inject
	protected DimensionalVortex1Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dimensional Vortex 1";
