 ...
 */
public class RizraellTemplate extends NPCTemplate {
	public static final int ID = 30361;

	@Inject
	protected RizraellTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
