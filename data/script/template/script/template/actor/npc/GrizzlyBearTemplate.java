 ...
 */
public class GrizzlyBearTemplate extends NPCTemplate {
	public static final int ID = 13131;

	@Inject
	protected GrizzlyBearTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
