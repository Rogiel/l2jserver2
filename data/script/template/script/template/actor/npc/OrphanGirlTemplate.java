 ...
 */
public class OrphanGirlTemplate extends NPCTemplate {
	public static final int ID = 30659;

	@Inject
	protected OrphanGirlTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Orphan Girl";
