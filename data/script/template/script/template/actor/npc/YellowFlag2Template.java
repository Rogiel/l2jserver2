 ...
 */
public class YellowFlag2Template extends NPCTemplate {
	public static final int ID = 35608;

	@Inject
	protected YellowFlag2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Yellow Flag";
