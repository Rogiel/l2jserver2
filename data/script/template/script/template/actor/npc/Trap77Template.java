 ...
 */
public class Trap77Template extends NPCTemplate {
	public static final int ID = 13241;

	@Inject
	protected Trap77Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
