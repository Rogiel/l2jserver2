 ...
 */
public class GuardCaptain3Template extends NPCTemplate {
	public static final int ID = 35691;

	@Inject
	protected GuardCaptain3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
