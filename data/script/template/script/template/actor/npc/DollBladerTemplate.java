 ...
 */
public class DollBladerTemplate extends NPCTemplate {
	public static final int ID = 13111;

	@Inject
	protected DollBladerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
