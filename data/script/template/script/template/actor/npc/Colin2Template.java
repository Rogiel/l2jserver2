 ...
 */
public class Colin2Template extends NPCTemplate {
	public static final int ID = 32571;

	@Inject
	protected Colin2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Colin";
		this.serverSideName = false;
		this.title = "Secret Agent";
