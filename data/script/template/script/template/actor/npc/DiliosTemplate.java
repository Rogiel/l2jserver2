 ...
 */
public class DiliosTemplate extends NPCTemplate {
	public static final int ID = 32549;

	@Inject
	protected DiliosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
