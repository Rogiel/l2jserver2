 ...
 */
public class DoorGolemTemplate extends NPCTemplate {
	public static final int ID = 18922;

	@Inject
	protected DoorGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
