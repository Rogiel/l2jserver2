 ...
 */
public class FalkTemplate extends NPCTemplate {
	public static final int ID = 32297;

	@Inject
	protected FalkTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
