 ...
 */
public class GreenFlagTemplate extends NPCTemplate {
	public static final int ID = 35425;

	@Inject
	protected GreenFlagTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
