 ...
 */
public class Trap137Template extends NPCTemplate {
	public static final int ID = 18438;

	@Inject
	protected Trap137Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
