 ...
 */
public class GroupGatekeeper6Template extends NPCTemplate {
	public static final int ID = 35615;

	@Inject
	protected GroupGatekeeper6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
