 ...
 */
public class DetentionCampWarden20Template extends NPCTemplate {
	public static final int ID = 36326;

	@Inject
	protected DetentionCampWarden20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
