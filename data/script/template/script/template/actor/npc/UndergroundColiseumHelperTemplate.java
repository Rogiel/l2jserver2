 ...
 */
public class UndergroundColiseumHelperTemplate extends NPCTemplate {
	public static final int ID = 32491;

	@Inject
	protected UndergroundColiseumHelperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Underground Coliseum Helper";
