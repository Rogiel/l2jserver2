 ...
 */
public class SaberToothTigerTemplate extends NPCTemplate {
	public static final int ID = 13109;

	@Inject
	protected SaberToothTigerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Saber Tooth Tiger";
		...
		this.rightHand = itemProvider.createID(8190);
		this.leftHand = null;
		this.enchantLevel = 0;
