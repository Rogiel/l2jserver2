 ...
 */
public class SleinShiningBladeTemplate extends NPCTemplate {
	public static final int ID = 30663;

	@Inject
	protected SleinShiningBladeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Slein Shining Blade";
