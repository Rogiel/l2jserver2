 ...
 */
public class DancingLuckyKidAgathionTemplate extends NPCTemplate {
	public static final int ID = 1531;

	@Inject
	protected DancingLuckyKidAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dancing Lucky Kid Agathion";
