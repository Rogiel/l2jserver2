 ...
 */
public class MercenaryPrivate2Template extends NPCTemplate {
	public static final int ID = 35725;

	@Inject
	protected MercenaryPrivate2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
