 ...
 */
public class LokenTemplate extends NPCTemplate {
	public static final int ID = 35420;

	@Inject
	protected LokenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
