 ...
 */
public class NottingaleTemplate extends NPCTemplate {
	public static final int ID = 32627;

	@Inject
	protected NottingaleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nottingale";
