 ...
 */
public class MasterYogiTemplate extends NPCTemplate {
	public static final int ID = 32599;

	@Inject
	protected MasterYogiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Master Yogi";
		this.serverSideName = false;
		this.title = "Mountain Ascetic";
