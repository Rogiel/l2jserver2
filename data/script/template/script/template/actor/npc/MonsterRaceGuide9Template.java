 ...
 */
public class MonsterRaceGuide9Template extends NPCTemplate {
	public static final int ID = 31412;

	@Inject
	protected MonsterRaceGuide9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Monster Race Guide";
		this.serverSideName = false;
		this.title = "Rune Township";
