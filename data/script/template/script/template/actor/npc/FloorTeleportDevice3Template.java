 ...
 */
public class FloorTeleportDevice3Template extends NPCTemplate {
	public static final int ID = 32755;

	@Inject
	protected FloorTeleportDevice3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
