 ...
 */
public class KrateisSteward2Template extends NPCTemplate {
	public static final int ID = 18600;

	@Inject
	protected KrateisSteward2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kratei's Steward";
