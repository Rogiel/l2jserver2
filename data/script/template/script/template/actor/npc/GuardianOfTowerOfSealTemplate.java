 ...
 */
public class GuardianOfTowerOfSealTemplate extends NPCTemplate {
	public static final int ID = 32663;

	@Inject
	protected GuardianOfTowerOfSealTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guardian of Tower of Seal";
