 ...
 */
public class Gardener2Template extends NPCTemplate {
	public static final int ID = 18586;

	@Inject
	protected Gardener2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
