 ...
 */
public class Auctioneer5Template extends AuctioneerNPCTemplate {
	public static final int ID = 30771;

	@Inject
	protected Auctioneer5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
