 ...
 */
public class AuctioneerTemplate extends AuctioneerNPCTemplate {
	public static final int ID = 30767;

	@Inject
	protected AuctioneerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
