 ...
 */
public class Auctioneer4Template extends AuctioneerNPCTemplate {
	public static final int ID = 30770;

	@Inject
	protected Auctioneer4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
