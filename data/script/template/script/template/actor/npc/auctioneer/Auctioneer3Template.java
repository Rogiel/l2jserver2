 ...
 */
public class Auctioneer3Template extends AuctioneerNPCTemplate {
	public static final int ID = 30769;

	@Inject
	protected Auctioneer3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
