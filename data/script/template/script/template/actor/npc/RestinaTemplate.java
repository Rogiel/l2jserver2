 ...
 */
public class RestinaTemplate extends NPCTemplate {
	public static final int ID = 30926;

	@Inject
	protected RestinaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
