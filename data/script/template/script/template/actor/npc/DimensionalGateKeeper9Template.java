 ...
 */
public class DimensionalGateKeeper9Template extends NPCTemplate {
	public static final int ID = 31502;

	@Inject
	protected DimensionalGateKeeper9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
