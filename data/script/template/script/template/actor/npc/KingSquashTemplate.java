 ...
 */
public class KingSquashTemplate extends NPCTemplate {
	public static final int ID = 13016;

	@Inject
	protected KingSquashTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "King Squash";
