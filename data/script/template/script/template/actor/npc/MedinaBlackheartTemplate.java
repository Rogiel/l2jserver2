 ...
 */
public class MedinaBlackheartTemplate extends NPCTemplate {
	public static final int ID = 31598;

	@Inject
	protected MedinaBlackheartTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Medina Blackheart";
