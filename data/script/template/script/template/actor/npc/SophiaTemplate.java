 ...
 */
public class SophiaTemplate extends NPCTemplate {
	public static final int ID = 32596;

	@Inject
	protected SophiaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sophia";
		this.serverSideName = false;
		this.title = "Library of Sages Director";
