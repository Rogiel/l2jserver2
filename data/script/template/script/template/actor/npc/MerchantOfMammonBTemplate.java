 ...
 */
public class MerchantOfMammonBTemplate extends NPCTemplate {
	public static final int ID = 18825;

	@Inject
	protected MerchantOfMammonBTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Merchant of Mammon B";
