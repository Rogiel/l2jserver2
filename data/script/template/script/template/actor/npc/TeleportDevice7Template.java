 ...
 */
public class TeleportDevice7Template extends NPCTemplate {
	public static final int ID = 32751;

	@Inject
	protected TeleportDevice7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
