 ...
 */
public class FireFeedTemplate extends NPCTemplate {
	public static final int ID = 18933;

	@Inject
	protected FireFeedTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
