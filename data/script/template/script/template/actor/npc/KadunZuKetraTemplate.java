 ...
 */
public class KadunZuKetraTemplate extends NPCTemplate {
	public static final int ID = 31370;

	@Inject
	protected KadunZuKetraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kadun Zu Ketra";
