 ...
 */
public class EntranceManager2Template extends NPCTemplate {
	public static final int ID = 32521;

	@Inject
	protected EntranceManager2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Entrance Manager";
		this.serverSideName = false;
		this.title = "Handy's Block Checker - Arena 1";
