 ...
 */
public class RosheekTemplate extends NPCTemplate {
	public static final int ID = 30590;

	@Inject
	protected RosheekTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
