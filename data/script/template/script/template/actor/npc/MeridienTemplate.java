 ...
 */
public class MeridienTemplate extends NPCTemplate {
	public static final int ID = 30948;

	@Inject
	protected MeridienTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
