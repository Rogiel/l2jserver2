 ...
 */
public class SorrowTemplate extends NPCTemplate {
	public static final int ID = 16057;

	@Inject
	protected SorrowTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
