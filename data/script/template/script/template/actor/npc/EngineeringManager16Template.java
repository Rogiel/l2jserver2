 ...
 */
public class EngineeringManager16Template extends NPCTemplate {
	public static final int ID = 36178;

	@Inject
	protected EngineeringManager16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Engineering Manager";
