 ...
 */
public class PippiTemplate extends NPCTemplate {
	public static final int ID = 30524;

	@Inject
	protected PippiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
