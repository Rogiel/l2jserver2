 ...
 */
public class GuardianOfBorder7Template extends NPCTemplate {
	public static final int ID = 31871;

	@Inject
	protected GuardianOfBorder7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
