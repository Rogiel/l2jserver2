 ...
 */
public class NaoninAgathionTemplate extends NPCTemplate {
	public static final int ID = 1550;

	@Inject
	protected NaoninAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Naonin Agathion";
