 ...
 */
public class RabbitTemplate extends NPCTemplate {
	public static final int ID = 13096;

	@Inject
	protected RabbitTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
