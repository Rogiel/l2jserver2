 ...
 */
public class MonsterRaceGuideTemplate extends NPCTemplate {
	public static final int ID = 31404;

	@Inject
	protected MonsterRaceGuideTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Monster Race Guide";
		this.serverSideName = false;
		this.title = "Town of Gludio";
