 ...
 */
public class TurnedBoyTemplate extends NPCTemplate {
	public static final int ID = 18584;

	@Inject
	protected TurnedBoyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Turned Boy";
