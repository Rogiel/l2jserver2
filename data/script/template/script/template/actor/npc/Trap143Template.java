 ...
 */
public class Trap143Template extends NPCTemplate {
	public static final int ID = 18720;

	@Inject
	protected Trap143Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
