 ...
 */
public class TrejuoTemplate extends NPCTemplate {
	public static final int ID = 33;

	@Inject
	protected TrejuoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Trejuo";
		this.serverSideName = false;
		this.title = "Blessed Child";
