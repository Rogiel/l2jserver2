 ...
 */
public class KuberTemplate extends NPCTemplate {
	public static final int ID = 31546;

	@Inject
	protected KuberTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
