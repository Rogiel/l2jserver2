 ...
 */
public class Trap87Template extends NPCTemplate {
	public static final int ID = 13251;

	@Inject
	protected Trap87Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
