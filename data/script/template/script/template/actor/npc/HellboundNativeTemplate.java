 ...
 */
public class HellboundNativeTemplate extends NPCTemplate {
	public static final int ID = 32362;

	@Inject
	protected HellboundNativeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hellbound Native";
