 ...
 */
public class JoyTemplate extends NPCTemplate {
	public static final int ID = 16056;

	@Inject
	protected JoyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
