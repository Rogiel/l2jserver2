 ...
 */
public class ForgottenMonument2Template extends NPCTemplate {
	public static final int ID = 31662;

	@Inject
	protected ForgottenMonument2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
