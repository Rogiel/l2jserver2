 ...
 */
public class DelusionManager37Template extends NPCTemplate {
	public static final int ID = 32700;

	@Inject
	protected DelusionManager37Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
