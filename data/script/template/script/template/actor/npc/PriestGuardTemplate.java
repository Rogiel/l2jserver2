 ...
 */
public class PriestGuardTemplate extends NPCTemplate {
	public static final int ID = 32126;

	@Inject
	protected PriestGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
