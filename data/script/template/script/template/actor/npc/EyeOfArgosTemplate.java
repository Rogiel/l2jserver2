 ...
 */
public class EyeOfArgosTemplate extends NPCTemplate {
	public static final int ID = 31683;

	@Inject
	protected EyeOfArgosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Eye of Argos";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 205.00;
		this.collisionHeight = 305.00;
		this.level = 70;
		this.sex = null;
		this.attackRange = 40;
