 ...
 */
public class DimensionalGateKeeper6Template extends NPCTemplate {
	public static final int ID = 31499;

	@Inject
	protected DimensionalGateKeeper6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
