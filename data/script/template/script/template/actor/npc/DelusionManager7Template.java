 ...
 */
public class DelusionManager7Template extends NPCTemplate {
	public static final int ID = 32670;

	@Inject
	protected DelusionManager7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
