 ...
 */
public class HeadMilkCowTemplate extends NPCTemplate {
	public static final int ID = 13188;

	@Inject
	protected HeadMilkCowTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Head Milk Cow";
