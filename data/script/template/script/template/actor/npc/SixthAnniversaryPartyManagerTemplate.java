 ...
 */
public class SixthAnniversaryPartyManagerTemplate extends NPCTemplate {
	public static final int ID = 32732;

	@Inject
	protected SixthAnniversaryPartyManagerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sixth Anniversary Party Manager";
