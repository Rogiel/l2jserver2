 ...
 */
public class Trap138Template extends NPCTemplate {
	public static final int ID = 18442;

	@Inject
	protected Trap138Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
