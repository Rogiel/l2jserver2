 ...
 */
public class General5Template extends NPCTemplate {
	public static final int ID = 35862;

	@Inject
	protected General5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
