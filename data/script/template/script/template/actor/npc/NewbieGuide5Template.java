 ...
 */
public class NewbieGuide5Template extends NPCTemplate {
	public static final int ID = 30602;

	@Inject
	protected NewbieGuide5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
