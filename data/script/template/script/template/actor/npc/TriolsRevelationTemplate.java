 ...
 */
public class TriolsRevelationTemplate extends NPCTemplate {
	public static final int ID = 32058;

	@Inject
	protected TriolsRevelationTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
