 ...
 */
public class LureTowTemplate extends NPCTemplate {
	public static final int ID = 13164;

	@Inject
	protected LureTowTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.walkSpeed = 155.00000;
