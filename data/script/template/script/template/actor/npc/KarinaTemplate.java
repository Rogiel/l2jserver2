 ...
 */
public class KarinaTemplate extends NPCTemplate {
	public static final int ID = 30352;

	@Inject
	protected KarinaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
