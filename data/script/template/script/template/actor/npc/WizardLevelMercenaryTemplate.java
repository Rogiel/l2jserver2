 ...
 */
public class WizardLevelMercenaryTemplate extends NPCTemplate {
	public static final int ID = 13177;

	@Inject
	protected WizardLevelMercenaryTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Wizard Level Mercenary";
