 ...
 */
public class Toma2Template extends NPCTemplate {
	public static final int ID = 30556;

	@Inject
	protected Toma2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
