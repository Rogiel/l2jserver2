 ...
 */
public class Flagpole8Template extends NPCTemplate {
	public static final int ID = 35895;

	@Inject
	protected Flagpole8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
