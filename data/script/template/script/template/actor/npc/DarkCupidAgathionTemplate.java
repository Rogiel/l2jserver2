 ...
 */
public class DarkCupidAgathionTemplate extends NPCTemplate {
	public static final int ID = 1509;

	@Inject
	protected DarkCupidAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Cupid Agathion";
