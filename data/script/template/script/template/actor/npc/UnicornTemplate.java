 ...
 */
public class UnicornTemplate extends NPCTemplate {
	public static final int ID = 13081;

	@Inject
	protected UnicornTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
