 ...
 */
public class Trap172Template extends NPCTemplate {
	public static final int ID = 18749;

	@Inject
	protected Trap172Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
