 ...
 */
public class Flagpole20Template extends NPCTemplate {
	public static final int ID = 36316;

	@Inject
	protected Flagpole20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
