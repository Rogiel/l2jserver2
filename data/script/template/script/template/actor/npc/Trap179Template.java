 ...
 */
public class Trap179Template extends NPCTemplate {
	public static final int ID = 18756;

	@Inject
	protected Trap179Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
