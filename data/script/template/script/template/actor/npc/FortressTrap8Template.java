 ...
 */
public class FortressTrap8Template extends NPCTemplate {
	public static final int ID = 36419;

	@Inject
	protected FortressTrap8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
