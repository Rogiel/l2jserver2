 ...
 */
public class ClosedMouthOfEkimusTemplate extends NPCTemplate {
	public static final int ID = 32538;

	@Inject
	protected ClosedMouthOfEkimusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Closed Mouth of Ekimus";
