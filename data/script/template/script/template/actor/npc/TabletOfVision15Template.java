 ...
 */
public class TabletOfVision15Template extends NPCTemplate {
	public static final int ID = 31660;

	@Inject
	protected TabletOfVision15Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tablet of Vision";
