 ...
 */
public class WinnieTheCatTemplate extends NPCTemplate {
	public static final int ID = 31229;

	@Inject
	protected WinnieTheCatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Winnie the Cat";
