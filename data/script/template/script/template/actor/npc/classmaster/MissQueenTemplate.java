 ...
 */
package script.template.actor.npc.classmaster;

import com.google.inject.Inject;
import com.l2jserver.model.id.template.provider.ItemTemplateIDProvider;
import com.l2jserver.model.id.template.provider.NPCTemplateIDProvider;
import com.l2jserver.model.template.npc.ClassMasterNPCTemplate;
import com.l2jserver.model.world.Actor.ActorSex;

/**
 * @author <a href="http://www.rogiel.com">Rogiel</a>
 */
public class MissQueenTemplate extends ClassMasterNPCTemplate {
	public static final int ID = 31757;

	@Inject
	protected MissQueenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Miss Queen";
		this.serverSideName = false;
		this.title = "Test Server Helper";
