 ...
 */
public class MrCatTemplate extends ClassMasterNPCTemplate {
	public static final int ID = 31756;

	@Inject
	protected MrCatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
