 ...
 */
public class Trap169Template extends NPCTemplate {
	public static final int ID = 18746;

	@Inject
	protected Trap169Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
