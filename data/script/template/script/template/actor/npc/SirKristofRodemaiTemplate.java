 ...
 */
public class SirKristofRodemaiTemplate extends NPCTemplate {
	public static final int ID = 30756;

	@Inject
	protected SirKristofRodemaiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sir Kristof Rodemai";
