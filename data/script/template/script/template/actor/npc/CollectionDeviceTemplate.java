 ...
 */
public class CollectionDeviceTemplate extends NPCTemplate {
	public static final int ID = 16061;

	@Inject
	protected CollectionDeviceTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Collection Device";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 5.50;
		this.collisionHeight = 6.25;
		this.level = 55;
