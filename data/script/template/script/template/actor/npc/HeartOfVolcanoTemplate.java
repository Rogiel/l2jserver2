 ...
 */
public class HeartOfVolcanoTemplate extends NPCTemplate {
	public static final int ID = 31385;

	@Inject
	protected HeartOfVolcanoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Heart of Volcano";
