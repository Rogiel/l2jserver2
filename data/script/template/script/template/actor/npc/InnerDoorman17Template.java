 ...
 */
public class InnerDoorman17Template extends NPCTemplate {
	public static final int ID = 35624;

	@Inject
	protected InnerDoorman17Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
