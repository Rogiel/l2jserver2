 ...
 */
public class Trap101Template extends NPCTemplate {
	public static final int ID = 18386;

	@Inject
	protected Trap101Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
