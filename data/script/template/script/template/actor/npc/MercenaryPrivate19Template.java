 ...
 */
public class MercenaryPrivate19Template extends NPCTemplate {
	public static final int ID = 36315;

	@Inject
	protected MercenaryPrivate19Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
