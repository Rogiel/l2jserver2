 ...
 */
public class FairyPrincessTemplate extends BabyPetNPCTemplate {
	public static final int ID = 16046;

	@Inject
	protected FairyPrincessTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fairy Princess";
