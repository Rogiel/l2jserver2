 ...
 */
public class BabyKookaburraTemplate extends BabyPetNPCTemplate {
	public static final int ID = 12781;

	@Inject
	protected BabyKookaburraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Baby Kookaburra";
