 ...
 */
public class WhiteWeaselTemplate extends BabyPetNPCTemplate {
	public static final int ID = 16045;

	@Inject
	protected WhiteWeaselTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "White Weasel";
