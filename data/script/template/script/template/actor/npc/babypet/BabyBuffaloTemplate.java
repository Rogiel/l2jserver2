 ...
 */
public class BabyBuffaloTemplate extends BabyPetNPCTemplate {
	public static final int ID = 12780;

	@Inject
	protected BabyBuffaloTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Baby Buffalo";
