 ...
 */
public class ImprovedBabyKookaburraTemplate extends BabyPetNPCTemplate {
	public static final int ID = 16035;

	@Inject
	protected ImprovedBabyKookaburraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Improved Baby Kookaburra";
