 ...
 */
public class ToyKnightTemplate extends BabyPetNPCTemplate {
	public static final int ID = 16052;

	@Inject
	protected ToyKnightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Toy Knight";
