 ...
 */
public class BabyCougarTemplate extends BabyPetNPCTemplate {
	public static final int ID = 12782;

	@Inject
	protected BabyCougarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Baby Cougar";
