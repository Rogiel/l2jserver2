 ...
 */
public class TurtleAsceticTemplate extends BabyPetNPCTemplate {
	public static final int ID = 16053;

	@Inject
	protected TurtleAsceticTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Turtle Ascetic";
		...
		attributes.intelligence = 26;
		attributes.strength = 38;
		attributes.concentration = 40;
