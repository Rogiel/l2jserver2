 ...
 */
public class ImprovedBabyCougarTemplate extends BabyPetNPCTemplate {
	public static final int ID = 16036;

	@Inject
	protected ImprovedBabyCougarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Improved Baby Cougar";
