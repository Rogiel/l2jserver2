 ...
 */
public class ImprovedBabyBuffaloTemplate extends BabyPetNPCTemplate {
	public static final int ID = 16034;

	@Inject
	protected ImprovedBabyBuffaloTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Improved Baby Buffalo";
