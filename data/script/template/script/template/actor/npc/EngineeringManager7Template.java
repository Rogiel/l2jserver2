 ...
 */
public class EngineeringManager7Template extends NPCTemplate {
	public static final int ID = 35864;

	@Inject
	protected EngineeringManager7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
