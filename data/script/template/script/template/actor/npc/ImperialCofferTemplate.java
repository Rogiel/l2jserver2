 ...
 */
public class ImperialCofferTemplate extends NPCTemplate {
	public static final int ID = 30765;

	@Inject
	protected ImperialCofferTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Imperial Coffer";
