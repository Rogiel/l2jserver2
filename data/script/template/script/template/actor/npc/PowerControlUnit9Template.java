 ...
 */
public class PowerControlUnit9Template extends NPCTemplate {
	public static final int ID = 35948;

	@Inject
	protected PowerControlUnit9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
