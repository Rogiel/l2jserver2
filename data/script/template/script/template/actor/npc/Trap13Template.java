 ...
 */
public class Trap13Template extends NPCTemplate {
	public static final int ID = 13049;

	@Inject
	protected Trap13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
