 ...
 */
public class Warpgate4Template extends NPCTemplate {
	public static final int ID = 32317;

	@Inject
	protected Warpgate4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
