 ...
 */
public class ObiTemplate extends NPCTemplate {
	public static final int ID = 32052;

	@Inject
	protected ObiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
