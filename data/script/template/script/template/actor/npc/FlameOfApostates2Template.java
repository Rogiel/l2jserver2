 ...
 */
public class FlameOfApostates2Template extends NPCTemplate {
	public static final int ID = 18311;

	@Inject
	protected FlameOfApostates2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
