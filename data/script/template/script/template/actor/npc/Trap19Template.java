 ...
 */
public class Trap19Template extends NPCTemplate {
	public static final int ID = 13055;

	@Inject
	protected Trap19Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
