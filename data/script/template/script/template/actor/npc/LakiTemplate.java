 ...
 */
public class LakiTemplate extends NPCTemplate {
	public static final int ID = 32742;

	@Inject
	protected LakiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
