 ...
 */
public class Warden7Template extends NPCTemplate {
	public static final int ID = 36409;

	@Inject
	protected Warden7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
