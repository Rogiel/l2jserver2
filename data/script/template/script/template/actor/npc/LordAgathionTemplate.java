 ...
 */
public class LordAgathionTemplate extends NPCTemplate {
	public static final int ID = 16028;

	@Inject
	protected LordAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lord Agathion";
