 ...
 */
public class Trap54Template extends NPCTemplate {
	public static final int ID = 13218;

	@Inject
	protected Trap54Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
