 ...
 */
public class FortressTrap5Template extends NPCTemplate {
	public static final int ID = 36416;

	@Inject
	protected FortressTrap5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
