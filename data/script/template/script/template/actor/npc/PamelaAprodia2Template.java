 ...
 */
public class PamelaAprodia2Template extends NPCTemplate {
	public static final int ID = 31601;

	@Inject
	protected PamelaAprodia2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Pamela Aprodia";
