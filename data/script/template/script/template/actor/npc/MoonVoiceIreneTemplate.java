 ...
 */
public class MoonVoiceIreneTemplate extends NPCTemplate {
	public static final int ID = 31618;

	@Inject
	protected MoonVoiceIreneTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Moon Voice Irene";
		...
		this.leftHand = itemProvider.createID(109);
		this.enchantLevel = 0;
