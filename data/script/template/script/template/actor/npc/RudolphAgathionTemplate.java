 ...
 */
public class RudolphAgathionTemplate extends NPCTemplate {
	public static final int ID = 16033;

	@Inject
	protected RudolphAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
