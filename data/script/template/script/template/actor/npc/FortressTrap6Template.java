 ...
 */
public class FortressTrap6Template extends NPCTemplate {
	public static final int ID = 36417;

	@Inject
	protected FortressTrap6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
