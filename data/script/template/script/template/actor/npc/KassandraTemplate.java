 ...
 */
public class KassandraTemplate extends NPCTemplate {
	public static final int ID = 31743;

	@Inject
	protected KassandraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
