 ...
 */
public class SariaTemplate extends NPCTemplate {
	public static final int ID = 32251;

	@Inject
	protected SariaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
