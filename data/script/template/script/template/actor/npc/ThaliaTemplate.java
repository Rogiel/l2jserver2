 ...
 */
public class ThaliaTemplate extends NPCTemplate {
	public static final int ID = 30371;

	@Inject
	protected ThaliaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
