 ...
 */
public class ToadTemplate extends NPCTemplate {
	public static final int ID = 30740;

	@Inject
	protected ToadTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
