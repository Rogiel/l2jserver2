 ...
 */
public class HereticMaleTemplate extends NPCTemplate {
	public static final int ID = 13106;

	@Inject
	protected HereticMaleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Heretic Male";
