 ...
 */
public class Trap112Template extends NPCTemplate {
	public static final int ID = 18397;

	@Inject
	protected Trap112Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
