 ...
 */
public class JeremyTemplate extends NPCTemplate {
	public static final int ID = 31521;

	@Inject
	protected JeremyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
