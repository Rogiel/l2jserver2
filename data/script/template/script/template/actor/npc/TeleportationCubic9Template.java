 ...
 */
public class TeleportationCubic9Template extends NPCTemplate {
	public static final int ID = 32375;

	@Inject
	protected TeleportationCubic9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
