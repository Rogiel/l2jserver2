 ...
 */
public class Trap60Template extends NPCTemplate {
	public static final int ID = 13224;

	@Inject
	protected Trap60Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
