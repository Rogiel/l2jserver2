 ...
 */
public class MercenaryPrivate15Template extends NPCTemplate {
	public static final int ID = 36170;

	@Inject
	protected MercenaryPrivate15Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
