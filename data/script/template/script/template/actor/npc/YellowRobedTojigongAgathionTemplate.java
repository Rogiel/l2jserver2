 ...
 */
public class YellowRobedTojigongAgathionTemplate extends NPCTemplate {
	public static final int ID = 1515;

	@Inject
	protected YellowRobedTojigongAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Yellow-Robed Tojigong Agathion";
