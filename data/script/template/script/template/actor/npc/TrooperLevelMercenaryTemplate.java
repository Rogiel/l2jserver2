 ...
 */
public class TrooperLevelMercenaryTemplate extends NPCTemplate {
	public static final int ID = 13178;

	@Inject
	protected TrooperLevelMercenaryTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Trooper Level Mercenary";
