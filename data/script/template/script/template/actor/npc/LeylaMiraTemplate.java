 ...
 */
public class LeylaMiraTemplate extends NPCTemplate {
	public static final int ID = 32431;

	@Inject
	protected LeylaMiraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Leyla Mira";
		this.serverSideName = false;
		this.title = "Elf Singer";
