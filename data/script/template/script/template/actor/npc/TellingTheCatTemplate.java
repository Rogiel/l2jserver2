 ...
 */
public class TellingTheCatTemplate extends NPCTemplate {
	public static final int ID = 32103;

	@Inject
	protected TellingTheCatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Telling the Cat";
