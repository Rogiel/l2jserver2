 ...
 */
public class Warden9Template extends NPCTemplate {
	public static final int ID = 36411;

	@Inject
	protected Warden9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
