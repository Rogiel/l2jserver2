 ...
 */
public class TerritoryCatapult13Template extends NPCTemplate {
	public static final int ID = 36584;

	@Inject
	protected TerritoryCatapult13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Territory Catapult";
		this.serverSideName = false;
		this.title = "Oren";
		this.serverSideTitle = false;
		this.collisionRadius = 125.00;
