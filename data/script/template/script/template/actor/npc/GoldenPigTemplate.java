 ...
 */
public class GoldenPigTemplate extends NPCTemplate {
	public static final int ID = 13035;

	@Inject
	protected GoldenPigTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Golden Pig";
