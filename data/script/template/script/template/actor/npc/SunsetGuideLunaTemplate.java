 ...
 */
public class SunsetGuideLunaTemplate extends NPCTemplate {
	public static final int ID = 31591;

	@Inject
	protected SunsetGuideLunaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sunset Guide Luna";
