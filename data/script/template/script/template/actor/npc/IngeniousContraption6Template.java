 ...
 */
public class IngeniousContraption6Template extends NPCTemplate {
	public static final int ID = 18499;

	@Inject
	protected IngeniousContraption6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
