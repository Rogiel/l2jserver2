 ...
 */
public class GuardsOfTheDawn2Template extends NPCTemplate {
	public static final int ID = 18834;

	@Inject
	protected GuardsOfTheDawn2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
