 ...
 */
public class EngineeringManager4Template extends NPCTemplate {
	public static final int ID = 35764;

	@Inject
	protected EngineeringManager4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
