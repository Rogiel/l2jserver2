 ...
 */
public class TataruZuHestuiTemplate extends NPCTemplate {
	public static final int ID = 30585;

	@Inject
	protected TataruZuHestuiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tataru Zu Hestui";
