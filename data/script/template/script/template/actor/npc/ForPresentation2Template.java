 ...
 */
public class ForPresentation2Template extends NPCTemplate {
	public static final int ID = 13150;

	@Inject
	protected ForPresentation2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "For Presentation 2";
