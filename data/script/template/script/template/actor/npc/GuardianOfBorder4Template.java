 ...
 */
public class GuardianOfBorder4Template extends NPCTemplate {
	public static final int ID = 31868;

	@Inject
	protected GuardianOfBorder4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
