 ...
 */
public class MikiTheCatTemplate extends NPCTemplate {
	public static final int ID = 31706;

	@Inject
	protected MikiTheCatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Miki the Cat";
