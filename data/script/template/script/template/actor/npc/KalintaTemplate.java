 ...
 */
public class KalintaTemplate extends NPCTemplate {
	public static final int ID = 30422;

	@Inject
	protected KalintaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
