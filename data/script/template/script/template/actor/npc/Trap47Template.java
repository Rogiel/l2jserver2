 ...
 */
public class Trap47Template extends NPCTemplate {
	public static final int ID = 13211;

	@Inject
	protected Trap47Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
