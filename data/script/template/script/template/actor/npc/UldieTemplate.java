 ...
 */
public class UldieTemplate extends NPCTemplate {
	public static final int ID = 13279;

	@Inject
	protected UldieTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
