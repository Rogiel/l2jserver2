 ...
 */
public class EvilAltarTemplate extends NPCTemplate {
	public static final int ID = 31512;

	@Inject
	protected EvilAltarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
