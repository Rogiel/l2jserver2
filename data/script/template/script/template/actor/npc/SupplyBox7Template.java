 ...
 */
public class SupplyBox7Template extends NPCTemplate {
	public static final int ID = 35866;

	@Inject
	protected SupplyBox7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
