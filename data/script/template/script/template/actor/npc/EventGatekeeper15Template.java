 ...
 */
public class EventGatekeeper15Template extends NPCTemplate {
	public static final int ID = 31768;

	@Inject
	protected EventGatekeeper15Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
