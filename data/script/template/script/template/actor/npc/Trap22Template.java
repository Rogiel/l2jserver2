 ...
 */
public class Trap22Template extends NPCTemplate {
	public static final int ID = 13058;

	@Inject
	protected Trap22Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
