 ...
 */
public class FestivalGuideTemplate extends FestivalGuideNPCTemplate {
	public static final int ID = 31127;

	@Inject
	protected FestivalGuideTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
