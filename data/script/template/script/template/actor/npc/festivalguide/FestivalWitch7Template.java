 ...
 */
public class FestivalWitch7Template extends FestivalGuideNPCTemplate {
	public static final int ID = 31143;

	@Inject
	protected FestivalWitch7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
