 ...
 */
public class FestivalWitch2Template extends FestivalGuideNPCTemplate {
	public static final int ID = 31133;

	@Inject
	protected FestivalWitch2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
