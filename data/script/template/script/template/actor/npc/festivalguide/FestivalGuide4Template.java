 ...
 */
public class FestivalGuide4Template extends FestivalGuideNPCTemplate {
	public static final int ID = 31130;

	@Inject
	protected FestivalGuide4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
