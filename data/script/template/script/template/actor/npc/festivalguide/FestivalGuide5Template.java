 ...
 */
public class FestivalGuide5Template extends FestivalGuideNPCTemplate {
	public static final int ID = 31131;

	@Inject
	protected FestivalGuide5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
