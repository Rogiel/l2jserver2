 ...
 */
public class FestivalGuide3Template extends FestivalGuideNPCTemplate {
	public static final int ID = 31129;

	@Inject
	protected FestivalGuide3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
