 ...
 */
public class FestivalGuide2Template extends FestivalGuideNPCTemplate {
	public static final int ID = 31128;

	@Inject
	protected FestivalGuide2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
