 ...
 */
public class FestivalWitch5Template extends FestivalGuideNPCTemplate {
	public static final int ID = 31136;

	@Inject
	protected FestivalWitch5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
