 ...
 */
public class FestivalWitch6Template extends FestivalGuideNPCTemplate {
	public static final int ID = 31142;

	@Inject
	protected FestivalWitch6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
