 ...
 */
public class FestivalWitch10Template extends FestivalGuideNPCTemplate {
	public static final int ID = 31146;

	@Inject
	protected FestivalWitch10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Festival Witch";
