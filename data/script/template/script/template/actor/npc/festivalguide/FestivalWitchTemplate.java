 ...
 */
public class FestivalWitchTemplate extends FestivalGuideNPCTemplate {
	public static final int ID = 31132;

	@Inject
	protected FestivalWitchTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
