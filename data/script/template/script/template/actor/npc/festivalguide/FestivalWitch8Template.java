 ...
 */
public class FestivalWitch8Template extends FestivalGuideNPCTemplate {
	public static final int ID = 31144;

	@Inject
	protected FestivalWitch8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
