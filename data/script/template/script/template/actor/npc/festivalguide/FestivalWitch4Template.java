 ...
 */
public class FestivalWitch4Template extends FestivalGuideNPCTemplate {
	public static final int ID = 31135;

	@Inject
	protected FestivalWitch4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
