 ...
 */
public class LilimKnightTemplate extends NPCTemplate {
	public static final int ID = 13082;

	@Inject
	protected LilimKnightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
