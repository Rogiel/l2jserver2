 ...
 */
public class ShilensEvilThoughtsForPresentationTemplate extends NPCTemplate {
	public static final int ID = 18826;

	@Inject
	protected ShilensEvilThoughtsForPresentationTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shilen's Evil Thoughts For Presentation";
