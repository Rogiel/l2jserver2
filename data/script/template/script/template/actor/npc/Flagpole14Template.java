 ...
 */
public class Flagpole14Template extends NPCTemplate {
	public static final int ID = 36109;

	@Inject
	protected Flagpole14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
