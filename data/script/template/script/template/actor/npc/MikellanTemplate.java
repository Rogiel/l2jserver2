 ...
 */
public class MikellanTemplate extends NPCTemplate {
	public static final int ID = 31368;

	@Inject
	protected MikellanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mikellan";
		this.serverSideName = false;
		this.title = "Monk of Silence";
