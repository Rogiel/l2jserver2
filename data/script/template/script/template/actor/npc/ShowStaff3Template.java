 ...
 */
public class ShowStaff3Template extends NPCTemplate {
	public static final int ID = 32426;

	@Inject
	protected ShowStaff3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
