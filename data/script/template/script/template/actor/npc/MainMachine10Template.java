 ...
 */
public class MainMachine10Template extends NPCTemplate {
	public static final int ID = 36266;

	@Inject
	protected MainMachine10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
