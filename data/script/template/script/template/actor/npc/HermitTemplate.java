 ...
 */
public class HermitTemplate extends NPCTemplate {
	public static final int ID = 31615;

	@Inject
	protected HermitTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
