 ...
 */
public class Trap4Template extends NPCTemplate {
	public static final int ID = 13040;

	@Inject
	protected Trap4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
