 ...
 */
public class KetraOrcShaman2Template extends NPCTemplate {
	public static final int ID = 32499;

	@Inject
	protected KetraOrcShaman2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
