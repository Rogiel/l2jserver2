 ...
 */
public class PowerControlUnit6Template extends NPCTemplate {
	public static final int ID = 35844;

	@Inject
	protected PowerControlUnit6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
