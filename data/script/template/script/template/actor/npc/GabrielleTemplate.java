 ...
 */
public class GabrielleTemplate extends NPCTemplate {
	public static final int ID = 30753;

	@Inject
	protected GabrielleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
