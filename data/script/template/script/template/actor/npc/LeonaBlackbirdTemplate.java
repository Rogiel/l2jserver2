 ...
 */
public class LeonaBlackbirdTemplate extends NPCTemplate {
	public static final int ID = 31595;

	@Inject
	protected LeonaBlackbirdTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Leona Blackbird";
