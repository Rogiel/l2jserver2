 ...
 */
public class MenacingMachineTemplate extends NPCTemplate {
	public static final int ID = 32258;

	@Inject
	protected MenacingMachineTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Menacing Machine";
