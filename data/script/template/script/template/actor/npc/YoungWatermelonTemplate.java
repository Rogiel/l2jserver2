 ...
 */
public class YoungWatermelonTemplate extends NPCTemplate {
	public static final int ID = 13271;

	@Inject
	protected YoungWatermelonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Young Watermelon";
