 ...
 */
public class ZombieTemplate extends NPCTemplate {
	public static final int ID = 13094;

	@Inject
	protected ZombieTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
