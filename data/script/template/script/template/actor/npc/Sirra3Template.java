 ...
 */
public class Sirra3Template extends NPCTemplate {
	public static final int ID = 32763;

	@Inject
	protected Sirra3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sirra";
		this.serverSideName = false;
		this.title = "Ice Fairy";
