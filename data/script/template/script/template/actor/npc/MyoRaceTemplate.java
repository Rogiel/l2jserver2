 ...
 */
public class MyoRaceTemplate extends NPCTemplate {
	public static final int ID = 13156;

	@Inject
	protected MyoRaceTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
