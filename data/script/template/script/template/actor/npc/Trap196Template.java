 ...
 */
public class Trap196Template extends NPCTemplate {
	public static final int ID = 18773;

	@Inject
	protected Trap196Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
