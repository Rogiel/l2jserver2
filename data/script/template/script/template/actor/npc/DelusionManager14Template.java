 ...
 */
public class DelusionManager14Template extends NPCTemplate {
	public static final int ID = 32677;

	@Inject
	protected DelusionManager14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
