 ...
 */
public class IconOfTheFutureTemplate extends NPCTemplate {
	public static final int ID = 32257;

	@Inject
	protected IconOfTheFutureTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Icon of the Future";
