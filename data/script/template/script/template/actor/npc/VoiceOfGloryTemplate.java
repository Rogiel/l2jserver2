 ...
 */
public class VoiceOfGloryTemplate extends NPCTemplate {
	public static final int ID = 31367;

	@Inject
	protected VoiceOfGloryTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Voice of Glory";
