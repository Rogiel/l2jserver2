 ...
 */
public class ImperialTombGuideTemplate extends NPCTemplate {
	public static final int ID = 32011;

	@Inject
	protected ImperialTombGuideTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Imperial Tomb Guide";
