 ...
 */
public class ForPresentation3Template extends NPCTemplate {
	public static final int ID = 13151;

	@Inject
	protected ForPresentation3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "For Presentation 3";
