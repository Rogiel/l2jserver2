 ...
 */
public class WeathermasterTemplate extends NPCTemplate {
	public static final int ID = 32042;

	@Inject
	protected WeathermasterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
