 ...
 */
public class OrimTemplate extends NPCTemplate {
	public static final int ID = 30630;

	@Inject
	protected OrimTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
