 ...
 */
public class SexyPandaAgathionTemplate extends NPCTemplate {
	public static final int ID = 1507;

	@Inject
	protected SexyPandaAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sexy Panda Agathion";
