 ...
 */
public class TarionTemplate extends NPCTemplate {
	public static final int ID = 32514;

	@Inject
	protected TarionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
