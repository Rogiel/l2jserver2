 ...
 */
public class EnergySeedEarthTemplate extends NPCTemplate {
	public static final int ID = 18681;

	@Inject
	protected EnergySeedEarthTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Energy Seed - Earth";
