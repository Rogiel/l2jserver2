 ...
 */
public class Tiat3Template extends NPCTemplate {
	public static final int ID = 32525;

	@Inject
	protected Tiat3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
