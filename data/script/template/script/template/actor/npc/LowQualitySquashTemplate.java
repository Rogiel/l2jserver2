 ...
 */
public class LowQualitySquashTemplate extends NPCTemplate {
	public static final int ID = 12776;

	@Inject
	protected LowQualitySquashTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Low Quality Squash";
