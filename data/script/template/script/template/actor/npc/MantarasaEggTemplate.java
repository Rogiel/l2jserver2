 ...
 */
public class MantarasaEggTemplate extends NPCTemplate {
	public static final int ID = 32118;

	@Inject
	protected MantarasaEggTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mantarasa Egg";
