 ...
 */
public class NanarinTemplate extends NPCTemplate {
	public static final int ID = 30956;

	@Inject
	protected NanarinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
