 ...
 */
public class PiratesChestTemplate extends NPCTemplate {
	public static final int ID = 31148;

	@Inject
	protected PiratesChestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Pirate's Chest";
