 ...
 */
public class HolyBrazierTemplate extends NPCTemplate {
	public static final int ID = 32027;

	@Inject
	protected HolyBrazierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Holy Brazier";
