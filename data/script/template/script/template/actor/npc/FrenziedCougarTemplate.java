 ...
 */
public class FrenziedCougarTemplate extends NPCTemplate {
	public static final int ID = 35618;

	@Inject
	protected FrenziedCougarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Frenzied Cougar";
