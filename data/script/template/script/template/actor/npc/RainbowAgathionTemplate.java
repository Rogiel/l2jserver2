 ...
 */
public class RainbowAgathionTemplate extends NPCTemplate {
	public static final int ID = 16027;

	@Inject
	protected RainbowAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rainbow Agathion";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 0.01;
		this.collisionHeight = 6.70;
		this.level = 55;
