 ...
 */
public class MidwayGatekeeperTemplate extends NPCTemplate {
	public static final int ID = 18415;

	@Inject
	protected MidwayGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Midway Gatekeeper";
