 ...
 */
public class GupuTemplate extends NPCTemplate {
	public static final int ID = 30658;

	@Inject
	protected GupuTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
