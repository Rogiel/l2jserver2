 ...
 */
public class IngeniousContraptionTemplate extends NPCTemplate {
	public static final int ID = 18494;

	@Inject
	protected IngeniousContraptionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
