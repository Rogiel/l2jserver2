 ...
 */
public class PatrinTemplate extends NPCTemplate {
	public static final int ID = 30929;

	@Inject
	protected PatrinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
