 ...
 */
public class GroupGatekeeper5Template extends NPCTemplate {
	public static final int ID = 35614;

	@Inject
	protected GroupGatekeeper5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
