 ...
 */
public class Trap7Template extends NPCTemplate {
	public static final int ID = 13043;

	@Inject
	protected Trap7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
