 ...
 */
public class Harkilgamed4Template extends NPCTemplate {
	public static final int ID = 32334;

	@Inject
	protected Harkilgamed4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Harkilgamed";
