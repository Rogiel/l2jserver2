 ...
 */
public class MatchManager3Template extends NPCTemplate {
	public static final int ID = 32506;

	@Inject
	protected MatchManager3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
