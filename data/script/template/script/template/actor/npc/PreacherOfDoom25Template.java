 ...
 */
public class PreacherOfDoom25Template extends NPCTemplate {
	public static final int ID = 31239;

	@Inject
	protected PreacherOfDoom25Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
