 ...
 */
public class WinterHunterKadythTemplate extends NPCTemplate {
	public static final int ID = 31633;

	@Inject
	protected WinterHunterKadythTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
