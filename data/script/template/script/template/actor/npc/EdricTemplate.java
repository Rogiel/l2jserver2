 ...
 */
public class EdricTemplate extends NPCTemplate {
	public static final int ID = 32527;

	@Inject
	protected EdricTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
