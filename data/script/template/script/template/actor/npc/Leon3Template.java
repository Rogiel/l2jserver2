 ...
 */
public class Leon3Template extends NPCTemplate {
	public static final int ID = 32587;

	@Inject
	protected Leon3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Leon";
		this.serverSideName = false;
		this.title = "Emperor's Guard";
