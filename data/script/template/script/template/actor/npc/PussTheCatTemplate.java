 ...
 */
public class PussTheCatTemplate extends NPCTemplate {
	public static final int ID = 32727;

	@Inject
	protected PussTheCatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Puss the Cat";
