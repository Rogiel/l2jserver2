 ...
 */
public class HolidaySantaTemplate extends NPCTemplate {
	public static final int ID = 4;

	@Inject
	protected HolidaySantaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
