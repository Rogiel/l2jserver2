 ...
 */
public class WinterHunterKadyth3Template extends NPCTemplate {
	public static final int ID = 31635;

	@Inject
	protected WinterHunterKadyth3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Winter Hunter Kadyth";
