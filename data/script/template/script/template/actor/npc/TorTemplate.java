 ...
 */
public class TorTemplate extends NPCTemplate {
	public static final int ID = 30745;

	@Inject
	protected TorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
