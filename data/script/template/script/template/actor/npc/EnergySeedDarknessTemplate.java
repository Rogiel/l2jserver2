 ...
 */
public class EnergySeedDarknessTemplate extends NPCTemplate {
	public static final int ID = 18683;

	@Inject
	protected EnergySeedDarknessTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Energy Seed - Darkness";
