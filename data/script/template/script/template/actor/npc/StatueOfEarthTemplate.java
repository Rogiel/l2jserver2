 ...
 */
public class StatueOfEarthTemplate extends NPCTemplate {
	public static final int ID = 30965;

	@Inject
	protected StatueOfEarthTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Statue of Earth";
