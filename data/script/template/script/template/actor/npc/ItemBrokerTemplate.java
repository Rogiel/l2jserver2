 ...
 */
public class ItemBrokerTemplate extends NPCTemplate {
	public static final int ID = 32320;

	@Inject
	protected ItemBrokerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
