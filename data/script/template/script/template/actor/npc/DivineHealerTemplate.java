 ...
 */
public class DivineHealerTemplate extends NPCTemplate {
	public static final int ID = 13115;

	@Inject
	protected DivineHealerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Divine Healer";
