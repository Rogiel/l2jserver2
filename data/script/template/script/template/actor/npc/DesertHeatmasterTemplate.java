 ...
 */
public class DesertHeatmasterTemplate extends NPCTemplate {
	public static final int ID = 32352;

	@Inject
	protected DesertHeatmasterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Desert Heatmaster";
