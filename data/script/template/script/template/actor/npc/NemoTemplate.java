 ...
 */
public class NemoTemplate extends NPCTemplate {
	public static final int ID = 32735;

	@Inject
	protected NemoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.rightHand = itemProvider.createID(13465);
		this.leftHand = null;
		this.enchantLevel = 0;
