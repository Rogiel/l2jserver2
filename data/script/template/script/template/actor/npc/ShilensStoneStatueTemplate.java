 ...
 */
public class ShilensStoneStatueTemplate extends NPCTemplate {
	public static final int ID = 32109;

	@Inject
	protected ShilensStoneStatueTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shilen's Stone Statue";
