 ...
 */
public class SelinaTemplate extends NPCTemplate {
	public static final int ID = 31556;

	@Inject
	protected SelinaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Selina";
		this.serverSideName = false;
		this.title = "Mercenary Medic";
		...
		this.leftHand = itemProvider.createID(659);
		this.enchantLevel = 0;
