 ...
 */
public class LightOfDawnTemplate extends NPCTemplate {
	public static final int ID = 16066;

	@Inject
	protected LightOfDawnTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Light of Dawn";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 6.00;
		this.collisionHeight = 5.75;
		this.level = 55;
