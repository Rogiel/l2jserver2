 ...
 */
public class MysteriousWomanTemplate extends NPCTemplate {
	public static final int ID = 31750;

	@Inject
	protected MysteriousWomanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mysterious Woman";
