 ...
 */
public class DelusionManager32Template extends NPCTemplate {
	public static final int ID = 32695;

	@Inject
	protected DelusionManager32Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
