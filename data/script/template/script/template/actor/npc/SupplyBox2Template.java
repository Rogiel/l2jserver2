 ...
 */
public class SupplyBox2Template extends NPCTemplate {
	public static final int ID = 35697;

	@Inject
	protected SupplyBox2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
