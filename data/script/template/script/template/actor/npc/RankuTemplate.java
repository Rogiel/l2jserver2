 ...
 */
public class RankuTemplate extends NPCTemplate {
	public static final int ID = 13103;

	@Inject
	protected RankuTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
