 ...
 */
public class PriestGuard2Template extends NPCTemplate {
	public static final int ID = 32127;

	@Inject
	protected PriestGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Priest Guard";
		...
		this.rightHand = itemProvider.createID(7824);
		this.leftHand = null;
		this.enchantLevel = 0;
