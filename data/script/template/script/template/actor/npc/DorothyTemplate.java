 ...
 */
public class DorothyTemplate extends NPCTemplate {
	public static final int ID = 30970;

	@Inject
	protected DorothyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dorothy";
		this.serverSideName = false;
		this.title = "Locksmith";
