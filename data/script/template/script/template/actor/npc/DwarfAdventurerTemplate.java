 ...
 */
public class DwarfAdventurerTemplate extends NPCTemplate {
	public static final int ID = 32508;

	@Inject
	protected DwarfAdventurerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
