 ...
 */
public class FlameOfDarkOmenTemplate extends NPCTemplate {
	public static final int ID = 18305;

	@Inject
	protected FlameOfDarkOmenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
