 ...
 */
public class GreymoreTemplate extends NPCTemplate {
	public static final int ID = 32008;

	@Inject
	protected GreymoreTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
