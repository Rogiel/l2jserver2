 ...
 */
public class MedownTemplate extends DarkElfVillageMasterNPCTemplate {
	public static final int ID = 30699;

	@Inject
	protected MedownTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
