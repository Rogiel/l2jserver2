 ...
 */
public class AngusTemplate extends DarkElfVillageMasterNPCTemplate {
	public static final int ID = 30474;

	@Inject
	protected AngusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
