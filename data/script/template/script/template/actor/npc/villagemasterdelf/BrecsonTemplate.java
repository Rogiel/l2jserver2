 ...
 */
public class BrecsonTemplate extends DarkElfVillageMasterNPCTemplate {
	public static final int ID = 30195;

	@Inject
	protected BrecsonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
