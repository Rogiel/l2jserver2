 ...
 */
public class TronixTemplate extends DarkElfVillageMasterNPCTemplate {
	public static final int ID = 30462;

	@Inject
	protected TronixTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
