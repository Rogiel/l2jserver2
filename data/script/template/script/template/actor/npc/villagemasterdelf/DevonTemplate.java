 ...
 */
public class DevonTemplate extends DarkElfVillageMasterNPCTemplate {
	public static final int ID = 32160;

	@Inject
	protected DevonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
