 ...
 */
public class OltranTemplate extends DarkElfVillageMasterNPCTemplate {
	public static final int ID = 30862;

	@Inject
	protected OltranTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
