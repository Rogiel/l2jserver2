 ...
 */
public class XairakinTemplate extends DarkElfVillageMasterNPCTemplate {
	public static final int ID = 30910;

	@Inject
	protected XairakinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
