 ...
 */
public class TifarenTemplate extends DarkElfVillageMasterNPCTemplate {
	public static final int ID = 31334;

	@Inject
	protected TifarenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
