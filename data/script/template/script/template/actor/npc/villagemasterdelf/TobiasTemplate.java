 ...
 */
public class TobiasTemplate extends DarkElfVillageMasterNPCTemplate {
	public static final int ID = 30297;

	@Inject
	protected TobiasTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
