 ...
 */
public class XenosTemplate extends DarkElfVillageMasterNPCTemplate {
	public static final int ID = 30290;

	@Inject
	protected XenosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
