 ...
 */
public class AndromedaTemplate extends DarkElfVillageMasterNPCTemplate {
	public static final int ID = 31324;

	@Inject
	protected AndromedaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
