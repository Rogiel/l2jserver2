 ...
 */
public class HarkelTemplate extends NPCTemplate {
	public static final int ID = 30596;

	@Inject
	protected HarkelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Harkel";
		this.serverSideName = false;
		this.title = "Partisan Doorman";
