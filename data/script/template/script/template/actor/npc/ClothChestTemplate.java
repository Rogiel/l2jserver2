 ...
 */
public class ClothChestTemplate extends NPCTemplate {
	public static final int ID = 30961;

	@Inject
	protected ClothChestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cloth Chest";
