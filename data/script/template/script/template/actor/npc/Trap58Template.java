 ...
 */
public class Trap58Template extends NPCTemplate {
	public static final int ID = 13222;

	@Inject
	protected Trap58Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
