 ...
 */
public class McTemplate extends NPCTemplate {
	public static final int ID = 32433;

	@Inject
	protected McTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
