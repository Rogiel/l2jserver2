 ...
 */
public class Doorman2Template extends NPCTemplate {
	public static final int ID = 18468;

	@Inject
	protected Doorman2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
