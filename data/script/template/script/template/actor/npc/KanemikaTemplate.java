 ...
 */
public class KanemikaTemplate extends NPCTemplate {
	public static final int ID = 32650;

	@Inject
	protected KanemikaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kanemika";
		this.serverSideName = false;
		this.title = "Grave Robber Leader";
