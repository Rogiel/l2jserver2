 ...
 */
public class SuzetTemplate extends NPCTemplate {
	public static final int ID = 30751;

	@Inject
	protected SuzetTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
