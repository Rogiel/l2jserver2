 ...
 */
public class Flagpole3Template extends NPCTemplate {
	public static final int ID = 35726;

	@Inject
	protected Flagpole3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
