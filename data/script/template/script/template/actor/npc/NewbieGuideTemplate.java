 ...
 */
public class NewbieGuideTemplate extends NPCTemplate {
	public static final int ID = 30598;

	@Inject
	protected NewbieGuideTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
