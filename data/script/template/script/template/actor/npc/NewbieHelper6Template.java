 ...
 */
public class NewbieHelper6Template extends NPCTemplate {
	public static final int ID = 30402;

	@Inject
	protected NewbieHelper6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
