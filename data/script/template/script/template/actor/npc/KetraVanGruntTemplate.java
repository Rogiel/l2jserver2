 ...
 */
public class KetraVanGruntTemplate extends NPCTemplate {
	public static final int ID = 31707;

	@Inject
	protected KetraVanGruntTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ketra Van Grunt";
