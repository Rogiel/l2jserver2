 ...
 */
public class EricRamsheartTemplate extends NPCTemplate {
	public static final int ID = 31631;

	@Inject
	protected EricRamsheartTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Eric Ramsheart";
