 ...
 */
public class MatchManagerTemplate extends NPCTemplate {
	public static final int ID = 32504;

	@Inject
	protected MatchManagerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
