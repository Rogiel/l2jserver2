 ...
 */
public class KintaijinTemplate extends NPCTemplate {
	public static final int ID = 32640;

	@Inject
	protected KintaijinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
