 ...
 */
public class Trap20Template extends NPCTemplate {
	public static final int ID = 13056;

	@Inject
	protected Trap20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
