 ...
 */
public class Trap144Template extends NPCTemplate {
	public static final int ID = 18721;

	@Inject
	protected Trap144Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
