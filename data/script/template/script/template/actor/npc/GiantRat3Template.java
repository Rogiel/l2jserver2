 ...
 */
public class GiantRat3Template extends NPCTemplate {
	public static final int ID = 13122;

	@Inject
	protected GiantRat3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
