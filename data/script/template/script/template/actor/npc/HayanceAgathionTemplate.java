 ...
 */
public class HayanceAgathionTemplate extends NPCTemplate {
	public static final int ID = 1545;

	@Inject
	protected HayanceAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hayance Agathion";
