 ...
 */
public class SupplyBoxTemplate extends NPCTemplate {
	public static final int ID = 35665;

	@Inject
	protected SupplyBoxTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
