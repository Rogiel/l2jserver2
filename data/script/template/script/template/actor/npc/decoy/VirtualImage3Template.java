 ...
 */
public class VirtualImage3Template extends DecoyNPCTemplate {
	public static final int ID = 13073;

	@Inject
	protected VirtualImage3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
