 ...
 */
public class VirtualImage8Template extends DecoyNPCTemplate {
	public static final int ID = 13258;

	@Inject
	protected VirtualImage8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
