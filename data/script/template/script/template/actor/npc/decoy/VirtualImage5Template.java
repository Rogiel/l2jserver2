 ...
 */
public class VirtualImage5Template extends DecoyNPCTemplate {
	public static final int ID = 13075;

	@Inject
	protected VirtualImage5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
