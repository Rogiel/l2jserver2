 ...
 */
public class VirtualImageTemplate extends DecoyNPCTemplate {
	public static final int ID = 13071;

	@Inject
	protected VirtualImageTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
