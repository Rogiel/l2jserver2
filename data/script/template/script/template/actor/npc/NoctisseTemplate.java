 ...
 */
public class NoctisseTemplate extends NPCTemplate {
	public static final int ID = 31613;

	@Inject
	protected NoctisseTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
