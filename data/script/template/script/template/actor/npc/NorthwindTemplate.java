 ...
 */
public class NorthwindTemplate extends NPCTemplate {
	public static final int ID = 30423;

	@Inject
	protected NorthwindTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
