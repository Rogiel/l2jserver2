 ...
 */
public class VerdureElderElikiaTemplate extends NPCTemplate {
	public static final int ID = 31620;

	@Inject
	protected VerdureElderElikiaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Verdure Elder Elikia";
