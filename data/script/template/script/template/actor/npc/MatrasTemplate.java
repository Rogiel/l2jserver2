 ...
 */
public class MatrasTemplate extends NPCTemplate {
	public static final int ID = 32245;

	@Inject
	protected MatrasTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
