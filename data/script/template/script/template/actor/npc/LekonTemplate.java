 ...
 */
public class LekonTemplate extends NPCTemplate {
	public static final int ID = 32557;

	@Inject
	protected LekonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
