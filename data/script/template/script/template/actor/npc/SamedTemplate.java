 ...
 */
public class SamedTemplate extends NPCTemplate {
	public static final int ID = 30434;

	@Inject
	protected SamedTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
