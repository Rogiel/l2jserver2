 ...
 */
public class DivineRogueTemplate extends NPCTemplate {
	public static final int ID = 13114;

	@Inject
	protected DivineRogueTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Divine Rogue";
