 ...
 */
public class LindaTemplate extends NPCTemplate {
	public static final int ID = 32071;

	@Inject
	protected LindaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
