 ...
 */
public class HugePig3Template extends NPCTemplate {
	public static final int ID = 13033;

	@Inject
	protected HugePig3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
