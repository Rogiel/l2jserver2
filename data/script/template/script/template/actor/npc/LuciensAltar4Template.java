 ...
 */
public class LuciensAltar4Template extends NPCTemplate {
	public static final int ID = 32709;

	@Inject
	protected LuciensAltar4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
