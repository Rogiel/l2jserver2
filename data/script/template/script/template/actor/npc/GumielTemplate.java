 ...
 */
public class GumielTemplate extends NPCTemplate {
	public static final int ID = 32759;

	@Inject
	protected GumielTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gumiel";
		this.serverSideName = false;
		this.title = "Treasure Seeker";
