 ...
 */
public class FinalForm2Template extends NPCTemplate {
	public static final int ID = 13089;

	@Inject
	protected FinalForm2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
