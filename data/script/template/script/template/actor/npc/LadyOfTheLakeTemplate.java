 ...
 */
public class LadyOfTheLakeTemplate extends NPCTemplate {
	public static final int ID = 31745;

	@Inject
	protected LadyOfTheLakeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
