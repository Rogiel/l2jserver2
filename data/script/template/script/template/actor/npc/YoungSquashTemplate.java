 ...
 */
public class YoungSquashTemplate extends NPCTemplate {
	public static final int ID = 12774;

	@Inject
	protected YoungSquashTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Young Squash";
