 ...
 */
public class PlaipitakAgathionTemplate extends NPCTemplate {
	public static final int ID = 1504;

	@Inject
	protected PlaipitakAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Plaipitak Agathion";
