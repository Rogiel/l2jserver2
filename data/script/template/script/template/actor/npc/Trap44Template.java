 ...
 */
public class Trap44Template extends NPCTemplate {
	public static final int ID = 13208;

	@Inject
	protected Trap44Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
