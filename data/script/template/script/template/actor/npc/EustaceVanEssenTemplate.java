 ...
 */
public class EustaceVanEssenTemplate extends NPCTemplate {
	public static final int ID = 31679;

	@Inject
	protected EustaceVanEssenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Eustace Van Essen";
