 ...
 */
public class DorfTemplate extends NPCTemplate {
	public static final int ID = 30651;

	@Inject
	protected DorfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
