 ...
 */
public class FortressTrap10Template extends NPCTemplate {
	public static final int ID = 36421;

	@Inject
	protected FortressTrap10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
