 ...
 */
public class PathfinderWorker2Template extends NPCTemplate {
	public static final int ID = 32485;

	@Inject
	protected PathfinderWorker2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Pathfinder Worker";
