 ...
 */
public class SpiritOfFireTemplate extends NPCTemplate {
	public static final int ID = 8;

	@Inject
	protected SpiritOfFireTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
