 ...
 */
public class GraciaServerHelperTemplate extends NPCTemplate {
	public static final int ID = 32630;

	@Inject
	protected GraciaServerHelperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gracia Server Helper";
