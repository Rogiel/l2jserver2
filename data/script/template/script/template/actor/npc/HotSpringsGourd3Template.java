 ...
 */
public class HotSpringsGourd3Template extends NPCTemplate {
	public static final int ID = 35590;

	@Inject
	protected HotSpringsGourd3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
