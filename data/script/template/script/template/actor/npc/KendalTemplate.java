 ...
 */
public class KendalTemplate extends NPCTemplate {
	public static final int ID = 32301;

	@Inject
	protected KendalTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kendal";
		this.serverSideName = false;
		this.title = "Wandering Ghost";
