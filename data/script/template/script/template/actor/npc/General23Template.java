 ...
 */
public class General23Template extends NPCTemplate {
	public static final int ID = 36359;

	@Inject
	protected General23Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
