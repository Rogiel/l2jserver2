 ...
 */
public class RainHoneyWatermelonTemplate extends NPCTemplate {
	public static final int ID = 13277;

	@Inject
	protected RainHoneyWatermelonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rain Honey Watermelon";
