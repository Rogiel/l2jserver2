 ...
 */
public class Messenger2Template extends NPCTemplate {
	public static final int ID = 35604;

	@Inject
	protected Messenger2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
