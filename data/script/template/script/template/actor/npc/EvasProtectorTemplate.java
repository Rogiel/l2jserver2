 ...
 */
public class EvasProtectorTemplate extends NPCTemplate {
	public static final int ID = 32284;

	@Inject
	protected EvasProtectorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
