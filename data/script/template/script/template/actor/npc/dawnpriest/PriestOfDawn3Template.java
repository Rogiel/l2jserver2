 ...
 */
public class PriestOfDawn3Template extends DawnPriestNPCTemplate {
	public static final int ID = 31080;

	@Inject
	protected PriestOfDawn3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
