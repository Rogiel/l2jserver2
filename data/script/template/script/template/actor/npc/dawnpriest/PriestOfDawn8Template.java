 ...
 */
public class PriestOfDawn8Template extends DawnPriestNPCTemplate {
	public static final int ID = 31168;

	@Inject
	protected PriestOfDawn8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
