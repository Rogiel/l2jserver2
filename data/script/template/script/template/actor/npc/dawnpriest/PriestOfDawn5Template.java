 ...
 */
public class PriestOfDawn5Template extends DawnPriestNPCTemplate {
	public static final int ID = 31082;

	@Inject
	protected PriestOfDawn5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
