 ...
 */
public class PriestOfDawn6Template extends DawnPriestNPCTemplate {
	public static final int ID = 31083;

	@Inject
	protected PriestOfDawn6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
