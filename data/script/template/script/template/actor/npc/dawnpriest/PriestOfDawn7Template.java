 ...
 */
public class PriestOfDawn7Template extends DawnPriestNPCTemplate {
	public static final int ID = 31084;

	@Inject
	protected PriestOfDawn7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
