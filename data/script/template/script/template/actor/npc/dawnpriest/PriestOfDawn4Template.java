 ...
 */
public class PriestOfDawn4Template extends DawnPriestNPCTemplate {
	public static final int ID = 31081;

	@Inject
	protected PriestOfDawn4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
