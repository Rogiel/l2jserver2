 ...
 */
public class PriestOfDawnTemplate extends DawnPriestNPCTemplate {
	public static final int ID = 31078;

	@Inject
	protected PriestOfDawnTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
