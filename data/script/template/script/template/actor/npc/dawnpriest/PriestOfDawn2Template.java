 ...
 */
public class PriestOfDawn2Template extends DawnPriestNPCTemplate {
	public static final int ID = 31079;

	@Inject
	protected PriestOfDawn2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
