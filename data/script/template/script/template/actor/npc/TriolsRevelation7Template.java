 ...
 */
public class TriolsRevelation7Template extends NPCTemplate {
	public static final int ID = 32064;

	@Inject
	protected TriolsRevelation7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
