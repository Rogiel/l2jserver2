 ...
 */
public class YangTemplate extends NPCTemplate {
	public static final int ID = 32326;

	@Inject
	protected YangTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Yang";
		this.serverSideName = false;
		this.title = "Attribute Master";
