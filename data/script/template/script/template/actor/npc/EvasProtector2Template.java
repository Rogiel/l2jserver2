 ...
 */
public class EvasProtector2Template extends NPCTemplate {
	public static final int ID = 32285;

	@Inject
	protected EvasProtector2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
