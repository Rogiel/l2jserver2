 ...
 */
public class JainaTemplate extends NPCTemplate {
	public static final int ID = 32582;

	@Inject
	protected JainaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
