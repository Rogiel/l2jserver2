 ...
 */
public class Katenar3Template extends NPCTemplate {
	public static final int ID = 32242;

	@Inject
	protected Katenar3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
