 ...
 */
public class ZakenTemplate extends NPCTemplate {
	public static final int ID = 13099;

	@Inject
	protected ZakenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
