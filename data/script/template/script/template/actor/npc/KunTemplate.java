 ...
 */
public class KunTemplate extends NPCTemplate {
	public static final int ID = 32513;

	@Inject
	protected KunTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
