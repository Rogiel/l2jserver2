 ...
 */
public class GatemasterOfThePresentTemplate extends NPCTemplate {
	public static final int ID = 32261;

	@Inject
	protected GatemasterOfThePresentTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gatemaster of the Present";
