 ...
 */
public class PowerControlUnit8Template extends NPCTemplate {
	public static final int ID = 35913;

	@Inject
	protected PowerControlUnit8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
