 ...
 */
public class Hermit2Template extends NPCTemplate {
	public static final int ID = 31616;

	@Inject
	protected Hermit2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
