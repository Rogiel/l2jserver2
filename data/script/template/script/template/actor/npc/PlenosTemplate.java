 ...
 */
public class PlenosTemplate extends NPCTemplate {
	public static final int ID = 32563;

	@Inject
	protected PlenosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
