 ...
 */
public class Flagpole5Template extends NPCTemplate {
	public static final int ID = 35795;

	@Inject
	protected Flagpole5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
