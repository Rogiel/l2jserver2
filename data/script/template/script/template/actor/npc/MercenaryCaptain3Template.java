 ...
 */
public class MercenaryCaptain3Template extends NPCTemplate {
	public static final int ID = 35755;

	@Inject
	protected MercenaryCaptain3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
