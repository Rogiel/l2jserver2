 ...
 */
public class DimensionalGateKeeper4Template extends NPCTemplate {
	public static final int ID = 31497;

	@Inject
	protected DimensionalGateKeeper4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
