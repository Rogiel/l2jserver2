 ...
 */
public class RiftPostCaptainTemplate extends NPCTemplate {
	public static final int ID = 31491;

	@Inject
	protected RiftPostCaptainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rift Post Captain";
		...
		this.leftHand = itemProvider.createID(660);
		this.enchantLevel = 0;
