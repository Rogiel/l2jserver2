 ...
 */
public class TeleportationCubic6Template extends NPCTemplate {
	public static final int ID = 31859;

	@Inject
	protected TeleportationCubic6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
