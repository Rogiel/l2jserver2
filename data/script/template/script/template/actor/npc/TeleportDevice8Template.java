 ...
 */
public class TeleportDevice8Template extends NPCTemplate {
	public static final int ID = 32752;

	@Inject
	protected TeleportDevice8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
