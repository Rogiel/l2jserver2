 ...
 */
public class RockswellTemplate extends NPCTemplate {
	public static final int ID = 30312;

	@Inject
	protected RockswellTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rockswell";
		this.serverSideName = false;
		this.title = "Lighthouse Keeper";
