 ...
 */
public class PriestCainForPresentationTemplate extends NPCTemplate {
	public static final int ID = 18827;

	@Inject
	protected PriestCainForPresentationTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Priest Cain for Presentation";
