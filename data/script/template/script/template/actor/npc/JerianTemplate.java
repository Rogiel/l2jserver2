 ...
 */
public class JerianTemplate extends NPCTemplate {
	public static final int ID = 32302;

	@Inject
	protected JerianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
