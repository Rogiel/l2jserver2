 ...
 */
public class TomarisTemplate extends NPCTemplate {
	public static final int ID = 32552;

	@Inject
	protected TomarisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
