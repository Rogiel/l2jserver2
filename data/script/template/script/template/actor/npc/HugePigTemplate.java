 ...
 */
public class HugePigTemplate extends NPCTemplate {
	public static final int ID = 13031;

	@Inject
	protected HugePigTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
