 ...
 */
public class OratorOfRevelations24Template extends NPCTemplate {
	public static final int ID = 31254;

	@Inject
	protected OratorOfRevelations24Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
