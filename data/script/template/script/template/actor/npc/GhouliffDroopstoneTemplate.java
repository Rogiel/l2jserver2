 ...
 */
public class GhouliffDroopstoneTemplate extends NPCTemplate {
	public static final int ID = 30549;

	@Inject
	protected GhouliffDroopstoneTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ghouliff Droopstone";
