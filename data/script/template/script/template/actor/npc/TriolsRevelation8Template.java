 ...
 */
public class TriolsRevelation8Template extends NPCTemplate {
	public static final int ID = 32065;

	@Inject
	protected TriolsRevelation8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
