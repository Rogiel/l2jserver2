 ...
 */
public class RedSumoWrestlerAgathionTemplate extends NPCTemplate {
	public static final int ID = 1519;

	@Inject
	protected RedSumoWrestlerAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Red Sumo Wrestler Agathion";
