 ...
 */
public class PerrinTemplate extends NPCTemplate {
	public static final int ID = 30428;

	@Inject
	protected PerrinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
