 ...
 */
public class ForPresentation1Template extends NPCTemplate {
	public static final int ID = 13149;

	@Inject
	protected ForPresentation1Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "For Presentation 1";
