 ...
 */
public class MainMachine4Template extends NPCTemplate {
	public static final int ID = 35945;

	@Inject
	protected MainMachine4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
