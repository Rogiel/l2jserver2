 ...
 */
public class GwanseumNyangNyangAgathionTemplate extends NPCTemplate {
	public static final int ID = 1552;

	@Inject
	protected GwanseumNyangNyangAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gwanseum Nyang Nyang Agathion";
