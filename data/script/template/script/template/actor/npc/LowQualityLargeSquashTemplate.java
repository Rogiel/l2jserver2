 ...
 */
public class LowQualityLargeSquashTemplate extends NPCTemplate {
	public static final int ID = 12779;

	@Inject
	protected LowQualityLargeSquashTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Low Quality Large Squash";
