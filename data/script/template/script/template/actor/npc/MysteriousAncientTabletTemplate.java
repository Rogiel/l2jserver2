 ...
 */
public class MysteriousAncientTabletTemplate extends NPCTemplate {
	public static final int ID = 31548;

	@Inject
	protected MysteriousAncientTabletTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
