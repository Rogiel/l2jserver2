 ...
 */
public class OratorOfRevelations22Template extends NPCTemplate {
	public static final int ID = 31252;

	@Inject
	protected OratorOfRevelations22Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
