 ...
 */
public class KunotaTemplate extends NPCTemplate {
	public static final int ID = 32561;

	@Inject
	protected KunotaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
