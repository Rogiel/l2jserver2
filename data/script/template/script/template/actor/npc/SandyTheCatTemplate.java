 ...
 */
public class SandyTheCatTemplate extends NPCTemplate {
	public static final int ID = 32075;

	@Inject
	protected SandyTheCatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sandy the Cat";
		this.serverSideName = false;
		this.title = "Tournament Helper";
