 ...
 */
public class TiatPriestTemplate extends NPCTemplate {
	public static final int ID = 29173;

	@Inject
	protected TiatPriestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
