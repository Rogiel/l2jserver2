 ...
 */
public class JisansTemplate extends NPCTemplate {
	public static final int ID = 32553;

	@Inject
	protected JisansTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
