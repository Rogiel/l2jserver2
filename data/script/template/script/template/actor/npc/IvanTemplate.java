 ...
 */
public class IvanTemplate extends NPCTemplate {
	public static final int ID = 32014;

	@Inject
	protected IvanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ivan";
		this.serverSideName = false;
		this.title = "Runaway Youth";
