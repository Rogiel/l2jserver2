 ...
 */
public class DelusionManager4Template extends NPCTemplate {
	public static final int ID = 32667;

	@Inject
	protected DelusionManager4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
