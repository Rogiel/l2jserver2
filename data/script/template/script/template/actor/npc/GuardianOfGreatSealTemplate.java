 ...
 */
public class GuardianOfGreatSealTemplate extends NPCTemplate {
	public static final int ID = 32662;

	@Inject
	protected GuardianOfGreatSealTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guardian of Great Seal";
