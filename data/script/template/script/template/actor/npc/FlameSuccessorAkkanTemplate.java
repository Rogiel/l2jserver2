 ...
 */
public class FlameSuccessorAkkanTemplate extends NPCTemplate {
	public static final int ID = 31636;

	@Inject
	protected FlameSuccessorAkkanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Flame Successor Akkan";
