 ...
 */
public class Trap45Template extends NPCTemplate {
	public static final int ID = 13209;

	@Inject
	protected Trap45Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
