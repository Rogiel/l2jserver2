 ...
 */
public class WhiteTigerTemplate extends NPCTemplate {
	public static final int ID = 13290;

	@Inject
	protected WhiteTigerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
