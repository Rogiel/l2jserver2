 ...
 */
public class KarudaTemplate extends NPCTemplate {
	public static final int ID = 32017;

	@Inject
	protected KarudaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
