 ...
 */
public class SupplyBox16Template extends NPCTemplate {
	public static final int ID = 36180;

	@Inject
	protected SupplyBox16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
