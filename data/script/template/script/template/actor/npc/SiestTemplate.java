 ...
 */
public class SiestTemplate extends NPCTemplate {
	public static final int ID = 32562;

	@Inject
	protected SiestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
