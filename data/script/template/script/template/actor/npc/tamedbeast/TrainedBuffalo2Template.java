 ...
 */
public class TrainedBuffalo2Template extends TamedBeastNPCTemplate {
	public static final int ID = 16014;

	@Inject
	protected TrainedBuffalo2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
