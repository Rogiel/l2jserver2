 ...
 */
public class TrainedCougar2Template extends TamedBeastNPCTemplate {
	public static final int ID = 16016;

	@Inject
	protected TrainedCougar2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Trained Cougar";
