 ...
 */
public class GrendelTemplate extends TamedBeastNPCTemplate {
	public static final int ID = 18872;

	@Inject
	protected GrendelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
