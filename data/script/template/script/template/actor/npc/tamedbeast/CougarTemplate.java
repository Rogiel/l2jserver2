 ...
 */
public class CougarTemplate extends TamedBeastNPCTemplate {
	public static final int ID = 18870;

	@Inject
	protected CougarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
