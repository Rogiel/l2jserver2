 ...
 */
public class TrainedCougarTemplate extends TamedBeastNPCTemplate {
	public static final int ID = 16015;

	@Inject
	protected TrainedCougarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
