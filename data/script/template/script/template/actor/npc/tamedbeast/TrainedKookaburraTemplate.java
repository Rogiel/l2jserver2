 ...
 */
public class TrainedKookaburraTemplate extends TamedBeastNPCTemplate {
	public static final int ID = 16017;

	@Inject
	protected TrainedKookaburraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
