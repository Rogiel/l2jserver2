 ...
 */
public class KekropusTemplate extends NPCTemplate {
	public static final int ID = 32138;

	@Inject
	protected KekropusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
