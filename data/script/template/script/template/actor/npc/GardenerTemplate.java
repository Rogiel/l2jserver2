 ...
 */
public class GardenerTemplate extends NPCTemplate {
	public static final int ID = 18581;

	@Inject
	protected GardenerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
