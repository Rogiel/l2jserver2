 ...
 */
public class TolonisTemplate extends NPCTemplate {
	public static final int ID = 32611;

	@Inject
	protected TolonisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
