 ...
 */
public class VortexGateTemplate extends NPCTemplate {
	public static final int ID = 32518;

	@Inject
	protected VortexGateTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
