 ...
 */
public class TriolsRevelation9Template extends NPCTemplate {
	public static final int ID = 32066;

	@Inject
	protected TriolsRevelation9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
