 ...
 */
public class GhostOfVonHellmannTemplate extends NPCTemplate {
	public static final int ID = 31524;

	@Inject
	protected GhostOfVonHellmannTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ghost of von Hellmann";
