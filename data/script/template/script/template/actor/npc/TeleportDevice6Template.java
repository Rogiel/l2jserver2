 ...
 */
public class TeleportDevice6Template extends NPCTemplate {
	public static final int ID = 32750;

	@Inject
	protected TeleportDevice6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
