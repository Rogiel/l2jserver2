 ...
 */
public class Tepios2Template extends NPCTemplate {
	public static final int ID = 32603;

	@Inject
	protected Tepios2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
