 ...
 */
public class Trap31Template extends NPCTemplate {
	public static final int ID = 13067;

	@Inject
	protected Trap31Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
