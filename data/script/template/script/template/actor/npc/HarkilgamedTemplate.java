 ...
 */
public class HarkilgamedTemplate extends NPCTemplate {
	public static final int ID = 32236;

	@Inject
	protected HarkilgamedTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
