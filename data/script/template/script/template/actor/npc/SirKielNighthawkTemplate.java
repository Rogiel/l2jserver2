 ...
 */
public class SirKielNighthawkTemplate extends NPCTemplate {
	public static final int ID = 30654;

	@Inject
	protected SirKielNighthawkTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sir Kiel Nighthawk";
