 ...
 */
public class EngineeringManager3Template extends NPCTemplate {
	public static final int ID = 35732;

	@Inject
	protected EngineeringManager3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
