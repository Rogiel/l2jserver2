 ...
 */
public class Trap113Template extends NPCTemplate {
	public static final int ID = 18398;

	@Inject
	protected Trap113Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
