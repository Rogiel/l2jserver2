 ...
 */
public class GreatSoulTemplate extends NPCTemplate {
	public static final int ID = 32124;

	@Inject
	protected GreatSoulTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
