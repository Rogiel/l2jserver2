 ...
 */
public class EmeryConverterTemplate extends NPCTemplate {
	public static final int ID = 32520;

	@Inject
	protected EmeryConverterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Emery Converter";
