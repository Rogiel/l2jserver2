 ...
 */
public class Trap65Template extends NPCTemplate {
	public static final int ID = 13229;

	@Inject
	protected Trap65Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
