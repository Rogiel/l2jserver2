 ...
 */
public class Flagpole15Template extends NPCTemplate {
	public static final int ID = 36140;

	@Inject
	protected Flagpole15Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
