 ...
 */
public class RadyssTemplate extends NPCTemplate {
	public static final int ID = 31614;

	@Inject
	protected RadyssTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
