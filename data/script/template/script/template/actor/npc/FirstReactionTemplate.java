 ...
 */
public class FirstReactionTemplate extends NPCTemplate {
	public static final int ID = 32248;

	@Inject
	protected FirstReactionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "First Reaction";
