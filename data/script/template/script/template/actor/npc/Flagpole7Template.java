 ...
 */
public class Flagpole7Template extends NPCTemplate {
	public static final int ID = 35857;

	@Inject
	protected Flagpole7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
