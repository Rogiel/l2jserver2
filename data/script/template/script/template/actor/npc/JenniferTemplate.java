 ...
 */
public class JenniferTemplate extends NPCTemplate {
	public static final int ID = 30968;

	@Inject
	protected JenniferTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
