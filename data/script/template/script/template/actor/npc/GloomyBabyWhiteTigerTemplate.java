 ...
 */
public class GloomyBabyWhiteTigerTemplate extends NPCTemplate {
	public static final int ID = 13288;

	@Inject
	protected GloomyBabyWhiteTigerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gloomy Baby White Tiger";
