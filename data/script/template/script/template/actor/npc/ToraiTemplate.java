 ...
 */
public class ToraiTemplate extends NPCTemplate {
	public static final int ID = 30557;

	@Inject
	protected ToraiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
