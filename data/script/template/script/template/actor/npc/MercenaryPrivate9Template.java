 ...
 */
public class MercenaryPrivate9Template extends NPCTemplate {
	public static final int ID = 35963;

	@Inject
	protected MercenaryPrivate9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
