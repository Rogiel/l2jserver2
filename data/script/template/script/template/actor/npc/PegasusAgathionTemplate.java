 ...
 */
public class PegasusAgathionTemplate extends NPCTemplate {
	public static final int ID = 1514;

	@Inject
	protected PegasusAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Pegasus Agathion";
