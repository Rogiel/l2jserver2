 ...
 */
public class OrpheusTemplate extends NPCTemplate {
	public static final int ID = 30971;

	@Inject
	protected OrpheusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Orpheus";
		this.serverSideName = false;
		this.title = "Mad Doctor";
