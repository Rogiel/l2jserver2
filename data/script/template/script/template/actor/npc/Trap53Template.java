 ...
 */
public class Trap53Template extends NPCTemplate {
	public static final int ID = 13217;

	@Inject
	protected Trap53Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
