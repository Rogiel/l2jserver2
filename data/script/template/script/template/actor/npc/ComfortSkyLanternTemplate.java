 ...
 */
public class ComfortSkyLanternTemplate extends NPCTemplate {
	public static final int ID = 25;

	@Inject
	protected ComfortSkyLanternTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Comfort Sky Lantern";
