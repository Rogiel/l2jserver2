 ...
 */
public class TabletOfVision8Template extends NPCTemplate {
	public static final int ID = 31653;

	@Inject
	protected TabletOfVision8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
