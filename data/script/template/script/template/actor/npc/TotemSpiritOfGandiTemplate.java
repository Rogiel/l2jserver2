 ...
 */
public class TotemSpiritOfGandiTemplate extends NPCTemplate {
	public static final int ID = 32057;

	@Inject
	protected TotemSpiritOfGandiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Totem Spirit of Gandi";
