 ...
 */
public class ResurrectionTower5Template extends NPCTemplate {
	public static final int ID = 18543;

	@Inject
	protected ResurrectionTower5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
