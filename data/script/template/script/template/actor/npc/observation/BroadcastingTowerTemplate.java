 ...
 */
package script.template.actor.npc.observation;

import com.google.inject.Inject;
import com.l2jserver.model.id.template.provider.ItemTemplateIDProvider;
import com.l2jserver.model.id.template.provider.NPCTemplateIDProvider;
import com.l2jserver.model.template.npc.ObservationNPCTemplate;

/**
 * @author <a href="http://www.rogiel.com">Rogiel</a>
 */
public class BroadcastingTowerTemplate extends ObservationNPCTemplate {
	public static final int ID = 31031;

	@Inject
	protected BroadcastingTowerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Broadcasting Tower";
