 ...
 */
public class Rabbit3Template extends NPCTemplate {
	public static final int ID = 30741;

	@Inject
	protected Rabbit3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
