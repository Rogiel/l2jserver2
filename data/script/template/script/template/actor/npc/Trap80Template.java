 ...
 */
public class Trap80Template extends NPCTemplate {
	public static final int ID = 13244;

	@Inject
	protected Trap80Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
