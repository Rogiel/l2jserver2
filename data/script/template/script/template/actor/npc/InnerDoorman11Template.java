 ...
 */
public class InnerDoorman11Template extends NPCTemplate {
	public static final int ID = 35434;

	@Inject
	protected InnerDoorman11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
