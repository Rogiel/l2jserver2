 ...
 */
public class MercenaryPrivate12Template extends NPCTemplate {
	public static final int ID = 36070;

	@Inject
	protected MercenaryPrivate12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
