 ...
 */
public class DelusionManager9Template extends NPCTemplate {
	public static final int ID = 32672;

	@Inject
	protected DelusionManager9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
