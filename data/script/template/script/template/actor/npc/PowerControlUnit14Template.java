 ...
 */
public class PowerControlUnit14Template extends NPCTemplate {
	public static final int ID = 36127;

	@Inject
	protected PowerControlUnit14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Power Control Unit";
		this.serverSideName = false;
		this.title = "Control Room";
		this.serverSideTitle = false;
		this.collisionRadius = 54.00;
		this.collisionHeight = 59.50;
		this.level = 75;
		this.sex = null;
		this.attackRange = 40;
