 ...
 */
public class SparkyTheCatTemplate extends NPCTemplate {
	public static final int ID = 31585;

	@Inject
	protected SparkyTheCatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
