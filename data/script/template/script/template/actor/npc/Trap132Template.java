 ...
 */
public class Trap132Template extends NPCTemplate {
	public static final int ID = 18433;

	@Inject
	protected Trap132Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
