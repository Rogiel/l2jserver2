 ...
 */
public class ControlUnit4Template extends NPCTemplate {
	public static final int ID = 35947;

	@Inject
	protected ControlUnit4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
