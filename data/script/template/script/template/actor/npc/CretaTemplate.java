 ...
 */
public class CretaTemplate extends NPCTemplate {
	public static final int ID = 30609;

	@Inject
	protected CretaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Creta";
		this.serverSideName = false;
		this.title = "Astrologer";
