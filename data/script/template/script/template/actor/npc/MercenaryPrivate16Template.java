 ...
 */
public class MercenaryPrivate16Template extends NPCTemplate {
	public static final int ID = 36208;

	@Inject
	protected MercenaryPrivate16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
