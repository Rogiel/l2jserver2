 ...
 */
public class SantasHelperTemplate extends NPCTemplate {
	public static final int ID = 3;

	@Inject
	protected SantasHelperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Santa's Helper";
