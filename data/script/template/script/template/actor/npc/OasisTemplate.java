 ...
 */
public class OasisTemplate extends NPCTemplate {
	public static final int ID = 32304;

	@Inject
	protected OasisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
