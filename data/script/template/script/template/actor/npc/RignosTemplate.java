 ...
 */
public class RignosTemplate extends NPCTemplate {
	public static final int ID = 32349;

	@Inject
	protected RignosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
