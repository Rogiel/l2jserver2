 ...
 */
public class RogentTemplate extends NPCTemplate {
	public static final int ID = 30930;

	@Inject
	protected RogentTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rogent";
		this.serverSideName = false;
		this.title = "Antique Appraiser";
