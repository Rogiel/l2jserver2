 ...
 */
public class Trap192Template extends NPCTemplate {
	public static final int ID = 18769;

	@Inject
	protected Trap192Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
