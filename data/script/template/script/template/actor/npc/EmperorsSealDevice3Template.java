 ...
 */
public class EmperorsSealDevice3Template extends NPCTemplate {
	public static final int ID = 32589;

	@Inject
	protected EmperorsSealDevice3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
