 ...
 */
public class Hardin2Template extends NPCTemplate {
	public static final int ID = 32731;

	@Inject
	protected Hardin2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
