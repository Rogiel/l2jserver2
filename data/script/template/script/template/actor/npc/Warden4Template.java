 ...
 */
public class Warden4Template extends NPCTemplate {
	public static final int ID = 36406;

	@Inject
	protected Warden4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
