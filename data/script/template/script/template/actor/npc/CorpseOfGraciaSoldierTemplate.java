 ...
 */
public class CorpseOfGraciaSoldierTemplate extends NPCTemplate {
	public static final int ID = 32769;

	@Inject
	protected CorpseOfGraciaSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
