 ...
 */
public class PigTemplate extends NPCTemplate {
	public static final int ID = 13093;

	@Inject
	protected PigTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
