 ...
 */
public class MainMachine3Template extends NPCTemplate {
	public static final int ID = 35876;

	@Inject
	protected MainMachine3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
