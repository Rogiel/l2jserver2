 ...
 */
public class InventorMaruTemplate extends NPCTemplate {
	public static final int ID = 32486;

	@Inject
	protected InventorMaruTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Inventor Maru";
