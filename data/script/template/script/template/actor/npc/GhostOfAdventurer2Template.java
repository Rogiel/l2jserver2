 ...
 */
public class GhostOfAdventurer2Template extends NPCTemplate {
	public static final int ID = 31538;

	@Inject
	protected GhostOfAdventurer2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ghost of Adventurer";
