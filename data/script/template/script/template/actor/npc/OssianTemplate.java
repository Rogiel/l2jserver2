 ...
 */
public class OssianTemplate extends NPCTemplate {
	public static final int ID = 31741;

	@Inject
	protected OssianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
