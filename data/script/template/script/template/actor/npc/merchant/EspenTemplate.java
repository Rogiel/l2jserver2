 ...
 */
public class EspenTemplate extends MerchantNPCTemplate {
	public static final int ID = 30890;

	@Inject
	protected EspenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
