 ...
 */
public class WoodrowTemplate extends MerchantNPCTemplate {
	public static final int ID = 30837;

	@Inject
	protected WoodrowTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
