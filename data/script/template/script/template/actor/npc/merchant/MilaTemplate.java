 ...
 */
public class MilaTemplate extends MerchantNPCTemplate {
	public static final int ID = 32169;

	@Inject
	protected MilaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
