 ...
 */
public class DaniTemplate extends MerchantNPCTemplate {
	public static final int ID = 31436;

	@Inject
	protected DaniTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
