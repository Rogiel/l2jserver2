 ...
 */
public class OlfAdamsTemplate extends MerchantNPCTemplate {
	public static final int ID = 32612;

	@Inject
	protected OlfAdamsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
