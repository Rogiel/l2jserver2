 ...
 */
public class UrgalTemplate extends MerchantNPCTemplate {
	public static final int ID = 31427;

	@Inject
	protected UrgalTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
