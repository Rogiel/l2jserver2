 ...
 */
public class LahmTemplate extends MerchantNPCTemplate {
	public static final int ID = 32359;

	@Inject
	protected LahmTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lahm";
		this.serverSideName = false;
		this.title = "Blacksmith of Power";
