 ...
 */
public class KikiTemplate extends MerchantNPCTemplate {
	public static final int ID = 31442;

	@Inject
	protected KikiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
