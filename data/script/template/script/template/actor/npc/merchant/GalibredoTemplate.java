 ...
 */
public class GalibredoTemplate extends MerchantNPCTemplate {
	public static final int ID = 30181;

	@Inject
	protected GalibredoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Galibredo";
		this.serverSideName = false;
		this.title = "Accessory Merchant";
