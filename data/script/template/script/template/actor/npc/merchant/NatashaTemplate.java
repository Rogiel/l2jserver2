 ...
 */
public class NatashaTemplate extends MerchantNPCTemplate {
	public static final int ID = 31306;

	@Inject
	protected NatashaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
