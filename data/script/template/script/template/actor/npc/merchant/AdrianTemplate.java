 ...
 */
public class AdrianTemplate extends MerchantNPCTemplate {
	public static final int ID = 31948;

	@Inject
	protected AdrianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
