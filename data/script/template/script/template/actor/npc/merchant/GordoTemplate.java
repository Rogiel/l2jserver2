 ...
 */
public class GordoTemplate extends MerchantNPCTemplate {
	public static final int ID = 31441;

	@Inject
	protected GordoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
