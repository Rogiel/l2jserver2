 ...
 */
public class RatriyaTemplate extends MerchantNPCTemplate {
	public static final int ID = 31421;

	@Inject
	protected RatriyaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
