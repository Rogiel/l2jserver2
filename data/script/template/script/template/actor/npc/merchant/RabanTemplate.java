 ...
 */
public class RabanTemplate extends MerchantNPCTemplate {
	public static final int ID = 31443;

	@Inject
	protected RabanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
