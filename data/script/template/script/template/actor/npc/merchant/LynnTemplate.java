 ...
 */
public class LynnTemplate extends MerchantNPCTemplate {
	public static final int ID = 31414;

	@Inject
	protected LynnTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
