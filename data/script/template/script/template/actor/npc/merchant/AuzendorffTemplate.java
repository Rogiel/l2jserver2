 ...
 */
public class AuzendorffTemplate extends MerchantNPCTemplate {
	public static final int ID = 31945;

	@Inject
	protected AuzendorffTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Auzendorff";
