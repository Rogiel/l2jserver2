 ...
 */
public class VaranTemplate extends MerchantNPCTemplate {
	public static final int ID = 30294;

	@Inject
	protected VaranTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
