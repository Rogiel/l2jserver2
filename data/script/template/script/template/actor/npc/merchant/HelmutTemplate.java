 ...
 */
public class HelmutTemplate extends MerchantNPCTemplate {
	public static final int ID = 31258;

	@Inject
	protected HelmutTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
