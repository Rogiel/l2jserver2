 ...
 */
public class RoukeTemplate extends MerchantNPCTemplate {
	public static final int ID = 31418;

	@Inject
	protected RoukeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
