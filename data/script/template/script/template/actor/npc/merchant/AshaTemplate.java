 ...
 */
public class AshaTemplate extends MerchantNPCTemplate {
	public static final int ID = 30313;

	@Inject
	protected AshaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
