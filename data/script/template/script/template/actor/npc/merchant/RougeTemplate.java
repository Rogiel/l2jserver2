 ...
 */
public class RougeTemplate extends MerchantNPCTemplate {
	public static final int ID = 31949;

	@Inject
	protected RougeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
