 ...
 */
public class HombreTemplate extends MerchantNPCTemplate {
	public static final int ID = 31946;

	@Inject
	protected HombreTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
