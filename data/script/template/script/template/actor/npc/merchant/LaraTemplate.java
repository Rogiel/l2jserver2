 ...
 */
public class LaraTemplate extends MerchantNPCTemplate {
	public static final int ID = 30063;

	@Inject
	protected LaraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
