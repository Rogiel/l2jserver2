 ...
 */
public class DenkusTemplate extends MerchantNPCTemplate {
	public static final int ID = 30082;

	@Inject
	protected DenkusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
