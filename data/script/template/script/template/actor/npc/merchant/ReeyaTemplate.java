 ...
 */
public class ReeyaTemplate extends MerchantNPCTemplate {
	public static final int ID = 31432;

	@Inject
	protected ReeyaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
