 ...
 */
public class JakaTemplate extends MerchantNPCTemplate {
	public static final int ID = 31426;

	@Inject
	protected JakaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
