 ...
 */
public class ShalingTemplate extends MerchantNPCTemplate {
	public static final int ID = 31434;

	@Inject
	protected ShalingTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
