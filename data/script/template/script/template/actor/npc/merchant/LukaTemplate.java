 ...
 */
public class LukaTemplate extends MerchantNPCTemplate {
	public static final int ID = 31437;

	@Inject
	protected LukaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
