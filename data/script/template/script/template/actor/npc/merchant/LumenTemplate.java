 ...
 */
public class LumenTemplate extends MerchantNPCTemplate {
	public static final int ID = 31666;

	@Inject
	protected LumenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
