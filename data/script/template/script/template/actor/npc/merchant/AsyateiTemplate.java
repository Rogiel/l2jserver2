 ...
 */
public class AsyateiTemplate extends MerchantNPCTemplate {
	public static final int ID = 32546;

	@Inject
	protected AsyateiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Asyatei";
		this.serverSideName = false;
		this.title = "Soul Trader";
