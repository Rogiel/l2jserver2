 ...
 */
public class BurnsTemplate extends MerchantNPCTemplate {
	public static final int ID = 31670;

	@Inject
	protected BurnsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
