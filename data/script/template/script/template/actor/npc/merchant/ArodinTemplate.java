 ...
 */
public class ArodinTemplate extends MerchantNPCTemplate {
	public static final int ID = 30207;

	@Inject
	protected ArodinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
