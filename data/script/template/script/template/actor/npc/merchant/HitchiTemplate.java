 ...
 */
public class HitchiTemplate extends MerchantNPCTemplate {
	public static final int ID = 31963;

	@Inject
	protected HitchiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hitchi";
		this.serverSideName = false;
		this.title = "Mineral Trader";
