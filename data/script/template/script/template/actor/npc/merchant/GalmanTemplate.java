 ...
 */
public class GalmanTemplate extends MerchantNPCTemplate {
	public static final int ID = 31044;

	@Inject
	protected GalmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Galman";
		this.serverSideName = false;
		this.title = "Valley Trader";
