 ...
 */
public class VolkerTemplate extends MerchantNPCTemplate {
	public static final int ID = 31351;

	@Inject
	protected VolkerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Volker";
		this.serverSideName = false;
		this.title = "Wharf Manager";
