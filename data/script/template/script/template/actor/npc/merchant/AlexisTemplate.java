 ...
 */
public class AlexisTemplate extends MerchantNPCTemplate {
	public static final int ID = 30842;

	@Inject
	protected AlexisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
