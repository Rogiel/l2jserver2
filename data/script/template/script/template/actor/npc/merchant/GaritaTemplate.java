 ...
 */
public class GaritaTemplate extends MerchantNPCTemplate {
	public static final int ID = 30518;

	@Inject
	protected GaritaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
