 ...
 */
public class EdrocTemplate extends MerchantNPCTemplate {
	public static final int ID = 30230;

	@Inject
	protected EdrocTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
