 ...
 */
public class IriaTemplate extends MerchantNPCTemplate {
	public static final int ID = 30135;

	@Inject
	protected IriaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
