 ...
 */
public class BorodinTemplate extends MerchantNPCTemplate {
	public static final int ID = 31273;

	@Inject
	protected BorodinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
