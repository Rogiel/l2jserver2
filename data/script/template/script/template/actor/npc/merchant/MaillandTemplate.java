 ...
 */
public class MaillandTemplate extends MerchantNPCTemplate {
	public static final int ID = 31950;

	@Inject
	protected MaillandTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
