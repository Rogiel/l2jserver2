 ...
 */
public class RaikTemplate extends MerchantNPCTemplate {
	public static final int ID = 31667;

	@Inject
	protected RaikTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
