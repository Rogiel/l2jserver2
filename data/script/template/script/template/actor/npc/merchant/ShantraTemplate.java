 ...
 */
public class ShantraTemplate extends MerchantNPCTemplate {
	public static final int ID = 31424;

	@Inject
	protected ShantraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
