 ...
 */
public class RexTemplate extends MerchantNPCTemplate {
	public static final int ID = 30163;

	@Inject
	protected RexTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
