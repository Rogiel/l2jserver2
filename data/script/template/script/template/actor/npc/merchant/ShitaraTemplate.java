 ...
 */
public class ShitaraTemplate extends MerchantNPCTemplate {
	public static final int ID = 31429;

	@Inject
	protected ShitaraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shitara";
		this.serverSideName = false;
		this.title = "Amulet Seller";
