 ...
 */
public class TangenTemplate extends MerchantNPCTemplate {
	public static final int ID = 31668;

	@Inject
	protected TangenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
