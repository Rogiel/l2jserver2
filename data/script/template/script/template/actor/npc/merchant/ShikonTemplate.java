 ...
 */
public class ShikonTemplate extends MerchantNPCTemplate {
	public static final int ID = 31382;

	@Inject
	protected ShikonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
