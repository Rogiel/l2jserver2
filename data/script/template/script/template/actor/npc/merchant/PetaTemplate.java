 ...
 */
public class PetaTemplate extends MerchantNPCTemplate {
	public static final int ID = 30087;

	@Inject
	protected PetaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Peta";
		this.serverSideName = false;
		this.title = "Wizard-use Armor Merchant";
