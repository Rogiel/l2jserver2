 ...
 */
public class PeleTemplate extends MerchantNPCTemplate {
	public static final int ID = 31952;

	@Inject
	protected PeleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
