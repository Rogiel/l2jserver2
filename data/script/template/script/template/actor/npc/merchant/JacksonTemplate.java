 ...
 */
public class JacksonTemplate extends MerchantNPCTemplate {
	public static final int ID = 30002;

	@Inject
	protected JacksonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
