 ...
 */
public class GentlerTemplate extends MerchantNPCTemplate {
	public static final int ID = 30094;

	@Inject
	protected GentlerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gentler";
		this.serverSideName = false;
		this.title = "Wizard-use Equipment Merchant";
