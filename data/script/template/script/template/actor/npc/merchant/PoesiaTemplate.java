 ...
 */
public class PoesiaTemplate extends MerchantNPCTemplate {
	public static final int ID = 30315;

	@Inject
	protected PoesiaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
