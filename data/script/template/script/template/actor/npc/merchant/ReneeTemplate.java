 ...
 */
public class ReneeTemplate extends MerchantNPCTemplate {
	public static final int ID = 31261;

	@Inject
	protected ReneeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
