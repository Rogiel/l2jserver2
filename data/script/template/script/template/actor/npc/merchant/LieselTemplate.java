 ...
 */
public class LieselTemplate extends MerchantNPCTemplate {
	public static final int ID = 31263;

	@Inject
	protected LieselTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
