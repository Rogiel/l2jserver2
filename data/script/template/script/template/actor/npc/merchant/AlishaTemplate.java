 ...
 */
public class AlishaTemplate extends MerchantNPCTemplate {
	public static final int ID = 31303;

	@Inject
	protected AlishaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
