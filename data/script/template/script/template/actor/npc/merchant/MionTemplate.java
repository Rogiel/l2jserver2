 ...
 */
public class MionTemplate extends MerchantNPCTemplate {
	public static final int ID = 30519;

	@Inject
	protected MionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
