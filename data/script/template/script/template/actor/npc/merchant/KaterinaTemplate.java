 ...
 */
public class KaterinaTemplate extends MerchantNPCTemplate {
	public static final int ID = 30004;

	@Inject
	protected KaterinaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
