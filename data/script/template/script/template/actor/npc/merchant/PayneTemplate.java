 ...
 */
public class PayneTemplate extends MerchantNPCTemplate {
	public static final int ID = 30136;

	@Inject
	protected PayneTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
