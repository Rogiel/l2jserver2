 ...
 */
public class AlexandriaTemplate extends MerchantNPCTemplate {
	public static final int ID = 30098;

	@Inject
	protected AlexandriaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Alexandria";
		this.serverSideName = false;
		this.title = "Armor Merchant";
