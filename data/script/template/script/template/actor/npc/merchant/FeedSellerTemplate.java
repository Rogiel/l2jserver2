 ...
 */
public class FeedSellerTemplate extends MerchantNPCTemplate {
	public static final int ID = 31366;

	@Inject
	protected FeedSellerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Feed Seller";
