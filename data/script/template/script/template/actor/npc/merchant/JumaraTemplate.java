 ...
 */
public class JumaraTemplate extends MerchantNPCTemplate {
	public static final int ID = 31375;

	@Inject
	protected JumaraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
