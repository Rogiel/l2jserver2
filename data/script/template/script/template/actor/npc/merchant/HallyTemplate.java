 ...
 */
public class HallyTemplate extends MerchantNPCTemplate {
	public static final int ID = 30301;

	@Inject
	protected HallyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
