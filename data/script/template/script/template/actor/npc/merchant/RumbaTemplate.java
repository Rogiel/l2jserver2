 ...
 */
public class RumbaTemplate extends MerchantNPCTemplate {
	public static final int ID = 31980;

	@Inject
	protected RumbaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
