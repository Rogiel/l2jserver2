 ...
 */
public class HelvetiaTemplate extends MerchantNPCTemplate {
	public static final int ID = 30081;

	@Inject
	protected HelvetiaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
