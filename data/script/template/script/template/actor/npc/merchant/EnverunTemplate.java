 ...
 */
public class EnverunTemplate extends MerchantNPCTemplate {
	public static final int ID = 30892;

	@Inject
	protected EnverunTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
