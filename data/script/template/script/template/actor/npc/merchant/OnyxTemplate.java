 ...
 */
public class OnyxTemplate extends MerchantNPCTemplate {
	public static final int ID = 31669;

	@Inject
	protected OnyxTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
