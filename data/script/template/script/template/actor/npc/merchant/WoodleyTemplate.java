 ...
 */
public class WoodleyTemplate extends MerchantNPCTemplate {
	public static final int ID = 30838;

	@Inject
	protected WoodleyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
