 ...
 */
public class LannaTemplate extends MerchantNPCTemplate {
	public static final int ID = 31440;

	@Inject
	protected LannaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
