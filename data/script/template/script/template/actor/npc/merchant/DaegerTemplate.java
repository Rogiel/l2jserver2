 ...
 */
public class DaegerTemplate extends MerchantNPCTemplate {
	public static final int ID = 31435;

	@Inject
	protected DaegerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
