 ...
 */
public class VeronicaTemplate extends MerchantNPCTemplate {
	public static final int ID = 31257;

	@Inject
	protected VeronicaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
