 ...
 */
public class VeronaTemplate extends MerchantNPCTemplate {
	public static final int ID = 30891;

	@Inject
	protected VeronaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
