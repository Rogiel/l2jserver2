 ...
 */
public class HollyTemplate extends MerchantNPCTemplate {
	public static final int ID = 30839;

	@Inject
	protected HollyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
