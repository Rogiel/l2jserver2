 ...
 */
public class RomasTemplate extends MerchantNPCTemplate {
	public static final int ID = 31423;

	@Inject
	protected RomasTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
