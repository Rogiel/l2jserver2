 ...
 */
public class ShadaiTemplate extends MerchantNPCTemplate {
	public static final int ID = 32347;

	@Inject
	protected ShadaiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
