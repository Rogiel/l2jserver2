 ...
 */
public class ArielTemplate extends MerchantNPCTemplate {
	public static final int ID = 30148;

	@Inject
	protected ArielTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
