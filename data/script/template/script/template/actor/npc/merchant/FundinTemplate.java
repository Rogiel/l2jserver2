 ...
 */
public class FundinTemplate extends MerchantNPCTemplate {
	public static final int ID = 31274;

	@Inject
	protected FundinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
