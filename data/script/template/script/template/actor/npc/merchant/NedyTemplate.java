 ...
 */
public class NedyTemplate extends MerchantNPCTemplate {
	public static final int ID = 30924;

	@Inject
	protected NedyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
