 ...
 */
public class SarienTemplate extends MerchantNPCTemplate {
	public static final int ID = 30436;

	@Inject
	protected SarienTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
