 ...
 */
public class RadiaTemplate extends MerchantNPCTemplate {
	public static final int ID = 30088;

	@Inject
	protected RadiaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Radia";
		this.serverSideName = false;
		this.title = "Warrior-use Armor Merchant";
