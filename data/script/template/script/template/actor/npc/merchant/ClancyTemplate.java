 ...
 */
public class ClancyTemplate extends MerchantNPCTemplate {
	public static final int ID = 30387;

	@Inject
	protected ClancyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
