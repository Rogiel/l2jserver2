 ...
 */
public class WeberTemplate extends MerchantNPCTemplate {
	public static final int ID = 31307;

	@Inject
	protected WeberTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
