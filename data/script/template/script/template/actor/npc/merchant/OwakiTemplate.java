 ...
 */
public class OwakiTemplate extends MerchantNPCTemplate {
	public static final int ID = 31947;

	@Inject
	protected OwakiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
