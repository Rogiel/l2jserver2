 ...
 */
public class KunaiTemplate extends MerchantNPCTemplate {
	public static final int ID = 30559;

	@Inject
	protected KunaiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
