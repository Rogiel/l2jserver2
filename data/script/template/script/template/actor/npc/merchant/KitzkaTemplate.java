 ...
 */
public class KitzkaTemplate extends MerchantNPCTemplate {
	public static final int ID = 31045;

	@Inject
	protected KitzkaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
