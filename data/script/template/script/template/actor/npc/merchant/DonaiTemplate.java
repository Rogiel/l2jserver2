 ...
 */
public class DonaiTemplate extends MerchantNPCTemplate {
	public static final int ID = 31430;

	@Inject
	protected DonaiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
