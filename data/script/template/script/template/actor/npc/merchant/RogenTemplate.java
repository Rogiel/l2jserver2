 ...
 */
public class RogenTemplate extends MerchantNPCTemplate {
	public static final int ID = 31439;

	@Inject
	protected RogenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
