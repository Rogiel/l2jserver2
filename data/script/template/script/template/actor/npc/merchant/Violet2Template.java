 ...
 */
public class Violet2Template extends MerchantNPCTemplate {
	public static final int ID = 31386;

	@Inject
	protected Violet2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
