 ...
 */
public class DamionTemplate extends MerchantNPCTemplate {
	public static final int ID = 30208;

	@Inject
	protected DamionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
