 ...
 */
public class Leon2Template extends MerchantNPCTemplate {
	public static final int ID = 31256;

	@Inject
	protected Leon2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
