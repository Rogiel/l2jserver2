 ...
 */
public class SingsingTemplate extends MerchantNPCTemplate {
	public static final int ID = 32106;

	@Inject
	protected SingsingTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
