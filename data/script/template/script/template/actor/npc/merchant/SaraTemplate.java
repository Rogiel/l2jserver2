 ...
 */
public class SaraTemplate extends MerchantNPCTemplate {
	public static final int ID = 30180;

	@Inject
	protected SaraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
