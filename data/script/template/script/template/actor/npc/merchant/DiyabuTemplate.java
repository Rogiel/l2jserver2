 ...
 */
public class DiyabuTemplate extends MerchantNPCTemplate {
	public static final int ID = 31380;

	@Inject
	protected DiyabuTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
