 ...
 */
public class JoseTemplate extends MerchantNPCTemplate {
	public static final int ID = 31951;

	@Inject
	protected JoseTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
