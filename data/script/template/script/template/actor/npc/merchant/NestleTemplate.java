 ...
 */
public class NestleTemplate extends MerchantNPCTemplate {
	public static final int ID = 30314;

	@Inject
	protected NestleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
