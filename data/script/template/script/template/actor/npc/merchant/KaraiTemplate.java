 ...
 */
public class KaraiTemplate extends MerchantNPCTemplate {
	public static final int ID = 31431;

	@Inject
	protected KaraiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
