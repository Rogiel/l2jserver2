 ...
 */
public class RolentoTemplate extends MerchantNPCTemplate {
	public static final int ID = 30437;

	@Inject
	protected RolentoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
