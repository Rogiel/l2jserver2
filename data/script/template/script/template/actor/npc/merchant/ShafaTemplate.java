 ...
 */
public class ShafaTemplate extends MerchantNPCTemplate {
	public static final int ID = 31428;

	@Inject
	protected ShafaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
