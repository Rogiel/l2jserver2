 ...
 */
public class LorenzoTemplate extends MerchantNPCTemplate {
	public static final int ID = 30840;

	@Inject
	protected LorenzoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
