 ...
 */
public class ConaTemplate extends MerchantNPCTemplate {
	public static final int ID = 31444;

	@Inject
	protected ConaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
