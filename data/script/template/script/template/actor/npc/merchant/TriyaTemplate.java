 ...
 */
public class TriyaTemplate extends MerchantNPCTemplate {
	public static final int ID = 31415;

	@Inject
	protected TriyaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
