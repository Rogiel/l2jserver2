 ...
 */
public class VollodosTemplate extends MerchantNPCTemplate {
	public static final int ID = 30137;

	@Inject
	protected VollodosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
