 ...
 */
public class HansTemplate extends MerchantNPCTemplate {
	public static final int ID = 31319;

	@Inject
	protected HansTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
