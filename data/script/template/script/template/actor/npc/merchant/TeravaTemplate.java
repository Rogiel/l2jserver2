 ...
 */
public class TeravaTemplate extends MerchantNPCTemplate {
	public static final int ID = 31291;

	@Inject
	protected TeravaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
