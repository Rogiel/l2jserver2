 ...
 */
public class TyraTemplate extends MerchantNPCTemplate {
	public static final int ID = 30420;

	@Inject
	protected TyraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
