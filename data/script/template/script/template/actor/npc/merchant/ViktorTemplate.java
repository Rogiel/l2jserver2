 ...
 */
public class ViktorTemplate extends MerchantNPCTemplate {
	public static final int ID = 30684;

	@Inject
	protected ViktorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
