 ...
 */
public class CarsonTemplate extends MerchantNPCTemplate {
	public static final int ID = 30841;

	@Inject
	protected CarsonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
