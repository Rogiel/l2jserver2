 ...
 */
public class Atan2Template extends MerchantNPCTemplate {
	public static final int ID = 31373;

	@Inject
	protected Atan2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
