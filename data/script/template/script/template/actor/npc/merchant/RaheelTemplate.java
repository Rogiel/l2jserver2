 ...
 */
public class RaheelTemplate extends MerchantNPCTemplate {
	public static final int ID = 31973;

	@Inject
	protected RaheelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
