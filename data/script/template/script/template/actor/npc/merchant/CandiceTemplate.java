 ...
 */
public class CandiceTemplate extends MerchantNPCTemplate {
	public static final int ID = 31305;

	@Inject
	protected CandiceTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
