 ...
 */
public class GrahamTemplate extends MerchantNPCTemplate {
	public static final int ID = 30084;

	@Inject
	protected GrahamTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
