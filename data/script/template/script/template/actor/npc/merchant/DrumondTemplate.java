 ...
 */
public class DrumondTemplate extends MerchantNPCTemplate {
	public static final int ID = 31300;

	@Inject
	protected DrumondTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
