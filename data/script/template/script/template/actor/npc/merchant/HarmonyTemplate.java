 ...
 */
public class HarmonyTemplate extends MerchantNPCTemplate {
	public static final int ID = 30254;

	@Inject
	protected HarmonyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
