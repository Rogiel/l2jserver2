 ...
 */
public class RalfordTemplate extends MerchantNPCTemplate {
	public static final int ID = 30165;

	@Inject
	protected RalfordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
