 ...
 */
public class RaudiaTemplate extends MerchantNPCTemplate {
	public static final int ID = 30179;

	@Inject
	protected RaudiaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
