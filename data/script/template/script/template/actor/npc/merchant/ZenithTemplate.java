 ...
 */
public class ZenithTemplate extends MerchantNPCTemplate {
	public static final int ID = 32168;

	@Inject
	protected ZenithTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
