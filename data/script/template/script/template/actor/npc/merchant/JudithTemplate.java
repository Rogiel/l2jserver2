 ...
 */
public class JudithTemplate extends MerchantNPCTemplate {
	public static final int ID = 31260;

	@Inject
	protected JudithTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
