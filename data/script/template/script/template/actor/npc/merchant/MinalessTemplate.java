 ...
 */
public class MinalessTemplate extends MerchantNPCTemplate {
	public static final int ID = 30138;

	@Inject
	protected MinalessTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
