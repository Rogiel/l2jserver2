 ...
 */
public class GalladucciTemplate extends MerchantNPCTemplate {
	public static final int ID = 30097;

	@Inject
	protected GalladucciTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Galladucci";
