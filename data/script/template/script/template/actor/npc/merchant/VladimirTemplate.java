 ...
 */
public class VladimirTemplate extends MerchantNPCTemplate {
	public static final int ID = 31302;

	@Inject
	protected VladimirTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
