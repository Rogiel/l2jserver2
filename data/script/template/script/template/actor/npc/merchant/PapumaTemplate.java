 ...
 */
public class PapumaTemplate extends MerchantNPCTemplate {
	public static final int ID = 30561;

	@Inject
	protected PapumaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
