 ...
 */
public class ZenkinTemplate extends MerchantNPCTemplate {
	public static final int ID = 30178;

	@Inject
	protected ZenkinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
