 ...
 */
public class ZakoneTemplate extends MerchantNPCTemplate {
	public static final int ID = 32165;

	@Inject
	protected ZakoneTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
