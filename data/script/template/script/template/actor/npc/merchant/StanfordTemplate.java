 ...
 */
public class StanfordTemplate extends MerchantNPCTemplate {
	public static final int ID = 30085;

	@Inject
	protected StanfordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
