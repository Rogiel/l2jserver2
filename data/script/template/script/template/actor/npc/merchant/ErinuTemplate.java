 ...
 */
public class ErinuTemplate extends MerchantNPCTemplate {
	public static final int ID = 32164;

	@Inject
	protected ErinuTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
