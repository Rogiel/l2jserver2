 ...
 */
public class TrevorTemplate extends MerchantNPCTemplate {
	public static final int ID = 32166;

	@Inject
	protected TrevorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
