 ...
 */
public class CreameesTemplate extends MerchantNPCTemplate {
	public static final int ID = 30149;

	@Inject
	protected CreameesTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
