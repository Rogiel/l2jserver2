 ...
 */
public class SandraTemplate extends MerchantNPCTemplate {
	public static final int ID = 30090;

	@Inject
	protected SandraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
