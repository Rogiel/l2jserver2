 ...
 */
public class UnorenTemplate extends MerchantNPCTemplate {
	public static final int ID = 30147;

	@Inject
	protected UnorenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
