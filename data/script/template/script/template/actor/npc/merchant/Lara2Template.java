 ...
 */
public class Lara2Template extends MerchantNPCTemplate {
	public static final int ID = 31438;

	@Inject
	protected Lara2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
