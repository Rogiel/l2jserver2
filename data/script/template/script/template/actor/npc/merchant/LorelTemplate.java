 ...
 */
public class LorelTemplate extends MerchantNPCTemplate {
	public static final int ID = 31419;

	@Inject
	protected LorelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
