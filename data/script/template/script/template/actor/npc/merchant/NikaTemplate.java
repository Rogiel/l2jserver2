 ...
 */
public class NikaTemplate extends MerchantNPCTemplate {
	public static final int ID = 32167;

	@Inject
	protected NikaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
