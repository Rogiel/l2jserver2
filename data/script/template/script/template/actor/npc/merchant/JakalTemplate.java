 ...
 */
public class JakalTemplate extends MerchantNPCTemplate {
	public static final int ID = 30558;

	@Inject
	protected JakalTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
