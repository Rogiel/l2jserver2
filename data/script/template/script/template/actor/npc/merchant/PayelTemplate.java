 ...
 */
public class PayelTemplate extends MerchantNPCTemplate {
	public static final int ID = 30893;

	@Inject
	protected PayelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
