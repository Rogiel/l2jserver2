 ...
 */
public class EllieTemplate extends MerchantNPCTemplate {
	public static final int ID = 30091;

	@Inject
	protected EllieTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
