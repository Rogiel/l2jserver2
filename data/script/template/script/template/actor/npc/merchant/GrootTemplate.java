 ...
 */
public class GrootTemplate extends MerchantNPCTemplate {
	public static final int ID = 30093;

	@Inject
	protected GrootTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
