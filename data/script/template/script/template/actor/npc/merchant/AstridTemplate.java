 ...
 */
public class AstridTemplate extends MerchantNPCTemplate {
	public static final int ID = 31304;

	@Inject
	protected AstridTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
