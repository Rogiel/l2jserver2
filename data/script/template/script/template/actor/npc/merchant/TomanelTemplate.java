 ...
 */
public class TomanelTemplate extends MerchantNPCTemplate {
	public static final int ID = 31420;

	@Inject
	protected TomanelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
