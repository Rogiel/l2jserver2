 ...
 */
public class SimplonTemplate extends MerchantNPCTemplate {
	public static final int ID = 30253;

	@Inject
	protected SimplonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
