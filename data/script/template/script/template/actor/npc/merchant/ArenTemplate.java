 ...
 */
public class ArenTemplate extends MerchantNPCTemplate {
	public static final int ID = 31416;

	@Inject
	protected ArenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
