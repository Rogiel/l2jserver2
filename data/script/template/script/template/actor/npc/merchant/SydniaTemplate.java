 ...
 */
public class SydniaTemplate extends MerchantNPCTemplate {
	public static final int ID = 30321;

	@Inject
	protected SydniaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
