 ...
 */
public class AntonioTemplate extends MerchantNPCTemplate {
	public static final int ID = 31413;

	@Inject
	protected AntonioTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
