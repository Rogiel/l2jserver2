 ...
 */
public class GretaTemplate extends MerchantNPCTemplate {
	public static final int ID = 31318;

	@Inject
	protected GretaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
