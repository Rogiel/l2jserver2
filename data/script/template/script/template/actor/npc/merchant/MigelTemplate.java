 ...
 */
public class MigelTemplate extends MerchantNPCTemplate {
	public static final int ID = 31422;

	@Inject
	protected MigelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
