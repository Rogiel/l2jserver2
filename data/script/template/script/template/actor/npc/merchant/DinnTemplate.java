 ...
 */
public class DinnTemplate extends MerchantNPCTemplate {
	public static final int ID = 32105;

	@Inject
	protected DinnTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
