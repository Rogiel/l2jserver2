 ...
 */
public class GaretteTemplate extends MerchantNPCTemplate {
	public static final int ID = 30231;

	@Inject
	protected GaretteTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
