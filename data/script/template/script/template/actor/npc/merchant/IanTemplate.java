 ...
 */
public class IanTemplate extends MerchantNPCTemplate {
	public static final int ID = 30164;

	@Inject
	protected IanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
