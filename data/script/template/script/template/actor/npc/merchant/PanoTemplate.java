 ...
 */
public class PanoTemplate extends MerchantNPCTemplate {
	public static final int ID = 30078;

	@Inject
	protected PanoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
