 ...
 */
public class RupertTemplate extends MerchantNPCTemplate {
	public static final int ID = 31262;

	@Inject
	protected RupertTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
