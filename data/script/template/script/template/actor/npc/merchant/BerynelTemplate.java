 ...
 */
public class BerynelTemplate extends MerchantNPCTemplate {
	public static final int ID = 31417;

	@Inject
	protected BerynelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
