 ...
 */
public class AltairTemplate extends MerchantNPCTemplate {
	public static final int ID = 31962;

	@Inject
	protected AltairTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
