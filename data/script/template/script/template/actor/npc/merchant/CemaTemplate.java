 ...
 */
public class CemaTemplate extends MerchantNPCTemplate {
	public static final int ID = 30834;

	@Inject
	protected CemaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
