 ...
 */
public class ColleenTemplate extends MerchantNPCTemplate {
	public static final int ID = 30209;

	@Inject
	protected ColleenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Colleen";
		this.serverSideName = false;
		this.title = "Dye Merchant";
