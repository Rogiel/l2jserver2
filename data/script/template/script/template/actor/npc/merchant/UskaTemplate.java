 ...
 */
public class UskaTemplate extends MerchantNPCTemplate {
	public static final int ID = 30560;

	@Inject
	protected UskaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
