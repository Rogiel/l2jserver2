 ...
 */
public class OlfKanoreTemplate extends MerchantNPCTemplate {
	public static final int ID = 32610;

	@Inject
	protected OlfKanoreTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Olf Kanore";
