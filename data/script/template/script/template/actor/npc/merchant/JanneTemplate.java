 ...
 */
public class JanneTemplate extends MerchantNPCTemplate {
	public static final int ID = 31259;

	@Inject
	protected JanneTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
