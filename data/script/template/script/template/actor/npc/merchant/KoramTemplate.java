 ...
 */
public class KoramTemplate extends MerchantNPCTemplate {
	public static final int ID = 31425;

	@Inject
	protected KoramTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
