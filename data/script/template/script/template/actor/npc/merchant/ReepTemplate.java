 ...
 */
public class ReepTemplate extends MerchantNPCTemplate {
	public static final int ID = 30516;

	@Inject
	protected ReepTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
