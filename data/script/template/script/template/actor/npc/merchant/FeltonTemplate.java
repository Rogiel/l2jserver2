 ...
 */
public class FeltonTemplate extends MerchantNPCTemplate {
	public static final int ID = 30879;

	@Inject
	protected FeltonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
