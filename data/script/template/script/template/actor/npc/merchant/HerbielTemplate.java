 ...
 */
public class HerbielTemplate extends MerchantNPCTemplate {
	public static final int ID = 30150;

	@Inject
	protected HerbielTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
