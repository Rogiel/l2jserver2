 ...
 */
public class DimensionalVortex3Template extends NPCTemplate {
	public static final int ID = 30954;

	@Inject
	protected DimensionalVortex3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dimensional Vortex 3";
