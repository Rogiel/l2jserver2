 ...
 */
public class Trap75Template extends NPCTemplate {
	public static final int ID = 13239;

	@Inject
	protected Trap75Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
