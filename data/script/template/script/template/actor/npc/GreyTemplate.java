 ...
 */
public class GreyTemplate extends NPCTemplate {
	public static final int ID = 30744;

	@Inject
	protected GreyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
