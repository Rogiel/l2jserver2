 ...
 */
public class HestuiGuardTemplate extends NPCTemplate {
	public static final int ID = 32026;

	@Inject
	protected HestuiGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hestui Guard";
