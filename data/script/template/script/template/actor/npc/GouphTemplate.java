 ...
 */
public class GouphTemplate extends NPCTemplate {
	public static final int ID = 30523;

	@Inject
	protected GouphTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
