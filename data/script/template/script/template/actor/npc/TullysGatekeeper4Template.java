 ...
 */
public class TullysGatekeeper4Template extends NPCTemplate {
	public static final int ID = 18448;

	@Inject
	protected TullysGatekeeper4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
