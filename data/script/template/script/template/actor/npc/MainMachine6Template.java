 ...
 */
public class MainMachine6Template extends NPCTemplate {
	public static final int ID = 36052;

	@Inject
	protected MainMachine6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
