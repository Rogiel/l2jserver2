 ...
 */
public class MaryseRedbonnetTemplate extends NPCTemplate {
	public static final int ID = 30553;

	@Inject
	protected MaryseRedbonnetTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Maryse Redbonnet";
