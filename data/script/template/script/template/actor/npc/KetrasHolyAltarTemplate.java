 ...
 */
public class KetrasHolyAltarTemplate extends NPCTemplate {
	public static final int ID = 31558;

	@Inject
	protected KetrasHolyAltarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ketra's Holy Altar";
