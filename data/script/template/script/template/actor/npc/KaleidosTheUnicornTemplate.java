 ...
 */
public class KaleidosTheUnicornTemplate extends NPCTemplate {
	public static final int ID = 31629;

	@Inject
	protected KaleidosTheUnicornTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
