 ...
 */
public class ElTemplate extends NPCTemplate {
	public static final int ID = 32556;

	@Inject
	protected ElTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
