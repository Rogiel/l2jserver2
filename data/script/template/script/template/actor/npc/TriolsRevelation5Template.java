 ...
 */
public class TriolsRevelation5Template extends NPCTemplate {
	public static final int ID = 32062;

	@Inject
	protected TriolsRevelation5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
