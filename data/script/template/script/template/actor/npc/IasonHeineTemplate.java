 ...
 */
public class IasonHeineTemplate extends NPCTemplate {
	public static final int ID = 30969;

	@Inject
	protected IasonHeineTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Iason Heine";
