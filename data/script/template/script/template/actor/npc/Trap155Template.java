 ...
 */
public class Trap155Template extends NPCTemplate {
	public static final int ID = 18732;

	@Inject
	protected Trap155Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
