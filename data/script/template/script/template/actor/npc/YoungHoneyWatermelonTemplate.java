 ...
 */
public class YoungHoneyWatermelonTemplate extends NPCTemplate {
	public static final int ID = 13275;

	@Inject
	protected YoungHoneyWatermelonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Young Honey Watermelon";
