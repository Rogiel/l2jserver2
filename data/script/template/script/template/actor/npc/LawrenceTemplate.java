 ...
 */
public class LawrenceTemplate extends NPCTemplate {
	public static final int ID = 32595;

	@Inject
	protected LawrenceTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
