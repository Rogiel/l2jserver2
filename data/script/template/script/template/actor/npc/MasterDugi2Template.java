 ...
 */
public class MasterDugi2Template extends NPCTemplate {
	public static final int ID = 32635;

	@Inject
	protected MasterDugi2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Master Dugi";
		this.serverSideName = false;
		this.title = "Energy Recovery Event";
		this.serverSideTitle = false;
		this.collisionRadius = 9.00;
		this.collisionHeight = 16.70;
		this.level = 75;
