 ...
 */
public class KalibranTemplate extends NPCTemplate {
	public static final int ID = 30750;

	@Inject
	protected KalibranTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
