 ...
 */
public class FallenAngel2Template extends NPCTemplate {
	public static final int ID = 32369;

	@Inject
	protected FallenAngel2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
