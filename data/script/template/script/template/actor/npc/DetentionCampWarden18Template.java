 ...
 */
public class DetentionCampWarden18Template extends NPCTemplate {
	public static final int ID = 36257;

	@Inject
	protected DetentionCampWarden18Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Detention Camp Warden";
