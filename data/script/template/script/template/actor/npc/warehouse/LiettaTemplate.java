 ...
 */
public class LiettaTemplate extends WarehouseNPCTemplate {
	public static final int ID = 31267;

	@Inject
	protected LiettaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
