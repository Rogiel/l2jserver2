 ...
 */
public class RompTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30843;

	@Inject
	protected RompTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
