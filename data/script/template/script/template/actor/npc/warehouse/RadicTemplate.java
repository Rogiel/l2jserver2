 ...
 */
public class RadicTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30170;

	@Inject
	protected RadicTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
