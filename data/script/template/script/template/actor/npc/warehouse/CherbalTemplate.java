 ...
 */
public class CherbalTemplate extends WarehouseNPCTemplate {
	public static final int ID = 31957;

	@Inject
	protected CherbalTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
