 ...
 */
public class ImantuTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30563;

	@Inject
	protected ImantuTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
