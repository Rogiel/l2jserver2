 ...
 */
public class SilvaTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30686;

	@Inject
	protected SilvaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
