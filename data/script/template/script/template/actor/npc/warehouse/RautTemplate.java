 ...
 */
public class RautTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30316;

	@Inject
	protected RautTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
