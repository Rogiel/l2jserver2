 ...
 */
public class AiryTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30522;

	@Inject
	protected AiryTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
