 ...
 */
public class DorankusTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30139;

	@Inject
	protected DorankusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
