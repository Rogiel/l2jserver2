 ...
 */
public class HaggerTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30183;

	@Inject
	protected HaggerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
