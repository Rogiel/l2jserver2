 ...
 */
public class CliffTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30182;

	@Inject
	protected CliffTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
