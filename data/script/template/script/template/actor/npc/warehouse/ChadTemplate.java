 ...
 */
public class ChadTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30151;

	@Inject
	protected ChadTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
