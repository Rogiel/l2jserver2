 ...
 */
public class WalderalTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30844;

	@Inject
	protected WalderalTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
