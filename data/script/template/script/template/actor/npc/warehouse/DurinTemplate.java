 ...
 */
public class DurinTemplate extends WarehouseNPCTemplate {
	public static final int ID = 31312;

	@Inject
	protected DurinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
