 ...
 */
public class BarderTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30079;

	@Inject
	protected BarderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
