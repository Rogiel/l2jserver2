 ...
 */
public class LuninTemplate extends WarehouseNPCTemplate {
	public static final int ID = 31313;

	@Inject
	protected LuninTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
