 ...
 */
public class JaffTemplate extends WarehouseNPCTemplate {
	public static final int ID = 31374;

	@Inject
	protected JaffTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
