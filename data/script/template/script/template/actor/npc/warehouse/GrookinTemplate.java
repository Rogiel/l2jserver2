 ...
 */
public class GrookinTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30562;

	@Inject
	protected GrookinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
