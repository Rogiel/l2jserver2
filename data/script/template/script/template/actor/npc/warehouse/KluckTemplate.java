 ...
 */
public class KluckTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30895;

	@Inject
	protected KluckTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
