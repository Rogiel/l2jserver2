 ...
 */
public class RydelTemplate extends WarehouseNPCTemplate {
	public static final int ID = 31956;

	@Inject
	protected RydelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
