 ...
 */
public class ParmanTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30104;

	@Inject
	protected ParmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
