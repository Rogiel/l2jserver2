 ...
 */
public class SoninTemplate extends WarehouseNPCTemplate {
	public static final int ID = 31773;

	@Inject
	protected SoninTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
