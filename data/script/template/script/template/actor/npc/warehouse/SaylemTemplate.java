 ...
 */
public class SaylemTemplate extends WarehouseNPCTemplate {
	public static final int ID = 32172;

	@Inject
	protected SaylemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
