 ...
 */
public class JuliaTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30152;

	@Inject
	protected JuliaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
