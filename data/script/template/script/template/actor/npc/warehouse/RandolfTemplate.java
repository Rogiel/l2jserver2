 ...
 */
public class RandolfTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30095;

	@Inject
	protected RandolfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
