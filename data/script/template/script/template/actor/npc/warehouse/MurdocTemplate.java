 ...
 */
public class MurdocTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30521;

	@Inject
	protected MurdocTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
