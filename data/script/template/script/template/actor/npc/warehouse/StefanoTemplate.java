 ...
 */
public class StefanoTemplate extends WarehouseNPCTemplate {
	public static final int ID = 31270;

	@Inject
	protected StefanoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
