 ...
 */
public class HaprockTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30255;

	@Inject
	protected HaprockTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
