 ...
 */
public class ErvianteTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30140;

	@Inject
	protected ErvianteTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
