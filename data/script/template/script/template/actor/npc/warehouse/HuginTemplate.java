 ...
 */
public class HuginTemplate extends WarehouseNPCTemplate {
	public static final int ID = 31311;

	@Inject
	protected HuginTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
