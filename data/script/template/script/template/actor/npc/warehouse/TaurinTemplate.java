 ...
 */
public class TaurinTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30086;

	@Inject
	protected TaurinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
