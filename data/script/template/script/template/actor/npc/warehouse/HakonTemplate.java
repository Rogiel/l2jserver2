 ...
 */
public class HakonTemplate extends WarehouseNPCTemplate {
	public static final int ID = 31268;

	@Inject
	protected HakonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
