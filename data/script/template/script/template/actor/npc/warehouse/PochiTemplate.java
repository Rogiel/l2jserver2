 ...
 */
public class PochiTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30083;

	@Inject
	protected PochiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
