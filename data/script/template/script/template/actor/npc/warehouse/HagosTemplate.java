 ...
 */
public class HagosTemplate extends WarehouseNPCTemplate {
	public static final int ID = 31381;

	@Inject
	protected HagosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
