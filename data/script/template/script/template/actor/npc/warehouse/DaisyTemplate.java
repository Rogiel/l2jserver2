 ...
 */
public class DaisyTemplate extends WarehouseNPCTemplate {
	public static final int ID = 31315;

	@Inject
	protected DaisyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
