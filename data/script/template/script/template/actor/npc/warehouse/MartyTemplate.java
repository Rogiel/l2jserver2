 ...
 */
public class MartyTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30169;

	@Inject
	protected MartyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
