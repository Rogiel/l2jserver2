 ...
 */
public class NormanTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30210;

	@Inject
	protected NormanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
