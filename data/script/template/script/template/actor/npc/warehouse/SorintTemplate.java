 ...
 */
public class SorintTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30232;

	@Inject
	protected SorintTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
