 ...
 */
public class MiaTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30896;

	@Inject
	protected MiaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
