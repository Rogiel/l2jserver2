 ...
 */
public class AxelTemplate extends WarehouseNPCTemplate {
	public static final int ID = 31959;

	@Inject
	protected AxelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
