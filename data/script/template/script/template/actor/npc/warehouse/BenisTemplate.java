 ...
 */
public class BenisTemplate extends WarehouseNPCTemplate {
	public static final int ID = 32170;

	@Inject
	protected BenisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
