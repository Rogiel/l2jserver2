 ...
 */
public class CarlonTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30350;

	@Inject
	protected CarlonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
