 ...
 */
public class MarkiusTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30153;

	@Inject
	protected MarkiusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
