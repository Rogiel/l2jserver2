 ...
 */
public class ValkonTemplate extends WarehouseNPCTemplate {
	public static final int ID = 30103;

	@Inject
	protected ValkonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
