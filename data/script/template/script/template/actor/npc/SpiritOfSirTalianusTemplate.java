 ...
 */
public class SpiritOfSirTalianusTemplate extends NPCTemplate {
	public static final int ID = 30656;

	@Inject
	protected SpiritOfSirTalianusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Spirit Of Sir Talianus";
