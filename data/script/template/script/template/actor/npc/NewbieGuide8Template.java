 ...
 */
public class NewbieGuide8Template extends NPCTemplate {
	public static final int ID = 32135;

	@Inject
	protected NewbieGuide8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
