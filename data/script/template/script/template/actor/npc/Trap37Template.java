 ...
 */
public class Trap37Template extends NPCTemplate {
	public static final int ID = 13127;

	@Inject
	protected Trap37Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
