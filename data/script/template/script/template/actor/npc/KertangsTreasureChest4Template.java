 ...
 */
public class KertangsTreasureChest4Template extends NPCTemplate {
	public static final int ID = 18537;

	@Inject
	protected KertangsTreasureChest4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
