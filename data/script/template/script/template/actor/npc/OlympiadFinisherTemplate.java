 ...
 */
public class OlympiadFinisherTemplate extends NPCTemplate {
	public static final int ID = 31689;

	@Inject
	protected OlympiadFinisherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Olympiad Finisher";
