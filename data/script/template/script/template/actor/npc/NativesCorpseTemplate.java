 ...
 */
public class NativesCorpseTemplate extends NPCTemplate {
	public static final int ID = 32306;

	@Inject
	protected NativesCorpseTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Native's Corpse";
