 ...
 */
public class EnergySeedFireTemplate extends NPCTemplate {
	public static final int ID = 18679;

	@Inject
	protected EnergySeedFireTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Energy Seed - Fire";
