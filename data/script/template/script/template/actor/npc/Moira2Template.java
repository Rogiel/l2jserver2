 ...
 */
public class Moira2Template extends NPCTemplate {
	public static final int ID = 32554;

	@Inject
	protected Moira2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
