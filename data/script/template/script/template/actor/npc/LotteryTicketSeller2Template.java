 ...
 */
public class LotteryTicketSeller2Template extends NPCTemplate {
	public static final int ID = 30991;

	@Inject
	protected LotteryTicketSeller2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lottery Ticket Seller";
