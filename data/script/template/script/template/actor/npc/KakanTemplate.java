 ...
 */
public class KakanTemplate extends NPCTemplate {
	public static final int ID = 30669;

	@Inject
	protected KakanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
