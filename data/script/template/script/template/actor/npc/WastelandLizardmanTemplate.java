 ...
 */
public class WastelandLizardmanTemplate extends NPCTemplate {
	public static final int ID = 30410;

	@Inject
	protected WastelandLizardmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Wasteland Lizardman";
