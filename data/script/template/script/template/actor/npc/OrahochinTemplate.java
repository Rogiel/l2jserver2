 ...
 */
public class OrahochinTemplate extends NPCTemplate {
	public static final int ID = 32111;

	@Inject
	protected OrahochinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
