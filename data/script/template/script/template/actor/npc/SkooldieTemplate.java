 ...
 */
public class SkooldieTemplate extends NPCTemplate {
	public static final int ID = 13281;

	@Inject
	protected SkooldieTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
