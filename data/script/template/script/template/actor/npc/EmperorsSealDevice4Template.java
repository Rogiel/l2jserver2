 ...
 */
public class EmperorsSealDevice4Template extends NPCTemplate {
	public static final int ID = 32590;

	@Inject
	protected EmperorsSealDevice4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
