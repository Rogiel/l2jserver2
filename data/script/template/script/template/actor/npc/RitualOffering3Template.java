 ...
 */
public class RitualOffering3Template extends NPCTemplate {
	public static final int ID = 32038;

	@Inject
	protected RitualOffering3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
