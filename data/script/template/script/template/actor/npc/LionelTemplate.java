 ...
 */
public class LionelTemplate extends NPCTemplate {
	public static final int ID = 30408;

	@Inject
	protected LionelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
