 ...
 */
public class KaleidosTheUnicorn2Template extends NPCTemplate {
	public static final int ID = 31630;

	@Inject
	protected KaleidosTheUnicorn2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kaleidos the Unicorn";
