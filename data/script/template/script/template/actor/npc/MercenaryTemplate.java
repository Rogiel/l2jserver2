 ...
 */
public class MercenaryTemplate extends NPCTemplate {
	public static final int ID = 13159;

	@Inject
	protected MercenaryTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
