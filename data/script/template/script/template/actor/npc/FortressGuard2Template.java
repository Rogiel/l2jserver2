 ...
 */
public class FortressGuard2Template extends NPCTemplate {
	public static final int ID = 35642;

	@Inject
	protected FortressGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fortress Guard";
