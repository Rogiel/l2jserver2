 ...
 */
public class MedibalsCorpseTemplate extends NPCTemplate {
	public static final int ID = 32528;

	@Inject
	protected MedibalsCorpseTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Medibal's Corpse";
