 ...
 */
public class EntranceManagerTemplate extends NPCTemplate {
	public static final int ID = 32503;

	@Inject
	protected EntranceManagerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Entrance Manager";
		this.serverSideName = false;
		this.title = "Kratei's Cube";
