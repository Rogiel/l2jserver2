 ...
 */
public class VarangkasGuardianTemplate extends NPCTemplate {
	public static final int ID = 18836;

	@Inject
	protected VarangkasGuardianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Varangka's Guardian";
