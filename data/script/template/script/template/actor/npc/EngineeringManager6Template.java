 ...
 */
public class EngineeringManager6Template extends NPCTemplate {
	public static final int ID = 35832;

	@Inject
	protected EngineeringManager6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
