 ...
 */
public class DaurinHammercrushTemplate extends NPCTemplate {
	public static final int ID = 30674;

	@Inject
	protected DaurinHammercrushTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Daurin Hammercrush";
