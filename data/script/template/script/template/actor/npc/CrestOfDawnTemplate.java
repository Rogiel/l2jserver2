 ...
 */
public class CrestOfDawnTemplate extends NPCTemplate {
	public static final int ID = 31170;

	@Inject
	protected CrestOfDawnTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Crest of Dawn";
