 ...
 */
public class GuardCaptain41Template extends NPCTemplate {
	public static final int ID = 36357;

	@Inject
	protected GuardCaptain41Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
