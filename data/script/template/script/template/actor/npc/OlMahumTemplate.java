 ...
 */
public class OlMahumTemplate extends NPCTemplate {
	public static final int ID = 13110;

	@Inject
	protected OlMahumTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
