 ...
 */
public class ValentineTemplate extends NPCTemplate {
	public static final int ID = 31584;

	@Inject
	protected ValentineTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
