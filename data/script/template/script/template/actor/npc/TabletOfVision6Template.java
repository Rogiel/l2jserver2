 ...
 */
public class TabletOfVision6Template extends NPCTemplate {
	public static final int ID = 31651;

	@Inject
	protected TabletOfVision6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
