 ...
 */
public class TunatunTemplate extends NPCTemplate {
	public static final int ID = 31537;

	@Inject
	protected TunatunTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tunatun";
		this.serverSideName = false;
		this.title = "Beast Herder";
