 ...
 */
public class PreacherOfDoom38Template extends NPCTemplate {
	public static final int ID = 31718;

	@Inject
	protected PreacherOfDoom38Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
