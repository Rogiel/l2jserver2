 ...
 */
public class RedFlag2Template extends NPCTemplate {
	public static final int ID = 35607;

	@Inject
	protected RedFlag2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
