 ...
 */
public class TriolsRevelation3Template extends NPCTemplate {
	public static final int ID = 32060;

	@Inject
	protected TriolsRevelation3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
