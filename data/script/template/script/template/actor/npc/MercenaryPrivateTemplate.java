 ...
 */
public class MercenaryPrivateTemplate extends NPCTemplate {
	public static final int ID = 35687;

	@Inject
	protected MercenaryPrivateTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
