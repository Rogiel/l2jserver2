 ...
 */
public class HotSpringsYeti5Template extends NPCTemplate {
	public static final int ID = 35599;

	@Inject
	protected HotSpringsYeti5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 10000.00000;
