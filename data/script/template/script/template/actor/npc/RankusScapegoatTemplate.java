 ...
 */
public class RankusScapegoatTemplate extends NPCTemplate {
	public static final int ID = 32305;

	@Inject
	protected RankusScapegoatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ranku's Scapegoat";
