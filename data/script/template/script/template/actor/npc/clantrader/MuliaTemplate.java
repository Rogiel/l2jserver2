 ...
 */
package script.template.actor.npc.clantrader;

import com.google.inject.Inject;
import com.l2jserver.model.id.template.provider.ItemTemplateIDProvider;
import com.l2jserver.model.id.template.provider.NPCTemplateIDProvider;
import com.l2jserver.model.template.npc.ClanTraderNPCTemplate;
import com.l2jserver.model.world.Actor.ActorSex;

/**
 * @author <a href="http://www.rogiel.com">Rogiel</a>
 */
public class MuliaTemplate extends ClanTraderNPCTemplate {
	public static final int ID = 32024;

	@Inject
	protected MuliaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mulia";
		this.serverSideName = false;
		this.title = "Clan Trader";
