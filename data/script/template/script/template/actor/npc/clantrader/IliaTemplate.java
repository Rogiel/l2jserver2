 ...
 */
public class IliaTemplate extends ClanTraderNPCTemplate {
	public static final int ID = 32025;

	@Inject
	protected IliaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
