 ...
 */
public class HighQualityLargeSquashTemplate extends NPCTemplate {
	public static final int ID = 12778;

	@Inject
	protected HighQualityLargeSquashTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "High Quality Large Squash";
