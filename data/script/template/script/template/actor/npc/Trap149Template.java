 ...
 */
public class Trap149Template extends NPCTemplate {
	public static final int ID = 18726;

	@Inject
	protected Trap149Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
