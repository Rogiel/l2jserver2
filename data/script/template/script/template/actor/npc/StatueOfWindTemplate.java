 ...
 */
public class StatueOfWindTemplate extends NPCTemplate {
	public static final int ID = 30964;

	@Inject
	protected StatueOfWindTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Statue of Wind";
