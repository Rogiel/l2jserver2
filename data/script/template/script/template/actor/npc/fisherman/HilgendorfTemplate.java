 ...
 */
public class HilgendorfTemplate extends FishermanNPCTemplate {
	public static final int ID = 31578;

	@Inject
	protected HilgendorfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hilgendorf";
