 ...
 */
public class CyanoTemplate extends FishermanNPCTemplate {
	public static final int ID = 31569;

	@Inject
	protected CyanoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
