 ...
 */
public class LanoscoTemplate extends FishermanNPCTemplate {
	public static final int ID = 31570;

	@Inject
	protected LanoscoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
