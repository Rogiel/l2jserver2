 ...
 */
public class PerelinTemplate extends FishermanNPCTemplate {
	public static final int ID = 31563;

	@Inject
	protected PerelinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
