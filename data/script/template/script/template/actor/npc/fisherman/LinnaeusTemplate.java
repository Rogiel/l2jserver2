 ...
 */
public class LinnaeusTemplate extends FishermanNPCTemplate {
	public static final int ID = 31577;

	@Inject
	protected LinnaeusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
