 ...
 */
public class RopfiTemplate extends FishermanNPCTemplate {
	public static final int ID = 31566;

	@Inject
	protected RopfiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
