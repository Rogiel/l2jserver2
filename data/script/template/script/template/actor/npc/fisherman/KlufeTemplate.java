 ...
 */
public class KlufeTemplate extends FishermanNPCTemplate {
	public static final int ID = 31562;

	@Inject
	protected KlufeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
