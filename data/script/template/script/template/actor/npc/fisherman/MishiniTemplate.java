 ...
 */
public class MishiniTemplate extends FishermanNPCTemplate {
	public static final int ID = 31564;

	@Inject
	protected MishiniTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
