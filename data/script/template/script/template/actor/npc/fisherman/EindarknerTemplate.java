 ...
 */
package script.template.actor.npc.fisherman;

import com.google.inject.Inject;
import com.l2jserver.model.id.template.provider.ItemTemplateIDProvider;
import com.l2jserver.model.id.template.provider.NPCTemplateIDProvider;
import com.l2jserver.model.template.npc.FishermanNPCTemplate;
import com.l2jserver.model.world.Actor.ActorSex;

/**
 * @author <a href="http://www.rogiel.com">Rogiel</a>
 */
public class EindarknerTemplate extends FishermanNPCTemplate {
	public static final int ID = 31697;

	@Inject
	protected EindarknerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Eindarkner";
		...
		this.rightHand = itemProvider.createID(7560);
		this.leftHand = null;
		this.enchantLevel = 0;
