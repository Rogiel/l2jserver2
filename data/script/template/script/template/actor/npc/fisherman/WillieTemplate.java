 ...
 */
public class WillieTemplate extends FishermanNPCTemplate {
	public static final int ID = 31574;

	@Inject
	protected WillieTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
