 ...
 */
public class GalbaTemplate extends FishermanNPCTemplate {
	public static final int ID = 32007;

	@Inject
	protected GalbaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
