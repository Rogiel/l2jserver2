 ...
 */
public class HufsTemplate extends FishermanNPCTemplate {
	public static final int ID = 31571;

	@Inject
	protected HufsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
