 ...
 */
public class OfulleTemplate extends FishermanNPCTemplate {
	public static final int ID = 31572;

	@Inject
	protected OfulleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
