 ...
 */
public class MonakanTemplate extends FishermanNPCTemplate {
	public static final int ID = 31573;

	@Inject
	protected MonakanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
