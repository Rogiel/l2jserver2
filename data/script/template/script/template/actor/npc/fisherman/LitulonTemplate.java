 ...
 */
public class LitulonTemplate extends FishermanNPCTemplate {
	public static final int ID = 31575;

	@Inject
	protected LitulonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
