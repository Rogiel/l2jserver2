 ...
 */
public class PlatisTemplate extends FishermanNPCTemplate {
	public static final int ID = 31696;

	@Inject
	protected PlatisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
