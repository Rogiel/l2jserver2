 ...
 */
public class KlausTemplate extends FishermanNPCTemplate {
	public static final int ID = 31579;

	@Inject
	protected KlausTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
