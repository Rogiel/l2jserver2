 ...
 */
public class BleakerTemplate extends FishermanNPCTemplate {
	public static final int ID = 31567;

	@Inject
	protected BleakerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
