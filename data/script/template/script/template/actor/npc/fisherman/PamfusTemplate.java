 ...
 */
public class PamfusTemplate extends FishermanNPCTemplate {
	public static final int ID = 31568;

	@Inject
	protected PamfusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
