 ...
 */
public class BatidaeTemplate extends FishermanNPCTemplate {
	public static final int ID = 31989;

	@Inject
	protected BatidaeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
