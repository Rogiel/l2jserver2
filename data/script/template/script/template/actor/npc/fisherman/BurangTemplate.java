 ...
 */
public class BurangTemplate extends FishermanNPCTemplate {
	public static final int ID = 32348;

	@Inject
	protected BurangTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
