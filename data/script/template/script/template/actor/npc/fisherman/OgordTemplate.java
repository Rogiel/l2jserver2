 ...
 */
public class OgordTemplate extends FishermanNPCTemplate {
	public static final int ID = 31565;

	@Inject
	protected OgordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
