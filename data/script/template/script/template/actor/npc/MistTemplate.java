 ...
 */
public class MistTemplate extends NPCTemplate {
	public static final int ID = 31627;

	@Inject
	protected MistTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
