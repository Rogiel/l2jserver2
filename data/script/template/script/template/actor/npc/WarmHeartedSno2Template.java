 ...
 */
public class WarmHeartedSno2Template extends NPCTemplate {
	public static final int ID = 14;

	@Inject
	protected WarmHeartedSno2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
