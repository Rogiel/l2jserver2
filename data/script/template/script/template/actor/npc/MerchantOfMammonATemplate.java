 ...
 */
public class MerchantOfMammonATemplate extends NPCTemplate {
	public static final int ID = 18824;

	@Inject
	protected MerchantOfMammonATemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Merchant of Mammon A";
