 ...
 */
public class ResurrectedTownMaidenTemplate extends NPCTemplate {
	public static final int ID = 30976;

	@Inject
	protected ResurrectedTownMaidenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Resurrected Town Maiden";
