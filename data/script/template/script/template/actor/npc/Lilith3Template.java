 ...
 */
public class Lilith3Template extends NPCTemplate {
	public static final int ID = 30368;

	@Inject
	protected Lilith3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
