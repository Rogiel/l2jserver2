 ...
 */
public class TullysGatekeeper9Template extends NPCTemplate {
	public static final int ID = 18453;

	@Inject
	protected TullysGatekeeper9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
