 ...
 */
public class UdanMarduisBoxTemplate extends NPCTemplate {
	public static final int ID = 31561;

	@Inject
	protected UdanMarduisBoxTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Udan Mardui's Box";
