 ...
 */
public class NewbieGuide2Template extends NPCTemplate {
	public static final int ID = 30599;

	@Inject
	protected NewbieGuide2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
