 ...
 */
public class HanarinTemplate extends NPCTemplate {
	public static final int ID = 32191;

	@Inject
	protected HanarinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
