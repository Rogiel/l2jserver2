 ...
 */
public class GuardianOfNorthernSealTemplate extends NPCTemplate {
	public static final int ID = 32661;

	@Inject
	protected GuardianOfNorthernSealTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guardian of Northern Seal";
