 ...
 */
public class SirOrthoLancerTemplate extends NPCTemplate {
	public static final int ID = 30477;

	@Inject
	protected SirOrthoLancerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sir Ortho Lancer";
