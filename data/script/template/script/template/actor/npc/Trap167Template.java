 ...
 */
public class Trap167Template extends NPCTemplate {
	public static final int ID = 18744;

	@Inject
	protected Trap167Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
