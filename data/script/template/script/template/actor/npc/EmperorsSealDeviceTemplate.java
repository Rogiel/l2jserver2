 ...
 */
public class EmperorsSealDeviceTemplate extends NPCTemplate {
	public static final int ID = 18833;

	@Inject
	protected EmperorsSealDeviceTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
