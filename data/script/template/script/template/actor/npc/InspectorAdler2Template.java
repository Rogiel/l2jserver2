 ...
 */
public class InspectorAdler2Template extends NPCTemplate {
	public static final int ID = 32510;

	@Inject
	protected InspectorAdler2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Inspector Adler";
