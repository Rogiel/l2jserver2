 ...
 */
public class ForgottenMonumentTemplate extends NPCTemplate {
	public static final int ID = 31661;

	@Inject
	protected ForgottenMonumentTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
