 ...
 */
public class RoienTemplate extends NPCTemplate {
	public static final int ID = 30008;

	@Inject
	protected RoienTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
