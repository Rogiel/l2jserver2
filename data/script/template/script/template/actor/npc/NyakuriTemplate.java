 ...
 */
public class NyakuriTemplate extends NPCTemplate {
	public static final int ID = 30670;

	@Inject
	protected NyakuriTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
