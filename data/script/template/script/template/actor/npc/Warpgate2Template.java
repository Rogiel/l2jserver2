 ...
 */
public class Warpgate2Template extends NPCTemplate {
	public static final int ID = 32315;

	@Inject
	protected Warpgate2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
