 ...
 */
public class WarmHeartedSno5Template extends NPCTemplate {
	public static final int ID = 17;

	@Inject
	protected WarmHeartedSno5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
