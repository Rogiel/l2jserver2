 ...
 */
public class SantaClausTemplate extends NPCTemplate {
	public static final int ID = 13184;

	@Inject
	protected SantaClausTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
