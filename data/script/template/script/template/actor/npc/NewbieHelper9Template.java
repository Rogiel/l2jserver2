 ...
 */
public class NewbieHelper9Template extends NPCTemplate {
	public static final int ID = 30530;

	@Inject
	protected NewbieHelper9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
