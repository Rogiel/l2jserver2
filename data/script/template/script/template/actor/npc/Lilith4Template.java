 ...
 */
public class Lilith4Template extends NPCTemplate {
	public static final int ID = 32715;

	@Inject
	protected Lilith4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
