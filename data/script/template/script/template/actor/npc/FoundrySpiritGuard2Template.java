 ...
 */
public class FoundrySpiritGuard2Template extends NPCTemplate {
	public static final int ID = 22389;

	@Inject
	protected FoundrySpiritGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
