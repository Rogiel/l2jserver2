 ...
 */
public class TonyTheCat2Template extends NPCTemplate {
	public static final int ID = 32100;

	@Inject
	protected TonyTheCat2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tony the Cat";
