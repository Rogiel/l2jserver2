 ...
 */
public class ClaudiaAthebaldtTemplate extends NPCTemplate {
	public static final int ID = 31001;

	@Inject
	protected ClaudiaAthebaldtTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Claudia Athebaldt";
