 ...
 */
public class DaimonsAltarTemplate extends NPCTemplate {
	public static final int ID = 31541;

	@Inject
	protected DaimonsAltarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Daimon's Altar";
