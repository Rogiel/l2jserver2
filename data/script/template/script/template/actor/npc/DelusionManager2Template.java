 ...
 */
public class DelusionManager2Template extends NPCTemplate {
	public static final int ID = 32665;

	@Inject
	protected DelusionManager2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
