 ...
 */
public class Trap27Template extends NPCTemplate {
	public static final int ID = 13063;

	@Inject
	protected Trap27Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
