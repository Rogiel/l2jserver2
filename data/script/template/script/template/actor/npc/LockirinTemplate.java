 ...
 */
public class LockirinTemplate extends NPCTemplate {
	public static final int ID = 30531;

	@Inject
	protected LockirinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lockirin";
		this.serverSideName = false;
		this.title = "Iron Gate's";
