 ...
 */
public class UdanMarduiTemplate extends NPCTemplate {
	public static final int ID = 31379;

	@Inject
	protected UdanMarduiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Udan Mardui";
