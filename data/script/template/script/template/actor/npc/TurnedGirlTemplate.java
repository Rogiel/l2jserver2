 ...
 */
public class TurnedGirlTemplate extends NPCTemplate {
	public static final int ID = 18582;

	@Inject
	protected TurnedGirlTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Turned Girl";
		this.serverSideName = false;
		this.title = "Kratei's Fortune";
