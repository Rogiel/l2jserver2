 ...
 */
public class Trap84Template extends NPCTemplate {
	public static final int ID = 13248;

	@Inject
	protected Trap84Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
