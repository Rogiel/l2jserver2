 ...
 */
public class HallGuard4Template extends NPCTemplate {
	public static final int ID = 18472;

	@Inject
	protected HallGuard4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
