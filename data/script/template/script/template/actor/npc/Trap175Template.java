 ...
 */
public class Trap175Template extends NPCTemplate {
	public static final int ID = 18752;

	@Inject
	protected Trap175Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
