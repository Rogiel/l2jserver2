 ...
 */
public class OuterDoorman13Template extends NPCTemplate {
	public static final int ID = 35626;

	@Inject
	protected OuterDoorman13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
