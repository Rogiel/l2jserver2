 ...
 */
public class GuardCaptainTemplate extends NPCTemplate {
	public static final int ID = 35660;

	@Inject
	protected GuardCaptainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
