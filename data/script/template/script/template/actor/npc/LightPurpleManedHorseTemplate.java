 ...
 */
public class LightPurpleManedHorseTemplate extends NPCTemplate {
	public static final int ID = 13130;

	@Inject
	protected LightPurpleManedHorseTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Light Purple Maned Horse";
