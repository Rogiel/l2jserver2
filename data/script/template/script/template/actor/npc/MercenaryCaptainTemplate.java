 ...
 */
public class MercenaryCaptainTemplate extends NPCTemplate {
	public static final int ID = 35686;

	@Inject
	protected MercenaryCaptainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
