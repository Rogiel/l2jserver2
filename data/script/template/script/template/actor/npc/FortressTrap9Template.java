 ...
 */
public class FortressTrap9Template extends NPCTemplate {
	public static final int ID = 36420;

	@Inject
	protected FortressTrap9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
