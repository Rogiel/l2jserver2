 ...
 */
public class MercenaryPrivate5Template extends NPCTemplate {
	public static final int ID = 35825;

	@Inject
	protected MercenaryPrivate5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
