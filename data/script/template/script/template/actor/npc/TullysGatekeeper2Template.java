 ...
 */
public class TullysGatekeeper2Template extends NPCTemplate {
	public static final int ID = 18446;

	@Inject
	protected TullysGatekeeper2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
