 ...
 */
public class FirstOrcTemplate extends NPCTemplate {
	public static final int ID = 30643;

	@Inject
	protected FirstOrcTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
