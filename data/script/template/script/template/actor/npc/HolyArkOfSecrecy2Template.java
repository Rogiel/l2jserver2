 ...
 */
public class HolyArkOfSecrecy2Template extends NPCTemplate {
	public static final int ID = 30978;

	@Inject
	protected HolyArkOfSecrecy2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Holy Ark of Secrecy 2";
