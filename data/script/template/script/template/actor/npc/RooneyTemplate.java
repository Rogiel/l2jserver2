 ...
 */
public class RooneyTemplate extends NPCTemplate {
	public static final int ID = 32049;

	@Inject
	protected RooneyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rooney";
		this.serverSideName = false;
		this.title = "Blacksmith of Wind";
