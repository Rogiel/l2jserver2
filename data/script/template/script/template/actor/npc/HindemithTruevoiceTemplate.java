 ...
 */
public class HindemithTruevoiceTemplate extends NPCTemplate {
	public static final int ID = 31645;

	@Inject
	protected HindemithTruevoiceTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hindemith Truevoice";
