 ...
 */
public class GuardianOfBorder16Template extends NPCTemplate {
	public static final int ID = 31880;

	@Inject
	protected GuardianOfBorder16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
