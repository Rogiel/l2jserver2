 ...
 */
public class HotSpringsYeti3Template extends NPCTemplate {
	public static final int ID = 35597;

	@Inject
	protected HotSpringsYeti3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
