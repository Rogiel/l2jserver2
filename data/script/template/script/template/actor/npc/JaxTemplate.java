 ...
 */
public class JaxTemplate extends NPCTemplate {
	public static final int ID = 30730;

	@Inject
	protected JaxTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
