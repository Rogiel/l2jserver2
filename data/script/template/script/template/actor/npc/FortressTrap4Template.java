 ...
 */
public class FortressTrap4Template extends NPCTemplate {
	public static final int ID = 36415;

	@Inject
	protected FortressTrap4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
