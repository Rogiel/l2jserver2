 ...
 */
public class SuspiciousManTemplate extends NPCTemplate {
	public static final int ID = 32019;

	@Inject
	protected SuspiciousManTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
