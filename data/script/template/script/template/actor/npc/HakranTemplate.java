 ...
 */
public class HakranTemplate extends NPCTemplate {
	public static final int ID = 31339;

	@Inject
	protected HakranTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
