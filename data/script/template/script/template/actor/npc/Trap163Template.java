 ...
 */
public class Trap163Template extends NPCTemplate {
	public static final int ID = 18740;

	@Inject
	protected Trap163Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
