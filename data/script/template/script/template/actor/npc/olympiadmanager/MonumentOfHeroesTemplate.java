 ...
 */
public class MonumentOfHeroesTemplate extends OlympiadManagerNPCTemplate {
	public static final int ID = 31690;

	@Inject
	protected MonumentOfHeroesTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
