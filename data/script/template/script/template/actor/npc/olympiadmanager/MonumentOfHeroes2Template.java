 ...
 */
public class MonumentOfHeroes2Template extends OlympiadManagerNPCTemplate {
	public static final int ID = 31769;

	@Inject
	protected MonumentOfHeroes2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
