 ...
 */
public class MonumentOfHeroes4Template extends OlympiadManagerNPCTemplate {
	public static final int ID = 31771;

	@Inject
	protected MonumentOfHeroes4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
