 ...
 */
public class MonumentOfHeroes5Template extends OlympiadManagerNPCTemplate {
	public static final int ID = 31772;

	@Inject
	protected MonumentOfHeroes5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
