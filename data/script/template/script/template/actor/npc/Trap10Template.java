 ...
 */
public class Trap10Template extends NPCTemplate {
	public static final int ID = 13046;

	@Inject
	protected Trap10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
