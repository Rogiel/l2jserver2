 ...
 */
public class KetraVanCaptainTemplate extends NPCTemplate {
	public static final int ID = 31709;

	@Inject
	protected KetraVanCaptainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ketra Van Captain";
