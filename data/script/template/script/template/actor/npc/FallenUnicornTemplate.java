 ...
 */
public class FallenUnicornTemplate extends NPCTemplate {
	public static final int ID = 31746;

	@Inject
	protected FallenUnicornTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fallen Unicorn";
