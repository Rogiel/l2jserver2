 ...
 */
public class Flagpole18Template extends NPCTemplate {
	public static final int ID = 36247;

	@Inject
	protected Flagpole18Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
