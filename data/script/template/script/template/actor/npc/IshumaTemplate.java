 ...
 */
public class IshumaTemplate extends NPCTemplate {
	public static final int ID = 32615;

	@Inject
	protected IshumaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
