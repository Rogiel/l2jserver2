 ...
 */
public class WildMaguenTemplate extends NPCTemplate {
	public static final int ID = 18839;

	@Inject
	protected WildMaguenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Wild Maguen";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 11.00;
		this.collisionHeight = 13.25;
		this.level = 85;
