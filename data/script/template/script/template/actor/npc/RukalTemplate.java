 ...
 */
public class RukalTemplate extends NPCTemplate {
	public static final int ID = 30629;

	@Inject
	protected RukalTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
