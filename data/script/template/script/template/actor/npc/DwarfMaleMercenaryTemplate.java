 ...
 */
public class DwarfMaleMercenaryTemplate extends NPCTemplate {
	public static final int ID = 13173;

	@Inject
	protected DwarfMaleMercenaryTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dwarf Male Mercenary";
