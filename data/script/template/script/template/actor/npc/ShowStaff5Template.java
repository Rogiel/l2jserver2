 ...
 */
public class ShowStaff5Template extends NPCTemplate {
	public static final int ID = 32428;

	@Inject
	protected ShowStaff5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
