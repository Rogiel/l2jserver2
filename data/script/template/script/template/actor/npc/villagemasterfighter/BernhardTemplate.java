 ...
 */
public class BernhardTemplate extends FightherVillageMasterNPCTemplate {
	public static final int ID = 31276;

	@Inject
	protected BernhardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
