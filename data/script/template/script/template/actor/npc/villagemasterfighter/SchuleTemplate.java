 ...
 */
public class SchuleTemplate extends FightherVillageMasterNPCTemplate {
	public static final int ID = 32094;

	@Inject
	protected SchuleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
