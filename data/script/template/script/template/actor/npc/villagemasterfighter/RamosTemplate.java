 ...
 */
public class RamosTemplate extends FightherVillageMasterNPCTemplate {
	public static final int ID = 30373;

	@Inject
	protected RamosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
