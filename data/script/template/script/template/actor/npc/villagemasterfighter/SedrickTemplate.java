 ...
 */
public class SedrickTemplate extends FightherVillageMasterNPCTemplate {
	public static final int ID = 30849;

	@Inject
	protected SedrickTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
