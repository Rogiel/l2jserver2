 ...
 */
public class PabrisTemplate extends FightherVillageMasterNPCTemplate {
	public static final int ID = 30066;

	@Inject
	protected PabrisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
