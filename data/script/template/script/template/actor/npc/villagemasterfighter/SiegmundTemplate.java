 ...
 */
public class SiegmundTemplate extends FightherVillageMasterNPCTemplate {
	public static final int ID = 31321;

	@Inject
	protected SiegmundTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
