 ...
 */
public class SiriaTemplate extends FightherVillageMasterNPCTemplate {
	public static final int ID = 30689;

	@Inject
	protected SiriaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
