 ...
 */
public class RainsTemplate extends FightherVillageMasterNPCTemplate {
	public static final int ID = 30288;

	@Inject
	protected RainsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
