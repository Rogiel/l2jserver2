 ...
 */
public class BitzTemplate extends FightherVillageMasterNPCTemplate {
	public static final int ID = 30026;

	@Inject
	protected BitzTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
