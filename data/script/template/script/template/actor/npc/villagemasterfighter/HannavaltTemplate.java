 ...
 */
public class HannavaltTemplate extends FightherVillageMasterNPCTemplate {
	public static final int ID = 30109;

	@Inject
	protected HannavaltTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
