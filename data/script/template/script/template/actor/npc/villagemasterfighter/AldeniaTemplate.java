 ...
 */
public class AldeniaTemplate extends FightherVillageMasterNPCTemplate {
	public static final int ID = 32154;

	@Inject
	protected AldeniaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
