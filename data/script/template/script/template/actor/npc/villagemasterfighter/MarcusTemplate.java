 ...
 */
public class MarcusTemplate extends FightherVillageMasterNPCTemplate {
	public static final int ID = 30900;

	@Inject
	protected MarcusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
