 ...
 */
public class Hector2Template extends FightherVillageMasterNPCTemplate {
	public static final int ID = 31965;

	@Inject
	protected Hector2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
