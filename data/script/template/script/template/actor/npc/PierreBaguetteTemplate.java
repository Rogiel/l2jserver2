 ...
 */
public class PierreBaguetteTemplate extends NPCTemplate {
	public static final int ID = 32639;

	@Inject
	protected PierreBaguetteTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Pierre Baguette";
		this.serverSideName = false;
		this.title = "April Fool's Day Event";
