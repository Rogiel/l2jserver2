 ...
 */
public class Trap185Template extends NPCTemplate {
	public static final int ID = 18762;

	@Inject
	protected Trap185Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
