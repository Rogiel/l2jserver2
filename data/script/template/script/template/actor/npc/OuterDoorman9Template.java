 ...
 */
public class OuterDoorman9Template extends NPCTemplate {
	public static final int ID = 35436;

	@Inject
	protected OuterDoorman9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
