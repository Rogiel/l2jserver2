 ...
 */
public class JewelTemplate extends NPCTemplate {
	public static final int ID = 30354;

	@Inject
	protected JewelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
