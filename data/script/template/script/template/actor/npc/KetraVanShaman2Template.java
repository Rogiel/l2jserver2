 ...
 */
public class KetraVanShaman2Template extends NPCTemplate {
	public static final int ID = 31711;

	@Inject
	protected KetraVanShaman2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ketra Van Shaman";
