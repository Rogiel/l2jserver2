 ...
 */
public class IngeniousContraption5Template extends NPCTemplate {
	public static final int ID = 18498;

	@Inject
	protected IngeniousContraption5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
