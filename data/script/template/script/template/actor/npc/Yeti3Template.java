 ...
 */
public class Yeti3Template extends NPCTemplate {
	public static final int ID = 31625;

	@Inject
	protected Yeti3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Yeti";
		this.serverSideName = false;
		this.title = "Donath Kitchen Help";
