 ...
 */
public class NewbieHelper8Template extends NPCTemplate {
	public static final int ID = 30404;

	@Inject
	protected NewbieHelper8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
