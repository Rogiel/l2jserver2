 ...
 */
public class Trap115Template extends NPCTemplate {
	public static final int ID = 18400;

	@Inject
	protected Trap115Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
