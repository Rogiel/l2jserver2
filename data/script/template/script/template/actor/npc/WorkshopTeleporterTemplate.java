 ...
 */
public class WorkshopTeleporterTemplate extends NPCTemplate {
	public static final int ID = 32637;

	@Inject
	protected WorkshopTeleporterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Workshop Teleporter";
