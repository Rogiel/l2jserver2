 ...
 */
public class PowerControlUnit3Template extends NPCTemplate {
	public static final int ID = 35744;

	@Inject
	protected PowerControlUnit3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
