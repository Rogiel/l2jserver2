 ...
 */
public class TeleportDevice2Template extends NPCTemplate {
	public static final int ID = 32746;

	@Inject
	protected TeleportDevice2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Teleport Device";
