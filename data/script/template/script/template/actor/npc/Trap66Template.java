 ...
 */
public class Trap66Template extends NPCTemplate {
	public static final int ID = 13230;

	@Inject
	protected Trap66Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
