 ...
 */
public class PreacherOfDoom22Template extends NPCTemplate {
	public static final int ID = 31236;

	@Inject
	protected PreacherOfDoom22Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
