 ...
 */
public class DivineSwordProtectionTemplate extends NPCTemplate {
	public static final int ID = 18935;

	@Inject
	protected DivineSwordProtectionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Divine Sword Protection";
