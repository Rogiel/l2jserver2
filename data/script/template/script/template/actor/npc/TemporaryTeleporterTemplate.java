 ...
 */
public class TemporaryTeleporterTemplate extends NPCTemplate {
	public static final int ID = 32602;

	@Inject
	protected TemporaryTeleporterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Temporary Teleporter";
