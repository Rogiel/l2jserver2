 ...
 */
public class StatueOfDarknessTemplate extends NPCTemplate {
	public static final int ID = 30966;

	@Inject
	protected StatueOfDarknessTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Statue of Darkness";
