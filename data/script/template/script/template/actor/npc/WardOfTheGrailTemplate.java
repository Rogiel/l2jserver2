 ...
 */
public class WardOfTheGrailTemplate extends NPCTemplate {
	public static final int ID = 18929;

	@Inject
	protected WardOfTheGrailTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ward of the Grail";
