 ...
 */
public class TallothTemplate extends NPCTemplate {
	public static final int ID = 30141;

	@Inject
	protected TallothTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
