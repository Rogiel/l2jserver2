 ...
 */
public class Trap90Template extends NPCTemplate {
	public static final int ID = 13254;

	@Inject
	protected Trap90Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
