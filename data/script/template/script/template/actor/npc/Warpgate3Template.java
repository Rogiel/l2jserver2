 ...
 */
public class Warpgate3Template extends NPCTemplate {
	public static final int ID = 32316;

	@Inject
	protected Warpgate3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
