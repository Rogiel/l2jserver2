 ...
 */
public class ZwovTemplate extends NPCTemplate {
	public static final int ID = 30749;

	@Inject
	protected ZwovTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
