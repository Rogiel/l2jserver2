 ...
 */
public class Warden6Template extends NPCTemplate {
	public static final int ID = 36408;

	@Inject
	protected Warden6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
