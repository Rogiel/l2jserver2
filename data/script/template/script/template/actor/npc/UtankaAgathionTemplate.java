 ...
 */
public class UtankaAgathionTemplate extends NPCTemplate {
	public static final int ID = 1533;

	@Inject
	protected UtankaAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Utanka Agathion";
