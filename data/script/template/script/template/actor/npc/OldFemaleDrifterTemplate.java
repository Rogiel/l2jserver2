 ...
 */
public class OldFemaleDrifterTemplate extends NPCTemplate {
	public static final int ID = 32073;

	@Inject
	protected OldFemaleDrifterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Old Female Drifter";
		...
		attributes.walkSpeed = 9.00000;
		attributes.runSpeed = 34.00000;
	}
}
