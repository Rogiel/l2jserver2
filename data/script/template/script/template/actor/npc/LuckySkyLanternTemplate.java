 ...
 */
public class LuckySkyLanternTemplate extends NPCTemplate {
	public static final int ID = 22;

	@Inject
	protected LuckySkyLanternTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lucky Sky Lantern";
