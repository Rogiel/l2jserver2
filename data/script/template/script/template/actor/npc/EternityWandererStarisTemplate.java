 ...
 */
public class EternityWandererStarisTemplate extends NPCTemplate {
	public static final int ID = 31612;

	@Inject
	protected EternityWandererStarisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Eternity Wanderer Staris";
