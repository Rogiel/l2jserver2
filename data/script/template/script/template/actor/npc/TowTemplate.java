 ...
 */
public class TowTemplate extends NPCTemplate {
	public static final int ID = 13163;

	@Inject
	protected TowTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
