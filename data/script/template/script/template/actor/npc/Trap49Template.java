 ...
 */
public class Trap49Template extends NPCTemplate {
	public static final int ID = 13213;

	@Inject
	protected Trap49Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
