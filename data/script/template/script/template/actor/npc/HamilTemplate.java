 ...
 */
public class HamilTemplate extends NPCTemplate {
	public static final int ID = 30626;

	@Inject
	protected HamilTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
