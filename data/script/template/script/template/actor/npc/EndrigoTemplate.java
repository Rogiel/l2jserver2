 ...
 */
public class EndrigoTemplate extends NPCTemplate {
	public static final int ID = 30632;

	@Inject
	protected EndrigoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
