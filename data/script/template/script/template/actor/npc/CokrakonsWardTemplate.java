 ...
 */
public class CokrakonsWardTemplate extends NPCTemplate {
	public static final int ID = 18843;

	@Inject
	protected CokrakonsWardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cokrakon's Ward";
