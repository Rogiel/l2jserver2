 ...
 */
public class OrbyuTemplate extends NPCTemplate {
	public static final int ID = 32560;

	@Inject
	protected OrbyuTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
