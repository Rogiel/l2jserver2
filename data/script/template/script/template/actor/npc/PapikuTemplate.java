 ...
 */
public class PapikuTemplate extends NPCTemplate {
	public static final int ID = 32564;

	@Inject
	protected PapikuTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
