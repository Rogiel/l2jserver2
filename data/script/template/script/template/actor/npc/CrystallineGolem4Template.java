 ...
 */
public class CrystallineGolem4Template extends NPCTemplate {
	public static final int ID = 32328;

	@Inject
	protected CrystallineGolem4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
