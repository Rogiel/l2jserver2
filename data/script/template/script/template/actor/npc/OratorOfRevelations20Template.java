 ...
 */
public class OratorOfRevelations20Template extends NPCTemplate {
	public static final int ID = 31250;

	@Inject
	protected OratorOfRevelations20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
