 ...
 */
public class LeirynnTemplate extends NPCTemplate {
	public static final int ID = 30728;

	@Inject
	protected LeirynnTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Leirynn";
		this.serverSideName = false;
		this.title = "Militiaman";
