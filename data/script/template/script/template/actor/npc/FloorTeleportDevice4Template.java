 ...
 */
public class FloorTeleportDevice4Template extends NPCTemplate {
	public static final int ID = 32756;

	@Inject
	protected FloorTeleportDevice4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Floor Teleport Device";
