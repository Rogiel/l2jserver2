 ...
 */
public class Harkilgamed2Template extends NPCTemplate {
	public static final int ID = 32253;

	@Inject
	protected Harkilgamed2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
