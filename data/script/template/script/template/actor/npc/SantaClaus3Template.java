 ...
 */
public class SantaClaus3Template extends NPCTemplate {
	public static final int ID = 13186;

	@Inject
	protected SantaClaus3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
