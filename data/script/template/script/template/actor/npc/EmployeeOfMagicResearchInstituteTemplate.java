 ...
 */
public class EmployeeOfMagicResearchInstituteTemplate extends NPCTemplate {
	public static final int ID = 13292;

	@Inject
	protected EmployeeOfMagicResearchInstituteTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
