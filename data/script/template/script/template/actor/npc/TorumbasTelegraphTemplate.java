 ...
 */
public class TorumbasTelegraphTemplate extends NPCTemplate {
	public static final int ID = 18845;

	@Inject
	protected TorumbasTelegraphTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Torumba's Telegraph";
