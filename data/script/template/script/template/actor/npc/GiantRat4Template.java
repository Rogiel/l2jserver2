 ...
 */
public class GiantRat4Template extends NPCTemplate {
	public static final int ID = 13124;

	@Inject
	protected GiantRat4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Giant rat";
		this.serverSideName = false;
		this.title = "Mr. Bashful";
