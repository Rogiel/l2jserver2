 ...
 */
public class Katenar2Template extends NPCTemplate {
	public static final int ID = 32240;

	@Inject
	protected Katenar2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
