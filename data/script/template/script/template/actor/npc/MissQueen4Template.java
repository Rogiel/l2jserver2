 ...
 */
public class MissQueen4Template extends NPCTemplate {
	public static final int ID = 31762;

	@Inject
	protected MissQueen4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
