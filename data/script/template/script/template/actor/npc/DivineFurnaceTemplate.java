 ...
 */
public class DivineFurnaceTemplate extends NPCTemplate {
	public static final int ID = 18915;

	@Inject
	protected DivineFurnaceTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Divine Furnace";
