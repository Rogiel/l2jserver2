 ...
 */
public class TullysGatekeeper13Template extends NPCTemplate {
	public static final int ID = 18457;

	@Inject
	protected TullysGatekeeper13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
