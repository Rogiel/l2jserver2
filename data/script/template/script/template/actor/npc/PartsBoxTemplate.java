 ...
 */
public class PartsBoxTemplate extends NPCTemplate {
	public static final int ID = 32050;

	@Inject
	protected PartsBoxTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
