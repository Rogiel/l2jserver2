 ...
 */
public class Trap63Template extends NPCTemplate {
	public static final int ID = 13227;

	@Inject
	protected Trap63Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
