 ...
 */
public class AdventureGuildsman41Template extends AdventurerNPCTemplate {
	public static final int ID = 31815;

	@Inject
	protected AdventureGuildsman41Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
