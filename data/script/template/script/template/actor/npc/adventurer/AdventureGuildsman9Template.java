 ...
 */
public class AdventureGuildsman9Template extends AdventurerNPCTemplate {
	public static final int ID = 31783;

	@Inject
	protected AdventureGuildsman9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
