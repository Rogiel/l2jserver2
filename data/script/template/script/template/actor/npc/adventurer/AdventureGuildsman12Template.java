 ...
 */
public class AdventureGuildsman12Template extends AdventurerNPCTemplate {
	public static final int ID = 31786;

	@Inject
	protected AdventureGuildsman12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
