 ...
 */
public class AdventureGuildsman70Template extends AdventurerNPCTemplate {
	public static final int ID = 31993;

	@Inject
	protected AdventureGuildsman70Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
