 ...
 */
public class AdventurerGuildsman4Template extends AdventurerNPCTemplate {
	public static final int ID = 31732;

	@Inject
	protected AdventurerGuildsman4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
