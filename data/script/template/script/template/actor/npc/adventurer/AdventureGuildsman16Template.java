 ...
 */
public class AdventureGuildsman16Template extends AdventurerNPCTemplate {
	public static final int ID = 31790;

	@Inject
	protected AdventureGuildsman16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
