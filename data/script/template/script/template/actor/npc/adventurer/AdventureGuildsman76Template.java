 ...
 */
public class AdventureGuildsman76Template extends AdventurerNPCTemplate {
	public static final int ID = 32340;

	@Inject
	protected AdventureGuildsman76Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
