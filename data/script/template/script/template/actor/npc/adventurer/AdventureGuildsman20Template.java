 ...
 */
public class AdventureGuildsman20Template extends AdventurerNPCTemplate {
	public static final int ID = 31794;

	@Inject
	protected AdventureGuildsman20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
