 ...
 */
public class AdventureGuildsman61Template extends AdventurerNPCTemplate {
	public static final int ID = 31835;

	@Inject
	protected AdventureGuildsman61Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
