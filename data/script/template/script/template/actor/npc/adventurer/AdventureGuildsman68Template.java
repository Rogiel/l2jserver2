 ...
 */
public class AdventureGuildsman68Template extends AdventurerNPCTemplate {
	public static final int ID = 31991;

	@Inject
	protected AdventureGuildsman68Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
