 ...
 */
public class AdventureGuildsman66Template extends AdventurerNPCTemplate {
	public static final int ID = 31840;

	@Inject
	protected AdventureGuildsman66Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
