 ...
 */
public class AdventureGuildsman7Template extends AdventurerNPCTemplate {
	public static final int ID = 31781;

	@Inject
	protected AdventureGuildsman7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
