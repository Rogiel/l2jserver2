 ...
 */
public class AdventurerGuildsman5Template extends AdventurerNPCTemplate {
	public static final int ID = 31733;

	@Inject
	protected AdventurerGuildsman5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
