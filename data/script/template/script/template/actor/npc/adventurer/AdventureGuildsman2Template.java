 ...
 */
public class AdventureGuildsman2Template extends AdventurerNPCTemplate {
	public static final int ID = 31776;

	@Inject
	protected AdventureGuildsman2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
