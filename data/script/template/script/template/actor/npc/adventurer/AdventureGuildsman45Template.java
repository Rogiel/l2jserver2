 ...
 */
public class AdventureGuildsman45Template extends AdventurerNPCTemplate {
	public static final int ID = 31819;

	@Inject
	protected AdventureGuildsman45Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
