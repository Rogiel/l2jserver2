 ...
 */
public class AdventurerGuildsman7Template extends AdventurerNPCTemplate {
	public static final int ID = 31735;

	@Inject
	protected AdventurerGuildsman7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
