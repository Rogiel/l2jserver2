 ...
 */
public class AdventureGuildsman25Template extends AdventurerNPCTemplate {
	public static final int ID = 31799;

	@Inject
	protected AdventureGuildsman25Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
