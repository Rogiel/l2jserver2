 ...
 */
public class AdventureGuildsman8Template extends AdventurerNPCTemplate {
	public static final int ID = 31782;

	@Inject
	protected AdventureGuildsman8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
