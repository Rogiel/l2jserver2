 ...
 */
public class AdventurerGuildsman9Template extends AdventurerNPCTemplate {
	public static final int ID = 31737;

	@Inject
	protected AdventurerGuildsman9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
