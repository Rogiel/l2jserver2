 ...
 */
public class AdventureGuildsman14Template extends AdventurerNPCTemplate {
	public static final int ID = 31788;

	@Inject
	protected AdventureGuildsman14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
