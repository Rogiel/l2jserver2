 ...
 */
public class AdventureGuildsman64Template extends AdventurerNPCTemplate {
	public static final int ID = 31838;

	@Inject
	protected AdventureGuildsman64Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
