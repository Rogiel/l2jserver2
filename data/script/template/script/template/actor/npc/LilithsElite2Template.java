 ...
 */
public class LilithsElite2Template extends NPCTemplate {
	public static final int ID = 32717;

	@Inject
	protected LilithsElite2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lilith's Elite";
