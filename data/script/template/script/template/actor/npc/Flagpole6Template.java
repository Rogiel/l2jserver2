 ...
 */
public class Flagpole6Template extends NPCTemplate {
	public static final int ID = 35826;

	@Inject
	protected Flagpole6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
