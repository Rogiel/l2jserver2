 ...
 */
public class Trap9Template extends NPCTemplate {
	public static final int ID = 13045;

	@Inject
	protected Trap9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
