 ...
 */
public class DetentionCampWarden6Template extends NPCTemplate {
	public static final int ID = 35835;

	@Inject
	protected DetentionCampWarden6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
