 ...
 */
public class MainRoleBTemplate extends NPCTemplate {
	public static final int ID = 13168;

	@Inject
	protected MainRoleBTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Main Role B";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 9.00;
		this.collisionHeight = 28.30;
		this.level = 55;
