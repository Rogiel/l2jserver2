 ...
 */
public class HotSpringsGourdTemplate extends NPCTemplate {
	public static final int ID = 35588;

	@Inject
	protected HotSpringsGourdTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
