 ...
 */
public class Trap64Template extends NPCTemplate {
	public static final int ID = 13228;

	@Inject
	protected Trap64Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
