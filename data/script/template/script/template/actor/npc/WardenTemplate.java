 ...
 */
public class WardenTemplate extends NPCTemplate {
	public static final int ID = 36403;

	@Inject
	protected WardenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
