 ...
 */
public class KaienTemplate extends NPCTemplate {
	public static final int ID = 30623;

	@Inject
	protected KaienTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
