 ...
 */
public class EdmondTemplate extends NPCTemplate {
	public static final int ID = 30497;

	@Inject
	protected EdmondTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
