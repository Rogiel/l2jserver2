 ...
 */
public class VolunteerTemplate extends NPCTemplate {
	public static final int ID = 32477;

	@Inject
	protected VolunteerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Volunteer";
		this.serverSideName = false;
		this.title = "Gatekeeper Welfare Foundation";
