 ...
 */
public class WhiteTigerCaptainTemplate extends NPCTemplate {
	public static final int ID = 13291;

	@Inject
	protected WhiteTigerCaptainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "White Tiger Captain";
