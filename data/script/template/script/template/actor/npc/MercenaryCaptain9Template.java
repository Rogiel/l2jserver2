 ...
 */
public class MercenaryCaptain9Template extends NPCTemplate {
	public static final int ID = 35962;

	@Inject
	protected MercenaryCaptain9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
