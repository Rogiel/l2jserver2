 ...
 */
public class Sirra2Template extends NPCTemplate {
	public static final int ID = 32762;

	@Inject
	protected Sirra2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
