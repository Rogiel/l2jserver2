 ...
 */
public class WarmHeartedSnoTemplate extends NPCTemplate {
	public static final int ID = 13;

	@Inject
	protected WarmHeartedSnoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
