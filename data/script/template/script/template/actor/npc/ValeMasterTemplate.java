 ...
 */
public class ValeMasterTemplate extends NPCTemplate {
	public static final int ID = 13108;

	@Inject
	protected ValeMasterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
