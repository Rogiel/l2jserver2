 ...
 */
public class SumielTemplate extends NPCTemplate {
	public static final int ID = 32758;

	@Inject
	protected SumielTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
