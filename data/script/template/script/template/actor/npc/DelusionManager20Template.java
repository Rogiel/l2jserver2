 ...
 */
public class DelusionManager20Template extends NPCTemplate {
	public static final int ID = 32683;

	@Inject
	protected DelusionManager20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
