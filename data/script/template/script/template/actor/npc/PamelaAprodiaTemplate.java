 ...
 */
public class PamelaAprodiaTemplate extends NPCTemplate {
	public static final int ID = 31600;

	@Inject
	protected PamelaAprodiaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
