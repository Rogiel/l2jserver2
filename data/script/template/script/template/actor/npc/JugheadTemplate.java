 ...
 */
public class JugheadTemplate extends NPCTemplate {
	public static final int ID = 30353;

	@Inject
	protected JugheadTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
