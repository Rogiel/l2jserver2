 ...
 */
public class IngeniousContraption4Template extends NPCTemplate {
	public static final int ID = 18497;

	@Inject
	protected IngeniousContraption4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
