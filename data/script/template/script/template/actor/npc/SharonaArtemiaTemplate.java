 ...
 */
public class SharonaArtemiaTemplate extends NPCTemplate {
	public static final int ID = 31602;

	@Inject
	protected SharonaArtemiaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sharona Artemia";
		this.serverSideName = false;
		this.title = "Bodyguard";
