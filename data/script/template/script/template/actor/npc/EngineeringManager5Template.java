 ...
 */
public class EngineeringManager5Template extends NPCTemplate {
	public static final int ID = 35801;

	@Inject
	protected EngineeringManager5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
