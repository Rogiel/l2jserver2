 ...
 */
public class YiyenTemplate extends NPCTemplate {
	public static final int ID = 32282;

	@Inject
	protected YiyenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Yiyen";
		this.serverSideName = false;
		this.title = "Archaeologist";
