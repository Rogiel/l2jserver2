 ...
 */
public class TheodricTemplate extends NPCTemplate {
	public static final int ID = 30755;

	@Inject
	protected TheodricTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Theodric";
		this.serverSideName = false;
		this.title = "Antharas Watchman";
