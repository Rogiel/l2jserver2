 ...
 */
public class GrailApostleTemplate extends NPCTemplate {
	public static final int ID = 13079;

	@Inject
	protected GrailApostleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grail Apostle";
