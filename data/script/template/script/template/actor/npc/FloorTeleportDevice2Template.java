 ...
 */
public class FloorTeleportDevice2Template extends NPCTemplate {
	public static final int ID = 32754;

	@Inject
	protected FloorTeleportDevice2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
