 ...
 */
public class Trap71Template extends NPCTemplate {
	public static final int ID = 13235;

	@Inject
	protected Trap71Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
