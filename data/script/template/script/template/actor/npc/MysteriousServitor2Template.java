 ...
 */
public class MysteriousServitor2Template extends NPCTemplate {
	public static final int ID = 31632;

	@Inject
	protected MysteriousServitor2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
