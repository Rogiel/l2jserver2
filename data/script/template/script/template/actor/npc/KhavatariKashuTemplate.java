 ...
 */
public class KhavatariKashuTemplate extends NPCTemplate {
	public static final int ID = 31637;

	@Inject
	protected KhavatariKashuTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Khavatari Kashu";
		...
		this.rightHand = itemProvider.createID(267);
		this.leftHand = null;
		this.enchantLevel = 0;
