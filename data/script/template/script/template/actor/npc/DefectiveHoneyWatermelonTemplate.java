 ...
 */
public class DefectiveHoneyWatermelonTemplate extends NPCTemplate {
	public static final int ID = 13276;

	@Inject
	protected DefectiveHoneyWatermelonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Defective Honey Watermelon";
