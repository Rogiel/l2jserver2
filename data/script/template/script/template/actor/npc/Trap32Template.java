 ...
 */
public class Trap32Template extends NPCTemplate {
	public static final int ID = 13068;

	@Inject
	protected Trap32Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
