 ...
 */
public class TreasureChest53Template extends NPCTemplate {
	public static final int ID = 35593;

	@Inject
	protected TreasureChest53Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
