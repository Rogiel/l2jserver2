 ...
 */
public class GuardianOfBorder48Template extends NPCTemplate {
	public static final int ID = 31912;

	@Inject
	protected GuardianOfBorder48Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
