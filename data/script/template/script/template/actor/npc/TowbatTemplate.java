 ...
 */
public class TowbatTemplate extends NPCTemplate {
	public static final int ID = 16070;

	@Inject
	protected TowbatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
