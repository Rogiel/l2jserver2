 ...
 */
public class NewbieHelper2Template extends NPCTemplate {
	public static final int ID = 30019;

	@Inject
	protected NewbieHelper2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
