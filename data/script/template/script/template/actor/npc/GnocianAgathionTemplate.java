 ...
 */
public class GnocianAgathionTemplate extends NPCTemplate {
	public static final int ID = 1541;

	@Inject
	protected GnocianAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gnocian Agathion";
