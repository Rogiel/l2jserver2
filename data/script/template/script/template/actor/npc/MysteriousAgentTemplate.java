 ...
 */
public class MysteriousAgentTemplate extends NPCTemplate {
	public static final int ID = 32372;

	@Inject
	protected MysteriousAgentTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mysterious Agent";
