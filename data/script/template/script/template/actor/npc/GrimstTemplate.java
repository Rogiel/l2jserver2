 ...
 */
public class GrimstTemplate extends NPCTemplate {
	public static final int ID = 31604;

	@Inject
	protected GrimstTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
