 ...
 */
public class LittleDevilAgathionTemplate extends NPCTemplate {
	public static final int ID = 16032;

	@Inject
	protected LittleDevilAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Little Devil Agathion";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 0.01;
		this.collisionHeight = 5.50;
		this.level = 55;
