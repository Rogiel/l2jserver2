 ...
 */
public class RodenpiculaTemplate extends NPCTemplate {
	public static final int ID = 32237;

	@Inject
	protected RodenpiculaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
