 ...
 */
public class Trap11Template extends NPCTemplate {
	public static final int ID = 13047;

	@Inject
	protected Trap11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
