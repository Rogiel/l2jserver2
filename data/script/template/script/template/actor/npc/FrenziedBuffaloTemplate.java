 ...
 */
public class FrenziedBuffaloTemplate extends NPCTemplate {
	public static final int ID = 35619;

	@Inject
	protected FrenziedBuffaloTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Frenzied Buffalo";
