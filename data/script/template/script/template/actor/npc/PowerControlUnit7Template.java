 ...
 */
public class PowerControlUnit7Template extends NPCTemplate {
	public static final int ID = 35879;

	@Inject
	protected PowerControlUnit7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
