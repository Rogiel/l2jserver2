 ...
 */
public class Warpgate6Template extends NPCTemplate {
	public static final int ID = 32319;

	@Inject
	protected Warpgate6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
