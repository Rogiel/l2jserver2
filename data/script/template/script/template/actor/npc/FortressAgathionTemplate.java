 ...
 */
public class FortressAgathionTemplate extends NPCTemplate {
	public static final int ID = 16029;

	@Inject
	protected FortressAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fortress Agathion";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 0.01;
		this.collisionHeight = 3.50;
		this.level = 55;
