 ...
 */
public class GreenRobedTojigongAgathionTemplate extends NPCTemplate {
	public static final int ID = 1517;

	@Inject
	protected GreenRobedTojigongAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Green-Robed Tojigong Agathion";
