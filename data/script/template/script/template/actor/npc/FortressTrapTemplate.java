 ...
 */
public class FortressTrapTemplate extends NPCTemplate {
	public static final int ID = 36412;

	@Inject
	protected FortressTrapTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
