 ...
 */
public class RaceManagerTemplate extends NPCTemplate {
	public static final int ID = 30995;

	@Inject
	protected RaceManagerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Race Manager";
