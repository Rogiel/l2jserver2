 ...
 */
public class Housekeeper2Template extends NPCTemplate {
	public static final int ID = 18593;

	@Inject
	protected Housekeeper2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
