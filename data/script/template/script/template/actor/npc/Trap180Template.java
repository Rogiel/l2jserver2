 ...
 */
public class Trap180Template extends NPCTemplate {
	public static final int ID = 18757;

	@Inject
	protected Trap180Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
