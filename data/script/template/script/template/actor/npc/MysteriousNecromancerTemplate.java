 ...
 */
public class MysteriousNecromancerTemplate extends NPCTemplate {
	public static final int ID = 31518;

	@Inject
	protected MysteriousNecromancerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mysterious Necromancer";
