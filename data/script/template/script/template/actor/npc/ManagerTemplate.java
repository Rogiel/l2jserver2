 ...
 */
public class ManagerTemplate extends NPCTemplate {
	public static final int ID = 35600;

	@Inject
	protected ManagerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
