 ...
 */
public class SirGustavAthebaldtTemplate extends NPCTemplate {
	public static final int ID = 30760;

	@Inject
	protected SirGustavAthebaldtTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sir Gustav Athebaldt";
