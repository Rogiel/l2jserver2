 ...
 */
public class IngeniousContraption9Template extends NPCTemplate {
	public static final int ID = 18502;

	@Inject
	protected IngeniousContraption9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
