 ...
 */
public class PasswordEntryDeviceTemplate extends NPCTemplate {
	public static final int ID = 32577;

	@Inject
	protected PasswordEntryDeviceTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Password Entry Device";
