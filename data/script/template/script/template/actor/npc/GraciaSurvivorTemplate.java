 ...
 */
public class GraciaSurvivorTemplate extends NPCTemplate {
	public static final int ID = 32632;

	@Inject
	protected GraciaSurvivorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gracia Survivor";
