 ...
 */
public class SantiagoTemplate extends NPCTemplate {
	public static final int ID = 30648;

	@Inject
	protected SantiagoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
