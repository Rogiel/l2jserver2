 ...
 */
public class GuardianOfBorder50Template extends NPCTemplate {
	public static final int ID = 31914;

	@Inject
	protected GuardianOfBorder50Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
