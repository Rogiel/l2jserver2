 ...
 */
public class GatekeeperOfAbyss2Template extends NPCTemplate {
	public static final int ID = 32540;

	@Inject
	protected GatekeeperOfAbyss2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
