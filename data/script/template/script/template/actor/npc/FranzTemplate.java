 ...
 */
public class FranzTemplate extends NPCTemplate {
	public static final int ID = 32597;

	@Inject
	protected FranzTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
