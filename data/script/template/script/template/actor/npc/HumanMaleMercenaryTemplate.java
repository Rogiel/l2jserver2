 ...
 */
public class HumanMaleMercenaryTemplate extends NPCTemplate {
	public static final int ID = 13169;

	@Inject
	protected HumanMaleMercenaryTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Human Male Mercenary";
