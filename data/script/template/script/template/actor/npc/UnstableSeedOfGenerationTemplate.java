 ...
 */
public class UnstableSeedOfGenerationTemplate extends NPCTemplate {
	public static final int ID = 32541;

	@Inject
	protected UnstableSeedOfGenerationTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Unstable Seed of Generation";
