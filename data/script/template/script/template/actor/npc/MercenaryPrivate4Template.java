 ...
 */
public class MercenaryPrivate4Template extends NPCTemplate {
	public static final int ID = 35794;

	@Inject
	protected MercenaryPrivate4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
