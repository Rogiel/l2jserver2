 ...
 */
public class LelrikiaTemplate extends NPCTemplate {
	public static final int ID = 32567;

	@Inject
	protected LelrikiaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lelrikia";
		this.serverSideName = false;
		this.title = "Priest of Shilen";
		this.serverSideTitle = false;
		this.collisionRadius = 15.75;
		this.collisionHeight = 25.73;
		this.level = 70;
