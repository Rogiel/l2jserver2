 ...
 */
public class GroupGatekeeper4Template extends NPCTemplate {
	public static final int ID = 35613;

	@Inject
	protected GroupGatekeeper4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
