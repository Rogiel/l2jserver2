 ...
 */
public class DemonPrinceTemplate extends NPCTemplate {
	public static final int ID = 13105;

	@Inject
	protected DemonPrinceTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
