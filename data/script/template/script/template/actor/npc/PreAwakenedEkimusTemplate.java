 ...
 */
public class PreAwakenedEkimusTemplate extends NPCTemplate {
	public static final int ID = 29161;

	@Inject
	protected PreAwakenedEkimusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Pre-Awakened Ekimus";
