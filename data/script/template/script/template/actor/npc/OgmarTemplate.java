 ...
 */
public class OgmarTemplate extends NPCTemplate {
	public static final int ID = 31744;

	@Inject
	protected OgmarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
