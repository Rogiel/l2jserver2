 ...
 */
public class DetentionCampWarden10Template extends NPCTemplate {
	public static final int ID = 35974;

	@Inject
	protected DetentionCampWarden10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
