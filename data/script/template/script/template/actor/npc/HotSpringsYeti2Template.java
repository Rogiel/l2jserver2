 ...
 */
public class HotSpringsYeti2Template extends NPCTemplate {
	public static final int ID = 35596;

	@Inject
	protected HotSpringsYeti2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
