 ...
 */
public class TombstoneTemplate extends NPCTemplate {
	public static final int ID = 31523;

	@Inject
	protected TombstoneTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
