 ...
 */
public class DisgracedKnightWaldsteinTemplate extends NPCTemplate {
	public static final int ID = 31599;

	@Inject
	protected DisgracedKnightWaldsteinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Disgraced Knight Waldstein";
		...
		this.rightHand = itemProvider.createID(81);
		this.leftHand = null;
		this.enchantLevel = 0;
