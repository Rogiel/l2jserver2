 ...
 */
public class Trap62Template extends NPCTemplate {
	public static final int ID = 13226;

	@Inject
	protected Trap62Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
