 ...
 */
public class TeniusTemplate extends NPCTemplate {
	public static final int ID = 32555;

	@Inject
	protected TeniusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
