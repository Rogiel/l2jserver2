 ...
 */
public class RafaelTemplate extends NPCTemplate {
	public static final int ID = 31310;

	@Inject
	protected RafaelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
