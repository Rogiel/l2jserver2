 ...
 */
public class HeartOfWardingTemplate extends NPCTemplate {
	public static final int ID = 13001;

	@Inject
	protected HeartOfWardingTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Heart of Warding";
