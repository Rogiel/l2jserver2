 ...
 */
public class Trap14Template extends NPCTemplate {
	public static final int ID = 13050;

	@Inject
	protected Trap14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
