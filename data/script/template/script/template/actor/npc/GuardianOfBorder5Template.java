 ...
 */
public class GuardianOfBorder5Template extends NPCTemplate {
	public static final int ID = 31869;

	@Inject
	protected GuardianOfBorder5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
