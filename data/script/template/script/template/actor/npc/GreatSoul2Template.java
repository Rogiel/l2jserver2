 ...
 */
public class GreatSoul2Template extends NPCTemplate {
	public static final int ID = 32125;

	@Inject
	protected GreatSoul2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Great Soul";
