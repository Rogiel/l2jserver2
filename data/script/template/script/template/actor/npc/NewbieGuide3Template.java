 ...
 */
public class NewbieGuide3Template extends NPCTemplate {
	public static final int ID = 30600;

	@Inject
	protected NewbieGuide3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
