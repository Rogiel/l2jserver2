 ...
 */
public class SnowmanTemplate extends NPCTemplate {
	public static final int ID = 13160;

	@Inject
	protected SnowmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
