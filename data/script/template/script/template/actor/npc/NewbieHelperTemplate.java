 ...
 */
public class NewbieHelperTemplate extends NPCTemplate {
	public static final int ID = 30009;

	@Inject
	protected NewbieHelperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
