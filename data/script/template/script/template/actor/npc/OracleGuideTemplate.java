 ...
 */
public class OracleGuideTemplate extends NPCTemplate {
	public static final int ID = 32273;

	@Inject
	protected OracleGuideTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
