 ...
 */
public class HuntingGroundKeeperTemplate extends NPCTemplate {
	public static final int ID = 18579;

	@Inject
	protected HuntingGroundKeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
