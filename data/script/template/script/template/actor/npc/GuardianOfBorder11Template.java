 ...
 */
public class GuardianOfBorder11Template extends NPCTemplate {
	public static final int ID = 31875;

	@Inject
	protected GuardianOfBorder11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
