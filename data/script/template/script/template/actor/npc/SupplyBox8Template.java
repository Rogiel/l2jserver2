 ...
 */
public class SupplyBox8Template extends NPCTemplate {
	public static final int ID = 35903;

	@Inject
	protected SupplyBox8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
