 ...
 */
public class Trap130Template extends NPCTemplate {
	public static final int ID = 18431;

	@Inject
	protected Trap130Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
