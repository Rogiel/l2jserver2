 ...
 */
public class DoctorChaosTemplate extends NPCTemplate {
	public static final int ID = 32033;

	@Inject
	protected DoctorChaosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Doctor Chaos";
