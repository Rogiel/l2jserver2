 ...
 */
public class StoneCoffinTemplate extends NPCTemplate {
	public static final int ID = 32470;

	@Inject
	protected StoneCoffinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Stone Coffin";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 109.00;
