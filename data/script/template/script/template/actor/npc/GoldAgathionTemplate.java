 ...
 */
public class GoldAgathionTemplate extends NPCTemplate {
	public static final int ID = 1502;

	@Inject
	protected GoldAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gold Agathion";
