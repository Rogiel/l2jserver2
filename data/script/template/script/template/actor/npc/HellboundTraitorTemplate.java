 ...
 */
public class HellboundTraitorTemplate extends NPCTemplate {
	public static final int ID = 32364;

	@Inject
	protected HellboundTraitorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hellbound Traitor";
