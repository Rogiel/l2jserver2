 ...
 */
public class Trap111Template extends NPCTemplate {
	public static final int ID = 18396;

	@Inject
	protected Trap111Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
