 ...
 */
public class RockTemplate extends NPCTemplate {
	public static final int ID = 32238;

	@Inject
	protected RockTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
