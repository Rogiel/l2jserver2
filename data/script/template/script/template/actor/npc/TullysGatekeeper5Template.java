 ...
 */
public class TullysGatekeeper5Template extends NPCTemplate {
	public static final int ID = 18449;

	@Inject
	protected TullysGatekeeper5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
