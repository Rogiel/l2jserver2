 ...
 */
public class MarquezTemplate extends NPCTemplate {
	public static final int ID = 32113;

	@Inject
	protected MarquezTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
