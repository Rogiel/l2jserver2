 ...
 */
public class KutaTemplate extends NPCTemplate {
	public static final int ID = 32574;

	@Inject
	protected KutaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
