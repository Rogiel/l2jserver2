 ...
 */
public class NerupaTemplate extends NPCTemplate {
	public static final int ID = 30370;

	@Inject
	protected NerupaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
