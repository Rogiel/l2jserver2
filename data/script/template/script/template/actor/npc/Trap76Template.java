 ...
 */
public class Trap76Template extends NPCTemplate {
	public static final int ID = 13240;

	@Inject
	protected Trap76Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
