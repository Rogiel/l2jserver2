 ...
 */
public class Warden8Template extends NPCTemplate {
	public static final int ID = 36410;

	@Inject
	protected Warden8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
