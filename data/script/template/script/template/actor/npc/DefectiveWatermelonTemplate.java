 ...
 */
public class DefectiveWatermelonTemplate extends NPCTemplate {
	public static final int ID = 13272;

	@Inject
	protected DefectiveWatermelonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Defective Watermelon";
