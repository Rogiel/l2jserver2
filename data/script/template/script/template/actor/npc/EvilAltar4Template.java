 ...
 */
public class EvilAltar4Template extends NPCTemplate {
	public static final int ID = 31515;

	@Inject
	protected EvilAltar4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
