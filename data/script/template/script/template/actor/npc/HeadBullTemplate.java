 ...
 */
public class HeadBullTemplate extends NPCTemplate {
	public static final int ID = 13190;

	@Inject
	protected HeadBullTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
