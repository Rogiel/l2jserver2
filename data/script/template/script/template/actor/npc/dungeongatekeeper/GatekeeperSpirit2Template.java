 ...
 */
public class GatekeeperSpirit2Template extends DungeonGatekeeperNPCTemplate {
	public static final int ID = 31112;

	@Inject
	protected GatekeeperSpirit2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gatekeeper Spirit";
