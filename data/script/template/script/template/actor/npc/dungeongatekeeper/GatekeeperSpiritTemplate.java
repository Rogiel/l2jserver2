 ...
 */
public class GatekeeperSpiritTemplate extends DungeonGatekeeperNPCTemplate {
	public static final int ID = 31111;

	@Inject
	protected GatekeeperSpiritTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
