 ...
 */
public class DoormanTemplate extends NPCTemplate {
	public static final int ID = 18416;

	@Inject
	protected DoormanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
