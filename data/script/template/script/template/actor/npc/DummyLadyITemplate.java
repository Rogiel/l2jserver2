 ...
 */
public class DummyLadyITemplate extends NPCTemplate {
	public static final int ID = 31398;

	@Inject
	protected DummyLadyITemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dummy - Lady I";
