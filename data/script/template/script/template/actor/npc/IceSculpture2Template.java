 ...
 */
public class IceSculpture2Template extends NPCTemplate {
	public static final int ID = 32077;

	@Inject
	protected IceSculpture2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ice Sculpture";
