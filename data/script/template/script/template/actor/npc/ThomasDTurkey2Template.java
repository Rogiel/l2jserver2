 ...
 */
public class ThomasDTurkey2Template extends NPCTemplate {
	public static final int ID = 13183;

	@Inject
	protected ThomasDTurkey2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
