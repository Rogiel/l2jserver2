 ...
 */
public class SparkyTheCat2Template extends NPCTemplate {
	public static final int ID = 31586;

	@Inject
	protected SparkyTheCat2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sparky the Cat";
		this.serverSideName = false;
		this.title = "Keats Servitor";
