 ...
 */
public class DelusionManager13Template extends NPCTemplate {
	public static final int ID = 32676;

	@Inject
	protected DelusionManager13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
