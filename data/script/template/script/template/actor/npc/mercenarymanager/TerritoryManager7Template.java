 ...
 */
public class TerritoryManager7Template extends MercenaryManagerNPCTemplate {
	public static final int ID = 36496;

	@Inject
	protected TerritoryManager7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
