 ...
 */
public class TerritoryManager8Template extends MercenaryManagerNPCTemplate {
	public static final int ID = 36497;

	@Inject
	protected TerritoryManager8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
