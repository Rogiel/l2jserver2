 ...
 */
public class TerritoryManager3Template extends MercenaryManagerNPCTemplate {
	public static final int ID = 36492;

	@Inject
	protected TerritoryManager3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
