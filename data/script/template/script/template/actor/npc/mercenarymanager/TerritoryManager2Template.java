 ...
 */
public class TerritoryManager2Template extends MercenaryManagerNPCTemplate {
	public static final int ID = 36491;

	@Inject
	protected TerritoryManager2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
