 ...
 */
public class TerritoryManagerTemplate extends MercenaryManagerNPCTemplate {
	public static final int ID = 36490;

	@Inject
	protected TerritoryManagerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
