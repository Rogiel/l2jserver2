 ...
 */
public class TerritoryManager4Template extends MercenaryManagerNPCTemplate {
	public static final int ID = 36493;

	@Inject
	protected TerritoryManager4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
