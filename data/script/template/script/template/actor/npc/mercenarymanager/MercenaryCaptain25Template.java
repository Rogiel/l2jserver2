 ...
 */
public class MercenaryCaptain25Template extends MercenaryManagerNPCTemplate {
	public static final int ID = 36484;

	@Inject
	protected MercenaryCaptain25Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
