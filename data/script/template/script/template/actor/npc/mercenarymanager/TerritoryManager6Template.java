 ...
 */
public class TerritoryManager6Template extends MercenaryManagerNPCTemplate {
	public static final int ID = 36495;

	@Inject
	protected TerritoryManager6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
