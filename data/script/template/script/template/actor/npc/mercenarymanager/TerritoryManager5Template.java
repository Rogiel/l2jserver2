 ...
 */
public class TerritoryManager5Template extends MercenaryManagerNPCTemplate {
	public static final int ID = 36494;

	@Inject
	protected TerritoryManager5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
