 ...
 */
public class IngeniousContraption12Template extends NPCTemplate {
	public static final int ID = 18505;

	@Inject
	protected IngeniousContraption12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ingenious Contraption";
