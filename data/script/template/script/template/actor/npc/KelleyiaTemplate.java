 ...
 */
public class KelleyiaTemplate extends NPCTemplate {
	public static final int ID = 32768;

	@Inject
	protected KelleyiaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
