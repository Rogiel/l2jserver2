 ...
 */
public class OrodrielAgathionTemplate extends NPCTemplate {
	public static final int ID = 1542;

	@Inject
	protected OrodrielAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Orodriel Agathion";
