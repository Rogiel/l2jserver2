 ...
 */
public class StatueOfLightTemplate extends NPCTemplate {
	public static final int ID = 30967;

	@Inject
	protected StatueOfLightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Statue of Light";
