 ...
 */
public class StatueOfFireTemplate extends NPCTemplate {
	public static final int ID = 30963;

	@Inject
	protected StatueOfFireTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Statue of Fire";
