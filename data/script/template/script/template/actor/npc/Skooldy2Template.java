 ...
 */
public class Skooldy2Template extends NPCTemplate {
	public static final int ID = 4303;

	@Inject
	protected Skooldy2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
