 ...
 */
public class RerikyaTemplate extends NPCTemplate {
	public static final int ID = 30947;

	@Inject
	protected RerikyaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
