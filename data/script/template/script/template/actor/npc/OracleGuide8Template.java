 ...
 */
public class OracleGuide8Template extends NPCTemplate {
	public static final int ID = 32280;

	@Inject
	protected OracleGuide8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
