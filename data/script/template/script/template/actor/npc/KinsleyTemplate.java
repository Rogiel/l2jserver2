 ...
 */
public class KinsleyTemplate extends NPCTemplate {
	public static final int ID = 31605;

	@Inject
	protected KinsleyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kinsley";
		this.serverSideName = false;
		this.title = "Head Summoner";
