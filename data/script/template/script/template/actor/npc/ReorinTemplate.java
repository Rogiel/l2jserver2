 ...
 */
public class ReorinTemplate extends NPCTemplate {
	public static final int ID = 31002;

	@Inject
	protected ReorinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
