 ...
 */
public class ZaricheTemplate extends NPCTemplate {
	public static final int ID = 13086;

	@Inject
	protected ZaricheTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
