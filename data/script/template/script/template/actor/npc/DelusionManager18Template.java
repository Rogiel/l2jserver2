 ...
 */
public class DelusionManager18Template extends NPCTemplate {
	public static final int ID = 32681;

	@Inject
	protected DelusionManager18Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
