 ...
 */
public class SeducedMageTemplate extends NPCTemplate {
	public static final int ID = 36564;

	@Inject
	protected SeducedMageTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
