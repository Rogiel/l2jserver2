 ...
 */
public class OracleGuide6Template extends NPCTemplate {
	public static final int ID = 32278;

	@Inject
	protected OracleGuide6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
