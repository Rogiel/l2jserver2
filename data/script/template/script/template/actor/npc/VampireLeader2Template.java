 ...
 */
public class VampireLeader2Template extends NPCTemplate {
	public static final int ID = 35647;

	@Inject
	protected VampireLeader2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vampire Leader";
		...
		this.attackRange = 40;
		this.maxHP = 7333.000000000000000;
		...
		attributes.physicalAttack = 1204.00000;
