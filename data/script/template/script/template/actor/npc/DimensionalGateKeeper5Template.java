 ...
 */
public class DimensionalGateKeeper5Template extends NPCTemplate {
	public static final int ID = 31498;

	@Inject
	protected DimensionalGateKeeper5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
