 ...
 */
public class PowerControlUnit16Template extends NPCTemplate {
	public static final int ID = 36193;

	@Inject
	protected PowerControlUnit16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
