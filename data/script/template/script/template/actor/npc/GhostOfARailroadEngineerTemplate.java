 ...
 */
public class GhostOfARailroadEngineerTemplate extends NPCTemplate {
	public static final int ID = 32054;

	@Inject
	protected GhostOfARailroadEngineerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ghost of a Railroad Engineer";
