 ...
 */
public class EsrandellTemplate extends TrainerNPCTemplate {
	public static final int ID = 30158;

	@Inject
	protected EsrandellTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
