 ...
 */
public class BerylTemplate extends TrainerNPCTemplate {
	public static final int ID = 31323;

	@Inject
	protected BerylTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
