 ...
 */
public class AnabelTemplate extends TrainerNPCTemplate {
	public static final int ID = 30909;

	@Inject
	protected AnabelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
