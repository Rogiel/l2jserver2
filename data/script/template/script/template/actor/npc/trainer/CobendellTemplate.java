 ...
 */
public class CobendellTemplate extends TrainerNPCTemplate {
	public static final int ID = 30156;

	@Inject
	protected CobendellTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
