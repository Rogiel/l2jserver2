 ...
 */
public class ArtiTemplate extends TrainerNPCTemplate {
	public static final int ID = 30901;

	@Inject
	protected ArtiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
