 ...
 */
public class RohmerTemplate extends TrainerNPCTemplate {
	public static final int ID = 30344;

	@Inject
	protected RohmerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
