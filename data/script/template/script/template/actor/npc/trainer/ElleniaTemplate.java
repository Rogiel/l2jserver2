 ...
 */
public class ElleniaTemplate extends TrainerNPCTemplate {
	public static final int ID = 30155;

	@Inject
	protected ElleniaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
