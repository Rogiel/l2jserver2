 ...
 */
public class TerryTemplate extends TrainerNPCTemplate {
	public static final int ID = 30064;

	@Inject
	protected TerryTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
