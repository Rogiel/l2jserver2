 ...
 */
public class GenwitterTemplate extends TrainerNPCTemplate {
	public static final int ID = 30105;

	@Inject
	protected GenwitterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
