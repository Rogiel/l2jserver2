 ...
 */
public class VidelrienTemplate extends TrainerNPCTemplate {
	public static final int ID = 30697;

	@Inject
	protected VidelrienTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
