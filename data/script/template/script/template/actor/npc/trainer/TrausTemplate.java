 ...
 */
public class TrausTemplate extends TrainerNPCTemplate {
	public static final int ID = 30903;

	@Inject
	protected TrausTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
