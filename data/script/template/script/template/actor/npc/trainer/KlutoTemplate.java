 ...
 */
public class KlutoTemplate extends TrainerNPCTemplate {
	public static final int ID = 30317;

	@Inject
	protected KlutoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
