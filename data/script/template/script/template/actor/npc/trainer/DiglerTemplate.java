 ...
 */
public class DiglerTemplate extends TrainerNPCTemplate {
	public static final int ID = 32227;

	@Inject
	protected DiglerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
