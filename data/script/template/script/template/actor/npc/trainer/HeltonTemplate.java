 ...
 */
public class HeltonTemplate extends TrainerNPCTemplate {
	public static final int ID = 30678;

	@Inject
	protected HeltonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
