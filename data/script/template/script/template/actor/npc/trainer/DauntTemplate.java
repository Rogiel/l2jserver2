 ...
 */
public class DauntTemplate extends TrainerNPCTemplate {
	public static final int ID = 30683;

	@Inject
	protected DauntTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
