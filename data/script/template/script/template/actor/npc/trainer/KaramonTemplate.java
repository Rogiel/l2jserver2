 ...
 */
public class KaramonTemplate extends TrainerNPCTemplate {
	public static final int ID = 31966;

	@Inject
	protected KaramonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
