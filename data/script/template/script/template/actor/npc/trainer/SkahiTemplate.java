 ...
 */
public class SkahiTemplate extends TrainerNPCTemplate {
	public static final int ID = 31290;

	@Inject
	protected SkahiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
