 ...
 */
public class ArnelleTemplate extends TrainerNPCTemplate {
	public static final int ID = 30065;

	@Inject
	protected ArnelleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
