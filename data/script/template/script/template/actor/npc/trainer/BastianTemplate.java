 ...
 */
public class BastianTemplate extends TrainerNPCTemplate {
	public static final int ID = 31280;

	@Inject
	protected BastianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
