 ...
 */
public class NergaTemplate extends TrainerNPCTemplate {
	public static final int ID = 32141;

	@Inject
	protected NergaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
