 ...
 */
public class KincaidTemplate extends TrainerNPCTemplate {
	public static final int ID = 32159;

	@Inject
	protected KincaidTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
