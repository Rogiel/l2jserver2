 ...
 */
public class HildaTemplate extends TrainerNPCTemplate {
	public static final int ID = 31271;

	@Inject
	protected HildaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
