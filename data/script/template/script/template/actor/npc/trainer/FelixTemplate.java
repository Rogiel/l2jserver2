 ...
 */
public class FelixTemplate extends TrainerNPCTemplate {
	public static final int ID = 31277;

	@Inject
	protected FelixTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
