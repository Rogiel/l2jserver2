 ...
 */
public class XoniaTemplate extends TrainerNPCTemplate {
	public static final int ID = 32144;

	@Inject
	protected XoniaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
