 ...
 */
public class RosheriaTemplate extends TrainerNPCTemplate {
	public static final int ID = 30472;

	@Inject
	protected RosheriaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
