 ...
 */
public class KairaTemplate extends TrainerNPCTemplate {
	public static final int ID = 30476;

	@Inject
	protected KairaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
