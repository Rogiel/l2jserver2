 ...
 */
public class MiniaTemplate extends TrainerNPCTemplate {
	public static final int ID = 30029;

	@Inject
	protected MiniaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
