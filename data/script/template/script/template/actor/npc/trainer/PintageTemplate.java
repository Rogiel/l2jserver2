 ...
 */
public class PintageTemplate extends TrainerNPCTemplate {
	public static final int ID = 30028;

	@Inject
	protected PintageTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
