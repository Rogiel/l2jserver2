 ...
 */
public class SindenTemplate extends TrainerNPCTemplate {
	public static final int ID = 30852;

	@Inject
	protected SindenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
