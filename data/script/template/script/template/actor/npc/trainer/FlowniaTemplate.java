 ...
 */
public class FlowniaTemplate extends TrainerNPCTemplate {
	public static final int ID = 30860;

	@Inject
	protected FlowniaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
