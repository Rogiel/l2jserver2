 ...
 */
public class ErianTemplate extends TrainerNPCTemplate {
	public static final int ID = 31322;

	@Inject
	protected ErianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
