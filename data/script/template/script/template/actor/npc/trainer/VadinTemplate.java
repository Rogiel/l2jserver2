 ...
 */
public class VadinTemplate extends TrainerNPCTemplate {
	public static final int ID = 30188;

	@Inject
	protected VadinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
