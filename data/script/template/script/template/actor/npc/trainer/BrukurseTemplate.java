 ...
 */
public class BrukurseTemplate extends TrainerNPCTemplate {
	public static final int ID = 30569;

	@Inject
	protected BrukurseTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
