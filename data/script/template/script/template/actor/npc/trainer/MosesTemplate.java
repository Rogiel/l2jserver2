 ...
 */
public class MosesTemplate extends TrainerNPCTemplate {
	public static final int ID = 30695;

	@Inject
	protected MosesTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
