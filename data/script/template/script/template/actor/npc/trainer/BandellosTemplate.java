 ...
 */
public class BandellosTemplate extends TrainerNPCTemplate {
	public static final int ID = 30473;

	@Inject
	protected BandellosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
