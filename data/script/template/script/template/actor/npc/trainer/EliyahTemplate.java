 ...
 */
public class EliyahTemplate extends TrainerNPCTemplate {
	public static final int ID = 31329;

	@Inject
	protected EliyahTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
