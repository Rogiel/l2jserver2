 ...
 */
public class RupioTemplate extends TrainerNPCTemplate {
	public static final int ID = 30471;

	@Inject
	protected RupioTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
