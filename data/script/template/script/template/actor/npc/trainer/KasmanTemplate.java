 ...
 */
public class KasmanTemplate extends TrainerNPCTemplate {
	public static final int ID = 30501;

	@Inject
	protected KasmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
