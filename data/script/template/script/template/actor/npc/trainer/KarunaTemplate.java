 ...
 */
public class KarunaTemplate extends TrainerNPCTemplate {
	public static final int ID = 30902;

	@Inject
	protected KarunaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
