 ...
 */
public class HarantTemplate extends TrainerNPCTemplate {
	public static final int ID = 30360;

	@Inject
	protected HarantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
