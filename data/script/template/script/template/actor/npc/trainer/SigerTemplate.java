 ...
 */
public class SigerTemplate extends TrainerNPCTemplate {
	public static final int ID = 31990;

	@Inject
	protected SigerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
