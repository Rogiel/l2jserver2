 ...
 */
public class ErrickinTemplate extends TrainerNPCTemplate {
	public static final int ID = 30701;

	@Inject
	protected ErrickinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
