 ...
 */
public class Vivyan2Template extends TrainerNPCTemplate {
	public static final int ID = 30859;

	@Inject
	protected Vivyan2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
