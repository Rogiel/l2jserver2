 ...
 */
public class MekaraTemplate extends TrainerNPCTemplate {
	public static final int ID = 31337;

	@Inject
	protected MekaraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
