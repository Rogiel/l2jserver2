 ...
 */
public class CindetTemplate extends TrainerNPCTemplate {
	public static final int ID = 32148;

	@Inject
	protected CindetTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
