 ...
 */
public class AnastiaTemplate extends TrainerNPCTemplate {
	public static final int ID = 31581;

	@Inject
	protected AnastiaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
