 ...
 */
public class TanapiTemplate extends TrainerNPCTemplate {
	public static final int ID = 30571;

	@Inject
	protected TanapiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
