 ...
 */
public class SoriusTemplate extends TrainerNPCTemplate {
	public static final int ID = 30327;

	@Inject
	protected SoriusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
