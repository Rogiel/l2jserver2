 ...
 */
public class NaielTemplate extends TrainerNPCTemplate {
	public static final int ID = 30904;

	@Inject
	protected NaielTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
