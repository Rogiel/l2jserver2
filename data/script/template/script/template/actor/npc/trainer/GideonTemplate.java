 ...
 */
public class GideonTemplate extends TrainerNPCTemplate {
	public static final int ID = 30194;

	@Inject
	protected GideonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
