 ...
 */
public class LeonardTemplate extends TrainerNPCTemplate {
	public static final int ID = 30861;

	@Inject
	protected LeonardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
