 ...
 */
public class ThemisTemplate extends TrainerNPCTemplate {
	public static final int ID = 31325;

	@Inject
	protected ThemisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
