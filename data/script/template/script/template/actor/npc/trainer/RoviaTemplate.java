 ...
 */
public class RoviaTemplate extends TrainerNPCTemplate {
	public static final int ID = 30189;

	@Inject
	protected RoviaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
