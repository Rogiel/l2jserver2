 ...
 */
public class UmosTemplate extends TrainerNPCTemplate {
	public static final int ID = 30502;

	@Inject
	protected UmosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
