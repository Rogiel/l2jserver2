 ...
 */
public class DuningTemplate extends TrainerNPCTemplate {
	public static final int ID = 30688;

	@Inject
	protected DuningTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
