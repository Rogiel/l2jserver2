 ...
 */
public class MackenTemplate extends TrainerNPCTemplate {
	public static final int ID = 30108;

	@Inject
	protected MackenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
