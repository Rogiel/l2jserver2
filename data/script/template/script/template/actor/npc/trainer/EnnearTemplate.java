 ...
 */
public class EnnearTemplate extends TrainerNPCTemplate {
	public static final int ID = 32149;

	@Inject
	protected EnnearTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
