 ...
 */
public class LutherTemplate extends TrainerNPCTemplate {
	public static final int ID = 30690;

	@Inject
	protected LutherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
