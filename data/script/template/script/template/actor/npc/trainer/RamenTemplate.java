 ...
 */
public class RamenTemplate extends TrainerNPCTemplate {
	public static final int ID = 32203;

	@Inject
	protected RamenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
