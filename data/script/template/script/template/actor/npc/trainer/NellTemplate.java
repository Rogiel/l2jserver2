 ...
 */
public class NellTemplate extends TrainerNPCTemplate {
	public static final int ID = 30376;

	@Inject
	protected NellTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
