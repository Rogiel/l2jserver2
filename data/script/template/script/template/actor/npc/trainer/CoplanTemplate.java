 ...
 */
public class CoplanTemplate extends TrainerNPCTemplate {
	public static final int ID = 32182;

	@Inject
	protected CoplanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
