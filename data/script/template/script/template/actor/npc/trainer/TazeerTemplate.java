 ...
 */
public class TazeerTemplate extends TrainerNPCTemplate {
	public static final int ID = 31978;

	@Inject
	protected TazeerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.rightHand = itemProvider.createID(161);
		this.leftHand = null;
		this.enchantLevel = 0;
