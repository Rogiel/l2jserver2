 ...
 */
public class JustinTemplate extends TrainerNPCTemplate {
	public static final int ID = 31282;

	@Inject
	protected JustinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
