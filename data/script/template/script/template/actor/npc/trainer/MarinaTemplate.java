 ...
 */
public class MarinaTemplate extends TrainerNPCTemplate {
	public static final int ID = 30715;

	@Inject
	protected MarinaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
