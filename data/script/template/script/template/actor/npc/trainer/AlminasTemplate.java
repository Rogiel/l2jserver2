 ...
 */
public class AlminasTemplate extends TrainerNPCTemplate {
	public static final int ID = 31283;

	@Inject
	protected AlminasTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
