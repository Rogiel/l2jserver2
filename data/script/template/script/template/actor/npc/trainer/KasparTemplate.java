 ...
 */
public class KasparTemplate extends TrainerNPCTemplate {
	public static final int ID = 30833;

	@Inject
	protected KasparTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
