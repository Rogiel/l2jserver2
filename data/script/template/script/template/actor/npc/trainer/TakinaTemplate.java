 ...
 */
public class TakinaTemplate extends TrainerNPCTemplate {
	public static final int ID = 30915;

	@Inject
	protected TakinaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
