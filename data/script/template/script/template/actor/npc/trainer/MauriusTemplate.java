 ...
 */
public class MauriusTemplate extends TrainerNPCTemplate {
	public static final int ID = 30112;

	@Inject
	protected MauriusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
