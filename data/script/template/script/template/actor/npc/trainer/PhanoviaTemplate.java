 ...
 */
public class PhanoviaTemplate extends TrainerNPCTemplate {
	public static final int ID = 30190;

	@Inject
	protected PhanoviaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
