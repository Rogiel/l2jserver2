 ...
 */
public class GreenisTemplate extends TrainerNPCTemplate {
	public static final int ID = 30157;

	@Inject
	protected GreenisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
