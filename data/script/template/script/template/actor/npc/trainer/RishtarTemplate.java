 ...
 */
public class RishtarTemplate extends TrainerNPCTemplate {
	public static final int ID = 32212;

	@Inject
	protected RishtarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
