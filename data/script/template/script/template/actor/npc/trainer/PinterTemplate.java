 ...
 */
public class PinterTemplate extends TrainerNPCTemplate {
	public static final int ID = 30298;

	@Inject
	protected PinterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
