 ...
 */
public class JuenoTemplate extends TrainerNPCTemplate {
	public static final int ID = 32211;

	@Inject
	protected JuenoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
