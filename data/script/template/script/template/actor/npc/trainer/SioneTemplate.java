 ...
 */
public class SioneTemplate extends TrainerNPCTemplate {
	public static final int ID = 32195;

	@Inject
	protected SioneTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
