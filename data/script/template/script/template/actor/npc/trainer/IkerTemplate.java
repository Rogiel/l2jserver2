 ...
 */
public class IkerTemplate extends TrainerNPCTemplate {
	public static final int ID = 30110;

	@Inject
	protected IkerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
