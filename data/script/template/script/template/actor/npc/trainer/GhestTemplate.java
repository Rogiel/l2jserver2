 ...
 */
public class GhestTemplate extends TrainerNPCTemplate {
	public static final int ID = 30863;

	@Inject
	protected GhestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
