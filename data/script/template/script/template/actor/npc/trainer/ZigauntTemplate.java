 ...
 */
public class ZigauntTemplate extends TrainerNPCTemplate {
	public static final int ID = 30022;

	@Inject
	protected ZigauntTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
