 ...
 */
public class NabotTemplate extends TrainerNPCTemplate {
	public static final int ID = 32155;

	@Inject
	protected NabotTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
