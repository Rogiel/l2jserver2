 ...
 */
public class MordredTemplate extends TrainerNPCTemplate {
	public static final int ID = 31582;

	@Inject
	protected MordredTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.rightHand = itemProvider.createID(84);
		this.leftHand = itemProvider.createID(634);
		this.enchantLevel = 0;
