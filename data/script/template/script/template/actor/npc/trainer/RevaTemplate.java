 ...
 */
public class RevaTemplate extends TrainerNPCTemplate {
	public static final int ID = 30867;

	@Inject
	protected RevaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
