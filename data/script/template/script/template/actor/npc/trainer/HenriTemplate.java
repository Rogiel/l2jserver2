 ...
 */
public class HenriTemplate extends TrainerNPCTemplate {
	public static final int ID = 32152;

	@Inject
	protected HenriTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
