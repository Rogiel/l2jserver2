 ...
 */
public class RantonTemplate extends TrainerNPCTemplate {
	public static final int ID = 30906;

	@Inject
	protected RantonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
