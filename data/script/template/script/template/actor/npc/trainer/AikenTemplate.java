 ...
 */
public class AikenTemplate extends TrainerNPCTemplate {
	public static final int ID = 30850;

	@Inject
	protected AikenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
