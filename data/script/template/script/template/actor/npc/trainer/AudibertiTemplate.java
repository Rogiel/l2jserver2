 ...
 */
public class AudibertiTemplate extends TrainerNPCTemplate {
	public static final int ID = 30325;

	@Inject
	protected AudibertiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
