 ...
 */
public class ShubainTemplate extends TrainerNPCTemplate {
	public static final int ID = 32194;

	@Inject
	protected ShubainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
