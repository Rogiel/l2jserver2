 ...
 */
public class ManuelTemplate extends TrainerNPCTemplate {
	public static final int ID = 30293;

	@Inject
	protected ManuelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
