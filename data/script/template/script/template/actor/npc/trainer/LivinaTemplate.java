 ...
 */
public class LivinaTemplate extends TrainerNPCTemplate {
	public static final int ID = 30572;

	@Inject
	protected LivinaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
