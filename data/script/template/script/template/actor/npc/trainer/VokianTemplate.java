 ...
 */
public class VokianTemplate extends TrainerNPCTemplate {
	public static final int ID = 30514;

	@Inject
	protected VokianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
