 ...
 */
public class IcarusTemplate extends TrainerNPCTemplate {
	public static final int ID = 30835;

	@Inject
	protected IcarusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Icarus";
		this.serverSideName = false;
		this.title = "Lich King";
		...
		this.rightHand = itemProvider.createID(212);
		this.leftHand = null;
		this.enchantLevel = 0;
