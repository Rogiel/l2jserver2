 ...
 */
public class JurisTemplate extends TrainerNPCTemplate {
	public static final int ID = 30113;

	@Inject
	protected JurisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
