 ...
 */
public class GobieTemplate extends TrainerNPCTemplate {
	public static final int ID = 32198;

	@Inject
	protected GobieTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
