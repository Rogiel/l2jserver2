 ...
 */
public class MoiraTemplate extends TrainerNPCTemplate {
	public static final int ID = 31979;

	@Inject
	protected MoiraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
