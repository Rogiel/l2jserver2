 ...
 */
public class TaniosTemplate extends TrainerNPCTemplate {
	public static final int ID = 30908;

	@Inject
	protected TaniosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
