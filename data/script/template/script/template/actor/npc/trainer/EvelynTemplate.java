 ...
 */
public class EvelynTemplate extends TrainerNPCTemplate {
	public static final int ID = 30698;

	@Inject
	protected EvelynTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
