 ...
 */
public class FeynnTemplate extends TrainerNPCTemplate {
	public static final int ID = 31583;

	@Inject
	protected FeynnTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.rightHand = itemProvider.createID(168);
		this.leftHand = null;
		this.enchantLevel = 0;
