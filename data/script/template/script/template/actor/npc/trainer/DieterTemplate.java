 ...
 */
public class DieterTemplate extends TrainerNPCTemplate {
	public static final int ID = 30111;

	@Inject
	protected DieterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
