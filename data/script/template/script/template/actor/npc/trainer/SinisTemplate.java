 ...
 */
public class SinisTemplate extends TrainerNPCTemplate {
	public static final int ID = 31970;

	@Inject
	protected SinisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
