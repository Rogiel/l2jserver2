 ...
 */
public class RossTemplate extends TrainerNPCTemplate {
	public static final int ID = 30858;

	@Inject
	protected RossTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
