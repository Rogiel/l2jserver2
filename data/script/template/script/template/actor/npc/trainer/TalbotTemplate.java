 ...
 */
public class TalbotTemplate extends TrainerNPCTemplate {
	public static final int ID = 30377;

	@Inject
	protected TalbotTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
