 ...
 */
public class GwinterTemplate extends TrainerNPCTemplate {
	public static final int ID = 30027;

	@Inject
	protected GwinterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
