 ...
 */
public class KarukiaTemplate extends TrainerNPCTemplate {
	public static final int ID = 30570;

	@Inject
	protected KarukiaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
