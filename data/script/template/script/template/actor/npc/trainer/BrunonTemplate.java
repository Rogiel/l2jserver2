 ...
 */
public class BrunonTemplate extends TrainerNPCTemplate {
	public static final int ID = 30526;

	@Inject
	protected BrunonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
