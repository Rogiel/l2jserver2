 ...
 */
public class NoirTemplate extends TrainerNPCTemplate {
	public static final int ID = 32216;

	@Inject
	protected NoirTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
