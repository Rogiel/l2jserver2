 ...
 */
public class RoaTemplate extends TrainerNPCTemplate {
	public static final int ID = 30114;

	@Inject
	protected RoaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
