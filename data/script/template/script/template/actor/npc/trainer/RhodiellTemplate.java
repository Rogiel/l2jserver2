 ...
 */
public class RhodiellTemplate extends TrainerNPCTemplate {
	public static final int ID = 30374;

	@Inject
	protected RhodiellTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
