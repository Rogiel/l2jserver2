 ...
 */
public class SomakTemplate extends TrainerNPCTemplate {
	public static final int ID = 30510;

	@Inject
	protected SomakTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
