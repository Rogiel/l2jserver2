 ...
 */
public class BrikusTemplate extends TrainerNPCTemplate {
	public static final int ID = 30911;

	@Inject
	protected BrikusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
