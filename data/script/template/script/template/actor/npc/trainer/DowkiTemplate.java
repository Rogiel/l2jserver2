 ...
 */
public class DowkiTemplate extends TrainerNPCTemplate {
	public static final int ID = 30509;

	@Inject
	protected DowkiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
