 ...
 */
public class AmeliaTemplate extends TrainerNPCTemplate {
	public static final int ID = 31332;

	@Inject
	protected AmeliaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
