 ...
 */
public class OrkurusTemplate extends TrainerNPCTemplate {
	public static final int ID = 32207;

	@Inject
	protected OrkurusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
