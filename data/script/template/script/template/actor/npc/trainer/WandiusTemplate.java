 ...
 */
public class WandiusTemplate extends TrainerNPCTemplate {
	public static final int ID = 30459;

	@Inject
	protected WandiusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
