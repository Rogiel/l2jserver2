 ...
 */
public class PageTemplate extends TrainerNPCTemplate {
	public static final int ID = 30696;

	@Inject
	protected PageTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
