 ...
 */
public class RamoniellTemplate extends TrainerNPCTemplate {
	public static final int ID = 30345;

	@Inject
	protected RamoniellTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
