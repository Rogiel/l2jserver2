 ...
 */
public class PekironTemplate extends TrainerNPCTemplate {
	public static final int ID = 30682;

	@Inject
	protected PekironTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
