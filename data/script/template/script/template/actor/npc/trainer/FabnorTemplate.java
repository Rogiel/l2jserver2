 ...
 */
public class FabnorTemplate extends TrainerNPCTemplate {
	public static final int ID = 32219;

	@Inject
	protected FabnorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
