 ...
 */
public class RollantTemplate extends TrainerNPCTemplate {
	public static final int ID = 30069;

	@Inject
	protected RollantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
