 ...
 */
public class QueenienTemplate extends TrainerNPCTemplate {
	public static final int ID = 30693;

	@Inject
	protected QueenienTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
