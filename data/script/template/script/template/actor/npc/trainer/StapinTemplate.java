 ...
 */
public class StapinTemplate extends TrainerNPCTemplate {
	public static final int ID = 30475;

	@Inject
	protected StapinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
