 ...
 */
public class WinoninTemplate extends TrainerNPCTemplate {
	public static final int ID = 30856;

	@Inject
	protected WinoninTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
