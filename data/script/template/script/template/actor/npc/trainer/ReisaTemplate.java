 ...
 */
public class ReisaTemplate extends TrainerNPCTemplate {
	public static final int ID = 30328;

	@Inject
	protected ReisaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
