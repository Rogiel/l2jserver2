 ...
 */
public class LubenTemplate extends TrainerNPCTemplate {
	public static final int ID = 32231;

	@Inject
	protected LubenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
