 ...
 */
public class TenorTemplate extends TrainerNPCTemplate {
	public static final int ID = 32142;

	@Inject
	protected TenorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
