 ...
 */
public class KayanTemplate extends TrainerNPCTemplate {
	public static final int ID = 31335;

	@Inject
	protected KayanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.rightHand = itemProvider.createID(317);
		this.leftHand = null;
		this.enchantLevel = 0;
