 ...
 */
public class DufnerTemplate extends TrainerNPCTemplate {
	public static final int ID = 30106;

	@Inject
	protected DufnerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
