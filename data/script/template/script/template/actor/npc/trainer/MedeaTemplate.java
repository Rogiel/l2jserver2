 ...
 */
public class MedeaTemplate extends TrainerNPCTemplate {
	public static final int ID = 32228;

	@Inject
	protected MedeaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
