 ...
 */
public class GaiusTemplate extends TrainerNPCTemplate {
	public static final int ID = 30171;

	@Inject
	protected GaiusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
