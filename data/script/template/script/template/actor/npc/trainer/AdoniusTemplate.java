 ...
 */
public class AdoniusTemplate extends TrainerNPCTemplate {
	public static final int ID = 30375;

	@Inject
	protected AdoniusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
