 ...
 */
public class EntienTemplate extends TrainerNPCTemplate {
	public static final int ID = 32200;

	@Inject
	protected EntienTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
