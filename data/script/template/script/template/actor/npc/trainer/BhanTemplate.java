 ...
 */
public class BhanTemplate extends TrainerNPCTemplate {
	public static final int ID = 30186;

	@Inject
	protected BhanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
