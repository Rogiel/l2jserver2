 ...
 */
public class BronwynTemplate extends TrainerNPCTemplate {
	public static final int ID = 31278;

	@Inject
	protected BronwynTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
