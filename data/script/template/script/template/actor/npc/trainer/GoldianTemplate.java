 ...
 */
public class GoldianTemplate extends TrainerNPCTemplate {
	public static final int ID = 30107;

	@Inject
	protected GoldianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
