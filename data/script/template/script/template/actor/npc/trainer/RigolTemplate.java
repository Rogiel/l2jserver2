 ...
 */
public class RigolTemplate extends TrainerNPCTemplate {
	public static final int ID = 30184;

	@Inject
	protected RigolTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
