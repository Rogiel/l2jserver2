 ...
 */
public class TaniacBlackbirdTemplate extends TrainerNPCTemplate {
	public static final int ID = 30185;

	@Inject
	protected TaniacBlackbirdTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Taniac Blackbird";
