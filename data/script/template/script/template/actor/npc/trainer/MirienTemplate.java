 ...
 */
public class MirienTemplate extends TrainerNPCTemplate {
	public static final int ID = 30461;

	@Inject
	protected MirienTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
