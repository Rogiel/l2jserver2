 ...
 */
public class RaienTemplate extends TrainerNPCTemplate {
	public static final int ID = 30853;

	@Inject
	protected RaienTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
