 ...
 */
public class SelsiaTemplate extends TrainerNPCTemplate {
	public static final int ID = 32220;

	@Inject
	protected SelsiaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
