 ...
 */
public class SorboTemplate extends TrainerNPCTemplate {
	public static final int ID = 30914;

	@Inject
	protected SorboTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
