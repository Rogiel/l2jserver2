 ...
 */
public class DaryaTemplate extends TrainerNPCTemplate {
	public static final int ID = 30192;

	@Inject
	protected DaryaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
