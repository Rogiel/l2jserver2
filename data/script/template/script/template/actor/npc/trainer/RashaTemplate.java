 ...
 */
public class RashaTemplate extends TrainerNPCTemplate {
	public static final int ID = 32208;

	@Inject
	protected RashaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
