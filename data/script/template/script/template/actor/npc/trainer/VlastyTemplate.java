 ...
 */
public class VlastyTemplate extends TrainerNPCTemplate {
	public static final int ID = 30145;

	@Inject
	protected VlastyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
