 ...
 */
public class AerinaTemplate extends TrainerNPCTemplate {
	public static final int ID = 31975;

	@Inject
	protected AerinaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
