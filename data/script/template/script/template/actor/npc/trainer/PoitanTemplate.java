 ...
 */
public class PoitanTemplate extends TrainerNPCTemplate {
	public static final int ID = 30458;

	@Inject
	protected PoitanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
