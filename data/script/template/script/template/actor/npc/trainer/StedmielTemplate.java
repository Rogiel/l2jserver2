 ...
 */
public class StedmielTemplate extends TrainerNPCTemplate {
	public static final int ID = 30692;

	@Inject
	protected StedmielTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
