 ...
 */
public class DesmondTemplate extends TrainerNPCTemplate {
	public static final int ID = 30855;

	@Inject
	protected DesmondTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
