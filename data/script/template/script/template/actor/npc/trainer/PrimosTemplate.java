 ...
 */
public class PrimosTemplate extends TrainerNPCTemplate {
	public static final int ID = 30117;

	@Inject
	protected PrimosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
