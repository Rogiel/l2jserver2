 ...
 */
public class BlackTemplate extends TrainerNPCTemplate {
	public static final int ID = 32161;

	@Inject
	protected BlackTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
