 ...
 */
public class KendraTemplate extends TrainerNPCTemplate {
	public static final int ID = 30851;

	@Inject
	protected KendraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
