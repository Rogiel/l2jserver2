 ...
 */
public class TenainTemplate extends TrainerNPCTemplate {
	public static final int ID = 32215;

	@Inject
	protected TenainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
