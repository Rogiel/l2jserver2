 ...
 */
public class TrudyTemplate extends TrainerNPCTemplate {
	public static final int ID = 30143;

	@Inject
	protected TrudyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
