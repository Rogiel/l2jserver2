 ...
 */
public class DrakonTemplate extends TrainerNPCTemplate {
	public static final int ID = 31286;

	@Inject
	protected DrakonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
