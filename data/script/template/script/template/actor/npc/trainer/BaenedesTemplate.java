 ...
 */
public class BaenedesTemplate extends TrainerNPCTemplate {
	public static final int ID = 30369;

	@Inject
	protected BaenedesTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
