 ...
 */
public class SidraTemplate extends TrainerNPCTemplate {
	public static final int ID = 30330;

	@Inject
	protected SidraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
