 ...
 */
public class PrestanTemplate extends TrainerNPCTemplate {
	public static final int ID = 30700;

	@Inject
	protected PrestanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
