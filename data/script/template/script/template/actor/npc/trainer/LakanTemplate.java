 ...
 */
public class LakanTemplate extends TrainerNPCTemplate {
	public static final int ID = 31289;

	@Inject
	protected LakanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
