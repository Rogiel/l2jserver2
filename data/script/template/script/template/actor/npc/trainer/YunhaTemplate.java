 ...
 */
public class YunhaTemplate extends TrainerNPCTemplate {
	public static final int ID = 32183;

	@Inject
	protected YunhaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
