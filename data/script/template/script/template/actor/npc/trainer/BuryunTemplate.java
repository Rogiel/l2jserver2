 ...
 */
public class BuryunTemplate extends TrainerNPCTemplate {
	public static final int ID = 31960;

	@Inject
	protected BuryunTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.rightHand = itemProvider.createID(87);
		this.leftHand = null;
		this.enchantLevel = 0;
