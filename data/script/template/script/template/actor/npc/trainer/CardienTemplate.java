 ...
 */
public class CardienTemplate extends TrainerNPCTemplate {
	public static final int ID = 30460;

	@Inject
	protected CardienTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
