 ...
 */
public class EgnosTemplate extends TrainerNPCTemplate {
	public static final int ID = 30680;

	@Inject
	protected EgnosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
