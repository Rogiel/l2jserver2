 ...
 */
public class RoameriaTemplate extends TrainerNPCTemplate {
	public static final int ID = 30679;

	@Inject
	protected RoameriaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
