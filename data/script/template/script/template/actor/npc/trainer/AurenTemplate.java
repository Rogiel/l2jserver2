 ...
 */
public class AurenTemplate extends TrainerNPCTemplate {
	public static final int ID = 32224;

	@Inject
	protected AurenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
