 ...
 */
public class RumielTemplate extends TrainerNPCTemplate {
	public static final int ID = 31333;

	@Inject
	protected RumielTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
