 ...
 */
public class RindyTemplate extends TrainerNPCTemplate {
	public static final int ID = 32201;

	@Inject
	protected RindyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
