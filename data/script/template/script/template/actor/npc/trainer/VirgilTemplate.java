 ...
 */
public class VirgilTemplate extends TrainerNPCTemplate {
	public static final int ID = 30329;

	@Inject
	protected VirgilTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
