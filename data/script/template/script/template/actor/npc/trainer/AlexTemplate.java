 ...
 */
public class AlexTemplate extends TrainerNPCTemplate {
	public static final int ID = 30291;

	@Inject
	protected AlexTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
