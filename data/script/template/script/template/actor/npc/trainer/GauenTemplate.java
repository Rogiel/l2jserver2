 ...
 */
public class GauenTemplate extends TrainerNPCTemplate {
	public static final int ID = 30717;

	@Inject
	protected GauenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
