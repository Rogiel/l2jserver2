 ...
 */
public class AtraxiaTemplate extends TrainerNPCTemplate {
	public static final int ID = 31972;

	@Inject
	protected AtraxiaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
