 ...
 */
public class KamilenTemplate extends TrainerNPCTemplate {
	public static final int ID = 31287;

	@Inject
	protected KamilenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.rightHand = itemProvider.createID(204);
		this.leftHand = null;
		this.enchantLevel = 0;
