 ...
 */
public class IsabellinTemplate extends TrainerNPCTemplate {
	public static final int ID = 30119;

	@Inject
	protected IsabellinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
