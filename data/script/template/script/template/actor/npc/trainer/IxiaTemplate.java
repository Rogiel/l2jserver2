 ...
 */
public class IxiaTemplate extends TrainerNPCTemplate {
	public static final int ID = 30463;

	@Inject
	protected IxiaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
