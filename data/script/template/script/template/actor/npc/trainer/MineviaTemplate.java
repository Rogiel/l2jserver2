 ...
 */
public class MineviaTemplate extends TrainerNPCTemplate {
	public static final int ID = 30907;

	@Inject
	protected MineviaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
