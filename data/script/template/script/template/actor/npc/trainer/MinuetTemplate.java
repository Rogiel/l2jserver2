 ...
 */
public class MinuetTemplate extends TrainerNPCTemplate {
	public static final int ID = 32232;

	@Inject
	protected MinuetTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
