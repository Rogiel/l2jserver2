 ...
 */
public class XenoviaTemplate extends TrainerNPCTemplate {
	public static final int ID = 30912;

	@Inject
	protected XenoviaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
