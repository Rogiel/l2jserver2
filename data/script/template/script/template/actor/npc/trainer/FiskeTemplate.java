 ...
 */
public class FiskeTemplate extends TrainerNPCTemplate {
	public static final int ID = 32204;

	@Inject
	protected FiskeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
