 ...
 */
public class WilbertTemplate extends TrainerNPCTemplate {
	public static final int ID = 30846;

	@Inject
	protected WilbertTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
