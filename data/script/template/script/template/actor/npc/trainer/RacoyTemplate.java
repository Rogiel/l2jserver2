 ...
 */
public class RacoyTemplate extends TrainerNPCTemplate {
	public static final int ID = 30507;

	@Inject
	protected RacoyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
