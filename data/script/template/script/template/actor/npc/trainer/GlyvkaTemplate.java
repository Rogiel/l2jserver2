 ...
 */
public class GlyvkaTemplate extends TrainerNPCTemplate {
	public static final int ID = 30067;

	@Inject
	protected GlyvkaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
