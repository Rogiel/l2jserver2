 ...
 */
public class TaliaTemplate extends TrainerNPCTemplate {
	public static final int ID = 31976;

	@Inject
	protected TaliaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
