 ...
 */
public class MorningTemplate extends TrainerNPCTemplate {
	public static final int ID = 30898;

	@Inject
	protected MorningTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
