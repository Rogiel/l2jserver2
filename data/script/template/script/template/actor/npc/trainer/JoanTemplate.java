 ...
 */
public class JoanTemplate extends TrainerNPCTemplate {
	public static final int ID = 30718;

	@Inject
	protected JoanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
