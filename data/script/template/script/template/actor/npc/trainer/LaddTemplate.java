 ...
 */
public class LaddTemplate extends TrainerNPCTemplate {
	public static final int ID = 30721;

	@Inject
	protected LaddTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
