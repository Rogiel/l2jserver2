 ...
 */
public class BukaTemplate extends TrainerNPCTemplate {
	public static final int ID = 30506;

	@Inject
	protected BukaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
