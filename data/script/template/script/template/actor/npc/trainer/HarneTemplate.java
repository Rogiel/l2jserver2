 ...
 */
public class HarneTemplate extends TrainerNPCTemplate {
	public static final int ID = 30144;

	@Inject
	protected HarneTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
