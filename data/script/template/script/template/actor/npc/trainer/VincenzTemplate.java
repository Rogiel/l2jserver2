 ...
 */
public class VincenzTemplate extends TrainerNPCTemplate {
	public static final int ID = 31316;

	@Inject
	protected VincenzTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
