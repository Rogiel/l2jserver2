 ...
 */
public class ClaytonTemplate extends TrainerNPCTemplate {
	public static final int ID = 30464;

	@Inject
	protected ClaytonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
