 ...
 */
public class GwainTemplate extends TrainerNPCTemplate {
	public static final int ID = 32197;

	@Inject
	protected GwainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
