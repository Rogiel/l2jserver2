 ...
 */
public class LazenbyTemplate extends TrainerNPCTemplate {
	public static final int ID = 30706;

	@Inject
	protected LazenbyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
