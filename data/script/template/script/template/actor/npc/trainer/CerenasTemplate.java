 ...
 */
public class CerenasTemplate extends TrainerNPCTemplate {
	public static final int ID = 31281;

	@Inject
	protected CerenasTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
