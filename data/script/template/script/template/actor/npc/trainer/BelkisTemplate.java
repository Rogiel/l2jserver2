 ...
 */
public class BelkisTemplate extends TrainerNPCTemplate {
	public static final int ID = 32143;

	@Inject
	protected BelkisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
