 ...
 */
public class DustinTemplate extends TrainerNPCTemplate {
	public static final int ID = 30116;

	@Inject
	protected DustinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
