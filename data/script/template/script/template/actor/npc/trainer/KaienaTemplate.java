 ...
 */
public class KaienaTemplate extends TrainerNPCTemplate {
	public static final int ID = 30720;

	@Inject
	protected KaienaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
