 ...
 */
public class WagnerTemplate extends TrainerNPCTemplate {
	public static final int ID = 31330;

	@Inject
	protected WagnerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
