 ...
 */
public class ShegfieldTemplate extends TrainerNPCTemplate {
	public static final int ID = 30068;

	@Inject
	protected ShegfieldTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
