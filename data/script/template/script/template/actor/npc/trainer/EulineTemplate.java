 ...
 */
public class EulineTemplate extends TrainerNPCTemplate {
	public static final int ID = 31967;

	@Inject
	protected EulineTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
