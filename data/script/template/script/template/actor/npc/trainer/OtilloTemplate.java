 ...
 */
public class OtilloTemplate extends TrainerNPCTemplate {
	public static final int ID = 31971;

	@Inject
	protected OtilloTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
