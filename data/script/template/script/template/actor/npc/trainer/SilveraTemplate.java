 ...
 */
public class SilveraTemplate extends TrainerNPCTemplate {
	public static final int ID = 30527;

	@Inject
	protected SilveraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
