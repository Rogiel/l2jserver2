 ...
 */
public class ManakiaTemplate extends TrainerNPCTemplate {
	public static final int ID = 30515;

	@Inject
	protected ManakiaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
