 ...
 */
public class ChakirisTemplate extends TrainerNPCTemplate {
	public static final int ID = 30705;

	@Inject
	protected ChakirisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
