 ...
 */
public class EstellaTemplate extends TrainerNPCTemplate {
	public static final int ID = 30378;

	@Inject
	protected EstellaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
