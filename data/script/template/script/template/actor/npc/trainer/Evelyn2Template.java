 ...
 */
public class Evelyn2Template extends TrainerNPCTemplate {
	public static final int ID = 31969;

	@Inject
	protected Evelyn2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
