 ...
 */
public class HanellinTemplate extends TrainerNPCTemplate {
	public static final int ID = 30864;

	@Inject
	protected HanellinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
