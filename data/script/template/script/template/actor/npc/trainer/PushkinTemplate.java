 ...
 */
public class PushkinTemplate extends TrainerNPCTemplate {
	public static final int ID = 30300;

	@Inject
	protected PushkinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
