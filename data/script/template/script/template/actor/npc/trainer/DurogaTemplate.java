 ...
 */
public class DurogaTemplate extends TrainerNPCTemplate {
	public static final int ID = 32223;

	@Inject
	protected DurogaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
