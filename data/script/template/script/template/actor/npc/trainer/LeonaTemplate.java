 ...
 */
public class LeonaTemplate extends TrainerNPCTemplate {
	public static final int ID = 30326;

	@Inject
	protected LeonaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
