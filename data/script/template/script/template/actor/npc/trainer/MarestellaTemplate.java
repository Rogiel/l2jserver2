 ...
 */
public class MarestellaTemplate extends TrainerNPCTemplate {
	public static final int ID = 30866;

	@Inject
	protected MarestellaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Marestella";
