 ...
 */
public class MartikaTemplate extends TrainerNPCTemplate {
	public static final int ID = 32162;

	@Inject
	protected MartikaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
