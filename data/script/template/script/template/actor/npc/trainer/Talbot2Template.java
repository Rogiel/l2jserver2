 ...
 */
public class Talbot2Template extends TrainerNPCTemplate {
	public static final int ID = 32156;

	@Inject
	protected Talbot2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
