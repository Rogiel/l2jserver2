 ...
 */
public class PupinaTemplate extends TrainerNPCTemplate {
	public static final int ID = 30118;

	@Inject
	protected PupinaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
