 ...
 */
public class TriolsRevelation4Template extends NPCTemplate {
	public static final int ID = 32061;

	@Inject
	protected TriolsRevelation4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
