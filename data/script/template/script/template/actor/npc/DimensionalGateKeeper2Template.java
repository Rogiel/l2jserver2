 ...
 */
public class DimensionalGateKeeper2Template extends NPCTemplate {
	public static final int ID = 31495;

	@Inject
	protected DimensionalGateKeeper2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
