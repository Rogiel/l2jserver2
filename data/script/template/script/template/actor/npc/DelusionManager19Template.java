 ...
 */
public class DelusionManager19Template extends NPCTemplate {
	public static final int ID = 32682;

	@Inject
	protected DelusionManager19Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
