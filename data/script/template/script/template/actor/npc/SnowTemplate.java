 ...
 */
public class SnowTemplate extends NPCTemplate {
	public static final int ID = 32365;

	@Inject
	protected SnowTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
