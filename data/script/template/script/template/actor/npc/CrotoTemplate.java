 ...
 */
public class CrotoTemplate extends NPCTemplate {
	public static final int ID = 30671;

	@Inject
	protected CrotoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
