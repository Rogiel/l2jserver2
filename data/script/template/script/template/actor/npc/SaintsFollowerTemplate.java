 ...
 */
public class SaintsFollowerTemplate extends NPCTemplate {
	public static final int ID = 31700;

	@Inject
	protected SaintsFollowerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
