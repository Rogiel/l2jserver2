 ...
 */
public class LotteryTicketSellerTemplate extends NPCTemplate {
	public static final int ID = 30990;

	@Inject
	protected LotteryTicketSellerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
