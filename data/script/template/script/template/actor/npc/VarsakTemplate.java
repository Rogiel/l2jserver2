 ...
 */
public class VarsakTemplate extends NPCTemplate {
	public static final int ID = 30342;

	@Inject
	protected VarsakTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
