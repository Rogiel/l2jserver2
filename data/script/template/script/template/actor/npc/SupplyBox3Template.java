 ...
 */
public class SupplyBox3Template extends NPCTemplate {
	public static final int ID = 35734;

	@Inject
	protected SupplyBox3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
