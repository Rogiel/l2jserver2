 ...
 */
public class PartisanCourtGuard2Template extends MonsterNPCTemplate {
	public static final int ID = 35371;

	@Inject
	protected PartisanCourtGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
