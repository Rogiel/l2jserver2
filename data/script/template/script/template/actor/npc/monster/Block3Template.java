 ...
 */
public class Block3Template extends MonsterNPCTemplate {
	public static final int ID = 18673;

	@Inject
	protected Block3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
