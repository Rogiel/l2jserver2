 ...
 */
public class PashikaSonOfVoltarTemplate extends MonsterNPCTemplate {
	public static final int ID = 27080;

	@Inject
	protected PashikaSonOfVoltarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Pashika Son Of Voltar";
