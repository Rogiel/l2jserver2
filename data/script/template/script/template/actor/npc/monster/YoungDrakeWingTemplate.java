 ...
 */
public class YoungDrakeWingTemplate extends MonsterNPCTemplate {
	public static final int ID = 18781;

	@Inject
	protected YoungDrakeWingTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Young Drake Wing";
