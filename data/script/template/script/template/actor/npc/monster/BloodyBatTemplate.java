 ...
 */
public class BloodyBatTemplate extends MonsterNPCTemplate {
	public static final int ID = 20838;

	@Inject
	protected BloodyBatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bloody Bat";
