 ...
 */
public class GuardianArchangel2Template extends MonsterNPCTemplate {
	public static final int ID = 21068;

	@Inject
	protected GuardianArchangel2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guardian Archangel";
