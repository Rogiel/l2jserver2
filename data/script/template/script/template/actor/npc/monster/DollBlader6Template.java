 ...
 */
public class DollBlader6Template extends MonsterNPCTemplate {
	public static final int ID = 29182;

	@Inject
	protected DollBlader6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
