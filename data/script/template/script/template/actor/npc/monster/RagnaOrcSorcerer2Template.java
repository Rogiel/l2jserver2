 ...
 */
public class RagnaOrcSorcerer2Template extends MonsterNPCTemplate {
	public static final int ID = 22042;

	@Inject
	protected RagnaOrcSorcerer2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
