 ...
 */
public class AmberBasiliskTemplate extends MonsterNPCTemplate {
	public static final int ID = 20199;

	@Inject
	protected AmberBasiliskTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Amber Basilisk";
