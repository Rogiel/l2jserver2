 ...
 */
public class TotemGuardArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 25261;

	@Inject
	protected TotemGuardArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Totem Guard Archer";
		...
		this.maxHP = 16743.063872554300000;
