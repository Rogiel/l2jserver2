 ...
 */
public class ImperialGuard3Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18168;

	@Inject
	protected ImperialGuard3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
