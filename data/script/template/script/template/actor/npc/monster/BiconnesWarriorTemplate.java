 ...
 */
public class BiconnesWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 25059;

	@Inject
	protected BiconnesWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Biconne's Warrior";
