 ...
 */
public class AllSevenTemplate extends MonsterNPCTemplate {
	public static final int ID = 31019;

	@Inject
	protected AllSevenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
