 ...
 */
public class InvaderAssassinOfNightmareTemplate extends MonsterNPCTemplate {
	public static final int ID = 22712;

	@Inject
	protected InvaderAssassinOfNightmareTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Invader Assassin of Nightmare";
