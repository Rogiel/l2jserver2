 ...
 */
public class KashaDireWolfTemplate extends MonsterNPCTemplate {
	public static final int ID = 21121;

	@Inject
	protected KashaDireWolfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kasha Dire Wolf";
