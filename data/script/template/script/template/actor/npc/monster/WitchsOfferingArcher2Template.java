 ...
 */
public class WitchsOfferingArcher2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18081;

	@Inject
	protected WitchsOfferingArcher2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
