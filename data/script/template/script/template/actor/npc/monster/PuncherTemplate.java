 ...
 */
public class PuncherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20085;

	@Inject
	protected PuncherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
