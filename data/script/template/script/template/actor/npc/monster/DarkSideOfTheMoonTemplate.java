 ...
 */
public class DarkSideOfTheMoonTemplate extends MonsterNPCTemplate {
	public static final int ID = 31006;

	@Inject
	protected DarkSideOfTheMoonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
