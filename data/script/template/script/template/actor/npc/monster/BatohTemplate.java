 ...
 */
public class BatohTemplate extends MonsterNPCTemplate {
	public static final int ID = 27061;

	@Inject
	protected BatohTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
