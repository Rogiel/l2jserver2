 ...
 */
public class KechisGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 22308;

	@Inject
	protected KechisGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
