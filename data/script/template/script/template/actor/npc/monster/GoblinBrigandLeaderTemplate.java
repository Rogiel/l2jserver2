 ...
 */
public class GoblinBrigandLeaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20323;

	@Inject
	protected GoblinBrigandLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Goblin Brigand Leader";
