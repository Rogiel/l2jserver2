 ...
 */
public class WasteLandfillMachineTemplate extends MonsterNPCTemplate {
	public static final int ID = 18805;

	@Inject
	protected WasteLandfillMachineTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Waste Landfill Machine";
