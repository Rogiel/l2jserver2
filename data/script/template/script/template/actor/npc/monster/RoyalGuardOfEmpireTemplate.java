 ...
 */
public class RoyalGuardOfEmpireTemplate extends MonsterNPCTemplate {
	public static final int ID = 21408;

	@Inject
	protected RoyalGuardOfEmpireTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
