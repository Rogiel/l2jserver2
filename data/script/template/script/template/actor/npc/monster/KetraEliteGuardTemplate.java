 ...
 */
public class KetraEliteGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 21344;

	@Inject
	protected KetraEliteGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ketra Elite Guard";
