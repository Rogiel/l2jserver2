 ...
 */
public class HalishasForeman8Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18180;

	@Inject
	protected HalishasForeman8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
