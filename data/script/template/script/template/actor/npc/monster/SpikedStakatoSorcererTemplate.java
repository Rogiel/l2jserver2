 ...
 */
public class SpikedStakatoSorcererTemplate extends MonsterNPCTemplate {
	public static final int ID = 22111;

	@Inject
	protected SpikedStakatoSorcererTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
