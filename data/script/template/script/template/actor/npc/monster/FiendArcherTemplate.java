 ...
 */
public class FiendArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20841;

	@Inject
	protected FiendArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
