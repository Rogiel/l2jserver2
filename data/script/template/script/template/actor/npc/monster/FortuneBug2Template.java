 ...
 */
public class FortuneBug2Template extends MonsterNPCTemplate {
	public static final int ID = 18665;

	@Inject
	protected FortuneBug2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
