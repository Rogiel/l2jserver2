 ...
 */
public class HeathenKnightTemplate extends MonsterNPCTemplate {
	public static final int ID = 21442;

	@Inject
	protected HeathenKnightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Heathen Knight";
