 ...
 */
public class JewelGuardianMusfelTemplate extends MonsterNPCTemplate {
	public static final int ID = 27169;

	@Inject
	protected JewelGuardianMusfelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Jewel Guardian Musfel";
