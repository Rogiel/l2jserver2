 ...
 */
public class ApostatesOfferingArcher2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18071;

	@Inject
	protected ApostatesOfferingArcher2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
