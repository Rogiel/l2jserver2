 ...
 */
public class BeetleOfGraveTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18141;

	@Inject
	protected BeetleOfGraveTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
