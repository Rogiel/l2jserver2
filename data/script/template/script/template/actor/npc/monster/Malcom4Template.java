 ...
 */
public class Malcom4Template extends MonsterNPCTemplate {
	public static final int ID = 30939;

	@Inject
	protected Malcom4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Malcom4";
		this.serverSideName = false;
		this.title = "Prince of Darkness";
