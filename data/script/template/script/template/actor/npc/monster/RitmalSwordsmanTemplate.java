 ...
 */
public class RitmalSwordsmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20615;

	@Inject
	protected RitmalSwordsmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ritmal Swordsman";
