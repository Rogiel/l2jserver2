 ...
 */
public class HarpyTemplate extends MonsterNPCTemplate {
	public static final int ID = 20145;

	@Inject
	protected HarpyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
