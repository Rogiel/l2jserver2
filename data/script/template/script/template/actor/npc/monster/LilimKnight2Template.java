 ...
 */
public class LilimKnight2Template extends MonsterNPCTemplate {
	public static final int ID = 21180;

	@Inject
	protected LilimKnight2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
