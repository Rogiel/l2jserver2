 ...
 */
public class WitchOfDust3Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18193;

	@Inject
	protected WitchOfDust3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Witch of dust";
