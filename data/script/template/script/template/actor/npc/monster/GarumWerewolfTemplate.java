 ...
 */
public class GarumWerewolfTemplate extends MonsterNPCTemplate {
	public static final int ID = 20307;

	@Inject
	protected GarumWerewolfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Garum Werewolf";
