 ...
 */
public class BarahamTemplate extends MonsterNPCTemplate {
	public static final int ID = 27113;

	@Inject
	protected BarahamTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
