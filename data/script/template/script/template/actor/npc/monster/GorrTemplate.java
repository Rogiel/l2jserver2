 ...
 */
public class GorrTemplate extends MonsterNPCTemplate {
	public static final int ID = 27112;

	@Inject
	protected GorrTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
