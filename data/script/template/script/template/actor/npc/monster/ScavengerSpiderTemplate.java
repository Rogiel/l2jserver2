 ...
 */
public class ScavengerSpiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20410;

	@Inject
	protected ScavengerSpiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Scavenger Spider";
