 ...
 */
public class ArcherOfAbyssTemplate extends MonsterNPCTemplate {
	public static final int ID = 20819;

	@Inject
	protected ArcherOfAbyssTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Archer of Abyss";
