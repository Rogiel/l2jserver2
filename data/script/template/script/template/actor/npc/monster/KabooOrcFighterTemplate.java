 ...
 */
public class KabooOrcFighterTemplate extends MonsterNPCTemplate {
	public static final int ID = 20471;

	@Inject
	protected KabooOrcFighterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kaboo Orc Fighter";
