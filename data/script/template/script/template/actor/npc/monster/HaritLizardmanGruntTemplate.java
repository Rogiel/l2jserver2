 ...
 */
public class HaritLizardmanGruntTemplate extends MonsterNPCTemplate {
	public static final int ID = 20641;

	@Inject
	protected HaritLizardmanGruntTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Harit Lizardman Grunt";
