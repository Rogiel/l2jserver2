 ...
 */
public class ShadowOfBelethTemplate extends MonsterNPCTemplate {
	public static final int ID = 27278;

	@Inject
	protected ShadowOfBelethTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shadow of Beleth";
