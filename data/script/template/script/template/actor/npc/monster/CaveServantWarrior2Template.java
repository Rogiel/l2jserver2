 ...
 */
public class CaveServantWarrior2Template extends MonsterNPCTemplate {
	public static final int ID = 20274;

	@Inject
	protected CaveServantWarrior2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
