 ...
 */
public class WalkingFungusTemplate extends MonsterNPCTemplate {
	public static final int ID = 20175;

	@Inject
	protected WalkingFungusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Walking Fungus";
