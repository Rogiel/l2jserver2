 ...
 */
public class DefeatedTroopsInfantry2Template extends MonsterNPCTemplate {
	public static final int ID = 22562;

	@Inject
	protected DefeatedTroopsInfantry2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Defeated Troops Infantry";
