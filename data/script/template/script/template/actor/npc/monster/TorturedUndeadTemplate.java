 ...
 */
public class TorturedUndeadTemplate extends MonsterNPCTemplate {
	public static final int ID = 20678;

	@Inject
	protected TorturedUndeadTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tortured Undead";
