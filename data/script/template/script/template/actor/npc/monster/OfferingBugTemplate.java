 ...
 */
public class OfferingBugTemplate extends MonsterNPCTemplate {
	public static final int ID = 21437;

	@Inject
	protected OfferingBugTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Offering Bug";
