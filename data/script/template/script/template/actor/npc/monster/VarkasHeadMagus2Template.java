 ...
 */
public class VarkasHeadMagus2Template extends MonsterNPCTemplate {
	public static final int ID = 21371;

	@Inject
	protected VarkasHeadMagus2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Varka's Head Magus";
