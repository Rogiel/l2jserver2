 ...
 */
public class BrekaOverlordJakaTemplate extends MonsterNPCTemplate {
	public static final int ID = 27141;

	@Inject
	protected BrekaOverlordJakaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Breka Overlord Jaka";
