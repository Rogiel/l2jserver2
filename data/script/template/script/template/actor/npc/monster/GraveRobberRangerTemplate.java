 ...
 */
public class GraveRobberRangerTemplate extends MonsterNPCTemplate {
	public static final int ID = 22005;

	@Inject
	protected GraveRobberRangerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grave Robber Ranger";
		...
		this.experience = 1477;
		this.sp = 77;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(8529);
		this.leftHand = null;
		this.enchantLevel = 0;
