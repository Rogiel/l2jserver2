 ...
 */
public class FamilyOfNastronTemplate extends MonsterNPCTemplate {
	public static final int ID = 25307;

	@Inject
	protected FamilyOfNastronTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
