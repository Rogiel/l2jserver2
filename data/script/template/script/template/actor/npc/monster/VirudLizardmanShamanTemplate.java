 ...
 */
public class VirudLizardmanShamanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20297;

	@Inject
	protected VirudLizardmanShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
