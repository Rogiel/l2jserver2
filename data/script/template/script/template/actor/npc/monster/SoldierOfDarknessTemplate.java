 ...
 */
public class SoldierOfDarknessTemplate extends MonsterNPCTemplate {
	public static final int ID = 21040;

	@Inject
	protected SoldierOfDarknessTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Soldier of Darkness";
