 ...
 */
public class RagnaOrcWarrior2Template extends MonsterNPCTemplate {
	public static final int ID = 22692;

	@Inject
	protected RagnaOrcWarrior2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
