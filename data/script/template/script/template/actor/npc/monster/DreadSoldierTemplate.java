 ...
 */
public class DreadSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 20504;

	@Inject
	protected DreadSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dread Soldier";
