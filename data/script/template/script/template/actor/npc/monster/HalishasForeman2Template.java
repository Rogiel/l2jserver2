 ...
 */
public class HalishasForeman2Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18174;

	@Inject
	protected HalishasForeman2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
