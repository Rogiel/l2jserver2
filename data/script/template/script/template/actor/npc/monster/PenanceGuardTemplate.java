 ...
 */
public class PenanceGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 22137;

	@Inject
	protected PenanceGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
