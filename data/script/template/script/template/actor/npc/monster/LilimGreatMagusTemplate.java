 ...
 */
public class LilimGreatMagusTemplate extends MonsterNPCTemplate {
	public static final int ID = 27360;

	@Inject
	protected LilimGreatMagusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lilim Great Magus";
