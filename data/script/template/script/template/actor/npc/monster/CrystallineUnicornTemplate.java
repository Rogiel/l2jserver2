 ...
 */
public class CrystallineUnicornTemplate extends MonsterNPCTemplate {
	public static final int ID = 22287;

	@Inject
	protected CrystallineUnicornTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Crystalline Unicorn";
