 ...
 */
public class ShakasShooterTemplate extends MonsterNPCTemplate {
	public static final int ID = 25068;

	@Inject
	protected ShakasShooterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shaka's Shooter";
		...
		this.maxHP = 23915.749075598500000;
