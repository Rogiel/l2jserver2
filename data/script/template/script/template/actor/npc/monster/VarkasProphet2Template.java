 ...
 */
public class VarkasProphet2Template extends MonsterNPCTemplate {
	public static final int ID = 21373;

	@Inject
	protected VarkasProphet2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Varka's Prophet";
