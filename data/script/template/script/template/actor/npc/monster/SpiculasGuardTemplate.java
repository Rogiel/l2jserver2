 ...
 */
public class SpiculasGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 18355;

	@Inject
	protected SpiculasGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Spicula's Guard";
