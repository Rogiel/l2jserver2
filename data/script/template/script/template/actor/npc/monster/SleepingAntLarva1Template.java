 ...
 */
public class SleepingAntLarva1Template extends MonsterNPCTemplate {
	public static final int ID = 30982;

	@Inject
	protected SleepingAntLarva1Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sleeping Ant Larva1";
