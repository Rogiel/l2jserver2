 ...
 */
public class WardOfDeathTemplate extends MonsterNPCTemplate {
	public static final int ID = 18667;

	@Inject
	protected WardOfDeathTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
