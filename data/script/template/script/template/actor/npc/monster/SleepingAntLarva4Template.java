 ...
 */
public class SleepingAntLarva4Template extends MonsterNPCTemplate {
	public static final int ID = 30985;

	@Inject
	protected SleepingAntLarva4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sleeping Ant Larva4";
