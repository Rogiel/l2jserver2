 ...
 */
public class TulbenTemplate extends MonsterNPCTemplate {
	public static final int ID = 20677;

	@Inject
	protected TulbenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
