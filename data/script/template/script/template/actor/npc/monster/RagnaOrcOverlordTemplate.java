 ...
 */
public class RagnaOrcOverlordTemplate extends MonsterNPCTemplate {
	public static final int ID = 20778;

	@Inject
	protected RagnaOrcOverlordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ragna Orc Overlord";
