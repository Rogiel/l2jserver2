 ...
 */
public class MoonstoneBeastTemplate extends MonsterNPCTemplate {
	public static final int ID = 20369;

	@Inject
	protected MoonstoneBeastTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Moonstone Beast";
