 ...
 */
public class WaspLeaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20935;

	@Inject
	protected WaspLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Wasp Leader";
