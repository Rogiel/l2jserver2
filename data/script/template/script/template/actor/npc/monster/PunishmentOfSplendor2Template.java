 ...
 */
public class PunishmentOfSplendor2Template extends MonsterNPCTemplate {
	public static final int ID = 21658;

	@Inject
	protected PunishmentOfSplendor2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Punishment of Splendor";
