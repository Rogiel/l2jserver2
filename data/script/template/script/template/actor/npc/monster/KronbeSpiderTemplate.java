 ...
 */
public class KronbeSpiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20603;

	@Inject
	protected KronbeSpiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kronbe Spider";
