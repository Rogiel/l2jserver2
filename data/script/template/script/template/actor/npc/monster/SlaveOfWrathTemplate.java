 ...
 */
public class SlaveOfWrathTemplate extends MonsterNPCTemplate {
	public static final int ID = 22426;

	@Inject
	protected SlaveOfWrathTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
