 ...
 */
public class AndreasRoyalGuards4Template extends MonsterNPCTemplate {
	public static final int ID = 22193;

	@Inject
	protected AndreasRoyalGuards4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
