 ...
 */
public class BoxOfAthrea5Template extends MonsterNPCTemplate {
	public static final int ID = 27177;

	@Inject
	protected BoxOfAthrea5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Box Of Athrea 5";
