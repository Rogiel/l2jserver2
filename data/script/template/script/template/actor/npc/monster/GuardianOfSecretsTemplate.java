 ...
 */
public class GuardianOfSecretsTemplate extends MonsterNPCTemplate {
	public static final int ID = 18358;

	@Inject
	protected GuardianOfSecretsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guardian of Secrets";
