 ...
 */
public class DarkAngelOthielTemplate extends MonsterNPCTemplate {
	public static final int ID = 27282;

	@Inject
	protected DarkAngelOthielTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
