 ...
 */
public class LawScholarOfConclusions3Template extends MonsterNPCTemplate {
	public static final int ID = 22534;

	@Inject
	protected LawScholarOfConclusions3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Law Scholar of Conclusions";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 21.12;
		this.collisionHeight = 40.48;
		this.level = 81;
