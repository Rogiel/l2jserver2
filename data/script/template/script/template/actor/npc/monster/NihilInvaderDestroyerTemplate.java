 ...
 */
public class NihilInvaderDestroyerTemplate extends MonsterNPCTemplate {
	public static final int ID = 22722;

	@Inject
	protected NihilInvaderDestroyerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nihil Invader Destroyer";
