 ...
 */
public class BlackLeopardTemplate extends MonsterNPCTemplate {
	public static final int ID = 27319;

	@Inject
	protected BlackLeopardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
