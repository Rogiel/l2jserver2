 ...
 */
public class GraveRobberWarriorOfLightTemplate extends MonsterNPCTemplate {
	public static final int ID = 22682;

	@Inject
	protected GraveRobberWarriorOfLightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grave Robber Warrior of Light";
