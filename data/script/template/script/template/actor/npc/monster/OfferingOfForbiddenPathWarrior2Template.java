 ...
 */
public class OfferingOfForbiddenPathWarrior2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18102;

	@Inject
	protected OfferingOfForbiddenPathWarrior2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Offering of Forbidden Path Warrior";
