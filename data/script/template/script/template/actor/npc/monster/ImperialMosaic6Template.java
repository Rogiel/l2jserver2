 ...
 */
public class ImperialMosaic6Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18138;

	@Inject
	protected ImperialMosaic6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
