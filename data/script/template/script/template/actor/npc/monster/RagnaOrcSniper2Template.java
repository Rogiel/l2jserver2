 ...
 */
public class RagnaOrcSniper2Template extends MonsterNPCTemplate {
	public static final int ID = 22699;

	@Inject
	protected RagnaOrcSniper2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ragna Orc Sniper";
