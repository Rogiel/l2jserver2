 ...
 */
public class ElderLongtailKeltirTemplate extends MonsterNPCTemplate {
	public static final int ID = 20539;

	@Inject
	protected ElderLongtailKeltirTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Elder Longtail Keltir";
		...
		attributes.magicalDefense = 31.90336;
