 ...
 */
public class EpicCannonGolemAdjunctTemplate extends MonsterNPCTemplate {
	public static final int ID = 22075;

	@Inject
	protected EpicCannonGolemAdjunctTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Epic Cannon Golem Adjunct";
