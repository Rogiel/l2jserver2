 ...
 */
public class CrumaPhantom2Template extends MonsterNPCTemplate {
	public static final int ID = 18551;

	@Inject
	protected CrumaPhantom2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 53155.208634217200000;
		...
		attributes.physicalAttack = 491.12346;
		attributes.magicalAttack = 335.37366;
