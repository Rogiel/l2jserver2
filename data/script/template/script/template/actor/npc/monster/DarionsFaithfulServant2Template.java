 ...
 */
public class DarionsFaithfulServant2Template extends MonsterNPCTemplate {
	public static final int ID = 22406;

	@Inject
	protected DarionsFaithfulServant2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
