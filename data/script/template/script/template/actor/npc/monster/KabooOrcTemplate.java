 ...
 */
public class KabooOrcTemplate extends MonsterNPCTemplate {
	public static final int ID = 20468;

	@Inject
	protected KabooOrcTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
