 ...
 */
public class TerritoryCatapult5Template extends MonsterNPCTemplate {
	public static final int ID = 36503;

	@Inject
	protected TerritoryCatapult5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
