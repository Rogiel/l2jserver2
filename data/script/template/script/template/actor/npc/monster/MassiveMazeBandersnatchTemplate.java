 ...
 */
public class MassiveMazeBandersnatchTemplate extends MonsterNPCTemplate {
	public static final int ID = 22080;

	@Inject
	protected MassiveMazeBandersnatchTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Massive Maze Bandersnatch";
