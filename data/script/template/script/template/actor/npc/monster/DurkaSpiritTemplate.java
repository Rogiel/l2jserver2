 ...
 */
public class DurkaSpiritTemplate extends MonsterNPCTemplate {
	public static final int ID = 27056;

	@Inject
	protected DurkaSpiritTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Durka Spirit";
