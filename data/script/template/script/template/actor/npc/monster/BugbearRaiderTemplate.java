 ...
 */
public class BugbearRaiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20775;

	@Inject
	protected BugbearRaiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bugbear Raider";
