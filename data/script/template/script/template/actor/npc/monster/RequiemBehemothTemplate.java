 ...
 */
public class RequiemBehemothTemplate extends MonsterNPCTemplate {
	public static final int ID = 21597;

	@Inject
	protected RequiemBehemothTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
