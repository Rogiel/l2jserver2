 ...
 */
public class LilimGuardKnight2Template extends MonsterNPCTemplate {
	public static final int ID = 27370;

	@Inject
	protected LilimGuardKnight2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
