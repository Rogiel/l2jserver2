 ...
 */
public class GhostTemplate extends MonsterNPCTemplate {
	public static final int ID = 20543;

	@Inject
	protected GhostTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
