 ...
 */
public class ServitorOfDarknessTemplate extends MonsterNPCTemplate {
	public static final int ID = 22683;

	@Inject
	protected ServitorOfDarknessTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
