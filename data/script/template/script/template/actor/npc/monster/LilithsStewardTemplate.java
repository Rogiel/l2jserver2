 ...
 */
public class LilithsStewardTemplate extends MonsterNPCTemplate {
	public static final int ID = 27386;

	@Inject
	protected LilithsStewardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lilith's Steward";
