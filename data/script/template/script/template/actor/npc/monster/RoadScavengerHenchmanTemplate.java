 ...
 */
public class RoadScavengerHenchmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 25411;

	@Inject
	protected RoadScavengerHenchmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Road Scavenger Henchman";
