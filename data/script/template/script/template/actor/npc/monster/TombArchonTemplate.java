 ...
 */
public class TombArchonTemplate extends MonsterNPCTemplate {
	public static final int ID = 21246;

	@Inject
	protected TombArchonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tomb Archon";
