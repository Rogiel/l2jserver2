 ...
 */
public class WaterGiantTemplate extends MonsterNPCTemplate {
	public static final int ID = 20798;

	@Inject
	protected WaterGiantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Water Giant";
