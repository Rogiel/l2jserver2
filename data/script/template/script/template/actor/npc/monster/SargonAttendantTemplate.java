 ...
 */
public class SargonAttendantTemplate extends MonsterNPCTemplate {
	public static final int ID = 25561;

	@Inject
	protected SargonAttendantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sargon Attendant";
