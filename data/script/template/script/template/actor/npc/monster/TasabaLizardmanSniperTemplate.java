 ...
 */
public class TasabaLizardmanSniperTemplate extends MonsterNPCTemplate {
	public static final int ID = 21642;

	@Inject
	protected TasabaLizardmanSniperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
