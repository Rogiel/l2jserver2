 ...
 */
public class DeluLizardmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20251;

	@Inject
	protected DeluLizardmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Delu Lizardman";
