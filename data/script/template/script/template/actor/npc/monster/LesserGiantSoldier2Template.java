 ...
 */
public class LesserGiantSoldier2Template extends MonsterNPCTemplate {
	public static final int ID = 22661;

	@Inject
	protected LesserGiantSoldier2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lesser Giant Soldier";
