 ...
 */
public class NephilimBishopTemplate extends MonsterNPCTemplate {
	public static final int ID = 21200;

	@Inject
	protected NephilimBishopTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nephilim Bishop";
