 ...
 */
public class LesserAncientScoutTemplate extends MonsterNPCTemplate {
	public static final int ID = 21162;

	@Inject
	protected LesserAncientScoutTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lesser Ancient Scout";
