 ...
 */
public class MonumentWatcherEzekielTemplate extends MonsterNPCTemplate {
	public static final int ID = 27296;

	@Inject
	protected MonumentWatcherEzekielTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
