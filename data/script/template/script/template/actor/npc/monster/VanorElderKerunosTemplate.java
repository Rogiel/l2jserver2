 ...
 */
public class VanorElderKerunosTemplate extends MonsterNPCTemplate {
	public static final int ID = 27163;

	@Inject
	protected VanorElderKerunosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vanor Elder Kerunos";
