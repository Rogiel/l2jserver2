 ...
 */
public class PapionTemplate extends MonsterNPCTemplate {
	public static final int ID = 18609;

	@Inject
	protected PapionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 10512.777762038200000;
