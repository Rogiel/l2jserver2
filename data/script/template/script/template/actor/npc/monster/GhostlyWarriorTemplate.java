 ...
 */
public class GhostlyWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20955;

	@Inject
	protected GhostlyWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
