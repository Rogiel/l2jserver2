 ...
 */
public class BlockTemplate extends MonsterNPCTemplate {
	public static final int ID = 18671;

	@Inject
	protected BlockTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
