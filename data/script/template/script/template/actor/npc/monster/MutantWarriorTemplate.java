 ...
 */
public class MutantWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 22730;

	@Inject
	protected MutantWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mutant Warrior";
