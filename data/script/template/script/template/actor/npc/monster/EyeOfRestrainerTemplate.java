 ...
 */
public class EyeOfRestrainerTemplate extends MonsterNPCTemplate {
	public static final int ID = 21298;

	@Inject
	protected EyeOfRestrainerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Eye of Restrainer";
