 ...
 */
public class GatekeeperOfFireTemplate extends MonsterNPCTemplate {
	public static final int ID = 22278;

	@Inject
	protected GatekeeperOfFireTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gatekeeper of Fire";
