 ...
 */
public class BloodyMysticTemplate extends MonsterNPCTemplate {
	public static final int ID = 21092;

	@Inject
	protected BloodyMysticTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bloody Mystic";
