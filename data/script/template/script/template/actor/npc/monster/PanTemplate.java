 ...
 */
public class PanTemplate extends MonsterNPCTemplate {
	public static final int ID = 31847;

	@Inject
	protected PanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
