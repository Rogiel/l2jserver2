 ...
 */
public class VarkaSilenosHunterTemplate extends MonsterNPCTemplate {
	public static final int ID = 18639;

	@Inject
	protected VarkaSilenosHunterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
