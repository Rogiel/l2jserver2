 ...
 */
public class RicenseoTemplate extends MonsterNPCTemplate {
	public static final int ID = 20216;

	@Inject
	protected RicenseoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
