 ...
 */
public class CaveBladeSpiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20462;

	@Inject
	protected CaveBladeSpiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cave Blade Spider";
