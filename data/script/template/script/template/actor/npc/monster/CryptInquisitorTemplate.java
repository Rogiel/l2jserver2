 ...
 */
public class CryptInquisitorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21245;

	@Inject
	protected CryptInquisitorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Crypt Inquisitor";
