 ...
 */
public class OfferingOfForbiddenPathBerserker2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18104;

	@Inject
	protected OfferingOfForbiddenPathBerserker2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Offering of Forbidden Path Berserker";
		...
		this.experience = 10912;
		this.sp = 1239;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(305);
		this.leftHand = null;
		this.enchantLevel = 0;
