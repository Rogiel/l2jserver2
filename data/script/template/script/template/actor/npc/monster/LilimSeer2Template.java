 ...
 */
public class LilimSeer2Template extends MonsterNPCTemplate {
	public static final int ID = 27366;

	@Inject
	protected LilimSeer2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
