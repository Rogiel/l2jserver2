 ...
 */
public class FallenAngelTanakiaTemplate extends MonsterNPCTemplate {
	public static final int ID = 27274;

	@Inject
	protected FallenAngelTanakiaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
