 ...
 */
public class ImperialGuard2Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18167;

	@Inject
	protected ImperialGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
