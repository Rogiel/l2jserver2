 ...
 */
public class TwinkPumaTemplate extends MonsterNPCTemplate {
	public static final int ID = 20502;

	@Inject
	protected TwinkPumaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Twink Puma";
