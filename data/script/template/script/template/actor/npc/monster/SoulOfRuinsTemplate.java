 ...
 */
public class SoulOfRuinsTemplate extends MonsterNPCTemplate {
	public static final int ID = 21000;

	@Inject
	protected SoulOfRuinsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Soul of Ruins";
