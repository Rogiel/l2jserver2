 ...
 */
public class RainbowFrogTemplate extends MonsterNPCTemplate {
	public static final int ID = 18866;

	@Inject
	protected RainbowFrogTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rainbow Frog";
