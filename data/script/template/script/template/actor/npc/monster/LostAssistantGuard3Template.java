 ...
 */
public class LostAssistantGuard3Template extends MonsterNPCTemplate {
	public static final int ID = 29134;

	@Inject
	protected LostAssistantGuard3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.mpRegeneration = 9.000000000000000;
		this.experience = 0;
		this.sp = 0;
		...
		attributes.physicalAttack = 355.71819;
