 ...
 */
public class MarshStakatoQueenTemplate extends MonsterNPCTemplate {
	public static final int ID = 20304;

	@Inject
	protected MarshStakatoQueenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Marsh Stakato Queen";
