 ...
 */
public class AlexandroSanchesTemplate extends MonsterNPCTemplate {
	public static final int ID = 27153;

	@Inject
	protected AlexandroSanchesTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Alexandro Sanches";
		this.serverSideName = false;
		this.title = "Dark Lord";
