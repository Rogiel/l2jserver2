 ...
 */
public class OlMahumOfficerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20439;

	@Inject
	protected OlMahumOfficerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ol Mahum Officer";
