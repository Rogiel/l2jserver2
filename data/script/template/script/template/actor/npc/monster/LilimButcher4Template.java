 ...
 */
public class LilimButcher4Template extends MonsterNPCTemplate {
	public static final int ID = 27371;

	@Inject
	protected LilimButcher4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
