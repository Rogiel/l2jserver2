 ...
 */
public class HunterBearTemplate extends MonsterNPCTemplate {
	public static final int ID = 20777;

	@Inject
	protected HunterBearTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hunter Bear";
