 ...
 */
public class GemstoneBeastTemplate extends MonsterNPCTemplate {
	public static final int ID = 20540;

	@Inject
	protected GemstoneBeastTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gemstone Beast";
