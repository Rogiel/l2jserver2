 ...
 */
public class CursedSeer2Template extends MonsterNPCTemplate {
	public static final int ID = 22672;

	@Inject
	protected CursedSeer2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cursed Seer";
