 ...
 */
public class ZakensEliteGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 21625;

	@Inject
	protected ZakensEliteGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Zaken's Elite Guard";
