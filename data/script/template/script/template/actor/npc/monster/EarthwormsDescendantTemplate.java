 ...
 */
public class EarthwormsDescendantTemplate extends MonsterNPCTemplate {
	public static final int ID = 22690;

	@Inject
	protected EarthwormsDescendantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Earthworm's Descendant";
