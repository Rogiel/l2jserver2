 ...
 */
public class SlaughterExecutioner2Template extends MonsterNPCTemplate {
	public static final int ID = 21556;

	@Inject
	protected SlaughterExecutioner2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Slaughter Executioner";
