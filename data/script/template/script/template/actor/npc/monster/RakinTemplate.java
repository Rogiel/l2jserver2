 ...
 */
public class RakinTemplate extends MonsterNPCTemplate {
	public static final int ID = 20604;

	@Inject
	protected RakinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
