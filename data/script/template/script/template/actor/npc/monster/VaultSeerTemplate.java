 ...
 */
public class VaultSeerTemplate extends MonsterNPCTemplate {
	public static final int ID = 21211;

	@Inject
	protected VaultSeerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vault Seer";
