 ...
 */
public class Ornithomimus6Template extends MonsterNPCTemplate {
	public static final int ID = 22742;

	@Inject
	protected Ornithomimus6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ornithomimus";
