 ...
 */
public class TantaLizardmanBerserkerTemplate extends MonsterNPCTemplate {
	public static final int ID = 22771;

	@Inject
	protected TantaLizardmanBerserkerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tanta Lizardman Berserker";
