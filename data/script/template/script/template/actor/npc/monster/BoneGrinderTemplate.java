 ...
 */
public class BoneGrinderTemplate extends MonsterNPCTemplate {
	public static final int ID = 21574;

	@Inject
	protected BoneGrinderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
