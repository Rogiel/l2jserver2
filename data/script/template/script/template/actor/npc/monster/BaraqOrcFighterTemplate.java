 ...
 */
public class BaraqOrcFighterTemplate extends MonsterNPCTemplate {
	public static final int ID = 20372;

	@Inject
	protected BaraqOrcFighterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Baraq Orc Fighter";
