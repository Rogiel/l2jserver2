 ...
 */
public class SilenosTemplate extends MonsterNPCTemplate {
	public static final int ID = 20168;

	@Inject
	protected SilenosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
