 ...
 */
public class SoulOfTreeGuardianTemplate extends MonsterNPCTemplate {
	public static final int ID = 27189;

	@Inject
	protected SoulOfTreeGuardianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Soul of Tree Guardian";
