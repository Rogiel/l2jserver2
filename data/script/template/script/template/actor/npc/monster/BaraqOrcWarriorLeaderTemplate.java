 ...
 */
public class BaraqOrcWarriorLeaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20373;

	@Inject
	protected BaraqOrcWarriorLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Baraq Orc Warrior Leader";
