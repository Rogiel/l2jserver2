 ...
 */
public class OutpostCaptainTemplate extends MonsterNPCTemplate {
	public static final int ID = 18466;

	@Inject
	protected OutpostCaptainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Outpost Captain";
