 ...
 */
public class MerkenisEscortTemplate extends MonsterNPCTemplate {
	public static final int ID = 20367;

	@Inject
	protected MerkenisEscortTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Merkenis Escort";
