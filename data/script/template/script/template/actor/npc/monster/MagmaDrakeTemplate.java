 ...
 */
public class MagmaDrakeTemplate extends MonsterNPCTemplate {
	public static final int ID = 21393;

	@Inject
	protected MagmaDrakeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
