 ...
 */
public class BaarDreVanulDestroyerTemplate extends MonsterNPCTemplate {
	public static final int ID = 21123;

	@Inject
	protected BaarDreVanulDestroyerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Baar Dre Vanul Destroyer";
