 ...
 */
public class EnchantedSpineGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 21131;

	@Inject
	protected EnchantedSpineGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Enchanted Spine Golem";
