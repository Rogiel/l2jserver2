 ...
 */
public class RagnaOrcHero2Template extends MonsterNPCTemplate {
	public static final int ID = 22693;

	@Inject
	protected RagnaOrcHero2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ragna Orc Hero";
