 ...
 */
public class CaveFangSpiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20350;

	@Inject
	protected CaveFangSpiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cave Fang Spider";
