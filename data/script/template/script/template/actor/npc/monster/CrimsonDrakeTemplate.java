 ...
 */
public class CrimsonDrakeTemplate extends MonsterNPCTemplate {
	public static final int ID = 20670;

	@Inject
	protected CrimsonDrakeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Crimson Drake";
