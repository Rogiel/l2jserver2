 ...
 */
public class EliteBgurentTemplate extends MonsterNPCTemplate {
	public static final int ID = 22750;

	@Inject
	protected EliteBgurentTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Elite Bgurent";
