 ...
 */
public class AntTemplate extends MonsterNPCTemplate {
	public static final int ID = 20079;

	@Inject
	protected AntTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
