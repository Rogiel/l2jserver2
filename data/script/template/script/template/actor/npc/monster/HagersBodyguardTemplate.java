 ...
 */
public class HagersBodyguardTemplate extends MonsterNPCTemplate {
	public static final int ID = 25574;

	@Inject
	protected HagersBodyguardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hager's Bodyguard";
