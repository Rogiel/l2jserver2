 ...
 */
public class LichKingIcarusTemplate extends MonsterNPCTemplate {
	public static final int ID = 27265;

	@Inject
	protected LichKingIcarusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lich King Icarus";
