 ...
 */
public class KertangsMessenger5Template extends MonsterNPCTemplate {
	public static final int ID = 22447;

	@Inject
	protected KertangsMessenger5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
