 ...
 */
public class TurekOrcArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20496;

	@Inject
	protected TurekOrcArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Turek Orc Archer";
