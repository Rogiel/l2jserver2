 ...
 */
public class SuperHugePigTemplate extends MonsterNPCTemplate {
	public static final int ID = 13034;

	@Inject
	protected SuperHugePigTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Super Huge Pig";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 29.00;
		this.collisionHeight = 38.70;
		this.level = 80;
