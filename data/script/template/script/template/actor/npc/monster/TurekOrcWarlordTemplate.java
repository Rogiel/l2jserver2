 ...
 */
public class TurekOrcWarlordTemplate extends MonsterNPCTemplate {
	public static final int ID = 20495;

	@Inject
	protected TurekOrcWarlordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Turek Orc Warlord";
