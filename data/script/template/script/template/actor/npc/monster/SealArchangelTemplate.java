 ...
 */
public class SealArchangelTemplate extends MonsterNPCTemplate {
	public static final int ID = 21070;

	@Inject
	protected SealArchangelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Seal Archangel";
