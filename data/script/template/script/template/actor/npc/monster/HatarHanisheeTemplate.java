 ...
 */
public class HatarHanisheeTemplate extends MonsterNPCTemplate {
	public static final int ID = 20663;

	@Inject
	protected HatarHanisheeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hatar Hanishee";
