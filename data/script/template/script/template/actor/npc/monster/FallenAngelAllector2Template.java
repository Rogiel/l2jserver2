 ...
 */
public class FallenAngelAllector2Template extends MonsterNPCTemplate {
	public static final int ID = 27251;

	@Inject
	protected FallenAngelAllector2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fallen Angel Allector";
