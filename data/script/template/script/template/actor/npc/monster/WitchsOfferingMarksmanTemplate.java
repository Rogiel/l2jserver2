 ...
 */
public class WitchsOfferingMarksmanTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18036;

	@Inject
	protected WitchsOfferingMarksmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
