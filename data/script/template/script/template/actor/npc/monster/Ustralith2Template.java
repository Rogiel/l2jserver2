 ...
 */
public class Ustralith2Template extends MonsterNPCTemplate {
	public static final int ID = 21413;

	@Inject
	protected Ustralith2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
