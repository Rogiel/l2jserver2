 ...
 */
public class OfferingOfBrandedBerserker2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18064;

	@Inject
	protected OfferingOfBrandedBerserker2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
