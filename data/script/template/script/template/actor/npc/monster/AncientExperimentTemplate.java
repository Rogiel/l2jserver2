 ...
 */
public class AncientExperimentTemplate extends MonsterNPCTemplate {
	public static final int ID = 18545;

	@Inject
	protected AncientExperimentTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
