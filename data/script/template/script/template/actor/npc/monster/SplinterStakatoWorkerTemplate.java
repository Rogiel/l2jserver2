 ...
 */
public class SplinterStakatoWorkerTemplate extends MonsterNPCTemplate {
	public static final int ID = 21509;

	@Inject
	protected SplinterStakatoWorkerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Splinter Stakato Worker";
