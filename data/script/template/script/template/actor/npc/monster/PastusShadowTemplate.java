 ...
 */
public class PastusShadowTemplate extends MonsterNPCTemplate {
	public static final int ID = 25022;

	@Inject
	protected PastusShadowTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Pastu's Shadow";
		...
		this.attackRange = 40;
		this.maxHP = 4991.851721687510000;
