 ...
 */
public class RatmanSubChieftainTemplate extends MonsterNPCTemplate {
	public static final int ID = 21093;

	@Inject
	protected RatmanSubChieftainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ratman Sub Chieftain";
