 ...
 */
public class VarkaSilenosGreatMagus2Template extends MonsterNPCTemplate {
	public static final int ID = 21365;

	@Inject
	protected VarkaSilenosGreatMagus2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
