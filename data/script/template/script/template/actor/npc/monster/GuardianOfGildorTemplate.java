 ...
 */
public class GuardianOfGildorTemplate extends MonsterNPCTemplate {
	public static final int ID = 25489;

	@Inject
	protected GuardianOfGildorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
