 ...
 */
public class LithGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 21169;

	@Inject
	protected LithGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lith Guard";
