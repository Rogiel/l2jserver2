 ...
 */
public class NihilInvaderTreasureChest2Template extends MonsterNPCTemplate {
	public static final int ID = 18820;

	@Inject
	protected NihilInvaderTreasureChest2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
