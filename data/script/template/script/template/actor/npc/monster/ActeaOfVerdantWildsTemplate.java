 ...
 */
public class ActeaOfVerdantWildsTemplate extends MonsterNPCTemplate {
	public static final int ID = 27121;

	@Inject
	protected ActeaOfVerdantWildsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Actea Of Verdant Wilds";
