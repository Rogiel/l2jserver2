 ...
 */
public class OlMahumRangerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20224;

	@Inject
	protected OlMahumRangerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ol Mahum Ranger";
