 ...
 */
public class DeathFlyer3Template extends MonsterNPCTemplate {
	public static final int ID = 21615;

	@Inject
	protected DeathFlyer3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
