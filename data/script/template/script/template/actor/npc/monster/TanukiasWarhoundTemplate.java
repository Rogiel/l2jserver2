 ...
 */
public class TanukiasWarhoundTemplate extends MonsterNPCTemplate {
	public static final int ID = 27063;

	@Inject
	protected TanukiasWarhoundTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tanukia's Warhound";
