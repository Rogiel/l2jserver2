 ...
 */
public class WailingOfSplendor2Template extends MonsterNPCTemplate {
	public static final int ID = 21540;

	@Inject
	protected WailingOfSplendor2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
