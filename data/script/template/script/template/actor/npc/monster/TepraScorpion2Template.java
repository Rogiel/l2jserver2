 ...
 */
public class TepraScorpion2Template extends MonsterNPCTemplate {
	public static final int ID = 22637;

	@Inject
	protected TepraScorpion2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
