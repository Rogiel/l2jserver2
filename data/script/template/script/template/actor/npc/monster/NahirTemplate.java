 ...
 */
public class NahirTemplate extends MonsterNPCTemplate {
	public static final int ID = 27117;

	@Inject
	protected NahirTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
