 ...
 */
public class SpiritOfWater3Template extends MonsterNPCTemplate {
	public static final int ID = 18613;

	@Inject
	protected SpiritOfWater3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
