 ...
 */
public class NightmareKeeperTemplate extends MonsterNPCTemplate {
	public static final int ID = 20943;

	@Inject
	protected NightmareKeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nightmare Keeper";
