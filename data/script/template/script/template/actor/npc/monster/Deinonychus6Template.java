 ...
 */
public class Deinonychus6Template extends MonsterNPCTemplate {
	public static final int ID = 22743;

	@Inject
	protected Deinonychus6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
