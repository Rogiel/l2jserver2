 ...
 */
public class PerumTemplate extends MonsterNPCTemplate {
	public static final int ID = 20221;

	@Inject
	protected PerumTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
