 ...
 */
public class TrimdenLordTemplate extends MonsterNPCTemplate {
	public static final int ID = 27078;

	@Inject
	protected TrimdenLordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Trimden Lord";
