 ...
 */
public class TriolsPriest3Template extends MonsterNPCTemplate {
	public static final int ID = 22156;

	@Inject
	protected TriolsPriest3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
