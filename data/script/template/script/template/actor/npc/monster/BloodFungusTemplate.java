 ...
 */
public class BloodFungusTemplate extends MonsterNPCTemplate {
	public static final int ID = 20400;

	@Inject
	protected BloodFungusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Blood Fungus";
