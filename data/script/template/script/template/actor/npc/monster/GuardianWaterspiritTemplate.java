 ...
 */
public class GuardianWaterspiritTemplate extends MonsterNPCTemplate {
	public static final int ID = 22659;

	@Inject
	protected GuardianWaterspiritTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guardian Waterspirit";
