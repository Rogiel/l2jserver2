 ...
 */
public class WhiteSkullKanabion3Template extends MonsterNPCTemplate {
	public static final int ID = 22454;

	@Inject
	protected WhiteSkullKanabion3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
