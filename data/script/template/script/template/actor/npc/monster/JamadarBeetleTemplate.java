 ...
 */
public class JamadarBeetleTemplate extends MonsterNPCTemplate {
	public static final int ID = 21433;

	@Inject
	protected JamadarBeetleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Jamadar Beetle";
