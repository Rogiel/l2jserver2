 ...
 */
public class RuinImpTemplate extends MonsterNPCTemplate {
	public static final int ID = 20506;

	@Inject
	protected RuinImpTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
