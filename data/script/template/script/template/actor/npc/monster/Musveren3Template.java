 ...
 */
public class Musveren3Template extends MonsterNPCTemplate {
	public static final int ID = 21621;

	@Inject
	protected Musveren3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
