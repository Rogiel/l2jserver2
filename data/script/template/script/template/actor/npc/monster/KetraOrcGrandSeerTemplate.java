 ...
 */
public class KetraOrcGrandSeerTemplate extends MonsterNPCTemplate {
	public static final int ID = 21342;

	@Inject
	protected KetraOrcGrandSeerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ketra Orc Grand Seer";
