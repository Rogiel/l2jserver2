 ...
 */
public class OlMahumDeserterTemplate extends MonsterNPCTemplate {
	public static final int ID = 20548;

	@Inject
	protected OlMahumDeserterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ol Mahum Deserter";
