 ...
 */
public class HatarRatmanThiefTemplate extends MonsterNPCTemplate {
	public static final int ID = 20661;

	@Inject
	protected HatarRatmanThiefTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hatar Ratman Thief";
