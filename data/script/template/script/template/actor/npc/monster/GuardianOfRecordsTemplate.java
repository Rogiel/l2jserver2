 ...
 */
public class GuardianOfRecordsTemplate extends MonsterNPCTemplate {
	public static final int ID = 18353;

	@Inject
	protected GuardianOfRecordsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guardian of Records";
