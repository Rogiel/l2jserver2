 ...
 */
public class TameTinyBabyCougarTemplate extends MonsterNPCTemplate {
	public static final int ID = 16022;

	@Inject
	protected TameTinyBabyCougarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tame Tiny Baby Cougar";
