 ...
 */
public class BrekaOrcTemplate extends MonsterNPCTemplate {
	public static final int ID = 20267;

	@Inject
	protected BrekaOrcTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
