 ...
 */
public class ForgottenVictimTemplate extends MonsterNPCTemplate {
	public static final int ID = 22141;

	@Inject
	protected ForgottenVictimTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Forgotten Victim";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 11.00;
		this.collisionHeight = 24.60;
		this.level = 78;
