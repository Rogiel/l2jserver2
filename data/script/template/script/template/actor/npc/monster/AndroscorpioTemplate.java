 ...
 */
public class AndroscorpioTemplate extends MonsterNPCTemplate {
	public static final int ID = 20074;

	@Inject
	protected AndroscorpioTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Androscorpio";
