 ...
 */
public class RagnaOrcArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 22031;

	@Inject
	protected RagnaOrcArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
