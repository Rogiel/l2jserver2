 ...
 */
public class LargeCrystalCoreTemplate extends MonsterNPCTemplate {
	public static final int ID = 22553;

	@Inject
	protected LargeCrystalCoreTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Large Crystal Core";
