 ...
 */
public class TalkinsSeerTemplate extends MonsterNPCTemplate {
	public static final int ID = 25135;

	@Inject
	protected TalkinsSeerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Talkin's Seer";
