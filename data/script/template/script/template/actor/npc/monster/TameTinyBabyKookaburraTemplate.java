 ...
 */
public class TameTinyBabyKookaburraTemplate extends MonsterNPCTemplate {
	public static final int ID = 16024;

	@Inject
	protected TameTinyBabyKookaburraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tame Tiny Baby Kookaburra";
