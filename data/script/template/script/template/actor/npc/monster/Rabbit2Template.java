 ...
 */
public class Rabbit2Template extends MonsterNPCTemplate {
	public static final int ID = 20002;

	@Inject
	protected Rabbit2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
