 ...
 */
public class CasterOfDarknessTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18226;

	@Inject
	protected CasterOfDarknessTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
