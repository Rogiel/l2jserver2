 ...
 */
public class UrsusTemplate extends MonsterNPCTemplate {
	public static final int ID = 22096;

	@Inject
	protected UrsusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
