 ...
 */
public class CaveServantArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20237;

	@Inject
	protected CaveServantArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
