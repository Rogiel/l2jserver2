 ...
 */
public class KnightOfDarkness4Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18190;

	@Inject
	protected KnightOfDarkness4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
