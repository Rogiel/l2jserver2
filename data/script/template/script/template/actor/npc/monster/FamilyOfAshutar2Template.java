 ...
 */
public class FamilyOfAshutar2Template extends MonsterNPCTemplate {
	public static final int ID = 25318;

	@Inject
	protected FamilyOfAshutar2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
