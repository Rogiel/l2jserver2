 ...
 */
public class KleoporaTemplate extends MonsterNPCTemplate {
	public static final int ID = 22260;

	@Inject
	protected KleoporaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
