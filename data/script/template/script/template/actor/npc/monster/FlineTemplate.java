 ...
 */
public class FlineTemplate extends MonsterNPCTemplate {
	public static final int ID = 20589;

	@Inject
	protected FlineTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
