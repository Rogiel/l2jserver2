 ...
 */
public class LienrikLad2Template extends MonsterNPCTemplate {
	public static final int ID = 21645;

	@Inject
	protected LienrikLad2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lienrik Lad";
