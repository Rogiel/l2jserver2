 ...
 */
public class OlMahumLegionnaireTemplate extends MonsterNPCTemplate {
	public static final int ID = 20073;

	@Inject
	protected OlMahumLegionnaireTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ol Mahum Legionnaire";
