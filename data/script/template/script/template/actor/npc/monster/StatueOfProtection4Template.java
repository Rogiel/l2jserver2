 ...
 */
public class StatueOfProtection4Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18234;

	@Inject
	protected StatueOfProtection4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
