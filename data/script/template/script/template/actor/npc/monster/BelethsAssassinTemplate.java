 ...
 */
public class BelethsAssassinTemplate extends MonsterNPCTemplate {
	public static final int ID = 22439;

	@Inject
	protected BelethsAssassinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
