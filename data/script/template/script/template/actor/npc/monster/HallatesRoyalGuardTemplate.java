 ...
 */
public class HallatesRoyalGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 20816;

	@Inject
	protected HallatesRoyalGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hallate's Royal Guard";
