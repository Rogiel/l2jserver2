 ...
 */
public class ServitorOfDarkness2Template extends MonsterNPCTemplate {
	public static final int ID = 22684;

	@Inject
	protected ServitorOfDarkness2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
