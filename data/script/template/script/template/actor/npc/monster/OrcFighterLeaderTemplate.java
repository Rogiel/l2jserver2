 ...
 */
public class OrcFighterLeaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20098;

	@Inject
	protected OrcFighterLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Orc Fighter Leader";
