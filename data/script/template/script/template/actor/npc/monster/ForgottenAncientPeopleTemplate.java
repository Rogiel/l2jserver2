 ...
 */
public class ForgottenAncientPeopleTemplate extends MonsterNPCTemplate {
	public static final int ID = 20973;

	@Inject
	protected ForgottenAncientPeopleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Forgotten Ancient People";
