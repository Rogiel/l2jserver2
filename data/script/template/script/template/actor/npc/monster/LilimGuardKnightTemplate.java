 ...
 */
public class LilimGuardKnightTemplate extends MonsterNPCTemplate {
	public static final int ID = 27361;

	@Inject
	protected LilimGuardKnightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lilim Guard Knight";
		...
		attributes.magicalDefense = 149.90176;
