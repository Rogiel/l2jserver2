 ...
 */
public class AndreasCaptainOfTheRoyalGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 22175;

	@Inject
	protected AndreasCaptainOfTheRoyalGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
