 ...
 */
public class MalrukSuccubusTuren2Template extends MonsterNPCTemplate {
	public static final int ID = 20284;

	@Inject
	protected MalrukSuccubusTuren2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Malruk Succubus Turen";
