 ...
 */
public class OfferingOfBrandedWarriorTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18012;

	@Inject
	protected OfferingOfBrandedWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
