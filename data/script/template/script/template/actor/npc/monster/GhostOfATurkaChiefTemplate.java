 ...
 */
public class GhostOfATurkaChiefTemplate extends MonsterNPCTemplate {
	public static final int ID = 22015;

	@Inject
	protected GhostOfATurkaChiefTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
