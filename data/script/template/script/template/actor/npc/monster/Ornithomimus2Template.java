 ...
 */
public class Ornithomimus2Template extends MonsterNPCTemplate {
	public static final int ID = 22201;

	@Inject
	protected Ornithomimus2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
