 ...
 */
public class GuardsOfTheDawnOracle4Template extends MonsterNPCTemplate {
	public static final int ID = 27350;

	@Inject
	protected GuardsOfTheDawnOracle4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guards of the Dawn Oracle";
