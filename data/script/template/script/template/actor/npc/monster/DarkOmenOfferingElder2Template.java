 ...
 */
public class DarkOmenOfferingElder2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18089;

	@Inject
	protected DarkOmenOfferingElder2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Omen Offering Elder";
