 ...
 */
public class HallatesInspectorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20825;

	@Inject
	protected HallatesInspectorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hallate's Inspector";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 31.00;
		this.collisionHeight = 110.00;
		this.level = 68;
