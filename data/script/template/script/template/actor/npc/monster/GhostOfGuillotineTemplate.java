 ...
 */
public class GhostOfGuillotineTemplate extends MonsterNPCTemplate {
	public static final int ID = 21576;

	@Inject
	protected GhostOfGuillotineTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
