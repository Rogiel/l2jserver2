 ...
 */
public class LavastoneGolem2Template extends MonsterNPCTemplate {
	public static final int ID = 22642;

	@Inject
	protected LavastoneGolem2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
