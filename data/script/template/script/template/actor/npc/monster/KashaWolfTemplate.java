 ...
 */
public class KashaWolfTemplate extends MonsterNPCTemplate {
	public static final int ID = 20475;

	@Inject
	protected KashaWolfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kasha Wolf";
