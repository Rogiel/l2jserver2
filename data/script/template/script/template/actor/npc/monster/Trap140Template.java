 ...
 */
public class Trap140Template extends MonsterNPCTemplate {
	public static final int ID = 18697;

	@Inject
	protected Trap140Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
