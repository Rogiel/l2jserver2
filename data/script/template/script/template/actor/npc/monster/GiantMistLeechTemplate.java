 ...
 */
public class GiantMistLeechTemplate extends MonsterNPCTemplate {
	public static final int ID = 20225;

	@Inject
	protected GiantMistLeechTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Giant Mist Leech";
