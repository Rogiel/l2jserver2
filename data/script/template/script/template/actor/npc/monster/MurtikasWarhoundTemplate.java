 ...
 */
public class MurtikasWarhoundTemplate extends MonsterNPCTemplate {
	public static final int ID = 27069;

	@Inject
	protected MurtikasWarhoundTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Murtika's Warhound";
