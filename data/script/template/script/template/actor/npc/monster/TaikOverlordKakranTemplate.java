 ...
 */
public class TaikOverlordKakranTemplate extends MonsterNPCTemplate {
	public static final int ID = 27161;

	@Inject
	protected TaikOverlordKakranTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Taik Overlord Kakran";
