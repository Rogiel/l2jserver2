 ...
 */
public class HallowedMonkTemplate extends MonsterNPCTemplate {
	public static final int ID = 21213;

	@Inject
	protected HallowedMonkTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hallowed Monk";
