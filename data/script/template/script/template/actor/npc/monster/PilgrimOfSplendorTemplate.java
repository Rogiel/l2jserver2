 ...
 */
public class PilgrimOfSplendorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21541;

	@Inject
	protected PilgrimOfSplendorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Pilgrim of Splendor";
