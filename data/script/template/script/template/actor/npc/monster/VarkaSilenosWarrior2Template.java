 ...
 */
public class VarkaSilenosWarrior2Template extends MonsterNPCTemplate {
	public static final int ID = 21358;

	@Inject
	protected VarkaSilenosWarrior2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
