 ...
 */
public class EliteBrakianTemplate extends MonsterNPCTemplate {
	public static final int ID = 22751;

	@Inject
	protected EliteBrakianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Elite Brakian";
