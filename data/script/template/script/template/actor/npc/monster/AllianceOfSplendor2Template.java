 ...
 */
public class AllianceOfSplendor2Template extends MonsterNPCTemplate {
	public static final int ID = 21534;

	@Inject
	protected AllianceOfSplendor2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
