 ...
 */
public class DragonBomber3Template extends MonsterNPCTemplate {
	public static final int ID = 29071;

	@Inject
	protected DragonBomber3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
