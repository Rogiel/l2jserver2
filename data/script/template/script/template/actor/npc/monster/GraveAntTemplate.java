 ...
 */
public class GraveAntTemplate extends MonsterNPCTemplate {
	public static final int ID = 21648;

	@Inject
	protected GraveAntTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
