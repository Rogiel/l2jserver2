 ...
 */
public class WeirdDrakeTemplate extends MonsterNPCTemplate {
	public static final int ID = 20605;

	@Inject
	protected WeirdDrakeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Weird Drake";
