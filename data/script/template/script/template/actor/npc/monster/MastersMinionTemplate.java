 ...
 */
public class MastersMinionTemplate extends MonsterNPCTemplate {
	public static final int ID = 22378;

	@Inject
	protected MastersMinionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
