 ...
 */
public class ImperialGravekeeperTemplate extends MonsterNPCTemplate {
	public static final int ID = 27181;

	@Inject
	protected ImperialGravekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Imperial Gravekeeper";
