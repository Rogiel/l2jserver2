 ...
 */
public class EyeOfWatchmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 21302;

	@Inject
	protected EyeOfWatchmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Eye of Watchman";
