 ...
 */
public class PinrulTemplate extends MonsterNPCTemplate {
	public static final int ID = 20032;

	@Inject
	protected PinrulTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
