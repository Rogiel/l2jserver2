 ...
 */
public class TamlinOrcTemplate extends MonsterNPCTemplate {
	public static final int ID = 20601;

	@Inject
	protected TamlinOrcTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tamlin Orc";
