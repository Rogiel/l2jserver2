 ...
 */
public class ApostatesOfferingSaint2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18078;

	@Inject
	protected ApostatesOfferingSaint2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Apostate's Offering Saint";
