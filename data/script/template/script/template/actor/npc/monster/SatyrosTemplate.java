 ...
 */
public class SatyrosTemplate extends MonsterNPCTemplate {
	public static final int ID = 31846;

	@Inject
	protected SatyrosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
