 ...
 */
public class AtekasGruntTemplate extends MonsterNPCTemplate {
	public static final int ID = 25210;

	@Inject
	protected AtekasGruntTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ateka's Grunt";
