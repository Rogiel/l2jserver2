 ...
 */
public class SentinelOfWater2Template extends MonsterNPCTemplate {
	public static final int ID = 20617;

	@Inject
	protected SentinelOfWater2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sentinel Of Water";
