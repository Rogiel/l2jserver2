 ...
 */
public class HallKeeperWizardTemplate extends MonsterNPCTemplate {
	public static final int ID = 18330;

	@Inject
	protected HallKeeperWizardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hall Keeper Wizard";
