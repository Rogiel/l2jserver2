 ...
 */
public class RuinBatTemplate extends MonsterNPCTemplate {
	public static final int ID = 20505;

	@Inject
	protected RuinBatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
