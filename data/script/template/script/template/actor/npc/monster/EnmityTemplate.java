 ...
 */
public class EnmityTemplate extends MonsterNPCTemplate {
	public static final int ID = 25537;

	@Inject
	protected EnmityTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 34551.489728592800000;
