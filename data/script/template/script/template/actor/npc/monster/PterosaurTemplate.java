 ...
 */
public class PterosaurTemplate extends MonsterNPCTemplate {
	public static final int ID = 22199;

	@Inject
	protected PterosaurTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
