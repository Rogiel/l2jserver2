 ...
 */
public class ScoutOfHekatonTemplate extends MonsterNPCTemplate {
	public static final int ID = 25300;

	@Inject
	protected ScoutOfHekatonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Scout of Hekaton";
