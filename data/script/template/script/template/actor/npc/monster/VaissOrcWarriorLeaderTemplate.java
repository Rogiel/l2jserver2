 ...
 */
public class VaissOrcWarriorLeaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20382;

	@Inject
	protected VaissOrcWarriorLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vaiss Orc Warrior Leader";
