 ...
 */
public class PeerlessKanabionTemplate extends MonsterNPCTemplate {
	public static final int ID = 22470;

	@Inject
	protected PeerlessKanabionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.rightHand = itemProvider.createID(7888);
		this.leftHand = null;
		this.enchantLevel = 0;
