 ...
 */
public class YoungKeltirTemplate extends MonsterNPCTemplate {
	public static final int ID = 20545;

	@Inject
	protected YoungKeltirTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Young Keltir";
