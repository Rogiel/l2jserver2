 ...
 */
public class BeastLordTemplate extends MonsterNPCTemplate {
	public static final int ID = 21058;

	@Inject
	protected BeastLordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Beast Lord";
