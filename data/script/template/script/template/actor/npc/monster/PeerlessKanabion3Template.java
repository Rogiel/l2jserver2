 ...
 */
public class PeerlessKanabion3Template extends MonsterNPCTemplate {
	public static final int ID = 22472;

	@Inject
	protected PeerlessKanabion3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
