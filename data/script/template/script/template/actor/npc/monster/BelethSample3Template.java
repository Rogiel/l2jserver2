 ...
 */
public class BelethSample3Template extends MonsterNPCTemplate {
	public static final int ID = 18373;

	@Inject
	protected BelethSample3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
