 ...
 */
public class VukuOrcFighterTemplate extends MonsterNPCTemplate {
	public static final int ID = 20017;

	@Inject
	protected VukuOrcFighterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vuku Orc Fighter";
