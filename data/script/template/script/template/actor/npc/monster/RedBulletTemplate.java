 ...
 */
public class RedBulletTemplate extends MonsterNPCTemplate {
	public static final int ID = 31015;

	@Inject
	protected RedBulletTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Red Bullet";
