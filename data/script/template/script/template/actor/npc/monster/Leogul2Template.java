 ...
 */
public class Leogul2Template extends MonsterNPCTemplate {
	public static final int ID = 22669;

	@Inject
	protected Leogul2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
