 ...
 */
public class TeraBeetle2Template extends MonsterNPCTemplate {
	public static final int ID = 21405;

	@Inject
	protected TeraBeetle2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tera Beetle";
