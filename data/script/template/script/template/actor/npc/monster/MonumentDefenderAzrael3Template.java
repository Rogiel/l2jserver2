 ...
 */
public class MonumentDefenderAzrael3Template extends MonsterNPCTemplate {
	public static final int ID = 27304;

	@Inject
	protected MonumentDefenderAzrael3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Monument Defender Azrael";
