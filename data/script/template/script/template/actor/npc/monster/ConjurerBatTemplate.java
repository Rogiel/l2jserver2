 ...
 */
public class ConjurerBatTemplate extends MonsterNPCTemplate {
	public static final int ID = 20774;

	@Inject
	protected ConjurerBatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Conjurer Bat";
