 ...
 */
public class Tyrannosaurus2Template extends MonsterNPCTemplate {
	public static final int ID = 22216;

	@Inject
	protected Tyrannosaurus2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
