 ...
 */
public class CannibalisticStakatoFollower2Template extends MonsterNPCTemplate {
	public static final int ID = 22624;

	@Inject
	protected CannibalisticStakatoFollower2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cannibalistic Stakato Follower";
