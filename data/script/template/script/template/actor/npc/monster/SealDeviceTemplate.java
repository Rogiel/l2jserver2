 ...
 */
public class SealDeviceTemplate extends MonsterNPCTemplate {
	public static final int ID = 27384;

	@Inject
	protected SealDeviceTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Seal Device";
		this.serverSideName = false;
		this.title = "Emperor Shunaiman's";
