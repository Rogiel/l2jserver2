 ...
 */
public class AssassinOfDarkness2Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18223;

	@Inject
	protected AssassinOfDarkness2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
