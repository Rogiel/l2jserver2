 ...
 */
public class TerritoryCatapult6Template extends MonsterNPCTemplate {
	public static final int ID = 36504;

	@Inject
	protected TerritoryCatapult6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
