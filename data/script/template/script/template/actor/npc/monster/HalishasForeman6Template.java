 ...
 */
public class HalishasForeman6Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18178;

	@Inject
	protected HalishasForeman6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
