 ...
 */
public class BloodyAxeAideTemplate extends MonsterNPCTemplate {
	public static final int ID = 27392;

	@Inject
	protected BloodyAxeAideTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bloody Axe Aide";
