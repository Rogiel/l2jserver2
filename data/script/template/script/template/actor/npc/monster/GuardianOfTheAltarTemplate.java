 ...
 */
public class GuardianOfTheAltarTemplate extends MonsterNPCTemplate {
	public static final int ID = 18811;

	@Inject
	protected GuardianOfTheAltarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guardian of the Altar";
