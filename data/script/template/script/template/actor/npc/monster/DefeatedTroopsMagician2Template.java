 ...
 */
public class DefeatedTroopsMagician2Template extends MonsterNPCTemplate {
	public static final int ID = 22564;

	@Inject
	protected DefeatedTroopsMagician2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
