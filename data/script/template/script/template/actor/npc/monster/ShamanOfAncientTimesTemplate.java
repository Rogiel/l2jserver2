 ...
 */
public class ShamanOfAncientTimesTemplate extends MonsterNPCTemplate {
	public static final int ID = 20972;

	@Inject
	protected ShamanOfAncientTimesTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shaman of Ancient Times";
