 ...
 */
public class WhinstoneGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 20521;

	@Inject
	protected WhinstoneGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Whinstone Golem";
