 ...
 */
public class StoneGiantTemplate extends MonsterNPCTemplate {
	public static final int ID = 20378;

	@Inject
	protected StoneGiantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
