 ...
 */
public class OgreTemplate extends MonsterNPCTemplate {
	public static final int ID = 20162;

	@Inject
	protected OgreTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
