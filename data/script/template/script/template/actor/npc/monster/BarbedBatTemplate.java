 ...
 */
public class BarbedBatTemplate extends MonsterNPCTemplate {
	public static final int ID = 20370;

	@Inject
	protected BarbedBatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Barbed Bat";
