 ...
 */
public class ShamanOfThePlainsTemplate extends MonsterNPCTemplate {
	public static final int ID = 20764;

	@Inject
	protected ShamanOfThePlainsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shaman of the Plains";
