 ...
 */
public class CalpicosGoonsTemplate extends MonsterNPCTemplate {
	public static final int ID = 27037;

	@Inject
	protected CalpicosGoonsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Calpico's Goons";
