 ...
 */
public class FallenAngelNarcissusTemplate extends MonsterNPCTemplate {
	public static final int ID = 27280;

	@Inject
	protected FallenAngelNarcissusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fallen Angel Narcissus";
