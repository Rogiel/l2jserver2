 ...
 */
public class DecayedAncientPikemanTemplate extends MonsterNPCTemplate {
	public static final int ID = 21149;

	@Inject
	protected DecayedAncientPikemanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Decayed Ancient Pikeman";
