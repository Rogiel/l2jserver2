 ...
 */
public class LostBeholder8Template extends MonsterNPCTemplate {
	public static final int ID = 25708;

	@Inject
	protected LostBeholder8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
