 ...
 */
public class PirateCaptainUthankaTemplate extends MonsterNPCTemplate {
	public static final int ID = 20520;

	@Inject
	protected PirateCaptainUthankaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Pirate Captain Uthanka";
