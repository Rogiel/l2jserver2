 ...
 */
public class JudgeOfSplendorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21544;

	@Inject
	protected JudgeOfSplendorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Judge of Splendor";
