 ...
 */
public class SkeletonArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20100;

	@Inject
	protected SkeletonArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
