 ...
 */
public class Victim2Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18151;

	@Inject
	protected Victim2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
