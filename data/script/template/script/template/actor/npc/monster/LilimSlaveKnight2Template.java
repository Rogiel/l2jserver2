 ...
 */
public class LilimSlaveKnight2Template extends MonsterNPCTemplate {
	public static final int ID = 27364;

	@Inject
	protected LilimSlaveKnight2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
