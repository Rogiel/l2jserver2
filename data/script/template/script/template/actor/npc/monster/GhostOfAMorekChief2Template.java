 ...
 */
public class GhostOfAMorekChief2Template extends MonsterNPCTemplate {
	public static final int ID = 22014;

	@Inject
	protected GhostOfAMorekChief2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ghost of a Morek Chief";
