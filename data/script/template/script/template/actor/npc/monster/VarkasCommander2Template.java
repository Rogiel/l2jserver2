 ...
 */
public class VarkasCommander2Template extends MonsterNPCTemplate {
	public static final int ID = 21369;

	@Inject
	protected VarkasCommander2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
