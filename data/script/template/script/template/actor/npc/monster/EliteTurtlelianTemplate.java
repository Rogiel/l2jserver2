 ...
 */
public class EliteTurtlelianTemplate extends MonsterNPCTemplate {
	public static final int ID = 22757;

	@Inject
	protected EliteTurtlelianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Elite Turtlelian";
