 ...
 */
public class NightmareWeaverTemplate extends MonsterNPCTemplate {
	public static final int ID = 20338;

	@Inject
	protected NightmareWeaverTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nightmare Weaver";
