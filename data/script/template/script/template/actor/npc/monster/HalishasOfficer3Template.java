 ...
 */
public class HalishasOfficer3Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18122;

	@Inject
	protected HalishasOfficer3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
