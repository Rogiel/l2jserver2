 ...
 */
public class HekatonCottusTemplate extends MonsterNPCTemplate {
	public static final int ID = 25141;

	@Inject
	protected HekatonCottusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 6982.68629;
		attributes.magicalAttack = 9405.35312;
