 ...
 */
public class SkeletonHunterArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20518;

	@Inject
	protected SkeletonHunterArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Skeleton Hunter Archer";
