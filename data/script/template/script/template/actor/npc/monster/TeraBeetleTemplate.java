 ...
 */
public class TeraBeetleTemplate extends MonsterNPCTemplate {
	public static final int ID = 21404;

	@Inject
	protected TeraBeetleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
