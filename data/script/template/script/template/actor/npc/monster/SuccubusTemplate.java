 ...
 */
public class SuccubusTemplate extends MonsterNPCTemplate {
	public static final int ID = 20166;

	@Inject
	protected SuccubusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
