 ...
 */
public class BlindHuntsmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 22324;

	@Inject
	protected BlindHuntsmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Blind Huntsman";
