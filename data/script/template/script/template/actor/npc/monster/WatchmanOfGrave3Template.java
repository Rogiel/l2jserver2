 ...
 */
public class WatchmanOfGrave3Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18246;

	@Inject
	protected WatchmanOfGrave3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
