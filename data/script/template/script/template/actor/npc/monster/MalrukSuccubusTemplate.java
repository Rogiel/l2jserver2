 ...
 */
public class MalrukSuccubusTemplate extends MonsterNPCTemplate {
	public static final int ID = 20244;

	@Inject
	protected MalrukSuccubusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
