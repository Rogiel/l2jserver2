 ...
 */
public class DemonKingTemplate extends MonsterNPCTemplate {
	public static final int ID = 27137;

	@Inject
	protected DemonKingTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Demon King";
