 ...
 */
public class KabooOrcArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20469;

	@Inject
	protected KabooOrcArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kaboo Orc Archer";
