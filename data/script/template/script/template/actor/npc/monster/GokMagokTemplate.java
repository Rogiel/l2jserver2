 ...
 */
public class GokMagokTemplate extends MonsterNPCTemplate {
	public static final int ID = 27160;

	@Inject
	protected GokMagokTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gok Magok";
		this.serverSideName = false;
		this.title = "Grandis Chief";
