 ...
 */
public class Lilith2Template extends MonsterNPCTemplate {
	public static final int ID = 27385;

	@Inject
	protected Lilith2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lilith";
		this.serverSideName = false;
		this.title = "Holy Mother of Abyss";
