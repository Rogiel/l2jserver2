 ...
 */
public class KetraOrcRaiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 21327;

	@Inject
	protected KetraOrcRaiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ketra Orc Raider";
