 ...
 */
public class SpiritOfSirHerodTemplate extends MonsterNPCTemplate {
	public static final int ID = 27119;

	@Inject
	protected SpiritOfSirHerodTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Spirit of Sir Herod";
