 ...
 */
public class KerinnesIfritTemplate extends MonsterNPCTemplate {
	public static final int ID = 29031;

	@Inject
	protected KerinnesIfritTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kerinne's Ifrit";
		...
		this.attackRange = 40;
		this.maxHP = 20648.928000000000000;
		this.maxMP = 1607.808000000000000;
		this.hpRegeneration = 33.792000000000000;
