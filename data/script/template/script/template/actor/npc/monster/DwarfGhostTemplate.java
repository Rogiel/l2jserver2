 ...
 */
public class DwarfGhostTemplate extends MonsterNPCTemplate {
	public static final int ID = 20354;

	@Inject
	protected DwarfGhostTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dwarf Ghost";
