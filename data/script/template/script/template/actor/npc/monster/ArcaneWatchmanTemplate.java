 ...
 */
public class ArcaneWatchmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 22329;

	@Inject
	protected ArcaneWatchmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Arcane Watchman";
