 ...
 */
public class KetrasHeadGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 21346;

	@Inject
	protected KetrasHeadGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ketra's Head Guard";
