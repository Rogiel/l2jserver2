 ...
 */
public class NephilimCenturionTemplate extends MonsterNPCTemplate {
	public static final int ID = 21201;

	@Inject
	protected NephilimCenturionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nephilim Centurion";
