 ...
 */
public class OfferingOfBrandedFollowerTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18013;

	@Inject
	protected OfferingOfBrandedFollowerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
