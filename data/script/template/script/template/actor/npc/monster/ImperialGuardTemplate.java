 ...
 */
public class ImperialGuardTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18166;

	@Inject
	protected ImperialGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
