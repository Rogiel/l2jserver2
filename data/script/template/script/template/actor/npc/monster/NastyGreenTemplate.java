 ...
 */
public class NastyGreenTemplate extends MonsterNPCTemplate {
	public static final int ID = 31020;

	@Inject
	protected NastyGreenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nasty Green";
