 ...
 */
public class BrownBearTemplate extends MonsterNPCTemplate {
	public static final int ID = 20310;

	@Inject
	protected BrownBearTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
