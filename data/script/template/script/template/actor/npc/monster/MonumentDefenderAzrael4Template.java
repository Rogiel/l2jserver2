 ...
 */
public class MonumentDefenderAzrael4Template extends MonsterNPCTemplate {
	public static final int ID = 27305;

	@Inject
	protected MonumentDefenderAzrael4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
