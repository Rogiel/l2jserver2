 ...
 */
public class GigantOverseerTemplate extends MonsterNPCTemplate {
	public static final int ID = 21189;

	@Inject
	protected GigantOverseerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gigant Overseer";
		...
		this.rightHand = itemProvider.createID(5792);
		this.leftHand = null;
		this.enchantLevel = 0;
