 ...
 */
public class YoungPrairieKeltirTemplate extends MonsterNPCTemplate {
	public static final int ID = 20531;

	@Inject
	protected YoungPrairieKeltirTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Young Prairie Keltir";
		...
		attributes.magicalDefense = 29.59162;
