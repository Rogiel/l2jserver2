 ...
 */
public class GhastlyWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20811;

	@Inject
	protected GhastlyWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ghastly Warrior";
