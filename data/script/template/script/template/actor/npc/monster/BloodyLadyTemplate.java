 ...
 */
public class BloodyLadyTemplate extends MonsterNPCTemplate {
	public static final int ID = 21084;

	@Inject
	protected BloodyLadyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bloody Lady";
