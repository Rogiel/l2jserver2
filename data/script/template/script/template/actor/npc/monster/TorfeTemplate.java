 ...
 */
public class TorfeTemplate extends MonsterNPCTemplate {
	public static final int ID = 20222;

	@Inject
	protected TorfeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
