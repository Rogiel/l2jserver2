 ...
 */
public class KratorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20217;

	@Inject
	protected KratorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
