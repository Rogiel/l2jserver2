 ...
 */
public class FanaticShamanTemplate extends MonsterNPCTemplate {
	public static final int ID = 25156;

	@Inject
	protected FanaticShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fanatic Shaman";
		...
		attributes.physicalAttack = 1096.87417;
		attributes.magicalAttack = 426.43539;
