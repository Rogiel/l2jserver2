 ...
 */
public class TameTinyBabyBuffaloTemplate extends MonsterNPCTemplate {
	public static final int ID = 16020;

	@Inject
	protected TameTinyBabyBuffaloTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tame Tiny Baby Buffalo";
