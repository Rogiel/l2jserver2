 ...
 */
public class DarkChoirLancerTemplate extends MonsterNPCTemplate {
	public static final int ID = 18336;

	@Inject
	protected DarkChoirLancerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Choir Lancer";
