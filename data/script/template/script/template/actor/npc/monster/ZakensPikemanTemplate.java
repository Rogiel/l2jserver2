 ...
 */
public class ZakensPikemanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20832;

	@Inject
	protected ZakensPikemanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
