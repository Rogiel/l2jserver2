 ...
 */
public class StoneGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 20016;

	@Inject
	protected StoneGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
