 ...
 */
public class OfferingOfForbiddenPathTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18050;

	@Inject
	protected OfferingOfForbiddenPathTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
