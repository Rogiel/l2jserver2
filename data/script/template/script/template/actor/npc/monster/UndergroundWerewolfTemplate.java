 ...
 */
public class UndergroundWerewolfTemplate extends MonsterNPCTemplate {
	public static final int ID = 21256;

	@Inject
	protected UndergroundWerewolfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Underground Werewolf";
