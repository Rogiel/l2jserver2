 ...
 */
public class MarshStakatoMarquessTemplate extends MonsterNPCTemplate {
	public static final int ID = 27152;

	@Inject
	protected MarshStakatoMarquessTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Marsh Stakato Marquess";
