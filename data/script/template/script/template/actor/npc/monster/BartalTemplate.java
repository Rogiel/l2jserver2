 ...
 */
public class BartalTemplate extends MonsterNPCTemplate {
	public static final int ID = 20948;

	@Inject
	protected BartalTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
