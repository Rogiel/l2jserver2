 ...
 */
public class SpikedStakatoWorkerTemplate extends MonsterNPCTemplate {
	public static final int ID = 22106;

	@Inject
	protected SpikedStakatoWorkerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
