 ...
 */
public class EnkuOrcShamanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20292;

	@Inject
	protected EnkuOrcShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Enku Orc Shaman";
