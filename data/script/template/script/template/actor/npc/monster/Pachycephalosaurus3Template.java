 ...
 */
public class Pachycephalosaurus3Template extends MonsterNPCTemplate {
	public static final int ID = 22210;

	@Inject
	protected Pachycephalosaurus3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
