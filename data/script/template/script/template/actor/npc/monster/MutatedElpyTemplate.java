 ...
 */
public class MutatedElpyTemplate extends MonsterNPCTemplate {
	public static final int ID = 25604;

	@Inject
	protected MutatedElpyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mutated Elpy";
		this.serverSideName = false;
		this.title = "Naia's Creature";
