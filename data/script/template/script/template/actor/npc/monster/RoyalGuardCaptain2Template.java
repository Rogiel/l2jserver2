 ...
 */
public class RoyalGuardCaptain2Template extends MonsterNPCTemplate {
	public static final int ID = 22570;

	@Inject
	protected RoyalGuardCaptain2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
