 ...
 */
public class AncientExperiment2Template extends MonsterNPCTemplate {
	public static final int ID = 18546;

	@Inject
	protected AncientExperiment2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
