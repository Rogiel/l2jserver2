 ...
 */
public class RitualSacrificeTemplate extends MonsterNPCTemplate {
	public static final int ID = 22145;

	@Inject
	protected RitualSacrificeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
