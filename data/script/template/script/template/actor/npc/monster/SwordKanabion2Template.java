 ...
 */
public class SwordKanabion2Template extends MonsterNPCTemplate {
	public static final int ID = 22483;

	@Inject
	protected SwordKanabion2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
