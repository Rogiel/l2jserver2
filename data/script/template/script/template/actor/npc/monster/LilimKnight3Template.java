 ...
 */
public class LilimKnight3Template extends MonsterNPCTemplate {
	public static final int ID = 27358;

	@Inject
	protected LilimKnight3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lilim Knight";
