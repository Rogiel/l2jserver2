 ...
 */
public class CarinkainTemplate extends MonsterNPCTemplate {
	public static final int ID = 20635;

	@Inject
	protected CarinkainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
