 ...
 */
public class KelMahumWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20854;

	@Inject
	protected KelMahumWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kel Mahum Warrior";
