 ...
 */
public class LithOverlordTemplate extends MonsterNPCTemplate {
	public static final int ID = 21171;

	@Inject
	protected LithOverlordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lith Overlord";
