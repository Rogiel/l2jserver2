 ...
 */
public class DarkstoneGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 20346;

	@Inject
	protected DarkstoneGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Darkstone Golem";
