 ...
 */
public class AncientSwordMasterIronTemplate extends MonsterNPCTemplate {
	public static final int ID = 27289;

	@Inject
	protected AncientSwordMasterIronTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ancient Sword Master Iron";
