 ...
 */
public class TrampledManTemplate extends MonsterNPCTemplate {
	public static final int ID = 21553;

	@Inject
	protected TrampledManTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
