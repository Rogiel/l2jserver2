 ...
 */
public class PitchstoneGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 20511;

	@Inject
	protected PitchstoneGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Pitchstone Golem";
