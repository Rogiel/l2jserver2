 ...
 */
public class RangosIrisTemplate extends MonsterNPCTemplate {
	public static final int ID = 25576;

	@Inject
	protected RangosIrisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rango's Iris";
