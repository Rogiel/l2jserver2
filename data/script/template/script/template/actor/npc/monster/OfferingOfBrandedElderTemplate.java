 ...
 */
public class OfferingOfBrandedElderTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18009;

	@Inject
	protected OfferingOfBrandedElderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
