 ...
 */
public class KabooOrcFighterLieutenantTemplate extends MonsterNPCTemplate {
	public static final int ID = 20473;

	@Inject
	protected KabooOrcFighterLieutenantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kaboo Orc Fighter Lieutenant";
