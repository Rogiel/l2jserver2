 ...
 */
public class OrcSniperTemplate extends MonsterNPCTemplate {
	public static final int ID = 27001;

	@Inject
	protected OrcSniperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Orc Sniper";
