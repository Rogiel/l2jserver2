 ...
 */
public class RatmanChieftainTemplate extends MonsterNPCTemplate {
	public static final int ID = 21094;

	@Inject
	protected RatmanChieftainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ratman Chieftain";
