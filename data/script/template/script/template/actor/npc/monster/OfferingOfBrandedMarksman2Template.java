 ...
 */
public class OfferingOfBrandedMarksman2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18066;

	@Inject
	protected OfferingOfBrandedMarksman2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Offering of Branded Marksman";
		...
		attributes.physicalAttack = 235.89919;
