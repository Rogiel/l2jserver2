 ...
 */
public class GreenDryadTemplate extends MonsterNPCTemplate {
	public static final int ID = 20336;

	@Inject
	protected GreenDryadTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Green Dryad";
