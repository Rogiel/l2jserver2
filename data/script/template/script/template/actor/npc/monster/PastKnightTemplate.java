 ...
 */
public class PastKnightTemplate extends MonsterNPCTemplate {
	public static final int ID = 20956;

	@Inject
	protected PastKnightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Past Knight";
