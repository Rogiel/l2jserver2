 ...
 */
public class ElderPrairieKeltirTemplate extends MonsterNPCTemplate {
	public static final int ID = 20538;

	@Inject
	protected ElderPrairieKeltirTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Elder Prairie Keltir";
