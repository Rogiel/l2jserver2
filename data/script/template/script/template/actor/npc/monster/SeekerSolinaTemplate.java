 ...
 */
public class SeekerSolinaTemplate extends MonsterNPCTemplate {
	public static final int ID = 22790;

	@Inject
	protected SeekerSolinaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Seeker Solina";
