 ...
 */
public class KeropeWerewolfChiefTemplate extends MonsterNPCTemplate {
	public static final int ID = 21129;

	@Inject
	protected KeropeWerewolfChiefTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kerope Werewolf Chief";
