 ...
 */
public class RemnantWraithTemplate extends MonsterNPCTemplate {
	public static final int ID = 22330;

	@Inject
	protected RemnantWraithTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Remnant Wraith";
