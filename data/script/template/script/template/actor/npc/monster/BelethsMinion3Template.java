 ...
 */
public class BelethsMinion3Template extends MonsterNPCTemplate {
	public static final int ID = 22274;

	@Inject
	protected BelethsMinion3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
