 ...
 */
public class MarakuWerewolfTemplate extends MonsterNPCTemplate {
	public static final int ID = 20363;

	@Inject
	protected MarakuWerewolfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Maraku Werewolf";
