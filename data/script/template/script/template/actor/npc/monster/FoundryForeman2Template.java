 ...
 */
public class FoundryForeman2Template extends MonsterNPCTemplate {
	public static final int ID = 22397;

	@Inject
	protected FoundryForeman2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
