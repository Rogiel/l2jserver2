 ...
 */
public class RagnaOrcSorcerer3Template extends MonsterNPCTemplate {
	public static final int ID = 22043;

	@Inject
	protected RagnaOrcSorcerer3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ragna Orc Sorcerer";
