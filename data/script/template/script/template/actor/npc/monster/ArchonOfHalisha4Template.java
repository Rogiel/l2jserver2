 ...
 */
public class ArchonOfHalisha4Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18215;

	@Inject
	protected ArchonOfHalisha4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
