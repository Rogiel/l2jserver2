 ...
 */
public class KelMahumTemplate extends MonsterNPCTemplate {
	public static final int ID = 20853;

	@Inject
	protected KelMahumTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
