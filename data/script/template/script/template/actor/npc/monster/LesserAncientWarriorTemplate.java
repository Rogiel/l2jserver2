 ...
 */
public class LesserAncientWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21165;

	@Inject
	protected LesserAncientWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lesser Ancient Warrior";
