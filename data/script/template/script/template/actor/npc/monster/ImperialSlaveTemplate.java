 ...
 */
public class ImperialSlaveTemplate extends MonsterNPCTemplate {
	public static final int ID = 27180;

	@Inject
	protected ImperialSlaveTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Imperial Slave";
