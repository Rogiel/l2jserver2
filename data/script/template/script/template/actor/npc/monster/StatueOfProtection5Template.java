 ...
 */
public class StatueOfProtection5Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18235;

	@Inject
	protected StatueOfProtection5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
