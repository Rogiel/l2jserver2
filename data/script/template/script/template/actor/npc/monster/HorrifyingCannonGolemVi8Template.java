 ...
 */
public class HorrifyingCannonGolemVi8Template extends MonsterNPCTemplate {
	public static final int ID = 22073;

	@Inject
	protected HorrifyingCannonGolemVi8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
