 ...
 */
public class BoneGrinder2Template extends MonsterNPCTemplate {
	public static final int ID = 21575;

	@Inject
	protected BoneGrinder2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bone Grinder";
		...
		attributes.magicalDefense = 197.02420;
