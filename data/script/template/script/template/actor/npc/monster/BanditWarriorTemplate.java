 ...
 */
public class BanditWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 22023;

	@Inject
	protected BanditWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bandit Warrior";
