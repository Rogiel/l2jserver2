 ...
 */
public class SerpentDemonKadeshTemplate extends MonsterNPCTemplate {
	public static final int ID = 27090;

	@Inject
	protected SerpentDemonKadeshTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Serpent Demon Kadesh";
		...
		attributes.magicalDefense = 117.58598;
