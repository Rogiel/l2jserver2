 ...
 */
public class WhiteDragonLeaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 22540;

	@Inject
	protected WhiteDragonLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
