 ...
 */
public class FollowerOfMontagnarTemplate extends MonsterNPCTemplate {
	public static final int ID = 18569;

	@Inject
	protected FollowerOfMontagnarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Follower of Montagnar";
