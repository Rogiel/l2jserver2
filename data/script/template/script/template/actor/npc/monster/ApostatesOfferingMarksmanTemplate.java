 ...
 */
public class ApostatesOfferingMarksmanTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18026;

	@Inject
	protected ApostatesOfferingMarksmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
