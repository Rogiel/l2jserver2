 ...
 */
public class DeadmansGrudge4Template extends MonsterNPCTemplate {
	public static final int ID = 18627;

	@Inject
	protected DeadmansGrudge4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Deadman's Grudge";
