 ...
 */
public class FrostBuffaloTemplate extends MonsterNPCTemplate {
	public static final int ID = 22094;

	@Inject
	protected FrostBuffaloTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Frost Buffalo";
