 ...
 */
public class AshurasOfDestruction3Template extends MonsterNPCTemplate {
	public static final int ID = 22646;

	@Inject
	protected AshurasOfDestruction3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
