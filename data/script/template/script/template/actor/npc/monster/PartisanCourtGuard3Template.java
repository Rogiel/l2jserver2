 ...
 */
public class PartisanCourtGuard3Template extends MonsterNPCTemplate {
	public static final int ID = 35377;

	@Inject
	protected PartisanCourtGuard3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Partisan Court Guard";
