 ...
 */
public class KetraOrcLieutenantTemplate extends MonsterNPCTemplate {
	public static final int ID = 21332;

	@Inject
	protected KetraOrcLieutenantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ketra Orc Lieutenant";
