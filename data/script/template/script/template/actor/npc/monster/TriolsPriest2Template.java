 ...
 */
public class TriolsPriest2Template extends MonsterNPCTemplate {
	public static final int ID = 22151;

	@Inject
	protected TriolsPriest2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
