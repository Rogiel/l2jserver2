 ...
 */
public class MutantTreasureChestTemplate extends MonsterNPCTemplate {
	public static final int ID = 18822;

	@Inject
	protected MutantTreasureChestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
