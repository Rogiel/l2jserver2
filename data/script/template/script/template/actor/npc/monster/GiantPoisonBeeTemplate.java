 ...
 */
public class GiantPoisonBeeTemplate extends MonsterNPCTemplate {
	public static final int ID = 21095;

	@Inject
	protected GiantPoisonBeeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Giant Poison Bee";
