 ...
 */
public class SilhouetteTilfoTemplate extends MonsterNPCTemplate {
	public static final int ID = 27107;

	@Inject
	protected SilhouetteTilfoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Silhouette Tilfo";
