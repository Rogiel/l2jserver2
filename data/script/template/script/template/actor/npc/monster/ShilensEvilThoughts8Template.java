 ...
 */
public class ShilensEvilThoughts8Template extends MonsterNPCTemplate {
	public static final int ID = 27375;

	@Inject
	protected ShilensEvilThoughts8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
