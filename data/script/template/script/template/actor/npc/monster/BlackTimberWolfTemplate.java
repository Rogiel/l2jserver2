 ...
 */
public class BlackTimberWolfTemplate extends MonsterNPCTemplate {
	public static final int ID = 20318;

	@Inject
	protected BlackTimberWolfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Black Timber Wolf";
