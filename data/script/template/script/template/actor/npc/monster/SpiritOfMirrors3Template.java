 ...
 */
public class SpiritOfMirrors3Template extends MonsterNPCTemplate {
	public static final int ID = 27005;

	@Inject
	protected SpiritOfMirrors3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
