 ...
 */
public class ArchonOfHalishaTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18212;

	@Inject
	protected ArchonOfHalishaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
