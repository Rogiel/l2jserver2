 ...
 */
public class ElementalOfFlameTemplate extends MonsterNPCTemplate {
	public static final int ID = 25432;

	@Inject
	protected ElementalOfFlameTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Elemental of Flame";
