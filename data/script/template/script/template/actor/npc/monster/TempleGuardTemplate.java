 ...
 */
public class TempleGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 22152;

	@Inject
	protected TempleGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Temple Guard";
