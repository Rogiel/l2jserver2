 ...
 */
public class RoyalStraightTemplate extends MonsterNPCTemplate {
	public static final int ID = 31018;

	@Inject
	protected RoyalStraightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Royal Straight";
