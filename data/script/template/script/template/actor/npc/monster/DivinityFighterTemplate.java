 ...
 */
public class DivinityFighterTemplate extends MonsterNPCTemplate {
	public static final int ID = 22799;

	@Inject
	protected DivinityFighterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Divinity Fighter";
