 ...
 */
public class GoldenStagLordTemplate extends MonsterNPCTemplate {
	public static final int ID = 20850;

	@Inject
	protected GoldenStagLordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Golden Stag Lord";
