 ...
 */
public class SuppliesSafe7Template extends MonsterNPCTemplate {
	public static final int ID = 36597;

	@Inject
	protected SuppliesSafe7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
