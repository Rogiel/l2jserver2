 ...
 */
public class MutantAssassinTemplate extends MonsterNPCTemplate {
	public static final int ID = 22734;

	@Inject
	protected MutantAssassinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mutant Assassin";
