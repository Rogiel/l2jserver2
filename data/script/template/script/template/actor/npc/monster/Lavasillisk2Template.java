 ...
 */
public class Lavasillisk2Template extends MonsterNPCTemplate {
	public static final int ID = 22647;

	@Inject
	protected Lavasillisk2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lavasillisk";
