 ...
 */
public class HotSpringsNepenthesTemplate extends MonsterNPCTemplate {
	public static final int ID = 21319;

	@Inject
	protected HotSpringsNepenthesTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hot Springs Nepenthes";
