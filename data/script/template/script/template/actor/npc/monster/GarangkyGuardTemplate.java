 ...
 */
public class GarangkyGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 25466;

	@Inject
	protected GarangkyGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Garangky Guard";
