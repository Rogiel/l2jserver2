 ...
 */
public class KatenarsGatekeeperTemplate extends MonsterNPCTemplate {
	public static final int ID = 18360;

	@Inject
	protected KatenarsGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Katenar's Gatekeeper";
