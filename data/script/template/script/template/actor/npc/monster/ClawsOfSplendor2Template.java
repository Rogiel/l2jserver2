 ...
 */
public class ClawsOfSplendor2Template extends MonsterNPCTemplate {
	public static final int ID = 21522;

	@Inject
	protected ClawsOfSplendor2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
