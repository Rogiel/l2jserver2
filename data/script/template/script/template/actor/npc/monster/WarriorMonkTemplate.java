 ...
 */
public class WarriorMonkTemplate extends MonsterNPCTemplate {
	public static final int ID = 22129;

	@Inject
	protected WarriorMonkTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Warrior Monk";
		...
		this.experience = 35775;
		this.sp = 4012;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(8211);
		...
		attributes.magicalDefense = 273.65464;
