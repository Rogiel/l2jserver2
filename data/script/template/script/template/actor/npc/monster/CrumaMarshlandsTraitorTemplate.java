 ...
 */
public class CrumaMarshlandsTraitorTemplate extends MonsterNPCTemplate {
	public static final int ID = 27339;

	@Inject
	protected CrumaMarshlandsTraitorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cruma Marshlands Traitor";
