 ...
 */
public class TanorSilenosShamanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20940;

	@Inject
	protected TanorSilenosShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tanor Silenos Shaman";
