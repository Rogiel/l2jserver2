 ...
 */
public class FallenOrcShaman2Template extends MonsterNPCTemplate {
	public static final int ID = 21258;

	@Inject
	protected FallenOrcShaman2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
