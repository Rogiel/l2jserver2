 ...
 */
public class FieldStalkerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20512;

	@Inject
	protected FieldStalkerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Field Stalker";
