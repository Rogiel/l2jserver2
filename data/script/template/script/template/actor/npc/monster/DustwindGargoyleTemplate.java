 ...
 */
public class DustwindGargoyleTemplate extends MonsterNPCTemplate {
	public static final int ID = 20242;

	@Inject
	protected DustwindGargoyleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
