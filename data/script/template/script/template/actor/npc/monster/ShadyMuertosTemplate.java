 ...
 */
public class ShadyMuertosTemplate extends MonsterNPCTemplate {
	public static final int ID = 22248;

	@Inject
	protected ShadyMuertosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shady Muertos";
