 ...
 */
public class SavageKanabion2Template extends MonsterNPCTemplate {
	public static final int ID = 22468;

	@Inject
	protected SavageKanabion2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
