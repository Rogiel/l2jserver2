 ...
 */
public class GrazingBandersnatchTemplate extends MonsterNPCTemplate {
	public static final int ID = 21359;

	@Inject
	protected GrazingBandersnatchTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grazing Bandersnatch";
