 ...
 */
public class VarkaSilenosFootmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 18636;

	@Inject
	protected VarkaSilenosFootmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Varka Silenos Footman";
