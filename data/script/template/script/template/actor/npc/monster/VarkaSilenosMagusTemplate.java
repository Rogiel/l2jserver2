 ...
 */
public class VarkaSilenosMagusTemplate extends MonsterNPCTemplate {
	public static final int ID = 18645;

	@Inject
	protected VarkaSilenosMagusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Varka Silenos Magus";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 11.00;
		this.collisionHeight = 55.20;
		this.level = 73;
