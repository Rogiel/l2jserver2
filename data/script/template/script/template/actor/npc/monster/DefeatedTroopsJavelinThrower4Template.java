 ...
 */
public class DefeatedTroopsJavelinThrower4Template extends MonsterNPCTemplate {
	public static final int ID = 22568;

	@Inject
	protected DefeatedTroopsJavelinThrower4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Defeated Troops Javelin Thrower";
