 ...
 */
public class BonaparteriusTemplate extends MonsterNPCTemplate {
	public static final int ID = 27154;

	@Inject
	protected BonaparteriusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bonaparterius";
		this.serverSideName = false;
		this.title = "Abyss King";
