 ...
 */
public class LizardmanScoutTemplate extends MonsterNPCTemplate {
	public static final int ID = 27033;

	@Inject
	protected LizardmanScoutTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lizardman Scout";
