 ...
 */
public class BabyPantheraTemplate extends MonsterNPCTemplate {
	public static final int ID = 22083;

	@Inject
	protected BabyPantheraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Baby Panthera";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 29.00;
		this.collisionHeight = 22.70;
		this.level = 55;
