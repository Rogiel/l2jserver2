 ...
 */
public class GalaxyExpressTemplate extends MonsterNPCTemplate {
	public static final int ID = 31024;

	@Inject
	protected GalaxyExpressTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Galaxy Express";
