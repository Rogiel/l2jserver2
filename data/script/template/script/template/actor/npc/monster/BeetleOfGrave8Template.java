 ...
 */
public class BeetleOfGrave8Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18148;

	@Inject
	protected BeetleOfGrave8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
