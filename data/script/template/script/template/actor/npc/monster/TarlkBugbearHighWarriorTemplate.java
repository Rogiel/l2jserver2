 ...
 */
public class TarlkBugbearHighWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20572;

	@Inject
	protected TarlkBugbearHighWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tarlk Bugbear High Warrior";
