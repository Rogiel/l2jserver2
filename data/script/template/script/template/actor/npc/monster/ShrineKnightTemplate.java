 ...
 */
public class ShrineKnightTemplate extends MonsterNPCTemplate {
	public static final int ID = 21650;

	@Inject
	protected ShrineKnightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shrine Knight";
