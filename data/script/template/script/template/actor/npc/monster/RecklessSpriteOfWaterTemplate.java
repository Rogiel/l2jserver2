 ...
 */
public class RecklessSpriteOfWaterTemplate extends MonsterNPCTemplate {
	public static final int ID = 27380;

	@Inject
	protected RecklessSpriteOfWaterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Reckless Sprite of Water";
