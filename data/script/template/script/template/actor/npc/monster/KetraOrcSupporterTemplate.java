 ...
 */
public class KetraOrcSupporterTemplate extends MonsterNPCTemplate {
	public static final int ID = 32502;

	@Inject
	protected KetraOrcSupporterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ketra Orc Supporter";
