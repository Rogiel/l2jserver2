 ...
 */
public class CaveAntLarvaTemplate extends MonsterNPCTemplate {
	public static final int ID = 21265;

	@Inject
	protected CaveAntLarvaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
