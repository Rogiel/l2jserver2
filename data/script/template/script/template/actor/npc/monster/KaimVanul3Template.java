 ...
 */
public class KaimVanul3Template extends MonsterNPCTemplate {
	public static final int ID = 21627;

	@Inject
	protected KaimVanul3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
