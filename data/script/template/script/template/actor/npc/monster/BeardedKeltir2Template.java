 ...
 */
public class BeardedKeltir2Template extends MonsterNPCTemplate {
	public static final int ID = 20481;

	@Inject
	protected BeardedKeltir2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
