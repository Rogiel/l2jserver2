 ...
 */
public class CallousKanabion3Template extends MonsterNPCTemplate {
	public static final int ID = 22466;

	@Inject
	protected CallousKanabion3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Callous Kanabion";
