 ...
 */
public class AllianceOfSplendorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21533;

	@Inject
	protected AllianceOfSplendorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Alliance of Splendor";
		...
		this.experience = 9320;
		this.sp = 866;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(196);
		this.leftHand = null;
		this.enchantLevel = 0;
