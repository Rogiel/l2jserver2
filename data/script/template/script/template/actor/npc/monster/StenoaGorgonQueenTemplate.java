 ...
 */
public class StenoaGorgonQueenTemplate extends MonsterNPCTemplate {
	public static final int ID = 27108;

	@Inject
	protected StenoaGorgonQueenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Stenoa Gorgon Queen";
