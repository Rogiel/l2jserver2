 ...
 */
public class BeetleOfGrave5Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18145;

	@Inject
	protected BeetleOfGrave5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
