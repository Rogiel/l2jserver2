 ...
 */
public class EmissaryOfDeath3Template extends MonsterNPCTemplate {
	public static final int ID = 22526;

	@Inject
	protected EmissaryOfDeath3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
