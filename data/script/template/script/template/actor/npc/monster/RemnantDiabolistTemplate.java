 ...
 */
public class RemnantDiabolistTemplate extends MonsterNPCTemplate {
	public static final int ID = 18463;

	@Inject
	protected RemnantDiabolistTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Remnant Diabolist";
