 ...
 */
public class PhantomsOfTheMineTemplate extends MonsterNPCTemplate {
	public static final int ID = 22687;

	@Inject
	protected PhantomsOfTheMineTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Phantoms of the Mine";
