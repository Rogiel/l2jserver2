 ...
 */
public class TepraScarab2Template extends MonsterNPCTemplate {
	public static final int ID = 22638;

	@Inject
	protected TepraScarab2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tepra Scarab";
