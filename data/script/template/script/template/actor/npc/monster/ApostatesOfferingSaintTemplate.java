 ...
 */
public class ApostatesOfferingSaintTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18028;

	@Inject
	protected ApostatesOfferingSaintTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
