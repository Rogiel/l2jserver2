 ...
 */
public class Pachycephalosaurus2Template extends MonsterNPCTemplate {
	public static final int ID = 22209;

	@Inject
	protected Pachycephalosaurus2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
