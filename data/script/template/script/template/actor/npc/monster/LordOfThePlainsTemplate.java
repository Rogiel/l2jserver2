 ...
 */
public class LordOfThePlainsTemplate extends MonsterNPCTemplate {
	public static final int ID = 20763;

	@Inject
	protected LordOfThePlainsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lord of the Plains";
