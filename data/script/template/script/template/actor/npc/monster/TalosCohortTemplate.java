 ...
 */
public class TalosCohortTemplate extends MonsterNPCTemplate {
	public static final int ID = 25430;

	@Inject
	protected TalosCohortTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Talos' Cohort";
