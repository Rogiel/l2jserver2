 ...
 */
public class KashaSpiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20474;

	@Inject
	protected KashaSpiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kasha Spider";
