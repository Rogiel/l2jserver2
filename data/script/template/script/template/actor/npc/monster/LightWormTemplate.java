 ...
 */
public class LightWormTemplate extends MonsterNPCTemplate {
	public static final int ID = 20849;

	@Inject
	protected LightWormTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Light Worm";
