 ...
 */
public class OrcFighterTemplate extends MonsterNPCTemplate {
	public static final int ID = 20093;

	@Inject
	protected OrcFighterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
