 ...
 */
public class TaikOrcSupplyLeaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20669;

	@Inject
	protected TaikOrcSupplyLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Taik Orc Supply Leader";
