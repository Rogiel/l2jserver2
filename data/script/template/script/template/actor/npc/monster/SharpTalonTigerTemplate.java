 ...
 */
public class SharpTalonTigerTemplate extends MonsterNPCTemplate {
	public static final int ID = 21021;

	@Inject
	protected SharpTalonTigerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sharp Talon Tiger";
