 ...
 */
public class AnakimsGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 27390;

	@Inject
	protected AnakimsGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
