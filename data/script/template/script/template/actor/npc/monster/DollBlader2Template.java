 ...
 */
public class DollBlader2Template extends MonsterNPCTemplate {
	public static final int ID = 20846;

	@Inject
	protected DollBlader2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
