 ...
 */
public class LesserBasiliskTemplate extends MonsterNPCTemplate {
	public static final int ID = 20070;

	@Inject
	protected LesserBasiliskTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lesser Basilisk";
