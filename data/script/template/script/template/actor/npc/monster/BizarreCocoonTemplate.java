 ...
 */
public class BizarreCocoonTemplate extends MonsterNPCTemplate {
	public static final int ID = 18793;

	@Inject
	protected BizarreCocoonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
