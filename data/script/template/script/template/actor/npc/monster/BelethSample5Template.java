 ...
 */
public class BelethSample5Template extends MonsterNPCTemplate {
	public static final int ID = 18375;

	@Inject
	protected BelethSample5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
