 ...
 */
public class MaleSpikedStakatoTemplate extends MonsterNPCTemplate {
	public static final int ID = 22109;

	@Inject
	protected MaleSpikedStakatoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
