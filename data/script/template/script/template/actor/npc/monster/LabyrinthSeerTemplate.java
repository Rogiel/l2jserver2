 ...
 */
public class LabyrinthSeerTemplate extends MonsterNPCTemplate {
	public static final int ID = 22369;

	@Inject
	protected LabyrinthSeerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Labyrinth Seer";
