 ...
 */
public class SkeletonHunterTemplate extends MonsterNPCTemplate {
	public static final int ID = 20517;

	@Inject
	protected SkeletonHunterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Skeleton Hunter";
