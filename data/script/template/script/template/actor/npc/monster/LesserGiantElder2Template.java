 ...
 */
public class LesserGiantElder2Template extends MonsterNPCTemplate {
	public static final int ID = 22665;

	@Inject
	protected LesserGiantElder2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lesser Giant Elder";
