 ...
 */
public class BladeBatTemplate extends MonsterNPCTemplate {
	public static final int ID = 20480;

	@Inject
	protected BladeBatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
