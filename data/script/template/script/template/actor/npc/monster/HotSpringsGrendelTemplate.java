 ...
 */
public class HotSpringsGrendelTemplate extends MonsterNPCTemplate {
	public static final int ID = 21323;

	@Inject
	protected HotSpringsGrendelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hot Springs Grendel";
