 ...
 */
public class MutantTreasureChest2Template extends MonsterNPCTemplate {
	public static final int ID = 18823;

	@Inject
	protected MutantTreasureChest2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mutant Treasure Chest";
