 ...
 */
public class DryadTemplate extends MonsterNPCTemplate {
	public static final int ID = 20013;

	@Inject
	protected DryadTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
