 ...
 */
public class OfferingOfBrandedSaintTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18018;

	@Inject
	protected OfferingOfBrandedSaintTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
