 ...
 */
public class KnightOfDestructionTemplate extends MonsterNPCTemplate {
	public static final int ID = 21383;

	@Inject
	protected KnightOfDestructionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
