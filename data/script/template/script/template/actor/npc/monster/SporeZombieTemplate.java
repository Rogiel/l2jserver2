 ...
 */
public class SporeZombieTemplate extends MonsterNPCTemplate {
	public static final int ID = 20562;

	@Inject
	protected SporeZombieTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
