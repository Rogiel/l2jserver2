 ...
 */
public class ShadowOfHalisha4Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 25349;

	@Inject
	protected ShadowOfHalisha4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
