 ...
 */
public class PicotAraneidTemplate extends MonsterNPCTemplate {
	public static final int ID = 27322;

	@Inject
	protected PicotAraneidTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Picot Araneid";
