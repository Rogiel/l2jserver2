 ...
 */
public class SeluLizardmanScoutTemplate extends MonsterNPCTemplate {
	public static final int ID = 20069;

	@Inject
	protected SeluLizardmanScoutTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Selu Lizardman Scout";
