 ...
 */
public class VukuOrcTemplate extends MonsterNPCTemplate {
	public static final int ID = 20009;

	@Inject
	protected VukuOrcTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
