 ...
 */
public class CrumaPhantom4Template extends MonsterNPCTemplate {
	public static final int ID = 18553;

	@Inject
	protected CrumaPhantom4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
