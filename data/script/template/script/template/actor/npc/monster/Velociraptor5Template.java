 ...
 */
public class Velociraptor5Template extends MonsterNPCTemplate {
	public static final int ID = 22223;

	@Inject
	protected Velociraptor5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
