 ...
 */
public class SpikeStakatoNurse2Template extends MonsterNPCTemplate {
	public static final int ID = 22631;

	@Inject
	protected SpikeStakatoNurse2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
