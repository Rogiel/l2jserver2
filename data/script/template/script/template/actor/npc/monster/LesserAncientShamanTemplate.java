 ...
 */
public class LesserAncientShamanTemplate extends MonsterNPCTemplate {
	public static final int ID = 21163;

	@Inject
	protected LesserAncientShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lesser Ancient Shaman";
