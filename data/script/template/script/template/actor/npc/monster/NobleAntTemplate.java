 ...
 */
public class NobleAntTemplate extends MonsterNPCTemplate {
	public static final int ID = 20089;

	@Inject
	protected NobleAntTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
