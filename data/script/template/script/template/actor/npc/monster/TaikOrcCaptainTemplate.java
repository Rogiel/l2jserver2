 ...
 */
public class TaikOrcCaptainTemplate extends MonsterNPCTemplate {
	public static final int ID = 20634;

	@Inject
	protected TaikOrcCaptainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Taik Orc Captain";
		...
		this.experience = 7065;
		this.sp = 484;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(75);
		this.leftHand = itemProvider.createID(104);
		this.enchantLevel = 0;
