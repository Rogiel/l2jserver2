 ...
 */
public class TaikOrcSupplyTemplate extends MonsterNPCTemplate {
	public static final int ID = 20665;

	@Inject
	protected TaikOrcSupplyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Taik Orc Supply";
