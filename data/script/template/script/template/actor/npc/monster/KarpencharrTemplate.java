 ...
 */
public class KarpencharrTemplate extends MonsterNPCTemplate {
	public static final int ID = 25637;

	@Inject
	protected KarpencharrTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Karpencharr";
		this.serverSideName = false;
		this.title = "Prophet of Lies";
