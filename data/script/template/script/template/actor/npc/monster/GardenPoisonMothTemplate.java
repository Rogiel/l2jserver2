 ...
 */
public class GardenPoisonMothTemplate extends MonsterNPCTemplate {
	public static final int ID = 22314;

	@Inject
	protected GardenPoisonMothTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Garden Poison Moth";
