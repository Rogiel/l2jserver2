 ...
 */
public class ThunderWyrm2Template extends MonsterNPCTemplate {
	public static final int ID = 20282;

	@Inject
	protected ThunderWyrm2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Thunder Wyrm";
