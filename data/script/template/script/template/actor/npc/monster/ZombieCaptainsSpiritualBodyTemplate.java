 ...
 */
public class ZombieCaptainsSpiritualBodyTemplate extends MonsterNPCTemplate {
	public static final int ID = 21631;

	@Inject
	protected ZombieCaptainsSpiritualBodyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Zombie Captain's Spiritual Body";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 20.00;
		this.collisionHeight = 33.60;
		this.level = 52;
