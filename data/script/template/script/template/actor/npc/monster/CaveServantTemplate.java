 ...
 */
public class CaveServantTemplate extends MonsterNPCTemplate {
	public static final int ID = 20236;

	@Inject
	protected CaveServantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
