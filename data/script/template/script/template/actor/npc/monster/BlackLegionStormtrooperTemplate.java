 ...
 */
public class BlackLegionStormtrooperTemplate extends MonsterNPCTemplate {
	public static final int ID = 27150;

	@Inject
	protected BlackLegionStormtrooperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Black Legion Stormtrooper";
