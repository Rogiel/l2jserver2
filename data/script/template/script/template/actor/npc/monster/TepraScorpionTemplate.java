 ...
 */
public class TepraScorpionTemplate extends MonsterNPCTemplate {
	public static final int ID = 21379;

	@Inject
	protected TepraScorpionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tepra Scorpion";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 24.00;
		this.collisionHeight = 52.80;
		this.level = 78;
