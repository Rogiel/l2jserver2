 ...
 */
public class NecromancerOfDestruction2Template extends MonsterNPCTemplate {
	public static final int ID = 21654;

	@Inject
	protected NecromancerOfDestruction2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Necromancer of Destruction";
		...
		attributes.magicalDefense = 239.18092;
