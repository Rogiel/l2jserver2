 ...
 */
public class WitchsOfferingBerserker2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18084;

	@Inject
	protected WitchsOfferingBerserker2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Witch's Offering Berserker";
		...
		this.experience = 5790;
		this.sp = 495;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(301);
		this.leftHand = null;
		this.enchantLevel = 0;
		...
		attributes.magicalDefense = 147.09282;
		attributes.attackSpeed = 253;
		attributes.castSpeed = 333;
		attributes.criticalChance = 4;
		attributes.walkSpeed = 52.00000;
		attributes.runSpeed = 125.00000;
	}
}
