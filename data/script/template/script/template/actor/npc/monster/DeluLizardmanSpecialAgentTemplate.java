 ...
 */
public class DeluLizardmanSpecialAgentTemplate extends MonsterNPCTemplate {
	public static final int ID = 21105;

	@Inject
	protected DeluLizardmanSpecialAgentTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Delu Lizardman Special Agent";
