 ...
 */
public class GiantSpiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20103;

	@Inject
	protected GiantSpiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
