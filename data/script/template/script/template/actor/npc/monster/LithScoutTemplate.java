 ...
 */
public class LithScoutTemplate extends MonsterNPCTemplate {
	public static final int ID = 21166;

	@Inject
	protected LithScoutTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lith Scout";
