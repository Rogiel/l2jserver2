 ...
 */
public class CannibalisticStakatoLeaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 22113;

	@Inject
	protected CannibalisticStakatoLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
