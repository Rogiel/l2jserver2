 ...
 */
public class DiscipleOfProphetTemplate extends MonsterNPCTemplate {
	public static final int ID = 18658;

	@Inject
	protected DiscipleOfProphetTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
