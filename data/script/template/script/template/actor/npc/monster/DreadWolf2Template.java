 ...
 */
public class DreadWolf2Template extends MonsterNPCTemplate {
	public static final int ID = 21638;

	@Inject
	protected DreadWolf2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dread Wolf";
