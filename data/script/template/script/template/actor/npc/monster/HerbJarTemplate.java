 ...
 */
public class HerbJarTemplate extends MonsterNPCTemplate {
	public static final int ID = 18478;

	@Inject
	protected HerbJarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
