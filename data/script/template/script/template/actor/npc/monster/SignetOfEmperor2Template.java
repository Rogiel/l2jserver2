 ...
 */
public class SignetOfEmperor2Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18230;

	@Inject
	protected SignetOfEmperor2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Signet of Emperor";
		...
		this.hpRegeneration = 26.163000000000000;
		this.mpRegeneration = 3.070200000000000;
		this.experience = 22486;
		this.sp = 2553;
