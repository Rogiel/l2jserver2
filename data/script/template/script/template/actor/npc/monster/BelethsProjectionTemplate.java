 ...
 */
public class BelethsProjectionTemplate extends MonsterNPCTemplate {
	public static final int ID = 22395;

	@Inject
	protected BelethsProjectionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Beleth's Projection";
