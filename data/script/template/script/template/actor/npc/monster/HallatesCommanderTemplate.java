 ...
 */
public class HallatesCommanderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20824;

	@Inject
	protected HallatesCommanderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hallate's Commander";
