 ...
 */
public class SkeletonPikemanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20519;

	@Inject
	protected SkeletonPikemanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Skeleton Pikeman";
