 ...
 */
public class WitchsOfferingZealotTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18035;

	@Inject
	protected WitchsOfferingZealotTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
