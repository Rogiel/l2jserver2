 ...
 */
public class FanaticsOfRahhaTemplate extends MonsterNPCTemplate {
	public static final int ID = 25053;

	@Inject
	protected FanaticsOfRahhaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fanatics of Rahha";
		...
		this.attackRange = 40;
		this.maxHP = 26989.445611047200000;
