 ...
 */
public class WildStriderTemplate extends MonsterNPCTemplate {
	public static final int ID = 22211;

	@Inject
	protected WildStriderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
