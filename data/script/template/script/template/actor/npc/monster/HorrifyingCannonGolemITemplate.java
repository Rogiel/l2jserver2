 ...
 */
public class HorrifyingCannonGolemITemplate extends MonsterNPCTemplate {
	public static final int ID = 22053;

	@Inject
	protected HorrifyingCannonGolemITemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Horrifying Cannon Golem I";
