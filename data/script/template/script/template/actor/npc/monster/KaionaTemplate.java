 ...
 */
public class KaionaTemplate extends MonsterNPCTemplate {
	public static final int ID = 22762;

	@Inject
	protected KaionaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
