 ...
 */
public class GatekeeperOfTheSquareTemplate extends MonsterNPCTemplate {
	public static final int ID = 22276;

	@Inject
	protected GatekeeperOfTheSquareTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gatekeeper of the Square";
