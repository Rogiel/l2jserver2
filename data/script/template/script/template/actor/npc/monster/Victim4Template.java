 ...
 */
public class Victim4Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18153;

	@Inject
	protected Victim4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
