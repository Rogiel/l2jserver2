 ...
 */
public class GhostOfRebellionSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 21571;

	@Inject
	protected GhostOfRebellionSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ghost of Rebellion Soldier";
