 ...
 */
public class CryptHorrorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20491;

	@Inject
	protected CryptHorrorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Crypt Horror";
