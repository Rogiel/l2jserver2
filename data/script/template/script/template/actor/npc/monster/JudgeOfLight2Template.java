 ...
 */
public class JudgeOfLight2Template extends MonsterNPCTemplate {
	public static final int ID = 22132;

	@Inject
	protected JudgeOfLight2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
