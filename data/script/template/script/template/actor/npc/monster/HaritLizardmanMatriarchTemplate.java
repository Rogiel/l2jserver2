 ...
 */
public class HaritLizardmanMatriarchTemplate extends MonsterNPCTemplate {
	public static final int ID = 20645;

	@Inject
	protected HaritLizardmanMatriarchTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Harit Lizardman Matriarch";
