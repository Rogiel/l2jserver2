 ...
 */
public class CannibalisticStakatoLeader2Template extends MonsterNPCTemplate {
	public static final int ID = 22114;

	@Inject
	protected CannibalisticStakatoLeader2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
