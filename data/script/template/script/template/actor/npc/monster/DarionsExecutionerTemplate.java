 ...
 */
public class DarionsExecutionerTemplate extends MonsterNPCTemplate {
	public static final int ID = 22343;

	@Inject
	protected DarionsExecutionerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Darion's Executioner";
