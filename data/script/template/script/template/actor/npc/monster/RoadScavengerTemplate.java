 ...
 */
public class RoadScavengerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20551;

	@Inject
	protected RoadScavengerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Road Scavenger";
