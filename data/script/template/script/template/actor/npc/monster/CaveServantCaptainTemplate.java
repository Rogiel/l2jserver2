 ...
 */
public class CaveServantCaptainTemplate extends MonsterNPCTemplate {
	public static final int ID = 20239;

	@Inject
	protected CaveServantCaptainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cave Servant Captain";
