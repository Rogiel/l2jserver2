 ...
 */
public class BelethsDevoteeTemplate extends MonsterNPCTemplate {
	public static final int ID = 22394;

	@Inject
	protected BelethsDevoteeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
