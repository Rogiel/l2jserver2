 ...
 */
public class VisionGuardianShakiel2Template extends MonsterNPCTemplate {
	public static final int ID = 27314;

	@Inject
	protected VisionGuardianShakiel2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vision Guardian Shakiel";
