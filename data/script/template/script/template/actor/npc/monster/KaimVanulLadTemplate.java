 ...
 */
public class KaimVanulLadTemplate extends MonsterNPCTemplate {
	public static final int ID = 21628;

	@Inject
	protected KaimVanulLadTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kaim Vanul Lad";
