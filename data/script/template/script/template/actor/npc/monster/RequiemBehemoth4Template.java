 ...
 */
public class RequiemBehemoth4Template extends MonsterNPCTemplate {
	public static final int ID = 21601;

	@Inject
	protected RequiemBehemoth4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Requiem Behemoth";
