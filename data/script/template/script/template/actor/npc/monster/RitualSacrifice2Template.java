 ...
 */
public class RitualSacrifice2Template extends MonsterNPCTemplate {
	public static final int ID = 22154;

	@Inject
	protected RitualSacrifice2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
