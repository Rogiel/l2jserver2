 ...
 */
public class TurkaCommandersGhostTemplate extends MonsterNPCTemplate {
	public static final int ID = 22707;

	@Inject
	protected TurkaCommandersGhostTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Turka Commander's Ghost";
		this.serverSideName = false;
		this.title = "Grave Guardian Spirit";
