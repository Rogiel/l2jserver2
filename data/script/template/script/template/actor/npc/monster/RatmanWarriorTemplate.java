 ...
 */
public class RatmanWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20359;

	@Inject
	protected RatmanWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ratman Warrior";
