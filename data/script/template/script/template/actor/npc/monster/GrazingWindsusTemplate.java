 ...
 */
public class GrazingWindsusTemplate extends MonsterNPCTemplate {
	public static final int ID = 21333;

	@Inject
	protected GrazingWindsusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grazing Windsus";
