 ...
 */
public class CrimsonWerewolfTemplate extends MonsterNPCTemplate {
	public static final int ID = 27131;

	@Inject
	protected CrimsonWerewolfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
