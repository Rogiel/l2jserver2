 ...
 */
public class CasterOfDarkness4Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18229;

	@Inject
	protected CasterOfDarkness4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
