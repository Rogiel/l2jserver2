 ...
 */
public class Deinonychus2Template extends MonsterNPCTemplate {
	public static final int ID = 22204;

	@Inject
	protected Deinonychus2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
