 ...
 */
public class MakumBugbearThugTemplate extends MonsterNPCTemplate {
	public static final int ID = 27083;

	@Inject
	protected MakumBugbearThugTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Makum Bugbear Thug";
