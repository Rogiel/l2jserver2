 ...
 */
public class StrainTemplate extends MonsterNPCTemplate {
	public static final int ID = 20200;

	@Inject
	protected StrainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
