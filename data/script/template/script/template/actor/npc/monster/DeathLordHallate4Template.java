 ...
 */
public class DeathLordHallate4Template extends MonsterNPCTemplate {
	public static final int ID = 27264;

	@Inject
	protected DeathLordHallate4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
