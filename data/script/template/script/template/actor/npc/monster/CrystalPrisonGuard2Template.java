 ...
 */
public class CrystalPrisonGuard2Template extends MonsterNPCTemplate {
	public static final int ID = 29104;

	@Inject
	protected CrystalPrisonGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
