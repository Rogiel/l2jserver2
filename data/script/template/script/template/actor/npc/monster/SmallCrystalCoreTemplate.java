 ...
 */
public class SmallCrystalCoreTemplate extends MonsterNPCTemplate {
	public static final int ID = 22554;

	@Inject
	protected SmallCrystalCoreTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
