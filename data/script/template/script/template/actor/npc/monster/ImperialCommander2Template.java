 ...
 */
public class ImperialCommander2Template extends MonsterNPCTemplate {
	public static final int ID = 21417;

	@Inject
	protected ImperialCommander2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Imperial Commander";
