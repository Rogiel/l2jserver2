 ...
 */
public class GrandpapaAskaliusTemplate extends MonsterNPCTemplate {
	public static final int ID = 27283;

	@Inject
	protected GrandpapaAskaliusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grandpapa Askalius";
