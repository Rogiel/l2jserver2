 ...
 */
public class KashaBearTemplate extends MonsterNPCTemplate {
	public static final int ID = 20479;

	@Inject
	protected KashaBearTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kasha Bear";
