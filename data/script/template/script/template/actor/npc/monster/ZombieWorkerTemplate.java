 ...
 */
public class ZombieWorkerTemplate extends MonsterNPCTemplate {
	public static final int ID = 22140;

	@Inject
	protected ZombieWorkerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Zombie Worker";
