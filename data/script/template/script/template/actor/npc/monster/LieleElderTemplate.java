 ...
 */
public class LieleElderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20596;

	@Inject
	protected LieleElderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Liele Elder";
