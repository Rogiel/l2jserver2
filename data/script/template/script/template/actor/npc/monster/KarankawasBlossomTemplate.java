 ...
 */
public class KarankawasBlossomTemplate extends MonsterNPCTemplate {
	public static final int ID = 25559;

	@Inject
	protected KarankawasBlossomTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Karankawa's Blossom";
