 ...
 */
public class ColossusTemplate extends MonsterNPCTemplate {
	public static final int ID = 22241;

	@Inject
	protected ColossusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.magicalDefense = 50.25308;
