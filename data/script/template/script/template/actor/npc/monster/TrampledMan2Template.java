 ...
 */
public class TrampledMan2Template extends MonsterNPCTemplate {
	public static final int ID = 21554;

	@Inject
	protected TrampledMan2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Trampled Man";
