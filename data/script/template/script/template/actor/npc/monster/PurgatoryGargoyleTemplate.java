 ...
 */
public class PurgatoryGargoyleTemplate extends MonsterNPCTemplate {
	public static final int ID = 21159;

	@Inject
	protected PurgatoryGargoyleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Purgatory Gargoyle";
