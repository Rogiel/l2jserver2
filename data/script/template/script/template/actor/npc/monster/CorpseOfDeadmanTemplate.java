 ...
 */
public class CorpseOfDeadmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 18119;

	@Inject
	protected CorpseOfDeadmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Corpse of Deadman";
