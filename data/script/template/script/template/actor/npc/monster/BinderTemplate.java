 ...
 */
public class BinderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20983;

	@Inject
	protected BinderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
