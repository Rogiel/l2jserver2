 ...
 */
public class Karik2Template extends MonsterNPCTemplate {
	public static final int ID = 20629;

	@Inject
	protected Karik2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
