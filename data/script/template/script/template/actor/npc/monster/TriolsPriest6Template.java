 ...
 */
public class TriolsPriest6Template extends MonsterNPCTemplate {
	public static final int ID = 22165;

	@Inject
	protected TriolsPriest6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
