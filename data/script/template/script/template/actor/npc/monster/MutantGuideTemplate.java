 ...
 */
public class MutantGuideTemplate extends MonsterNPCTemplate {
	public static final int ID = 22732;

	@Inject
	protected MutantGuideTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mutant Guide";
