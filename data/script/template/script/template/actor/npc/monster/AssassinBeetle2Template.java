 ...
 */
public class AssassinBeetle2Template extends MonsterNPCTemplate {
	public static final int ID = 21653;

	@Inject
	protected AssassinBeetle2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Assassin Beetle";
