 ...
 */
public class VampireMagister2Template extends MonsterNPCTemplate {
	public static final int ID = 21591;

	@Inject
	protected VampireMagister2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
