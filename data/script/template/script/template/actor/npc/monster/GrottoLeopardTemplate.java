 ...
 */
public class GrottoLeopardTemplate extends MonsterNPCTemplate {
	public static final int ID = 22250;

	@Inject
	protected GrottoLeopardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grotto Leopard";
