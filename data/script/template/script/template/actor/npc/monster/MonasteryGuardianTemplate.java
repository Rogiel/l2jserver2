 ...
 */
public class MonasteryGuardianTemplate extends MonsterNPCTemplate {
	public static final int ID = 22128;

	@Inject
	protected MonasteryGuardianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Monastery Guardian";
