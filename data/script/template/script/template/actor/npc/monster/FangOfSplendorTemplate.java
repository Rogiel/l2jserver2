 ...
 */
public class FangOfSplendorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21537;

	@Inject
	protected FangOfSplendorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fang of Splendor";
