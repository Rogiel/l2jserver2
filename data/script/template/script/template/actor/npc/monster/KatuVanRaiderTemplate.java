 ...
 */
public class KatuVanRaiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 25028;

	@Inject
	protected KatuVanRaiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Katu Van Raider";
