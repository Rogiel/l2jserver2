 ...
 */
public class DeathDollTemplate extends MonsterNPCTemplate {
	public static final int ID = 20490;

	@Inject
	protected DeathDollTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Death Doll";
