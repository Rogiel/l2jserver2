 ...
 */
public class SatyrElderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20598;

	@Inject
	protected SatyrElderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Satyr Elder";
