 ...
 */
public class TurelTemplate extends MonsterNPCTemplate {
	public static final int ID = 27064;

	@Inject
	protected TurelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
