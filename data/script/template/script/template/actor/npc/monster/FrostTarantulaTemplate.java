 ...
 */
public class FrostTarantulaTemplate extends MonsterNPCTemplate {
	public static final int ID = 22090;

	@Inject
	protected FrostTarantulaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Frost Tarantula";
