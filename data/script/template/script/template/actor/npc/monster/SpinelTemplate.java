 ...
 */
public class SpinelTemplate extends MonsterNPCTemplate {
	public static final int ID = 22293;

	@Inject
	protected SpinelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
