 ...
 */
public class SnowLynxTemplate extends MonsterNPCTemplate {
	public static final int ID = 22020;

	@Inject
	protected SnowLynxTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
