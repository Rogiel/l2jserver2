 ...
 */
public class InvaderMartyrOfNightmareTemplate extends MonsterNPCTemplate {
	public static final int ID = 18817;

	@Inject
	protected InvaderMartyrOfNightmareTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Invader Martyr of Nightmare";
