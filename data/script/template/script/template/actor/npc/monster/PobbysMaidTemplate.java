 ...
 */
public class PobbysMaidTemplate extends MonsterNPCTemplate {
	public static final int ID = 20951;

	@Inject
	protected PobbysMaidTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Pobby's Maid";
