 ...
 */
public class OmenBeastTemplate extends MonsterNPCTemplate {
	public static final int ID = 20031;

	@Inject
	protected OmenBeastTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Omen Beast";
