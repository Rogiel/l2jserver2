 ...
 */
public class SoldierOfGriefTemplate extends MonsterNPCTemplate {
	public static final int ID = 20997;

	@Inject
	protected SoldierOfGriefTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Soldier of Grief";
