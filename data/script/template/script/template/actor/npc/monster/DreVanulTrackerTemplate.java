 ...
 */
public class DreVanulTrackerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20351;

	@Inject
	protected DreVanulTrackerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dre Vanul Tracker";
