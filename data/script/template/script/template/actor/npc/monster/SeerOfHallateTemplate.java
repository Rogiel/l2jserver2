 ...
 */
public class SeerOfHallateTemplate extends MonsterNPCTemplate {
	public static final int ID = 20810;

	@Inject
	protected SeerOfHallateTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Seer of Hallate";
