 ...
 */
public class FerventKanabion2Template extends MonsterNPCTemplate {
	public static final int ID = 22477;

	@Inject
	protected FerventKanabion2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
