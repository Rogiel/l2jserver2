 ...
 */
public class KechisGuard3Template extends MonsterNPCTemplate {
	public static final int ID = 22310;

	@Inject
	protected KechisGuard3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kechi's Guard";
