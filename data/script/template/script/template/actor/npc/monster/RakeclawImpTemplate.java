 ...
 */
public class RakeclawImpTemplate extends MonsterNPCTemplate {
	public static final int ID = 20311;

	@Inject
	protected RakeclawImpTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rakeclaw Imp";
