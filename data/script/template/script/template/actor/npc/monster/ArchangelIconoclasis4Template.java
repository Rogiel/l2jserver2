 ...
 */
public class ArchangelIconoclasis4Template extends MonsterNPCTemplate {
	public static final int ID = 27260;

	@Inject
	protected ArchangelIconoclasis4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
