 ...
 */
public class BloodyPriestTemplate extends MonsterNPCTemplate {
	public static final int ID = 20962;

	@Inject
	protected BloodyPriestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bloody Priest";
