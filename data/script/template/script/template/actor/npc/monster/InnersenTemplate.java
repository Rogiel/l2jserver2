 ...
 */
public class InnersenTemplate extends MonsterNPCTemplate {
	public static final int ID = 20950;

	@Inject
	protected InnersenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
