 ...
 */
public class GuardianOfForbiddenKnowledgeTemplate extends MonsterNPCTemplate {
	public static final int ID = 27214;

	@Inject
	protected GuardianOfForbiddenKnowledgeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
