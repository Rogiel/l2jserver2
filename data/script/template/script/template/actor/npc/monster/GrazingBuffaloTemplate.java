 ...
 */
public class GrazingBuffaloTemplate extends MonsterNPCTemplate {
	public static final int ID = 21330;

	@Inject
	protected GrazingBuffaloTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grazing Buffalo";
