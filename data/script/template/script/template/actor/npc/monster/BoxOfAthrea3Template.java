 ...
 */
public class BoxOfAthrea3Template extends MonsterNPCTemplate {
	public static final int ID = 27175;

	@Inject
	protected BoxOfAthrea3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Box Of Athrea 3";
