 ...
 */
public class KechisGuard4Template extends MonsterNPCTemplate {
	public static final int ID = 22417;

	@Inject
	protected KechisGuard4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
