 ...
 */
public class LafiLizardmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20613;

	@Inject
	protected LafiLizardmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lafi Lizardman";
