 ...
 */
public class GuardianOfTheGhostTownTemplate extends MonsterNPCTemplate {
	public static final int ID = 22047;

	@Inject
	protected GuardianOfTheGhostTownTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guardian of the Ghost Town";
