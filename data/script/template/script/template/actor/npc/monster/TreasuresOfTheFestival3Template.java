 ...
 */
public class TreasuresOfTheFestival3Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18111;

	@Inject
	protected TreasuresOfTheFestival3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 1302.758046000000000;
		...
		attributes.physicalDefense = 209.50000;
