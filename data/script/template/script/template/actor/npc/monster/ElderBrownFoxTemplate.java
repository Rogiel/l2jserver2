 ...
 */
public class ElderBrownFoxTemplate extends MonsterNPCTemplate {
	public static final int ID = 20440;

	@Inject
	protected ElderBrownFoxTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Elder Brown Fox";
