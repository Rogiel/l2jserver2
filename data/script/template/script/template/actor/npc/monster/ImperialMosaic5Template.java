 ...
 */
public class ImperialMosaic5Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18137;

	@Inject
	protected ImperialMosaic5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
