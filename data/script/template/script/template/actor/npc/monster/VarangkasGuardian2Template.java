 ...
 */
public class VarangkasGuardian2Template extends MonsterNPCTemplate {
	public static final int ID = 22700;

	@Inject
	protected VarangkasGuardian2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
