 ...
 */
public class GazeOfNightmareTemplate extends MonsterNPCTemplate {
	public static final int ID = 21301;

	@Inject
	protected GazeOfNightmareTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gaze of Nightmare";
