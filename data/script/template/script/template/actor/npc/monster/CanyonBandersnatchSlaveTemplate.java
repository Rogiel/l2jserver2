 ...
 */
public class CanyonBandersnatchSlaveTemplate extends MonsterNPCTemplate {
	public static final int ID = 21297;

	@Inject
	protected CanyonBandersnatchSlaveTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Canyon Bandersnatch Slave";
