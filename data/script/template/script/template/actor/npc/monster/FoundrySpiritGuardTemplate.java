 ...
 */
public class FoundrySpiritGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 22388;

	@Inject
	protected FoundrySpiritGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Foundry Spirit Guard";
