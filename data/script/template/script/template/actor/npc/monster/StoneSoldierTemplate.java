 ...
 */
public class StoneSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 20379;

	@Inject
	protected StoneSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Stone Soldier";
