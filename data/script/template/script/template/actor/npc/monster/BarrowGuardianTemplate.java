 ...
 */
public class BarrowGuardianTemplate extends MonsterNPCTemplate {
	public static final int ID = 21232;

	@Inject
	protected BarrowGuardianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Barrow Guardian";
