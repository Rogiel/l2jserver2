 ...
 */
public class CrendionTemplate extends MonsterNPCTemplate {
	public static final int ID = 20813;

	@Inject
	protected CrendionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
