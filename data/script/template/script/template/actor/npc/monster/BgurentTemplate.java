 ...
 */
public class BgurentTemplate extends MonsterNPCTemplate {
	public static final int ID = 22746;

	@Inject
	protected BgurentTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
