 ...
 */
public class NosTemplate extends MonsterNPCTemplate {
	public static final int ID = 20793;

	@Inject
	protected NosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
