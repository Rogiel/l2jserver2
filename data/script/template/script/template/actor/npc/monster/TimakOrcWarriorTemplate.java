 ...
 */
public class TimakOrcWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20586;

	@Inject
	protected TimakOrcWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Timak Orc Warrior";
