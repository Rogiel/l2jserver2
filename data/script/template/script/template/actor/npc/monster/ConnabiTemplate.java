 ...
 */
public class ConnabiTemplate extends MonsterNPCTemplate {
	public static final int ID = 20947;

	@Inject
	protected ConnabiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
