 ...
 */
public class DragonBomber7Template extends MonsterNPCTemplate {
	public static final int ID = 29075;

	@Inject
	protected DragonBomber7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
