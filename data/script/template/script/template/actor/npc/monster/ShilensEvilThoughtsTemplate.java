 ...
 */
public class ShilensEvilThoughtsTemplate extends MonsterNPCTemplate {
	public static final int ID = 27341;

	@Inject
	protected ShilensEvilThoughtsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
