 ...
 */
public class HorrifyingCannonGolemVi6Template extends MonsterNPCTemplate {
	public static final int ID = 22071;

	@Inject
	protected HorrifyingCannonGolemVi6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
