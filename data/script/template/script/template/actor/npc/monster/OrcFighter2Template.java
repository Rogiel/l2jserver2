 ...
 */
public class OrcFighter2Template extends MonsterNPCTemplate {
	public static final int ID = 27002;

	@Inject
	protected OrcFighter2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Orc Fighter";
