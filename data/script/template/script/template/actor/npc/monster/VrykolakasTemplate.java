 ...
 */
public class VrykolakasTemplate extends MonsterNPCTemplate {
	public static final int ID = 20398;

	@Inject
	protected VrykolakasTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vrykolakas";
