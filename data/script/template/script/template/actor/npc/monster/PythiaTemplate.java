 ...
 */
public class PythiaTemplate extends MonsterNPCTemplate {
	public static final int ID = 22266;

	@Inject
	protected PythiaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
