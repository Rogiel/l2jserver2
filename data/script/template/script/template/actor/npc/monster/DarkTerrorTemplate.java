 ...
 */
public class DarkTerrorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20345;

	@Inject
	protected DarkTerrorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Terror";
