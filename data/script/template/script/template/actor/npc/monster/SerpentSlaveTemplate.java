 ...
 */
public class SerpentSlaveTemplate extends MonsterNPCTemplate {
	public static final int ID = 20167;

	@Inject
	protected SerpentSlaveTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Serpent Slave";
