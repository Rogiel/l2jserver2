 ...
 */
public class VarkaSilenosMedium2Template extends MonsterNPCTemplate {
	public static final int ID = 21360;

	@Inject
	protected VarkaSilenosMedium2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Varka Silenos Medium";
