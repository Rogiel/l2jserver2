 ...
 */
public class PriestZombieOfFarakelsusTemplate extends MonsterNPCTemplate {
	public static final int ID = 25377;

	@Inject
	protected PriestZombieOfFarakelsusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Priest Zombie of Farakelsus";
