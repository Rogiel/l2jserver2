 ...
 */
public class OfferingOfForbiddenPathWarriorTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18052;

	@Inject
	protected OfferingOfForbiddenPathWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
