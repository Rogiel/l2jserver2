 ...
 */
public class BeetleOfGrave2Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18142;

	@Inject
	protected BeetleOfGrave2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
