 ...
 */
public class SkeletonMarksmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20102;

	@Inject
	protected SkeletonMarksmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
