 ...
 */
public class ManaSeekerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20037;

	@Inject
	protected ManaSeekerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mana Seeker";
