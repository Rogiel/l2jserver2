 ...
 */
public class DefeatedTroopsMagicLeader2Template extends MonsterNPCTemplate {
	public static final int ID = 22563;

	@Inject
	protected DefeatedTroopsMagicLeader2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
