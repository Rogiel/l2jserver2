 ...
 */
public class DustwindGargoyle2Template extends MonsterNPCTemplate {
	public static final int ID = 20281;

	@Inject
	protected DustwindGargoyle2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dustwind Gargoyle";
