 ...
 */
public class Sprigant2Template extends MonsterNPCTemplate {
	public static final int ID = 18346;

	@Inject
	protected Sprigant2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
