 ...
 */
public class LesserSuccubusTurenTemplate extends MonsterNPCTemplate {
	public static final int ID = 20052;

	@Inject
	protected LesserSuccubusTurenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lesser Succubus Turen";
