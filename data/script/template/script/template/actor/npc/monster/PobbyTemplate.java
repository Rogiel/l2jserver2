 ...
 */
public class PobbyTemplate extends MonsterNPCTemplate {
	public static final int ID = 20953;

	@Inject
	protected PobbyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
