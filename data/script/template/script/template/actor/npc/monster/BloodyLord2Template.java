 ...
 */
public class BloodyLord2Template extends MonsterNPCTemplate {
	public static final int ID = 21089;

	@Inject
	protected BloodyLord2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bloody Lord";
