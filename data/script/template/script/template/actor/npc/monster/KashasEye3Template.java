 ...
 */
public class KashasEye3Template extends MonsterNPCTemplate {
	public static final int ID = 18814;

	@Inject
	protected KashasEye3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kasha's Eye";
