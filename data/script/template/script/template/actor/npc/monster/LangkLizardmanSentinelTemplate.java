 ...
 */
public class LangkLizardmanSentinelTemplate extends MonsterNPCTemplate {
	public static final int ID = 21100;

	@Inject
	protected LangkLizardmanSentinelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Langk Lizardman Sentinel";
