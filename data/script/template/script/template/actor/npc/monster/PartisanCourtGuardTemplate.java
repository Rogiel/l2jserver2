 ...
 */
public class PartisanCourtGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 35370;

	@Inject
	protected PartisanCourtGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
