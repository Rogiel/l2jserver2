 ...
 */
public class OfferingOfForbiddenPathElderTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18049;

	@Inject
	protected OfferingOfForbiddenPathElderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
