 ...
 */
public class RedHotTemplate extends MonsterNPCTemplate {
	public static final int ID = 31023;

	@Inject
	protected RedHotTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
