 ...
 */
public class VisionGuardianShakielTemplate extends MonsterNPCTemplate {
	public static final int ID = 27313;

	@Inject
	protected VisionGuardianShakielTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
