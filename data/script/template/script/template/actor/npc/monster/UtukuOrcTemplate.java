 ...
 */
public class UtukuOrcTemplate extends MonsterNPCTemplate {
	public static final int ID = 20446;

	@Inject
	protected UtukuOrcTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
