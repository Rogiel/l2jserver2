 ...
 */
public class TimakOrcRanger2Template extends MonsterNPCTemplate {
	public static final int ID = 25087;

	@Inject
	protected TimakOrcRanger2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Timak Orc Ranger";
		...
		this.attackRange = 40;
		this.maxHP = 11805.346980048000000;
		this.maxMP = 557.400000000000000;
		this.hpRegeneration = 53.367325543449300;
