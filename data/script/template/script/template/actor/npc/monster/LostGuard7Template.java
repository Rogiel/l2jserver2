 ...
 */
public class LostGuard7Template extends MonsterNPCTemplate {
	public static final int ID = 29145;

	@Inject
	protected LostGuard7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 3412.94843;
		attributes.magicalAttack = 2330.60138;
