 ...
 */
public class DisciplesOfAuthority2Template extends MonsterNPCTemplate {
	public static final int ID = 21311;

	@Inject
	protected DisciplesOfAuthority2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Disciples of Authority";
