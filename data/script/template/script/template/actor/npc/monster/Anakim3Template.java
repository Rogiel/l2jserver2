 ...
 */
public class Anakim3Template extends MonsterNPCTemplate {
	public static final int ID = 27388;

	@Inject
	protected Anakim3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
