 ...
 */
public class NephilimArchbishopTemplate extends MonsterNPCTemplate {
	public static final int ID = 21203;

	@Inject
	protected NephilimArchbishopTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nephilim Archbishop";
