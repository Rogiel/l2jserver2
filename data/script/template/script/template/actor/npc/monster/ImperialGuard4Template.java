 ...
 */
public class ImperialGuard4Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18169;

	@Inject
	protected ImperialGuard4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
