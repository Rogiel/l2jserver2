 ...
 */
public class Malcom6Template extends MonsterNPCTemplate {
	public static final int ID = 30941;

	@Inject
	protected Malcom6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Malcom6";
		this.serverSideName = false;
		this.title = "Prince of Wild Beast";
