 ...
 */
public class GuardianWarriorOfElmoredenTemplate extends MonsterNPCTemplate {
	public static final int ID = 21073;

	@Inject
	protected GuardianWarriorOfElmoredenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guardian Warrior of Elmoreden";
