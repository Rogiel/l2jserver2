 ...
 */
public class HatuBrownBearTemplate extends MonsterNPCTemplate {
	public static final int ID = 20930;

	@Inject
	protected HatuBrownBearTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hatu Brown Bear";
