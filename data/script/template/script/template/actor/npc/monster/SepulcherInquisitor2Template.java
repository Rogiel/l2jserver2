 ...
 */
public class SepulcherInquisitor2Template extends MonsterNPCTemplate {
	public static final int ID = 21223;

	@Inject
	protected SepulcherInquisitor2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
