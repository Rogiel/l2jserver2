 ...
 */
public class VampireBatTemplate extends MonsterNPCTemplate {
	public static final int ID = 20095;

	@Inject
	protected VampireBatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
