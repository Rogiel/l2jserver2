 ...
 */
public class KechisGuard2Template extends MonsterNPCTemplate {
	public static final int ID = 22309;

	@Inject
	protected KechisGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
