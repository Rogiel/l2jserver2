 ...
 */
public class PobbyEscortTemplate extends MonsterNPCTemplate {
	public static final int ID = 20952;

	@Inject
	protected PobbyEscortTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Pobby Escort";
