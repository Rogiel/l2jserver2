 ...
 */
public class VanorSilenosShamanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20685;

	@Inject
	protected VanorSilenosShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vanor Silenos Shaman";
