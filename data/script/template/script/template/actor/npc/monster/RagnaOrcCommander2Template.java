 ...
 */
public class RagnaOrcCommander2Template extends MonsterNPCTemplate {
	public static final int ID = 22694;

	@Inject
	protected RagnaOrcCommander2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ragna Orc Commander";
		...
		this.rightHand = itemProvider.createID(7892);
		this.leftHand = null;
		this.enchantLevel = 0;
