 ...
 */
public class ButcherOfBifronsTemplate extends MonsterNPCTemplate {
	public static final int ID = 25148;

	@Inject
	protected ButcherOfBifronsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Butcher of Bifrons";
		...
		this.attackRange = 40;
		this.maxHP = 2947.774886031530000;
