 ...
 */
public class OfferingOfForbiddenPathSaintTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18058;

	@Inject
	protected OfferingOfForbiddenPathSaintTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
