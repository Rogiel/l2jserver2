 ...
 */
public class TasabaLizardmanShamanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20785;

	@Inject
	protected TasabaLizardmanShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
