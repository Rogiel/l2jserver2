 ...
 */
public class PlatinumTribeWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20827;

	@Inject
	protected PlatinumTribeWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Platinum Tribe Warrior";
