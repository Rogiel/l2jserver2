 ...
 */
public class SelMahumDrillSergeant3Template extends MonsterNPCTemplate {
	public static final int ID = 22778;

	@Inject
	protected SelMahumDrillSergeant3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
