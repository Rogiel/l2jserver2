 ...
 */
public class VirudLizardmanMatriarchTemplate extends MonsterNPCTemplate {
	public static final int ID = 20294;

	@Inject
	protected VirudLizardmanMatriarchTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Virud Lizardman Matriarch";
