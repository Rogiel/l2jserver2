 ...
 */
public class DarkOmenOfferingDiscipleTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18047;

	@Inject
	protected DarkOmenOfferingDiscipleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
