 ...
 */
public class HorrifyingCannonGolemVi7Template extends MonsterNPCTemplate {
	public static final int ID = 22072;

	@Inject
	protected HorrifyingCannonGolemVi7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
