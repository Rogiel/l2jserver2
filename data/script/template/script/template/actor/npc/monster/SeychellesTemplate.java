 ...
 */
public class SeychellesTemplate extends MonsterNPCTemplate {
	public static final int ID = 22261;

	@Inject
	protected SeychellesTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
