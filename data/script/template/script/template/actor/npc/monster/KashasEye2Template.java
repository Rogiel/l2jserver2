 ...
 */
public class KashasEye2Template extends MonsterNPCTemplate {
	public static final int ID = 18813;

	@Inject
	protected KashasEye2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
