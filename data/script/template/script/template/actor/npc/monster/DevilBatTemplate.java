 ...
 */
public class DevilBatTemplate extends MonsterNPCTemplate {
	public static final int ID = 21568;

	@Inject
	protected DevilBatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
