 ...
 */
public class DeinonychusTemplate extends MonsterNPCTemplate {
	public static final int ID = 22203;

	@Inject
	protected DeinonychusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
