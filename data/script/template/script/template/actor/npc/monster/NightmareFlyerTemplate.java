 ...
 */
public class NightmareFlyerTemplate extends MonsterNPCTemplate {
	public static final int ID = 25381;

	@Inject
	protected NightmareFlyerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nightmare Flyer";
