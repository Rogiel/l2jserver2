 ...
 */
public class LilimAssassinTemplate extends MonsterNPCTemplate {
	public static final int ID = 21181;

	@Inject
	protected LilimAssassinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
