 ...
 */
public class VrykolakasWolfkinTemplate extends MonsterNPCTemplate {
	public static final int ID = 20399;

	@Inject
	protected VrykolakasWolfkinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vrykolakas Wolfkin";
