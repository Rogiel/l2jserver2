 ...
 */
public class MountainFungusTemplate extends MonsterNPCTemplate {
	public static final int ID = 20365;

	@Inject
	protected MountainFungusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
