 ...
 */
public class ScarletSalamanderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20415;

	@Inject
	protected ScarletSalamanderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Scarlet Salamander";
