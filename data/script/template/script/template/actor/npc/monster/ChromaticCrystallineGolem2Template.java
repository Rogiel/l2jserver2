 ...
 */
public class ChromaticCrystallineGolem2Template extends MonsterNPCTemplate {
	public static final int ID = 18370;

	@Inject
	protected ChromaticCrystallineGolem2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Chromatic Crystalline Golem";
