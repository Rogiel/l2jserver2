 ...
 */
public class GlassJaguarTemplate extends MonsterNPCTemplate {
	public static final int ID = 20250;

	@Inject
	protected GlassJaguarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Glass Jaguar";
