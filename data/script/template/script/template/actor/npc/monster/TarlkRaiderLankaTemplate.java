 ...
 */
public class TarlkRaiderLankaTemplate extends MonsterNPCTemplate {
	public static final int ID = 27145;

	@Inject
	protected TarlkRaiderLankaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tarlk Raider Lanka";
