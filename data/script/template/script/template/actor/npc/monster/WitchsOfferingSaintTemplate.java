 ...
 */
public class WitchsOfferingSaintTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18038;

	@Inject
	protected WitchsOfferingSaintTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
