 ...
 */
public class CallousKanabion2Template extends MonsterNPCTemplate {
	public static final int ID = 22465;

	@Inject
	protected CallousKanabion2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
