 ...
 */
public class KinazsIfritTemplate extends MonsterNPCTemplate {
	public static final int ID = 29038;

	@Inject
	protected KinazsIfritTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
