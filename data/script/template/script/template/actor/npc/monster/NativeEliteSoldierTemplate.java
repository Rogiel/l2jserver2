 ...
 */
public class NativeEliteSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 22451;

	@Inject
	protected NativeEliteSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Native Elite Soldier";
