 ...
 */
public class GuardsOfTheDawn4Template extends MonsterNPCTemplate {
	public static final int ID = 27351;

	@Inject
	protected GuardsOfTheDawn4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
