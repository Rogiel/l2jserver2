 ...
 */
public class FallenAngelAllectorTemplate extends MonsterNPCTemplate {
	public static final int ID = 27250;

	@Inject
	protected FallenAngelAllectorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
