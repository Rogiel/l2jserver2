 ...
 */
public class YoungCrimsonFoxTemplate extends MonsterNPCTemplate {
	public static final int ID = 20407;

	@Inject
	protected YoungCrimsonFoxTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Young Crimson Fox";
