 ...
 */
public class HallKeeperSuicidalSoldier2Template extends MonsterNPCTemplate {
	public static final int ID = 18340;

	@Inject
	protected HallKeeperSuicidalSoldier2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
