 ...
 */
public class RagnaOrcSeerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20779;

	@Inject
	protected RagnaOrcSeerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
