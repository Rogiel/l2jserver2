 ...
 */
public class PlatinumGuardianPrefectTemplate extends MonsterNPCTemplate {
	public static final int ID = 21069;

	@Inject
	protected PlatinumGuardianPrefectTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Platinum Guardian Prefect";
