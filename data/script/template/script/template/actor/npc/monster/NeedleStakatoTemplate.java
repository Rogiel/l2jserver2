 ...
 */
public class NeedleStakatoTemplate extends MonsterNPCTemplate {
	public static final int ID = 21513;

	@Inject
	protected NeedleStakatoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Needle Stakato";
