 ...
 */
public class RuinImpElderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20507;

	@Inject
	protected RuinImpElderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ruin Imp Elder";
