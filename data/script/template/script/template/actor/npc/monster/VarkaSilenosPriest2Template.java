 ...
 */
public class VarkaSilenosPriest2Template extends MonsterNPCTemplate {
	public static final int ID = 21357;

	@Inject
	protected VarkaSilenosPriest2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Varka Silenos Priest";
