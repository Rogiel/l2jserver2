 ...
 */
public class TombGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 21254;

	@Inject
	protected TombGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tomb Guard";
