 ...
 */
public class NeerCrawlerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20160;

	@Inject
	protected NeerCrawlerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Neer Crawler";
