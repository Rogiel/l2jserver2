 ...
 */
public class NeedleStakatoWorkerTemplate extends MonsterNPCTemplate {
	public static final int ID = 21514;

	@Inject
	protected NeedleStakatoWorkerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Needle Stakato Worker";
