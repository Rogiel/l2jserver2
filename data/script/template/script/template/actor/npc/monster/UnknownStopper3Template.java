 ...
 */
public class UnknownStopper3Template extends MonsterNPCTemplate {
	public static final int ID = 27256;

	@Inject
	protected UnknownStopper3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
