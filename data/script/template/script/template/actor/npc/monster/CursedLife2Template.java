 ...
 */
public class CursedLife2Template extends MonsterNPCTemplate {
	public static final int ID = 25682;

	@Inject
	protected CursedLife2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
