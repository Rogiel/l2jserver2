 ...
 */
public class KatraxisTemplate extends MonsterNPCTemplate {
	public static final int ID = 21402;

	@Inject
	protected KatraxisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
