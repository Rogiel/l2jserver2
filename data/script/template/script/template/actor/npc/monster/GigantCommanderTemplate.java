 ...
 */
public class GigantCommanderTemplate extends MonsterNPCTemplate {
	public static final int ID = 21195;

	@Inject
	protected GigantCommanderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gigant Commander";
