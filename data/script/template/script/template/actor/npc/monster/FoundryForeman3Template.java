 ...
 */
public class FoundryForeman3Template extends MonsterNPCTemplate {
	public static final int ID = 22403;

	@Inject
	protected FoundryForeman3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
