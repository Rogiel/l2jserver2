 ...
 */
public class WatchmanOfGraveTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18244;

	@Inject
	protected WatchmanOfGraveTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
