 ...
 */
public class RedScavengerSpiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20393;

	@Inject
	protected RedScavengerSpiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Red Scavenger Spider";
