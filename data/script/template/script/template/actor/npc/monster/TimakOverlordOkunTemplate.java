 ...
 */
public class TimakOverlordOkunTemplate extends MonsterNPCTemplate {
	public static final int ID = 27159;

	@Inject
	protected TimakOverlordOkunTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Timak Overlord Okun";
