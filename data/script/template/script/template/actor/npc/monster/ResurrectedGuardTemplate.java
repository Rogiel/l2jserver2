 ...
 */
public class ResurrectedGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 21551;

	@Inject
	protected ResurrectedGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
