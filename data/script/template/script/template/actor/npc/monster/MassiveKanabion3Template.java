 ...
 */
public class MassiveKanabion3Template extends MonsterNPCTemplate {
	public static final int ID = 22475;

	@Inject
	protected MassiveKanabion3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
