 ...
 */
public class ChimeraGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 27271;

	@Inject
	protected ChimeraGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Chimera Golem";
