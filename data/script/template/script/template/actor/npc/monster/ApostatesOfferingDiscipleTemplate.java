 ...
 */
public class ApostatesOfferingDiscipleTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18027;

	@Inject
	protected ApostatesOfferingDiscipleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Apostate's Offering Disciple";
