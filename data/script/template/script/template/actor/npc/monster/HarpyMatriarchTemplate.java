 ...
 */
public class HarpyMatriarchTemplate extends MonsterNPCTemplate {
	public static final int ID = 27088;

	@Inject
	protected HarpyMatriarchTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Harpy Matriarch";
