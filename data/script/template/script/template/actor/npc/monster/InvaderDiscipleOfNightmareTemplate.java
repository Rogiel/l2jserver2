 ...
 */
public class InvaderDiscipleOfNightmareTemplate extends MonsterNPCTemplate {
	public static final int ID = 22717;

	@Inject
	protected InvaderDiscipleOfNightmareTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Invader Disciple of Nightmare";
