 ...
 */
public class ElfGhostTemplate extends MonsterNPCTemplate {
	public static final int ID = 20431;

	@Inject
	protected ElfGhostTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
