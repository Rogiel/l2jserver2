 ...
 */
public class PastusSilhouetteTemplate extends MonsterNPCTemplate {
	public static final int ID = 25021;

	@Inject
	protected PastusSilhouetteTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Pastu's Silhouette";
