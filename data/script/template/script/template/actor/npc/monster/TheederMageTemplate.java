 ...
 */
public class TheederMageTemplate extends MonsterNPCTemplate {
	public static final int ID = 20802;

	@Inject
	protected TheederMageTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Theeder Mage";
