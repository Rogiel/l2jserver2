 ...
 */
public class ClarasPawnTemplate extends MonsterNPCTemplate {
	public static final int ID = 25219;

	@Inject
	protected ClarasPawnTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Clara's Pawn";
