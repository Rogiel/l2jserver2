 ...
 */
public class CrimsonSpider2Template extends MonsterNPCTemplate {
	public static final int ID = 22244;

	@Inject
	protected CrimsonSpider2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Crimson Spider";
