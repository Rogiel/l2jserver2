 ...
 */
public class Victim6Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18155;

	@Inject
	protected Victim6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
