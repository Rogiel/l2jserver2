 ...
 */
public class RokoTemplate extends MonsterNPCTemplate {
	public static final int ID = 27065;

	@Inject
	protected RokoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
