 ...
 */
public class OfferingOfForbiddenPathBerserkerTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18054;

	@Inject
	protected OfferingOfForbiddenPathBerserkerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
