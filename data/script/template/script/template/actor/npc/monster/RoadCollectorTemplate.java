 ...
 */
public class RoadCollectorTemplate extends MonsterNPCTemplate {
	public static final int ID = 27089;

	@Inject
	protected RoadCollectorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Road Collector";
