 ...
 */
public class AshakielsRodTemplate extends MonsterNPCTemplate {
	public static final int ID = 25207;

	@Inject
	protected AshakielsRodTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ashakiel's Rod";
