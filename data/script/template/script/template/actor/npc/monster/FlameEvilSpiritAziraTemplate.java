 ...
 */
public class FlameEvilSpiritAziraTemplate extends MonsterNPCTemplate {
	public static final int ID = 27284;

	@Inject
	protected FlameEvilSpiritAziraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Flame Evil Spirit Azira";
