 ...
 */
public class ApostatesOffering2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18070;

	@Inject
	protected ApostatesOffering2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Apostate's Offering";
		...
		attributes.physicalAttack = 183.79228;
