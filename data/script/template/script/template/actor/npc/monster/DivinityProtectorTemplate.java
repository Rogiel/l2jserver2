 ...
 */
public class DivinityProtectorTemplate extends MonsterNPCTemplate {
	public static final int ID = 22798;

	@Inject
	protected DivinityProtectorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Divinity Protector";
