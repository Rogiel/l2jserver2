 ...
 */
public class InvaderGuideOfNightmareTemplate extends MonsterNPCTemplate {
	public static final int ID = 22710;

	@Inject
	protected InvaderGuideOfNightmareTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Invader Guide of Nightmare";
