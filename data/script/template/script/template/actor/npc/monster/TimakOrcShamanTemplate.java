 ...
 */
public class TimakOrcShamanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20587;

	@Inject
	protected TimakOrcShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Timak Orc Shaman";
