 ...
 */
public class HotSpringsBandersnatchTemplate extends MonsterNPCTemplate {
	public static final int ID = 21322;

	@Inject
	protected HotSpringsBandersnatchTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hot Springs Bandersnatch";
