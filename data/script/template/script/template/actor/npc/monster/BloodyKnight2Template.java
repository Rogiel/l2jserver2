 ...
 */
public class BloodyKnight2Template extends MonsterNPCTemplate {
	public static final int ID = 21087;

	@Inject
	protected BloodyKnight2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
