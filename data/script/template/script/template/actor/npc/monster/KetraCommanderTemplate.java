 ...
 */
public class KetraCommanderTemplate extends MonsterNPCTemplate {
	public static final int ID = 21343;

	@Inject
	protected KetraCommanderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ketra Commander";
