 ...
 */
public class SnipeCohort2Template extends MonsterNPCTemplate {
	public static final int ID = 21039;

	@Inject
	protected SnipeCohort2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
