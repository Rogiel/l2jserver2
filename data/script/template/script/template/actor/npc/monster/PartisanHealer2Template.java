 ...
 */
public class PartisanHealer2Template extends MonsterNPCTemplate {
	public static final int ID = 35376;

	@Inject
	protected PartisanHealer2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Partisan Healer";
