 ...
 */
public class GreenGoblinTemplate extends MonsterNPCTemplate {
	public static final int ID = 22234;

	@Inject
	protected GreenGoblinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.magicalDefense = 39.17366;
