 ...
 */
public class BalorOrcArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20385;

	@Inject
	protected BalorOrcArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Balor Orc Archer";
