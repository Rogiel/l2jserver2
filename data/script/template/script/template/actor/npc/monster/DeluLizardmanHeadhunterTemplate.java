 ...
 */
public class DeluLizardmanHeadhunterTemplate extends MonsterNPCTemplate {
	public static final int ID = 27151;

	@Inject
	protected DeluLizardmanHeadhunterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Delu Lizardman Headhunter";
