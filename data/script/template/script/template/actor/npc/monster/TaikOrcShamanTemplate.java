 ...
 */
public class TaikOrcShamanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20633;

	@Inject
	protected TaikOrcShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Taik Orc Shaman";
