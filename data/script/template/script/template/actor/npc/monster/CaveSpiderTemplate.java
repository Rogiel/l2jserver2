 ...
 */
public class CaveSpiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20348;

	@Inject
	protected CaveSpiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
