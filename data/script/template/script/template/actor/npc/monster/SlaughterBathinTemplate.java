 ...
 */
public class SlaughterBathinTemplate extends MonsterNPCTemplate {
	public static final int ID = 21075;

	@Inject
	protected SlaughterBathinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Slaughter Bathin";
