 ...
 */
public class SolinaKnightsTemplate extends MonsterNPCTemplate {
	public static final int ID = 18909;

	@Inject
	protected SolinaKnightsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Solina Knights";
