 ...
 */
public class BegrudgedKanabion3Template extends MonsterNPCTemplate {
	public static final int ID = 22457;

	@Inject
	protected BegrudgedKanabion3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Begrudged Kanabion";
		...
		this.experience = 1883;
		this.sp = 90;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(7886);
		this.leftHand = null;
		this.enchantLevel = 0;
