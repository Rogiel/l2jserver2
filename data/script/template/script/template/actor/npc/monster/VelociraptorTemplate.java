 ...
 */
public class VelociraptorTemplate extends MonsterNPCTemplate {
	public static final int ID = 22196;

	@Inject
	protected VelociraptorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
