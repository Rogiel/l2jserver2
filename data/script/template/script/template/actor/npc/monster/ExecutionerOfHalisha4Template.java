 ...
 */
public class ExecutionerOfHalisha4Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18161;

	@Inject
	protected ExecutionerOfHalisha4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
