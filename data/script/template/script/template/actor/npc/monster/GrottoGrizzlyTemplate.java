 ...
 */
public class GrottoGrizzlyTemplate extends MonsterNPCTemplate {
	public static final int ID = 22252;

	@Inject
	protected GrottoGrizzlyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grotto Grizzly";
