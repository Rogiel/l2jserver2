 ...
 */
public class KnightOfDarkness2Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18188;

	@Inject
	protected KnightOfDarkness2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
