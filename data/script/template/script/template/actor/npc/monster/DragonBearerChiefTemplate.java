 ...
 */
public class DragonBearerChiefTemplate extends MonsterNPCTemplate {
	public static final int ID = 20758;

	@Inject
	protected DragonBearerChiefTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dragon Bearer Chief";
