 ...
 */
public class DarkChoirWitchDoctorTemplate extends MonsterNPCTemplate {
	public static final int ID = 18338;

	@Inject
	protected DarkChoirWitchDoctorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Choir Witch Doctor";
