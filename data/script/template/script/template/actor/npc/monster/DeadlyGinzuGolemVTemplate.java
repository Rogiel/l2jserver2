 ...
 */
public class DeadlyGinzuGolemVTemplate extends MonsterNPCTemplate {
	public static final int ID = 22076;

	@Inject
	protected DeadlyGinzuGolemVTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Deadly Ginzu Golem V";
