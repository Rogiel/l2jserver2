 ...
 */
public class HellKeeperMedusaTemplate extends MonsterNPCTemplate {
	public static final int ID = 21154;

	@Inject
	protected HellKeeperMedusaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hell Keeper Medusa";
