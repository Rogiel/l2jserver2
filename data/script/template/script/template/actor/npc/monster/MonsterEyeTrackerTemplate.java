 ...
 */
public class MonsterEyeTrackerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20331;

	@Inject
	protected MonsterEyeTrackerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Monster Eye Tracker";
