 ...
 */
public class ImperialMosaic4Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18136;

	@Inject
	protected ImperialMosaic4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 761.97417;
