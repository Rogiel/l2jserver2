 ...
 */
public class WitchsOfferingFollower2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18083;

	@Inject
	protected WitchsOfferingFollower2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
