 ...
 */
public class Buffalo4Template extends MonsterNPCTemplate {
	public static final int ID = 21286;

	@Inject
	protected Buffalo4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
