 ...
 */
public class LetoLizardmanSniperTemplate extends MonsterNPCTemplate {
	public static final int ID = 27125;

	@Inject
	protected LetoLizardmanSniperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Leto Lizardman Sniper";
