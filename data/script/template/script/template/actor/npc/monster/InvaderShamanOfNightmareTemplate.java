 ...
 */
public class InvaderShamanOfNightmareTemplate extends MonsterNPCTemplate {
	public static final int ID = 22713;

	@Inject
	protected InvaderShamanOfNightmareTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Invader Shaman of Nightmare";
