 ...
 */
public class DeathLordHallate3Template extends MonsterNPCTemplate {
	public static final int ID = 27263;

	@Inject
	protected DeathLordHallate3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
