 ...
 */
public class AndreasRoyalGuardsTemplate extends MonsterNPCTemplate {
	public static final int ID = 22176;

	@Inject
	protected AndreasRoyalGuardsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
