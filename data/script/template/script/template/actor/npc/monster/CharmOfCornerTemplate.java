 ...
 */
public class CharmOfCornerTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18196;

	@Inject
	protected CharmOfCornerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
