 ...
 */
public class ArkGuardianShadowfangTemplate extends MonsterNPCTemplate {
	public static final int ID = 27183;

	@Inject
	protected ArkGuardianShadowfangTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ark Guardian Shadowfang";
