 ...
 */
public class CatacombSerpentTemplate extends MonsterNPCTemplate {
	public static final int ID = 21141;

	@Inject
	protected CatacombSerpentTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Catacomb Serpent";
