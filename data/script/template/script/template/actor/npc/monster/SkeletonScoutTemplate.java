 ...
 */
public class SkeletonScoutTemplate extends MonsterNPCTemplate {
	public static final int ID = 20045;

	@Inject
	protected SkeletonScoutTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Skeleton Scout";
