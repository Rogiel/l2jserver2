 ...
 */
public class VampireSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 21582;

	@Inject
	protected VampireSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
