 ...
 */
public class CharmOfCorner5Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18200;

	@Inject
	protected CharmOfCorner5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
