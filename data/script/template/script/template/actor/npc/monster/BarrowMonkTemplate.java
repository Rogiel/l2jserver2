 ...
 */
public class BarrowMonkTemplate extends MonsterNPCTemplate {
	public static final int ID = 21237;

	@Inject
	protected BarrowMonkTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Barrow Monk";
