 ...
 */
public class HeathenExecutedTemplate extends MonsterNPCTemplate {
	public static final int ID = 21439;

	@Inject
	protected HeathenExecutedTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Heathen Executed";
