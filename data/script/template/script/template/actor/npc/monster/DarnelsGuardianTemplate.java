 ...
 */
public class DarnelsGuardianTemplate extends MonsterNPCTemplate {
	public static final int ID = 22302;

	@Inject
	protected DarnelsGuardianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Darnel's Guardian";
