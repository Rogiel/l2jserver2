 ...
 */
public class OfferingOfTheBranded2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18060;

	@Inject
	protected OfferingOfTheBranded2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
