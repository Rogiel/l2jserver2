 ...
 */
public class RakulTemplate extends MonsterNPCTemplate {
	public static final int ID = 20788;

	@Inject
	protected RakulTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
