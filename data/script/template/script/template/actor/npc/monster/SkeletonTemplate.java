 ...
 */
public class SkeletonTemplate extends MonsterNPCTemplate {
	public static final int ID = 20099;

	@Inject
	protected SkeletonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
