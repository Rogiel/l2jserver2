 ...
 */
public class GraveScarabTemplate extends MonsterNPCTemplate {
	public static final int ID = 21646;

	@Inject
	protected GraveScarabTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grave Scarab";
