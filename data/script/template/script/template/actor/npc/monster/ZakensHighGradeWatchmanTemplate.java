 ...
 */
public class ZakensHighGradeWatchmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 21610;

	@Inject
	protected ZakensHighGradeWatchmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Zaken's High Grade Watchman";
