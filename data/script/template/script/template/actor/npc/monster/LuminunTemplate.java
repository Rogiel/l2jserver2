 ...
 */
public class LuminunTemplate extends MonsterNPCTemplate {
	public static final int ID = 20949;

	@Inject
	protected LuminunTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
