 ...
 */
public class SuppliesSafe4Template extends MonsterNPCTemplate {
	public static final int ID = 36594;

	@Inject
	protected SuppliesSafe4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
