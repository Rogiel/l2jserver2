 ...
 */
public class WitchsOfferingZealot2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18085;

	@Inject
	protected WitchsOfferingZealot2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Witch's Offering Zealot";
		...
		attributes.physicalAttack = 355.21898;
		attributes.magicalAttack = 277.22116;
		attributes.physicalDefense = 194.14115;
