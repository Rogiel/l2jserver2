 ...
 */
public class UndeadSlaveTemplate extends MonsterNPCTemplate {
	public static final int ID = 20341;

	@Inject
	protected UndeadSlaveTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
