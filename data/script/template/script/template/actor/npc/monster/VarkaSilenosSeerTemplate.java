 ...
 */
public class VarkaSilenosSeerTemplate extends MonsterNPCTemplate {
	public static final int ID = 18648;

	@Inject
	protected VarkaSilenosSeerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
