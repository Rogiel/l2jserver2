 ...
 */
public class TreasuresOfTheFestival4Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18112;

	@Inject
	protected TreasuresOfTheFestival4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
