 ...
 */
public class StingerWaspTemplate extends MonsterNPCTemplate {
	public static final int ID = 20229;

	@Inject
	protected StingerWaspTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Stinger Wasp";
