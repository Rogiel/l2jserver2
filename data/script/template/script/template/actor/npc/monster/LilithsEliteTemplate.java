 ...
 */
public class LilithsEliteTemplate extends MonsterNPCTemplate {
	public static final int ID = 27387;

	@Inject
	protected LilithsEliteTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
