 ...
 */
public class NihilInvaderSoldier2Template extends MonsterNPCTemplate {
	public static final int ID = 22727;

	@Inject
	protected NihilInvaderSoldier2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nihil Invader Soldier";
