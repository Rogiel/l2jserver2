 ...
 */
public class HallowedSeerTemplate extends MonsterNPCTemplate {
	public static final int ID = 21209;

	@Inject
	protected HallowedSeerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hallowed Seer";
