 ...
 */
public class PhantomSalamanderTemplate extends MonsterNPCTemplate {
	public static final int ID = 27029;

	@Inject
	protected PhantomSalamanderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Phantom Salamander";
		...
		attributes.magicalDefense = 57.57804;
