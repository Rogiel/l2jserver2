 ...
 */
public class DragonSteedTroopCommander2Template extends MonsterNPCTemplate {
	public static final int ID = 22572;

	@Inject
	protected DragonSteedTroopCommander2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
