 ...
 */
public class FallenAngelHauresTemplate extends MonsterNPCTemplate {
	public static final int ID = 27266;

	@Inject
	protected FallenAngelHauresTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
