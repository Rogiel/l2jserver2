 ...
 */
public class NephilimSentinelTemplate extends MonsterNPCTemplate {
	public static final int ID = 21196;

	@Inject
	protected NephilimSentinelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nephilim Sentinel";
