 ...
 */
public class GhostOfBetrayerTemplate extends MonsterNPCTemplate {
	public static final int ID = 21570;

	@Inject
	protected GhostOfBetrayerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ghost of Betrayer";
