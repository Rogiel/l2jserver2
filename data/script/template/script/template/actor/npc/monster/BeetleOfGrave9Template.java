 ...
 */
public class BeetleOfGrave9Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18149;

	@Inject
	protected BeetleOfGrave9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
