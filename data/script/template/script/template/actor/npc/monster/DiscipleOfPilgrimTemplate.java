 ...
 */
public class DiscipleOfPilgrimTemplate extends MonsterNPCTemplate {
	public static final int ID = 21542;

	@Inject
	protected DiscipleOfPilgrimTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Disciple of Pilgrim";
