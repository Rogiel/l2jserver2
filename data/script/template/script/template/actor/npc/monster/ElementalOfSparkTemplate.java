 ...
 */
public class ElementalOfSparkTemplate extends MonsterNPCTemplate {
	public static final int ID = 25433;

	@Inject
	protected ElementalOfSparkTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Elemental of Spark";
