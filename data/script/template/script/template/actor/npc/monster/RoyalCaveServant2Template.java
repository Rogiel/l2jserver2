 ...
 */
public class RoyalCaveServant2Template extends MonsterNPCTemplate {
	public static final int ID = 20276;

	@Inject
	protected RoyalCaveServant2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Royal Cave Servant";
