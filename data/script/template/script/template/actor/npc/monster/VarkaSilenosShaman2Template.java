 ...
 */
public class VarkaSilenosShaman2Template extends MonsterNPCTemplate {
	public static final int ID = 21355;

	@Inject
	protected VarkaSilenosShaman2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Varka Silenos Shaman";
