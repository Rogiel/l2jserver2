 ...
 */
public class GlowWispTemplate extends MonsterNPCTemplate {
	public static final int ID = 21108;

	@Inject
	protected GlowWispTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
