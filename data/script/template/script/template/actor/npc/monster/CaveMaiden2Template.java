 ...
 */
public class CaveMaiden2Template extends MonsterNPCTemplate {
	public static final int ID = 20287;

	@Inject
	protected CaveMaiden2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
