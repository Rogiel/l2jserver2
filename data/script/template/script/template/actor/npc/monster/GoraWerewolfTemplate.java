 ...
 */
public class GoraWerewolfTemplate extends MonsterNPCTemplate {
	public static final int ID = 20012;

	@Inject
	protected GoraWerewolfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gora Werewolf";
