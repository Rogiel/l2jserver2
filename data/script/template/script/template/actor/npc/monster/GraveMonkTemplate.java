 ...
 */
public class GraveMonkTemplate extends MonsterNPCTemplate {
	public static final int ID = 21239;

	@Inject
	protected GraveMonkTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grave Monk";
