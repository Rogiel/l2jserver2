 ...
 */
public class CatacombBarbedBatTemplate extends MonsterNPCTemplate {
	public static final int ID = 21139;

	@Inject
	protected CatacombBarbedBatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Catacomb Barbed Bat";
