 ...
 */
public class BelethsMinion5Template extends MonsterNPCTemplate {
	public static final int ID = 22442;

	@Inject
	protected BelethsMinion5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
