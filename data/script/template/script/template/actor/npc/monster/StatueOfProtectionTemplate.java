 ...
 */
public class StatueOfProtectionTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18231;

	@Inject
	protected StatueOfProtectionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
