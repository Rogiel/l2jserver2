 ...
 */
public class MysteriousServitorTemplate extends MonsterNPCTemplate {
	public static final int ID = 27312;

	@Inject
	protected MysteriousServitorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mysterious Servitor";
