 ...
 */
public class HungeredCorpseTemplate extends MonsterNPCTemplate {
	public static final int ID = 20954;

	@Inject
	protected HungeredCorpseTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hungered Corpse";
