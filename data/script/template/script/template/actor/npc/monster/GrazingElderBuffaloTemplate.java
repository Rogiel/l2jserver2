 ...
 */
public class GrazingElderBuffaloTemplate extends MonsterNPCTemplate {
	public static final int ID = 21337;

	@Inject
	protected GrazingElderBuffaloTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grazing Elder Buffalo";
