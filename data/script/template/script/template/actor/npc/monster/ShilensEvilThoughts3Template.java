 ...
 */
public class ShilensEvilThoughts3Template extends MonsterNPCTemplate {
	public static final int ID = 27343;

	@Inject
	protected ShilensEvilThoughts3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
