 ...
 */
public class PirateZombieCaptainTemplate extends MonsterNPCTemplate {
	public static final int ID = 21629;

	@Inject
	protected PirateZombieCaptainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
