 ...
 */
public class TurekOrcFootmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20499;

	@Inject
	protected TurekOrcFootmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Turek Orc Footman";
