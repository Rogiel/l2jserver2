 ...
 */
public class AlligatorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20135;

	@Inject
	protected AlligatorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
