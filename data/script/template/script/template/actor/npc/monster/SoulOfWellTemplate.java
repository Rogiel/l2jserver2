 ...
 */
public class SoulOfWellTemplate extends MonsterNPCTemplate {
	public static final int ID = 27217;

	@Inject
	protected SoulOfWellTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Soul of Well";
