 ...
 */
public class VarkaSilenosScout2Template extends MonsterNPCTemplate {
	public static final int ID = 21353;

	@Inject
	protected VarkaSilenosScout2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
