 ...
 */
public class SusceptorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20412;

	@Inject
	protected SusceptorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
