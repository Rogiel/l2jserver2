 ...
 */
public class FallenAngelHaures2Template extends MonsterNPCTemplate {
	public static final int ID = 27267;

	@Inject
	protected FallenAngelHaures2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fallen Angel Haures";
