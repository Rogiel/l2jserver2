 ...
 */
public class SkullAnimatorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21566;

	@Inject
	protected SkullAnimatorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Skull Animator";
