 ...
 */
public class RagingSpartoiTemplate extends MonsterNPCTemplate {
	public static final int ID = 20060;

	@Inject
	protected RagingSpartoiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Raging Spartoi";
