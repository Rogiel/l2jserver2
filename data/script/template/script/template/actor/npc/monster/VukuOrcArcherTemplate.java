 ...
 */
public class VukuOrcArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20011;

	@Inject
	protected VukuOrcArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vuku Orc Archer";
