 ...
 */
public class HallatesDancerLillianTemplate extends MonsterNPCTemplate {
	public static final int ID = 27272;

	@Inject
	protected HallatesDancerLillianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hallate's Dancer Lillian";
