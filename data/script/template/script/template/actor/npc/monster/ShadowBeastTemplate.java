 ...
 */
public class ShadowBeastTemplate extends MonsterNPCTemplate {
	public static final int ID = 20023;

	@Inject
	protected ShadowBeastTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shadow Beast";
