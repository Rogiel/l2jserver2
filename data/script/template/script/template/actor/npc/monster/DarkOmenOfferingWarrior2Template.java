 ...
 */
public class DarkOmenOfferingWarrior2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18092;

	@Inject
	protected DarkOmenOfferingWarrior2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Omen Offering Warrior";
