 ...
 */
public class HalfMoonLoveTemplate extends MonsterNPCTemplate {
	public static final int ID = 31004;

	@Inject
	protected HalfMoonLoveTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Half Moon Love";
