 ...
 */
public class VampireMagister3Template extends MonsterNPCTemplate {
	public static final int ID = 21592;

	@Inject
	protected VampireMagister3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
