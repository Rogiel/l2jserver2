 ...
 */
public class DeluChiefKalkisTemplate extends MonsterNPCTemplate {
	public static final int ID = 27093;

	@Inject
	protected DeluChiefKalkisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Delu Chief Kalkis";
