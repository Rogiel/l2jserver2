 ...
 */
public class WitchOfDust4Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18194;

	@Inject
	protected WitchOfDust4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
