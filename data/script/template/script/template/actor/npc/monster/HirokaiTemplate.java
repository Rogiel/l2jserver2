 ...
 */
public class HirokaiTemplate extends MonsterNPCTemplate {
	public static final int ID = 22673;

	@Inject
	protected HirokaiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
