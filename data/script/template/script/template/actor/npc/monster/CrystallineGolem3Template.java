 ...
 */
public class CrystallineGolem3Template extends MonsterNPCTemplate {
	public static final int ID = 29105;

	@Inject
	protected CrystallineGolem3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
