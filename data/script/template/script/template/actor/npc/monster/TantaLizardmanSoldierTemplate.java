 ...
 */
public class TantaLizardmanSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 22770;

	@Inject
	protected TantaLizardmanSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tanta Lizardman Soldier";
