 ...
 */
public class VarkasHeadGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 18655;

	@Inject
	protected VarkasHeadGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Varka's Head Guard";
		...
		attributes.physicalAttack = 428.24300;
