 ...
 */
public class OrcChampionTemplate extends MonsterNPCTemplate {
	public static final int ID = 20260;

	@Inject
	protected OrcChampionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Orc Champion";
