 ...
 */
public class GuardianOfPredictionTemplate extends MonsterNPCTemplate {
	public static final int ID = 18361;

	@Inject
	protected GuardianOfPredictionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guardian of Prediction";
