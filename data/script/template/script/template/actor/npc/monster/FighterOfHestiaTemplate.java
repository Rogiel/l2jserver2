 ...
 */
public class FighterOfHestiaTemplate extends MonsterNPCTemplate {
	public static final int ID = 25294;

	@Inject
	protected FighterOfHestiaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fighter of Hestia";
