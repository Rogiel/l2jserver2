 ...
 */
public class GuardOfTheGrailTemplate extends MonsterNPCTemplate {
	public static final int ID = 25702;

	@Inject
	protected GuardOfTheGrailTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guard of the Grail";
