 ...
 */
public class MailleLizardmanMatriarchTemplate extends MonsterNPCTemplate {
	public static final int ID = 20924;

	@Inject
	protected MailleLizardmanMatriarchTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Maille Lizardman Matriarch";
		...
		this.experience = 1025;
		this.sp = 56;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(69);
		this.leftHand = itemProvider.createID(627);
		this.enchantLevel = 0;
