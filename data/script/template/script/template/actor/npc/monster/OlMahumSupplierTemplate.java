 ...
 */
public class OlMahumSupplierTemplate extends MonsterNPCTemplate {
	public static final int ID = 20436;

	@Inject
	protected OlMahumSupplierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ol Mahum Supplier";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 14.00;
		this.collisionHeight = 29.20;
		this.level = 23;
