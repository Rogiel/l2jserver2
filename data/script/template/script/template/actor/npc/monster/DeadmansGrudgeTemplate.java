 ...
 */
public class DeadmansGrudgeTemplate extends MonsterNPCTemplate {
	public static final int ID = 18624;

	@Inject
	protected DeadmansGrudgeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
