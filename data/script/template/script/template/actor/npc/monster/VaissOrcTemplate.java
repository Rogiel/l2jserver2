 ...
 */
public class VaissOrcTemplate extends MonsterNPCTemplate {
	public static final int ID = 20381;

	@Inject
	protected VaissOrcTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
