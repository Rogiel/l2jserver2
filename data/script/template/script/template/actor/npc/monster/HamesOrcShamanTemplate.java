 ...
 */
public class HamesOrcShamanTemplate extends MonsterNPCTemplate {
	public static final int ID = 21115;

	@Inject
	protected HamesOrcShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hames Orc Shaman";
