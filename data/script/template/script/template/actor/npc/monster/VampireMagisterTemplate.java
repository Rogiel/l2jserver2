 ...
 */
public class VampireMagisterTemplate extends MonsterNPCTemplate {
	public static final int ID = 21590;

	@Inject
	protected VampireMagisterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
