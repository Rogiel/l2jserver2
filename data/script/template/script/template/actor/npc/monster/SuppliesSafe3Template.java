 ...
 */
public class SuppliesSafe3Template extends MonsterNPCTemplate {
	public static final int ID = 36593;

	@Inject
	protected SuppliesSafe3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
