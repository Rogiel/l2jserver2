 ...
 */
public class YoungGigantiopsTemplate extends MonsterNPCTemplate {
	public static final int ID = 20746;

	@Inject
	protected YoungGigantiopsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Young Gigantiops";
