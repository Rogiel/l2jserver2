 ...
 */
public class RaiderOfPasturelandTemplate extends MonsterNPCTemplate {
	public static final int ID = 21443;

	@Inject
	protected RaiderOfPasturelandTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
