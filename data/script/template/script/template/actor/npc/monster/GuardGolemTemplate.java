 ...
 */
public class GuardGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 22809;

	@Inject
	protected GuardGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guard Golem";
