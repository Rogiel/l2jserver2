 ...
 */
public class ShamanOfDarkness2Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18221;

	@Inject
	protected ShamanOfDarkness2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
