 ...
 */
public class LostGargoyleYounglingTemplate extends MonsterNPCTemplate {
	public static final int ID = 22086;

	@Inject
	protected LostGargoyleYounglingTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lost Gargoyle Youngling";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 17.50;
