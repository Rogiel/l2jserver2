 ...
 */
public class SuccubusHandmaidenTemplate extends MonsterNPCTemplate {
	public static final int ID = 27192;

	@Inject
	protected SuccubusHandmaidenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Succubus Handmaiden";
