 ...
 */
public class CanyonAntelopeSlaveTemplate extends MonsterNPCTemplate {
	public static final int ID = 21295;

	@Inject
	protected CanyonAntelopeSlaveTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Canyon Antelope Slave";
