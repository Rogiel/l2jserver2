 ...
 */
public class LesserGiantScoutTemplate extends MonsterNPCTemplate {
	public static final int ID = 20656;

	@Inject
	protected LesserGiantScoutTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
