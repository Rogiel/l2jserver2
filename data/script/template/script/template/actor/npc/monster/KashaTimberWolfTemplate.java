 ...
 */
public class KashaTimberWolfTemplate extends MonsterNPCTemplate {
	public static final int ID = 20477;

	@Inject
	protected KashaTimberWolfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kasha Timber Wolf";
