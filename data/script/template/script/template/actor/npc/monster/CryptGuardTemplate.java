 ...
 */
public class CryptGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 21252;

	@Inject
	protected CryptGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Crypt Guard";
