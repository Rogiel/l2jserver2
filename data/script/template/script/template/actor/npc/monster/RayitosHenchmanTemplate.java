 ...
 */
public class RayitosHenchmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 25507;

	@Inject
	protected RayitosHenchmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 11740.947836113800000;
		...
		attributes.physicalAttack = 705.82255;
		attributes.magicalAttack = 224.63892;
