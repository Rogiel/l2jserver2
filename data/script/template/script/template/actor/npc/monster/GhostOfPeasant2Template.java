 ...
 */
public class GhostOfPeasant2Template extends MonsterNPCTemplate {
	public static final int ID = 25015;

	@Inject
	protected GhostOfPeasant2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
