 ...
 */
public class UndergroundKoboldTemplate extends MonsterNPCTemplate {
	public static final int ID = 21132;

	@Inject
	protected UndergroundKoboldTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Underground Kobold";
