 ...
 */
public class AssassinOfDarkness3Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18224;

	@Inject
	protected AssassinOfDarkness3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
