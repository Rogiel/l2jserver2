 ...
 */
public class WildStrider2Template extends MonsterNPCTemplate {
	public static final int ID = 22212;

	@Inject
	protected WildStrider2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
