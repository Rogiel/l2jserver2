 ...
 */
public class CaveBeastTemplate extends MonsterNPCTemplate {
	public static final int ID = 20620;

	@Inject
	protected CaveBeastTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cave Beast";
