 ...
 */
public class JudgeOfFireTemplate extends MonsterNPCTemplate {
	public static final int ID = 21545;

	@Inject
	protected JudgeOfFireTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Judge of Fire";
