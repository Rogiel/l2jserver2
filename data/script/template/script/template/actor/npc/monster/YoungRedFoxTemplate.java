 ...
 */
public class YoungRedFoxTemplate extends MonsterNPCTemplate {
	public static final int ID = 20406;

	@Inject
	protected YoungRedFoxTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Young Red Fox";
