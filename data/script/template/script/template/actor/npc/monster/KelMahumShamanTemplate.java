 ...
 */
public class KelMahumShamanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20856;

	@Inject
	protected KelMahumShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kel Mahum Shaman";
