 ...
 */
public class ElderBrownKeltirTemplate extends MonsterNPCTemplate {
	public static final int ID = 20536;

	@Inject
	protected ElderBrownKeltirTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Elder Brown Keltir";
