 ...
 */
public class CaveBasiliskTemplate extends MonsterNPCTemplate {
	public static final int ID = 27111;

	@Inject
	protected CaveBasiliskTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cave Basilisk";
