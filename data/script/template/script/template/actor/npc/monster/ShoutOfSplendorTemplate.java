 ...
 */
public class ShoutOfSplendorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21532;

	@Inject
	protected ShoutOfSplendorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shout of Splendor";
