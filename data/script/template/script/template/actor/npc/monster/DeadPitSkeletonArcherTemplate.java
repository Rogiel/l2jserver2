 ...
 */
public class DeadPitSkeletonArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 21133;

	@Inject
	protected DeadPitSkeletonArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dead Pit Skeleton Archer";
		...
		this.experience = 1022;
		this.sp = 52;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(274);
		this.leftHand = null;
		this.enchantLevel = 0;
