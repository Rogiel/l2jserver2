 ...
 */
public class LizardmanWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 27032;

	@Inject
	protected LizardmanWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
