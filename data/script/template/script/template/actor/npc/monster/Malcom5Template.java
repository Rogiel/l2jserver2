 ...
 */
public class Malcom5Template extends MonsterNPCTemplate {
	public static final int ID = 30940;

	@Inject
	protected Malcom5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Malcom5";
		this.serverSideName = false;
		this.title = "Gremlin Prince";
