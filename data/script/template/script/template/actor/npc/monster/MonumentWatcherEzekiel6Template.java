 ...
 */
public class MonumentWatcherEzekiel6Template extends MonsterNPCTemplate {
	public static final int ID = 27301;

	@Inject
	protected MonumentWatcherEzekiel6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
