 ...
 */
public class DominantGreyKeltirTemplate extends MonsterNPCTemplate {
	public static final int ID = 22231;

	@Inject
	protected DominantGreyKeltirTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dominant Grey Keltir";
