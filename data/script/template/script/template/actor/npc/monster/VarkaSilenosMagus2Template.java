 ...
 */
public class VarkaSilenosMagus2Template extends MonsterNPCTemplate {
	public static final int ID = 21361;

	@Inject
	protected VarkaSilenosMagus2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
