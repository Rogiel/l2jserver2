 ...
 */
public class ZakensElitePikemanTemplate extends MonsterNPCTemplate {
	public static final int ID = 21604;

	@Inject
	protected ZakensElitePikemanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Zaken's Elite Pikeman";
