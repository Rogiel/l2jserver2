 ...
 */
public class GraveSeerTemplate extends MonsterNPCTemplate {
	public static final int ID = 21235;

	@Inject
	protected GraveSeerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grave Seer";
