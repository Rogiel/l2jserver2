 ...
 */
public class SpikedStakatoNurse2Template extends MonsterNPCTemplate {
	public static final int ID = 22119;

	@Inject
	protected SpikedStakatoNurse2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
