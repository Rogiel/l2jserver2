 ...
 */
public class BarifsPet2Template extends MonsterNPCTemplate {
	public static final int ID = 22667;

	@Inject
	protected BarifsPet2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
