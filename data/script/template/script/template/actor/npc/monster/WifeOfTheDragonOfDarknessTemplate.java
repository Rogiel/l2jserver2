 ...
 */
public class WifeOfTheDragonOfDarknessTemplate extends MonsterNPCTemplate {
	public static final int ID = 22545;

	@Inject
	protected WifeOfTheDragonOfDarknessTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Wife of the Dragon of Darkness";
