 ...
 */
public class KrudelLizardmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 27132;

	@Inject
	protected KrudelLizardmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
