 ...
 */
public class KirionaTemplate extends MonsterNPCTemplate {
	public static final int ID = 22761;

	@Inject
	protected KirionaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
