 ...
 */
public class RequiemLordTemplate extends MonsterNPCTemplate {
	public static final int ID = 21596;

	@Inject
	protected RequiemLordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Requiem Lord";
