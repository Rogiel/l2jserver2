 ...
 */
public class SelMahumSoldier2Template extends MonsterNPCTemplate {
	public static final int ID = 22783;

	@Inject
	protected SelMahumSoldier2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
