 ...
 */
public class CaveServantWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20238;

	@Inject
	protected CaveServantWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cave Servant Warrior";
		...
		this.experience = 4785;
		this.sp = 349;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(77);
		this.leftHand = itemProvider.createID(2495);
		this.enchantLevel = 0;
