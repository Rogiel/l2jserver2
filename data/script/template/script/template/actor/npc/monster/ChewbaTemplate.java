 ...
 */
public class ChewbaTemplate extends MonsterNPCTemplate {
	public static final int ID = 27048;

	@Inject
	protected ChewbaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
