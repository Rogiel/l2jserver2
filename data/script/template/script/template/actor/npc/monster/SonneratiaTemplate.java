 ...
 */
public class SonneratiaTemplate extends MonsterNPCTemplate {
	public static final int ID = 22263;

	@Inject
	protected SonneratiaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sonneratia";
