 ...
 */
public class BhatoBloodspearTemplate extends MonsterNPCTemplate {
	public static final int ID = 27006;

	@Inject
	protected BhatoBloodspearTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bhato Bloodspear";
