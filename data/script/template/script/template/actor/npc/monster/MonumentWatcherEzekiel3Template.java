 ...
 */
public class MonumentWatcherEzekiel3Template extends MonsterNPCTemplate {
	public static final int ID = 27298;

	@Inject
	protected MonumentWatcherEzekiel3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
