 ...
 */
public class DefeatedTroopsJavelinThrowerTemplate extends MonsterNPCTemplate {
	public static final int ID = 18791;

	@Inject
	protected DefeatedTroopsJavelinThrowerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
