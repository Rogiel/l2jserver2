 ...
 */
public class SelMahumRecruitTemplate extends MonsterNPCTemplate {
	public static final int ID = 22780;

	@Inject
	protected SelMahumRecruitTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
