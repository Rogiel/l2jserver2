 ...
 */
public class BoneShaperTemplate extends MonsterNPCTemplate {
	public static final int ID = 21560;

	@Inject
	protected BoneShaperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bone Shaper";
