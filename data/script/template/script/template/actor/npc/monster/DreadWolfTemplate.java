 ...
 */
public class DreadWolfTemplate extends MonsterNPCTemplate {
	public static final int ID = 20783;

	@Inject
	protected DreadWolfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
