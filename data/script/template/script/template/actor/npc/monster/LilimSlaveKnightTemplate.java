 ...
 */
public class LilimSlaveKnightTemplate extends MonsterNPCTemplate {
	public static final int ID = 27355;

	@Inject
	protected LilimSlaveKnightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lilim Slave Knight";
