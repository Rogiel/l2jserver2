 ...
 */
public class CorruptSageTemplate extends MonsterNPCTemplate {
	public static final int ID = 20817;

	@Inject
	protected CorruptSageTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Corrupt Sage";
