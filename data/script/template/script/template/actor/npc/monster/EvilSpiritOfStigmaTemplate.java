 ...
 */
public class EvilSpiritOfStigmaTemplate extends MonsterNPCTemplate {
	public static final int ID = 25279;

	@Inject
	protected EvilSpiritOfStigmaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Evil Spirit of Stigma";
		...
		this.attackRange = 40;
		this.maxHP = 16259.556802774600000;
