 ...
 */
public class LilimButcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 21175;

	@Inject
	protected LilimButcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
