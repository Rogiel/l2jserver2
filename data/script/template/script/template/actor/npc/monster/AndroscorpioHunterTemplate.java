 ...
 */
public class AndroscorpioHunterTemplate extends MonsterNPCTemplate {
	public static final int ID = 20077;

	@Inject
	protected AndroscorpioHunterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Androscorpio Hunter";
