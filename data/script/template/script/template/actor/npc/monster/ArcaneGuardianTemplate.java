 ...
 */
public class ArcaneGuardianTemplate extends MonsterNPCTemplate {
	public static final int ID = 22328;

	@Inject
	protected ArcaneGuardianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Arcane Guardian";
