 ...
 */
public class GuideSolinaTemplate extends MonsterNPCTemplate {
	public static final int ID = 22789;

	@Inject
	protected GuideSolinaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guide Solina";
