 ...
 */
public class SepulcherSageTemplate extends MonsterNPCTemplate {
	public static final int ID = 21225;

	@Inject
	protected SepulcherSageTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sepulcher Sage";
		...
		this.experience = 16680;
		this.sp = 1486;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(311);
		this.leftHand = null;
		this.enchantLevel = 0;
