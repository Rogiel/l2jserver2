 ...
 */
public class FairyTreeOfAbyssTemplate extends MonsterNPCTemplate {
	public static final int ID = 27188;

	@Inject
	protected FairyTreeOfAbyssTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fairy Tree of Abyss";
