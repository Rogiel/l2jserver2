 ...
 */
public class BlazingIfrit2Template extends MonsterNPCTemplate {
	public static final int ID = 22648;

	@Inject
	protected BlazingIfrit2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Blazing Ifrit";
