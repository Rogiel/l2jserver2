 ...
 */
public class KnightOfEmpire2Template extends MonsterNPCTemplate {
	public static final int ID = 21407;

	@Inject
	protected KnightOfEmpire2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Knight of Empire";
