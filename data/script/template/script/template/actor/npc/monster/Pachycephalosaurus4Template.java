 ...
 */
public class Pachycephalosaurus4Template extends MonsterNPCTemplate {
	public static final int ID = 22221;

	@Inject
	protected Pachycephalosaurus4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
