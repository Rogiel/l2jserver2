 ...
 */
public class BehemothDragonTemplate extends MonsterNPCTemplate {
	public static final int ID = 29069;

	@Inject
	protected BehemothDragonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Behemoth Dragon";
