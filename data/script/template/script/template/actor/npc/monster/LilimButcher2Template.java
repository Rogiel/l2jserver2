 ...
 */
public class LilimButcher2Template extends MonsterNPCTemplate {
	public static final int ID = 27353;

	@Inject
	protected LilimButcher2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lilim Butcher";
		...
		this.leftHand = itemProvider.createID(232);
		this.enchantLevel = 0;
