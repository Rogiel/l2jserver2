 ...
 */
public class Shackle2Template extends MonsterNPCTemplate {
	public static final int ID = 20279;

	@Inject
	protected Shackle2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
