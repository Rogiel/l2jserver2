 ...
 */
public class BloomTemplate extends MonsterNPCTemplate {
	public static final int ID = 18616;

	@Inject
	protected BloomTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
