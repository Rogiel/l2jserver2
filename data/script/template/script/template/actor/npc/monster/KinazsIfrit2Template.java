 ...
 */
public class KinazsIfrit2Template extends MonsterNPCTemplate {
	public static final int ID = 29039;

	@Inject
	protected KinazsIfrit2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kinaz's Ifrit";
