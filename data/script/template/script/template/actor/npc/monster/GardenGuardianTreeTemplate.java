 ...
 */
public class GardenGuardianTreeTemplate extends MonsterNPCTemplate {
	public static final int ID = 22316;

	@Inject
	protected GardenGuardianTreeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Garden Guardian Tree";
