 ...
 */
public class KertangsMessenger2Template extends MonsterNPCTemplate {
	public static final int ID = 22444;

	@Inject
	protected KertangsMessenger2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
