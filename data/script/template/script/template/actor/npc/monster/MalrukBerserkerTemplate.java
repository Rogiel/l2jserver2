 ...
 */
public class MalrukBerserkerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20626;

	@Inject
	protected MalrukBerserkerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Malruk Berserker";
