 ...
 */
public class OrcWarriorLeaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 27019;

	@Inject
	protected OrcWarriorLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Orc Warrior Leader";
