 ...
 */
public class RemmelsArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 25042;

	@Inject
	protected RemmelsArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Remmel's Archer";
