 ...
 */
public class UndineNobleTemplate extends MonsterNPCTemplate {
	public static final int ID = 20115;

	@Inject
	protected UndineNobleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Undine Noble";
