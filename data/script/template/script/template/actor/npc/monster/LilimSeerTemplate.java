 ...
 */
public class LilimSeerTemplate extends MonsterNPCTemplate {
	public static final int ID = 27357;

	@Inject
	protected LilimSeerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lilim Seer";
