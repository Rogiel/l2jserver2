 ...
 */
public class ImperialMosaicTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18133;

	@Inject
	protected ImperialMosaicTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
