 ...
 */
public class ShadeHorrorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20033;

	@Inject
	protected ShadeHorrorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shade Horror";
