 ...
 */
public class SkeletalMercenaryTemplate extends MonsterNPCTemplate {
	public static final int ID = 27100;

	@Inject
	protected SkeletalMercenaryTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Skeletal Mercenary";
		...
		attributes.magicalDefense = 111.56912;
