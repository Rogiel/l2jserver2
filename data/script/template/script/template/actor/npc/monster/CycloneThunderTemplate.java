 ...
 */
public class CycloneThunderTemplate extends MonsterNPCTemplate {
	public static final int ID = 31009;

	@Inject
	protected CycloneThunderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cyclone Thunder";
