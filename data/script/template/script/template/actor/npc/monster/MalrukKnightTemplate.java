 ...
 */
public class MalrukKnightTemplate extends MonsterNPCTemplate {
	public static final int ID = 20625;

	@Inject
	protected MalrukKnightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Malruk Knight";
