 ...
 */
public class GremlinFilcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 27149;

	@Inject
	protected GremlinFilcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gremlin Filcher";
