 ...
 */
public class GhostOfABaturChiefTemplate extends MonsterNPCTemplate {
	public static final int ID = 22011;

	@Inject
	protected GhostOfABaturChiefTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ghost of a Batur Chief";
		...
		this.experience = 2337;
		this.sp = 133;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(8533);
		this.leftHand = null;
		this.enchantLevel = 0;
