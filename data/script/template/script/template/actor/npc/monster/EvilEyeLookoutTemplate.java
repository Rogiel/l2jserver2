 ...
 */
public class EvilEyeLookoutTemplate extends MonsterNPCTemplate {
	public static final int ID = 20429;

	@Inject
	protected EvilEyeLookoutTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Evil Eye Lookout";
