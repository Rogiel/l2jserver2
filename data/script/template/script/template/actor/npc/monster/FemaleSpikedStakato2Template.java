 ...
 */
public class FemaleSpikedStakato2Template extends MonsterNPCTemplate {
	public static final int ID = 22620;

	@Inject
	protected FemaleSpikedStakato2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Female Spiked Stakato";
