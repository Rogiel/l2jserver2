 ...
 */
public class BloodyLordTemplate extends MonsterNPCTemplate {
	public static final int ID = 20963;

	@Inject
	protected BloodyLordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
