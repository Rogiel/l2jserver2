 ...
 */
public class RakinSalamanderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20609;

	@Inject
	protected RakinSalamanderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rakin Salamander";
