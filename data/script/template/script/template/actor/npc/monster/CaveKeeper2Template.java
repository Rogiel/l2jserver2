 ...
 */
public class CaveKeeper2Template extends MonsterNPCTemplate {
	public static final int ID = 20277;

	@Inject
	protected CaveKeeper2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cave Keeper";
		...
		attributes.magicalDefense = 158.45929;
