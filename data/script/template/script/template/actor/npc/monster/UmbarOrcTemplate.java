 ...
 */
public class UmbarOrcTemplate extends MonsterNPCTemplate {
	public static final int ID = 27054;

	@Inject
	protected UmbarOrcTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
