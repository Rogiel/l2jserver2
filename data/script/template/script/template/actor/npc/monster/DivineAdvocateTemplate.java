 ...
 */
public class DivineAdvocateTemplate extends MonsterNPCTemplate {
	public static final int ID = 22130;

	@Inject
	protected DivineAdvocateTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Divine Advocate";
