 ...
 */
public class KaimVanul2Template extends MonsterNPCTemplate {
	public static final int ID = 21626;

	@Inject
	protected KaimVanul2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kaim Vanul";
