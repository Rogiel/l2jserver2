 ...
 */
public class GuardOfHauresTemplate extends MonsterNPCTemplate {
	public static final int ID = 27268;

	@Inject
	protected GuardOfHauresTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guard of Haures";
