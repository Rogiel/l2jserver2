 ...
 */
public class GarangkyGuardShamanTemplate extends MonsterNPCTemplate {
	public static final int ID = 25465;

	@Inject
	protected GarangkyGuardShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Garangky Guard Shaman";
