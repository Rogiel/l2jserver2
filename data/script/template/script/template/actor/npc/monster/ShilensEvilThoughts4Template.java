 ...
 */
public class ShilensEvilThoughts4Template extends MonsterNPCTemplate {
	public static final int ID = 27344;

	@Inject
	protected ShilensEvilThoughts4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
