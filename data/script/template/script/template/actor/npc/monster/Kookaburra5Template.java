 ...
 */
public class Kookaburra5Template extends MonsterNPCTemplate {
	public static final int ID = 21276;

	@Inject
	protected Kookaburra5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
