 ...
 */
public class PantheraTemplate extends MonsterNPCTemplate {
	public static final int ID = 22084;

	@Inject
	protected PantheraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
