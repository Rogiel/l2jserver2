 ...
 */
public class FemaleSpikedStakatoTemplate extends MonsterNPCTemplate {
	public static final int ID = 22108;

	@Inject
	protected FemaleSpikedStakatoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
