 ...
 */
public class SpikedStakatoCaptain2Template extends MonsterNPCTemplate {
	public static final int ID = 22629;

	@Inject
	protected SpikedStakatoCaptain2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Spiked Stakato Captain";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 14.00;
		this.collisionHeight = 29.10;
		this.level = 83;
