 ...
 */
public class ZakensArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20833;

	@Inject
	protected ZakensArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
