 ...
 */
public class VampireWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21587;

	@Inject
	protected VampireWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vampire Warrior";
