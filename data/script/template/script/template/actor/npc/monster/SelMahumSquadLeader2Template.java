 ...
 */
public class SelMahumSquadLeader2Template extends MonsterNPCTemplate {
	public static final int ID = 22787;

	@Inject
	protected SelMahumSquadLeader2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sel Mahum Squad Leader";
