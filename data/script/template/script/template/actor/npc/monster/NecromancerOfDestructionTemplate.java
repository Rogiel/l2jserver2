 ...
 */
public class NecromancerOfDestructionTemplate extends MonsterNPCTemplate {
	public static final int ID = 21384;

	@Inject
	protected NecromancerOfDestructionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
