 ...
 */
public class CosmicPriestTemplate extends MonsterNPCTemplate {
	public static final int ID = 22375;

	@Inject
	protected CosmicPriestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cosmic Priest";
