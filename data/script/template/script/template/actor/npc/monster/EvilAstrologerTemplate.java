 ...
 */
public class EvilAstrologerTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18185;

	@Inject
	protected EvilAstrologerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Evil Astrologer";
