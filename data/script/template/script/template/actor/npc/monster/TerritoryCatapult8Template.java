 ...
 */
public class TerritoryCatapult8Template extends MonsterNPCTemplate {
	public static final int ID = 36506;

	@Inject
	protected TerritoryCatapult8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
