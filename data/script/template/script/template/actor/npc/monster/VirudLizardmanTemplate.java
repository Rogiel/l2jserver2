 ...
 */
public class VirudLizardmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20293;

	@Inject
	protected VirudLizardmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Virud Lizardman";
