 ...
 */
public class HallowedSentinelTemplate extends MonsterNPCTemplate {
	public static final int ID = 21212;

	@Inject
	protected HallowedSentinelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hallowed Sentinel";
