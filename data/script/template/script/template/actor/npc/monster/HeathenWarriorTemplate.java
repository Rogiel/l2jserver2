 ...
 */
public class HeathenWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21438;

	@Inject
	protected HeathenWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Heathen Warrior";
