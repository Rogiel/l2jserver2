 ...
 */
public class Ornithomimus4Template extends MonsterNPCTemplate {
	public static final int ID = 22219;

	@Inject
	protected Ornithomimus4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
