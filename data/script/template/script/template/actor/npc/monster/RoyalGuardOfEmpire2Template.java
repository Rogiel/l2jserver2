 ...
 */
public class RoyalGuardOfEmpire2Template extends MonsterNPCTemplate {
	public static final int ID = 21409;

	@Inject
	protected RoyalGuardOfEmpire2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Royal Guard of Empire";
		...
		this.experience = 41142;
		this.sp = 4618;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(304);
		this.leftHand = null;
		this.enchantLevel = 0;
