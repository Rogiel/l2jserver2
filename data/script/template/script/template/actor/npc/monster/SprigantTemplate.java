 ...
 */
public class SprigantTemplate extends MonsterNPCTemplate {
	public static final int ID = 18345;

	@Inject
	protected SprigantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
