 ...
 */
public class SnipeTemplate extends MonsterNPCTemplate {
	public static final int ID = 20751;

	@Inject
	protected SnipeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
