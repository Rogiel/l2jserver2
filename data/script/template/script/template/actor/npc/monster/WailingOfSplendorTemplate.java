 ...
 */
public class WailingOfSplendorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21539;

	@Inject
	protected WailingOfSplendorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Wailing of Splendor";
