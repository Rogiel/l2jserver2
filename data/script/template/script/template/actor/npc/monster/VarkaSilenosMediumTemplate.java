 ...
 */
public class VarkaSilenosMediumTemplate extends MonsterNPCTemplate {
	public static final int ID = 18644;

	@Inject
	protected VarkaSilenosMediumTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
