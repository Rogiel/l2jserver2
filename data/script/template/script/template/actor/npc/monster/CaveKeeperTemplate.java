 ...
 */
public class CaveKeeperTemplate extends MonsterNPCTemplate {
	public static final int ID = 20246;

	@Inject
	protected CaveKeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
