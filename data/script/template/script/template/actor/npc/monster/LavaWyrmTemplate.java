 ...
 */
public class LavaWyrmTemplate extends MonsterNPCTemplate {
	public static final int ID = 21111;

	@Inject
	protected LavaWyrmTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
