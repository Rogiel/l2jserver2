 ...
 */
public class MiserySkeletonTemplate extends MonsterNPCTemplate {
	public static final int ID = 20022;

	@Inject
	protected MiserySkeletonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Misery Skeleton";
