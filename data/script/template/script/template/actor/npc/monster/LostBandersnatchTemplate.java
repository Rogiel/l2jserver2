 ...
 */
public class LostBandersnatchTemplate extends MonsterNPCTemplate {
	public static final int ID = 22079;

	@Inject
	protected LostBandersnatchTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lost Bandersnatch";
