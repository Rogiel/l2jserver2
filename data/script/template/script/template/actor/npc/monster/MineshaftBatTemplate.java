 ...
 */
public class MineshaftBatTemplate extends MonsterNPCTemplate {
	public static final int ID = 20330;

	@Inject
	protected MineshaftBatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mineshaft Bat";
