 ...
 */
public class DarkOmenOfferingMarksmanTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18046;

	@Inject
	protected DarkOmenOfferingMarksmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
