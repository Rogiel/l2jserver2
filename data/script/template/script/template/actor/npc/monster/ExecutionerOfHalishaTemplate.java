 ...
 */
public class ExecutionerOfHalishaTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18158;

	@Inject
	protected ExecutionerOfHalishaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
