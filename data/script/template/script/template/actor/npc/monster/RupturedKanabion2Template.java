 ...
 */
public class RupturedKanabion2Template extends MonsterNPCTemplate {
	public static final int ID = 22480;

	@Inject
	protected RupturedKanabion2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ruptured Kanabion";
