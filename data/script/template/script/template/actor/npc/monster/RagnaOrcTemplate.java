 ...
 */
public class RagnaOrcTemplate extends MonsterNPCTemplate {
	public static final int ID = 22029;

	@Inject
	protected RagnaOrcTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
