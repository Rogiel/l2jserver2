 ...
 */
public class HallatesKnightTemplate extends MonsterNPCTemplate {
	public static final int ID = 20820;

	@Inject
	protected HallatesKnightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hallate's Knight";
