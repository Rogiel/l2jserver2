 ...
 */
public class DecayedAncientSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 21150;

	@Inject
	protected DecayedAncientSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Decayed Ancient Soldier";
