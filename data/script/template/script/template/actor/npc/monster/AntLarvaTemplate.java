 ...
 */
public class AntLarvaTemplate extends MonsterNPCTemplate {
	public static final int ID = 20075;

	@Inject
	protected AntLarvaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
