 ...
 */
public class PortaTemplate extends MonsterNPCTemplate {
	public static final int ID = 20213;

	@Inject
	protected PortaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
