 ...
 */
public class BoneMakerTemplate extends MonsterNPCTemplate {
	public static final int ID = 21559;

	@Inject
	protected BoneMakerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bone Maker";
