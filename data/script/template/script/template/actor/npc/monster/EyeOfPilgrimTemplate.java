 ...
 */
public class EyeOfPilgrimTemplate extends MonsterNPCTemplate {
	public static final int ID = 21305;

	@Inject
	protected EyeOfPilgrimTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Eye of Pilgrim";
