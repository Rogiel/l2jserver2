 ...
 */
public class SobbingWindTemplate extends MonsterNPCTemplate {
	public static final int ID = 21023;

	@Inject
	protected SobbingWindTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sobbing Wind";
