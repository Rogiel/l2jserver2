 ...
 */
public class DoormanOfHell2Template extends MonsterNPCTemplate {
	public static final int ID = 35418;

	@Inject
	protected DoormanOfHell2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Doorman of Hell";
