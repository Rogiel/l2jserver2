 ...
 */
public class OlMahumBetrayerTemplate extends MonsterNPCTemplate {
	public static final int ID = 27130;

	@Inject
	protected OlMahumBetrayerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ol Mahum Betrayer";
