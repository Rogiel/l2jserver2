 ...
 */
public class FollowerOfOtisTemplate extends MonsterNPCTemplate {
	public static final int ID = 18563;

	@Inject
	protected FollowerOfOtisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Follower of Otis";
