 ...
 */
public class FormorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20568;

	@Inject
	protected FormorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
