 ...
 */
public class LilimCourtKnightTemplate extends MonsterNPCTemplate {
	public static final int ID = 21186;

	@Inject
	protected LilimCourtKnightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lilim Court Knight";
