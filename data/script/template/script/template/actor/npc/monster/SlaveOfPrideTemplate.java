 ...
 */
public class SlaveOfPrideTemplate extends MonsterNPCTemplate {
	public static final int ID = 22429;

	@Inject
	protected SlaveOfPrideTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
