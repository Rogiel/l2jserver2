 ...
 */
public class GraveRobberWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 22681;

	@Inject
	protected GraveRobberWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
