 ...
 */
public class KertangsMessenger4Template extends MonsterNPCTemplate {
	public static final int ID = 22446;

	@Inject
	protected KertangsMessenger4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
