 ...
 */
public class KashaFangSpiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20476;

	@Inject
	protected KashaFangSpiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kasha Fang Spider";
