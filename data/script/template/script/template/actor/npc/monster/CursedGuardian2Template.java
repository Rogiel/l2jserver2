 ...
 */
public class CursedGuardian2Template extends MonsterNPCTemplate {
	public static final int ID = 22671;

	@Inject
	protected CursedGuardian2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
