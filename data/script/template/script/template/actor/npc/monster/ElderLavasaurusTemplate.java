 ...
 */
public class ElderLavasaurusTemplate extends MonsterNPCTemplate {
	public static final int ID = 21395;

	@Inject
	protected ElderLavasaurusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Elder Lavasaurus";
