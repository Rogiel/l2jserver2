 ...
 */
public class WitchWarder2Template extends MonsterNPCTemplate {
	public static final int ID = 18365;

	@Inject
	protected WitchWarder2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
