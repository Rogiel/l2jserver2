 ...
 */
public class FreyasServant3Template extends MonsterNPCTemplate {
	public static final int ID = 22102;

	@Inject
	protected FreyasServant3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
