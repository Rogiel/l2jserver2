 ...
 */
public class ZakensGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 21623;

	@Inject
	protected ZakensGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
