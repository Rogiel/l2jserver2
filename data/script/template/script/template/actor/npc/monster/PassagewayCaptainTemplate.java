 ...
 */
public class PassagewayCaptainTemplate extends MonsterNPCTemplate {
	public static final int ID = 22370;

	@Inject
	protected PassagewayCaptainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Passageway Captain";
