 ...
 */
public class GuardsOfTheDawnOracleTemplate extends MonsterNPCTemplate {
	public static final int ID = 27347;

	@Inject
	protected GuardsOfTheDawnOracleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
