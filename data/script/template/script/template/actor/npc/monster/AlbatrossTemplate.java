 ...
 */
public class AlbatrossTemplate extends MonsterNPCTemplate {
	public static final int ID = 31026;

	@Inject
	protected AlbatrossTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
