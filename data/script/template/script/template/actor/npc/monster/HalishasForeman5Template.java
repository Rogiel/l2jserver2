 ...
 */
public class HalishasForeman5Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18177;

	@Inject
	protected HalishasForeman5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
