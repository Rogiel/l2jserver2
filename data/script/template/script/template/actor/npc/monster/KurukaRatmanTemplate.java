 ...
 */
public class KurukaRatmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20487;

	@Inject
	protected KurukaRatmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kuruka Ratman";
