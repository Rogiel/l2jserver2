 ...
 */
public class TurekWarHoundTemplate extends MonsterNPCTemplate {
	public static final int ID = 20494;

	@Inject
	protected TurekWarHoundTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Turek War Hound";
