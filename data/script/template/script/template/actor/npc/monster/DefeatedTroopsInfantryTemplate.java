 ...
 */
public class DefeatedTroopsInfantryTemplate extends MonsterNPCTemplate {
	public static final int ID = 18786;

	@Inject
	protected DefeatedTroopsInfantryTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
