 ...
 */
public class HorrifyingGinzuGolemViiiTemplate extends MonsterNPCTemplate {
	public static final int ID = 22077;

	@Inject
	protected HorrifyingGinzuGolemViiiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Horrifying Ginzu Golem VIII";
		...
		attributes.magicalDefense = 160.17851;
