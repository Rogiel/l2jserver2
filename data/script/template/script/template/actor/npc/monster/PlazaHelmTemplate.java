 ...
 */
public class PlazaHelmTemplate extends MonsterNPCTemplate {
	public static final int ID = 22289;

	@Inject
	protected PlazaHelmTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Plaza Helm";
