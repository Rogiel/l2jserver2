 ...
 */
public class ProbeGolemChampionITemplate extends MonsterNPCTemplate {
	public static final int ID = 22056;

	@Inject
	protected ProbeGolemChampionITemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Probe Golem Champion I";
