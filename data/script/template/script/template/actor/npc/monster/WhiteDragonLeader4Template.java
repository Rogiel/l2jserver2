 ...
 */
public class WhiteDragonLeader4Template extends MonsterNPCTemplate {
	public static final int ID = 22596;

	@Inject
	protected WhiteDragonLeader4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
