 ...
 */
public class AbyssalJewel1Template extends MonsterNPCTemplate {
	public static final int ID = 27165;

	@Inject
	protected AbyssalJewel1Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Abyssal Jewel 1";
