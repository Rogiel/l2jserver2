 ...
 */
public class LithPatrolmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 21172;

	@Inject
	protected LithPatrolmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lith Patrolman";
