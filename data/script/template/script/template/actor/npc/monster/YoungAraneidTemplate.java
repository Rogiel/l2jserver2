 ...
 */
public class YoungAraneidTemplate extends MonsterNPCTemplate {
	public static final int ID = 21097;

	@Inject
	protected YoungAraneidTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Young Araneid";
