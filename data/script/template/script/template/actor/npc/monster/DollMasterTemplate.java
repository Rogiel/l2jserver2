 ...
 */
public class DollMasterTemplate extends MonsterNPCTemplate {
	public static final int ID = 20803;

	@Inject
	protected DollMasterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Doll Master";
