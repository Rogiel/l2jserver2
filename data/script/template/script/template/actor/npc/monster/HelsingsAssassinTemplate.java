 ...
 */
public class HelsingsAssassinTemplate extends MonsterNPCTemplate {
	public static final int ID = 25581;

	@Inject
	protected HelsingsAssassinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Helsing's Assassin";
