 ...
 */
public class DicorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20220;

	@Inject
	protected DicorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
