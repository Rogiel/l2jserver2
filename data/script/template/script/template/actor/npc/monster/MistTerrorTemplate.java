 ...
 */
public class MistTerrorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20371;

	@Inject
	protected MistTerrorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mist Terror";
