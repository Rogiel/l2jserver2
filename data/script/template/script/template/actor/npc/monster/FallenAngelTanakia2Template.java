 ...
 */
public class FallenAngelTanakia2Template extends MonsterNPCTemplate {
	public static final int ID = 27275;

	@Inject
	protected FallenAngelTanakia2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
