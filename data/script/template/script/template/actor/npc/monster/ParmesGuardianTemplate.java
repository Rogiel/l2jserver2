 ...
 */
public class ParmesGuardianTemplate extends MonsterNPCTemplate {
	public static final int ID = 22311;

	@Inject
	protected ParmesGuardianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Parme's Guardian";
