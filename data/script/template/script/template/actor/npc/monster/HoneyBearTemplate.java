 ...
 */
public class HoneyBearTemplate extends MonsterNPCTemplate {
	public static final int ID = 27058;

	@Inject
	protected HoneyBearTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Honey Bear";
