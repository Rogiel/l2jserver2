 ...
 */
public class TimakOrcTroopShamanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20768;

	@Inject
	protected TimakOrcTroopShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Timak Orc Troop Shaman";
