 ...
 */
public class SepulcherGuardianTemplate extends MonsterNPCTemplate {
	public static final int ID = 21224;

	@Inject
	protected SepulcherGuardianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
