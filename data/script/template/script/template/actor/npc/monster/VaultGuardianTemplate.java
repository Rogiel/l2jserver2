 ...
 */
public class VaultGuardianTemplate extends MonsterNPCTemplate {
	public static final int ID = 21210;

	@Inject
	protected VaultGuardianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vault Guardian";
