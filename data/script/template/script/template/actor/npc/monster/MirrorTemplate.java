 ...
 */
public class MirrorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20639;

	@Inject
	protected MirrorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
