 ...
 */
public class JudgeOfLightTemplate extends MonsterNPCTemplate {
	public static final int ID = 21546;

	@Inject
	protected JudgeOfLightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Judge of Light";
