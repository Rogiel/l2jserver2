 ...
 */
public class HallKeeperGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 18331;

	@Inject
	protected HallKeeperGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hall Keeper Guard";
