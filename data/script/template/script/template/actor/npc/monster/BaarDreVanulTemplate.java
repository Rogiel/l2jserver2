 ...
 */
public class BaarDreVanulTemplate extends MonsterNPCTemplate {
	public static final int ID = 21118;

	@Inject
	protected BaarDreVanulTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Baar Dre Vanul";
