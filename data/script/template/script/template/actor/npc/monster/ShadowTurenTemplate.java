 ...
 */
public class ShadowTurenTemplate extends MonsterNPCTemplate {
	public static final int ID = 27104;

	@Inject
	protected ShadowTurenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shadow Turen";
