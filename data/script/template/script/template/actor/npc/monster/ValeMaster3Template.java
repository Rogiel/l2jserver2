 ...
 */
public class ValeMaster3Template extends MonsterNPCTemplate {
	public static final int ID = 21635;

	@Inject
	protected ValeMaster3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
