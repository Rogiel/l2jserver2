 ...
 */
public class HamesOrcScoutTemplate extends MonsterNPCTemplate {
	public static final int ID = 21109;

	@Inject
	protected HamesOrcScoutTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hames Orc Scout";
