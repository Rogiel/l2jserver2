 ...
 */
public class LesserGiantMage2Template extends MonsterNPCTemplate {
	public static final int ID = 22664;

	@Inject
	protected LesserGiantMage2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lesser Giant Mage";
