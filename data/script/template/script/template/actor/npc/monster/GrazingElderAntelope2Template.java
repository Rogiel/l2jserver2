 ...
 */
public class GrazingElderAntelope2Template extends MonsterNPCTemplate {
	public static final int ID = 21367;

	@Inject
	protected GrazingElderAntelope2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grazing Elder Antelope";
