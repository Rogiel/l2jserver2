 ...
 */
public class SpikedStakatoCaptainTemplate extends MonsterNPCTemplate {
	public static final int ID = 22117;

	@Inject
	protected SpikedStakatoCaptainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
