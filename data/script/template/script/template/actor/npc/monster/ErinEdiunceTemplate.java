 ...
 */
public class ErinEdiunceTemplate extends MonsterNPCTemplate {
	public static final int ID = 20821;

	@Inject
	protected ErinEdiunceTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Erin Ediunce";
