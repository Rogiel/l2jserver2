 ...
 */
public class EnceinteDefender3Template extends MonsterNPCTemplate {
	public static final int ID = 22357;

	@Inject
	protected EnceinteDefender3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
