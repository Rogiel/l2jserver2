 ...
 */
public class ForestOfMirrorsGhostTemplate extends MonsterNPCTemplate {
	public static final int ID = 20636;

	@Inject
	protected ForestOfMirrorsGhostTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
