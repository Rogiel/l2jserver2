 ...
 */
public class InfernoGolem2Template extends MonsterNPCTemplate {
	public static final int ID = 29042;

	@Inject
	protected InfernoGolem2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 5024.60000;
		attributes.magicalAttack = 3539.66580;
