 ...
 */
public class TerodTemplate extends MonsterNPCTemplate {
	public static final int ID = 22301;

	@Inject
	protected TerodTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
