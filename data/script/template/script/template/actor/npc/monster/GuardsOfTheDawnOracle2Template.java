 ...
 */
public class GuardsOfTheDawnOracle2Template extends MonsterNPCTemplate {
	public static final int ID = 27348;

	@Inject
	protected GuardsOfTheDawnOracle2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
