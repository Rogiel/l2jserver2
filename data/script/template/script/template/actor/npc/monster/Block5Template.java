 ...
 */
public class Block5Template extends MonsterNPCTemplate {
	public static final int ID = 18675;

	@Inject
	protected Block5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
