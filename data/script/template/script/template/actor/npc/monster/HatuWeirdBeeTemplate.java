 ...
 */
public class HatuWeirdBeeTemplate extends MonsterNPCTemplate {
	public static final int ID = 20928;

	@Inject
	protected HatuWeirdBeeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hatu Weird Bee";
