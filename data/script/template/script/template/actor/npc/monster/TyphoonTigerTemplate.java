 ...
 */
public class TyphoonTigerTemplate extends MonsterNPCTemplate {
	public static final int ID = 31022;

	@Inject
	protected TyphoonTigerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Typhoon Tiger";
