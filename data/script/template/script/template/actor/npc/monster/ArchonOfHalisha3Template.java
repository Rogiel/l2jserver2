 ...
 */
public class ArchonOfHalisha3Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18214;

	@Inject
	protected ArchonOfHalisha3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
