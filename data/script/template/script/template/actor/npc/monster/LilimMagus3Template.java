 ...
 */
public class LilimMagus3Template extends MonsterNPCTemplate {
	public static final int ID = 27363;

	@Inject
	protected LilimMagus3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
