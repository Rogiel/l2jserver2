 ...
 */
public class SingingWindTemplate extends MonsterNPCTemplate {
	public static final int ID = 21026;

	@Inject
	protected SingingWindTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Singing Wind";
