 ...
 */
public class UndeadPriestTemplate extends MonsterNPCTemplate {
	public static final int ID = 27024;

	@Inject
	protected UndeadPriestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Undead Priest";
