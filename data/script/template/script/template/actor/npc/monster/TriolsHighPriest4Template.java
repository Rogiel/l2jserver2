 ...
 */
public class TriolsHighPriest4Template extends MonsterNPCTemplate {
	public static final int ID = 22167;

	@Inject
	protected TriolsHighPriest4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
