 ...
 */
public class CaveAnt2Template extends MonsterNPCTemplate {
	public static final int ID = 21271;

	@Inject
	protected CaveAnt2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
