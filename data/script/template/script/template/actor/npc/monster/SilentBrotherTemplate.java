 ...
 */
public class SilentBrotherTemplate extends MonsterNPCTemplate {
	public static final int ID = 22127;

	@Inject
	protected SilentBrotherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Silent Brother";
