 ...
 */
public class VirudLizardmanWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20295;

	@Inject
	protected VirudLizardmanWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Virud Lizardman Warrior";
