 ...
 */
public class Buffalo6Template extends MonsterNPCTemplate {
	public static final int ID = 21288;

	@Inject
	protected Buffalo6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
