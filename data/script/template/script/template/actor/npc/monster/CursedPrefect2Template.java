 ...
 */
public class CursedPrefect2Template extends MonsterNPCTemplate {
	public static final int ID = 22529;

	@Inject
	protected CursedPrefect2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
