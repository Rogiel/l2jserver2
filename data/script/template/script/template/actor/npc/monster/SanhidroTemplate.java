 ...
 */
public class SanhidroTemplate extends MonsterNPCTemplate {
	public static final int ID = 20946;

	@Inject
	protected SanhidroTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
