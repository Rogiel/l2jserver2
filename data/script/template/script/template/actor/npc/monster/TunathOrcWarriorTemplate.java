 ...
 */
public class TunathOrcWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20362;

	@Inject
	protected TunathOrcWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tunath Orc Warrior";
