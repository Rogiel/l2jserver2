 ...
 */
public class PartisanSorcerer2Template extends MonsterNPCTemplate {
	public static final int ID = 35380;

	@Inject
	protected PartisanSorcerer2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Partisan Sorcerer";
