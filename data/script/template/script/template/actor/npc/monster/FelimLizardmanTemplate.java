 ...
 */
public class FelimLizardmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20008;

	@Inject
	protected FelimLizardmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Felim Lizardman";
