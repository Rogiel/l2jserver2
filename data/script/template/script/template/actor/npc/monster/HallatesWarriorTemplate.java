 ...
 */
public class HallatesWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20818;

	@Inject
	protected HallatesWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hallate's Warrior";
