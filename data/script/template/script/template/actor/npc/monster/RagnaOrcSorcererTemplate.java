 ...
 */
public class RagnaOrcSorcererTemplate extends MonsterNPCTemplate {
	public static final int ID = 22041;

	@Inject
	protected RagnaOrcSorcererTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
