 ...
 */
public class RedEyeArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 25389;

	@Inject
	protected RedEyeArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Red Eye Archer";
