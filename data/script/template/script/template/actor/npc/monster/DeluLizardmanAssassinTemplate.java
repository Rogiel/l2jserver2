 ...
 */
public class DeluLizardmanAssassinTemplate extends MonsterNPCTemplate {
	public static final int ID = 27094;

	@Inject
	protected DeluLizardmanAssassinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Delu Lizardman Assassin";
