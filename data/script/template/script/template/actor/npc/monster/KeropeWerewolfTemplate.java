 ...
 */
public class KeropeWerewolfTemplate extends MonsterNPCTemplate {
	public static final int ID = 21126;

	@Inject
	protected KeropeWerewolfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kerope Werewolf";
