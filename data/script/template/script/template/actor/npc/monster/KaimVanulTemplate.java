 ...
 */
public class KaimVanulTemplate extends MonsterNPCTemplate {
	public static final int ID = 20844;

	@Inject
	protected KaimVanulTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
