 ...
 */
public class CryptGuardianTemplate extends MonsterNPCTemplate {
	public static final int ID = 21248;

	@Inject
	protected CryptGuardianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Crypt Guardian";
