 ...
 */
public class EliteKanibiTemplate extends MonsterNPCTemplate {
	public static final int ID = 22763;

	@Inject
	protected EliteKanibiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Elite Kanibi";
		this.serverSideName = false;
		this.title = "Kokracon";
		this.serverSideTitle = false;
		this.collisionRadius = 32.00;
		this.collisionHeight = 69.50;
		this.level = 85;
