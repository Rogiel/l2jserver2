 ...
 */
public class MucrokianSaviorTemplate extends MonsterNPCTemplate {
	public static final int ID = 22652;

	@Inject
	protected MucrokianSaviorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mucrokian Savior";
