 ...
 */
public class LilimKnight5Template extends MonsterNPCTemplate {
	public static final int ID = 27376;

	@Inject
	protected LilimKnight5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
