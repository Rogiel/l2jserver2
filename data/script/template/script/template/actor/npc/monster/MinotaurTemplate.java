 ...
 */
public class MinotaurTemplate extends MonsterNPCTemplate {
	public static final int ID = 20159;

	@Inject
	protected MinotaurTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
