 ...
 */
public class KraaculBlackskullTemplate extends MonsterNPCTemplate {
	public static final int ID = 27008;

	@Inject
	protected KraaculBlackskullTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kraacul Blackskull";
