 ...
 */
public class GardenGuard4Template extends MonsterNPCTemplate {
	public static final int ID = 18350;

	@Inject
	protected GardenGuard4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
