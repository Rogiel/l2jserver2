 ...
 */
public class BoxOfAthrea2Template extends MonsterNPCTemplate {
	public static final int ID = 27174;

	@Inject
	protected BoxOfAthrea2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Box Of Athrea 2";
