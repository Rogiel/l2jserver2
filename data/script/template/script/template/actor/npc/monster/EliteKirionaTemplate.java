 ...
 */
public class EliteKirionaTemplate extends MonsterNPCTemplate {
	public static final int ID = 22764;

	@Inject
	protected EliteKirionaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Elite Kiriona";
