 ...
 */
public class SpitefulGhostOfRuinsTemplate extends MonsterNPCTemplate {
	public static final int ID = 20996;

	@Inject
	protected SpitefulGhostOfRuinsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Spiteful Ghost of Ruins";
