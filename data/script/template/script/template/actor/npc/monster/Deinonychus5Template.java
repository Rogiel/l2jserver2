 ...
 */
public class Deinonychus5Template extends MonsterNPCTemplate {
	public static final int ID = 22225;

	@Inject
	protected Deinonychus5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
