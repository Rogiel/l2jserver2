 ...
 */
public class AngerOfSplendor2Template extends MonsterNPCTemplate {
	public static final int ID = 21528;

	@Inject
	protected AngerOfSplendor2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Anger of Splendor";
