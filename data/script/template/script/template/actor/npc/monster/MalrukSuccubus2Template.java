 ...
 */
public class MalrukSuccubus2Template extends MonsterNPCTemplate {
	public static final int ID = 20283;

	@Inject
	protected MalrukSuccubus2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Malruk Succubus";
