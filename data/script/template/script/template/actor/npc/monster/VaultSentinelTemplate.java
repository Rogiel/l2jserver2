 ...
 */
public class VaultSentinelTemplate extends MonsterNPCTemplate {
	public static final int ID = 21214;

	@Inject
	protected VaultSentinelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vault Sentinel";
