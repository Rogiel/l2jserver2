 ...
 */
public class ExecutionerOfHalisha7Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18164;

	@Inject
	protected ExecutionerOfHalisha7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
