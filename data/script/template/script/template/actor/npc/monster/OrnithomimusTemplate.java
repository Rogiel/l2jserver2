 ...
 */
public class OrnithomimusTemplate extends MonsterNPCTemplate {
	public static final int ID = 22200;

	@Inject
	protected OrnithomimusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
