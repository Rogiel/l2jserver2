 ...
 */
public class ExcuroTemplate extends MonsterNPCTemplate {
	public static final int ID = 20214;

	@Inject
	protected ExcuroTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
