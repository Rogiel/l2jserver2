 ...
 */
public class MarshZombieTemplate extends MonsterNPCTemplate {
	public static final int ID = 20015;

	@Inject
	protected MarshZombieTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Marsh Zombie";
