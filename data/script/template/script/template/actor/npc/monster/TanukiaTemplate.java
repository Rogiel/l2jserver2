 ...
 */
public class TanukiaTemplate extends MonsterNPCTemplate {
	public static final int ID = 27062;

	@Inject
	protected TanukiaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
