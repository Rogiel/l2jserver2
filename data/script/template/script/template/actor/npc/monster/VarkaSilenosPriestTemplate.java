 ...
 */
public class VarkaSilenosPriestTemplate extends MonsterNPCTemplate {
	public static final int ID = 18641;

	@Inject
	protected VarkaSilenosPriestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
