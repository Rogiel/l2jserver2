 ...
 */
public class RoughlyHewnRockGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 21103;

	@Inject
	protected RoughlyHewnRockGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Roughly Hewn Rock Golem";
		...
		attributes.magicalDefense = 81.22111;
