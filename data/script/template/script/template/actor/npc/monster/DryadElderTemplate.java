 ...
 */
public class DryadElderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20019;

	@Inject
	protected DryadElderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dryad Elder";
