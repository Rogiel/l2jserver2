 ...
 */
public class DarkOmenOfferingTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18040;

	@Inject
	protected DarkOmenOfferingTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
