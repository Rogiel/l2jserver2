 ...
 */
public class BepooksPetTemplate extends MonsterNPCTemplate {
	public static final int ID = 20739;

	@Inject
	protected BepooksPetTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bepook's Pet";
