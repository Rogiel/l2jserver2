 ...
 */
public class MimiTheCatTemplate extends MonsterNPCTemplate {
	public static final int ID = 27105;

	@Inject
	protected MimiTheCatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mimi The Cat";
