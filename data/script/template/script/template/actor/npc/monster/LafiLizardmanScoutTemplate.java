 ...
 */
public class LafiLizardmanScoutTemplate extends MonsterNPCTemplate {
	public static final int ID = 20614;

	@Inject
	protected LafiLizardmanScoutTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lafi Lizardman Scout";
