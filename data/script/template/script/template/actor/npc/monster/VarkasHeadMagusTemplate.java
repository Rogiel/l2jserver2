 ...
 */
public class VarkasHeadMagusTemplate extends MonsterNPCTemplate {
	public static final int ID = 18656;

	@Inject
	protected VarkasHeadMagusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
