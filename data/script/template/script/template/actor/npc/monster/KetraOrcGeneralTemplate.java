 ...
 */
public class KetraOrcGeneralTemplate extends MonsterNPCTemplate {
	public static final int ID = 21339;

	@Inject
	protected KetraOrcGeneralTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ketra Orc General";
