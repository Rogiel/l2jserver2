 ...
 */
public class SuppliesSafe2Template extends MonsterNPCTemplate {
	public static final int ID = 36592;

	@Inject
	protected SuppliesSafe2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
