 ...
 */
public class EvilEyeWatcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20427;

	@Inject
	protected EvilEyeWatcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Evil Eye Watcher";
