 ...
 */
public class GreaterEvilTemplate extends MonsterNPCTemplate {
	public static final int ID = 22399;

	@Inject
	protected GreaterEvilTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Greater Evil";
