 ...
 */
public class FairyTreeOfWindTemplate extends MonsterNPCTemplate {
	public static final int ID = 27185;

	@Inject
	protected FairyTreeOfWindTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fairy Tree of Wind";
