 ...
 */
public class ElderLostWatcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 22082;

	@Inject
	protected ElderLostWatcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Elder Lost Watcher";
