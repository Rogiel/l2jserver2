 ...
 */
public class GuardianOfTheSquareTemplate extends MonsterNPCTemplate {
	public static final int ID = 22303;

	@Inject
	protected GuardianOfTheSquareTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guardian of the Square";
