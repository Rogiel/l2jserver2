 ...
 */
public class InvaderWarriorOfNightmareTemplate extends MonsterNPCTemplate {
	public static final int ID = 22708;

	@Inject
	protected InvaderWarriorOfNightmareTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Invader Warrior of Nightmare";
