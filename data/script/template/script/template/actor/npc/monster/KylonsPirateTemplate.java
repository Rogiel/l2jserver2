 ...
 */
public class KylonsPirateTemplate extends MonsterNPCTemplate {
	public static final int ID = 25405;

	@Inject
	protected KylonsPirateTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kylon's Pirate";
