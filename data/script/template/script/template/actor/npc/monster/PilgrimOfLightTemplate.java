 ...
 */
public class PilgrimOfLightTemplate extends MonsterNPCTemplate {
	public static final int ID = 22131;

	@Inject
	protected PilgrimOfLightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Pilgrim of Light";
