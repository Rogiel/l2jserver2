 ...
 */
public class Victim3Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18152;

	@Inject
	protected Victim3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
