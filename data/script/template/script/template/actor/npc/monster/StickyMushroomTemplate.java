 ...
 */
public class StickyMushroomTemplate extends MonsterNPCTemplate {
	public static final int ID = 18865;

	@Inject
	protected StickyMushroomTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sticky Mushroom";
