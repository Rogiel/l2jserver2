 ...
 */
public class KarulChiefOrootoTemplate extends MonsterNPCTemplate {
	public static final int ID = 27164;

	@Inject
	protected KarulChiefOrootoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Karul Chief Orooto";
