 ...
 */
public class WitchsOfferingWarriorTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18032;

	@Inject
	protected WitchsOfferingWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
