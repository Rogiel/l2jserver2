 ...
 */
public class PavelSafetyDeviceTemplate extends MonsterNPCTemplate {
	public static final int ID = 18917;

	@Inject
	protected PavelSafetyDeviceTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Pavel Safety Device";
