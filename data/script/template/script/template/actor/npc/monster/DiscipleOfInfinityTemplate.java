 ...
 */
public class DiscipleOfInfinityTemplate extends MonsterNPCTemplate {
	public static final int ID = 22517;

	@Inject
	protected DiscipleOfInfinityTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Disciple of Infinity";
