 ...
 */
public class ElderRedKeltirTemplate extends MonsterNPCTemplate {
	public static final int ID = 20537;

	@Inject
	protected ElderRedKeltirTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Elder Red Keltir";
