 ...
 */
public class SkeletonLordTemplate extends MonsterNPCTemplate {
	public static final int ID = 20104;

	@Inject
	protected SkeletonLordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
