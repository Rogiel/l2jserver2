 ...
 */
public class SmallCrystalCore3Template extends MonsterNPCTemplate {
	public static final int ID = 22556;

	@Inject
	protected SmallCrystalCore3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Small Crystal Core";
