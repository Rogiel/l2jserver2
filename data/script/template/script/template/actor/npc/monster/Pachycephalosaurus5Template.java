 ...
 */
public class Pachycephalosaurus5Template extends MonsterNPCTemplate {
	public static final int ID = 22226;

	@Inject
	protected Pachycephalosaurus5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
