 ...
 */
public class DeathFireTemplate extends MonsterNPCTemplate {
	public static final int ID = 20749;

	@Inject
	protected DeathFireTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Death Fire";
