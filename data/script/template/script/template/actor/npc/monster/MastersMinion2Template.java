 ...
 */
public class MastersMinion2Template extends MonsterNPCTemplate {
	public static final int ID = 22379;

	@Inject
	protected MastersMinion2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Master's Minion";
