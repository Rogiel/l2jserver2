 ...
 */
public class OblivionWatcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20454;

	@Inject
	protected OblivionWatcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Oblivion Watcher";
