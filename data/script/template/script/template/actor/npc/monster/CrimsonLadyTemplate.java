 ...
 */
public class CrimsonLadyTemplate extends MonsterNPCTemplate {
	public static final int ID = 27336;

	@Inject
	protected CrimsonLadyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Crimson Lady";
