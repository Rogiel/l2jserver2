 ...
 */
public class TasabaLizardmanShaman2Template extends MonsterNPCTemplate {
	public static final int ID = 21640;

	@Inject
	protected TasabaLizardmanShaman2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tasaba Lizardman Shaman";
