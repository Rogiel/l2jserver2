 ...
 */
public class MutantDestroyerTemplate extends MonsterNPCTemplate {
	public static final int ID = 22733;

	@Inject
	protected MutantDestroyerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mutant Destroyer";
