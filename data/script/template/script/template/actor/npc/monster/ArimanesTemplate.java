 ...
 */
public class ArimanesTemplate extends MonsterNPCTemplate {
	public static final int ID = 21430;

	@Inject
	protected ArimanesTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
