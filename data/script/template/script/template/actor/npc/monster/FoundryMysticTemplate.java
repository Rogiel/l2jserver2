 ...
 */
public class FoundryMysticTemplate extends MonsterNPCTemplate {
	public static final int ID = 22386;

	@Inject
	protected FoundryMysticTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
