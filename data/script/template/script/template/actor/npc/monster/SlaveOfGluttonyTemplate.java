 ...
 */
public class SlaveOfGluttonyTemplate extends MonsterNPCTemplate {
	public static final int ID = 22430;

	@Inject
	protected SlaveOfGluttonyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
