 ...
 */
public class FiendArcher3Template extends MonsterNPCTemplate {
	public static final int ID = 21618;

	@Inject
	protected FiendArcher3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
