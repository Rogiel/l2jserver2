 ...
 */
public class SpikedStakatoWorker2Template extends MonsterNPCTemplate {
	public static final int ID = 22618;

	@Inject
	protected SpikedStakatoWorker2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Spiked Stakato Worker";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 22.00;
		this.collisionHeight = 48.30;
		this.level = 82;
