 ...
 */
public class LilimMagusTemplate extends MonsterNPCTemplate {
	public static final int ID = 21176;

	@Inject
	protected LilimMagusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
