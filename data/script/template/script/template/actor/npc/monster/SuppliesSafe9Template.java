 ...
 */
public class SuppliesSafe9Template extends MonsterNPCTemplate {
	public static final int ID = 36599;

	@Inject
	protected SuppliesSafe9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
