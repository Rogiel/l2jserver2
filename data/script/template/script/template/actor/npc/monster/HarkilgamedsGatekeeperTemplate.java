 ...
 */
public class HarkilgamedsGatekeeperTemplate extends MonsterNPCTemplate {
	public static final int ID = 18356;

	@Inject
	protected HarkilgamedsGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Harkilgamed's Gatekeeper";
		...
		this.experience = 2470;
		this.sp = 111;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(10128);
		this.leftHand = null;
		this.enchantLevel = 0;
