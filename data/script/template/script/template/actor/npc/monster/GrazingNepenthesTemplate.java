 ...
 */
public class GrazingNepenthesTemplate extends MonsterNPCTemplate {
	public static final int ID = 21356;

	@Inject
	protected GrazingNepenthesTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grazing Nepenthes";
