 ...
 */
public class HalishasOfficer2Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18121;

	@Inject
	protected HalishasOfficer2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
