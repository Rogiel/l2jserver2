 ...
 */
public class PlainGrizzlyTemplate extends MonsterNPCTemplate {
	public static final int ID = 21098;

	@Inject
	protected PlainGrizzlyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Plain Grizzly";
