 ...
 */
public class GoblinScoutTemplate extends MonsterNPCTemplate {
	public static final int ID = 20326;

	@Inject
	protected GoblinScoutTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
