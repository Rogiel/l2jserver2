 ...
 */
public class FormorElderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20569;

	@Inject
	protected FormorElderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Formor Elder";
