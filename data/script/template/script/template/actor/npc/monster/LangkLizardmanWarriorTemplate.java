 ...
 */
public class LangkLizardmanWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20024;

	@Inject
	protected LangkLizardmanWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Langk Lizardman Warrior";
