 ...
 */
public class ZakorelsExecutorTemplate extends MonsterNPCTemplate {
	public static final int ID = 27327;

	@Inject
	protected ZakorelsExecutorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Zakorel's Executor";
