 ...
 */
public class BloodyLordNurkaTemplate extends MonsterNPCTemplate {
	public static final int ID = 35368;

	@Inject
	protected BloodyLordNurkaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
