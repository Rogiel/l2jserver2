 ...
 */
public class BlockCarryingGirlTemplate extends MonsterNPCTemplate {
	public static final int ID = 18676;

	@Inject
	protected BlockCarryingGirlTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Block-Carrying Girl";
