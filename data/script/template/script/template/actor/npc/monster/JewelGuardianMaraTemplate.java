 ...
 */
public class JewelGuardianMaraTemplate extends MonsterNPCTemplate {
	public static final int ID = 27168;

	@Inject
	protected JewelGuardianMaraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Jewel Guardian Mara";
