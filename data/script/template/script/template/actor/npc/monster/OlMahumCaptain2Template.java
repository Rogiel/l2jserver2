 ...
 */
public class OlMahumCaptain2Template extends MonsterNPCTemplate {
	public static final int ID = 20211;

	@Inject
	protected OlMahumCaptain2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
