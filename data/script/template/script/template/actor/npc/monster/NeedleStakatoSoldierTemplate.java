 ...
 */
public class NeedleStakatoSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 21515;

	@Inject
	protected NeedleStakatoSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Needle Stakato Soldier";
