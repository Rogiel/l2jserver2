 ...
 */
public class KuroborosFollowerTemplate extends MonsterNPCTemplate {
	public static final int ID = 25367;

	@Inject
	protected KuroborosFollowerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kuroboros' Follower";
