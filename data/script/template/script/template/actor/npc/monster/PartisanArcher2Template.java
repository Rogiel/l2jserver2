 ...
 */
public class PartisanArcher2Template extends MonsterNPCTemplate {
	public static final int ID = 35381;

	@Inject
	protected PartisanArcher2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Partisan Archer";
