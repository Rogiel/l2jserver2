 ...
 */
public class VanorSilenosChieftainTemplate extends MonsterNPCTemplate {
	public static final int ID = 20686;

	@Inject
	protected VanorSilenosChieftainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vanor Silenos Chieftain";
