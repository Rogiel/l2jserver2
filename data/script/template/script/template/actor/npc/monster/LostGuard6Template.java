 ...
 */
public class LostGuard6Template extends MonsterNPCTemplate {
	public static final int ID = 29142;

	@Inject
	protected LostGuard6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 2733.25193;
		attributes.magicalAttack = 1866.45677;
