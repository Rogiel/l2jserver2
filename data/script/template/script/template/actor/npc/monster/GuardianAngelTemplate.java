 ...
 */
public class GuardianAngelTemplate extends MonsterNPCTemplate {
	public static final int ID = 20830;

	@Inject
	protected GuardianAngelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
