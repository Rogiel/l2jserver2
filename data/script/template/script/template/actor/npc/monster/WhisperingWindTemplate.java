 ...
 */
public class WhisperingWindTemplate extends MonsterNPCTemplate {
	public static final int ID = 20078;

	@Inject
	protected WhisperingWindTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Whispering Wind";
