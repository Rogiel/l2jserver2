 ...
 */
public class BoundArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20985;

	@Inject
	protected BoundArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bound Archer";
