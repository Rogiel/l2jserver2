 ...
 */
public class SpikedStakatoSorcerer2Template extends MonsterNPCTemplate {
	public static final int ID = 22623;

	@Inject
	protected SpikedStakatoSorcerer2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Spiked Stakato Sorcerer";
