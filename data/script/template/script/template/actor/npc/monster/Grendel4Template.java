 ...
 */
public class Grendel4Template extends MonsterNPCTemplate {
	public static final int ID = 21291;

	@Inject
	protected Grendel4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
