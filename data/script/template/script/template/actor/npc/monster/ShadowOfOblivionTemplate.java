 ...
 */
public class ShadowOfOblivionTemplate extends MonsterNPCTemplate {
	public static final int ID = 25458;

	@Inject
	protected ShadowOfOblivionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shadow of Oblivion";
