 ...
 */
public class WarriorOfAncientTimesTemplate extends MonsterNPCTemplate {
	public static final int ID = 20971;

	@Inject
	protected WarriorOfAncientTimesTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Warrior of Ancient Times";
