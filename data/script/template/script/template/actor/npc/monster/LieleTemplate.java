 ...
 */
public class LieleTemplate extends MonsterNPCTemplate {
	public static final int ID = 20590;

	@Inject
	protected LieleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
