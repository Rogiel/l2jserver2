 ...
 */
public class KashaImpTurenTemplate extends MonsterNPCTemplate {
	public static final int ID = 21120;

	@Inject
	protected KashaImpTurenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kasha Imp Turen";
