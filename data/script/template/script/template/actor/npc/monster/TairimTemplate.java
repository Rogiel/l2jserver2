 ...
 */
public class TairimTemplate extends MonsterNPCTemplate {
	public static final int ID = 20675;

	@Inject
	protected TairimTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
