 ...
 */
public class VarkaSilenosGreatSeerTemplate extends MonsterNPCTemplate {
	public static final int ID = 18652;

	@Inject
	protected VarkaSilenosGreatSeerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
