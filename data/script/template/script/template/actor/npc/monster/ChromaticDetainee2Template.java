 ...
 */
public class ChromaticDetainee2Template extends MonsterNPCTemplate {
	public static final int ID = 22282;

	@Inject
	protected ChromaticDetainee2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
