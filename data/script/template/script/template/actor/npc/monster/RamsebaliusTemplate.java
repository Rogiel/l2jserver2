 ...
 */
public class RamsebaliusTemplate extends MonsterNPCTemplate {
	public static final int ID = 27155;

	@Inject
	protected RamsebaliusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ramsebalius";
		this.serverSideName = false;
		this.title = "Evil Overlord";
