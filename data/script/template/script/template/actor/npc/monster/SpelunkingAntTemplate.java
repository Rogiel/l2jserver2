 ...
 */
public class SpelunkingAntTemplate extends MonsterNPCTemplate {
	public static final int ID = 22057;

	@Inject
	protected SpelunkingAntTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Spelunking Ant";
