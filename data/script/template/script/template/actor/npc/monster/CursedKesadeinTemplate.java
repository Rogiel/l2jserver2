 ...
 */
public class CursedKesadeinTemplate extends MonsterNPCTemplate {
	public static final int ID = 27279;

	@Inject
	protected CursedKesadeinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cursed Kesadein";
