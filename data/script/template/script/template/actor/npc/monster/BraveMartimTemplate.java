 ...
 */
public class BraveMartimTemplate extends MonsterNPCTemplate {
	public static final int ID = 18565;

	@Inject
	protected BraveMartimTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Brave Martim";
