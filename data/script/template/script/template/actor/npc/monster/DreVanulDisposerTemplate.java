 ...
 */
public class DreVanulDisposerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20056;

	@Inject
	protected DreVanulDisposerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dre Vanul Disposer";
