 ...
 */
public class CrumaBorderTemplate extends MonsterNPCTemplate {
	public static final int ID = 18544;

	@Inject
	protected CrumaBorderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cruma Border";
		this.serverSideName = false;
		this.title = "Event Monster";
		this.serverSideTitle = false;
		this.collisionRadius = 12.00;
		this.collisionHeight = 20.40;
		this.level = 45;
