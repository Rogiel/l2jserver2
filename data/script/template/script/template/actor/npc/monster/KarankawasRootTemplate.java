 ...
 */
public class KarankawasRootTemplate extends MonsterNPCTemplate {
	public static final int ID = 25558;

	@Inject
	protected KarankawasRootTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Karankawa's Root";
