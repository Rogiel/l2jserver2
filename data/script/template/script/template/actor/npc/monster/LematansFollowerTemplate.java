 ...
 */
public class LematansFollowerTemplate extends MonsterNPCTemplate {
	public static final int ID = 18634;

	@Inject
	protected LematansFollowerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lematan's Follower";
