 ...
 */
public class LienrikLadTemplate extends MonsterNPCTemplate {
	public static final int ID = 20787;

	@Inject
	protected LienrikLadTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
