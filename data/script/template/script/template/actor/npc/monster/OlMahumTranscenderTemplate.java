 ...
 */
public class OlMahumTranscenderTemplate extends MonsterNPCTemplate {
	public static final int ID = 21261;

	@Inject
	protected OlMahumTranscenderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ol Mahum Transcender";
