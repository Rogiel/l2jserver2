 ...
 */
public class RowinUndineTemplate extends MonsterNPCTemplate {
	public static final int ID = 20619;

	@Inject
	protected RowinUndineTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rowin Undine";
