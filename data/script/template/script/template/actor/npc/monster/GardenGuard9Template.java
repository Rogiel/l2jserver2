 ...
 */
public class GardenGuard9Template extends MonsterNPCTemplate {
	public static final int ID = 18483;

	@Inject
	protected GardenGuard9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
