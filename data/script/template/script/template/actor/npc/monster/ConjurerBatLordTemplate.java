 ...
 */
public class ConjurerBatLordTemplate extends MonsterNPCTemplate {
	public static final int ID = 20773;

	@Inject
	protected ConjurerBatLordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Conjurer Bat Lord";
