 ...
 */
public class WerewolfChieftainTemplate extends MonsterNPCTemplate {
	public static final int ID = 20342;

	@Inject
	protected WerewolfChieftainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Werewolf Chieftain";
