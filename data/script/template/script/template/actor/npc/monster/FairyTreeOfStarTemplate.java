 ...
 */
public class FairyTreeOfStarTemplate extends MonsterNPCTemplate {
	public static final int ID = 27186;

	@Inject
	protected FairyTreeOfStarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fairy Tree of Star";
