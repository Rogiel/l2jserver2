 ...
 */
public class HobgoblinTemplate extends MonsterNPCTemplate {
	public static final int ID = 20147;

	@Inject
	protected HobgoblinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
