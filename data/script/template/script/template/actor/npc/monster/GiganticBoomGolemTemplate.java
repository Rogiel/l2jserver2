 ...
 */
public class GiganticBoomGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 25705;

	@Inject
	protected GiganticBoomGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gigantic Boom Golem";
