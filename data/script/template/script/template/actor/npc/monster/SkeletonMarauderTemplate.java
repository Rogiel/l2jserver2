 ...
 */
public class SkeletonMarauderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20190;

	@Inject
	protected SkeletonMarauderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Skeleton Marauder";
