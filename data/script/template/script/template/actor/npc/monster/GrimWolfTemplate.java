 ...
 */
public class GrimWolfTemplate extends MonsterNPCTemplate {
	public static final int ID = 22001;

	@Inject
	protected GrimWolfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
