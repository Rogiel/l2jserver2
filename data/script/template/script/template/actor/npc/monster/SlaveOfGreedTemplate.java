 ...
 */
public class SlaveOfGreedTemplate extends MonsterNPCTemplate {
	public static final int ID = 22424;

	@Inject
	protected SlaveOfGreedTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
