 ...
 */
public class DarkOmenOfferingSaint2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18098;

	@Inject
	protected DarkOmenOfferingSaint2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Omen Offering Saint";
		...
		attributes.magicalDefense = 184.98039;
