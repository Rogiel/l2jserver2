 ...
 */
public class StinkZombieTemplate extends MonsterNPCTemplate {
	public static final int ID = 20046;

	@Inject
	protected StinkZombieTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Stink Zombie";
