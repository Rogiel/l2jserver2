 ...
 */
public class GhostOfAMorekChiefTemplate extends MonsterNPCTemplate {
	public static final int ID = 22013;

	@Inject
	protected GhostOfAMorekChiefTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
