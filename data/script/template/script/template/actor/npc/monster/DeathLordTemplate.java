 ...
 */
public class DeathLordTemplate extends MonsterNPCTemplate {
	public static final int ID = 20862;

	@Inject
	protected DeathLordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Death Lord";
