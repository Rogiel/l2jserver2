 ...
 */
public class DreVanulSlayerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20352;

	@Inject
	protected DreVanulSlayerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dre Vanul Slayer";
