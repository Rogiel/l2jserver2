 ...
 */
public class OfferingOfForbiddenPathFollower2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18103;

	@Inject
	protected OfferingOfForbiddenPathFollower2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
