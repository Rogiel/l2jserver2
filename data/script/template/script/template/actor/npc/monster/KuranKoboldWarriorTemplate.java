 ...
 */
public class KuranKoboldWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20607;

	@Inject
	protected KuranKoboldWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kuran Kobold Warrior";
