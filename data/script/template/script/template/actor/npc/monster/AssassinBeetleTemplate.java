 ...
 */
public class AssassinBeetleTemplate extends MonsterNPCTemplate {
	public static final int ID = 21381;

	@Inject
	protected AssassinBeetleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
