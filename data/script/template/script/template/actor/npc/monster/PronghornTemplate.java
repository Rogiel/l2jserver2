 ...
 */
public class PronghornTemplate extends MonsterNPCTemplate {
	public static final int ID = 22088;

	@Inject
	protected PronghornTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
