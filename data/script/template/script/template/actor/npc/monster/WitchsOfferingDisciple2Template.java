 ...
 */
public class WitchsOfferingDisciple2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18087;

	@Inject
	protected WitchsOfferingDisciple2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Witch's Offering Disciple";
