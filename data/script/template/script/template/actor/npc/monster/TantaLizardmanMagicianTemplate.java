 ...
 */
public class TantaLizardmanMagicianTemplate extends MonsterNPCTemplate {
	public static final int ID = 22773;

	@Inject
	protected TantaLizardmanMagicianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tanta Lizardman Magician";
