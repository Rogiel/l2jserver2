 ...
 */
public class ForgottenCrewmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 22027;

	@Inject
	protected ForgottenCrewmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Forgotten Crewman";
