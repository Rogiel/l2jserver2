 ...
 */
public class VisionGuardEranusTemplate extends MonsterNPCTemplate {
	public static final int ID = 27324;

	@Inject
	protected VisionGuardEranusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vision Guard Eranus";
