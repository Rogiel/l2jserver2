 ...
 */
public class OrcArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20006;

	@Inject
	protected OrcArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
