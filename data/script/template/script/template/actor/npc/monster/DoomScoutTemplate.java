 ...
 */
public class DoomScoutTemplate extends MonsterNPCTemplate {
	public static final int ID = 21002;

	@Inject
	protected DoomScoutTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Doom Scout";
		...
		this.experience = 6197;
		this.sp = 509;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(242);
		this.leftHand = itemProvider.createID(2496);
		this.enchantLevel = 0;
