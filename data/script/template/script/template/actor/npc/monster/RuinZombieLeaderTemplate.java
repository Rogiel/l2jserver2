 ...
 */
public class RuinZombieLeaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20029;

	@Inject
	protected RuinZombieLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ruin Zombie Leader";
