 ...
 */
public class FallenOrcShamanTemplate extends MonsterNPCTemplate {
	public static final int ID = 21020;

	@Inject
	protected FallenOrcShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fallen Orc Shaman";
