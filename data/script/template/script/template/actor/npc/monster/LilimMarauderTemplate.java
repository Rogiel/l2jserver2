 ...
 */
public class LilimMarauderTemplate extends MonsterNPCTemplate {
	public static final int ID = 21178;

	@Inject
	protected LilimMarauderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lilim Marauder";
