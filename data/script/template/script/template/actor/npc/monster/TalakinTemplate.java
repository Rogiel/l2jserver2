 ...
 */
public class TalakinTemplate extends MonsterNPCTemplate {
	public static final int ID = 20755;

	@Inject
	protected TalakinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
