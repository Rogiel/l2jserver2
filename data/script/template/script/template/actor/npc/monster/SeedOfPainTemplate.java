 ...
 */
public class SeedOfPainTemplate extends MonsterNPCTemplate {
	public static final int ID = 22616;

	@Inject
	protected SeedOfPainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Seed of Pain";
