 ...
 */
public class MaleAntTemplate extends MonsterNPCTemplate {
	public static final int ID = 27195;

	@Inject
	protected MaleAntTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
