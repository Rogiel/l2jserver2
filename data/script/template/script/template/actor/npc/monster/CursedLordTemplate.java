 ...
 */
public class CursedLordTemplate extends MonsterNPCTemplate {
	public static final int ID = 22670;

	@Inject
	protected CursedLordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cursed Lord";
