 ...
 */
public class SoulCoffin7Template extends MonsterNPCTemplate {
	public static final int ID = 18714;

	@Inject
	protected SoulCoffin7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
