 ...
 */
public class OfferingOfBrandedZealotTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18015;

	@Inject
	protected OfferingOfBrandedZealotTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
