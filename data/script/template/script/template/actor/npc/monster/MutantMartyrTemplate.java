 ...
 */
public class MutantMartyrTemplate extends MonsterNPCTemplate {
	public static final int ID = 18821;

	@Inject
	protected MutantMartyrTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mutant Martyr";
