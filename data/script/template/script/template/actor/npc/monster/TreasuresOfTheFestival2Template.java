 ...
 */
public class TreasuresOfTheFestival2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18110;

	@Inject
	protected TreasuresOfTheFestival2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
