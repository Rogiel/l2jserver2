 ...
 */
public class ArchonOfHalisha8Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18219;

	@Inject
	protected ArchonOfHalisha8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
