 ...
 */
public class KechisCaptain4Template extends MonsterNPCTemplate {
	public static final int ID = 22416;

	@Inject
	protected KechisCaptain4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
