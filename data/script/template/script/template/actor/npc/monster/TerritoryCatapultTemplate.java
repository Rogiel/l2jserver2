 ...
 */
public class TerritoryCatapultTemplate extends MonsterNPCTemplate {
	public static final int ID = 36499;

	@Inject
	protected TerritoryCatapultTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
