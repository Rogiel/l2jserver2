 ...
 */
public class ForestOfMirrorsGhost3Template extends MonsterNPCTemplate {
	public static final int ID = 20638;

	@Inject
	protected ForestOfMirrorsGhost3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Forest of Mirrors Ghost";
