 ...
 */
public class UnknownStopper2Template extends MonsterNPCTemplate {
	public static final int ID = 27255;

	@Inject
	protected UnknownStopper2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
