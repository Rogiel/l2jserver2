 ...
 */
public class SepulcherArchonTemplate extends MonsterNPCTemplate {
	public static final int ID = 21220;

	@Inject
	protected SepulcherArchonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
