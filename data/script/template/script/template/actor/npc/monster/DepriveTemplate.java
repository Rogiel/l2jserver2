 ...
 */
public class DepriveTemplate extends MonsterNPCTemplate {
	public static final int ID = 20664;

	@Inject
	protected DepriveTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
