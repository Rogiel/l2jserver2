 ...
 */
public class ContaminatedBaturWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 22704;

	@Inject
	protected ContaminatedBaturWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Contaminated Batur Warrior";
