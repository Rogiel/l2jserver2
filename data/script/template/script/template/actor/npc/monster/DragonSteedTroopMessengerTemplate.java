 ...
 */
public class DragonSteedTroopMessengerTemplate extends MonsterNPCTemplate {
	public static final int ID = 18677;

	@Inject
	protected DragonSteedTroopMessengerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dragon Steed Troop Messenger";
