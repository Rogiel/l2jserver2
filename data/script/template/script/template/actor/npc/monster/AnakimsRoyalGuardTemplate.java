 ...
 */
public class AnakimsRoyalGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 25288;

	@Inject
	protected AnakimsRoyalGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Anakim's Royal Guard";
