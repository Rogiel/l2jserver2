 ...
 */
public class ApostatesOfferingZealotTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18025;

	@Inject
	protected ApostatesOfferingZealotTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
