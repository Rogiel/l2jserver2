 ...
 */
public class VeelanBugbearWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20402;

	@Inject
	protected VeelanBugbearWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Veelan Bugbear Warrior";
