 ...
 */
public class OlMahumPatrolmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20065;

	@Inject
	protected OlMahumPatrolmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ol Mahum Patrolman";
