 ...
 */
public class GreyElpyTemplate extends MonsterNPCTemplate {
	public static final int ID = 22228;

	@Inject
	protected GreyElpyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
