 ...
 */
public class CloudyBeastTemplate extends MonsterNPCTemplate {
	public static final int ID = 21096;

	@Inject
	protected CloudyBeastTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cloudy Beast";
