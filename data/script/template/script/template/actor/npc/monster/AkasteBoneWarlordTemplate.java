 ...
 */
public class AkasteBoneWarlordTemplate extends MonsterNPCTemplate {
	public static final int ID = 20422;

	@Inject
	protected AkasteBoneWarlordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Akaste Bone Warlord";
