 ...
 */
public class BoogleRatmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20389;

	@Inject
	protected BoogleRatmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Boogle Ratman";
