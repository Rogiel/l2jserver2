 ...
 */
public class TriolsBeliever8Template extends MonsterNPCTemplate {
	public static final int ID = 22170;

	@Inject
	protected TriolsBeliever8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
