 ...
 */
public class MaleSpikedStakato3Template extends MonsterNPCTemplate {
	public static final int ID = 22621;

	@Inject
	protected MaleSpikedStakato3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
