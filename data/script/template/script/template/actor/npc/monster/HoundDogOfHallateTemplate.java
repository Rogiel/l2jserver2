 ...
 */
public class HoundDogOfHallateTemplate extends MonsterNPCTemplate {
	public static final int ID = 20815;

	@Inject
	protected HoundDogOfHallateTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hound Dog of Hallate";
