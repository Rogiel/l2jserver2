 ...
 */
public class AncientGargoyleTemplate extends MonsterNPCTemplate {
	public static final int ID = 21018;

	@Inject
	protected AncientGargoyleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ancient Gargoyle";
