 ...
 */
public class Puma2Template extends MonsterNPCTemplate {
	public static final int ID = 20510;

	@Inject
	protected Puma2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
