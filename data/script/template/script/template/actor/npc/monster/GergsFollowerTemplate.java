 ...
 */
public class GergsFollowerTemplate extends MonsterNPCTemplate {
	public static final int ID = 25594;

	@Inject
	protected GergsFollowerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gerg's Follower";
