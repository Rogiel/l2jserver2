 ...
 */
public class FrenzyStakatoDroneTemplate extends MonsterNPCTemplate {
	public static final int ID = 21519;

	@Inject
	protected FrenzyStakatoDroneTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Frenzy Stakato Drone";
