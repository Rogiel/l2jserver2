 ...
 */
public class OverlordOfTheHolyLandsTemplate extends MonsterNPCTemplate {
	public static final int ID = 21216;

	@Inject
	protected OverlordOfTheHolyLandsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Overlord of the Holy Lands";
		...
		this.experience = 6807;
		this.sp = 440;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(129);
		this.leftHand = itemProvider.createID(646);
		this.enchantLevel = 0;
