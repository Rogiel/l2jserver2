 ...
 */
public class FollowerOfGwindorr2Template extends MonsterNPCTemplate {
	public static final int ID = 25676;

	@Inject
	protected FollowerOfGwindorr2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
