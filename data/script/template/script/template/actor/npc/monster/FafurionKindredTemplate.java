 ...
 */
public class FafurionKindredTemplate extends MonsterNPCTemplate {
	public static final int ID = 18482;

	@Inject
	protected FafurionKindredTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fafurion Kindred";
