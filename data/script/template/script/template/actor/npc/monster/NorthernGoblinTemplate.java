 ...
 */
public class NorthernGoblinTemplate extends MonsterNPCTemplate {
	public static final int ID = 21127;

	@Inject
	protected NorthernGoblinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Northern Goblin";
