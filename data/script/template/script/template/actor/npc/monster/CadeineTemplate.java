 ...
 */
public class CadeineTemplate extends MonsterNPCTemplate {
	public static final int ID = 20945;

	@Inject
	protected CadeineTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.experience = 2690;
		this.sp = 203;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(127);
		this.leftHand = itemProvider.createID(625);
		this.enchantLevel = 0;
