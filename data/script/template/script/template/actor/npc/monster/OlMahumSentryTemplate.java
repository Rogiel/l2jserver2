 ...
 */
public class OlMahumSentryTemplate extends MonsterNPCTemplate {
	public static final int ID = 27031;

	@Inject
	protected OlMahumSentryTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ol Mahum Sentry";
