 ...
 */
public class RedArachneTemplate extends MonsterNPCTemplate {
	public static final int ID = 31849;

	@Inject
	protected RedArachneTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Red Arachne";
