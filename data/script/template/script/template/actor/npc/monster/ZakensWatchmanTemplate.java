 ...
 */
public class ZakensWatchmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 21608;

	@Inject
	protected ZakensWatchmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
