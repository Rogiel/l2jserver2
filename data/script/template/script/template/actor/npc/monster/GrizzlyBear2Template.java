 ...
 */
public class GrizzlyBear2Template extends MonsterNPCTemplate {
	public static final int ID = 20335;

	@Inject
	protected GrizzlyBear2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
