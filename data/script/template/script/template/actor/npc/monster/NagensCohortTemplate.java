 ...
 */
public class NagensCohortTemplate extends MonsterNPCTemplate {
	public static final int ID = 25567;

	@Inject
	protected NagensCohortTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nagen's Cohort";
