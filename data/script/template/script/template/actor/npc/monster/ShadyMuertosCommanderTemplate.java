 ...
 */
public class ShadyMuertosCommanderTemplate extends MonsterNPCTemplate {
	public static final int ID = 22255;

	@Inject
	protected ShadyMuertosCommanderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shady Muertos Commander";
