 ...
 */
public class KirunakTemplate extends MonsterNPCTemplate {
	public static final int ID = 27021;

	@Inject
	protected KirunakTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
