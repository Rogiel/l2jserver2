 ...
 */
public class HalishasForeman3Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18175;

	@Inject
	protected HalishasForeman3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
