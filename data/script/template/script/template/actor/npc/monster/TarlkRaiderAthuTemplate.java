 ...
 */
public class TarlkRaiderAthuTemplate extends MonsterNPCTemplate {
	public static final int ID = 27144;

	@Inject
	protected TarlkRaiderAthuTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tarlk Raider Athu";
