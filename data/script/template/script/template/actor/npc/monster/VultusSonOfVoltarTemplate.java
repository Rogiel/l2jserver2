 ...
 */
public class VultusSonOfVoltarTemplate extends MonsterNPCTemplate {
	public static final int ID = 27081;

	@Inject
	protected VultusSonOfVoltarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vultus Son Of Voltar";
