 ...
 */
public class ZealotOfShilenTemplate extends MonsterNPCTemplate {
	public static final int ID = 18782;

	@Inject
	protected ZealotOfShilenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Zealot of Shilen";
