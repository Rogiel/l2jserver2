 ...
 */
public class TempleGuardCaptainTemplate extends MonsterNPCTemplate {
	public static final int ID = 22153;

	@Inject
	protected TempleGuardCaptainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Temple Guard Captain";
