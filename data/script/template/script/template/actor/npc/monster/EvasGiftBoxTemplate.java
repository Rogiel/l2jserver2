 ...
 */
public class EvasGiftBoxTemplate extends MonsterNPCTemplate {
	public static final int ID = 32342;

	@Inject
	protected EvasGiftBoxTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Eva's Gift Box";
