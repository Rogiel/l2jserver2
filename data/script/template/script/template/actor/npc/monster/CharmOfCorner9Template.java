 ...
 */
public class CharmOfCorner9Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18204;

	@Inject
	protected CharmOfCorner9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
