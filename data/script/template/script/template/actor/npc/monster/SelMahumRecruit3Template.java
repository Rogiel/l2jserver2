 ...
 */
public class SelMahumRecruit3Template extends MonsterNPCTemplate {
	public static final int ID = 22784;

	@Inject
	protected SelMahumRecruit3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
