 ...
 */
public class Beleth2Template extends MonsterNPCTemplate {
	public static final int ID = 29119;

	@Inject
	protected Beleth2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 994600.000000000000000;
