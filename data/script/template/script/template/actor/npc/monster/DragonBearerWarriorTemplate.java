 ...
 */
public class DragonBearerWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20759;

	@Inject
	protected DragonBearerWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dragon Bearer Warrior";
