 ...
 */
public class DivinityMagusTemplate extends MonsterNPCTemplate {
	public static final int ID = 22800;

	@Inject
	protected DivinityMagusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Divinity Magus";
