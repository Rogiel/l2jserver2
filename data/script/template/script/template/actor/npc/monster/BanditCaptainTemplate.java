 ...
 */
public class BanditCaptainTemplate extends MonsterNPCTemplate {
	public static final int ID = 22026;

	@Inject
	protected BanditCaptainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
