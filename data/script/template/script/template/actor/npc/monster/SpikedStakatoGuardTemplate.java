 ...
 */
public class SpikedStakatoGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 22107;

	@Inject
	protected SpikedStakatoGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
