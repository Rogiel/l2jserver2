 ...
 */
public class FlineElderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20595;

	@Inject
	protected FlineElderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fline Elder";
