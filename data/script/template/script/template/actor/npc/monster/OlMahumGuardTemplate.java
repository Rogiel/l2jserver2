 ...
 */
public class OlMahumGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 20058;

	@Inject
	protected OlMahumGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ol Mahum Guard";
