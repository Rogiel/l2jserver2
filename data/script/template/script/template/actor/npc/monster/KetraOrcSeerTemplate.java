 ...
 */
public class KetraOrcSeerTemplate extends MonsterNPCTemplate {
	public static final int ID = 21338;

	@Inject
	protected KetraOrcSeerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ketra Orc Seer";
