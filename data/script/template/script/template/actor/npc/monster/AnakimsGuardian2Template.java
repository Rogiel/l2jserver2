 ...
 */
public class AnakimsGuardian2Template extends MonsterNPCTemplate {
	public static final int ID = 27389;

	@Inject
	protected AnakimsGuardian2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
