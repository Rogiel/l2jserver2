 ...
 */
public class ArchonOfHalisha9Template extends MonsterNPCTemplate {
	public static final int ID = 27219;

	@Inject
	protected ArchonOfHalisha9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
