 ...
 */
public class SalamanderRowinTemplate extends MonsterNPCTemplate {
	public static final int ID = 20612;

	@Inject
	protected SalamanderRowinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Salamander Rowin";
