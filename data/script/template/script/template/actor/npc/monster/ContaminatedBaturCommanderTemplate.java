 ...
 */
public class ContaminatedBaturCommanderTemplate extends MonsterNPCTemplate {
	public static final int ID = 22705;

	@Inject
	protected ContaminatedBaturCommanderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Contaminated Batur Commander";
