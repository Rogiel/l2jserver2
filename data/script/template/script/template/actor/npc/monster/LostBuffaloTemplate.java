 ...
 */
public class LostBuffaloTemplate extends MonsterNPCTemplate {
	public static final int ID = 22093;

	@Inject
	protected LostBuffaloTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lost Buffalo";
