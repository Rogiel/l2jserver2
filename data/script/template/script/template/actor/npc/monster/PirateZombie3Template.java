 ...
 */
public class PirateZombie3Template extends MonsterNPCTemplate {
	public static final int ID = 29185;

	@Inject
	protected PirateZombie3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
