 ...
 */
public class BlackWolfTemplate extends MonsterNPCTemplate {
	public static final int ID = 20317;

	@Inject
	protected BlackWolfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
