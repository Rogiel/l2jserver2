 ...
 */
public class CannibalisticStakatoLeader3Template extends MonsterNPCTemplate {
	public static final int ID = 22625;

	@Inject
	protected CannibalisticStakatoLeader3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cannibalistic Stakato Leader";
