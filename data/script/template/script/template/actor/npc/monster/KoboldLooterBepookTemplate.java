 ...
 */
public class KoboldLooterBepookTemplate extends MonsterNPCTemplate {
	public static final int ID = 20738;

	@Inject
	protected KoboldLooterBepookTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kobold Looter Bepook";
