 ...
 */
public class VanorSilenosTemplate extends MonsterNPCTemplate {
	public static final int ID = 20681;

	@Inject
	protected VanorSilenosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vanor Silenos";
