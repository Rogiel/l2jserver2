 ...
 */
public class AssassinOfEmpireTemplate extends MonsterNPCTemplate {
	public static final int ID = 21414;

	@Inject
	protected AssassinOfEmpireTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
