 ...
 */
public class RitualSacrifice6Template extends MonsterNPCTemplate {
	public static final int ID = 22190;

	@Inject
	protected RitualSacrifice6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
