 ...
 */
public class WitchsOfferingBerserkerTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18034;

	@Inject
	protected WitchsOfferingBerserkerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
