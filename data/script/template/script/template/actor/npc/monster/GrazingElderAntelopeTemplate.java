 ...
 */
public class GrazingElderAntelopeTemplate extends MonsterNPCTemplate {
	public static final int ID = 18651;

	@Inject
	protected GrazingElderAntelopeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
