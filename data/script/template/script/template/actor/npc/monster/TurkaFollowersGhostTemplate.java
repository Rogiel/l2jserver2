 ...
 */
public class TurkaFollowersGhostTemplate extends MonsterNPCTemplate {
	public static final int ID = 22706;

	@Inject
	protected TurkaFollowersGhostTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Turka Follower's Ghost";
