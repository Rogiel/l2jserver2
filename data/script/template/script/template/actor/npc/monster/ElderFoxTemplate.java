 ...
 */
public class ElderFoxTemplate extends MonsterNPCTemplate {
	public static final int ID = 20119;

	@Inject
	protected ElderFoxTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
