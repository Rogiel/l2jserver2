 ...
 */
public class ChieftainsTreasureChestTemplate extends MonsterNPCTemplate {
	public static final int ID = 18816;

	@Inject
	protected ChieftainsTreasureChestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Chieftain's Treasure Chest";
