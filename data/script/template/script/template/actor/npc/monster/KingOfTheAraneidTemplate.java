 ...
 */
public class KingOfTheAraneidTemplate extends MonsterNPCTemplate {
	public static final int ID = 20927;

	@Inject
	protected KingOfTheAraneidTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "King of the Araneid";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 39.00;
