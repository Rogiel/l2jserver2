 ...
 */
public class NihilInvaderWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 22719;

	@Inject
	protected NihilInvaderWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nihil Invader Warrior";
