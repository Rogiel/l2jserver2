 ...
 */
public class OfferingOfForbiddenPathDisciple2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18107;

	@Inject
	protected OfferingOfForbiddenPathDisciple2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Offering of Forbidden Path Disciple";
