 ...
 */
public class GiantFungusTemplate extends MonsterNPCTemplate {
	public static final int ID = 20555;

	@Inject
	protected GiantFungusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Giant Fungus";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 15.00;
		this.collisionHeight = 31.30;
		this.level = 40;
