 ...
 */
public class ElrokiTemplate extends MonsterNPCTemplate {
	public static final int ID = 22214;

	@Inject
	protected ElrokiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
