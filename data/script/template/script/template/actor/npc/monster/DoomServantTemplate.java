 ...
 */
public class DoomServantTemplate extends MonsterNPCTemplate {
	public static final int ID = 21006;

	@Inject
	protected DoomServantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Doom Servant";
