 ...
 */
public class MarshPredatorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21110;

	@Inject
	protected MarshPredatorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Marsh Predator";
