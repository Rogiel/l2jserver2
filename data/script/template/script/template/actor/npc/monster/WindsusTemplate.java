 ...
 */
public class WindsusTemplate extends MonsterNPCTemplate {
	public static final int ID = 20553;

	@Inject
	protected WindsusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
