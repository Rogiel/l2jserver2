 ...
 */
public class PirateZombieTemplate extends MonsterNPCTemplate {
	public static final int ID = 20836;

	@Inject
	protected PirateZombieTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
