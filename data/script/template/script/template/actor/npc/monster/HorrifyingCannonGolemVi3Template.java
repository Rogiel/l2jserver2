 ...
 */
public class HorrifyingCannonGolemVi3Template extends MonsterNPCTemplate {
	public static final int ID = 22068;

	@Inject
	protected HorrifyingCannonGolemVi3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
