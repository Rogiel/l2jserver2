 ...
 */
public class ShilensEvilThoughts15Template extends MonsterNPCTemplate {
	public static final int ID = 27400;

	@Inject
	protected ShilensEvilThoughts15Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shilen's Evil Thoughts";
