 ...
 */
public class AkasteSuccubusTurenTemplate extends MonsterNPCTemplate {
	public static final int ID = 20420;

	@Inject
	protected AkasteSuccubusTurenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Akaste Succubus Turen";
