 ...
 */
public class OlMahumRecruitTemplate extends MonsterNPCTemplate {
	public static final int ID = 20437;

	@Inject
	protected OlMahumRecruitTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ol Mahum Recruit";
