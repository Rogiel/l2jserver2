 ...
 */
public class LesserGiantTemplate extends MonsterNPCTemplate {
	public static final int ID = 20653;

	@Inject
	protected LesserGiantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
