 ...
 */
public class ArchangelIconoclasis3Template extends MonsterNPCTemplate {
	public static final int ID = 27259;

	@Inject
	protected ArchangelIconoclasis3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
