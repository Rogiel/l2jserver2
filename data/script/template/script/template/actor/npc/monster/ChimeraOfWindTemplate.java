 ...
 */
public class ChimeraOfWindTemplate extends MonsterNPCTemplate {
	public static final int ID = 22351;

	@Inject
	protected ChimeraOfWindTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Chimera of Wind";
