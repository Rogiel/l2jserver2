 ...
 */
public class OlMahumTranscender3Template extends MonsterNPCTemplate {
	public static final int ID = 21263;

	@Inject
	protected OlMahumTranscender3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
