 ...
 */
public class SpiritOfFire2Template extends MonsterNPCTemplate {
	public static final int ID = 18614;

	@Inject
	protected SpiritOfFire2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
