 ...
 */
public class DarkChoirPrimaDonnaTemplate extends MonsterNPCTemplate {
	public static final int ID = 18335;

	@Inject
	protected DarkChoirPrimaDonnaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Choir Prima Donna";
