 ...
 */
public class ShadyMuertosArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 22254;

	@Inject
	protected ShadyMuertosArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shady Muertos Archer";
