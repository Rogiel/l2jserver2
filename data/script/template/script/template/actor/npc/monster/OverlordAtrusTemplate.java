 ...
 */
public class OverlordAtrusTemplate extends MonsterNPCTemplate {
	public static final int ID = 27294;

	@Inject
	protected OverlordAtrusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Overlord Atrus";
