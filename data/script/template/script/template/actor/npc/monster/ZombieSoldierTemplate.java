 ...
 */
public class ZombieSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 20457;

	@Inject
	protected ZombieSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Zombie Soldier";
