 ...
 */
public class ShilensEvilThoughts7Template extends MonsterNPCTemplate {
	public static final int ID = 27374;

	@Inject
	protected ShilensEvilThoughts7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
