 ...
 */
public class VampireWarlordTemplate extends MonsterNPCTemplate {
	public static final int ID = 21593;

	@Inject
	protected VampireWarlordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
