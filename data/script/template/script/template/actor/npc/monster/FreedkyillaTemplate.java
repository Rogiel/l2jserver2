 ...
 */
public class FreedkyillaTemplate extends MonsterNPCTemplate {
	public static final int ID = 25640;

	@Inject
	protected FreedkyillaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Freedkyilla";
		this.serverSideName = false;
		this.title = "Hand of Night";
