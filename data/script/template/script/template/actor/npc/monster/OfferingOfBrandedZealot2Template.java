 ...
 */
public class OfferingOfBrandedZealot2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18065;

	@Inject
	protected OfferingOfBrandedZealot2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Offering of Branded Zealot";
		...
		attributes.physicalAttack = 106.05702;
		attributes.magicalAttack = 82.76936;
		attributes.physicalDefense = 113.00631;
