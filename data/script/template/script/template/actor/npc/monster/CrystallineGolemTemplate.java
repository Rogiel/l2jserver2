 ...
 */
public class CrystallineGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 29101;

	@Inject
	protected CrystallineGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
