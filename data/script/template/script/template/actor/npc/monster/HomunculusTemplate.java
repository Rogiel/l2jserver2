 ...
 */
public class HomunculusTemplate extends MonsterNPCTemplate {
	public static final int ID = 21303;

	@Inject
	protected HomunculusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Homunculus";
