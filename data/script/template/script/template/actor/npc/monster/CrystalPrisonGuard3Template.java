 ...
 */
public class CrystalPrisonGuard3Template extends MonsterNPCTemplate {
	public static final int ID = 29115;

	@Inject
	protected CrystalPrisonGuard3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
