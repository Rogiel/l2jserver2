 ...
 */
public class NephilimSwordsmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 21198;

	@Inject
	protected NephilimSwordsmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nephilim Swordsman";
