 ...
 */
public class ChimeraPieceTemplate extends MonsterNPCTemplate {
	public static final int ID = 20965;

	@Inject
	protected ChimeraPieceTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Chimera Piece";
