 ...
 */
public class OfferingOfBrandedMarksmanTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18016;

	@Inject
	protected OfferingOfBrandedMarksmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
