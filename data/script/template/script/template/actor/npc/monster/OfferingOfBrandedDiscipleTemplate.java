 ...
 */
public class OfferingOfBrandedDiscipleTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18017;

	@Inject
	protected OfferingOfBrandedDiscipleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
