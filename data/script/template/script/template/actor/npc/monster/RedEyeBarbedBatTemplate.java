 ...
 */
public class RedEyeBarbedBatTemplate extends MonsterNPCTemplate {
	public static final int ID = 21124;

	@Inject
	protected RedEyeBarbedBatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Red Eye Barbed Bat";
