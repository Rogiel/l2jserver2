 ...
 */
public class GreystoneGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 20333;

	@Inject
	protected GreystoneGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Greystone Golem";
