 ...
 */
public class EvilSpiritsOfTheMineTemplate extends MonsterNPCTemplate {
	public static final int ID = 22688;

	@Inject
	protected EvilSpiritsOfTheMineTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Evil Spirits of the Mine";
