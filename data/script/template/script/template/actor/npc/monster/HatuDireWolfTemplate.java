 ...
 */
public class HatuDireWolfTemplate extends MonsterNPCTemplate {
	public static final int ID = 20929;

	@Inject
	protected HatuDireWolfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hatu Dire Wolf";
