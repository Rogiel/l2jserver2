 ...
 */
public class HowlingIfritTemplate extends MonsterNPCTemplate {
	public static final int ID = 29043;

	@Inject
	protected HowlingIfritTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
