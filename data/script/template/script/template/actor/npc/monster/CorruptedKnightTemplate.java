 ...
 */
public class CorruptedKnightTemplate extends MonsterNPCTemplate {
	public static final int ID = 21547;

	@Inject
	protected CorruptedKnightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Corrupted Knight";
