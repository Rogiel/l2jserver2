 ...
 */
public class CorpseCandleTemplate extends MonsterNPCTemplate {
	public static final int ID = 20483;

	@Inject
	protected CorpseCandleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Corpse Candle";
