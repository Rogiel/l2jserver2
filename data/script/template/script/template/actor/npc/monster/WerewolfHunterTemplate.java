 ...
 */
public class WerewolfHunterTemplate extends MonsterNPCTemplate {
	public static final int ID = 20343;

	@Inject
	protected WerewolfHunterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Werewolf Hunter";
