 ...
 */
public class CallousKanabionTemplate extends MonsterNPCTemplate {
	public static final int ID = 22464;

	@Inject
	protected CallousKanabionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.experience = 3373;
		this.sp = 234;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(7887);
		this.leftHand = null;
		this.enchantLevel = 0;
