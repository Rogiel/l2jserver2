 ...
 */
public class GatosTroopLeaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 25133;

	@Inject
	protected GatosTroopLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gato's Troop Leader";
		...
		this.attackRange = 40;
		this.maxHP = 11846.087522148300000;
