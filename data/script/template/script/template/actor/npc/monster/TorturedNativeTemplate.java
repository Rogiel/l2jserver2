 ...
 */
public class TorturedNativeTemplate extends MonsterNPCTemplate {
	public static final int ID = 22450;

	@Inject
	protected TorturedNativeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tortured Native";
