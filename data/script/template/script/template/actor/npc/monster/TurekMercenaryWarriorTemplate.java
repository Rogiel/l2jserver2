 ...
 */
public class TurekMercenaryWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 25006;

	@Inject
	protected TurekMercenaryWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Turek Mercenary Warrior";
		...
		this.attackRange = 40;
		this.maxHP = 5391.141651731290000;
