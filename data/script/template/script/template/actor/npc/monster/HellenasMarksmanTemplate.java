 ...
 */
public class HellenasMarksmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 25186;

	@Inject
	protected HellenasMarksmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hellena's Marksman";
		...
		this.rightHand = itemProvider.createID(272);
		this.leftHand = null;
		this.enchantLevel = 0;
