 ...
 */
public class MalrukLordTemplate extends MonsterNPCTemplate {
	public static final int ID = 20627;

	@Inject
	protected MalrukLordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Malruk Lord";
