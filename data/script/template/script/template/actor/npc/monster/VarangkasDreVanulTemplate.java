 ...
 */
public class VarangkasDreVanulTemplate extends MonsterNPCTemplate {
	public static final int ID = 22046;

	@Inject
	protected VarangkasDreVanulTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
