 ...
 */
public class SentinelWaterspiritTemplate extends MonsterNPCTemplate {
	public static final int ID = 22658;

	@Inject
	protected SentinelWaterspiritTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sentinel Waterspirit";
