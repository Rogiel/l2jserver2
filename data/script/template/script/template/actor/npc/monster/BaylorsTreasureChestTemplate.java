 ...
 */
public class BaylorsTreasureChestTemplate extends MonsterNPCTemplate {
	public static final int ID = 29116;

	@Inject
	protected BaylorsTreasureChestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
