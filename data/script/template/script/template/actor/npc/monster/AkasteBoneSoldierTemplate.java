 ...
 */
public class AkasteBoneSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 20425;

	@Inject
	protected AkasteBoneSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Akaste Bone Soldier";
