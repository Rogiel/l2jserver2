 ...
 */
public class RottenMessengerTemplate extends MonsterNPCTemplate {
	public static final int ID = 22510;

	@Inject
	protected RottenMessengerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
