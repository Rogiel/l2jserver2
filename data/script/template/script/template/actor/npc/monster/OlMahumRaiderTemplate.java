 ...
 */
public class OlMahumRaiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20208;

	@Inject
	protected OlMahumRaiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ol Mahum Raider";
