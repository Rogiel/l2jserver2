 ...
 */
public class KinsusTemplate extends MonsterNPCTemplate {
	public static final int ID = 18608;

	@Inject
	protected KinsusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 16291.374214561000000;
