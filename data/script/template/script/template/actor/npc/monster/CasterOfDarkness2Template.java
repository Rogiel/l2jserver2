 ...
 */
public class CasterOfDarkness2Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18227;

	@Inject
	protected CasterOfDarkness2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
