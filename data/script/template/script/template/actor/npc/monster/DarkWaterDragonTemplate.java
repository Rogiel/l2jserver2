 ...
 */
public class DarkWaterDragonTemplate extends MonsterNPCTemplate {
	public static final int ID = 22267;

	@Inject
	protected DarkWaterDragonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Water Dragon";
