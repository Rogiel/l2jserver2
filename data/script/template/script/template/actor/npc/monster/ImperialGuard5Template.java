 ...
 */
public class ImperialGuard5Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18170;

	@Inject
	protected ImperialGuard5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1115.60664;
