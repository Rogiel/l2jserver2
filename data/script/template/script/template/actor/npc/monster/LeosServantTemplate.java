 ...
 */
public class LeosServantTemplate extends MonsterNPCTemplate {
	public static final int ID = 25123;

	@Inject
	protected LeosServantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Leo's Servant";
