 ...
 */
public class Gremlin2Template extends MonsterNPCTemplate {
	public static final int ID = 20001;

	@Inject
	protected Gremlin2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
