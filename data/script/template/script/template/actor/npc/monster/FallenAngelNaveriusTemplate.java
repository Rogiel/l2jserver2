 ...
 */
public class FallenAngelNaveriusTemplate extends MonsterNPCTemplate {
	public static final int ID = 27269;

	@Inject
	protected FallenAngelNaveriusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
