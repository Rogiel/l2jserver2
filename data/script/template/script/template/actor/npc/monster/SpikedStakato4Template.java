 ...
 */
public class SpikedStakato4Template extends MonsterNPCTemplate {
	public static final int ID = 25516;

	@Inject
	protected SpikedStakato4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
