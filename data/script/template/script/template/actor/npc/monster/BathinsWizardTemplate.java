 ...
 */
public class BathinsWizardTemplate extends MonsterNPCTemplate {
	public static final int ID = 21077;

	@Inject
	protected BathinsWizardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bathin's Wizard";
