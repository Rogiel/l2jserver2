 ...
 */
public class AssassinOfEmpire2Template extends MonsterNPCTemplate {
	public static final int ID = 21415;

	@Inject
	protected AssassinOfEmpire2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Assassin of Empire";
