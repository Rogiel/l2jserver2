 ...
 */
public class WarlikeTyrantTemplate extends MonsterNPCTemplate {
	public static final int ID = 21016;

	@Inject
	protected WarlikeTyrantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Warlike Tyrant";
