 ...
 */
public class SpelunkingSpiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 22051;

	@Inject
	protected SpelunkingSpiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Spelunking Spider";
