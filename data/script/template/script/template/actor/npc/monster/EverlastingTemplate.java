 ...
 */
public class EverlastingTemplate extends MonsterNPCTemplate {
	public static final int ID = 31005;

	@Inject
	protected EverlastingTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
