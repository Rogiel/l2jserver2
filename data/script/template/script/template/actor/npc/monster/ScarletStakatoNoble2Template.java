 ...
 */
public class ScarletStakatoNoble2Template extends MonsterNPCTemplate {
	public static final int ID = 21652;

	@Inject
	protected ScarletStakatoNoble2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Scarlet Stakato Noble";
