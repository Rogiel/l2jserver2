 ...
 */
public class StatueOfProtection6Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18236;

	@Inject
	protected StatueOfProtection6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
