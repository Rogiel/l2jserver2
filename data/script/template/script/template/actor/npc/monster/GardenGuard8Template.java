 ...
 */
public class GardenGuard8Template extends MonsterNPCTemplate {
	public static final int ID = 18444;

	@Inject
	protected GardenGuard8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
