 ...
 */
public class ConqueredSoul2Template extends MonsterNPCTemplate {
	public static final int ID = 18716;

	@Inject
	protected ConqueredSoul2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
