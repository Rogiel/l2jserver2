 ...
 */
public class GuardianAngel2Template extends MonsterNPCTemplate {
	public static final int ID = 20859;

	@Inject
	protected GuardianAngel2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
