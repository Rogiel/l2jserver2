 ...
 */
public class ArchonOfHalisha5Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18216;

	@Inject
	protected ArchonOfHalisha5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
