 ...
 */
public class HamesOrcOverlordTemplate extends MonsterNPCTemplate {
	public static final int ID = 21116;

	@Inject
	protected HamesOrcOverlordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hames Orc Overlord";
