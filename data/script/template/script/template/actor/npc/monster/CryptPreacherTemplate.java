 ...
 */
public class CryptPreacherTemplate extends MonsterNPCTemplate {
	public static final int ID = 21253;

	@Inject
	protected CryptPreacherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Crypt Preacher";
