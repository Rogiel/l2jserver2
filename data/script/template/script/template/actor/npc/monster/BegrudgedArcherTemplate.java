 ...
 */
public class BegrudgedArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 18623;

	@Inject
	protected BegrudgedArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Begrudged Archer";
