 ...
 */
public class DeadlyGinzuGolemViiiTemplate extends MonsterNPCTemplate {
	public static final int ID = 22078;

	@Inject
	protected DeadlyGinzuGolemViiiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Deadly Ginzu Golem VIII";
