 ...
 */
public class JaxsVanguardTemplate extends MonsterNPCTemplate {
	public static final int ID = 25570;

	@Inject
	protected JaxsVanguardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Jax's Vanguard";
