 ...
 */
public class OlMahumTranscender2Template extends MonsterNPCTemplate {
	public static final int ID = 21262;

	@Inject
	protected OlMahumTranscender2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
