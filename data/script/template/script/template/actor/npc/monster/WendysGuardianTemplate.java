 ...
 */
public class WendysGuardianTemplate extends MonsterNPCTemplate {
	public static final int ID = 27318;

	@Inject
	protected WendysGuardianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Wendy's Guardian";
