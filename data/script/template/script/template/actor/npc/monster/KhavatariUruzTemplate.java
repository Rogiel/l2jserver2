 ...
 */
public class KhavatariUruzTemplate extends MonsterNPCTemplate {
	public static final int ID = 27293;

	@Inject
	protected KhavatariUruzTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Khavatari Uruz";
