 ...
 */
public class HungryEyeTemplate extends MonsterNPCTemplate {
	public static final int ID = 20059;

	@Inject
	protected HungryEyeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hungry Eye";
