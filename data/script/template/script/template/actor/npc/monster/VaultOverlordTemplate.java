 ...
 */
public class VaultOverlordTemplate extends MonsterNPCTemplate {
	public static final int ID = 21218;

	@Inject
	protected VaultOverlordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vault Overlord";
