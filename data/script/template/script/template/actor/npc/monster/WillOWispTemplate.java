 ...
 */
public class WillOWispTemplate extends MonsterNPCTemplate {
	public static final int ID = 20449;

	@Inject
	protected WillOWispTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
