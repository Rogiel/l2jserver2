 ...
 */
public class ScavengerScarabTemplate extends MonsterNPCTemplate {
	public static final int ID = 21647;

	@Inject
	protected ScavengerScarabTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Scavenger Scarab";
