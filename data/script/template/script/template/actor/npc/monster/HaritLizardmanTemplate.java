 ...
 */
public class HaritLizardmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20640;

	@Inject
	protected HaritLizardmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Harit Lizardman";
