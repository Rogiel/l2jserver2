 ...
 */
public class FangOfSplendor2Template extends MonsterNPCTemplate {
	public static final int ID = 21538;

	@Inject
	protected FangOfSplendor2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
