 ...
 */
public class KashaImpTemplate extends MonsterNPCTemplate {
	public static final int ID = 21117;

	@Inject
	protected KashaImpTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
