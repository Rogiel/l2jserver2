 ...
 */
public class ThunderWyrmTemplate extends MonsterNPCTemplate {
	public static final int ID = 20243;

	@Inject
	protected ThunderWyrmTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
