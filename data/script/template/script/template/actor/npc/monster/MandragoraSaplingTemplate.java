 ...
 */
public class MandragoraSaplingTemplate extends MonsterNPCTemplate {
	public static final int ID = 20155;

	@Inject
	protected MandragoraSaplingTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mandragora Sapling";
