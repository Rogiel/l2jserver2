 ...
 */
public class KamutTemplate extends MonsterNPCTemplate {
	public static final int ID = 27067;

	@Inject
	protected KamutTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
