 ...
 */
public class KrajianTemplate extends MonsterNPCTemplate {
	public static final int ID = 22755;

	@Inject
	protected KrajianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
