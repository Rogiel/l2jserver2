 ...
 */
public class LostAssistantGuard8Template extends MonsterNPCTemplate {
	public static final int ID = 29149;

	@Inject
	protected LostAssistantGuard8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 2369.33573;
