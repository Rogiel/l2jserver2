 ...
 */
public class CaveAntTemplate extends MonsterNPCTemplate {
	public static final int ID = 21269;

	@Inject
	protected CaveAntTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
