 ...
 */
public class Victim7Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18156;

	@Inject
	protected Victim7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
