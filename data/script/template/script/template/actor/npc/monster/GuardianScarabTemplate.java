 ...
 */
public class GuardianScarabTemplate extends MonsterNPCTemplate {
	public static final int ID = 21410;

	@Inject
	protected GuardianScarabTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
