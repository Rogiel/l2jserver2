 ...
 */
public class LangkLizardmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20030;

	@Inject
	protected LangkLizardmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Langk Lizardman";
