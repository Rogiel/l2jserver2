 ...
 */
public class BloodyGhostTemplate extends MonsterNPCTemplate {
	public static final int ID = 20960;

	@Inject
	protected BloodyGhostTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bloody Ghost";
