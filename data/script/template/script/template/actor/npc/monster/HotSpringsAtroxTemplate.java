 ...
 */
public class HotSpringsAtroxTemplate extends MonsterNPCTemplate {
	public static final int ID = 21321;

	@Inject
	protected HotSpringsAtroxTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hot Springs Atrox";
