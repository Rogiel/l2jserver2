 ...
 */
public class OfferingOfBrandedArcherTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18011;

	@Inject
	protected OfferingOfBrandedArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
