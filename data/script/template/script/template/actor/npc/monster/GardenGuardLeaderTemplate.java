 ...
 */
public class GardenGuardLeaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20994;

	@Inject
	protected GardenGuardLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Garden Guard Leader";
