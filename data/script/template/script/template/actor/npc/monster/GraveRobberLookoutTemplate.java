 ...
 */
public class GraveRobberLookoutTemplate extends MonsterNPCTemplate {
	public static final int ID = 22004;

	@Inject
	protected GraveRobberLookoutTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grave Robber Lookout";
