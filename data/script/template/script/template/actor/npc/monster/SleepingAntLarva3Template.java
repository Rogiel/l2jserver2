 ...
 */
public class SleepingAntLarva3Template extends MonsterNPCTemplate {
	public static final int ID = 30984;

	@Inject
	protected SleepingAntLarva3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sleeping Ant Larva3";
