 ...
 */
public class SalamanderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20109;

	@Inject
	protected SalamanderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
