 ...
 */
public class CatacombShadowTemplate extends MonsterNPCTemplate {
	public static final int ID = 21144;

	@Inject
	protected CatacombShadowTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Catacomb Shadow";
