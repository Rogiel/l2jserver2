 ...
 */
public class CharmOfCorner6Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18201;

	@Inject
	protected CharmOfCorner6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
