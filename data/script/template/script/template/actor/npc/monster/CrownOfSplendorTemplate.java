 ...
 */
public class CrownOfSplendorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21536;

	@Inject
	protected CrownOfSplendorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Crown of Splendor";
