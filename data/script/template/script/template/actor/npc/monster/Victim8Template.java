 ...
 */
public class Victim8Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18157;

	@Inject
	protected Victim8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
