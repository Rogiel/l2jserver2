 ...
 */
public class ProwlerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20034;

	@Inject
	protected ProwlerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
