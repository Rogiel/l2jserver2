 ...
 */
public class RagnaOrcSniperTemplate extends MonsterNPCTemplate {
	public static final int ID = 22040;

	@Inject
	protected RagnaOrcSniperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
