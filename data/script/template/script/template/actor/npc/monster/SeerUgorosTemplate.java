 ...
 */
public class SeerUgorosTemplate extends MonsterNPCTemplate {
	public static final int ID = 18863;

	@Inject
	protected SeerUgorosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Seer Ugoros";
		this.serverSideName = false;
		this.title = "Tanta Lizardmen";
