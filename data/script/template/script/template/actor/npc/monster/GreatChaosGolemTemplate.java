 ...
 */
public class GreatChaosGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 22811;

	@Inject
	protected GreatChaosGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Great Chaos Golem";
