 ...
 */
public class BelethSample7Template extends MonsterNPCTemplate {
	public static final int ID = 18377;

	@Inject
	protected BelethSample7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
