 ...
 */
public class SleepingAntLarva6Template extends MonsterNPCTemplate {
	public static final int ID = 30987;

	@Inject
	protected SleepingAntLarva6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sleeping Ant Larva6";
