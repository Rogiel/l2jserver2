 ...
 */
public class GoblinBrigandLieutenantTemplate extends MonsterNPCTemplate {
	public static final int ID = 20324;

	@Inject
	protected GoblinBrigandLieutenantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Goblin Brigand Lieutenant";
		...
		this.rightHand = itemProvider.createID(10);
		this.leftHand = null;
		this.enchantLevel = 0;
