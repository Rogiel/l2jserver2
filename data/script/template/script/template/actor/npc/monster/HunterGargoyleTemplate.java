 ...
 */
public class HunterGargoyleTemplate extends MonsterNPCTemplate {
	public static final int ID = 20241;

	@Inject
	protected HunterGargoyleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hunter Gargoyle";
