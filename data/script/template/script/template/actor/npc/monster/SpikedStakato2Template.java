 ...
 */
public class SpikedStakato2Template extends MonsterNPCTemplate {
	public static final int ID = 22617;

	@Inject
	protected SpikedStakato2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
