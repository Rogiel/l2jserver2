 ...
 */
public class DollBlader3Template extends MonsterNPCTemplate {
	public static final int ID = 21632;

	@Inject
	protected DollBlader3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
