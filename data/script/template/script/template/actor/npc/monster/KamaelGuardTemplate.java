 ...
 */
public class KamaelGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 18352;

	@Inject
	protected KamaelGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kamael Guard";
