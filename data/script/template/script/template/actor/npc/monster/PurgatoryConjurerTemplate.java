 ...
 */
public class PurgatoryConjurerTemplate extends MonsterNPCTemplate {
	public static final int ID = 21155;

	@Inject
	protected PurgatoryConjurerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Purgatory Conjurer";
