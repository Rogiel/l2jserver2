 ...
 */
public class UrsusCubTemplate extends MonsterNPCTemplate {
	public static final int ID = 22095;

	@Inject
	protected UrsusCubTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
