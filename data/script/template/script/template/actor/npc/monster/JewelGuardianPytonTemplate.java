 ...
 */
public class JewelGuardianPytonTemplate extends MonsterNPCTemplate {
	public static final int ID = 27170;

	@Inject
	protected JewelGuardianPytonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Jewel Guardian Pyton";
