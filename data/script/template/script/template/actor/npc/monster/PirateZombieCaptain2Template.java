 ...
 */
public class PirateZombieCaptain2Template extends MonsterNPCTemplate {
	public static final int ID = 21630;

	@Inject
	protected PirateZombieCaptain2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
