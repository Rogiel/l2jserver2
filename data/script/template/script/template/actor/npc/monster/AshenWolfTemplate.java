 ...
 */
public class AshenWolfTemplate extends MonsterNPCTemplate {
	public static final int ID = 20456;

	@Inject
	protected AshenWolfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ashen Wolf";
