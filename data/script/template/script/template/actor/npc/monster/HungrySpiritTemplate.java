 ...
 */
public class HungrySpiritTemplate extends MonsterNPCTemplate {
	public static final int ID = 20148;

	@Inject
	protected HungrySpiritTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hungry Spirit";
