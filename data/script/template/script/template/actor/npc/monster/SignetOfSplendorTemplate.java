 ...
 */
public class SignetOfSplendorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21535;

	@Inject
	protected SignetOfSplendorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Signet of Splendor";
