 ...
 */
public class VictimTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18150;

	@Inject
	protected VictimTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
