 ...
 */
public class FoundryAssistantOverseerTemplate extends MonsterNPCTemplate {
	public static final int ID = 22391;

	@Inject
	protected FoundryAssistantOverseerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Foundry Assistant Overseer";
