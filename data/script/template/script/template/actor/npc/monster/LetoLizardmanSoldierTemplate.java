 ...
 */
public class LetoLizardmanSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 20579;

	@Inject
	protected LetoLizardmanSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Leto Lizardman Soldier";
