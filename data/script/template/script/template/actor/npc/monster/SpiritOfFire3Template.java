 ...
 */
public class SpiritOfFire3Template extends MonsterNPCTemplate {
	public static final int ID = 18615;

	@Inject
	protected SpiritOfFire3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Spirit of Fire";
