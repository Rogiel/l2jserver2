 ...
 */
public class MutantDiscipleTemplate extends MonsterNPCTemplate {
	public static final int ID = 22739;

	@Inject
	protected MutantDiscipleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mutant Disciple";
