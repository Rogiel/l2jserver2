 ...
 */
public class BlackWillowTemplate extends MonsterNPCTemplate {
	public static final int ID = 27118;

	@Inject
	protected BlackWillowTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Black Willow";
