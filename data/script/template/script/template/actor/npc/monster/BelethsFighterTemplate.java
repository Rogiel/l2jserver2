 ...
 */
public class BelethsFighterTemplate extends MonsterNPCTemplate {
	public static final int ID = 22412;

	@Inject
	protected BelethsFighterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Beleth's Fighter";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 32.00;
		this.collisionHeight = 46.80;
		this.level = 83;
