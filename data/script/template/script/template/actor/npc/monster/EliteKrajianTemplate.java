 ...
 */
public class EliteKrajianTemplate extends MonsterNPCTemplate {
	public static final int ID = 22758;

	@Inject
	protected EliteKrajianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Elite Krajian";
