 ...
 */
public class BaturOrcShamanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20258;

	@Inject
	protected BaturOrcShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Batur Orc Shaman";
