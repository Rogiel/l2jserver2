 ...
 */
public class DeluLizardmanWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20253;

	@Inject
	protected DeluLizardmanWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Delu Lizardman Warrior";
