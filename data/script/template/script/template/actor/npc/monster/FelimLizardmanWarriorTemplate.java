 ...
 */
public class FelimLizardmanWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20014;

	@Inject
	protected FelimLizardmanWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Felim Lizardman Warrior";
