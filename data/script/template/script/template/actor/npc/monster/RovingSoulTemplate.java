 ...
 */
public class RovingSoulTemplate extends MonsterNPCTemplate {
	public static final int ID = 20999;

	@Inject
	protected RovingSoulTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Roving Soul";
