 ...
 */
public class TardyonTemplate extends MonsterNPCTemplate {
	public static final int ID = 22756;

	@Inject
	protected TardyonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
