 ...
 */
public class MagicalEyeTemplate extends MonsterNPCTemplate {
	public static final int ID = 21012;

	@Inject
	protected MagicalEyeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Magical Eye";
