 ...
 */
public class Drake2Template extends MonsterNPCTemplate {
	public static final int ID = 20285;

	@Inject
	protected Drake2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
