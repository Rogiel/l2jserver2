 ...
 */
public class GigantSlaveTemplate extends MonsterNPCTemplate {
	public static final int ID = 21187;

	@Inject
	protected GigantSlaveTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gigant Slave";
