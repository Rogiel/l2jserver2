 ...
 */
public class NeedleStakatoDroneTemplate extends MonsterNPCTemplate {
	public static final int ID = 21516;

	@Inject
	protected NeedleStakatoDroneTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
