 ...
 */
public class AntPatrolTemplate extends MonsterNPCTemplate {
	public static final int ID = 20084;

	@Inject
	protected AntPatrolTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ant Patrol";
