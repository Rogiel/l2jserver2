 ...
 */
public class CannibalisticStakatoFollowerTemplate extends MonsterNPCTemplate {
	public static final int ID = 22112;

	@Inject
	protected CannibalisticStakatoFollowerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
