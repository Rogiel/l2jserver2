 ...
 */
public class TaikOrcArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20631;

	@Inject
	protected TaikOrcArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Taik Orc Archer";
