 ...
 */
public class BloodQueenTemplate extends MonsterNPCTemplate {
	public static final int ID = 18001;

	@Inject
	protected BloodQueenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
