 ...
 */
public class LilimSlayerTemplate extends MonsterNPCTemplate {
	public static final int ID = 21184;

	@Inject
	protected LilimSlayerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lilim Slayer";
		...
		this.leftHand = itemProvider.createID(236);
		this.enchantLevel = 0;
