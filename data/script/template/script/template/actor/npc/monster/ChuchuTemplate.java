 ...
 */
public class ChuchuTemplate extends MonsterNPCTemplate {
	public static final int ID = 27053;

	@Inject
	protected ChuchuTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
