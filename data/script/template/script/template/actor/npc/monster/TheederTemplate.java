 ...
 */
public class TheederTemplate extends MonsterNPCTemplate {
	public static final int ID = 20851;

	@Inject
	protected TheederTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
