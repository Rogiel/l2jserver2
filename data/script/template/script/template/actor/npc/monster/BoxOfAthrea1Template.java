 ...
 */
public class BoxOfAthrea1Template extends MonsterNPCTemplate {
	public static final int ID = 27173;

	@Inject
	protected BoxOfAthrea1Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Box Of Athrea 1";
