 ...
 */
public class MonumentDefenderAzraelTemplate extends MonsterNPCTemplate {
	public static final int ID = 27302;

	@Inject
	protected MonumentDefenderAzraelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
