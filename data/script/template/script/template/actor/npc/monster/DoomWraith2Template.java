 ...
 */
public class DoomWraith2Template extends MonsterNPCTemplate {
	public static final int ID = 20347;

	@Inject
	protected DoomWraith2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
