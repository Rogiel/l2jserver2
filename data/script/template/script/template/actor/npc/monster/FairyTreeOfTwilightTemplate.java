 ...
 */
public class FairyTreeOfTwilightTemplate extends MonsterNPCTemplate {
	public static final int ID = 27187;

	@Inject
	protected FairyTreeOfTwilightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fairy Tree of Twilight";
