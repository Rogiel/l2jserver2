 ...
 */
public class LostWatcher9Template extends MonsterNPCTemplate {
	public static final int ID = 22495;

	@Inject
	protected LostWatcher9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
