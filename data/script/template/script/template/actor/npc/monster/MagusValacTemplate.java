 ...
 */
public class MagusValacTemplate extends MonsterNPCTemplate {
	public static final int ID = 21078;

	@Inject
	protected MagusValacTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Magus Valac";
		...
		this.experience = 20355;
		this.sp = 2018;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(198);
		this.leftHand = null;
		this.enchantLevel = 0;
