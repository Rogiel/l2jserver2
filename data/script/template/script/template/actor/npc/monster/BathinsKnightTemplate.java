 ...
 */
public class BathinsKnightTemplate extends MonsterNPCTemplate {
	public static final int ID = 21076;

	@Inject
	protected BathinsKnightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bathin's Knight";
