 ...
 */
public class BumbumTemplate extends MonsterNPCTemplate {
	public static final int ID = 27051;

	@Inject
	protected BumbumTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
