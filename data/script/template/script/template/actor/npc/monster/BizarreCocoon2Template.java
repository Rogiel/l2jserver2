 ...
 */
public class BizarreCocoon2Template extends MonsterNPCTemplate {
	public static final int ID = 18794;

	@Inject
	protected BizarreCocoon2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
