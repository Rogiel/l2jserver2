 ...
 */
public class ResurrectedKnightTemplate extends MonsterNPCTemplate {
	public static final int ID = 21548;

	@Inject
	protected ResurrectedKnightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Resurrected Knight";
