 ...
 */
public class LilimMagus2Template extends MonsterNPCTemplate {
	public static final int ID = 27354;

	@Inject
	protected LilimMagus2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lilim Magus";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 8.00;
		this.collisionHeight = 30.60;
		this.level = 51;
