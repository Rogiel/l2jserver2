 ...
 */
public class SingingFlowerNightmareTemplate extends MonsterNPCTemplate {
	public static final int ID = 27096;

	@Inject
	protected SingingFlowerNightmareTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Singing Flower Nightmare";
