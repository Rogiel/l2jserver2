 ...
 */
public class OrcWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 27018;

	@Inject
	protected OrcWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
