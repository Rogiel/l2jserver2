 ...
 */
public class GigantRaiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 21193;

	@Inject
	protected GigantRaiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gigant Raider";
