 ...
 */
public class CarnivorousFungusTemplate extends MonsterNPCTemplate {
	public static final int ID = 20018;

	@Inject
	protected CarnivorousFungusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Carnivorous Fungus";
