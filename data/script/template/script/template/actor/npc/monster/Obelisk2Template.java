 ...
 */
public class Obelisk2Template extends MonsterNPCTemplate {
	public static final int ID = 22598;

	@Inject
	protected Obelisk2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Obelisk";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 229.00;
		this.collisionHeight = 177.50;
		this.level = 82;
