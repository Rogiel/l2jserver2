 ...
 */
public class NeedleStakatoDrone2Template extends MonsterNPCTemplate {
	public static final int ID = 21517;

	@Inject
	protected NeedleStakatoDrone2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Needle Stakato Drone";
