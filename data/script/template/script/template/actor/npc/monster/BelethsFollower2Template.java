 ...
 */
public class BelethsFollower2Template extends MonsterNPCTemplate {
	public static final int ID = 22414;

	@Inject
	protected BelethsFollower2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
