 ...
 */
public class DarkOmenOfferingDisciple2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18097;

	@Inject
	protected DarkOmenOfferingDisciple2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Omen Offering Disciple";
