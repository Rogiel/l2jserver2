 ...
 */
public class GoblinLordTemplate extends MonsterNPCTemplate {
	public static final int ID = 20528;

	@Inject
	protected GoblinLordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Goblin Lord";
