 ...
 */
public class MuertosCaptainTemplate extends MonsterNPCTemplate {
	public static final int ID = 22243;

	@Inject
	protected MuertosCaptainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Muertos Captain";
