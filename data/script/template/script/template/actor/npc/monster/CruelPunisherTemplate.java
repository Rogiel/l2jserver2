 ...
 */
public class CruelPunisherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20998;

	@Inject
	protected CruelPunisherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cruel Punisher";
