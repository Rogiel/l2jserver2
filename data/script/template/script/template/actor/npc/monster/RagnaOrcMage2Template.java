 ...
 */
public class RagnaOrcMage2Template extends MonsterNPCTemplate {
	public static final int ID = 22034;

	@Inject
	protected RagnaOrcMage2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
