 ...
 */
public class WindRiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 31007;

	@Inject
	protected WindRiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
