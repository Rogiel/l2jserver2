 ...
 */
public class NorthernGoblinLeaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 21130;

	@Inject
	protected NorthernGoblinLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Northern Goblin Leader";
