 ...
 */
public class LilimGreatMagus2Template extends MonsterNPCTemplate {
	public static final int ID = 27369;

	@Inject
	protected LilimGreatMagus2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
