 ...
 */
public class LawScholarOfConclusionsTemplate extends MonsterNPCTemplate {
	public static final int ID = 22532;

	@Inject
	protected LawScholarOfConclusionsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
