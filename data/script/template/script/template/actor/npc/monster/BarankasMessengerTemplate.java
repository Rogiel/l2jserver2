 ...
 */
public class BarankasMessengerTemplate extends MonsterNPCTemplate {
	public static final int ID = 27041;

	@Inject
	protected BarankasMessengerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Baranka's Messenger";
		...
		attributes.magicalDefense = 48.53733;
