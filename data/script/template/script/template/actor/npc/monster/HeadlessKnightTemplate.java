 ...
 */
public class HeadlessKnightTemplate extends MonsterNPCTemplate {
	public static final int ID = 20146;

	@Inject
	protected HeadlessKnightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
