 ...
 */
public class BloodySniperTemplate extends MonsterNPCTemplate {
	public static final int ID = 21085;

	@Inject
	protected BloodySniperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bloody Sniper";
