 ...
 */
public class OelMahumBerserkerTemplate extends MonsterNPCTemplate {
	public static final int ID = 35428;

	@Inject
	protected OelMahumBerserkerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Oel Mahum Berserker";
		...
		this.attackRange = 40;
		this.maxHP = 70386.644902731300000;
