 ...
 */
public class OriginalSinWardenTemplate extends MonsterNPCTemplate {
	public static final int ID = 22423;

	@Inject
	protected OriginalSinWardenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
