 ...
 */
public class QueenUndineTemplate extends MonsterNPCTemplate {
	public static final int ID = 20194;

	@Inject
	protected QueenUndineTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Queen Undine";
