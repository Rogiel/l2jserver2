 ...
 */
public class KnightOfDarknessTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18187;

	@Inject
	protected KnightOfDarknessTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
