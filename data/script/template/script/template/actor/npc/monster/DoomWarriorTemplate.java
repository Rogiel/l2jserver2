 ...
 */
public class DoomWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21010;

	@Inject
	protected DoomWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Doom Warrior";
