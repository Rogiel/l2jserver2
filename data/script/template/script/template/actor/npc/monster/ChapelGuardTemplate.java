 ...
 */
public class ChapelGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 22138;

	@Inject
	protected ChapelGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Chapel Guard";
