 ...
 */
public class DollBlader4Template extends MonsterNPCTemplate {
	public static final int ID = 21633;

	@Inject
	protected DollBlader4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
