 ...
 */
public class RitualOfferingTemplate extends MonsterNPCTemplate {
	public static final int ID = 22147;

	@Inject
	protected RitualOfferingTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
