 ...
 */
public class WarriorZombieOfFarakelsusTemplate extends MonsterNPCTemplate {
	public static final int ID = 25376;

	@Inject
	protected WarriorZombieOfFarakelsusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Warrior Zombie of Farakelsus";
