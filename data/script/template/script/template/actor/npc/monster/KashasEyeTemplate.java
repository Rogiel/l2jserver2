 ...
 */
public class KashasEyeTemplate extends MonsterNPCTemplate {
	public static final int ID = 18812;

	@Inject
	protected KashasEyeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
