 ...
 */
public class SleepingAntLarva5Template extends MonsterNPCTemplate {
	public static final int ID = 30986;

	@Inject
	protected SleepingAntLarva5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sleeping Ant Larva5";
