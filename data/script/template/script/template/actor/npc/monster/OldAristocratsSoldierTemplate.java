 ...
 */
public class OldAristocratsSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 22139;

	@Inject
	protected OldAristocratsSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Old Aristocrat's Soldier";
