 ...
 */
public class LilimAssassin4Template extends MonsterNPCTemplate {
	public static final int ID = 27377;

	@Inject
	protected LilimAssassin4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
