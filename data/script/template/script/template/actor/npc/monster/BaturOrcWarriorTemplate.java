 ...
 */
public class BaturOrcWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20257;

	@Inject
	protected BaturOrcWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Batur Orc Warrior";
