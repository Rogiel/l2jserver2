 ...
 */
public class MagicalWeaverTemplate extends MonsterNPCTemplate {
	public static final int ID = 20153;

	@Inject
	protected MagicalWeaverTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Magical Weaver";
