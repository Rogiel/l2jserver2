 ...
 */
public class BoneScavenger2Template extends MonsterNPCTemplate {
	public static final int ID = 21584;

	@Inject
	protected BoneScavenger2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
