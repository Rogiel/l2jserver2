 ...
 */
public class WitchsOfferingTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18030;

	@Inject
	protected WitchsOfferingTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
