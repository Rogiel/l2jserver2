 ...
 */
public class DeathKnightTemplate extends MonsterNPCTemplate {
	public static final int ID = 20136;

	@Inject
	protected DeathKnightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
