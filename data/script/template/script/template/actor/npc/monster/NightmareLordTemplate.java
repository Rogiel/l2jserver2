 ...
 */
public class NightmareLordTemplate extends MonsterNPCTemplate {
	public static final int ID = 20944;

	@Inject
	protected NightmareLordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nightmare Lord";
