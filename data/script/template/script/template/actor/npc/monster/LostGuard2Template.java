 ...
 */
public class LostGuard2Template extends MonsterNPCTemplate {
	public static final int ID = 29130;

	@Inject
	protected LostGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 249.84510;
		attributes.magicalAttack = 170.61181;
