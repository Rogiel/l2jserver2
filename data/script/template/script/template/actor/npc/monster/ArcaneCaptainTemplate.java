 ...
 */
public class ArcaneCaptainTemplate extends MonsterNPCTemplate {
	public static final int ID = 22404;

	@Inject
	protected ArcaneCaptainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Arcane Captain";
