 ...
 */
public class SikasWizardTemplate extends MonsterNPCTemplate {
	public static final int ID = 25215;

	@Inject
	protected SikasWizardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sika's Wizard";
