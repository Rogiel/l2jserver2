 ...
 */
public class ScoutTypeGolemNo2Template extends MonsterNPCTemplate {
	public static final int ID = 22808;

	@Inject
	protected ScoutTypeGolemNo2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Scout-type Golem No. 2";
