 ...
 */
public class RitualSacrifice7Template extends MonsterNPCTemplate {
	public static final int ID = 22195;

	@Inject
	protected RitualSacrifice7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ritual Sacrifice";
