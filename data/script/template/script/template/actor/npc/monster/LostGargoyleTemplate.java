 ...
 */
public class LostGargoyleTemplate extends MonsterNPCTemplate {
	public static final int ID = 22085;

	@Inject
	protected LostGargoyleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lost Gargoyle";
