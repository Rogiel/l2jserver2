 ...
 */
public class LangkLizardmanLeaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20356;

	@Inject
	protected LangkLizardmanLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Langk Lizardman Leader";
