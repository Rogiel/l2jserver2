 ...
 */
public class GrendelSlaveTemplate extends MonsterNPCTemplate {
	public static final int ID = 21304;

	@Inject
	protected GrendelSlaveTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grendel Slave";
