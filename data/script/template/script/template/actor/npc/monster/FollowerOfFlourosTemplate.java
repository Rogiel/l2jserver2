 ...
 */
public class FollowerOfFlourosTemplate extends MonsterNPCTemplate {
	public static final int ID = 18560;

	@Inject
	protected FollowerOfFlourosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Follower of Flouros";
