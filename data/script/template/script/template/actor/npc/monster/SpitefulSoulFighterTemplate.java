 ...
 */
public class SpitefulSoulFighterTemplate extends MonsterNPCTemplate {
	public static final int ID = 20976;

	@Inject
	protected SpitefulSoulFighterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Spiteful Soul Fighter";
