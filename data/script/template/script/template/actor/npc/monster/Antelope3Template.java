 ...
 */
public class Antelope3Template extends MonsterNPCTemplate {
	public static final int ID = 21280;

	@Inject
	protected Antelope3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
