 ...
 */
public class TasabaLizardmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20784;

	@Inject
	protected TasabaLizardmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
