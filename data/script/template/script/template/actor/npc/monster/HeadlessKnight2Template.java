 ...
 */
public class HeadlessKnight2Template extends MonsterNPCTemplate {
	public static final int ID = 20280;

	@Inject
	protected HeadlessKnight2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Headless Knight";
