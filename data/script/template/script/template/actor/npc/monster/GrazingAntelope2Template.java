 ...
 */
public class GrazingAntelope2Template extends MonsterNPCTemplate {
	public static final int ID = 18643;

	@Inject
	protected GrazingAntelope2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
