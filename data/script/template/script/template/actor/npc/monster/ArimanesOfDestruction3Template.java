 ...
 */
public class ArimanesOfDestruction3Template extends MonsterNPCTemplate {
	public static final int ID = 22644;

	@Inject
	protected ArimanesOfDestruction3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
