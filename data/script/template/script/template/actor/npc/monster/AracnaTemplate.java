 ...
 */
public class AracnaTemplate extends MonsterNPCTemplate {
	public static final int ID = 31844;

	@Inject
	protected AracnaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
