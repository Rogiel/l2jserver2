 ...
 */
public class ImperialCommanderTemplate extends MonsterNPCTemplate {
	public static final int ID = 21416;

	@Inject
	protected ImperialCommanderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
