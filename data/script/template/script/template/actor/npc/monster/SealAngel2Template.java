 ...
 */
public class SealAngel2Template extends MonsterNPCTemplate {
	public static final int ID = 20860;

	@Inject
	protected SealAngel2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Seal Angel";
