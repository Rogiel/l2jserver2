 ...
 */
public class EyeOfRulerTemplate extends MonsterNPCTemplate {
	public static final int ID = 21312;

	@Inject
	protected EyeOfRulerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Eye of Ruler";
