 ...
 */
public class TrackerSkeletonLeaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20042;

	@Inject
	protected TrackerSkeletonLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tracker Skeleton Leader";
