 ...
 */
public class RagnaOrcHeroTemplate extends MonsterNPCTemplate {
	public static final int ID = 22038;

	@Inject
	protected RagnaOrcHeroTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
