 ...
 */
public class VarkaSilenosGreatSeer2Template extends MonsterNPCTemplate {
	public static final int ID = 21368;

	@Inject
	protected VarkaSilenosGreatSeer2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Varka Silenos Great Seer";
