 ...
 */
public class PursuerTemplate extends MonsterNPCTemplate {
	public static final int ID = 27340;

	@Inject
	protected PursuerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
