 ...
 */
public class MasterZelosTemplate extends MonsterNPCTemplate {
	public static final int ID = 22377;

	@Inject
	protected MasterZelosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Master Zelos";
