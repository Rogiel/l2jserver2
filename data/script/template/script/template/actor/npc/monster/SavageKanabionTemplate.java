 ...
 */
public class SavageKanabionTemplate extends MonsterNPCTemplate {
	public static final int ID = 22467;

	@Inject
	protected SavageKanabionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
