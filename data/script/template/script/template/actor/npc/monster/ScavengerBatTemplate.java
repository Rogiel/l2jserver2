 ...
 */
public class ScavengerBatTemplate extends MonsterNPCTemplate {
	public static final int ID = 20411;

	@Inject
	protected ScavengerBatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Scavenger Bat";
