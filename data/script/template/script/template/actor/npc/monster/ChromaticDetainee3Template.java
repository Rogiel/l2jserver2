 ...
 */
public class ChromaticDetainee3Template extends MonsterNPCTemplate {
	public static final int ID = 22284;

	@Inject
	protected ChromaticDetainee3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
