 ...
 */
public class DrakeTemplate extends MonsterNPCTemplate {
	public static final int ID = 20137;

	@Inject
	protected DrakeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
