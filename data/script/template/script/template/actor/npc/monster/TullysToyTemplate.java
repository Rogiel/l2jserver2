 ...
 */
public class TullysToyTemplate extends MonsterNPCTemplate {
	public static final int ID = 22383;

	@Inject
	protected TullysToyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tully's Toy";
