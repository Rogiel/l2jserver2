 ...
 */
public class MarshSpiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20233;

	@Inject
	protected MarshSpiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Marsh Spider";
