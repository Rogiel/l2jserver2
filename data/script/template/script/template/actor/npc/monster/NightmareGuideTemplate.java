 ...
 */
public class NightmareGuideTemplate extends MonsterNPCTemplate {
	public static final int ID = 20942;

	@Inject
	protected NightmareGuideTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nightmare Guide";
