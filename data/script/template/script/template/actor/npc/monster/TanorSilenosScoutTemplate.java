 ...
 */
public class TanorSilenosScoutTemplate extends MonsterNPCTemplate {
	public static final int ID = 20938;

	@Inject
	protected TanorSilenosScoutTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tanor Silenos Scout";
