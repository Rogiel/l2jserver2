 ...
 */
public class LithWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21168;

	@Inject
	protected LithWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lith Warrior";
		...
		this.experience = 3420;
		this.sp = 175;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(5796);
		this.leftHand = null;
		this.enchantLevel = 0;
