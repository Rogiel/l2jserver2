 ...
 */
public class RakeclawImpChieftainTemplate extends MonsterNPCTemplate {
	public static final int ID = 20313;

	@Inject
	protected RakeclawImpChieftainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rakeclaw Imp Chieftain";
