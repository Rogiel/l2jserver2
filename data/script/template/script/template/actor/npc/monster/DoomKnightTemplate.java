 ...
 */
public class DoomKnightTemplate extends MonsterNPCTemplate {
	public static final int ID = 20674;

	@Inject
	protected DoomKnightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Doom Knight";
