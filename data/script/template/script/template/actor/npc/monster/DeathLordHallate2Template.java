 ...
 */
public class DeathLordHallate2Template extends MonsterNPCTemplate {
	public static final int ID = 27262;

	@Inject
	protected DeathLordHallate2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
