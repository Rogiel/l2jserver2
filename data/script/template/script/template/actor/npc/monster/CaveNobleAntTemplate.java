 ...
 */
public class CaveNobleAntTemplate extends MonsterNPCTemplate {
	public static final int ID = 21273;

	@Inject
	protected CaveNobleAntTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cave Noble Ant";
