 ...
 */
public class CrystallineGolem2Template extends MonsterNPCTemplate {
	public static final int ID = 29102;

	@Inject
	protected CrystallineGolem2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Crystalline Golem";
