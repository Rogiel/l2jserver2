 ...
 */
public class SatyrTemplate extends MonsterNPCTemplate {
	public static final int ID = 20592;

	@Inject
	protected SatyrTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
