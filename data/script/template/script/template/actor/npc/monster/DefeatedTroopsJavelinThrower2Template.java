 ...
 */
public class DefeatedTroopsJavelinThrower2Template extends MonsterNPCTemplate {
	public static final int ID = 18792;

	@Inject
	protected DefeatedTroopsJavelinThrower2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
