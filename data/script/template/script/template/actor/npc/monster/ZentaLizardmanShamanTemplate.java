 ...
 */
public class ZentaLizardmanShamanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20303;

	@Inject
	protected ZentaLizardmanShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Zenta Lizardman Shaman";
