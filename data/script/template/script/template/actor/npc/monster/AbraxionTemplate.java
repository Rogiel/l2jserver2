 ...
 */
public class AbraxionTemplate extends MonsterNPCTemplate {
	public static final int ID = 21426;

	@Inject
	protected AbraxionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
