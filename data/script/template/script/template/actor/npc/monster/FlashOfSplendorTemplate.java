 ...
 */
public class FlashOfSplendorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21523;

	@Inject
	protected FlashOfSplendorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Flash of Splendor";
		...
		this.experience = 9035;
		this.sp = 796;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(326);
		this.leftHand = null;
		this.enchantLevel = 0;
		...
		attributes.magicalDefense = 168.11300;
