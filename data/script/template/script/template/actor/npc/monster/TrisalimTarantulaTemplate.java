 ...
 */
public class TrisalimTarantulaTemplate extends MonsterNPCTemplate {
	public static final int ID = 20561;

	@Inject
	protected TrisalimTarantulaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Trisalim Tarantula";
