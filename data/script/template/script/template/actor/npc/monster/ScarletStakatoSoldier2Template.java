 ...
 */
public class ScarletStakatoSoldier2Template extends MonsterNPCTemplate {
	public static final int ID = 22635;

	@Inject
	protected ScarletStakatoSoldier2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
