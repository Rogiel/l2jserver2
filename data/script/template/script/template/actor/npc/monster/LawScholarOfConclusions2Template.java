 ...
 */
public class LawScholarOfConclusions2Template extends MonsterNPCTemplate {
	public static final int ID = 22533;

	@Inject
	protected LawScholarOfConclusions2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
