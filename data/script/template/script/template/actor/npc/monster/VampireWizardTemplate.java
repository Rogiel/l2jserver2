 ...
 */
public class VampireWizardTemplate extends MonsterNPCTemplate {
	public static final int ID = 21588;

	@Inject
	protected VampireWizardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
