 ...
 */
public class GrayAntTemplate extends MonsterNPCTemplate {
	public static final int ID = 20226;

	@Inject
	protected GrayAntTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
