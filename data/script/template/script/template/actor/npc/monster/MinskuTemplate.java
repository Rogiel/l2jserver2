 ...
 */
public class MinskuTemplate extends MonsterNPCTemplate {
	public static final int ID = 27052;

	@Inject
	protected MinskuTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
