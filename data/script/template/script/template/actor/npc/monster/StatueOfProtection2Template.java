 ...
 */
public class StatueOfProtection2Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18232;

	@Inject
	protected StatueOfProtection2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
