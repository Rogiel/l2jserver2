 ...
 */
public class RomerohivTemplate extends MonsterNPCTemplate {
	public static final int ID = 25638;

	@Inject
	protected RomerohivTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Romerohiv";
		this.serverSideName = false;
		this.title = "Betrayer of Oblivion";
