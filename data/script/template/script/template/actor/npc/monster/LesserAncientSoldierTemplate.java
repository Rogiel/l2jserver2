 ...
 */
public class LesserAncientSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 21161;

	@Inject
	protected LesserAncientSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lesser Ancient Soldier";
