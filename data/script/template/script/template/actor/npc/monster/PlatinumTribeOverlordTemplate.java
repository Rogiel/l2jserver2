 ...
 */
public class PlatinumTribeOverlordTemplate extends MonsterNPCTemplate {
	public static final int ID = 20829;

	@Inject
	protected PlatinumTribeOverlordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Platinum Tribe Overlord";
