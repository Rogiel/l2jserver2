 ...
 */
public class HorrifyingCannonGolemVi5Template extends MonsterNPCTemplate {
	public static final int ID = 22070;

	@Inject
	protected HorrifyingCannonGolemVi5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
