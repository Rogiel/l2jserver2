 ...
 */
public class BoneSnatcher2Template extends MonsterNPCTemplate {
	public static final int ID = 21558;

	@Inject
	protected BoneSnatcher2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bone Snatcher";
