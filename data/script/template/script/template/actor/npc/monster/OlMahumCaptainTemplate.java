 ...
 */
public class OlMahumCaptainTemplate extends MonsterNPCTemplate {
	public static final int ID = 20066;

	@Inject
	protected OlMahumCaptainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ol Mahum Captain";
