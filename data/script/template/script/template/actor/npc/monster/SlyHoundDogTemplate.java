 ...
 */
public class SlyHoundDogTemplate extends MonsterNPCTemplate {
	public static final int ID = 21313;

	@Inject
	protected SlyHoundDogTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sly Hound Dog";
