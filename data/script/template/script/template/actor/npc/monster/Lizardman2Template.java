 ...
 */
public class Lizardman2Template extends MonsterNPCTemplate {
	public static final int ID = 27034;

	@Inject
	protected Lizardman2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
