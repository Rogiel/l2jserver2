 ...
 */
public class YoungBrownKeltirTemplate extends MonsterNPCTemplate {
	public static final int ID = 20529;

	@Inject
	protected YoungBrownKeltirTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Young Brown Keltir";
