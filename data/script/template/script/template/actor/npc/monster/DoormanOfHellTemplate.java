 ...
 */
public class DoormanOfHellTemplate extends MonsterNPCTemplate {
	public static final int ID = 35417;

	@Inject
	protected DoormanOfHellTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
