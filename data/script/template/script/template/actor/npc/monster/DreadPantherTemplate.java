 ...
 */
public class DreadPantherTemplate extends MonsterNPCTemplate {
	public static final int ID = 25419;

	@Inject
	protected DreadPantherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dread Panther";
