 ...
 */
public class TreasuresOfTheFestival7Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18115;

	@Inject
	protected TreasuresOfTheFestival7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 942.392517900000000;
		...
		attributes.physicalDefense = 160.69000;
		attributes.magicalDefense = 97.34598;
