 ...
 */
public class ScarletStakatoNobleTemplate extends MonsterNPCTemplate {
	public static final int ID = 21378;

	@Inject
	protected ScarletStakatoNobleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
