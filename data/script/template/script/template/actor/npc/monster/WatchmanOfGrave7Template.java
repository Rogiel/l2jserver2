 ...
 */
public class WatchmanOfGrave7Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18250;

	@Inject
	protected WatchmanOfGrave7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
