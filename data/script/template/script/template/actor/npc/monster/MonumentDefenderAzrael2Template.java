 ...
 */
public class MonumentDefenderAzrael2Template extends MonsterNPCTemplate {
	public static final int ID = 27303;

	@Inject
	protected MonumentDefenderAzrael2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
