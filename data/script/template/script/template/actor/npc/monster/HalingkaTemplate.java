 ...
 */
public class HalingkaTemplate extends MonsterNPCTemplate {
	public static final int ID = 20646;

	@Inject
	protected HalingkaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
