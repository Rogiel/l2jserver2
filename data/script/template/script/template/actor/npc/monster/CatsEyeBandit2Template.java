 ...
 */
public class CatsEyeBandit2Template extends MonsterNPCTemplate {
	public static final int ID = 25081;

	@Inject
	protected CatsEyeBandit2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
