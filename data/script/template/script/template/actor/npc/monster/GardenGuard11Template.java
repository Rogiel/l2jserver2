 ...
 */
public class GardenGuard11Template extends MonsterNPCTemplate {
	public static final int ID = 22315;

	@Inject
	protected GardenGuard11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
