 ...
 */
public class GuardianAngel3Template extends MonsterNPCTemplate {
	public static final int ID = 27332;

	@Inject
	protected GuardianAngel3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
