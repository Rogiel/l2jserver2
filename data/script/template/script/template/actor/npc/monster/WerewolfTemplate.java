 ...
 */
public class WerewolfTemplate extends MonsterNPCTemplate {
	public static final int ID = 20132;

	@Inject
	protected WerewolfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
