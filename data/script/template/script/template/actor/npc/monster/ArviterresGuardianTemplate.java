 ...
 */
public class ArviterresGuardianTemplate extends MonsterNPCTemplate {
	public static final int ID = 18359;

	@Inject
	protected ArviterresGuardianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Arviterre's Guardian";
