 ...
 */
public class LeaderOfOfferingTemplate extends MonsterNPCTemplate {
	public static final int ID = 21436;

	@Inject
	protected LeaderOfOfferingTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Leader of Offering";
