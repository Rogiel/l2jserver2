 ...
 */
public class GardenGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 18347;

	@Inject
	protected GardenGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
