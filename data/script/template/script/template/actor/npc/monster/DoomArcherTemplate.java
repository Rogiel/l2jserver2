 ...
 */
public class DoomArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 21008;

	@Inject
	protected DoomArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Doom Archer";
