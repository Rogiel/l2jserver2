 ...
 */
public class LongtailKeltirTemplate extends MonsterNPCTemplate {
	public static final int ID = 20533;

	@Inject
	protected LongtailKeltirTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Longtail Keltir";
