 ...
 */
public class MonsterEyeWatcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20067;

	@Inject
	protected MonsterEyeWatcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Monster Eye Watcher";
