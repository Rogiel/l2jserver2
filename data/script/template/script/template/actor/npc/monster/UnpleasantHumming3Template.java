 ...
 */
public class UnpleasantHumming3Template extends MonsterNPCTemplate {
	public static final int ID = 21612;

	@Inject
	protected UnpleasantHumming3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Unpleasant Humming";
