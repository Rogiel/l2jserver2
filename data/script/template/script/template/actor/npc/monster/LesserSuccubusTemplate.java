 ...
 */
public class LesserSuccubusTemplate extends MonsterNPCTemplate {
	public static final int ID = 20048;

	@Inject
	protected LesserSuccubusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lesser Succubus";
