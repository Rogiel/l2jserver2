 ...
 */
public class WhiteSkullKanabionTemplate extends MonsterNPCTemplate {
	public static final int ID = 22452;

	@Inject
	protected WhiteSkullKanabionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
