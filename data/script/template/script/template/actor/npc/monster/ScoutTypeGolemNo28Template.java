 ...
 */
public class ScoutTypeGolemNo28Template extends MonsterNPCTemplate {
	public static final int ID = 22807;

	@Inject
	protected ScoutTypeGolemNo28Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Scout-type Golem No. 28";
