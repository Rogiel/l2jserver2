 ...
 */
public class DarkHorrorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20105;

	@Inject
	protected DarkHorrorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Horror";
