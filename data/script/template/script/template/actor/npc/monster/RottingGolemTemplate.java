 ...
 */
public class RottingGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 20559;

	@Inject
	protected RottingGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rotting Golem";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 22.00;
		this.collisionHeight = 43.40;
		this.level = 44;
