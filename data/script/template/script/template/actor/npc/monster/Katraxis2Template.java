 ...
 */
public class Katraxis2Template extends MonsterNPCTemplate {
	public static final int ID = 21403;

	@Inject
	protected Katraxis2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
