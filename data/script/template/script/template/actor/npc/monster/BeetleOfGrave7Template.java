 ...
 */
public class BeetleOfGrave7Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18147;

	@Inject
	protected BeetleOfGrave7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
