 ...
 */
public class HatarChieftainKubelTemplate extends MonsterNPCTemplate {
	public static final int ID = 27162;

	@Inject
	protected HatarChieftainKubelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hatar Chieftain Kubel";
