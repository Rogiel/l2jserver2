 ...
 */
public class BodyDestroyerTemplate extends MonsterNPCTemplate {
	public static final int ID = 22363;

	@Inject
	protected BodyDestroyerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Body Destroyer";
