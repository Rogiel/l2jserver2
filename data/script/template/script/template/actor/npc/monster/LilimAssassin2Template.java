 ...
 */
public class LilimAssassin2Template extends MonsterNPCTemplate {
	public static final int ID = 27359;

	@Inject
	protected LilimAssassin2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
