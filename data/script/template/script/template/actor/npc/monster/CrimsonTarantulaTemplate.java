 ...
 */
public class CrimsonTarantulaTemplate extends MonsterNPCTemplate {
	public static final int ID = 20394;

	@Inject
	protected CrimsonTarantulaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Crimson Tarantula";
