 ...
 */
public class MulsKnightTemplate extends MonsterNPCTemplate {
	public static final int ID = 20982;

	@Inject
	protected MulsKnightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mul's Knight";
