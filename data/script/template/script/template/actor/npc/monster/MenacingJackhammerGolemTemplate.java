 ...
 */
public class MenacingJackhammerGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 22052;

	@Inject
	protected MenacingJackhammerGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Menacing Jackhammer Golem";
