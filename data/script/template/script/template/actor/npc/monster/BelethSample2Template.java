 ...
 */
public class BelethSample2Template extends MonsterNPCTemplate {
	public static final int ID = 18372;

	@Inject
	protected BelethSample2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
