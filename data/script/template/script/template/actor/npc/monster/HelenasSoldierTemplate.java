 ...
 */
public class HelenasSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 25187;

	@Inject
	protected HelenasSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Helena's Soldier";
