 ...
 */
public class LilimGuardKnight3Template extends MonsterNPCTemplate {
	public static final int ID = 27379;

	@Inject
	protected LilimGuardKnight3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
