 ...
 */
public class CrimsonValeMasterTemplate extends MonsterNPCTemplate {
	public static final int ID = 21637;

	@Inject
	protected CrimsonValeMasterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Crimson Vale Master";
