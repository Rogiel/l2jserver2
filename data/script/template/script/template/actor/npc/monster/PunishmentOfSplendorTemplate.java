 ...
 */
public class PunishmentOfSplendorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21531;

	@Inject
	protected PunishmentOfSplendorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
