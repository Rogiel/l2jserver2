 ...
 */
public class SepulcherGuard2Template extends MonsterNPCTemplate {
	public static final int ID = 21230;

	@Inject
	protected SepulcherGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sepulcher Guard";
