 ...
 */
public class KartesRoyalGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 25049;

	@Inject
	protected KartesRoyalGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Karte's Royal Guard";
		...
		this.attackRange = 40;
		this.maxHP = 11293.712263901300000;
