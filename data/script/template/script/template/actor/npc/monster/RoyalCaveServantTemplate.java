 ...
 */
public class RoyalCaveServantTemplate extends MonsterNPCTemplate {
	public static final int ID = 20240;

	@Inject
	protected RoyalCaveServantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
