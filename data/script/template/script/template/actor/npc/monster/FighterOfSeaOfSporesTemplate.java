 ...
 */
public class FighterOfSeaOfSporesTemplate extends MonsterNPCTemplate {
	public static final int ID = 25101;

	@Inject
	protected FighterOfSeaOfSporesTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fighter of Sea of Spores";
		...
		this.attackRange = 40;
		this.maxHP = 8700.810593482620000;
