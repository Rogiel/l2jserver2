 ...
 */
public class ShiningSilverTemplate extends MonsterNPCTemplate {
	public static final int ID = 31016;

	@Inject
	protected ShiningSilverTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shining Silver";
