 ...
 */
public class WitchsOfferingWarrior2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18082;

	@Inject
	protected WitchsOfferingWarrior2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Witch's Offering Warrior";
