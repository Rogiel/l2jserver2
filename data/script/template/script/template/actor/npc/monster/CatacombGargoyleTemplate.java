 ...
 */
public class CatacombGargoyleTemplate extends MonsterNPCTemplate {
	public static final int ID = 21147;

	@Inject
	protected CatacombGargoyleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Catacomb Gargoyle";
