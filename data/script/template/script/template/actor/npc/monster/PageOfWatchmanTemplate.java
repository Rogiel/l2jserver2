 ...
 */
public class PageOfWatchmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 25400;

	@Inject
	protected PageOfWatchmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Page of Watchman";
