 ...
 */
public class ZakensGuard2Template extends MonsterNPCTemplate {
	public static final int ID = 21624;

	@Inject
	protected ZakensGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Zaken's Guard";
