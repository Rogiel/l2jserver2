 ...
 */
public class DragonBomber5Template extends MonsterNPCTemplate {
	public static final int ID = 29073;

	@Inject
	protected DragonBomber5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
