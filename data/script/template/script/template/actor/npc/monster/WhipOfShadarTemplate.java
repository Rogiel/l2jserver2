 ...
 */
public class WhipOfShadarTemplate extends MonsterNPCTemplate {
	public static final int ID = 25154;

	@Inject
	protected WhipOfShadarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Whip of Shadar";
