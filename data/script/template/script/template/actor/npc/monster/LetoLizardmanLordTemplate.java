 ...
 */
public class LetoLizardmanLordTemplate extends MonsterNPCTemplate {
	public static final int ID = 27127;

	@Inject
	protected LetoLizardmanLordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Leto Lizardman Lord";
