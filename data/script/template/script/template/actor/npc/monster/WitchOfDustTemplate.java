 ...
 */
public class WitchOfDustTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18191;

	@Inject
	protected WitchOfDustTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
