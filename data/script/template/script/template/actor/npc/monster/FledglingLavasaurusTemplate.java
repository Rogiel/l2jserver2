 ...
 */
public class FledglingLavasaurusTemplate extends MonsterNPCTemplate {
	public static final int ID = 18800;

	@Inject
	protected FledglingLavasaurusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fledgling Lavasaurus";
