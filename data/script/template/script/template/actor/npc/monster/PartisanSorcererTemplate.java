 ...
 */
public class PartisanSorcererTemplate extends MonsterNPCTemplate {
	public static final int ID = 35373;

	@Inject
	protected PartisanSorcererTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
