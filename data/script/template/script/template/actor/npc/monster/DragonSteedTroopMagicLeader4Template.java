 ...
 */
public class DragonSteedTroopMagicLeader4Template extends MonsterNPCTemplate {
	public static final int ID = 22591;

	@Inject
	protected DragonSteedTroopMagicLeader4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
