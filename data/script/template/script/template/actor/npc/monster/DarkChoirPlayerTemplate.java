 ...
 */
public class DarkChoirPlayerTemplate extends MonsterNPCTemplate {
	public static final int ID = 18339;

	@Inject
	protected DarkChoirPlayerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Choir Player";
