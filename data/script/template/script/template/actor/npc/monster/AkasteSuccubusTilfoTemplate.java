 ...
 */
public class AkasteSuccubusTilfoTemplate extends MonsterNPCTemplate {
	public static final int ID = 20421;

	@Inject
	protected AkasteSuccubusTilfoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Akaste Succubus Tilfo";
