 ...
 */
public class GrazingFlavaTemplate extends MonsterNPCTemplate {
	public static final int ID = 18647;

	@Inject
	protected GrazingFlavaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
