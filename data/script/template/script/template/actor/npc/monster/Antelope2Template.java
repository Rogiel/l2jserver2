 ...
 */
public class Antelope2Template extends MonsterNPCTemplate {
	public static final int ID = 21279;

	@Inject
	protected Antelope2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
