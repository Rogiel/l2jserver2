 ...
 */
public class Grendel5Template extends MonsterNPCTemplate {
	public static final int ID = 21292;

	@Inject
	protected Grendel5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
