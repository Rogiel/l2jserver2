 ...
 */
public class GrizzlyTemplate extends MonsterNPCTemplate {
	public static final int ID = 20143;

	@Inject
	protected GrizzlyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
