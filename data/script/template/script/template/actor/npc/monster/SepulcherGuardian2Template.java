 ...
 */
public class SepulcherGuardian2Template extends MonsterNPCTemplate {
	public static final int ID = 21226;

	@Inject
	protected SepulcherGuardian2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sepulcher Guardian";
