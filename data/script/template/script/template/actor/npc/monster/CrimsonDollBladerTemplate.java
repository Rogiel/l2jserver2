 ...
 */
public class CrimsonDollBladerTemplate extends MonsterNPCTemplate {
	public static final int ID = 21634;

	@Inject
	protected CrimsonDollBladerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Crimson Doll Blader";
