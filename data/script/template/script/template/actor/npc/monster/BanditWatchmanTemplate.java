 ...
 */
public class BanditWatchmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 22019;

	@Inject
	protected BanditWatchmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bandit Watchman";
