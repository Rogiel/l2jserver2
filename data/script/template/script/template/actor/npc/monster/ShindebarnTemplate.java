 ...
 */
public class ShindebarnTemplate extends MonsterNPCTemplate {
	public static final int ID = 21036;

	@Inject
	protected ShindebarnTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shindebarn";
