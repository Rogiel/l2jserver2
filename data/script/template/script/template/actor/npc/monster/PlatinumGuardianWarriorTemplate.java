 ...
 */
public class PlatinumGuardianWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21065;

	@Inject
	protected PlatinumGuardianWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Platinum Guardian Warrior";
