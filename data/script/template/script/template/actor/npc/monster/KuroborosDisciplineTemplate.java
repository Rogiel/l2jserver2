 ...
 */
public class KuroborosDisciplineTemplate extends MonsterNPCTemplate {
	public static final int ID = 25368;

	@Inject
	protected KuroborosDisciplineTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kuroboros' Discipline";
