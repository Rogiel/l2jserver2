 ...
 */
public class GravePredatorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21005;

	@Inject
	protected GravePredatorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grave Predator";
