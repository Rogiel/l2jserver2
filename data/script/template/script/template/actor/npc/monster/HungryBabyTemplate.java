 ...
 */
public class HungryBabyTemplate extends MonsterNPCTemplate {
	public static final int ID = 31010;

	@Inject
	protected HungryBabyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hungry Baby";
