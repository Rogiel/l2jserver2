 ...
 */
public class ZentaLizardmanMatriarchTemplate extends MonsterNPCTemplate {
	public static final int ID = 20300;

	@Inject
	protected ZentaLizardmanMatriarchTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Zenta Lizardman Matriarch";
