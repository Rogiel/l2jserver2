 ...
 */
public class CosmicWatcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 22374;

	@Inject
	protected CosmicWatcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cosmic Watcher";
