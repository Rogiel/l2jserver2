 ...
 */
public class GardenGuard3Template extends MonsterNPCTemplate {
	public static final int ID = 18349;

	@Inject
	protected GardenGuard3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.magicalDefense = 65.66095;
