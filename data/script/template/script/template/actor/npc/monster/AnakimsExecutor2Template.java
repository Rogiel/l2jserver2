 ...
 */
public class AnakimsExecutor2Template extends MonsterNPCTemplate {
	public static final int ID = 27391;

	@Inject
	protected AnakimsExecutor2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
