 ...
 */
public class AndreasRoyalGuards3Template extends MonsterNPCTemplate {
	public static final int ID = 22192;

	@Inject
	protected AndreasRoyalGuards3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
