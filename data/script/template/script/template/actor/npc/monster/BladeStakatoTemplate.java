 ...
 */
public class BladeStakatoTemplate extends MonsterNPCTemplate {
	public static final int ID = 20794;

	@Inject
	protected BladeStakatoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Blade Stakato";
