 ...
 */
public class BizarreCocoon6Template extends MonsterNPCTemplate {
	public static final int ID = 18798;

	@Inject
	protected BizarreCocoon6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bizarre Cocoon";
