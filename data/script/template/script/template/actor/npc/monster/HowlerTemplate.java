 ...
 */
public class HowlerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20743;

	@Inject
	protected HowlerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
