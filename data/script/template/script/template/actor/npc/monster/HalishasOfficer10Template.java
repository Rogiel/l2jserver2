 ...
 */
public class HalishasOfficer10Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18129;

	@Inject
	protected HalishasOfficer10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Halisha's Officer";
