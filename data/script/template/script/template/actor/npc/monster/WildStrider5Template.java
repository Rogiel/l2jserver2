 ...
 */
public class WildStrider5Template extends MonsterNPCTemplate {
	public static final int ID = 22227;

	@Inject
	protected WildStrider5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
