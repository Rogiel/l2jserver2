 ...
 */
public class ChakramBeetleTemplate extends MonsterNPCTemplate {
	public static final int ID = 21432;

	@Inject
	protected ChakramBeetleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Chakram Beetle";
