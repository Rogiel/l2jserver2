 ...
 */
public class HereIComeTemplate extends MonsterNPCTemplate {
	public static final int ID = 31003;

	@Inject
	protected HereIComeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Here I Come";
