 ...
 */
public class LavaSalamanderTemplate extends MonsterNPCTemplate {
	public static final int ID = 27116;

	@Inject
	protected LavaSalamanderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lava Salamander";
