 ...
 */
public class BarrowOverlordTemplate extends MonsterNPCTemplate {
	public static final int ID = 21240;

	@Inject
	protected BarrowOverlordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Barrow Overlord";
