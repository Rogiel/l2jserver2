 ...
 */
public class StatueOfProtection7Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18237;

	@Inject
	protected StatueOfProtection7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
