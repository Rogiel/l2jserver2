 ...
 */
public class BalrogOfDestruction2Template extends MonsterNPCTemplate {
	public static final int ID = 22645;

	@Inject
	protected BalrogOfDestruction2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Balrog of Destruction";
