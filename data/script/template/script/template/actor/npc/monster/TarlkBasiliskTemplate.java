 ...
 */
public class TarlkBasiliskTemplate extends MonsterNPCTemplate {
	public static final int ID = 20573;

	@Inject
	protected TarlkBasiliskTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tarlk Basilisk";
