 ...
 */
public class SikasFighterTemplate extends MonsterNPCTemplate {
	public static final int ID = 25216;

	@Inject
	protected SikasFighterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sika's Fighter";
