 ...
 */
public class GuardianArchangelTemplate extends MonsterNPCTemplate {
	public static final int ID = 21067;

	@Inject
	protected GuardianArchangelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
