 ...
 */
public class CatacombLivionaTemplate extends MonsterNPCTemplate {
	public static final int ID = 21148;

	@Inject
	protected CatacombLivionaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Catacomb Liviona";
