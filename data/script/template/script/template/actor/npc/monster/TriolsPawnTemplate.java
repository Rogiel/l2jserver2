 ...
 */
public class TriolsPawnTemplate extends MonsterNPCTemplate {
	public static final int ID = 27218;

	@Inject
	protected TriolsPawnTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Triol's Pawn";
