 ...
 */
public class TriolsBeliever5Template extends MonsterNPCTemplate {
	public static final int ID = 22162;

	@Inject
	protected TriolsBeliever5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
