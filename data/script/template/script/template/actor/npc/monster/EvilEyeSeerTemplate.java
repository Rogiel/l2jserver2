 ...
 */
public class EvilEyeSeerTemplate extends MonsterNPCTemplate {
	public static final int ID = 21257;

	@Inject
	protected EvilEyeSeerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Evil Eye Seer";
