 ...
 */
public class BeadOfSacredFlameTemplate extends MonsterNPCTemplate {
	public static final int ID = 27261;

	@Inject
	protected BeadOfSacredFlameTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bead of Sacred Flame";
