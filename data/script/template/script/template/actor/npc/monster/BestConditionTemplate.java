 ...
 */
public class BestConditionTemplate extends MonsterNPCTemplate {
	public static final int ID = 31025;

	@Inject
	protected BestConditionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Best Condition";
