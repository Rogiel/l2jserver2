 ...
 */
public class CursedSoulTemplate extends MonsterNPCTemplate {
	public static final int ID = 25469;

	@Inject
	protected CursedSoulTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 37984.850073708800000;
		...
		attributes.physicalAttack = 3589.22391;
		attributes.magicalAttack = 2632.09268;
