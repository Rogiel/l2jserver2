 ...
 */
public class TombInquisitorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21247;

	@Inject
	protected TombInquisitorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tomb Inquisitor";
