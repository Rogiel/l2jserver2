 ...
 */
public class WhiteWingFighterTemplate extends MonsterNPCTemplate {
	public static final int ID = 27291;

	@Inject
	protected WhiteWingFighterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "White Wing Fighter";
