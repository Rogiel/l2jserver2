 ...
 */
public class WildStrider4Template extends MonsterNPCTemplate {
	public static final int ID = 22222;

	@Inject
	protected WildStrider4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Wild Strider";
