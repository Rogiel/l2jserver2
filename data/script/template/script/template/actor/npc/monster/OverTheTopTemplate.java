 ...
 */
public class OverTheTopTemplate extends MonsterNPCTemplate {
	public static final int ID = 31017;

	@Inject
	protected OverTheTopTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Over the top";
