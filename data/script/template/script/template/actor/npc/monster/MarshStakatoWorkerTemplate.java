 ...
 */
public class MarshStakatoWorkerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20230;

	@Inject
	protected MarshStakatoWorkerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Marsh Stakato Worker";
