 ...
 */
public class KuranKoboldTemplate extends MonsterNPCTemplate {
	public static final int ID = 20606;

	@Inject
	protected KuranKoboldTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kuran Kobold";
