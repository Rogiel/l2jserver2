 ...
 */
public class SentinelOfWaterTemplate extends MonsterNPCTemplate {
	public static final int ID = 20610;

	@Inject
	protected SentinelOfWaterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
