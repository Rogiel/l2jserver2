 ...
 */
public class GraveLichTemplate extends MonsterNPCTemplate {
	public static final int ID = 21003;

	@Inject
	protected GraveLichTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grave Lich";
