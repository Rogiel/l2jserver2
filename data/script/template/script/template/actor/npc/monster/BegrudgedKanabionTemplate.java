 ...
 */
public class BegrudgedKanabionTemplate extends MonsterNPCTemplate {
	public static final int ID = 22455;

	@Inject
	protected BegrudgedKanabionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
