 ...
 */
public class TumranBugbearWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20064;

	@Inject
	protected TumranBugbearWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tumran Bugbear Warrior";
