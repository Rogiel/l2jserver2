 ...
 */
public class FallenAngelTanakia4Template extends MonsterNPCTemplate {
	public static final int ID = 27277;

	@Inject
	protected FallenAngelTanakia4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fallen Angel Tanakia";
