 ...
 */
public class ShurielsOracleTemplate extends MonsterNPCTemplate {
	public static final int ID = 25144;

	@Inject
	protected ShurielsOracleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shuriel's Oracle";
		...
		this.attackRange = 40;
		this.maxHP = 65696.087766909600000;
