 ...
 */
public class SoulCoffin3Template extends MonsterNPCTemplate {
	public static final int ID = 18710;

	@Inject
	protected SoulCoffin3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
