 ...
 */
public class PiratesZombieCaptainTemplate extends MonsterNPCTemplate {
	public static final int ID = 20845;

	@Inject
	protected PiratesZombieCaptainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Pirate's Zombie Captain";
