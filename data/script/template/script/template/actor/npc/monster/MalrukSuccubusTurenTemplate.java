 ...
 */
public class MalrukSuccubusTurenTemplate extends MonsterNPCTemplate {
	public static final int ID = 20245;

	@Inject
	protected MalrukSuccubusTurenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
