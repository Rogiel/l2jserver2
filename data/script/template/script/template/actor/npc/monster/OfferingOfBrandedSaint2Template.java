 ...
 */
public class OfferingOfBrandedSaint2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18068;

	@Inject
	protected OfferingOfBrandedSaint2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Offering of Branded Saint";
