 ...
 */
public class SpikedStakatoShaman2Template extends MonsterNPCTemplate {
	public static final int ID = 22633;

	@Inject
	protected SpikedStakatoShaman2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
