 ...
 */
public class VaultMonkTemplate extends MonsterNPCTemplate {
	public static final int ID = 21215;

	@Inject
	protected VaultMonkTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vault Monk";
