 ...
 */
public class TriolsBeliever4Template extends MonsterNPCTemplate {
	public static final int ID = 22158;

	@Inject
	protected TriolsBeliever4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
