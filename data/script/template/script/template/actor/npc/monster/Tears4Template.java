 ...
 */
public class Tears4Template extends MonsterNPCTemplate {
	public static final int ID = 25717;

	@Inject
	protected Tears4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 215.22959;
		attributes.magicalAttack = 147.29323;
