 ...
 */
public class BoneSlayerTemplate extends MonsterNPCTemplate {
	public static final int ID = 21567;

	@Inject
	protected BoneSlayerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bone Slayer";
