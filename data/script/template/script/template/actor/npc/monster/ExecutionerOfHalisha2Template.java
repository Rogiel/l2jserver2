 ...
 */
public class ExecutionerOfHalisha2Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18159;

	@Inject
	protected ExecutionerOfHalisha2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
