 ...
 */
public class AncientExperiment3Template extends MonsterNPCTemplate {
	public static final int ID = 18547;

	@Inject
	protected AncientExperiment3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 37803.322084299200000;
		...
		attributes.physicalAttack = 336.33483;
		attributes.magicalAttack = 229.67309;
