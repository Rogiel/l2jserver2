 ...
 */
public class TriolsPriest8Template extends MonsterNPCTemplate {
	public static final int ID = 22173;

	@Inject
	protected TriolsPriest8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
