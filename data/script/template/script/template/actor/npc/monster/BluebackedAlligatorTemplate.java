 ...
 */
public class BluebackedAlligatorTemplate extends MonsterNPCTemplate {
	public static final int ID = 27196;

	@Inject
	protected BluebackedAlligatorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bluebacked Alligator";
