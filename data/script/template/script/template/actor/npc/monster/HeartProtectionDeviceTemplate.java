 ...
 */
public class HeartProtectionDeviceTemplate extends MonsterNPCTemplate {
	public static final int ID = 22601;

	@Inject
	protected HeartProtectionDeviceTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Heart Protection Device";
