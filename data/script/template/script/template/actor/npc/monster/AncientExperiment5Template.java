 ...
 */
public class AncientExperiment5Template extends MonsterNPCTemplate {
	public static final int ID = 18549;

	@Inject
	protected AncientExperiment5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
