 ...
 */
public class SaironsDollTemplate extends MonsterNPCTemplate {
	public static final int ID = 20987;

	@Inject
	protected SaironsDollTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sairon's Doll";
