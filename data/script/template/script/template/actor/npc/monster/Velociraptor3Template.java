 ...
 */
public class Velociraptor3Template extends MonsterNPCTemplate {
	public static final int ID = 22198;

	@Inject
	protected Velociraptor3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
