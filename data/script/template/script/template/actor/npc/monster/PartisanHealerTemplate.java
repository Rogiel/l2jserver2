 ...
 */
public class PartisanHealerTemplate extends MonsterNPCTemplate {
	public static final int ID = 35369;

	@Inject
	protected PartisanHealerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
