 ...
 */
public class DarkOmenOfferingSaintTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18048;

	@Inject
	protected DarkOmenOfferingSaintTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
