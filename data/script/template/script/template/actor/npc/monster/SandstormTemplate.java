 ...
 */
public class SandstormTemplate extends MonsterNPCTemplate {
	public static final int ID = 22340;

	@Inject
	protected SandstormTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
