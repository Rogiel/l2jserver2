 ...
 */
public class MonsterEyeDestroyerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20068;

	@Inject
	protected MonsterEyeDestroyerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Monster Eye Destroyer";
