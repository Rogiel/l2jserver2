 ...
 */
public class TumranBugbearTemplate extends MonsterNPCTemplate {
	public static final int ID = 20062;

	@Inject
	protected TumranBugbearTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tumran Bugbear";
