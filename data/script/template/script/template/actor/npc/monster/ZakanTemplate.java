 ...
 */
public class ZakanTemplate extends MonsterNPCTemplate {
	public static final int ID = 27055;

	@Inject
	protected ZakanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
