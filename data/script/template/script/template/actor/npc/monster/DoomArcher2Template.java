 ...
 */
public class DoomArcher2Template extends MonsterNPCTemplate {
	public static final int ID = 35413;

	@Inject
	protected DoomArcher2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
