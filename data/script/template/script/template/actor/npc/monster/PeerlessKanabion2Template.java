 ...
 */
public class PeerlessKanabion2Template extends MonsterNPCTemplate {
	public static final int ID = 22471;

	@Inject
	protected PeerlessKanabion2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Peerless Kanabion";
