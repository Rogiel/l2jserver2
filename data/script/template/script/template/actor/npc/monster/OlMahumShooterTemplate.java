 ...
 */
public class OlMahumShooterTemplate extends MonsterNPCTemplate {
	public static final int ID = 20063;

	@Inject
	protected OlMahumShooterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ol Mahum Shooter";
