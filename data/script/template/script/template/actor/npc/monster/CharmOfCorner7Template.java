 ...
 */
public class CharmOfCorner7Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18202;

	@Inject
	protected CharmOfCorner7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
