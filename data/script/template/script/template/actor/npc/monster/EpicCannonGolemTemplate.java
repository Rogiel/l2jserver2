 ...
 */
public class EpicCannonGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 22074;

	@Inject
	protected EpicCannonGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Epic Cannon Golem";
