 ...
 */
public class SwordKanabion3Template extends MonsterNPCTemplate {
	public static final int ID = 22484;

	@Inject
	protected SwordKanabion3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sword Kanabion";
