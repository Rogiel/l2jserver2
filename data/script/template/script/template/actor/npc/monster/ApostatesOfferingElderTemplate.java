 ...
 */
public class ApostatesOfferingElderTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18019;

	@Inject
	protected ApostatesOfferingElderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
