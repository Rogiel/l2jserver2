 ...
 */
public class CrokianTemplate extends MonsterNPCTemplate {
	public static final int ID = 20789;

	@Inject
	protected CrokianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
