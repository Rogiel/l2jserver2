 ...
 */
public class CatGangTemplate extends MonsterNPCTemplate {
	public static final int ID = 25083;

	@Inject
	protected CatGangTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 8799.946422148720000;
		...
		attributes.physicalAttack = 545.46428;
		attributes.magicalAttack = 114.82299;
