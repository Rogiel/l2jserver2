 ...
 */
public class GiantWildHogTemplate extends MonsterNPCTemplate {
	public static final int ID = 20141;

	@Inject
	protected GiantWildHogTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Giant Wild Hog";
