 ...
 */
public class SwordKanabionTemplate extends MonsterNPCTemplate {
	public static final int ID = 22482;

	@Inject
	protected SwordKanabionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
