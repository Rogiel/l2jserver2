 ...
 */
public class BelethSampleTemplate extends MonsterNPCTemplate {
	public static final int ID = 18371;

	@Inject
	protected BelethSampleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
