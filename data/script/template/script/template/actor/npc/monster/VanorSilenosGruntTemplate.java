 ...
 */
public class VanorSilenosGruntTemplate extends MonsterNPCTemplate {
	public static final int ID = 20682;

	@Inject
	protected VanorSilenosGruntTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vanor Silenos Grunt";
