 ...
 */
public class LavasilliskTemplate extends MonsterNPCTemplate {
	public static final int ID = 21391;

	@Inject
	protected LavasilliskTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
