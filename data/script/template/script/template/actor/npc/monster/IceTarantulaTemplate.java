 ...
 */
public class IceTarantulaTemplate extends MonsterNPCTemplate {
	public static final int ID = 22089;

	@Inject
	protected IceTarantulaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ice Tarantula";
