 ...
 */
public class VarkasEliteGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 18653;

	@Inject
	protected VarkasEliteGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Varka's Elite Guard";
		...
		attributes.physicalAttack = 386.51000;
