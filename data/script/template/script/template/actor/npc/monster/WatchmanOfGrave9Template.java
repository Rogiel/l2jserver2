 ...
 */
public class WatchmanOfGrave9Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18252;

	@Inject
	protected WatchmanOfGrave9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
