 ...
 */
public class SoulDominatorTemplate extends MonsterNPCTemplate {
	public static final int ID = 22364;

	@Inject
	protected SoulDominatorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Soul Dominator";
