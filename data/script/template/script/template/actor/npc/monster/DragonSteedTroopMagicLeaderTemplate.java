 ...
 */
public class DragonSteedTroopMagicLeaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 22542;

	@Inject
	protected DragonSteedTroopMagicLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
