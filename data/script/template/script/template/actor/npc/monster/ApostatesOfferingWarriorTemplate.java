 ...
 */
public class ApostatesOfferingWarriorTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18022;

	@Inject
	protected ApostatesOfferingWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
