 ...
 */
public class GuillotinesGhostTemplate extends MonsterNPCTemplate {
	public static final int ID = 21562;

	@Inject
	protected GuillotinesGhostTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guillotine's Ghost";
