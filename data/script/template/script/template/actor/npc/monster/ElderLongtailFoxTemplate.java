 ...
 */
public class ElderLongtailFoxTemplate extends MonsterNPCTemplate {
	public static final int ID = 20441;

	@Inject
	protected ElderLongtailFoxTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Elder Longtail Fox";
