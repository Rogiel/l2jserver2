 ...
 */
public class UnpleasantHumming2Template extends MonsterNPCTemplate {
	public static final int ID = 21611;

	@Inject
	protected UnpleasantHumming2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
