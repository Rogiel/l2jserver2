 ...
 */
public class Grendel3Template extends MonsterNPCTemplate {
	public static final int ID = 21290;

	@Inject
	protected Grendel3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
