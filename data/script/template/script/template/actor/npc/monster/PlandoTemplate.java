 ...
 */
public class PlandoTemplate extends MonsterNPCTemplate {
	public static final int ID = 20623;

	@Inject
	protected PlandoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
