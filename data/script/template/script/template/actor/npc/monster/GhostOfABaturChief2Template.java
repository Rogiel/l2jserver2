 ...
 */
public class GhostOfABaturChief2Template extends MonsterNPCTemplate {
	public static final int ID = 22012;

	@Inject
	protected GhostOfABaturChief2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
