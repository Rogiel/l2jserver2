 ...
 */
public class FrightenedRagnaOrcTemplate extends MonsterNPCTemplate {
	public static final int ID = 18807;

	@Inject
	protected FrightenedRagnaOrcTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Frightened Ragna Orc";
