 ...
 */
public class CaveAntLarva2Template extends MonsterNPCTemplate {
	public static final int ID = 21266;

	@Inject
	protected CaveAntLarva2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
