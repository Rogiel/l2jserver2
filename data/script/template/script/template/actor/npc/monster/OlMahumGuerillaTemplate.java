 ...
 */
public class OlMahumGuerillaTemplate extends MonsterNPCTemplate {
	public static final int ID = 20207;

	@Inject
	protected OlMahumGuerillaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ol Mahum Guerilla";
