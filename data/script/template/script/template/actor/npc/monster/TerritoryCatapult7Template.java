 ...
 */
public class TerritoryCatapult7Template extends MonsterNPCTemplate {
	public static final int ID = 36505;

	@Inject
	protected TerritoryCatapult7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
