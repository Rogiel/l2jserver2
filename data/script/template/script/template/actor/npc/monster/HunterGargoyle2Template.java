 ...
 */
public class HunterGargoyle2Template extends MonsterNPCTemplate {
	public static final int ID = 20286;

	@Inject
	protected HunterGargoyle2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
