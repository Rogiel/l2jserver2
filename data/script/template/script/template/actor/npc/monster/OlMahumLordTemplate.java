 ...
 */
public class OlMahumLordTemplate extends MonsterNPCTemplate {
	public static final int ID = 20549;

	@Inject
	protected OlMahumLordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ol Mahum Lord";
