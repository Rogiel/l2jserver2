 ...
 */
public class MountainWerewolfChiefTemplate extends MonsterNPCTemplate {
	public static final int ID = 22238;

	@Inject
	protected MountainWerewolfChiefTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mountain Werewolf Chief";
