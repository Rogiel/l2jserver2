 ...
 */
public class CarrionScarabTemplate extends MonsterNPCTemplate {
	public static final int ID = 21396;

	@Inject
	protected CarrionScarabTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Carrion Scarab";
