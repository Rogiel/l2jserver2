 ...
 */
public class LimalKarinness2Template extends MonsterNPCTemplate {
	public static final int ID = 20628;

	@Inject
	protected LimalKarinness2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
