 ...
 */
public class GuardOfGwindorrTemplate extends MonsterNPCTemplate {
	public static final int ID = 25491;

	@Inject
	protected GuardOfGwindorrTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
