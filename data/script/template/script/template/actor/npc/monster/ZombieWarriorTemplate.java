 ...
 */
public class ZombieWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20458;

	@Inject
	protected ZombieWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Zombie Warrior";
