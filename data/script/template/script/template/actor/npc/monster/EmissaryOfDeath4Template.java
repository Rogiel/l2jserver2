 ...
 */
public class EmissaryOfDeath4Template extends MonsterNPCTemplate {
	public static final int ID = 22527;

	@Inject
	protected EmissaryOfDeath4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
