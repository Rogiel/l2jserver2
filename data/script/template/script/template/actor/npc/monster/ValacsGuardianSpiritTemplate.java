 ...
 */
public class ValacsGuardianSpiritTemplate extends MonsterNPCTemplate {
	public static final int ID = 21080;

	@Inject
	protected ValacsGuardianSpiritTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Valac's Guardian Spirit";
