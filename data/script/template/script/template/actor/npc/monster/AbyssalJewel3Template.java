 ...
 */
public class AbyssalJewel3Template extends MonsterNPCTemplate {
	public static final int ID = 27167;

	@Inject
	protected AbyssalJewel3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Abyssal Jewel 3";
