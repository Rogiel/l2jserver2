 ...
 */
public class BodySevererTemplate extends MonsterNPCTemplate {
	public static final int ID = 22512;

	@Inject
	protected BodySevererTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
