 ...
 */
public class KirunaksGuardsTemplate extends MonsterNPCTemplate {
	public static final int ID = 20492;

	@Inject
	protected KirunaksGuardsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kirunak's Guards";
