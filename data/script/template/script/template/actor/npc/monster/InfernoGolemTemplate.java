 ...
 */
public class InfernoGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 29041;

	@Inject
	protected InfernoGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Inferno Golem";
		...
		attributes.physicalAttack = 10049.20000;
		attributes.magicalAttack = 14158.66320;
