 ...
 */
public class StatueOfProtection9Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18239;

	@Inject
	protected StatueOfProtection9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
