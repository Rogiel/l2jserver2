 ...
 */
public class RatmanSpyTemplate extends MonsterNPCTemplate {
	public static final int ID = 20360;

	@Inject
	protected RatmanSpyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ratman Spy";
