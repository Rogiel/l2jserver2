 ...
 */
public class AmonsSpiritsTemplate extends MonsterNPCTemplate {
	public static final int ID = 21083;

	@Inject
	protected AmonsSpiritsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Amon's Spirits";
