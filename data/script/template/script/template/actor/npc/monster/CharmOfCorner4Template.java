 ...
 */
public class CharmOfCorner4Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18199;

	@Inject
	protected CharmOfCorner4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
