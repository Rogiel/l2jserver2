 ...
 */
public class TeruksKnightTemplate extends MonsterNPCTemplate {
	public static final int ID = 25066;

	@Inject
	protected TeruksKnightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Teruk's Knight";
