 ...
 */
public class AncientLavasaurusTemplate extends MonsterNPCTemplate {
	public static final int ID = 18803;

	@Inject
	protected AncientLavasaurusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ancient Lavasaurus";
