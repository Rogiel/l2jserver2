 ...
 */
public class InvaderDestroyerOfNightmareTemplate extends MonsterNPCTemplate {
	public static final int ID = 22711;

	@Inject
	protected InvaderDestroyerOfNightmareTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Invader Destroyer of Nightmare";
