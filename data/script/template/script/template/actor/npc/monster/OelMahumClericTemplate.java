 ...
 */
public class OelMahumClericTemplate extends MonsterNPCTemplate {
	public static final int ID = 35431;

	@Inject
	protected OelMahumClericTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Oel Mahum Cleric";
