 ...
 */
public class JuniorWatchmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 22320;

	@Inject
	protected JuniorWatchmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Junior Watchman";
