 ...
 */
public class HatuWindsusTemplate extends MonsterNPCTemplate {
	public static final int ID = 20933;

	@Inject
	protected HatuWindsusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hatu Windsus";
