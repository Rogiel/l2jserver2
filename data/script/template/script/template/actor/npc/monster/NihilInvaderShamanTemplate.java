 ...
 */
public class NihilInvaderShamanTemplate extends MonsterNPCTemplate {
	public static final int ID = 22724;

	@Inject
	protected NihilInvaderShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nihil Invader Shaman";
