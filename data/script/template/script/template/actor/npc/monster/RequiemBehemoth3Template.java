 ...
 */
public class RequiemBehemoth3Template extends MonsterNPCTemplate {
	public static final int ID = 21600;

	@Inject
	protected RequiemBehemoth3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
