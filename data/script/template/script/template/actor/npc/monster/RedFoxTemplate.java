 ...
 */
public class RedFoxTemplate extends MonsterNPCTemplate {
	public static final int ID = 20391;

	@Inject
	protected RedFoxTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
