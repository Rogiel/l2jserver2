 ...
 */
public class DreVanulBeholderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20353;

	@Inject
	protected DreVanulBeholderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dre Vanul Beholder";
