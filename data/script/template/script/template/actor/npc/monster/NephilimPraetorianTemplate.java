 ...
 */
public class NephilimPraetorianTemplate extends MonsterNPCTemplate {
	public static final int ID = 21204;

	@Inject
	protected NephilimPraetorianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nephilim Praetorian";
