 ...
 */
public class CatacombScavengerBatTemplate extends MonsterNPCTemplate {
	public static final int ID = 21143;

	@Inject
	protected CatacombScavengerBatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Catacomb Scavenger Bat";
