 ...
 */
public class CannibalisticStakatoLeader4Template extends MonsterNPCTemplate {
	public static final int ID = 22626;

	@Inject
	protected CannibalisticStakatoLeader4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
