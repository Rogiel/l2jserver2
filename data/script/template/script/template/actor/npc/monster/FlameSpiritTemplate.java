 ...
 */
public class FlameSpiritTemplate extends MonsterNPCTemplate {
	public static final int ID = 25525;

	@Inject
	protected FlameSpiritTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Flame Spirit";
