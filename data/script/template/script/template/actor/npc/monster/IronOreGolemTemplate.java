 ...
 */
public class IronOreGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 21137;

	@Inject
	protected IronOreGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Iron Ore Golem";
