 ...
 */
public class UnpleasantHummingTemplate extends MonsterNPCTemplate {
	public static final int ID = 20839;

	@Inject
	protected UnpleasantHummingTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
