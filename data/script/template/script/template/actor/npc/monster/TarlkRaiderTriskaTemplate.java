 ...
 */
public class TarlkRaiderTriskaTemplate extends MonsterNPCTemplate {
	public static final int ID = 27146;

	@Inject
	protected TarlkRaiderTriskaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tarlk Raider Triska";
