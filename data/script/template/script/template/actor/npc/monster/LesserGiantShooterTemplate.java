 ...
 */
public class LesserGiantShooterTemplate extends MonsterNPCTemplate {
	public static final int ID = 20655;

	@Inject
	protected LesserGiantShooterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
