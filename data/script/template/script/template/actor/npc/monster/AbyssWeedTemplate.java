 ...
 */
public class AbyssWeedTemplate extends MonsterNPCTemplate {
	public static final int ID = 18867;

	@Inject
	protected AbyssWeedTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Abyss Weed";
