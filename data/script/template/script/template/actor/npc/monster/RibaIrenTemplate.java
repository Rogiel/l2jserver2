 ...
 */
public class RibaIrenTemplate extends MonsterNPCTemplate {
	public static final int ID = 29018;

	@Inject
	protected RibaIrenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
