 ...
 */
public class HalishasOfficer7Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18126;

	@Inject
	protected HalishasOfficer7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
