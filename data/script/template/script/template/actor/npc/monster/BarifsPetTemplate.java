 ...
 */
public class BarifsPetTemplate extends MonsterNPCTemplate {
	public static final int ID = 20772;

	@Inject
	protected BarifsPetTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Barif's Pet";
