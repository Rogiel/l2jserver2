 ...
 */
public class TurakBugbearWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20249;

	@Inject
	protected TurakBugbearWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Turak Bugbear Warrior";
