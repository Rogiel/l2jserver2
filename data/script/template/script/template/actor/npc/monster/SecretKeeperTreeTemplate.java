 ...
 */
public class SecretKeeperTreeTemplate extends MonsterNPCTemplate {
	public static final int ID = 27139;

	@Inject
	protected SecretKeeperTreeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Secret Keeper Tree";
