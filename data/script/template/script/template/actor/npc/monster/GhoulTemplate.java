 ...
 */
public class GhoulTemplate extends MonsterNPCTemplate {
	public static final int ID = 20201;

	@Inject
	protected GhoulTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
