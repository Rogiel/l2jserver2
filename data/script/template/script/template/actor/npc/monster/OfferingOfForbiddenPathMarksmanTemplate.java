 ...
 */
public class OfferingOfForbiddenPathMarksmanTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18056;

	@Inject
	protected OfferingOfForbiddenPathMarksmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
