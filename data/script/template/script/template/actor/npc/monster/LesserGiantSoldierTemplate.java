 ...
 */
public class LesserGiantSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 20654;

	@Inject
	protected LesserGiantSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
