 ...
 */
public class MinerviaVanHackenTemplate extends MonsterNPCTemplate {
	public static final int ID = 27309;

	@Inject
	protected MinerviaVanHackenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Minervia Van Hacken";
