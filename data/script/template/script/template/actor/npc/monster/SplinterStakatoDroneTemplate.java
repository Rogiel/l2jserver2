 ...
 */
public class SplinterStakatoDroneTemplate extends MonsterNPCTemplate {
	public static final int ID = 21511;

	@Inject
	protected SplinterStakatoDroneTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
