 ...
 */
public class DisciplesOfAuthorityTemplate extends MonsterNPCTemplate {
	public static final int ID = 21310;

	@Inject
	protected DisciplesOfAuthorityTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
