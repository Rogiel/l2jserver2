 ...
 */
public class BloodyAxeEliteTemplate extends MonsterNPCTemplate {
	public static final int ID = 20780;

	@Inject
	protected BloodyAxeEliteTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bloody Axe Elite";
