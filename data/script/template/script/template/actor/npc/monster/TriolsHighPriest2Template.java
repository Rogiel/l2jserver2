 ...
 */
public class TriolsHighPriest2Template extends MonsterNPCTemplate {
	public static final int ID = 22159;

	@Inject
	protected TriolsHighPriest2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
