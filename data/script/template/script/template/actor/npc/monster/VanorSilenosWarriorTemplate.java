 ...
 */
public class VanorSilenosWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20684;

	@Inject
	protected VanorSilenosWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vanor Silenos Warrior";
