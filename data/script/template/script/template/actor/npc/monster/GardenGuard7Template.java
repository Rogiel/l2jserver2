 ...
 */
public class GardenGuard7Template extends MonsterNPCTemplate {
	public static final int ID = 18363;

	@Inject
	protected GardenGuard7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
