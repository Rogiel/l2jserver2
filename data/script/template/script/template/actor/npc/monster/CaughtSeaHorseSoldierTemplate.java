 ...
 */
public class CaughtSeaHorseSoldierTemplate extends PenaltyMonsterNPCTemplate {
	public static final int ID = 18323;

	@Inject
	protected CaughtSeaHorseSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Caught Sea Horse Soldier";
