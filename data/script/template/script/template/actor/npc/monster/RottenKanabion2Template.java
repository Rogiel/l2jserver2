 ...
 */
public class RottenKanabion2Template extends MonsterNPCTemplate {
	public static final int ID = 22459;

	@Inject
	protected RottenKanabion2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
