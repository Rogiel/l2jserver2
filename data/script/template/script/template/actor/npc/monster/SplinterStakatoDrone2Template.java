 ...
 */
public class SplinterStakatoDrone2Template extends MonsterNPCTemplate {
	public static final int ID = 21512;

	@Inject
	protected SplinterStakatoDrone2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Splinter Stakato Drone";
