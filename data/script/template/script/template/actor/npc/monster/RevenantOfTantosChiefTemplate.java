 ...
 */
public class RevenantOfTantosChiefTemplate extends MonsterNPCTemplate {
	public static final int ID = 27086;

	@Inject
	protected RevenantOfTantosChiefTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Revenant of Tantos Chief";
