 ...
 */
public class TreasuresOfTheFestival8Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18116;

	@Inject
	protected TreasuresOfTheFestival8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
