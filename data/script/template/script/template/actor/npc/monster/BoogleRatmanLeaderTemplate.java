 ...
 */
public class BoogleRatmanLeaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20390;

	@Inject
	protected BoogleRatmanLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Boogle Ratman Leader";
