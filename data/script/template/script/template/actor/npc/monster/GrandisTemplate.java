 ...
 */
public class GrandisTemplate extends MonsterNPCTemplate {
	public static final int ID = 20554;

	@Inject
	protected GrandisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
