 ...
 */
public class OlMahumPatrolTemplate extends MonsterNPCTemplate {
	public static final int ID = 20053;

	@Inject
	protected OlMahumPatrolTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ol Mahum Patrol";
