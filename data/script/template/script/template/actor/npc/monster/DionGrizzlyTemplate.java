 ...
 */
public class DionGrizzlyTemplate extends MonsterNPCTemplate {
	public static final int ID = 20203;

	@Inject
	protected DionGrizzlyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dion Grizzly";
