 ...
 */
public class ServitorOfDarkness3Template extends MonsterNPCTemplate {
	public static final int ID = 22685;

	@Inject
	protected ServitorOfDarkness3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
