 ...
 */
public class FallenAngelMetellusTemplate extends MonsterNPCTemplate {
	public static final int ID = 27281;

	@Inject
	protected FallenAngelMetellusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fallen Angel Metellus";
