 ...
 */
public class ElderTarlkBasiliskTemplate extends MonsterNPCTemplate {
	public static final int ID = 20574;

	@Inject
	protected ElderTarlkBasiliskTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Elder Tarlk Basilisk";
