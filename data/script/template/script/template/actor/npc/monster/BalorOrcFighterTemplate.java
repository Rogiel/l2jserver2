 ...
 */
public class BalorOrcFighterTemplate extends MonsterNPCTemplate {
	public static final int ID = 20386;

	@Inject
	protected BalorOrcFighterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Balor Orc Fighter";
