 ...
 */
public class ScavengerWereratTemplate extends MonsterNPCTemplate {
	public static final int ID = 20039;

	@Inject
	protected ScavengerWereratTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Scavenger Wererat";
