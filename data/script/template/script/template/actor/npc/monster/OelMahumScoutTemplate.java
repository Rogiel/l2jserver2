 ...
 */
public class OelMahumScoutTemplate extends MonsterNPCTemplate {
	public static final int ID = 35429;

	@Inject
	protected OelMahumScoutTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Oel Mahum Scout";
		...
		this.attackRange = 40;
		this.maxHP = 31673.990206229100000;
