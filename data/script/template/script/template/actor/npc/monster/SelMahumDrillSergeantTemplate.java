 ...
 */
public class SelMahumDrillSergeantTemplate extends MonsterNPCTemplate {
	public static final int ID = 22775;

	@Inject
	protected SelMahumDrillSergeantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
