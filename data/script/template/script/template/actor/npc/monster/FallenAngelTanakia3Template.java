 ...
 */
public class FallenAngelTanakia3Template extends MonsterNPCTemplate {
	public static final int ID = 27276;

	@Inject
	protected FallenAngelTanakia3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
