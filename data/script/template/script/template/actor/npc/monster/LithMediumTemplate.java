 ...
 */
public class LithMediumTemplate extends MonsterNPCTemplate {
	public static final int ID = 21170;

	@Inject
	protected LithMediumTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lith Medium";
		...
		this.rightHand = itemProvider.createID(5797);
		this.leftHand = null;
		this.enchantLevel = 0;
