 ...
 */
public class ApostatesOfferingDisciple2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18077;

	@Inject
	protected ApostatesOfferingDisciple2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
