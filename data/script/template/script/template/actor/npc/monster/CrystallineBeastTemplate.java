 ...
 */
public class CrystallineBeastTemplate extends MonsterNPCTemplate {
	public static final int ID = 20418;

	@Inject
	protected CrystallineBeastTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Crystalline Beast";
