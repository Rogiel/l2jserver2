 ...
 */
public class MandragoraBlossomTemplate extends MonsterNPCTemplate {
	public static final int ID = 20156;

	@Inject
	protected MandragoraBlossomTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mandragora Blossom";
