 ...
 */
public class VisionGuardianShakiel3Template extends MonsterNPCTemplate {
	public static final int ID = 27315;

	@Inject
	protected VisionGuardianShakiel3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
