 ...
 */
public class RedeyeBatTemplate extends MonsterNPCTemplate {
	public static final int ID = 20392;

	@Inject
	protected RedeyeBatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Redeye Bat";
