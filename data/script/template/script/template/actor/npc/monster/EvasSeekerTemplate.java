 ...
 */
public class EvasSeekerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20800;

	@Inject
	protected EvasSeekerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Eva's Seeker";
