 ...
 */
public class KelMahumArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20855;

	@Inject
	protected KelMahumArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kel Mahum Archer";
