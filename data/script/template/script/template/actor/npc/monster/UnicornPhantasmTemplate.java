 ...
 */
public class UnicornPhantasmTemplate extends MonsterNPCTemplate {
	public static final int ID = 27106;

	@Inject
	protected UnicornPhantasmTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Unicorn Phantasm";
