 ...
 */
public class LilimKnightErrantTemplate extends MonsterNPCTemplate {
	public static final int ID = 21177;

	@Inject
	protected LilimKnightErrantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lilim Knight Errant";
