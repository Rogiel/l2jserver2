 ...
 */
public class SkeletonKnightTemplate extends MonsterNPCTemplate {
	public static final int ID = 20513;

	@Inject
	protected SkeletonKnightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
