 ...
 */
public class GreatDemonKingTemplate extends MonsterNPCTemplate {
	public static final int ID = 27138;

	@Inject
	protected GreatDemonKingTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Great Demon King";
