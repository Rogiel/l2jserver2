 ...
 */
public class ForestRunnerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20594;

	@Inject
	protected ForestRunnerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Forest Runner";
