 ...
 */
public class GuardsOfTheDawnOracle5Template extends MonsterNPCTemplate {
	public static final int ID = 27352;

	@Inject
	protected GuardsOfTheDawnOracle5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
