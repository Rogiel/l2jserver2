 ...
 */
public class SeluLizardmanWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20071;

	@Inject
	protected SeluLizardmanWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Selu Lizardman Warrior";
