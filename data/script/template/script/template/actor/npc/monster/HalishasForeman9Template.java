 ...
 */
public class HalishasForeman9Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18181;

	@Inject
	protected HalishasForeman9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
