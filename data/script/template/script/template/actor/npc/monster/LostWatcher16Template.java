 ...
 */
public class LostWatcher16Template extends MonsterNPCTemplate {
	public static final int ID = 25706;

	@Inject
	protected LostWatcher16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 9288.76621;
		attributes.magicalAttack = 6343.02320;
