 ...
 */
public class InvaderArcherOfNightmareTemplate extends MonsterNPCTemplate {
	public static final int ID = 22714;

	@Inject
	protected InvaderArcherOfNightmareTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Invader Archer of Nightmare";
