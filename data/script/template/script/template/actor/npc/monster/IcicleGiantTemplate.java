 ...
 */
public class IcicleGiantTemplate extends MonsterNPCTemplate {
	public static final int ID = 25297;

	@Inject
	protected IcicleGiantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
