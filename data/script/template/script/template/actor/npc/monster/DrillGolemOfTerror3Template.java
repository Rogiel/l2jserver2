 ...
 */
public class DrillGolemOfTerror3Template extends MonsterNPCTemplate {
	public static final int ID = 22806;

	@Inject
	protected DrillGolemOfTerror3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
