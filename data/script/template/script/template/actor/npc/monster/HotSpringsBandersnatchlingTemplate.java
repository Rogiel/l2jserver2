 ...
 */
public class HotSpringsBandersnatchlingTemplate extends MonsterNPCTemplate {
	public static final int ID = 21314;

	@Inject
	protected HotSpringsBandersnatchlingTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hot Springs Bandersnatchling";
