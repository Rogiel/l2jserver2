 ...
 */
public class CursedSeerTemplate extends MonsterNPCTemplate {
	public static final int ID = 21106;

	@Inject
	protected CursedSeerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
