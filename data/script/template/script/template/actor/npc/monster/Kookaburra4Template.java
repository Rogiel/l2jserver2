 ...
 */
public class Kookaburra4Template extends MonsterNPCTemplate {
	public static final int ID = 21275;

	@Inject
	protected Kookaburra4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
