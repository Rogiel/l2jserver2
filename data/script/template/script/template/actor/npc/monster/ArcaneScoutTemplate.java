 ...
 */
public class ArcaneScoutTemplate extends MonsterNPCTemplate {
	public static final int ID = 22327;

	@Inject
	protected ArcaneScoutTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Arcane Scout";
