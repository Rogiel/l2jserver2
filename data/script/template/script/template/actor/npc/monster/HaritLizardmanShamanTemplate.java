 ...
 */
public class HaritLizardmanShamanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20644;

	@Inject
	protected HaritLizardmanShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Harit Lizardman Shaman";
