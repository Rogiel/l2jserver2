 ...
 */
public class ImagroTemplate extends MonsterNPCTemplate {
	public static final int ID = 22674;

	@Inject
	protected ImagroTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
