 ...
 */
public class GrimaTemplate extends MonsterNPCTemplate {
	public static final int ID = 27135;

	@Inject
	protected GrimaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
