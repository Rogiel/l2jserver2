 ...
 */
public class HorrifyingCannonGolemViTemplate extends MonsterNPCTemplate {
	public static final int ID = 22066;

	@Inject
	protected HorrifyingCannonGolemViTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
