 ...
 */
public class SwampAlligatorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20992;

	@Inject
	protected SwampAlligatorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Swamp Alligator";
