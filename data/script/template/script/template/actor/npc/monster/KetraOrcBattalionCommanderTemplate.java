 ...
 */
public class KetraOrcBattalionCommanderTemplate extends MonsterNPCTemplate {
	public static final int ID = 21340;

	@Inject
	protected KetraOrcBattalionCommanderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ketra Orc Battalion Commander";
