 ...
 */
public class HallKeeperCaptainTemplate extends MonsterNPCTemplate {
	public static final int ID = 18329;

	@Inject
	protected HallKeeperCaptainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hall Keeper Captain";
