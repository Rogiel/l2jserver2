 ...
 */
public class MuertosLieutenantTemplate extends MonsterNPCTemplate {
	public static final int ID = 22245;

	@Inject
	protected MuertosLieutenantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Muertos Lieutenant";
