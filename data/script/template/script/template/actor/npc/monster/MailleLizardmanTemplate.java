 ...
 */
public class MailleLizardmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20919;

	@Inject
	protected MailleLizardmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Maille Lizardman";
