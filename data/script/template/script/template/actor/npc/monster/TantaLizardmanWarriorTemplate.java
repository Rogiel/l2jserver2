 ...
 */
public class TantaLizardmanWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 22769;

	@Inject
	protected TantaLizardmanWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tanta Lizardman Warrior";
		...
		this.experience = 23866;
		this.sp = 2576;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(8682);
		this.leftHand = null;
		this.enchantLevel = 0;
