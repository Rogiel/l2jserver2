 ...
 */
public class EnkuOrcOverlordTemplate extends MonsterNPCTemplate {
	public static final int ID = 27082;

	@Inject
	protected EnkuOrcOverlordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Enku Orc Overlord";
