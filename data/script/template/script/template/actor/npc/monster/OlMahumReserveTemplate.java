 ...
 */
public class OlMahumReserveTemplate extends MonsterNPCTemplate {
	public static final int ID = 20547;

	@Inject
	protected OlMahumReserveTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ol Mahum Reserve";
