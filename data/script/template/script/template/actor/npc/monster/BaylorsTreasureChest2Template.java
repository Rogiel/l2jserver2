 ...
 */
public class BaylorsTreasureChest2Template extends MonsterNPCTemplate {
	public static final int ID = 29117;

	@Inject
	protected BaylorsTreasureChest2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Baylor's Treasure Chest";
