 ...
 */
public class PowderKegTemplate extends MonsterNPCTemplate {
	public static final int ID = 18622;

	@Inject
	protected PowderKegTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Powder Keg";
