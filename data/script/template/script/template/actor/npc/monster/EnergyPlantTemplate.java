 ...
 */
public class EnergyPlantTemplate extends MonsterNPCTemplate {
	public static final int ID = 18868;

	@Inject
	protected EnergyPlantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Energy Plant";
