 ...
 */
public class IcarusSample3Template extends MonsterNPCTemplate {
	public static final int ID = 25117;

	@Inject
	protected IcarusSample3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Icarus Sample 3";
		...
		this.attackRange = 40;
		this.maxHP = 9342.365285339690000;
