 ...
 */
public class HexaBeetleTemplate extends MonsterNPCTemplate {
	public static final int ID = 21400;

	@Inject
	protected HexaBeetleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
