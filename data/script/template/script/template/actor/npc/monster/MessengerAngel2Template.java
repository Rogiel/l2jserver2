 ...
 */
public class MessengerAngel2Template extends MonsterNPCTemplate {
	public static final int ID = 21063;

	@Inject
	protected MessengerAngel2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Messenger Angel";
