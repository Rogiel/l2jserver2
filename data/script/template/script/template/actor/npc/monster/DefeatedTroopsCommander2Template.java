 ...
 */
public class DefeatedTroopsCommander2Template extends MonsterNPCTemplate {
	public static final int ID = 22559;

	@Inject
	protected DefeatedTroopsCommander2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
