 ...
 */
public class TanorSilenosChieftainTemplate extends MonsterNPCTemplate {
	public static final int ID = 20941;

	@Inject
	protected TanorSilenosChieftainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tanor Silenos Chieftain";
