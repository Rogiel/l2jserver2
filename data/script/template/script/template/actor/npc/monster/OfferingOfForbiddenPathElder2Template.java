 ...
 */
public class OfferingOfForbiddenPathElder2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18099;

	@Inject
	protected OfferingOfForbiddenPathElder2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Offering of Forbidden Path Elder";
