 ...
 */
public class DeadSeekerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20202;

	@Inject
	protected DeadSeekerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dead Seeker";
