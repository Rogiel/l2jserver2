 ...
 */
public class AndreasRoyalGuards2Template extends MonsterNPCTemplate {
	public static final int ID = 22189;

	@Inject
	protected AndreasRoyalGuards2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Andreas' Royal Guards";
