 ...
 */
public class BaturOrcArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20256;

	@Inject
	protected BaturOrcArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Batur Orc Archer";
