 ...
 */
public class GuardianBasiliskTemplate extends MonsterNPCTemplate {
	public static final int ID = 20550;

	@Inject
	protected GuardianBasiliskTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guardian Basilisk";
