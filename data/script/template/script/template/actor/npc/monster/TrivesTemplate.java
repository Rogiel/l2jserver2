 ...
 */
public class TrivesTemplate extends MonsterNPCTemplate {
	public static final int ID = 20672;

	@Inject
	protected TrivesTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
