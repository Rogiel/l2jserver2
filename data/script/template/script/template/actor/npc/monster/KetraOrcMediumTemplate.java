 ...
 */
public class KetraOrcMediumTemplate extends MonsterNPCTemplate {
	public static final int ID = 21334;

	@Inject
	protected KetraOrcMediumTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ketra Orc Medium";
