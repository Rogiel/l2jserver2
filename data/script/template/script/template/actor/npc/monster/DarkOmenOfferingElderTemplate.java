 ...
 */
public class DarkOmenOfferingElderTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18039;

	@Inject
	protected DarkOmenOfferingElderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
