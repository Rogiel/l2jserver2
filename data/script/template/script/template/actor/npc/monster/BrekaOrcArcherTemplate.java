 ...
 */
public class BrekaOrcArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20268;

	@Inject
	protected BrekaOrcArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Breka Orc Archer";
