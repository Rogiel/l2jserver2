 ...
 */
public class YintzuTemplate extends MonsterNPCTemplate {
	public static final int ID = 20647;

	@Inject
	protected YintzuTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
