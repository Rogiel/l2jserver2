 ...
 */
public class CosmicScoutTemplate extends MonsterNPCTemplate {
	public static final int ID = 22373;

	@Inject
	protected CosmicScoutTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cosmic Scout";
