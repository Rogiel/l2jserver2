 ...
 */
public class MalrukSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 20622;

	@Inject
	protected MalrukSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Malruk Soldier";
