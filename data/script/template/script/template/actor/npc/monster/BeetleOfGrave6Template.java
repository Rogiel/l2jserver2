 ...
 */
public class BeetleOfGrave6Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18146;

	@Inject
	protected BeetleOfGrave6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
