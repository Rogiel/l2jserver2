 ...
 */
public class FreyasGardenerTemplate extends MonsterNPCTemplate {
	public static final int ID = 22100;

	@Inject
	protected FreyasGardenerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Freya's Gardener";
