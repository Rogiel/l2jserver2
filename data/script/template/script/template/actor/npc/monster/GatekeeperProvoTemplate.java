 ...
 */
public class GatekeeperProvoTemplate extends MonsterNPCTemplate {
	public static final int ID = 22277;

	@Inject
	protected GatekeeperProvoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gatekeeper Provo";
