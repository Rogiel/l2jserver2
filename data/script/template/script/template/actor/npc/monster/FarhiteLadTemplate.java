 ...
 */
public class FarhiteLadTemplate extends MonsterNPCTemplate {
	public static final int ID = 20807;

	@Inject
	protected FarhiteLadTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Farhite Lad";
