 ...
 */
public class Lienrik2Template extends MonsterNPCTemplate {
	public static final int ID = 21644;

	@Inject
	protected Lienrik2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
