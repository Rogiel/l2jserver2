 ...
 */
public class MountainFungus2Template extends MonsterNPCTemplate {
	public static final int ID = 22237;

	@Inject
	protected MountainFungus2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mountain Fungus";
