 ...
 */
public class DarionsFaithfulServant4Template extends MonsterNPCTemplate {
	public static final int ID = 22408;

	@Inject
	protected DarionsFaithfulServant4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 9590.36935;
		attributes.magicalAttack = 6701.28091;
