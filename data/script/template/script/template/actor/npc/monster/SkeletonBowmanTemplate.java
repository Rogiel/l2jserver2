 ...
 */
public class SkeletonBowmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20051;

	@Inject
	protected SkeletonBowmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
