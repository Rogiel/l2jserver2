 ...
 */
public class SelMahumDrillSergeant2Template extends MonsterNPCTemplate {
	public static final int ID = 22777;

	@Inject
	protected SelMahumDrillSergeant2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sel Mahum Drill Sergeant";
