 ...
 */
public class BrownFoxTemplate extends MonsterNPCTemplate {
	public static final int ID = 20309;

	@Inject
	protected BrownFoxTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
