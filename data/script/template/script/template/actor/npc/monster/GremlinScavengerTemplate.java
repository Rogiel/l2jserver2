 ...
 */
public class GremlinScavengerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20334;

	@Inject
	protected GremlinScavengerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gremlin Scavenger";
