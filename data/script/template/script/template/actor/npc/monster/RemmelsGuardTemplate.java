 ...
 */
public class RemmelsGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 25043;

	@Inject
	protected RemmelsGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Remmel's Guard";
