 ...
 */
public class GardenStakatoTemplate extends MonsterNPCTemplate {
	public static final int ID = 22313;

	@Inject
	protected GardenStakatoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Garden Stakato";
