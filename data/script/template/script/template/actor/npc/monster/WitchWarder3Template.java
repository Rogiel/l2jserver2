 ...
 */
public class WitchWarder3Template extends MonsterNPCTemplate {
	public static final int ID = 18366;

	@Inject
	protected WitchWarder3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
