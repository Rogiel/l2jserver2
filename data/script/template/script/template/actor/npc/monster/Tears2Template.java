 ...
 */
public class Tears2Template extends MonsterNPCTemplate {
	public static final int ID = 25535;

	@Inject
	protected Tears2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 213.09861;
		attributes.magicalAttack = 145.51872;
