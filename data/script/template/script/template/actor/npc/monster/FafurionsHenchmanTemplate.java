 ...
 */
public class FafurionsHenchmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 22312;

	@Inject
	protected FafurionsHenchmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fafurion's Henchman";
