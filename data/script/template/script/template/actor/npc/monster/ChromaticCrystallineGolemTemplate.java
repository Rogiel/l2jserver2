 ...
 */
public class ChromaticCrystallineGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 18369;

	@Inject
	protected ChromaticCrystallineGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
