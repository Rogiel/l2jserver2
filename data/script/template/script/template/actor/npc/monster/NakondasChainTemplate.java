 ...
 */
public class NakondasChainTemplate extends MonsterNPCTemplate {
	public static final int ID = 25417;

	@Inject
	protected NakondasChainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nakondas' Chain";
