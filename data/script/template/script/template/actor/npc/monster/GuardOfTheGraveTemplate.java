 ...
 */
public class GuardOfTheGraveTemplate extends MonsterNPCTemplate {
	public static final int ID = 18815;

	@Inject
	protected GuardOfTheGraveTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guard of the Grave";
		this.serverSideName = false;
		this.title = "Death-calling";
