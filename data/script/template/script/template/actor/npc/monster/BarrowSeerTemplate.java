 ...
 */
public class BarrowSeerTemplate extends MonsterNPCTemplate {
	public static final int ID = 21233;

	@Inject
	protected BarrowSeerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Barrow Seer";
