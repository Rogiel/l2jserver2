 ...
 */
public class TullysGolemGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 22385;

	@Inject
	protected TullysGolemGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tully's Golem Guard";
