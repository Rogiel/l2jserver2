 ...
 */
public class SpecterTemplate extends MonsterNPCTemplate {
	public static final int ID = 20171;

	@Inject
	protected SpecterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
