 ...
 */
public class LightMyFireTemplate extends MonsterNPCTemplate {
	public static final int ID = 31014;

	@Inject
	protected LightMyFireTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Light My Fire";
