 ...
 */
public class PitArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 21619;

	@Inject
	protected PitArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Pit Archer";
