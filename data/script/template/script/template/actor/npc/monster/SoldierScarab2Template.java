 ...
 */
public class SoldierScarab2Template extends MonsterNPCTemplate {
	public static final int ID = 21399;

	@Inject
	protected SoldierScarab2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
