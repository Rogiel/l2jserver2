 ...
 */
public class AntOverseerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20081;

	@Inject
	protected AntOverseerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ant Overseer";
