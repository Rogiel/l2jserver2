 ...
 */
public class VarkasEliteGuard2Template extends MonsterNPCTemplate {
	public static final int ID = 21370;

	@Inject
	protected VarkasEliteGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
