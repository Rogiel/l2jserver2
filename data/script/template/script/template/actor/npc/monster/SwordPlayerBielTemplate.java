 ...
 */
public class SwordPlayerBielTemplate extends MonsterNPCTemplate {
	public static final int ID = 27288;

	@Inject
	protected SwordPlayerBielTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sword Player Biel";
		...
		this.leftHand = itemProvider.createID(74);
		this.enchantLevel = 0;
