 ...
 */
public class FarhiteTemplate extends MonsterNPCTemplate {
	public static final int ID = 20792;

	@Inject
	protected FarhiteTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
