 ...
 */
public class RecklessSpriteOfAirTemplate extends MonsterNPCTemplate {
	public static final int ID = 27381;

	@Inject
	protected RecklessSpriteOfAirTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Reckless Sprite of Air";
