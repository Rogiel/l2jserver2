 ...
 */
public class CrimsonSpiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20460;

	@Inject
	protected CrimsonSpiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
