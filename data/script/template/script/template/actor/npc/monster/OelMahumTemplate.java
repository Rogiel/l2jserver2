 ...
 */
public class OelMahumTemplate extends MonsterNPCTemplate {
	public static final int ID = 20161;

	@Inject
	protected OelMahumTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
