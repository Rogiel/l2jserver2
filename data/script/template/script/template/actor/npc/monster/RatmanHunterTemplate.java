 ...
 */
public class RatmanHunterTemplate extends MonsterNPCTemplate {
	public static final int ID = 20358;

	@Inject
	protected RatmanHunterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ratman Hunter";
