 ...
 */
public class NewbornLavasaurusTemplate extends MonsterNPCTemplate {
	public static final int ID = 18799;

	@Inject
	protected NewbornLavasaurusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Newborn Lavasaurus";
