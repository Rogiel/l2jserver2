 ...
 */
public class NeerBodyguardTemplate extends MonsterNPCTemplate {
	public static final int ID = 27092;

	@Inject
	protected NeerBodyguardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Neer Bodyguard";
