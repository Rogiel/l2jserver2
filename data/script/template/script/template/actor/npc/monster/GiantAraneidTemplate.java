 ...
 */
public class GiantAraneidTemplate extends MonsterNPCTemplate {
	public static final int ID = 20925;

	@Inject
	protected GiantAraneidTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Giant Araneid";
