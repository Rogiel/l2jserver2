 ...
 */
public class SaltyDogTemplate extends MonsterNPCTemplate {
	public static final int ID = 31011;

	@Inject
	protected SaltyDogTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
