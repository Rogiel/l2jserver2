 ...
 */
public class LizardsTotemSharuhiTemplate extends MonsterNPCTemplate {
	public static final int ID = 27285;

	@Inject
	protected LizardsTotemSharuhiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lizard's Totem Sharuhi";
