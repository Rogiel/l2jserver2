 ...
 */
public class PlatinumGuardianArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 21064;

	@Inject
	protected PlatinumGuardianArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Platinum Guardian Archer";
