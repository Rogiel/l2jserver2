 ...
 */
public class SpitefulSoulWizardTemplate extends MonsterNPCTemplate {
	public static final int ID = 20975;

	@Inject
	protected SpitefulSoulWizardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Spiteful Soul Wizard";
