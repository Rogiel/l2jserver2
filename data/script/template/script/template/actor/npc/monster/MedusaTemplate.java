 ...
 */
public class MedusaTemplate extends MonsterNPCTemplate {
	public static final int ID = 20158;

	@Inject
	protected MedusaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
