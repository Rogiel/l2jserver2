 ...
 */
public class GoblinThiefTemplate extends MonsterNPCTemplate {
	public static final int ID = 20321;

	@Inject
	protected GoblinThiefTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
