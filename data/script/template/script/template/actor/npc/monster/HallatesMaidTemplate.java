 ...
 */
public class HallatesMaidTemplate extends MonsterNPCTemplate {
	public static final int ID = 20822;

	@Inject
	protected HallatesMaidTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hallate's Maid";
