 ...
 */
public class DarionsFaithfulServant6Template extends MonsterNPCTemplate {
	public static final int ID = 22410;

	@Inject
	protected DarionsFaithfulServant6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
