 ...
 */
public class GigantFootmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 21190;

	@Inject
	protected GigantFootmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gigant Footman";
		...
		this.experience = 4532;
		this.sp = 248;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(5791);
		this.leftHand = null;
		this.enchantLevel = 0;
