 ...
 */
public class MailleLizardmanShamanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20923;

	@Inject
	protected MailleLizardmanShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Maille Lizardman Shaman";
