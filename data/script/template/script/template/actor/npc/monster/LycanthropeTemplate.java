 ...
 */
public class LycanthropeTemplate extends MonsterNPCTemplate {
	public static final int ID = 20049;

	@Inject
	protected LycanthropeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
