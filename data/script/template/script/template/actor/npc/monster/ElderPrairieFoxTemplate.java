 ...
 */
public class ElderPrairieFoxTemplate extends MonsterNPCTemplate {
	public static final int ID = 20444;

	@Inject
	protected ElderPrairieFoxTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Elder Prairie Fox";
