 ...
 */
public class StoneGuardianTemplate extends MonsterNPCTemplate {
	public static final int ID = 20380;

	@Inject
	protected StoneGuardianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
