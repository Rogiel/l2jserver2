 ...
 */
public class AssassinFrostTemplate extends MonsterNPCTemplate {
	public static final int ID = 27308;

	@Inject
	protected AssassinFrostTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Assassin Frost";
