 ...
 */
public class AngerOfSplendorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21527;

	@Inject
	protected AngerOfSplendorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
