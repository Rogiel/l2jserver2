 ...
 */
public class HumanGhostTemplate extends MonsterNPCTemplate {
	public static final int ID = 20453;

	@Inject
	protected HumanGhostTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Human Ghost";
