 ...
 */
public class FerventKanabion3Template extends MonsterNPCTemplate {
	public static final int ID = 22478;

	@Inject
	protected FerventKanabion3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
