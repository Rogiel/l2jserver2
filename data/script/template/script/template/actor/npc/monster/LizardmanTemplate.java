 ...
 */
public class LizardmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20152;

	@Inject
	protected LizardmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
