 ...
 */
public class RokosWarhoundTemplate extends MonsterNPCTemplate {
	public static final int ID = 27066;

	@Inject
	protected RokosWarhoundTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Roko's Warhound";
