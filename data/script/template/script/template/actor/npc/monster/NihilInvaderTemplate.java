 ...
 */
public class NihilInvaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20957;

	@Inject
	protected NihilInvaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nihil Invader";
