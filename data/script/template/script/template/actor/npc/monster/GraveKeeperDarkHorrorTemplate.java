 ...
 */
public class GraveKeeperDarkHorrorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21146;

	@Inject
	protected GraveKeeperDarkHorrorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grave Keeper Dark Horror";
