 ...
 */
public class SignetOfEmperorTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18195;

	@Inject
	protected SignetOfEmperorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
