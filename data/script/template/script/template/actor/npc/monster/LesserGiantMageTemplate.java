 ...
 */
public class LesserGiantMageTemplate extends MonsterNPCTemplate {
	public static final int ID = 20657;

	@Inject
	protected LesserGiantMageTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
