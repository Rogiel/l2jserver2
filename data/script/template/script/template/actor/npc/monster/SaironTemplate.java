 ...
 */
public class SaironTemplate extends MonsterNPCTemplate {
	public static final int ID = 20986;

	@Inject
	protected SaironTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
