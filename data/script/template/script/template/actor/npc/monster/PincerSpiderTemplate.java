 ...
 */
public class PincerSpiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20466;

	@Inject
	protected PincerSpiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Pincer Spider";
