 ...
 */
public class AssassinBeetle3Template extends MonsterNPCTemplate {
	public static final int ID = 22639;

	@Inject
	protected AssassinBeetle3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
