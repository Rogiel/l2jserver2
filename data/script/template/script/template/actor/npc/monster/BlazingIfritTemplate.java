 ...
 */
public class BlazingIfritTemplate extends MonsterNPCTemplate {
	public static final int ID = 21392;

	@Inject
	protected BlazingIfritTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
