 ...
 */
public class SylphTemplate extends MonsterNPCTemplate {
	public static final int ID = 20172;

	@Inject
	protected SylphTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
