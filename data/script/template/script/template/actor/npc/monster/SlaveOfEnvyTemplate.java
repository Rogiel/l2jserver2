 ...
 */
public class SlaveOfEnvyTemplate extends MonsterNPCTemplate {
	public static final int ID = 22428;

	@Inject
	protected SlaveOfEnvyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
