 ...
 */
public class SoulOfSplendorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21529;

	@Inject
	protected SoulOfSplendorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Soul of Splendor";
