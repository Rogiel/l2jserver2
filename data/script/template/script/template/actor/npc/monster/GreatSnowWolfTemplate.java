 ...
 */
public class GreatSnowWolfTemplate extends MonsterNPCTemplate {
	public static final int ID = 20527;

	@Inject
	protected GreatSnowWolfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Great Snow Wolf";
