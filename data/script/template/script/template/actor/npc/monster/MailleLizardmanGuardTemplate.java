 ...
 */
public class MailleLizardmanGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 20921;

	@Inject
	protected MailleLizardmanGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Maille Lizardman Guard";
