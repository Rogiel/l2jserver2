 ...
 */
public class VarkaSilenosRecruitTemplate extends MonsterNPCTemplate {
	public static final int ID = 18635;

	@Inject
	protected VarkaSilenosRecruitTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Varka Silenos Recruit";
