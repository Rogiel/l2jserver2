 ...
 */
public class DeluLizardmanShamanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20781;

	@Inject
	protected DeluLizardmanShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Delu Lizardman Shaman";
