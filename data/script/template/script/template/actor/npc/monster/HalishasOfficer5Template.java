 ...
 */
public class HalishasOfficer5Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18124;

	@Inject
	protected HalishasOfficer5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
