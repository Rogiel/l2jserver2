 ...
 */
public class BarankasGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 20374;

	@Inject
	protected BarankasGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Baranka's Guard";
