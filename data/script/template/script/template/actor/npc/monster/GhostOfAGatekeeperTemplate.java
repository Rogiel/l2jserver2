 ...
 */
public class GhostOfAGatekeeperTemplate extends MonsterNPCTemplate {
	public static final int ID = 21798;

	@Inject
	protected GhostOfAGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
