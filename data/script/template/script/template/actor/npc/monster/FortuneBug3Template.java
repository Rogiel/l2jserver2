 ...
 */
public class FortuneBug3Template extends MonsterNPCTemplate {
	public static final int ID = 18666;

	@Inject
	protected FortuneBug3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
