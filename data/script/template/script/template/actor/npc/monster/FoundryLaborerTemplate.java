 ...
 */
public class FoundryLaborerTemplate extends MonsterNPCTemplate {
	public static final int ID = 22396;

	@Inject
	protected FoundryLaborerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Foundry Laborer";
