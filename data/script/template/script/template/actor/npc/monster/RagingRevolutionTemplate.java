 ...
 */
public class RagingRevolutionTemplate extends MonsterNPCTemplate {
	public static final int ID = 31012;

	@Inject
	protected RagingRevolutionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Raging Revolution";
