 ...
 */
public class EnchantedIronGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 20566;

	@Inject
	protected EnchantedIronGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Enchanted Iron Golem";
