 ...
 */
public class VarangkasDestroyerTemplate extends MonsterNPCTemplate {
	public static final int ID = 22702;

	@Inject
	protected VarangkasDestroyerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Varangka's Destroyer";
