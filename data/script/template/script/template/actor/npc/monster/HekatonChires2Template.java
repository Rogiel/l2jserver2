 ...
 */
public class HekatonChires2Template extends MonsterNPCTemplate {
	public static final int ID = 25689;

	@Inject
	protected HekatonChires2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hekaton Chires";
		...
		attributes.physicalAttack = 11010.05924;
		attributes.magicalAttack = 16152.45982;
