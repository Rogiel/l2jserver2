 ...
 */
public class BoneSweeperTemplate extends MonsterNPCTemplate {
	public static final int ID = 21572;

	@Inject
	protected BoneSweeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bone Sweeper";
