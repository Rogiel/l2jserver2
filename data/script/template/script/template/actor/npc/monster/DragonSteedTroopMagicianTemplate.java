 ...
 */
public class DragonSteedTroopMagicianTemplate extends MonsterNPCTemplate {
	public static final int ID = 22543;

	@Inject
	protected DragonSteedTroopMagicianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
