 ...
 */
public class Hasturan2Template extends MonsterNPCTemplate {
	public static final int ID = 21429;

	@Inject
	protected Hasturan2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
