 ...
 */
public class EliteGroikanTemplate extends MonsterNPCTemplate {
	public static final int ID = 22752;

	@Inject
	protected EliteGroikanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Elite Groikan";
