 ...
 */
public class BoneCollectorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21563;

	@Inject
	protected BoneCollectorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bone Collector";
