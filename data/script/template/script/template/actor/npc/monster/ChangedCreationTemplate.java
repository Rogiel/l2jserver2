 ...
 */
public class ChangedCreationTemplate extends MonsterNPCTemplate {
	public static final int ID = 20966;

	@Inject
	protected ChangedCreationTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Changed Creation";
