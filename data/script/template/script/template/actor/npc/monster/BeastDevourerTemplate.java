 ...
 */
public class BeastDevourerTemplate extends MonsterNPCTemplate {
	public static final int ID = 18907;

	@Inject
	protected BeastDevourerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Beast Devourer";
