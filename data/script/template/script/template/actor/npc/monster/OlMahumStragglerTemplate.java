 ...
 */
public class OlMahumStragglerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20061;

	@Inject
	protected OlMahumStragglerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ol Mahum Straggler";
