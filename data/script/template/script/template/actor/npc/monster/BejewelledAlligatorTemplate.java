 ...
 */
public class BejewelledAlligatorTemplate extends MonsterNPCTemplate {
	public static final int ID = 27197;

	@Inject
	protected BejewelledAlligatorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bejewelled Alligator";
