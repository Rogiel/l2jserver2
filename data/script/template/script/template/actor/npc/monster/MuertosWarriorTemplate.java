 ...
 */
public class MuertosWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 22242;

	@Inject
	protected MuertosWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Muertos Warrior";
		...
		attributes.magicalDefense = 52.01457;
