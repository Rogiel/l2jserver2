 ...
 */
public class TyrantTemplate extends MonsterNPCTemplate {
	public static final int ID = 20192;

	@Inject
	protected TyrantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
