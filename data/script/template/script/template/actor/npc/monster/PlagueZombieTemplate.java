 ...
 */
public class PlagueZombieTemplate extends MonsterNPCTemplate {
	public static final int ID = 27017;

	@Inject
	protected PlagueZombieTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Plague Zombie";
