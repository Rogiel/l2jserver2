 ...
 */
public class OlMahumSupportTroopTemplate extends MonsterNPCTemplate {
	public static final int ID = 27190;

	@Inject
	protected OlMahumSupportTroopTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ol Mahum Support Troop";
