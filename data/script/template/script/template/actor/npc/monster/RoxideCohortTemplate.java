 ...
 */
public class RoxideCohortTemplate extends MonsterNPCTemplate {
	public static final int ID = 20748;

	@Inject
	protected RoxideCohortTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Roxide Cohort";
