 ...
 */
public class KnightOfDarkness3Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18189;

	@Inject
	protected KnightOfDarkness3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Knight of Darkness";
