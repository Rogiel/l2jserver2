 ...
 */
public class NosLadTemplate extends MonsterNPCTemplate {
	public static final int ID = 20808;

	@Inject
	protected NosLadTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
