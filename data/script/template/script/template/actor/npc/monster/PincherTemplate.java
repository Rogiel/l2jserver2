 ...
 */
public class PincherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20028;

	@Inject
	protected PincherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
