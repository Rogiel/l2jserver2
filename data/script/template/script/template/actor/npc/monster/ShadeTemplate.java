 ...
 */
public class ShadeTemplate extends MonsterNPCTemplate {
	public static final int ID = 22268;

	@Inject
	protected ShadeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
