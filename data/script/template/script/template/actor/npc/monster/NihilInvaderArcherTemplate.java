 ...
 */
public class NihilInvaderArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 22725;

	@Inject
	protected NihilInvaderArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nihil Invader Archer";
