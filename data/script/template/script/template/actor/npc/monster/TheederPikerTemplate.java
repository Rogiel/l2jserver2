 ...
 */
public class TheederPikerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20801;

	@Inject
	protected TheederPikerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Theeder Piker";
		...
		this.experience = 7134;
		this.sp = 521;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(302);
		this.leftHand = null;
		this.enchantLevel = 0;
