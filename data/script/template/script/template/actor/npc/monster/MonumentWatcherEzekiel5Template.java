 ...
 */
public class MonumentWatcherEzekiel5Template extends MonsterNPCTemplate {
	public static final int ID = 27300;

	@Inject
	protected MonumentWatcherEzekiel5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Monument Watcher Ezekiel";
