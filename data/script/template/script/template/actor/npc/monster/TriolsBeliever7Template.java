 ...
 */
public class TriolsBeliever7Template extends MonsterNPCTemplate {
	public static final int ID = 22166;

	@Inject
	protected TriolsBeliever7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
