 ...
 */
public class TriolsHighPriest3Template extends MonsterNPCTemplate {
	public static final int ID = 22163;

	@Inject
	protected TriolsHighPriest3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
