 ...
 */
public class GraveRobberWarrior2Template extends MonsterNPCTemplate {
	public static final int ID = 22741;

	@Inject
	protected GraveRobberWarrior2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grave Robber Warrior";
