 ...
 */
public class AssassinOfDarknessTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18222;

	@Inject
	protected AssassinOfDarknessTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
