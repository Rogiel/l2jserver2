 ...
 */
public class TanukiSkullcrusherTemplate extends MonsterNPCTemplate {
	public static final int ID = 27007;

	@Inject
	protected TanukiSkullcrusherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tanuki Skullcrusher";
		...
		attributes.magicalDefense = 46.86683;
