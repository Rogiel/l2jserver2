 ...
 */
public class MucrokianFanaticTemplate extends MonsterNPCTemplate {
	public static final int ID = 22650;

	@Inject
	protected MucrokianFanaticTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mucrokian Fanatic";
