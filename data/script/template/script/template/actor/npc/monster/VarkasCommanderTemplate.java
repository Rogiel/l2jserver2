 ...
 */
public class VarkasCommanderTemplate extends MonsterNPCTemplate {
	public static final int ID = 18654;

	@Inject
	protected VarkasCommanderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Varka's Commander";
		...
		attributes.physicalAttack = 397.12000;
