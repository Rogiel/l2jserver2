 ...
 */
public class TamilTemplate extends MonsterNPCTemplate {
	public static final int ID = 27035;

	@Inject
	protected TamilTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
