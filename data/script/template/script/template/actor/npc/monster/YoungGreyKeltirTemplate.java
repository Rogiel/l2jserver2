 ...
 */
public class YoungGreyKeltirTemplate extends MonsterNPCTemplate {
	public static final int ID = 22229;

	@Inject
	protected YoungGreyKeltirTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Young Grey Keltir";
