 ...
 */
public class HeathenGruntTemplate extends MonsterNPCTemplate {
	public static final int ID = 21441;

	@Inject
	protected HeathenGruntTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Heathen Grunt";
