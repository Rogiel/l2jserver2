 ...
 */
public class KimsGangTemplate extends MonsterNPCTemplate {
	public static final int ID = 25474;

	@Inject
	protected KimsGangTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kim's Gang";
