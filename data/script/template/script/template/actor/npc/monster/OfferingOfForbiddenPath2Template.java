 ...
 */
public class OfferingOfForbiddenPath2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18100;

	@Inject
	protected OfferingOfForbiddenPath2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Offering of Forbidden Path";
		...
		attributes.physicalAttack = 713.45002;
