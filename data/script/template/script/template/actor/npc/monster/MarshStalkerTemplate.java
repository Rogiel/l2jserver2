 ...
 */
public class MarshStalkerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20679;

	@Inject
	protected MarshStalkerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Marsh Stalker";
