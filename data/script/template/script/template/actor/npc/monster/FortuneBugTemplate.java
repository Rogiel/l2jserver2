 ...
 */
public class FortuneBugTemplate extends MonsterNPCTemplate {
	public static final int ID = 18664;

	@Inject
	protected FortuneBugTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fortune Bug";
