 ...
 */
public class BodySeverer2Template extends MonsterNPCTemplate {
	public static final int ID = 22520;

	@Inject
	protected BodySeverer2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Body Severer";
