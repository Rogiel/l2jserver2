 ...
 */
public class EliteTardyonTemplate extends MonsterNPCTemplate {
	public static final int ID = 22759;

	@Inject
	protected EliteTardyonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Elite Tardyon";
