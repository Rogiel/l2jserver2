 ...
 */
public class MineBugTemplate extends MonsterNPCTemplate {
	public static final int ID = 22689;

	@Inject
	protected MineBugTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
