 ...
 */
public class RupturedKanabion3Template extends MonsterNPCTemplate {
	public static final int ID = 22481;

	@Inject
	protected RupturedKanabion3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
