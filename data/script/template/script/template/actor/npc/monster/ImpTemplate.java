 ...
 */
public class ImpTemplate extends MonsterNPCTemplate {
	public static final int ID = 20004;

	@Inject
	protected ImpTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
