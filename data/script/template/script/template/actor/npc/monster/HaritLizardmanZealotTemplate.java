 ...
 */
public class HaritLizardmanZealotTemplate extends MonsterNPCTemplate {
	public static final int ID = 27172;

	@Inject
	protected HaritLizardmanZealotTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Harit Lizardman Zealot";
