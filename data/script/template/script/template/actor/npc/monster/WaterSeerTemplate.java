 ...
 */
public class WaterSeerTemplate extends MonsterNPCTemplate {
	public static final int ID = 27030;

	@Inject
	protected WaterSeerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Water Seer";
