 ...
 */
public class SalamanderNobleTemplate extends MonsterNPCTemplate {
	public static final int ID = 20114;

	@Inject
	protected SalamanderNobleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Salamander Noble";
