 ...
 */
public class ArkGuardianElberothTemplate extends MonsterNPCTemplate {
	public static final int ID = 27182;

	@Inject
	protected ArkGuardianElberothTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ark Guardian Elberoth";
