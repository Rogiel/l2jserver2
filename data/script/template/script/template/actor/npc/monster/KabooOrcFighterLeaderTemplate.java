 ...
 */
public class KabooOrcFighterLeaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20472;

	@Inject
	protected KabooOrcFighterLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kaboo Orc Fighter Leader";
