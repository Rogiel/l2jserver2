 ...
 */
public class AssassinOfBifronsTemplate extends MonsterNPCTemplate {
	public static final int ID = 25147;

	@Inject
	protected AssassinOfBifronsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Assassin of Bifrons";
		...
		this.maxHP = 3950.018347282250000;
