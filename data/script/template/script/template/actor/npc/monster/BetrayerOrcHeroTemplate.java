 ...
 */
public class BetrayerOrcHeroTemplate extends MonsterNPCTemplate {
	public static final int ID = 21260;

	@Inject
	protected BetrayerOrcHeroTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Betrayer Orc Hero";
