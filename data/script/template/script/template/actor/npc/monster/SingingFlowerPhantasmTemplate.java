 ...
 */
public class SingingFlowerPhantasmTemplate extends MonsterNPCTemplate {
	public static final int ID = 27095;

	@Inject
	protected SingingFlowerPhantasmTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Singing Flower Phantasm";
