 ...
 */
public class TeslasApprenticeTemplate extends MonsterNPCTemplate {
	public static final int ID = 25550;

	@Inject
	protected TeslasApprenticeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tesla's Apprentice";
