 ...
 */
public class Ornithomimus3Template extends MonsterNPCTemplate {
	public static final int ID = 22202;

	@Inject
	protected Ornithomimus3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
