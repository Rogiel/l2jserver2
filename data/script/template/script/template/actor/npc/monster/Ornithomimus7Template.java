 ...
 */
public class Ornithomimus7Template extends MonsterNPCTemplate {
	public static final int ID = 22744;

	@Inject
	protected Ornithomimus7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
