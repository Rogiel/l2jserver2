 ...
 */
public class PumaTemplate extends MonsterNPCTemplate {
	public static final int ID = 20189;

	@Inject
	protected PumaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
