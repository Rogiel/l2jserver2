 ...
 */
public class SealAngelTemplate extends MonsterNPCTemplate {
	public static final int ID = 20831;

	@Inject
	protected SealAngelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
