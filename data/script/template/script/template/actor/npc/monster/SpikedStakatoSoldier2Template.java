 ...
 */
public class SpikedStakatoSoldier2Template extends MonsterNPCTemplate {
	public static final int ID = 22627;

	@Inject
	protected SpikedStakatoSoldier2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Spiked Stakato Soldier";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 18.00;
		this.collisionHeight = 43.20;
		this.level = 83;
