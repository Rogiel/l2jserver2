 ...
 */
public class RestrainerOfGloryTemplate extends MonsterNPCTemplate {
	public static final int ID = 27317;

	@Inject
	protected RestrainerOfGloryTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Restrainer of Glory";
