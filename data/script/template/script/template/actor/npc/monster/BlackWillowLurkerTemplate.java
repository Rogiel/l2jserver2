 ...
 */
public class BlackWillowLurkerTemplate extends MonsterNPCTemplate {
	public static final int ID = 27079;

	@Inject
	protected BlackWillowLurkerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Black Willow Lurker";
