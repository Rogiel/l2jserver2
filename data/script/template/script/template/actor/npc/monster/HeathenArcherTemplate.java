 ...
 */
public class HeathenArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 21440;

	@Inject
	protected HeathenArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Heathen Archer";
