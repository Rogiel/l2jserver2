 ...
 */
public class GamlinTemplate extends MonsterNPCTemplate {
	public static final int ID = 20651;

	@Inject
	protected GamlinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
