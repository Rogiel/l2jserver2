 ...
 */
public class LavastoneGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 21385;

	@Inject
	protected LavastoneGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lavastone Golem";
