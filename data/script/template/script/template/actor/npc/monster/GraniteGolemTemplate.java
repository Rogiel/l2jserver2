 ...
 */
public class GraniteGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 20083;

	@Inject
	protected GraniteGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Granite Golem";
