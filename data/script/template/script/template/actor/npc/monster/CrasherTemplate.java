 ...
 */
public class CrasherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20101;

	@Inject
	protected CrasherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
