 ...
 */
public class OrcTemplate extends MonsterNPCTemplate {
	public static final int ID = 20130;

	@Inject
	protected OrcTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
