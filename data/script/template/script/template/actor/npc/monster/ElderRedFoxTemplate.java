 ...
 */
public class ElderRedFoxTemplate extends MonsterNPCTemplate {
	public static final int ID = 20443;

	@Inject
	protected ElderRedFoxTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Elder Red Fox";
