 ...
 */
public class SpitefulSoulLeaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20974;

	@Inject
	protected SpitefulSoulLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Spiteful Soul Leader";
