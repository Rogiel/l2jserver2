 ...
 */
public class TerritoryCatapult3Template extends MonsterNPCTemplate {
	public static final int ID = 36501;

	@Inject
	protected TerritoryCatapult3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
