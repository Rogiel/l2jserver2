 ...
 */
public class ShyslassysTemplate extends MonsterNPCTemplate {
	public static final int ID = 27110;

	@Inject
	protected ShyslassysTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shyslassys";
