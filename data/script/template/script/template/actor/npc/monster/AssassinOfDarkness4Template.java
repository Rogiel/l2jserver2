 ...
 */
public class AssassinOfDarkness4Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18225;

	@Inject
	protected AssassinOfDarkness4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Assassin of Darkness";
