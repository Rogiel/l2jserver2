 ...
 */
public class KelMahumChampionTemplate extends MonsterNPCTemplate {
	public static final int ID = 20857;

	@Inject
	protected KelMahumChampionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kel Mahum Champion";
