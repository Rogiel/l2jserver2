 ...
 */
public class HookSpiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20308;

	@Inject
	protected HookSpiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hook Spider";
