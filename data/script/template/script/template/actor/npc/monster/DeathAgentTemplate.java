 ...
 */
public class DeathAgentTemplate extends MonsterNPCTemplate {
	public static final int ID = 20958;

	@Inject
	protected DeathAgentTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Death Agent";
