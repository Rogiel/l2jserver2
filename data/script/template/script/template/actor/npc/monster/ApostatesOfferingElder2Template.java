 ...
 */
public class ApostatesOfferingElder2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18069;

	@Inject
	protected ApostatesOfferingElder2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Apostate's Offering Elder";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 12.00;
		this.collisionHeight = 27.60;
		this.level = 45;
