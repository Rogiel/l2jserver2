 ...
 */
public class ExecutorOfSacrificialOfferingsTemplate extends MonsterNPCTemplate {
	public static final int ID = 21823;

	@Inject
	protected ExecutorOfSacrificialOfferingsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Executor of Sacrificial Offerings";
