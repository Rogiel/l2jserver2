 ...
 */
public class RagnaOrcCommanderTemplate extends MonsterNPCTemplate {
	public static final int ID = 22039;

	@Inject
	protected RagnaOrcCommanderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
