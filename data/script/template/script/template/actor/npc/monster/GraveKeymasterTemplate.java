 ...
 */
public class GraveKeymasterTemplate extends MonsterNPCTemplate {
	public static final int ID = 27179;

	@Inject
	protected GraveKeymasterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grave Keymaster";
