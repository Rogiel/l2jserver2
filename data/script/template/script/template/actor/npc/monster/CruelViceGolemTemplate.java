 ...
 */
public class CruelViceGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 22055;

	@Inject
	protected CruelViceGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cruel Vice Golem";
