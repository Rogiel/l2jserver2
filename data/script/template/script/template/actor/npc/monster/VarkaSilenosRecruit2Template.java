 ...
 */
public class VarkaSilenosRecruit2Template extends MonsterNPCTemplate {
	public static final int ID = 21350;

	@Inject
	protected VarkaSilenosRecruit2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
