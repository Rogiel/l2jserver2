 ...
 */
public class SelMahumSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 22781;

	@Inject
	protected SelMahumSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
