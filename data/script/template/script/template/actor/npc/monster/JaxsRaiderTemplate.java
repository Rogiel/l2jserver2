 ...
 */
public class JaxsRaiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 25571;

	@Inject
	protected JaxsRaiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Jax's Raider";
