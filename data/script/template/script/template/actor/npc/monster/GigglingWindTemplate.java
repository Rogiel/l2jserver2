 ...
 */
public class GigglingWindTemplate extends MonsterNPCTemplate {
	public static final int ID = 21025;

	@Inject
	protected GigglingWindTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Giggling Wind";
