 ...
 */
public class HallKeeperSuicidalSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 18333;

	@Inject
	protected HallKeeperSuicidalSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
