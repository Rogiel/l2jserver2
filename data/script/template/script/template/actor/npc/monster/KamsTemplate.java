 ...
 */
public class KamsTemplate extends MonsterNPCTemplate {
	public static final int ID = 18629;

	@Inject
	protected KamsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
