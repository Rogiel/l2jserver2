 ...
 */
public class MalignantSpiritOfTheExecutionGroundsTemplate extends MonsterNPCTemplate {
	public static final int ID = 25387;

	@Inject
	protected MalignantSpiritOfTheExecutionGroundsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Malignant Spirit of the Execution Grounds";
