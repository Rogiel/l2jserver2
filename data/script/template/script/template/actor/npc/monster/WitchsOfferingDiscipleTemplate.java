 ...
 */
public class WitchsOfferingDiscipleTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18037;

	@Inject
	protected WitchsOfferingDiscipleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
