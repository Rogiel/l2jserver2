 ...
 */
public class TurakBugbearTemplate extends MonsterNPCTemplate {
	public static final int ID = 20248;

	@Inject
	protected TurakBugbearTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Turak Bugbear";
