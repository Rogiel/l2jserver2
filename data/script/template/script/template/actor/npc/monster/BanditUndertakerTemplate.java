 ...
 */
public class BanditUndertakerTemplate extends MonsterNPCTemplate {
	public static final int ID = 22021;

	@Inject
	protected BanditUndertakerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bandit Undertaker";
