 ...
 */
public class TarBeetleTemplate extends MonsterNPCTemplate {
	public static final int ID = 18804;

	@Inject
	protected TarBeetleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tar Beetle";
