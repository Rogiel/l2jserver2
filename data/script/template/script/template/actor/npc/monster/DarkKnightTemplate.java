 ...
 */
public class DarkKnightTemplate extends MonsterNPCTemplate {
	public static final int ID = 20754;

	@Inject
	protected DarkKnightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
