 ...
 */
public class LetoLizardmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20577;

	@Inject
	protected LetoLizardmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Leto Lizardman";
