 ...
 */
public class PurgatoryShadowTemplate extends MonsterNPCTemplate {
	public static final int ID = 21156;

	@Inject
	protected PurgatoryShadowTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Purgatory Shadow";
