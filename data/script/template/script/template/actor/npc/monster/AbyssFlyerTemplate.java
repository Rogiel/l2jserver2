 ...
 */
public class AbyssFlyerTemplate extends MonsterNPCTemplate {
	public static final int ID = 25374;

	@Inject
	protected AbyssFlyerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Abyss Flyer";
