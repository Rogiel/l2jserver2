 ...
 */
public class RudeltosDreVanulTemplate extends MonsterNPCTemplate {
	public static final int ID = 25075;

	@Inject
	protected RudeltosDreVanulTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rudelto's Dre Vanul";
		...
		this.attackRange = 40;
		this.maxHP = 28997.569449543900000;
