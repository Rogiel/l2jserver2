 ...
 */
public class TalkinsBodyguardTemplate extends MonsterNPCTemplate {
	public static final int ID = 25136;

	@Inject
	protected TalkinsBodyguardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Talkin's Bodyguard";
