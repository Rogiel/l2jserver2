 ...
 */
public class Griffon2Template extends MonsterNPCTemplate {
	public static final int ID = 20142;

	@Inject
	protected Griffon2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
