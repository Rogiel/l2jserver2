 ...
 */
public class ProphetGuard2Template extends MonsterNPCTemplate {
	public static final int ID = 21374;

	@Inject
	protected ProphetGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
