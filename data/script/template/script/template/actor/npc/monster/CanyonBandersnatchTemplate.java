 ...
 */
public class CanyonBandersnatchTemplate extends MonsterNPCTemplate {
	public static final int ID = 21296;

	@Inject
	protected CanyonBandersnatchTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Canyon Bandersnatch";
