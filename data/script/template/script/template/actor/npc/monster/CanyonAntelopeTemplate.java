 ...
 */
public class CanyonAntelopeTemplate extends MonsterNPCTemplate {
	public static final int ID = 21294;

	@Inject
	protected CanyonAntelopeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Canyon Antelope";
