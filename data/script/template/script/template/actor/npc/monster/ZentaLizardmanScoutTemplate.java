 ...
 */
public class ZentaLizardmanScoutTemplate extends MonsterNPCTemplate {
	public static final int ID = 20301;

	@Inject
	protected ZentaLizardmanScoutTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Zenta Lizardman Scout";
