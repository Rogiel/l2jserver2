 ...
 */
public class EmissaryOfDeath2Template extends MonsterNPCTemplate {
	public static final int ID = 22525;

	@Inject
	protected EmissaryOfDeath2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
