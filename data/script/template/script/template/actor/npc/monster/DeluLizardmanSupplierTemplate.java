 ...
 */
public class DeluLizardmanSupplierTemplate extends MonsterNPCTemplate {
	public static final int ID = 21104;

	@Inject
	protected DeluLizardmanSupplierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Delu Lizardman Supplier";
