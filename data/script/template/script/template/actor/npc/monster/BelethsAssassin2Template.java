 ...
 */
public class BelethsAssassin2Template extends MonsterNPCTemplate {
	public static final int ID = 22440;

	@Inject
	protected BelethsAssassin2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Beleth's Assassin";
