 ...
 */
public class ExterminatorTemplate extends MonsterNPCTemplate {
	public static final int ID = 22657;

	@Inject
	protected ExterminatorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
