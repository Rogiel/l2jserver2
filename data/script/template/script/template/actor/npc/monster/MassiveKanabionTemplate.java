 ...
 */
public class MassiveKanabionTemplate extends MonsterNPCTemplate {
	public static final int ID = 22473;

	@Inject
	protected MassiveKanabionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
