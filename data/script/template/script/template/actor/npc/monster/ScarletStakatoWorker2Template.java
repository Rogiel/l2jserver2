 ...
 */
public class ScarletStakatoWorker2Template extends MonsterNPCTemplate {
	public static final int ID = 22634;

	@Inject
	protected ScarletStakatoWorker2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
