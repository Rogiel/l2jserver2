 ...
 */
public class Deinonychus3Template extends MonsterNPCTemplate {
	public static final int ID = 22205;

	@Inject
	protected Deinonychus3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
