 ...
 */
public class RaiderOfPastureland6Template extends MonsterNPCTemplate {
	public static final int ID = 21449;

	@Inject
	protected RaiderOfPastureland6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
