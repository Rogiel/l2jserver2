 ...
 */
public class SharuhiMouthMudahaTemplate extends MonsterNPCTemplate {
	public static final int ID = 27295;

	@Inject
	protected SharuhiMouthMudahaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sharuhi Mouth Mudaha";
