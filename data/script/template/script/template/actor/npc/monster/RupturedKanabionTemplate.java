 ...
 */
public class RupturedKanabionTemplate extends MonsterNPCTemplate {
	public static final int ID = 22479;

	@Inject
	protected RupturedKanabionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
