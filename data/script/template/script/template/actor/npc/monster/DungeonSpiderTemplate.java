 ...
 */
public class DungeonSpiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20461;

	@Inject
	protected DungeonSpiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dungeon Spider";
