 ...
 */
public class VanorSilenosScoutTemplate extends MonsterNPCTemplate {
	public static final int ID = 20683;

	@Inject
	protected VanorSilenosScoutTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vanor Silenos Scout";
