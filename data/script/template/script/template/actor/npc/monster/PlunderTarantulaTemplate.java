 ...
 */
public class PlunderTarantulaTemplate extends MonsterNPCTemplate {
	public static final int ID = 20508;

	@Inject
	protected PlunderTarantulaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Plunder Tarantula";
