 ...
 */
public class OfferingOfBrandedWarrior2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18062;

	@Inject
	protected OfferingOfBrandedWarrior2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Offering of Branded Warrior";
