 ...
 */
public class OlMahumVanGruntTemplate extends MonsterNPCTemplate {
	public static final int ID = 21011;

	@Inject
	protected OlMahumVanGruntTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ol Mahum Van Grunt";
