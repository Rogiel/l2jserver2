 ...
 */
public class AwakenedMucrokianTemplate extends MonsterNPCTemplate {
	public static final int ID = 22655;

	@Inject
	protected AwakenedMucrokianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Awakened Mucrokian";
