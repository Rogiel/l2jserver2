 ...
 */
public class TriolsPriestTemplate extends MonsterNPCTemplate {
	public static final int ID = 22146;

	@Inject
	protected TriolsPriestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
