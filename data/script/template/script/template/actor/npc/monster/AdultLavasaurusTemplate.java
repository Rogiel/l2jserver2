 ...
 */
public class AdultLavasaurusTemplate extends MonsterNPCTemplate {
	public static final int ID = 18801;

	@Inject
	protected AdultLavasaurusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Adult Lavasaurus";
