 ...
 */
public class ThroneOfDestructionPowerfulDevice2Template extends MonsterNPCTemplate {
	public static final int ID = 22600;

	@Inject
	protected ThroneOfDestructionPowerfulDevice2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Throne of Destruction Powerful Device";
