 ...
 */
public class MercenaryOfDestructionTemplate extends MonsterNPCTemplate {
	public static final int ID = 21382;

	@Inject
	protected MercenaryOfDestructionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
