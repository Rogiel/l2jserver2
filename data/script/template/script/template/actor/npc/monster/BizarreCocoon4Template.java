 ...
 */
public class BizarreCocoon4Template extends MonsterNPCTemplate {
	public static final int ID = 18796;

	@Inject
	protected BizarreCocoon4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
