 ...
 */
public class NonexistentManTemplate extends MonsterNPCTemplate {
	public static final int ID = 20968;

	@Inject
	protected NonexistentManTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nonexistent Man";
