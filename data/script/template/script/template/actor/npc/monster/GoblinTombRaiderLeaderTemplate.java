 ...
 */
public class GoblinTombRaiderLeaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20320;

	@Inject
	protected GoblinTombRaiderLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Goblin Tomb Raider Leader";
