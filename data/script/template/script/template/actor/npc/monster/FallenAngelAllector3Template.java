 ...
 */
public class FallenAngelAllector3Template extends MonsterNPCTemplate {
	public static final int ID = 27252;

	@Inject
	protected FallenAngelAllector3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
