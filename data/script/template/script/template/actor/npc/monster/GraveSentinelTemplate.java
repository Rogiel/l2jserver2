 ...
 */
public class GraveSentinelTemplate extends MonsterNPCTemplate {
	public static final int ID = 21238;

	@Inject
	protected GraveSentinelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grave Sentinel";
