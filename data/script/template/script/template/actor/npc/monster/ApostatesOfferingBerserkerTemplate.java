 ...
 */
public class ApostatesOfferingBerserkerTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18024;

	@Inject
	protected ApostatesOfferingBerserkerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
