 ...
 */
public class NihilInvaderDiscipleTemplate extends MonsterNPCTemplate {
	public static final int ID = 22728;

	@Inject
	protected NihilInvaderDiscipleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nihil Invader Disciple";
