 ...
 */
public class BoundShamanTemplate extends MonsterNPCTemplate {
	public static final int ID = 21074;

	@Inject
	protected BoundShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bound Shaman";
