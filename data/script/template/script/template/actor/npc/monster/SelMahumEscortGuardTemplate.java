 ...
 */
public class SelMahumEscortGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 22779;

	@Inject
	protected SelMahumEscortGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sel Mahum Escort Guard";
