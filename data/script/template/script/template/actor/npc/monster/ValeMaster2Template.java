 ...
 */
public class ValeMaster2Template extends MonsterNPCTemplate {
	public static final int ID = 20847;

	@Inject
	protected ValeMaster2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
