 ...
 */
public class ImperialMosaic7Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18139;

	@Inject
	protected ImperialMosaic7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
