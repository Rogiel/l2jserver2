 ...
 */
public class Barif2Template extends MonsterNPCTemplate {
	public static final int ID = 22666;

	@Inject
	protected Barif2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
