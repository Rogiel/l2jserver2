 ...
 */
public class PartisanSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 35372;

	@Inject
	protected PartisanSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
