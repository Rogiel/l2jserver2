 ...
 */
public class AsceticSolinaTemplate extends MonsterNPCTemplate {
	public static final int ID = 22793;

	@Inject
	protected AsceticSolinaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ascetic Solina";
