 ...
 */
public class ShilensEvilThoughts5Template extends MonsterNPCTemplate {
	public static final int ID = 27345;

	@Inject
	protected ShilensEvilThoughts5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
