 ...
 */
public class GhostOfALoyalVassalTemplate extends MonsterNPCTemplate {
	public static final int ID = 22009;

	@Inject
	protected GhostOfALoyalVassalTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ghost of a Loyal Vassal";
