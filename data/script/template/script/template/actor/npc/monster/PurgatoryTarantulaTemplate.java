 ...
 */
public class PurgatoryTarantulaTemplate extends MonsterNPCTemplate {
	public static final int ID = 21157;

	@Inject
	protected PurgatoryTarantulaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Purgatory Tarantula";
