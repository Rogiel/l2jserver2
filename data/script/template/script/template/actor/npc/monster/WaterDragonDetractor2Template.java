 ...
 */
public class WaterDragonDetractor2Template extends MonsterNPCTemplate {
	public static final int ID = 22271;

	@Inject
	protected WaterDragonDetractor2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Water Dragon Detractor";
