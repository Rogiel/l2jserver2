 ...
 */
public class LilimStabber2Template extends MonsterNPCTemplate {
	public static final int ID = 27365;

	@Inject
	protected LilimStabber2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
