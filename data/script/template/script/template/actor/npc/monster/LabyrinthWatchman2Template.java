 ...
 */
public class LabyrinthWatchman2Template extends MonsterNPCTemplate {
	public static final int ID = 22366;

	@Inject
	protected LabyrinthWatchman2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
