 ...
 */
public class Susceptor2Template extends MonsterNPCTemplate {
	public static final int ID = 29011;

	@Inject
	protected Susceptor2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 13389.000000000000000;
		...
		attributes.physicalAttack = 391.00000;
		attributes.magicalAttack = 66.00000;
