 ...
 */
public class LabyrinthMysticTemplate extends MonsterNPCTemplate {
	public static final int ID = 22367;

	@Inject
	protected LabyrinthMysticTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Labyrinth Mystic";
