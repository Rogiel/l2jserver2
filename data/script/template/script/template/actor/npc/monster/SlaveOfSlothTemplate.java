 ...
 */
public class SlaveOfSlothTemplate extends MonsterNPCTemplate {
	public static final int ID = 22427;

	@Inject
	protected SlaveOfSlothTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
