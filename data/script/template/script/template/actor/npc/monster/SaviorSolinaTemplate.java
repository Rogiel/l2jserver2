 ...
 */
public class SaviorSolinaTemplate extends MonsterNPCTemplate {
	public static final int ID = 22791;

	@Inject
	protected SaviorSolinaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Savior Solina";
