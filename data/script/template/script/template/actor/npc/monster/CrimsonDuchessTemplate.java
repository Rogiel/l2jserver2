 ...
 */
public class CrimsonDuchessTemplate extends MonsterNPCTemplate {
	public static final int ID = 27333;

	@Inject
	protected CrimsonDuchessTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Crimson Duchess";
