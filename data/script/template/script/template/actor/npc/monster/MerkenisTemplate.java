 ...
 */
public class MerkenisTemplate extends MonsterNPCTemplate {
	public static final int ID = 27022;

	@Inject
	protected MerkenisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
