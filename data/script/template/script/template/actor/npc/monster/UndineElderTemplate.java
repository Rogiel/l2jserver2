 ...
 */
public class UndineElderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20113;

	@Inject
	protected UndineElderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Undine Elder";
