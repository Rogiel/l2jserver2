 ...
 */
public class LithWitchTemplate extends MonsterNPCTemplate {
	public static final int ID = 21167;

	@Inject
	protected LithWitchTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lith Witch";
