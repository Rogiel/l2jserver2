 ...
 */
public class MutantHealerTemplate extends MonsterNPCTemplate {
	public static final int ID = 22731;

	@Inject
	protected MutantHealerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mutant Healer";
