 ...
 */
public class ClawOfSuccubusTemplate extends MonsterNPCTemplate {
	public static final int ID = 27115;

	@Inject
	protected ClawOfSuccubusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Claw Of Succubus";
