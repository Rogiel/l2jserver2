 ...
 */
public class BreathOfHalisha2Template extends MonsterNPCTemplate {
	public static final int ID = 29051;

	@Inject
	protected BreathOfHalisha2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
