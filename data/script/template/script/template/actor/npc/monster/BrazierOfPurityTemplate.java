 ...
 */
public class BrazierOfPurityTemplate extends MonsterNPCTemplate {
	public static final int ID = 18806;

	@Inject
	protected BrazierOfPurityTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Brazier of Purity";
