 ...
 */
public class Scarecrow2Template extends MonsterNPCTemplate {
	public static final int ID = 18912;

	@Inject
	protected Scarecrow2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
