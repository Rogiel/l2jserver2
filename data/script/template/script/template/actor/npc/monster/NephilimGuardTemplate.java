 ...
 */
public class NephilimGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 21199;

	@Inject
	protected NephilimGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nephilim Guard";
