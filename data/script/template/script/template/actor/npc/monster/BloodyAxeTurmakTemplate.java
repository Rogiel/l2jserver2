 ...
 */
public class BloodyAxeTurmakTemplate extends MonsterNPCTemplate {
	public static final int ID = 20212;

	@Inject
	protected BloodyAxeTurmakTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bloody Axe Turmak";
		this.serverSideName = false;
		this.title = "Ol Mahum Lord";
