 ...
 */
public class TantaLizardmanArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 22772;

	@Inject
	protected TantaLizardmanArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tanta Lizardman Archer";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 20.00;
		this.collisionHeight = 40.25;
		this.level = 83;
