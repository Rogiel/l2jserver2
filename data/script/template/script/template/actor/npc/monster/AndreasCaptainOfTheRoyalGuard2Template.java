 ...
 */
public class AndreasCaptainOfTheRoyalGuard2Template extends MonsterNPCTemplate {
	public static final int ID = 22188;

	@Inject
	protected AndreasCaptainOfTheRoyalGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Andreas' Captain of the Royal Guard";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 13.00;
		this.collisionHeight = 23.20;
		this.level = 78;
