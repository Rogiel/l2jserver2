 ...
 */
public class BoxOfAthrea4Template extends MonsterNPCTemplate {
	public static final int ID = 27176;

	@Inject
	protected BoxOfAthrea4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Box Of Athrea 4";
