 ...
 */
public class GuardianScarab2Template extends MonsterNPCTemplate {
	public static final int ID = 21411;

	@Inject
	protected GuardianScarab2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guardian Scarab";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 17.00;
		this.collisionHeight = 26.50;
		this.level = 78;
