 ...
 */
public class CaveAntLarva3Template extends MonsterNPCTemplate {
	public static final int ID = 21267;

	@Inject
	protected CaveAntLarva3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
