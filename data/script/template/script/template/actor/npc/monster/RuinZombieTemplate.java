 ...
 */
public class RuinZombieTemplate extends MonsterNPCTemplate {
	public static final int ID = 20026;

	@Inject
	protected RuinZombieTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ruin Zombie";
