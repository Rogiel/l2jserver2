 ...
 */
public class MandragoraSprout2Template extends MonsterNPCTemplate {
	public static final int ID = 20223;

	@Inject
	protected MandragoraSprout2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mandragora Sprout";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 14.00;
		this.collisionHeight = 17.80;
		this.level = 20;
