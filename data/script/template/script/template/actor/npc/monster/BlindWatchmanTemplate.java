 ...
 */
public class BlindWatchmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 22325;

	@Inject
	protected BlindWatchmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Blind Watchman";
