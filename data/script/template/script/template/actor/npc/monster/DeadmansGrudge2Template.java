 ...
 */
public class DeadmansGrudge2Template extends MonsterNPCTemplate {
	public static final int ID = 18625;

	@Inject
	protected DeadmansGrudge2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
