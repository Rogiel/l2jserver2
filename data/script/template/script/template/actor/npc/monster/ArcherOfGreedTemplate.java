 ...
 */
public class ArcherOfGreedTemplate extends MonsterNPCTemplate {
	public static final int ID = 20660;

	@Inject
	protected ArcherOfGreedTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Archer of Greed";
