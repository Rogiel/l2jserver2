 ...
 */
public class SingingFlowerDarklingTemplate extends MonsterNPCTemplate {
	public static final int ID = 27097;

	@Inject
	protected SingingFlowerDarklingTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Singing Flower Darkling";
