 ...
 */
public class SilentHorrorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20404;

	@Inject
	protected SilentHorrorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Silent Horror";
