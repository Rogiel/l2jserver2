 ...
 */
public class LindviorTemplate extends FlyMonsterNPCTemplate {
	public static final int ID = 13148;

	@Inject
	protected LindviorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
