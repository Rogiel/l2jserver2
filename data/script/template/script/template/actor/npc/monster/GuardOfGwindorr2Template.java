 ...
 */
public class GuardOfGwindorr2Template extends MonsterNPCTemplate {
	public static final int ID = 25675;

	@Inject
	protected GuardOfGwindorr2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guard of Gwindorr";
		...
		this.maxHP = 32842.180866976600000;
		...
		attributes.physicalAttack = 3931.59220;
