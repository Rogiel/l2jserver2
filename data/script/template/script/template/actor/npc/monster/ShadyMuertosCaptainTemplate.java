 ...
 */
public class ShadyMuertosCaptainTemplate extends MonsterNPCTemplate {
	public static final int ID = 22251;

	@Inject
	protected ShadyMuertosCaptainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shady Muertos Captain";
