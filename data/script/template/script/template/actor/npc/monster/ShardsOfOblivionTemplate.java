 ...
 */
public class ShardsOfOblivionTemplate extends MonsterNPCTemplate {
	public static final int ID = 25457;

	@Inject
	protected ShardsOfOblivionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
