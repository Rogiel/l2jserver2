 ...
 */
public class VarkaSilenosSeer2Template extends MonsterNPCTemplate {
	public static final int ID = 21364;

	@Inject
	protected VarkaSilenosSeer2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Varka Silenos Seer";
