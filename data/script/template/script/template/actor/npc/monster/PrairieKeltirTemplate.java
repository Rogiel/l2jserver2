 ...
 */
public class PrairieKeltirTemplate extends MonsterNPCTemplate {
	public static final int ID = 20535;

	@Inject
	protected PrairieKeltirTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Prairie Keltir";
