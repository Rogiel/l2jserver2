 ...
 */
public class ObsidianGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 20526;

	@Inject
	protected ObsidianGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
