 ...
 */
public class VarangkasDreVanul2Template extends MonsterNPCTemplate {
	public static final int ID = 22701;

	@Inject
	protected VarangkasDreVanul2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Varangka's Dre Vanul";
