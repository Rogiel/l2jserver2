 ...
 */
public class HotSpringsAtroxspawnTemplate extends MonsterNPCTemplate {
	public static final int ID = 21317;

	@Inject
	protected HotSpringsAtroxspawnTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hot Springs Atroxspawn";
