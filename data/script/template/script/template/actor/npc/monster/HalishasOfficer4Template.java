 ...
 */
public class HalishasOfficer4Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18123;

	@Inject
	protected HalishasOfficer4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
