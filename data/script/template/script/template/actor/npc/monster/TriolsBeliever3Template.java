 ...
 */
public class TriolsBeliever3Template extends MonsterNPCTemplate {
	public static final int ID = 22150;

	@Inject
	protected TriolsBeliever3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
