 ...
 */
public class ForestOfMirrorsGhost2Template extends MonsterNPCTemplate {
	public static final int ID = 20637;

	@Inject
	protected ForestOfMirrorsGhost2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
