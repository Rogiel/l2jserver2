 ...
 */
public class BrekaOrcWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20271;

	@Inject
	protected BrekaOrcWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Breka Orc Warrior";
