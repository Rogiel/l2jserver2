 ...
 */
public class MarshDrakeTemplate extends MonsterNPCTemplate {
	public static final int ID = 20680;

	@Inject
	protected MarshDrakeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Marsh Drake";
