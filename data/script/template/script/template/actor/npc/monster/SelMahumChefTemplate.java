 ...
 */
public class SelMahumChefTemplate extends MonsterNPCTemplate {
	public static final int ID = 18908;

	@Inject
	protected SelMahumChefTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sel Mahum Chef";
