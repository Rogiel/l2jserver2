 ...
 */
public class ProbeGolemProdigyIvTemplate extends MonsterNPCTemplate {
	public static final int ID = 22050;

	@Inject
	protected ProbeGolemProdigyIvTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Probe Golem Prodigy IV";
