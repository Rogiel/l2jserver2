 ...
 */
public class TownPatrolmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 22360;

	@Inject
	protected TownPatrolmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Town Patrolman";
