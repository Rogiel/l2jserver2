 ...
 */
public class BrekaOrcOverlordTemplate extends MonsterNPCTemplate {
	public static final int ID = 20270;

	@Inject
	protected BrekaOrcOverlordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Breka Orc Overlord";
