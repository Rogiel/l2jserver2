 ...
 */
public class LostIronGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 22091;

	@Inject
	protected LostIronGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lost Iron Golem";
