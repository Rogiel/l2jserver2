 ...
 */
public class Baylor2Template extends MonsterNPCTemplate {
	public static final int ID = 29103;

	@Inject
	protected Baylor2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
