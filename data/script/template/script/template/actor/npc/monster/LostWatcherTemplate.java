 ...
 */
public class LostWatcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 22081;

	@Inject
	protected LostWatcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
