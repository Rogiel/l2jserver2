 ...
 */
public class ValeMaster4Template extends MonsterNPCTemplate {
	public static final int ID = 21636;

	@Inject
	protected ValeMaster4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
