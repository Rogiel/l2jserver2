 ...
 */
public class QuarryForemanTemplate extends MonsterNPCTemplate {
	public static final int ID = 22346;

	@Inject
	protected QuarryForemanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Quarry Foreman";
