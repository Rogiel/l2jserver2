 ...
 */
public class FrekisGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 29035;

	@Inject
	protected FrekisGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Freki's Golem";
