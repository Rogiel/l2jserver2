 ...
 */
public class PageOfPilgrimTemplate extends MonsterNPCTemplate {
	public static final int ID = 21543;

	@Inject
	protected PageOfPilgrimTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Page of Pilgrim";
