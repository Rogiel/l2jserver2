 ...
 */
public class DoomTrooperTemplate extends MonsterNPCTemplate {
	public static final int ID = 21009;

	@Inject
	protected DoomTrooperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Doom Trooper";
