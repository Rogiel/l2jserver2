 ...
 */
public class KarulBugbearTemplate extends MonsterNPCTemplate {
	public static final int ID = 20600;

	@Inject
	protected KarulBugbearTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Karul Bugbear";
