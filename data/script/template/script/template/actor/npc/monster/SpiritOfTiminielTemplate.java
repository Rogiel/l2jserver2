 ...
 */
public class SpiritOfTiminielTemplate extends MonsterNPCTemplate {
	public static final int ID = 21797;

	@Inject
	protected SpiritOfTiminielTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Spirit of Timiniel";
