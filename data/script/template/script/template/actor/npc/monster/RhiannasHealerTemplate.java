 ...
 */
public class RhiannasHealerTemplate extends MonsterNPCTemplate {
	public static final int ID = 25548;

	@Inject
	protected RhiannasHealerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rhianna's Healer";
