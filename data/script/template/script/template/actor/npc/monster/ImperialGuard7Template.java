 ...
 */
public class ImperialGuard7Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18172;

	@Inject
	protected ImperialGuard7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
