 ...
 */
public class OrcMarksmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20094;

	@Inject
	protected OrcMarksmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Orc Marksman";
