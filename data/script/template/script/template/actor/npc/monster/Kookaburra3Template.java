 ...
 */
public class Kookaburra3Template extends MonsterNPCTemplate {
	public static final int ID = 21274;

	@Inject
	protected Kookaburra3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
