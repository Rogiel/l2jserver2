 ...
 */
public class SiroccosGargoyleTemplate extends MonsterNPCTemplate {
	public static final int ID = 25355;

	@Inject
	protected SiroccosGargoyleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sirocco's Gargoyle";
