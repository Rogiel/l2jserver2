 ...
 */
public class GhostOfAGeneralTemplate extends MonsterNPCTemplate {
	public static final int ID = 22010;

	@Inject
	protected GhostOfAGeneralTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ghost of a General";
		...
		attributes.magicalDefense = 91.89199;
