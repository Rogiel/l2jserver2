 ...
 */
public class PatinArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20608;

	@Inject
	protected PatinArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Patin Archer";
