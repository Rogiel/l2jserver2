 ...
 */
public class ChromaticDetaineeTemplate extends MonsterNPCTemplate {
	public static final int ID = 22279;

	@Inject
	protected ChromaticDetaineeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
