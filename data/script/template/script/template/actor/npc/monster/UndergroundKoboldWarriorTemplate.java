 ...
 */
public class UndergroundKoboldWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21135;

	@Inject
	protected UndergroundKoboldWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Underground Kobold Warrior";
