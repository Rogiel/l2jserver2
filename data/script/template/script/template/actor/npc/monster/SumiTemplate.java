 ...
 */
public class SumiTemplate extends MonsterNPCTemplate {
	public static final int ID = 27046;

	@Inject
	protected SumiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
