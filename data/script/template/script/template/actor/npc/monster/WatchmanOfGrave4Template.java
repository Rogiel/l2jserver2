 ...
 */
public class WatchmanOfGrave4Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18247;

	@Inject
	protected WatchmanOfGrave4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
