 ...
 */
public class FallenOrcTemplate extends MonsterNPCTemplate {
	public static final int ID = 21017;

	@Inject
	protected FallenOrcTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fallen Orc";
