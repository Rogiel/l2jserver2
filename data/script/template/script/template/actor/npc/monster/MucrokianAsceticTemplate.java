 ...
 */
public class MucrokianAsceticTemplate extends MonsterNPCTemplate {
	public static final int ID = 22651;

	@Inject
	protected MucrokianAsceticTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mucrokian Ascetic";
