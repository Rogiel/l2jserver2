 ...
 */
public class CletusPawnTemplate extends MonsterNPCTemplate {
	public static final int ID = 25009;

	@Inject
	protected CletusPawnTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cletu's Pawn";
		...
		this.attackRange = 40;
		this.maxHP = 10511.580575023000000;
