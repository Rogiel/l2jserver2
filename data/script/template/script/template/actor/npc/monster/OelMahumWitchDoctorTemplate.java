 ...
 */
public class OelMahumWitchDoctorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20576;

	@Inject
	protected OelMahumWitchDoctorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Oel Mahum Witch Doctor";
