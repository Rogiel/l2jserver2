 ...
 */
public class BodyHarvesterTemplate extends MonsterNPCTemplate {
	public static final int ID = 22513;

	@Inject
	protected BodyHarvesterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Body Harvester";
