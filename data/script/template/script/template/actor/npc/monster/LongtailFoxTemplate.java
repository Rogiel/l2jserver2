 ...
 */
public class LongtailFoxTemplate extends MonsterNPCTemplate {
	public static final int ID = 20337;

	@Inject
	protected LongtailFoxTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Longtail Fox";
