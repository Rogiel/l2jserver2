 ...
 */
public class VarkaSilenosShamanTemplate extends MonsterNPCTemplate {
	public static final int ID = 18640;

	@Inject
	protected VarkaSilenosShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
