 ...
 */
public class ResurrectedGuard2Template extends MonsterNPCTemplate {
	public static final int ID = 21552;

	@Inject
	protected ResurrectedGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Resurrected Guard";
