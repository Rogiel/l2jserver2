 ...
 */
public class KetraProphetTemplate extends MonsterNPCTemplate {
	public static final int ID = 21347;

	@Inject
	protected KetraProphetTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ketra Prophet";
		...
		attributes.magicalDefense = 295.99380;
