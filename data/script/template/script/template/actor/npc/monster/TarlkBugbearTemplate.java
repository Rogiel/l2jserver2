 ...
 */
public class TarlkBugbearTemplate extends MonsterNPCTemplate {
	public static final int ID = 20570;

	@Inject
	protected TarlkBugbearTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tarlk Bugbear";
