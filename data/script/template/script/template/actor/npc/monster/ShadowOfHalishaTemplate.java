 ...
 */
public class ShadowOfHalishaTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 25339;

	@Inject
	protected ShadowOfHalishaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
