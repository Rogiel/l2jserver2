 ...
 */
public class GardenGuard5Template extends MonsterNPCTemplate {
	public static final int ID = 18351;

	@Inject
	protected GardenGuard5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
