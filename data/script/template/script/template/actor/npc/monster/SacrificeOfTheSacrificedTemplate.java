 ...
 */
public class SacrificeOfTheSacrificedTemplate extends MonsterNPCTemplate {
	public static final int ID = 27171;

	@Inject
	protected SacrificeOfTheSacrificedTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sacrifice Of The Sacrificed";
