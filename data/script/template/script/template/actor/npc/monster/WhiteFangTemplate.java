 ...
 */
public class WhiteFangTemplate extends MonsterNPCTemplate {
	public static final int ID = 20522;

	@Inject
	protected WhiteFangTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
