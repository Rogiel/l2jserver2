 ...
 */
public class CryptSageTemplate extends MonsterNPCTemplate {
	public static final int ID = 21249;

	@Inject
	protected CryptSageTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Crypt Sage";
