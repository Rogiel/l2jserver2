 ...
 */
public class BansheeTemplate extends MonsterNPCTemplate {
	public static final int ID = 20852;

	@Inject
	protected BansheeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
