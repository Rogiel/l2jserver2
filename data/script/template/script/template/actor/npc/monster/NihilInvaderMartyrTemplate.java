 ...
 */
public class NihilInvaderMartyrTemplate extends MonsterNPCTemplate {
	public static final int ID = 18818;

	@Inject
	protected NihilInvaderMartyrTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nihil Invader Martyr";
