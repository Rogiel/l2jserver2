 ...
 */
public class PanathensProtectorsTemplate extends MonsterNPCTemplate {
	public static final int ID = 25194;

	@Inject
	protected PanathensProtectorsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Panathen's Protectors";
		...
		this.maxHP = 8231.476392643970000;
		...
		attributes.physicalAttack = 544.20375;
		attributes.magicalAttack = 108.26147;
