 ...
 */
public class TantaLizardmanScoutTemplate extends MonsterNPCTemplate {
	public static final int ID = 22768;

	@Inject
	protected TantaLizardmanScoutTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tanta Lizardman Scout";
