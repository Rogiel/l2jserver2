 ...
 */
public class FalibatiTemplate extends MonsterNPCTemplate {
	public static final int ID = 20673;

	@Inject
	protected FalibatiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
