 ...
 */
public class BerunsPrattlerTemplate extends MonsterNPCTemplate {
	public static final int ID = 25121;

	@Inject
	protected BerunsPrattlerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Berun's Prattler";
		...
		attributes.physicalAttack = 3227.02605;
		attributes.magicalAttack = 2881.08815;
