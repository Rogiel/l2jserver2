 ...
 */
public class ElderlyLavasaurusTemplate extends MonsterNPCTemplate {
	public static final int ID = 18802;

	@Inject
	protected ElderlyLavasaurusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Elderly Lavasaurus";
