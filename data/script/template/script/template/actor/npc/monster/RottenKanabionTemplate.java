 ...
 */
public class RottenKanabionTemplate extends MonsterNPCTemplate {
	public static final int ID = 22458;

	@Inject
	protected RottenKanabionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
