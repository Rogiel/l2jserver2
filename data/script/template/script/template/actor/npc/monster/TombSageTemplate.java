 ...
 */
public class TombSageTemplate extends MonsterNPCTemplate {
	public static final int ID = 21251;

	@Inject
	protected TombSageTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
