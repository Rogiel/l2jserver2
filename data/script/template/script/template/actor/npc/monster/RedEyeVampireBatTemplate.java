 ...
 */
public class RedEyeVampireBatTemplate extends MonsterNPCTemplate {
	public static final int ID = 20744;

	@Inject
	protected RedEyeVampireBatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Red Eye Vampire Bat";
