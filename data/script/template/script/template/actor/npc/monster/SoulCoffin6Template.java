 ...
 */
public class SoulCoffin6Template extends MonsterNPCTemplate {
	public static final int ID = 18713;

	@Inject
	protected SoulCoffin6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
