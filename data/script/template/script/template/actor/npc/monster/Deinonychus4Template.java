 ...
 */
public class Deinonychus4Template extends MonsterNPCTemplate {
	public static final int ID = 22220;

	@Inject
	protected Deinonychus4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
