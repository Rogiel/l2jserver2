 ...
 */
public class HallKeeperSuicidalSoldier3Template extends MonsterNPCTemplate {
	public static final int ID = 18341;

	@Inject
	protected HallKeeperSuicidalSoldier3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hall Keeper Suicidal Soldier";
