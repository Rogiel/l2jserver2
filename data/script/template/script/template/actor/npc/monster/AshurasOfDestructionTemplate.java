 ...
 */
public class AshurasOfDestructionTemplate extends MonsterNPCTemplate {
	public static final int ID = 21390;

	@Inject
	protected AshurasOfDestructionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
