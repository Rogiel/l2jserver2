 ...
 */
public class Tyrannosaurus3Template extends MonsterNPCTemplate {
	public static final int ID = 22217;

	@Inject
	protected Tyrannosaurus3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
