 ...
 */
public class LetoLizardmanOverlordTemplate extends MonsterNPCTemplate {
	public static final int ID = 20582;

	@Inject
	protected LetoLizardmanOverlordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Leto Lizardman Overlord";
