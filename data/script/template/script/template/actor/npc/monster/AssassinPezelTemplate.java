 ...
 */
public class AssassinPezelTemplate extends MonsterNPCTemplate {
	public static final int ID = 27273;

	@Inject
	protected AssassinPezelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Assassin Pezel";
