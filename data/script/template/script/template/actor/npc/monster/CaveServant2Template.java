 ...
 */
public class CaveServant2Template extends MonsterNPCTemplate {
	public static final int ID = 20272;

	@Inject
	protected CaveServant2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cave Servant";
