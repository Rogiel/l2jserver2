 ...
 */
public class ShardsOfOblivion2Template extends MonsterNPCTemplate {
	public static final int ID = 25459;

	@Inject
	protected ShardsOfOblivion2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shards of Oblivion";
