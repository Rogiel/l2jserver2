 ...
 */
public class KnightOfEmpireTemplate extends MonsterNPCTemplate {
	public static final int ID = 21406;

	@Inject
	protected KnightOfEmpireTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
