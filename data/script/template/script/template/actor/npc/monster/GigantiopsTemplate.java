 ...
 */
public class GigantiopsTemplate extends MonsterNPCTemplate {
	public static final int ID = 20745;

	@Inject
	protected GigantiopsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gigantiops";
