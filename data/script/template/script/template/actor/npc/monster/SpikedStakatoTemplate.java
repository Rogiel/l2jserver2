 ...
 */
public class SpikedStakatoTemplate extends MonsterNPCTemplate {
	public static final int ID = 22105;

	@Inject
	protected SpikedStakatoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
