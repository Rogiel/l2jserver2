 ...
 */
public class WanukTemplate extends MonsterNPCTemplate {
	public static final int ID = 27047;

	@Inject
	protected WanukTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
