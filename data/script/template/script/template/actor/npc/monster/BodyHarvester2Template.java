 ...
 */
public class BodyHarvester2Template extends MonsterNPCTemplate {
	public static final int ID = 22519;

	@Inject
	protected BodyHarvester2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
