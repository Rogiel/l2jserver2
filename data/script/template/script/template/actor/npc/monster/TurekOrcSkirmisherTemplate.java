 ...
 */
public class TurekOrcSkirmisherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20497;

	@Inject
	protected TurekOrcSkirmisherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Turek Orc Skirmisher";
		...
		this.experience = 2682;
		this.sp = 140;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(121);
		this.leftHand = null;
		this.enchantLevel = 0;
