 ...
 */
public class PowerOfSealIsolationTemplate extends MonsterNPCTemplate {
	public static final int ID = 27382;

	@Inject
	protected PowerOfSealIsolationTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Power of Seal Isolation";
