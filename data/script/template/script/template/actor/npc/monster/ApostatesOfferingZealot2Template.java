 ...
 */
public class ApostatesOfferingZealot2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18075;

	@Inject
	protected ApostatesOfferingZealot2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Apostate's Offering Zealot";
		...
		attributes.physicalAttack = 205.53600;
		attributes.magicalAttack = 160.40508;
		attributes.physicalDefense = 151.11934;
