 ...
 */
public class FiendTemplate extends MonsterNPCTemplate {
	public static final int ID = 25541;

	@Inject
	protected FiendTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
