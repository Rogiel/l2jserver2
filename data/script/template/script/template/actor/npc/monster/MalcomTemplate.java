 ...
 */
public class MalcomTemplate extends MonsterNPCTemplate {
	public static final int ID = 27191;

	@Inject
	protected MalcomTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
