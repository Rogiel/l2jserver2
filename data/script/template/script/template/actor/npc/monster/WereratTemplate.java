 ...
 */
public class WereratTemplate extends MonsterNPCTemplate {
	public static final int ID = 20107;

	@Inject
	protected WereratTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
