 ...
 */
public class AbyssalJewel2Template extends MonsterNPCTemplate {
	public static final int ID = 27166;

	@Inject
	protected AbyssalJewel2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Abyssal Jewel 2";
