 ...
 */
public class PassagewayMysticTemplate extends MonsterNPCTemplate {
	public static final int ID = 22372;

	@Inject
	protected PassagewayMysticTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Passageway Mystic";
