 ...
 */
public class GiganticFlyerTemplate extends MonsterNPCTemplate {
	public static final int ID = 21616;

	@Inject
	protected GiganticFlyerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gigantic Flyer";
