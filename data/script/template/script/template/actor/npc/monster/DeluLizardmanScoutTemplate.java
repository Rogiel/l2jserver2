 ...
 */
public class DeluLizardmanScoutTemplate extends MonsterNPCTemplate {
	public static final int ID = 20252;

	@Inject
	protected DeluLizardmanScoutTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Delu Lizardman Scout";
