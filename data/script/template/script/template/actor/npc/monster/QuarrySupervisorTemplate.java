 ...
 */
public class QuarrySupervisorTemplate extends MonsterNPCTemplate {
	public static final int ID = 22344;

	@Inject
	protected QuarrySupervisorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Quarry Supervisor";
