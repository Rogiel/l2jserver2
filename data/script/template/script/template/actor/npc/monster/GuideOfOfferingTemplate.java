 ...
 */
public class GuideOfOfferingTemplate extends MonsterNPCTemplate {
	public static final int ID = 21435;

	@Inject
	protected GuideOfOfferingTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guide of Offering";
