 ...
 */
public class WitchsOffering2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18080;

	@Inject
	protected WitchsOffering2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Witch's Offering";
		...
		attributes.physicalAttack = 324.35291;
