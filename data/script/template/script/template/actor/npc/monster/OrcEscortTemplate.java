 ...
 */
public class OrcEscortTemplate extends MonsterNPCTemplate {
	public static final int ID = 27042;

	@Inject
	protected OrcEscortTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Orc Escort";
