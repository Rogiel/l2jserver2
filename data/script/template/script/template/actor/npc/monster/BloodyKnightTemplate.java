 ...
 */
public class BloodyKnightTemplate extends MonsterNPCTemplate {
	public static final int ID = 20961;

	@Inject
	protected BloodyKnightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bloody Knight";
