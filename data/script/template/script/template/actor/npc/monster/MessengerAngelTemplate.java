 ...
 */
public class MessengerAngelTemplate extends MonsterNPCTemplate {
	public static final int ID = 21062;

	@Inject
	protected MessengerAngelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
