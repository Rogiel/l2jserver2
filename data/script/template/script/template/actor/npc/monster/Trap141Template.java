 ...
 */
public class Trap141Template extends MonsterNPCTemplate {
	public static final int ID = 18698;

	@Inject
	protected Trap141Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
