 ...
 */
public class WardOfDeath2Template extends MonsterNPCTemplate {
	public static final int ID = 18668;

	@Inject
	protected WardOfDeath2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ward of Death";
