 ...
 */
public class LuellOfZephyrWindsTemplate extends MonsterNPCTemplate {
	public static final int ID = 27120;

	@Inject
	protected LuellOfZephyrWindsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Luell Of Zephyr Winds";
