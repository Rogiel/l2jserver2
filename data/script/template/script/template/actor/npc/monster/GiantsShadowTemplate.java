 ...
 */
public class GiantsShadowTemplate extends MonsterNPCTemplate {
	public static final int ID = 20969;

	@Inject
	protected GiantsShadowTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Giant's Shadow";
