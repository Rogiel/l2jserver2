 ...
 */
public class TinyBabyBuffaloTemplate extends MonsterNPCTemplate {
	public static final int ID = 16019;

	@Inject
	protected TinyBabyBuffaloTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tiny Baby Buffalo";
