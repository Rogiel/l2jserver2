 ...
 */
public class CarnassiudTemplate extends MonsterNPCTemplate {
	public static final int ID = 25275;

	@Inject
	protected CarnassiudTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Carnassiud";
