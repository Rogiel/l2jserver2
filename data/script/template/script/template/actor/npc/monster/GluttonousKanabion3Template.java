 ...
 */
public class GluttonousKanabion3Template extends MonsterNPCTemplate {
	public static final int ID = 22463;

	@Inject
	protected GluttonousKanabion3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
