 ...
 */
public class KlennotTemplate extends MonsterNPCTemplate {
	public static final int ID = 22677;

	@Inject
	protected KlennotTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
