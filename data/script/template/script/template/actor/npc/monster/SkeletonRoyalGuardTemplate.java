 ...
 */
public class SkeletonRoyalGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 20169;

	@Inject
	protected SkeletonRoyalGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Skeleton Royal Guard";
