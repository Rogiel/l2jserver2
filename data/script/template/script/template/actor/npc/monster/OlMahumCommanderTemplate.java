 ...
 */
public class OlMahumCommanderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20076;

	@Inject
	protected OlMahumCommanderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ol Mahum Commander";
