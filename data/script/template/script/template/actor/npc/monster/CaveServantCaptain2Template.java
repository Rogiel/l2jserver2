 ...
 */
public class CaveServantCaptain2Template extends MonsterNPCTemplate {
	public static final int ID = 20275;

	@Inject
	protected CaveServantCaptain2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
