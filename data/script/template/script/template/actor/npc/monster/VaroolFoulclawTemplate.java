 ...
 */
public class VaroolFoulclawTemplate extends MonsterNPCTemplate {
	public static final int ID = 27020;

	@Inject
	protected VaroolFoulclawTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Varool Foulclaw";
