 ...
 */
public class GhostOfASoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 22007;

	@Inject
	protected GhostOfASoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ghost of a Soldier";
		...
		attributes.magicalDefense = 84.15638;
