 ...
 */
public class SleepingAntLarva2Template extends MonsterNPCTemplate {
	public static final int ID = 30983;

	@Inject
	protected SleepingAntLarva2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sleeping Ant Larva2";
