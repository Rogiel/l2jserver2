 ...
 */
public class ZakensArcher2Template extends MonsterNPCTemplate {
	public static final int ID = 21605;

	@Inject
	protected ZakensArcher2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
