 ...
 */
public class GuardianOfForbiddenKnowledge3Template extends MonsterNPCTemplate {
	public static final int ID = 27216;

	@Inject
	protected GuardianOfForbiddenKnowledge3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guardian of Forbidden Knowledge";
