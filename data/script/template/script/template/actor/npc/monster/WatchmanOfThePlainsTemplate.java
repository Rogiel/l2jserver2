 ...
 */
public class WatchmanOfThePlainsTemplate extends MonsterNPCTemplate {
	public static final int ID = 21102;

	@Inject
	protected WatchmanOfThePlainsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Watchman of the Plains";
