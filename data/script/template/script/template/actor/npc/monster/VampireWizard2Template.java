 ...
 */
public class VampireWizard2Template extends MonsterNPCTemplate {
	public static final int ID = 21589;

	@Inject
	protected VampireWizard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vampire Wizard";
