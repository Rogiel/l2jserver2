 ...
 */
public class ShootingStarTemplate extends MonsterNPCTemplate {
	public static final int ID = 31008;

	@Inject
	protected ShootingStarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
