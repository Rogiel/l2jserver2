 ...
 */
public class BrimstoneIrisTemplate extends MonsterNPCTemplate {
	public static final int ID = 22420;

	@Inject
	protected BrimstoneIrisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Brimstone Iris";
