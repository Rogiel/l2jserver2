 ...
 */
public class ApostatesOfferingTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18020;

	@Inject
	protected ApostatesOfferingTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
