 ...
 */
public class SkeletonAxemanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20254;

	@Inject
	protected SkeletonAxemanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Skeleton Axeman";
