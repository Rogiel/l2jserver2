 ...
 */
public class OlMahum2Template extends MonsterNPCTemplate {
	public static final int ID = 20163;

	@Inject
	protected OlMahum2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
