 ...
 */
public class OfferingOfBrandedDisciple2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18067;

	@Inject
	protected OfferingOfBrandedDisciple2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Offering of Branded Disciple";
