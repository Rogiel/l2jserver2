 ...
 */
public class CaveServantArcher2Template extends MonsterNPCTemplate {
	public static final int ID = 20273;

	@Inject
	protected CaveServantArcher2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cave Servant Archer";
