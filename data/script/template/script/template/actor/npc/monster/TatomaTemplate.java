 ...
 */
public class TatomaTemplate extends MonsterNPCTemplate {
	public static final int ID = 27134;

	@Inject
	protected TatomaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
