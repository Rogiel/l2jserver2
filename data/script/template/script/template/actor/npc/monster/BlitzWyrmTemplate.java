 ...
 */
public class BlitzWyrmTemplate extends MonsterNPCTemplate {
	public static final int ID = 27178;

	@Inject
	protected BlitzWyrmTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Blitz Wyrm";
