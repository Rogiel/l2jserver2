 ...
 */
public class LireinTemplate extends MonsterNPCTemplate {
	public static final int ID = 20036;

	@Inject
	protected LireinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
