 ...
 */
public class FanaticOfInfinityTemplate extends MonsterNPCTemplate {
	public static final int ID = 22509;

	@Inject
	protected FanaticOfInfinityTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fanatic of Infinity";
