 ...
 */
public class CarrionScarab2Template extends MonsterNPCTemplate {
	public static final int ID = 21397;

	@Inject
	protected CarrionScarab2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
