 ...
 */
public class RitualSacrifice3Template extends MonsterNPCTemplate {
	public static final int ID = 22161;

	@Inject
	protected RitualSacrifice3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
