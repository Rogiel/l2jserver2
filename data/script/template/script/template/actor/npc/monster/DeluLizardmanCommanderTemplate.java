 ...
 */
public class DeluLizardmanCommanderTemplate extends MonsterNPCTemplate {
	public static final int ID = 21107;

	@Inject
	protected DeluLizardmanCommanderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Delu Lizardman Commander";
