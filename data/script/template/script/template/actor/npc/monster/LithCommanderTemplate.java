 ...
 */
public class LithCommanderTemplate extends MonsterNPCTemplate {
	public static final int ID = 21174;

	@Inject
	protected LithCommanderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lith Commander";
