 ...
 */
public class GiantMonstereyeTemplate extends MonsterNPCTemplate {
	public static final int ID = 20556;

	@Inject
	protected GiantMonstereyeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Giant Monstereye";
