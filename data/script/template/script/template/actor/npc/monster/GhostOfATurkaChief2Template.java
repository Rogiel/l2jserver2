 ...
 */
public class GhostOfATurkaChief2Template extends MonsterNPCTemplate {
	public static final int ID = 22016;

	@Inject
	protected GhostOfATurkaChief2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ghost of a Turka Chief";
