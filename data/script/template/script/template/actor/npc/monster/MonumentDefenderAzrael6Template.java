 ...
 */
public class MonumentDefenderAzrael6Template extends MonsterNPCTemplate {
	public static final int ID = 27307;

	@Inject
	protected MonumentDefenderAzrael6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
