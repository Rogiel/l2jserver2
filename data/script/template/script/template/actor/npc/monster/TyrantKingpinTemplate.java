 ...
 */
public class TyrantKingpinTemplate extends MonsterNPCTemplate {
	public static final int ID = 20193;

	@Inject
	protected TyrantKingpinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tyrant Kingpin";
