 ...
 */
public class KashaBladeSpiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20478;

	@Inject
	protected KashaBladeSpiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kasha Blade Spider";
