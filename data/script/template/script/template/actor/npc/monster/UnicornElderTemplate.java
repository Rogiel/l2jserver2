 ...
 */
public class UnicornElderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20599;

	@Inject
	protected UnicornElderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Unicorn Elder";
