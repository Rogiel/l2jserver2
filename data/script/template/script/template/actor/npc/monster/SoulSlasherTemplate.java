 ...
 */
public class SoulSlasherTemplate extends MonsterNPCTemplate {
	public static final int ID = 25224;

	@Inject
	protected SoulSlasherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Soul Slasher";
