 ...
 */
public class Abraxion2Template extends MonsterNPCTemplate {
	public static final int ID = 21427;

	@Inject
	protected Abraxion2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
