 ...
 */
public class ScarletStakatoNoble3Template extends MonsterNPCTemplate {
	public static final int ID = 22636;

	@Inject
	protected ScarletStakatoNoble3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
