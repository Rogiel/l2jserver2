 ...
 */
public class HallatesGuardianTemplate extends MonsterNPCTemplate {
	public static final int ID = 21061;

	@Inject
	protected HallatesGuardianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hallate's Guardian";
