 ...
 */
public class CastaliaTemplate extends MonsterNPCTemplate {
	public static final int ID = 22264;

	@Inject
	protected CastaliaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
