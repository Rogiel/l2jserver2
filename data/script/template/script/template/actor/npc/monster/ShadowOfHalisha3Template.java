 ...
 */
public class ShadowOfHalisha3Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 25346;

	@Inject
	protected ShadowOfHalisha3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
