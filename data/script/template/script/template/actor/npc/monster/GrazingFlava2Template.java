 ...
 */
public class GrazingFlava2Template extends MonsterNPCTemplate {
	public static final int ID = 21363;

	@Inject
	protected GrazingFlava2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grazing Flava";
