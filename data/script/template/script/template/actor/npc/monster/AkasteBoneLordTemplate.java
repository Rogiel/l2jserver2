 ...
 */
public class AkasteBoneLordTemplate extends MonsterNPCTemplate {
	public static final int ID = 20424;

	@Inject
	protected AkasteBoneLordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Akaste Bone Lord";
