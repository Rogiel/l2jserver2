 ...
 */
public class GreatPowerfulDevice2Template extends MonsterNPCTemplate {
	public static final int ID = 22599;

	@Inject
	protected GreatPowerfulDevice2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Great Powerful Device";
