 ...
 */
public class DarkChoirArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 18337;

	@Inject
	protected DarkChoirArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Choir Archer";
