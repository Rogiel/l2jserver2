 ...
 */
public class Malcom3Template extends MonsterNPCTemplate {
	public static final int ID = 30938;

	@Inject
	protected Malcom3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Malcom3";
		this.serverSideName = false;
		this.title = "Orc Prince";
