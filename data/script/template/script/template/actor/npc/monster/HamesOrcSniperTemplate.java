 ...
 */
public class HamesOrcSniperTemplate extends MonsterNPCTemplate {
	public static final int ID = 21113;

	@Inject
	protected HamesOrcSniperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hames Orc Sniper";
