 ...
 */
public class SolinaKnightCaptainTemplate extends MonsterNPCTemplate {
	public static final int ID = 18910;

	@Inject
	protected SolinaKnightCaptainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Solina Knight Captain";
