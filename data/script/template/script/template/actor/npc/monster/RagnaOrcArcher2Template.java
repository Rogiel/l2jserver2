 ...
 */
public class RagnaOrcArcher2Template extends MonsterNPCTemplate {
	public static final int ID = 22698;

	@Inject
	protected RagnaOrcArcher2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ragna Orc Archer";
