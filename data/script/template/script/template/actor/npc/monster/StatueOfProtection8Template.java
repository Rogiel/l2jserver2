 ...
 */
public class StatueOfProtection8Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18238;

	@Inject
	protected StatueOfProtection8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
