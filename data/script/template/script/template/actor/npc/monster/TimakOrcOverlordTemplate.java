 ...
 */
public class TimakOrcOverlordTemplate extends MonsterNPCTemplate {
	public static final int ID = 20588;

	@Inject
	protected TimakOrcOverlordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Timak Orc Overlord";
