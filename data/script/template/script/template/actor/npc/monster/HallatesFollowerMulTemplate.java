 ...
 */
public class HallatesFollowerMulTemplate extends MonsterNPCTemplate {
	public static final int ID = 20980;

	@Inject
	protected HallatesFollowerMulTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hallate's Follower Mul";
