 ...
 */
public class OlMahumOfficerTakTemplate extends MonsterNPCTemplate {
	public static final int ID = 27337;

	@Inject
	protected OlMahumOfficerTakTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ol Mahum Officer Tak";
