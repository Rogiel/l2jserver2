 ...
 */
public class TerritoryCatapult4Template extends MonsterNPCTemplate {
	public static final int ID = 36502;

	@Inject
	protected TerritoryCatapult4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
