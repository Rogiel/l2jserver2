 ...
 */
public class GigantClericTemplate extends MonsterNPCTemplate {
	public static final int ID = 21191;

	@Inject
	protected GigantClericTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gigant Cleric";
