 ...
 */
public class TrollTemplate extends MonsterNPCTemplate {
	public static final int ID = 20173;

	@Inject
	protected TrollTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
