 ...
 */
public class AntelopeTemplate extends MonsterNPCTemplate {
	public static final int ID = 21278;

	@Inject
	protected AntelopeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
