 ...
 */
public class ApostatesOfferingWarrior2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18072;

	@Inject
	protected ApostatesOfferingWarrior2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Apostate's Offering Warrior";
