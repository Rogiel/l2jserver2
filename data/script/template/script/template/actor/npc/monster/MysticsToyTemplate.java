 ...
 */
public class MysticsToyTemplate extends MonsterNPCTemplate {
	public static final int ID = 22384;

	@Inject
	protected MysticsToyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mystic's Toy";
