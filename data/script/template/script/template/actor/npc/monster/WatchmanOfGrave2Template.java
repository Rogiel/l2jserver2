 ...
 */
public class WatchmanOfGrave2Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18245;

	@Inject
	protected WatchmanOfGrave2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
