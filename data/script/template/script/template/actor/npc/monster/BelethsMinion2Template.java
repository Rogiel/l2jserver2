 ...
 */
public class BelethsMinion2Template extends MonsterNPCTemplate {
	public static final int ID = 22273;

	@Inject
	protected BelethsMinion2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
