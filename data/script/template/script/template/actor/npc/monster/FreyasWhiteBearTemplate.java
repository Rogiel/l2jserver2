 ...
 */
public class FreyasWhiteBearTemplate extends MonsterNPCTemplate {
	public static final int ID = 22103;

	@Inject
	protected FreyasWhiteBearTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Freya's White Bear";
