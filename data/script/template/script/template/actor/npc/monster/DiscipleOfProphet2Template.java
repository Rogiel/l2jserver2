 ...
 */
public class DiscipleOfProphet2Template extends MonsterNPCTemplate {
	public static final int ID = 21375;

	@Inject
	protected DiscipleOfProphet2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Disciple of Prophet";
