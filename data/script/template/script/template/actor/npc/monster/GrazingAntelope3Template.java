 ...
 */
public class GrazingAntelope3Template extends MonsterNPCTemplate {
	public static final int ID = 21352;

	@Inject
	protected GrazingAntelope3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grazing Antelope";
