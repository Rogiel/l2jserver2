 ...
 */
public class TrisalimSpiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20560;

	@Inject
	protected TrisalimSpiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Trisalim Spider";
