 ...
 */
public class Malcom1Template extends MonsterNPCTemplate {
	public static final int ID = 30936;

	@Inject
	protected Malcom1Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Malcom1";
		this.serverSideName = false;
		this.title = "Frog Prince";
