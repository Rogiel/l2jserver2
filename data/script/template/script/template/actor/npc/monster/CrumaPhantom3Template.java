 ...
 */
public class CrumaPhantom3Template extends MonsterNPCTemplate {
	public static final int ID = 18552;

	@Inject
	protected CrumaPhantom3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.rightHand = itemProvider.createID(6307);
		this.leftHand = null;
		this.enchantLevel = 0;
