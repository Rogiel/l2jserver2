 ...
 */
public class TaintedOgreTemplate extends MonsterNPCTemplate {
	public static final int ID = 20837;

	@Inject
	protected TaintedOgreTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tainted Ogre";
