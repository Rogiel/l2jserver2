 ...
 */
public class ShackleTemplate extends MonsterNPCTemplate {
	public static final int ID = 20235;

	@Inject
	protected ShackleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
