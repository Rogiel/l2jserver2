 ...
 */
public class VarkaSilenosGeneral2Template extends MonsterNPCTemplate {
	public static final int ID = 21366;

	@Inject
	protected VarkaSilenosGeneral2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
