 ...
 */
public class MonumentWatcherEzekiel2Template extends MonsterNPCTemplate {
	public static final int ID = 27297;

	@Inject
	protected MonumentWatcherEzekiel2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
