 ...
 */
public class ExecutionerOfHalisha8Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18165;

	@Inject
	protected ExecutionerOfHalisha8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
