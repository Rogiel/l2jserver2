 ...
 */
public class Velociraptor4Template extends MonsterNPCTemplate {
	public static final int ID = 22218;

	@Inject
	protected Velociraptor4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
