 ...
 */
public class GhostOfPeasantTemplate extends MonsterNPCTemplate {
	public static final int ID = 25014;

	@Inject
	protected GhostOfPeasantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ghost of Peasant";
