 ...
 */
public class DragonBomber4Template extends MonsterNPCTemplate {
	public static final int ID = 29072;

	@Inject
	protected DragonBomber4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
