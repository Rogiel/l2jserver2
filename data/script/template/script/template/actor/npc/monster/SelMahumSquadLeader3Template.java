 ...
 */
public class SelMahumSquadLeader3Template extends MonsterNPCTemplate {
	public static final int ID = 22788;

	@Inject
	protected SelMahumSquadLeader3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
