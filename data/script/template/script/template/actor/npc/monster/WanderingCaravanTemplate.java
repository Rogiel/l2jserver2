 ...
 */
public class WanderingCaravanTemplate extends MonsterNPCTemplate {
	public static final int ID = 22339;

	@Inject
	protected WanderingCaravanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
