 ...
 */
public class NihilInvaderEliteSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 22729;

	@Inject
	protected NihilInvaderEliteSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nihil Invader Elite Soldier";
