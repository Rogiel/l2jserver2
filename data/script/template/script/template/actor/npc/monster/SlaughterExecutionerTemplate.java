 ...
 */
public class SlaughterExecutionerTemplate extends MonsterNPCTemplate {
	public static final int ID = 21555;

	@Inject
	protected SlaughterExecutionerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
