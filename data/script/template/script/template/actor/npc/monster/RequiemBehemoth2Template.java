 ...
 */
public class RequiemBehemoth2Template extends MonsterNPCTemplate {
	public static final int ID = 21598;

	@Inject
	protected RequiemBehemoth2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
