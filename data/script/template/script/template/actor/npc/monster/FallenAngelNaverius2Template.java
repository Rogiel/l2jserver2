 ...
 */
public class FallenAngelNaverius2Template extends MonsterNPCTemplate {
	public static final int ID = 27270;

	@Inject
	protected FallenAngelNaverius2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fallen Angel Naverius";
