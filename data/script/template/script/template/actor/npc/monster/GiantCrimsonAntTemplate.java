 ...
 */
public class GiantCrimsonAntTemplate extends MonsterNPCTemplate {
	public static final int ID = 20228;

	@Inject
	protected GiantCrimsonAntTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Giant Crimson Ant";
