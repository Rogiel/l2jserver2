 ...
 */
public class PartisanSoldier2Template extends MonsterNPCTemplate {
	public static final int ID = 35379;

	@Inject
	protected PartisanSoldier2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Partisan Soldier";
