 ...
 */
public class HekatonChiresTemplate extends MonsterNPCTemplate {
	public static final int ID = 25142;

	@Inject
	protected HekatonChiresTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
