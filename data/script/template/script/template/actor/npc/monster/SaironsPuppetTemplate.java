 ...
 */
public class SaironsPuppetTemplate extends MonsterNPCTemplate {
	public static final int ID = 20988;

	@Inject
	protected SaironsPuppetTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sairon's Puppet";
