 ...
 */
public class JudgmentHoundDogKelvasTemplate extends MonsterNPCTemplate {
	public static final int ID = 27311;

	@Inject
	protected JudgmentHoundDogKelvasTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Judgment Hound Dog Kelvas";
