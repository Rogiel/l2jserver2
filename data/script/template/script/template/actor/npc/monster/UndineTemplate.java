 ...
 */
public class UndineTemplate extends MonsterNPCTemplate {
	public static final int ID = 20110;

	@Inject
	protected UndineTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
