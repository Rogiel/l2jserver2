 ...
 */
public class PalitTemplate extends MonsterNPCTemplate {
	public static final int ID = 22675;

	@Inject
	protected PalitTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
