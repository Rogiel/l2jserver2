 ...
 */
public class RagnaOrcMage3Template extends MonsterNPCTemplate {
	public static final int ID = 22035;

	@Inject
	protected RagnaOrcMage3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
