 ...
 */
public class UophTemplate extends MonsterNPCTemplate {
	public static final int ID = 27059;

	@Inject
	protected UophTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
