 ...
 */
public class LeogulTemplate extends MonsterNPCTemplate {
	public static final int ID = 20652;

	@Inject
	protected LeogulTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
