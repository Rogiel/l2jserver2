 ...
 */
public class ArachnidPredatorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20050;

	@Inject
	protected ArachnidPredatorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Arachnid Predator";
