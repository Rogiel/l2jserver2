 ...
 */
public class TunathOrcMarksmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20361;

	@Inject
	protected TunathOrcMarksmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tunath Orc Marksman";
