 ...
 */
public class GigantAcolyteTemplate extends MonsterNPCTemplate {
	public static final int ID = 21188;

	@Inject
	protected GigantAcolyteTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gigant Acolyte";
		...
		this.experience = 2763;
		this.sp = 136;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(5793);
		this.leftHand = null;
		this.enchantLevel = 0;
