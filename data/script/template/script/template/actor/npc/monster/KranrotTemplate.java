 ...
 */
public class KranrotTemplate extends MonsterNPCTemplate {
	public static final int ID = 20650;

	@Inject
	protected KranrotTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
