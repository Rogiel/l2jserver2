 ...
 */
public class KrachaTemplate extends MonsterNPCTemplate {
	public static final int ID = 27060;

	@Inject
	protected KrachaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
