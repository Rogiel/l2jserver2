 ...
 */
public class LostYetiTemplate extends MonsterNPCTemplate {
	public static final int ID = 22097;

	@Inject
	protected LostYetiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.magicalDefense = 188.31220;
