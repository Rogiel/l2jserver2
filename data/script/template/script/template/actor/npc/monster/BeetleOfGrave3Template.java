 ...
 */
public class BeetleOfGrave3Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18143;

	@Inject
	protected BeetleOfGrave3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
