 ...
 */
public class InvaderSoldierOfNightmareTemplate extends MonsterNPCTemplate {
	public static final int ID = 22715;

	@Inject
	protected InvaderSoldierOfNightmareTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
