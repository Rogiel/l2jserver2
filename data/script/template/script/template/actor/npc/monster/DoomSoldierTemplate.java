 ...
 */
public class DoomSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 20455;

	@Inject
	protected DoomSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Doom Soldier";
