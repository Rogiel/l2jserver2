 ...
 */
public class GreaterMusverenTemplate extends MonsterNPCTemplate {
	public static final int ID = 21622;

	@Inject
	protected GreaterMusverenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Greater Musveren";
