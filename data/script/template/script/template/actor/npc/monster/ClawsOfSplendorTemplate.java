 ...
 */
public class ClawsOfSplendorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21521;

	@Inject
	protected ClawsOfSplendorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Claws of Splendor";
