 ...
 */
public class BoneSnatcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 21557;

	@Inject
	protected BoneSnatcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
