 ...
 */
public class MagmaDrake2Template extends MonsterNPCTemplate {
	public static final int ID = 21657;

	@Inject
	protected MagmaDrake2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
