 ...
 */
public class BoneCasterTemplate extends MonsterNPCTemplate {
	public static final int ID = 21580;

	@Inject
	protected BoneCasterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bone Caster";
