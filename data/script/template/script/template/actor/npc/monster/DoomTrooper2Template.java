 ...
 */
public class DoomTrooper2Template extends MonsterNPCTemplate {
	public static final int ID = 35414;

	@Inject
	protected DoomTrooper2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
