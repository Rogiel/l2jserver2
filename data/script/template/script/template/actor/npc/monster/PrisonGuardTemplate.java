 ...
 */
public class PrisonGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 18367;

	@Inject
	protected PrisonGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
