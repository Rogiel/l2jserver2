 ...
 */
public class HeadlessKnight3Template extends MonsterNPCTemplate {
	public static final int ID = 27393;

	@Inject
	protected HeadlessKnight3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
