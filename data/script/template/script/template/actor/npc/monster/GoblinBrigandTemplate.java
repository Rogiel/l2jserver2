 ...
 */
public class GoblinBrigandTemplate extends MonsterNPCTemplate {
	public static final int ID = 20322;

	@Inject
	protected GoblinBrigandTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Goblin Brigand";
