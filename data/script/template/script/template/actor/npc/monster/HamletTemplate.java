 ...
 */
public class HamletTemplate extends MonsterNPCTemplate {
	public static final int ID = 22676;

	@Inject
	protected HamletTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
