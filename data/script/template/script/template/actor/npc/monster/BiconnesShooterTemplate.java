 ...
 */
public class BiconnesShooterTemplate extends MonsterNPCTemplate {
	public static final int ID = 25058;

	@Inject
	protected BiconnesShooterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Biconne's Shooter";
		...
		this.maxHP = 12313.398435428600000;
