 ...
 */
public class HorrifyingCannonGolemIiiTemplate extends MonsterNPCTemplate {
	public static final int ID = 22061;

	@Inject
	protected HorrifyingCannonGolemIiiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Horrifying Cannon Golem III";
