 ...
 */
public class DoomServant2Template extends MonsterNPCTemplate {
	public static final int ID = 35411;

	@Inject
	protected DoomServant2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
