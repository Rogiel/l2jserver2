 ...
 */
public class SepulcherPreacherTemplate extends MonsterNPCTemplate {
	public static final int ID = 21229;

	@Inject
	protected SepulcherPreacherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sepulcher Preacher";
