 ...
 */
public class UnicornOfEvaTemplate extends MonsterNPCTemplate {
	public static final int ID = 27077;

	@Inject
	protected UnicornOfEvaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Unicorn Of Eva";
