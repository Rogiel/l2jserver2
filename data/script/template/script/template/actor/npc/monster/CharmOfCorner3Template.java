 ...
 */
public class CharmOfCorner3Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18198;

	@Inject
	protected CharmOfCorner3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
