 ...
 */
public class GuardsOfTheDawnOracle3Template extends MonsterNPCTemplate {
	public static final int ID = 27349;

	@Inject
	protected GuardsOfTheDawnOracle3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
