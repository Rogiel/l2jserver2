 ...
 */
public class GreyKeltirTemplate extends MonsterNPCTemplate {
	public static final int ID = 22230;

	@Inject
	protected GreyKeltirTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grey Keltir";
