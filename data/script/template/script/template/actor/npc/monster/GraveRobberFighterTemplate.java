 ...
 */
public class GraveRobberFighterTemplate extends MonsterNPCTemplate {
	public static final int ID = 22008;

	@Inject
	protected GraveRobberFighterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grave Robber Fighter";
