 ...
 */
public class GuardianOfObservationTemplate extends MonsterNPCTemplate {
	public static final int ID = 18354;

	@Inject
	protected GuardianOfObservationTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guardian of Observation";
