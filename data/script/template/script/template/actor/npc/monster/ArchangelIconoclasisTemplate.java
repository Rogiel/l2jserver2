 ...
 */
public class ArchangelIconoclasisTemplate extends MonsterNPCTemplate {
	public static final int ID = 27257;

	@Inject
	protected ArchangelIconoclasisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
