 ...
 */
public class Velociraptor2Template extends MonsterNPCTemplate {
	public static final int ID = 22197;

	@Inject
	protected Velociraptor2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
