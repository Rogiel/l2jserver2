 ...
 */
public class VarkasHeadGuard2Template extends MonsterNPCTemplate {
	public static final int ID = 21372;

	@Inject
	protected VarkasHeadGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
