 ...
 */
public class CharmOfCorner8Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18203;

	@Inject
	protected CharmOfCorner8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
