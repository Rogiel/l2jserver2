 ...
 */
public class DragonBomber2Template extends MonsterNPCTemplate {
	public static final int ID = 29070;

	@Inject
	protected DragonBomber2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
