 ...
 */
public class HorrifyingExcavatorGolemIiiTemplate extends MonsterNPCTemplate {
	public static final int ID = 22058;

	@Inject
	protected HorrifyingExcavatorGolemIiiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Horrifying Excavator Golem III";
