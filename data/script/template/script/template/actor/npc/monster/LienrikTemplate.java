 ...
 */
public class LienrikTemplate extends MonsterNPCTemplate {
	public static final int ID = 20786;

	@Inject
	protected LienrikTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
