 ...
 */
public class TrackerSkeletonTemplate extends MonsterNPCTemplate {
	public static final int ID = 20035;

	@Inject
	protected TrackerSkeletonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tracker Skeleton";
