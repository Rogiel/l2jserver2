 ...
 */
public class MarshZombieLordTemplate extends MonsterNPCTemplate {
	public static final int ID = 20020;

	@Inject
	protected MarshZombieLordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Marsh Zombie Lord";
