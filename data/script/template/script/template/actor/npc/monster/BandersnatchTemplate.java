 ...
 */
public class BandersnatchTemplate extends MonsterNPCTemplate {
	public static final int ID = 21282;

	@Inject
	protected BandersnatchTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
