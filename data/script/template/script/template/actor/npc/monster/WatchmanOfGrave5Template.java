 ...
 */
public class WatchmanOfGrave5Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18248;

	@Inject
	protected WatchmanOfGrave5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
