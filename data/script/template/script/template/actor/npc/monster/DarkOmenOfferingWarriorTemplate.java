 ...
 */
public class DarkOmenOfferingWarriorTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18042;

	@Inject
	protected DarkOmenOfferingWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
