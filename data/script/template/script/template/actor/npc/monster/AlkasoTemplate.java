 ...
 */
public class AlkasoTemplate extends MonsterNPCTemplate {
	public static final int ID = 18631;

	@Inject
	protected AlkasoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 22860.726260871900000;
