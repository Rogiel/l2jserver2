 ...
 */
public class SelMahumSquadLeaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 22786;

	@Inject
	protected SelMahumSquadLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
