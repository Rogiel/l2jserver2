 ...
 */
public class TerritoryCatapult9Template extends MonsterNPCTemplate {
	public static final int ID = 36507;

	@Inject
	protected TerritoryCatapult9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Territory Catapult";
