 ...
 */
public class DarkGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 20959;

	@Inject
	protected DarkGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Guard";
