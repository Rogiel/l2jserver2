 ...
 */
public class MagmaGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 21386;

	@Inject
	protected MagmaGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
