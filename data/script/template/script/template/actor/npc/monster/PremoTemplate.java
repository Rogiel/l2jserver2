 ...
 */
public class PremoTemplate extends MonsterNPCTemplate {
	public static final int ID = 20218;

	@Inject
	protected PremoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
