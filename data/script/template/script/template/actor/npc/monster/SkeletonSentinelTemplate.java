 ...
 */
public class SkeletonSentinelTemplate extends MonsterNPCTemplate {
	public static final int ID = 20516;

	@Inject
	protected SkeletonSentinelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Skeleton Sentinel";
