 ...
 */
public class VirudLizardmanShaman2Template extends MonsterNPCTemplate {
	public static final int ID = 20298;

	@Inject
	protected VirudLizardmanShaman2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Virud Lizardman Shaman";
