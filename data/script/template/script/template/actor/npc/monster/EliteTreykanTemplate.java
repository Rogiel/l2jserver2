 ...
 */
public class EliteTreykanTemplate extends MonsterNPCTemplate {
	public static final int ID = 22753;

	@Inject
	protected EliteTreykanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Elite Treykan";
