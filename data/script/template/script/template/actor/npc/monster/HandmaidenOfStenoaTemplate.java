 ...
 */
public class HandmaidenOfStenoaTemplate extends MonsterNPCTemplate {
	public static final int ID = 27109;

	@Inject
	protected HandmaidenOfStenoaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Handmaiden Of Stenoa";
