 ...
 */
public class YehanJaxsibhanTemplate extends MonsterNPCTemplate {
	public static final int ID = 25642;

	@Inject
	protected YehanJaxsibhanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Yehan Jaxsibhan";
		this.serverSideName = false;
		this.title = "Dark Guardian";
