 ...
 */
public class KertangsMessenger3Template extends MonsterNPCTemplate {
	public static final int ID = 22445;

	@Inject
	protected KertangsMessenger3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
