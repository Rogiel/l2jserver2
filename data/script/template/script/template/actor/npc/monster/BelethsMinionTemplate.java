 ...
 */
public class BelethsMinionTemplate extends MonsterNPCTemplate {
	public static final int ID = 22272;

	@Inject
	protected BelethsMinionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
