 ...
 */
public class Malcom2Template extends MonsterNPCTemplate {
	public static final int ID = 30937;

	@Inject
	protected Malcom2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Malcom2";
		this.serverSideName = false;
		this.title = "Wild Boar Prince";
