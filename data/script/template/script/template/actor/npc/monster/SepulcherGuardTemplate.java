 ...
 */
public class SepulcherGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 21228;

	@Inject
	protected SepulcherGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
