 ...
 */
public class KetraOrcIntelligenceOfficerTemplate extends MonsterNPCTemplate {
	public static final int ID = 32509;

	@Inject
	protected KetraOrcIntelligenceOfficerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ketra Orc Intelligence Officer";
