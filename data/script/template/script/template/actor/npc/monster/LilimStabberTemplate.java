 ...
 */
public class LilimStabberTemplate extends MonsterNPCTemplate {
	public static final int ID = 27356;

	@Inject
	protected LilimStabberTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lilim Stabber";
		...
		this.leftHand = itemProvider.createID(229);
		this.enchantLevel = 0;
