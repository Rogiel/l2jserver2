 ...
 */
public class WatchmanOfGrave6Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18249;

	@Inject
	protected WatchmanOfGrave6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
