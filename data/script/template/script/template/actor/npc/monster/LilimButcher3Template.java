 ...
 */
public class LilimButcher3Template extends MonsterNPCTemplate {
	public static final int ID = 27362;

	@Inject
	protected LilimButcher3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
