 ...
 */
public class MonsterEyeSearcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20265;

	@Inject
	protected MonsterEyeSearcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Monster Eye Searcher";
