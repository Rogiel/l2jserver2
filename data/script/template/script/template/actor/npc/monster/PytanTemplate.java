 ...
 */
public class PytanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20761;

	@Inject
	protected PytanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
