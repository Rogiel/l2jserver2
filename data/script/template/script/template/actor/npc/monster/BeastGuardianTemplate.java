 ...
 */
public class BeastGuardianTemplate extends MonsterNPCTemplate {
	public static final int ID = 21059;

	@Inject
	protected BeastGuardianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Beast Guardian";
