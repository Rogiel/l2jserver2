 ...
 */
public class GraveRobberMagicianTemplate extends MonsterNPCTemplate {
	public static final int ID = 22679;

	@Inject
	protected GraveRobberMagicianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grave Robber Magician";
