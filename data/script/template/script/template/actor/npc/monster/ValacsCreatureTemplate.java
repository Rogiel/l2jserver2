 ...
 */
public class ValacsCreatureTemplate extends MonsterNPCTemplate {
	public static final int ID = 21079;

	@Inject
	protected ValacsCreatureTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Valac's Creature";
