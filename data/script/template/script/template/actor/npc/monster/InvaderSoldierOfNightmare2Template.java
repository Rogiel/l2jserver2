 ...
 */
public class InvaderSoldierOfNightmare2Template extends MonsterNPCTemplate {
	public static final int ID = 22716;

	@Inject
	protected InvaderSoldierOfNightmare2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Invader Soldier of Nightmare";
