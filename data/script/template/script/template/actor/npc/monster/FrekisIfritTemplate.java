 ...
 */
public class FrekisIfritTemplate extends MonsterNPCTemplate {
	public static final int ID = 29034;

	@Inject
	protected FrekisIfritTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Freki's Ifrit";
