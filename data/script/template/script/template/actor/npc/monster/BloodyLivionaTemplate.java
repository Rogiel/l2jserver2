 ...
 */
public class BloodyLivionaTemplate extends MonsterNPCTemplate {
	public static final int ID = 21086;

	@Inject
	protected BloodyLivionaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bloody Liviona";
