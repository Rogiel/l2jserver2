 ...
 */
public class BladeStakatoDroneTemplate extends MonsterNPCTemplate {
	public static final int ID = 20797;

	@Inject
	protected BladeStakatoDroneTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Blade Stakato Drone";
