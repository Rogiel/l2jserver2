 ...
 */
public class ArchonOfHalisha6Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18217;

	@Inject
	protected ArchonOfHalisha6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
