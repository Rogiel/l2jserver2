 ...
 */
public class MutantSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 22737;

	@Inject
	protected MutantSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
