 ...
 */
public class Buffalo5Template extends MonsterNPCTemplate {
	public static final int ID = 21287;

	@Inject
	protected Buffalo5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
