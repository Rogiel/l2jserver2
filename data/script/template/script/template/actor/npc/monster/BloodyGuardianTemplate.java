 ...
 */
public class BloodyGuardianTemplate extends MonsterNPCTemplate {
	public static final int ID = 21090;

	@Inject
	protected BloodyGuardianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bloody Guardian";
