 ...
 */
public class ZakensPikeman3Template extends MonsterNPCTemplate {
	public static final int ID = 21603;

	@Inject
	protected ZakensPikeman3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Zaken's Pikeman";
