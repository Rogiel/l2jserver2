 ...
 */
public class ArcherOfDespairTemplate extends MonsterNPCTemplate {
	public static final int ID = 20812;

	@Inject
	protected ArcherOfDespairTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Archer of Despair";
