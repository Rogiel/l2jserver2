 ...
 */
public class FollowerOfThielesTemplate extends MonsterNPCTemplate {
	public static final int ID = 25012;

	@Inject
	protected FollowerOfThielesTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Follower of Thieles";
		...
		this.attackRange = 40;
		this.maxHP = 20218.525743110000000;
