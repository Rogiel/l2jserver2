 ...
 */
public class LetoShamanKetzTemplate extends MonsterNPCTemplate {
	public static final int ID = 27156;

	@Inject
	protected LetoShamanKetzTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Leto Shaman Ketz";
