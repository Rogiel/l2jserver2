 ...
 */
public class AkasteSuccubusTemplate extends MonsterNPCTemplate {
	public static final int ID = 20419;

	@Inject
	protected AkasteSuccubusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Akaste Succubus";
