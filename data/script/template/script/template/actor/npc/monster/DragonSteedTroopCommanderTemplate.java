 ...
 */
public class DragonSteedTroopCommanderTemplate extends MonsterNPCTemplate {
	public static final int ID = 22538;

	@Inject
	protected DragonSteedTroopCommanderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
