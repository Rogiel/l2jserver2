 ...
 */
public class KingBugbearTemplate extends MonsterNPCTemplate {
	public static final int ID = 20150;

	@Inject
	protected KingBugbearTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "King Bugbear";
