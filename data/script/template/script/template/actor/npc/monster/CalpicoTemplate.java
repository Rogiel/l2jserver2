 ...
 */
public class CalpicoTemplate extends MonsterNPCTemplate {
	public static final int ID = 27036;

	@Inject
	protected CalpicoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
