 ...
 */
public class DarkwingBatTemplate extends MonsterNPCTemplate {
	public static final int ID = 20316;

	@Inject
	protected DarkwingBatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Darkwing Bat";
