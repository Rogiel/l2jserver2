 ...
 */
public class HorrifyingCannonGolemVi2Template extends MonsterNPCTemplate {
	public static final int ID = 22067;

	@Inject
	protected HorrifyingCannonGolemVi2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
