 ...
 */
public class ExecutionerOfHalisha5Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18162;

	@Inject
	protected ExecutionerOfHalisha5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
