 ...
 */
public class BrekaOrcShamanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20269;

	@Inject
	protected BrekaOrcShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Breka Orc Shaman";
