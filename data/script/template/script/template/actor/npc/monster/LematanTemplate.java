 ...
 */
public class LematanTemplate extends MonsterNPCTemplate {
	public static final int ID = 18633;

	@Inject
	protected LematanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
