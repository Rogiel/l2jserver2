 ...
 */
public class CatsEyeBandit3Template extends MonsterNPCTemplate {
	public static final int ID = 27038;

	@Inject
	protected CatsEyeBandit3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cat's Eye Bandit";
