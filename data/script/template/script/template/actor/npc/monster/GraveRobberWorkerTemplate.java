 ...
 */
public class GraveRobberWorkerTemplate extends MonsterNPCTemplate {
	public static final int ID = 22680;

	@Inject
	protected GraveRobberWorkerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grave Robber Worker";
