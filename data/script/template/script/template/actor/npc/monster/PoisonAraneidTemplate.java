 ...
 */
public class PoisonAraneidTemplate extends MonsterNPCTemplate {
	public static final int ID = 20926;

	@Inject
	protected PoisonAraneidTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Poison Araneid";
