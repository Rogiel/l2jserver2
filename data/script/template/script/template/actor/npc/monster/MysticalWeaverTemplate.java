 ...
 */
public class MysticalWeaverTemplate extends MonsterNPCTemplate {
	public static final int ID = 20742;

	@Inject
	protected MysticalWeaverTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mystical Weaver";
