 ...
 */
public class BalrogOfDestructionTemplate extends MonsterNPCTemplate {
	public static final int ID = 21389;

	@Inject
	protected BalrogOfDestructionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
