 ...
 */
public class ShadyMuertosWizardTemplate extends MonsterNPCTemplate {
	public static final int ID = 22256;

	@Inject
	protected ShadyMuertosWizardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shady Muertos Wizard";
