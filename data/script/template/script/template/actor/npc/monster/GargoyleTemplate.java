 ...
 */
public class GargoyleTemplate extends MonsterNPCTemplate {
	public static final int ID = 20138;

	@Inject
	protected GargoyleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
