 ...
 */
public class DarkOmenOfferingZealotTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18045;

	@Inject
	protected DarkOmenOfferingZealotTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
