 ...
 */
public class ImperialMosaic8Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18140;

	@Inject
	protected ImperialMosaic8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
