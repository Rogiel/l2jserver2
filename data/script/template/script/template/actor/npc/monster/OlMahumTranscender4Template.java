 ...
 */
public class OlMahumTranscender4Template extends MonsterNPCTemplate {
	public static final int ID = 21264;

	@Inject
	protected OlMahumTranscender4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
