 ...
 */
public class YoungRedKeltirTemplate extends MonsterNPCTemplate {
	public static final int ID = 20530;

	@Inject
	protected YoungRedKeltirTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Young Red Keltir";
