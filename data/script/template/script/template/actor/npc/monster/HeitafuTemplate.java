 ...
 */
public class HeitafuTemplate extends MonsterNPCTemplate {
	public static final int ID = 27049;

	@Inject
	protected HeitafuTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Heitafu";
		this.serverSideName = false;
		this.title = "Orc Betrayer";
