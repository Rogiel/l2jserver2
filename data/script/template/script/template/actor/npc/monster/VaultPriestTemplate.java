 ...
 */
public class VaultPriestTemplate extends MonsterNPCTemplate {
	public static final int ID = 21219;

	@Inject
	protected VaultPriestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vault Priest";
