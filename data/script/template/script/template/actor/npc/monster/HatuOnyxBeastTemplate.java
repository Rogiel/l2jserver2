 ...
 */
public class HatuOnyxBeastTemplate extends MonsterNPCTemplate {
	public static final int ID = 20931;

	@Inject
	protected HatuOnyxBeastTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hatu Onyx Beast";
