 ...
 */
public class KnightOfDestruction2Template extends MonsterNPCTemplate {
	public static final int ID = 22641;

	@Inject
	protected KnightOfDestruction2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Knight of Destruction";
