 ...
 */
public class VampireAdeptTemplate extends MonsterNPCTemplate {
	public static final int ID = 21586;

	@Inject
	protected VampireAdeptTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
