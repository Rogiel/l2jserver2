 ...
 */
public class GrottoGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 22247;

	@Inject
	protected GrottoGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grotto Golem";
		...
		attributes.magicalDefense = 53.82228;
