 ...
 */
public class RitualSacrifice5Template extends MonsterNPCTemplate {
	public static final int ID = 22172;

	@Inject
	protected RitualSacrifice5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
