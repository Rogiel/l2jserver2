 ...
 */
public class OlMahumMarksmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20209;

	@Inject
	protected OlMahumMarksmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ol Mahum Marksman";
