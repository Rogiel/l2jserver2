 ...
 */
public class ScarletStakatoSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 21377;

	@Inject
	protected ScarletStakatoSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Scarlet Stakato Soldier";
