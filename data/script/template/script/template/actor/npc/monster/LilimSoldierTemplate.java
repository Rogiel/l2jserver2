 ...
 */
public class LilimSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 21182;

	@Inject
	protected LilimSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lilim Soldier";
