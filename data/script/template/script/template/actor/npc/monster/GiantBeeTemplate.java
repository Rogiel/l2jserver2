 ...
 */
public class GiantBeeTemplate extends MonsterNPCTemplate {
	public static final int ID = 20139;

	@Inject
	protected GiantBeeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
