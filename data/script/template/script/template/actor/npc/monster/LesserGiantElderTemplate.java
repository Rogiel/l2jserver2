 ...
 */
public class LesserGiantElderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20658;

	@Inject
	protected LesserGiantElderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
