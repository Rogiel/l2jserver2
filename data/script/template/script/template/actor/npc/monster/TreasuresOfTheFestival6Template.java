 ...
 */
public class TreasuresOfTheFestival6Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18114;

	@Inject
	protected TreasuresOfTheFestival6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 632.854963300000000;
		...
		attributes.physicalDefense = 118.46000;
		attributes.magicalDefense = 71.76565;
