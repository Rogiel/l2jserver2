 ...
 */
public class WereratLeaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20111;

	@Inject
	protected WereratLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Wererat Leader";
