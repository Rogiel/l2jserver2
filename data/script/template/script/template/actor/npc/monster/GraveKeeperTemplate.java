 ...
 */
public class GraveKeeperTemplate extends MonsterNPCTemplate {
	public static final int ID = 20368;

	@Inject
	protected GraveKeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grave Keeper";
