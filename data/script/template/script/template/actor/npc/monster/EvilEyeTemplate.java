 ...
 */
public class EvilEyeTemplate extends MonsterNPCTemplate {
	public static final int ID = 20426;

	@Inject
	protected EvilEyeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
