 ...
 */
public class ShilensEvilThoughts6Template extends MonsterNPCTemplate {
	public static final int ID = 27346;

	@Inject
	protected ShilensEvilThoughts6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
