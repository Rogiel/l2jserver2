 ...
 */
public class LilimMagus4Template extends MonsterNPCTemplate {
	public static final int ID = 27372;

	@Inject
	protected LilimMagus4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
