 ...
 */
public class PastCreatureTemplate extends MonsterNPCTemplate {
	public static final int ID = 20967;

	@Inject
	protected PastCreatureTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Past Creature";
