 ...
 */
public class BladeOfSplendorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21524;

	@Inject
	protected BladeOfSplendorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
