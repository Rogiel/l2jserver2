 ...
 */
public class EnkuOrcChampionTemplate extends MonsterNPCTemplate {
	public static final int ID = 20291;

	@Inject
	protected EnkuOrcChampionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Enku Orc Champion";
