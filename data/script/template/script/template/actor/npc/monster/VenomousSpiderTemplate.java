 ...
 */
public class VenomousSpiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20038;

	@Inject
	protected VenomousSpiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
