 ...
 */
public class PartisanCourtGuard4Template extends MonsterNPCTemplate {
	public static final int ID = 35378;

	@Inject
	protected PartisanCourtGuard4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
