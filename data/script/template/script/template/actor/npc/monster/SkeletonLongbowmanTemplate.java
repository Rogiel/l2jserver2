 ...
 */
public class SkeletonLongbowmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20542;

	@Inject
	protected SkeletonLongbowmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Skeleton Longbowman";
