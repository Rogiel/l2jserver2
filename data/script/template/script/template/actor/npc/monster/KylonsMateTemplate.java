 ...
 */
public class KylonsMateTemplate extends MonsterNPCTemplate {
	public static final int ID = 25406;

	@Inject
	protected KylonsMateTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kylon's Mate";
