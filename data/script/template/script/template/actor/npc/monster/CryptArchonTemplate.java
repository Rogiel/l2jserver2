 ...
 */
public class CryptArchonTemplate extends MonsterNPCTemplate {
	public static final int ID = 21244;

	@Inject
	protected CryptArchonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Crypt Archon";
