 ...
 */
public class BegrudgedKanabion2Template extends MonsterNPCTemplate {
	public static final int ID = 22456;

	@Inject
	protected BegrudgedKanabion2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
