 ...
 */
public class SuccubusOfSeductionTemplate extends MonsterNPCTemplate {
	public static final int ID = 27136;

	@Inject
	protected SuccubusOfSeductionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Succubus Of Seduction";
