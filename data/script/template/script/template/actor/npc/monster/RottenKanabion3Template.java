 ...
 */
public class RottenKanabion3Template extends MonsterNPCTemplate {
	public static final int ID = 22460;

	@Inject
	protected RottenKanabion3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rotten Kanabion";
		this.serverSideName = false;
		this.title = "Void";
		this.serverSideTitle = false;
		this.collisionRadius = 30.00;
		this.collisionHeight = 21.25;
		this.level = 37;
