 ...
 */
public class OrpheusResurrecterTemplate extends MonsterNPCTemplate {
	public static final int ID = 30972;

	@Inject
	protected OrpheusResurrecterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Orpheus Resurrecter";
