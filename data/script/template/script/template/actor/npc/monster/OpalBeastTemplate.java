 ...
 */
public class OpalBeastTemplate extends MonsterNPCTemplate {
	public static final int ID = 20435;

	@Inject
	protected OpalBeastTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Opal Beast";
