 ...
 */
public class CrimsonWerewolf2Template extends MonsterNPCTemplate {
	public static final int ID = 27199;

	@Inject
	protected CrimsonWerewolf2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Crimson Werewolf";
