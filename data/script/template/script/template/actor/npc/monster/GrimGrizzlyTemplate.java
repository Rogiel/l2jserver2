 ...
 */
public class GrimGrizzlyTemplate extends MonsterNPCTemplate {
	public static final int ID = 22002;

	@Inject
	protected GrimGrizzlyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grim Grizzly";
