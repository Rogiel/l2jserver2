 ...
 */
public class DeathFlyerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20840;

	@Inject
	protected DeathFlyerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
