 ...
 */
public class NaiadTemplate extends MonsterNPCTemplate {
	public static final int ID = 22262;

	@Inject
	protected NaiadTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
