 ...
 */
public class DreVanulTemplate extends MonsterNPCTemplate {
	public static final int ID = 20117;

	@Inject
	protected DreVanulTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
