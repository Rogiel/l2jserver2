 ...
 */
public class WanderingEyeTemplate extends MonsterNPCTemplate {
	public static final int ID = 20055;

	@Inject
	protected WanderingEyeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
