 ...
 */
public class ElderHomunculusTemplate extends MonsterNPCTemplate {
	public static final int ID = 21307;

	@Inject
	protected ElderHomunculusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Elder Homunculus";
