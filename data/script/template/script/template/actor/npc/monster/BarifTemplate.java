 ...
 */
public class BarifTemplate extends MonsterNPCTemplate {
	public static final int ID = 20771;

	@Inject
	protected BarifTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
