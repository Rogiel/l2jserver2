 ...
 */
public class LetoLizardmanWizardTemplate extends MonsterNPCTemplate {
	public static final int ID = 27126;

	@Inject
	protected LetoLizardmanWizardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Leto Lizardman Wizard";
