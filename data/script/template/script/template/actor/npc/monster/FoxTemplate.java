 ...
 */
public class FoxTemplate extends MonsterNPCTemplate {
	public static final int ID = 20116;

	@Inject
	protected FoxTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
