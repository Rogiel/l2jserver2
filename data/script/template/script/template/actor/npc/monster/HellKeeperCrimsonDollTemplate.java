 ...
 */
public class HellKeeperCrimsonDollTemplate extends MonsterNPCTemplate {
	public static final int ID = 21158;

	@Inject
	protected HellKeeperCrimsonDollTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hell Keeper Crimson Doll";
