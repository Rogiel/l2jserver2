 ...
 */
public class GrayWolfTemplate extends MonsterNPCTemplate {
	public static final int ID = 20525;

	@Inject
	protected GrayWolfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
