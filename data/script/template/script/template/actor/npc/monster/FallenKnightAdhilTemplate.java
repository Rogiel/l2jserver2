 ...
 */
public class FallenKnightAdhilTemplate extends MonsterNPCTemplate {
	public static final int ID = 27286;

	@Inject
	protected FallenKnightAdhilTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fallen Knight Adhil";
		...
		this.leftHand = itemProvider.createID(107);
		this.enchantLevel = 0;
