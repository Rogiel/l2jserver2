 ...
 */
public class TalakinRaiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20757;

	@Inject
	protected TalakinRaiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Talakin Raider";
