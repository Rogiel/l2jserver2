 ...
 */
public class MicroScoutGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 22810;

	@Inject
	protected MicroScoutGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Micro Scout Golem";
