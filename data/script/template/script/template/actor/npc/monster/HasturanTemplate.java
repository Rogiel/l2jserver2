 ...
 */
public class HasturanTemplate extends MonsterNPCTemplate {
	public static final int ID = 21428;

	@Inject
	protected HasturanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
