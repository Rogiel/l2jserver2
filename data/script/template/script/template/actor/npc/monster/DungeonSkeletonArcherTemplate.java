 ...
 */
public class DungeonSkeletonArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20463;

	@Inject
	protected DungeonSkeletonArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dungeon Skeleton Archer";
