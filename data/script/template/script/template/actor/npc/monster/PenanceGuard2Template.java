 ...
 */
public class PenanceGuard2Template extends MonsterNPCTemplate {
	public static final int ID = 22194;

	@Inject
	protected PenanceGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Penance Guard";
