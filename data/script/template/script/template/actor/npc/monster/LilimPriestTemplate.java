 ...
 */
public class LilimPriestTemplate extends MonsterNPCTemplate {
	public static final int ID = 21179;

	@Inject
	protected LilimPriestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lilim Priest";
