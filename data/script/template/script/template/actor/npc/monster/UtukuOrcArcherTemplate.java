 ...
 */
public class UtukuOrcArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20447;

	@Inject
	protected UtukuOrcArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Utuku Orc Archer";
