 ...
 */
public class ArchangelIconoclasis2Template extends MonsterNPCTemplate {
	public static final int ID = 27258;

	@Inject
	protected ArchangelIconoclasis2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Archangel Iconoclasis";
