 ...
 */
public class SpiritOfGildorTemplate extends MonsterNPCTemplate {
	public static final int ID = 25488;

	@Inject
	protected SpiritOfGildorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Spirit of Gildor";
