 ...
 */
public class BarrowSentinelTemplate extends MonsterNPCTemplate {
	public static final int ID = 21236;

	@Inject
	protected BarrowSentinelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Barrow Sentinel";
