 ...
 */
public class MandragoraSproutTemplate extends MonsterNPCTemplate {
	public static final int ID = 20154;

	@Inject
	protected MandragoraSproutTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
