 ...
 */
public class GuardianSpiritOfAncientHolyGroundTemplate extends MonsterNPCTemplate {
	public static final int ID = 21164;

	@Inject
	protected GuardianSpiritOfAncientHolyGroundTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guardian Spirit of Ancient Holy Ground";
