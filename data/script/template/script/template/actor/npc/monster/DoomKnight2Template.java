 ...
 */
public class DoomKnight2Template extends MonsterNPCTemplate {
	public static final int ID = 35416;

	@Inject
	protected DoomKnight2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
