 ...
 */
public class BalorOrcFighterLeaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20387;

	@Inject
	protected BalorOrcFighterLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Balor Orc Fighter Leader";
