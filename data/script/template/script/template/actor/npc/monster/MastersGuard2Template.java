 ...
 */
public class MastersGuard2Template extends MonsterNPCTemplate {
	public static final int ID = 22382;

	@Inject
	protected MastersGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Master's Guard";
