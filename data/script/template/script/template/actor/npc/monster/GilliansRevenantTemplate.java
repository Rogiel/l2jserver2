 ...
 */
public class GilliansRevenantTemplate extends MonsterNPCTemplate {
	public static final int ID = 30955;

	@Inject
	protected GilliansRevenantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gillian's Revenant";
