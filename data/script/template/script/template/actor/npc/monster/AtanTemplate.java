 ...
 */
public class AtanTemplate extends MonsterNPCTemplate {
	public static final int ID = 18628;

	@Inject
	protected AtanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
