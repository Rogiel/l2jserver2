 ...
 */
public class CorruptedGuard2Template extends MonsterNPCTemplate {
	public static final int ID = 21550;

	@Inject
	protected CorruptedGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
