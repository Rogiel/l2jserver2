 ...
 */
public class MosAideTemplate extends MonsterNPCTemplate {
	public static final int ID = 25313;

	@Inject
	protected MosAideTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
