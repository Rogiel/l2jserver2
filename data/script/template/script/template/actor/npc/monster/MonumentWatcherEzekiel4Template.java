 ...
 */
public class MonumentWatcherEzekiel4Template extends MonsterNPCTemplate {
	public static final int ID = 27299;

	@Inject
	protected MonumentWatcherEzekiel4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
