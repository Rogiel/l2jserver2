 ...
 */
public class EvilSpirit2Template extends MonsterNPCTemplate {
	public static final int ID = 29049;

	@Inject
	protected EvilSpirit2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
