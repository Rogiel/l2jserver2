 ...
 */
public class SoldierOfAncientTimesTemplate extends MonsterNPCTemplate {
	public static final int ID = 20970;

	@Inject
	protected SoldierOfAncientTimesTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Soldier of Ancient Times";
