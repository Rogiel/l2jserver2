 ...
 */
public class KadifWerewolfTemplate extends MonsterNPCTemplate {
	public static final int ID = 20206;

	@Inject
	protected KadifWerewolfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kadif Werewolf";
