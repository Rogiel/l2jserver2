 ...
 */
public class KurukaRatmanLeaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 27045;

	@Inject
	protected KurukaRatmanLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kuruka Ratman Leader";
