 ...
 */
public class BloodyKeeperTemplate extends MonsterNPCTemplate {
	public static final int ID = 21091;

	@Inject
	protected BloodyKeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bloody Keeper";
