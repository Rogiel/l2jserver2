 ...
 */
public class BizarreCocoon3Template extends MonsterNPCTemplate {
	public static final int ID = 18795;

	@Inject
	protected BizarreCocoon3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
