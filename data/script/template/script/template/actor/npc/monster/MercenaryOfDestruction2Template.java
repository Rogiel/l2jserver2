 ...
 */
public class MercenaryOfDestruction2Template extends MonsterNPCTemplate {
	public static final int ID = 22640;

	@Inject
	protected MercenaryOfDestruction2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mercenary of Destruction";
