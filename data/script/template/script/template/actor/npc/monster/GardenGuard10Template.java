 ...
 */
public class GardenGuard10Template extends MonsterNPCTemplate {
	public static final int ID = 20995;

	@Inject
	protected GardenGuard10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
