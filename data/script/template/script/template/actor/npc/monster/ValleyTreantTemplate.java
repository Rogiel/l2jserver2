 ...
 */
public class ValleyTreantTemplate extends MonsterNPCTemplate {
	public static final int ID = 20591;

	@Inject
	protected ValleyTreantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Valley Treant";
