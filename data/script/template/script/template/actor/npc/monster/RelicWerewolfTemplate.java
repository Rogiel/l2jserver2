 ...
 */
public class RelicWerewolfTemplate extends MonsterNPCTemplate {
	public static final int ID = 20450;

	@Inject
	protected RelicWerewolfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Relic Werewolf";
