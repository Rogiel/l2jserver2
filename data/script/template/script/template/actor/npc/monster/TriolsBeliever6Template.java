 ...
 */
public class TriolsBeliever6Template extends MonsterNPCTemplate {
	public static final int ID = 22164;

	@Inject
	protected TriolsBeliever6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
