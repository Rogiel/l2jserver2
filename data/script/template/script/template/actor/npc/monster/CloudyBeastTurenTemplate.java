 ...
 */
public class CloudyBeastTurenTemplate extends MonsterNPCTemplate {
	public static final int ID = 21099;

	@Inject
	protected CloudyBeastTurenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cloudy Beast Turen";
