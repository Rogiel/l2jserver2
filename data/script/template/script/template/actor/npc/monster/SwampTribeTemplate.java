 ...
 */
public class SwampTribeTemplate extends MonsterNPCTemplate {
	public static final int ID = 20991;

	@Inject
	protected SwampTribeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Swamp Tribe";
