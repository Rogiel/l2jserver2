 ...
 */
public class DarkOmenOfferingBerserker2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18094;

	@Inject
	protected DarkOmenOfferingBerserker2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Omen Offering Berserker";
