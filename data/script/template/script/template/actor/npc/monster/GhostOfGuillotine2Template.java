 ...
 */
public class GhostOfGuillotine2Template extends MonsterNPCTemplate {
	public static final int ID = 21577;

	@Inject
	protected GhostOfGuillotine2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ghost of Guillotine";
