 ...
 */
public class OlMahumGeneralTemplate extends MonsterNPCTemplate {
	public static final int ID = 20438;

	@Inject
	protected OlMahumGeneralTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ol Mahum General";
