 ...
 */
public class FrenzyStakatoSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 21518;

	@Inject
	protected FrenzyStakatoSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Frenzy Stakato Soldier";
		...
		attributes.magicalDefense = 209.54692;
