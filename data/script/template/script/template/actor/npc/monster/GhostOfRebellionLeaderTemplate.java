 ...
 */
public class GhostOfRebellionLeaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 21579;

	@Inject
	protected GhostOfRebellionLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ghost of Rebellion Leader";
