 ...
 */
public class SplinterStakatoTemplate extends MonsterNPCTemplate {
	public static final int ID = 21508;

	@Inject
	protected SplinterStakatoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Splinter Stakato";
