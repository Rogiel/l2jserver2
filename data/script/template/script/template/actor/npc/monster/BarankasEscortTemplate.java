 ...
 */
public class BarankasEscortTemplate extends MonsterNPCTemplate {
	public static final int ID = 20375;

	@Inject
	protected BarankasEscortTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Baranka's Escort";
