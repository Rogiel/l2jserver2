 ...
 */
public class HotSpringsFlavaTemplate extends MonsterNPCTemplate {
	public static final int ID = 21316;

	@Inject
	protected HotSpringsFlavaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hot Springs Flava";
