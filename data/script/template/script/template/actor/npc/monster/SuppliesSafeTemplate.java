 ...
 */
public class SuppliesSafeTemplate extends MonsterNPCTemplate {
	public static final int ID = 36591;

	@Inject
	protected SuppliesSafeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
