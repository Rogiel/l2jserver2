 ...
 */
public class PicuboTemplate extends MonsterNPCTemplate {
	public static final int ID = 27050;

	@Inject
	protected PicuboTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
