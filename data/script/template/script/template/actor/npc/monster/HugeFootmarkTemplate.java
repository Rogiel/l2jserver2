 ...
 */
public class HugeFootmarkTemplate extends MonsterNPCTemplate {
	public static final int ID = 20964;

	@Inject
	protected HugeFootmarkTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Huge Footmark";
