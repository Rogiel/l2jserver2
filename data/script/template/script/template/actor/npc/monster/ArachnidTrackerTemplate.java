 ...
 */
public class ArachnidTrackerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20043;

	@Inject
	protected ArachnidTrackerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Arachnid Tracker";
