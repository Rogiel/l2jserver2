 ...
 */
public class PirateZombieCaptain4Template extends MonsterNPCTemplate {
	public static final int ID = 29184;

	@Inject
	protected PirateZombieCaptain4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
