 ...
 */
public class TurekOrcElderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20546;

	@Inject
	protected TurekOrcElderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Turek Orc Elder";
