 ...
 */
public class HalishasOfficer6Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18125;

	@Inject
	protected HalishasOfficer6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
