 ...
 */
public class VictoryOfSplendorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21530;

	@Inject
	protected VictoryOfSplendorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Victory of Splendor";
