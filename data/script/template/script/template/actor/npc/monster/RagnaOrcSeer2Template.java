 ...
 */
public class RagnaOrcSeer2Template extends MonsterNPCTemplate {
	public static final int ID = 22697;

	@Inject
	protected RagnaOrcSeer2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ragna Orc Seer";
