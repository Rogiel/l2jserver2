 ...
 */
public class DeadmansGrudge3Template extends MonsterNPCTemplate {
	public static final int ID = 18626;

	@Inject
	protected DeadmansGrudge3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
