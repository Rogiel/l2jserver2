 ...
 */
public class GreatPowerfulDeviceTemplate extends MonsterNPCTemplate {
	public static final int ID = 18777;

	@Inject
	protected GreatPowerfulDeviceTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
