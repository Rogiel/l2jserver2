 ...
 */
public class TreasureBoxGuard2Template extends MonsterNPCTemplate {
	public static final int ID = 18695;

	@Inject
	protected TreasureBoxGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Treasure Box Guard";
