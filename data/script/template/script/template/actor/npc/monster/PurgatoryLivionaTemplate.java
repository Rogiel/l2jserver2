 ...
 */
public class PurgatoryLivionaTemplate extends MonsterNPCTemplate {
	public static final int ID = 21160;

	@Inject
	protected PurgatoryLivionaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Purgatory Liviona";
