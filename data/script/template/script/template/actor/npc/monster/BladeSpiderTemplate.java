 ...
 */
public class BladeSpiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20108;

	@Inject
	protected BladeSpiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Blade Spider";
