 ...
 */
public class SargonsSquireTemplate extends MonsterNPCTemplate {
	public static final int ID = 25562;

	@Inject
	protected SargonsSquireTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sargon's Squire";
