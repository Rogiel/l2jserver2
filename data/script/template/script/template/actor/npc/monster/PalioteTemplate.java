 ...
 */
public class PalioteTemplate extends MonsterNPCTemplate {
	public static final int ID = 20648;

	@Inject
	protected PalioteTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
