 ...
 */
public class ShadyMuertosGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 22249;

	@Inject
	protected ShadyMuertosGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shady Muertos Guard";
		...
		attributes.magicalDefense = 55.67663;
