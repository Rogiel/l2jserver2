 ...
 */
public class SealArchangel2Template extends MonsterNPCTemplate {
	public static final int ID = 21071;

	@Inject
	protected SealArchangel2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
