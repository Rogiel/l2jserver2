 ...
 */
public class PartisanArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 35374;

	@Inject
	protected PartisanArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
