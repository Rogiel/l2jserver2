 ...
 */
public class AntWarriorCaptainTemplate extends MonsterNPCTemplate {
	public static final int ID = 20088;

	@Inject
	protected AntWarriorCaptainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ant Warrior Captain";
