 ...
 */
public class SpineGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 21128;

	@Inject
	protected SpineGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Spine Golem";
