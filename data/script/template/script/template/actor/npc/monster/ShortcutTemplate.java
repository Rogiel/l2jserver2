 ...
 */
public class ShortcutTemplate extends MonsterNPCTemplate {
	public static final int ID = 31021;

	@Inject
	protected ShortcutTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
