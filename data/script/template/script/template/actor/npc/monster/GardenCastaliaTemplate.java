 ...
 */
public class GardenCastaliaTemplate extends MonsterNPCTemplate {
	public static final int ID = 22317;

	@Inject
	protected GardenCastaliaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Garden Castalia";
