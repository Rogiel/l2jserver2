 ...
 */
public class AmonsCaptainOfTheGuardsTemplate extends MonsterNPCTemplate {
	public static final int ID = 21082;

	@Inject
	protected AmonsCaptainOfTheGuardsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Amon's Captain of the Guards";
