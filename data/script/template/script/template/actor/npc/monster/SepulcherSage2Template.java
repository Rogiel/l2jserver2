 ...
 */
public class SepulcherSage2Template extends MonsterNPCTemplate {
	public static final int ID = 21227;

	@Inject
	protected SepulcherSage2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
