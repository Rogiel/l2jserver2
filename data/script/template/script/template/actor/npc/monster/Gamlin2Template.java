 ...
 */
public class Gamlin2Template extends MonsterNPCTemplate {
	public static final int ID = 22668;

	@Inject
	protected Gamlin2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
