 ...
 */
public class CaveBatTemplate extends MonsterNPCTemplate {
	public static final int ID = 20349;

	@Inject
	protected CaveBatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
