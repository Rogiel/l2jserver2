 ...
 */
public class ZakensArcher3Template extends MonsterNPCTemplate {
	public static final int ID = 21606;

	@Inject
	protected ZakensArcher3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Zaken's Archer";
