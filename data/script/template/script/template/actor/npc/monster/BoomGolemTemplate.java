 ...
 */
public class BoomGolemTemplate extends MonsterNPCTemplate {
	public static final int ID = 22812;

	@Inject
	protected BoomGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Boom Golem";
