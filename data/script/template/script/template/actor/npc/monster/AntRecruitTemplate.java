 ...
 */
public class AntRecruitTemplate extends MonsterNPCTemplate {
	public static final int ID = 20082;

	@Inject
	protected AntRecruitTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ant Recruit";
