 ...
 */
public class VukuShamanTemplate extends MonsterNPCTemplate {
	public static final int ID = 25129;

	@Inject
	protected VukuShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vuku Shaman";
		...
		this.attackRange = 40;
		this.maxHP = 6352.477410325370000;
		...
		attributes.physicalAttack = 346.92626;
		attributes.magicalAttack = 73.99717;
