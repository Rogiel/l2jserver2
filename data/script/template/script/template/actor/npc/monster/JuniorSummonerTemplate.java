 ...
 */
public class JuniorSummonerTemplate extends MonsterNPCTemplate {
	public static final int ID = 22321;

	@Inject
	protected JuniorSummonerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Junior Summoner";
