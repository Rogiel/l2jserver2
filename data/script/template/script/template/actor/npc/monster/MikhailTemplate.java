 ...
 */
public class MikhailTemplate extends MonsterNPCTemplate {
	public static final int ID = 35409;

	@Inject
	protected MikhailTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
