 ...
 */
public class SuccubusQueenTemplate extends MonsterNPCTemplate {
	public static final int ID = 27114;

	@Inject
	protected SuccubusQueenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Succubus Queen";
