 ...
 */
public class HaritLizardmanWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20643;

	@Inject
	protected HaritLizardmanWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Harit Lizardman Warrior";
