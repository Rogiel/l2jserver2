 ...
 */
public class AkasteBoneArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20423;

	@Inject
	protected AkasteBoneArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Akaste Bone Archer";
