 ...
 */
public class HalishasForeman7Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18179;

	@Inject
	protected HalishasForeman7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
