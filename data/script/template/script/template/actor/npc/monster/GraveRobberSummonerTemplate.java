 ...
 */
public class GraveRobberSummonerTemplate extends MonsterNPCTemplate {
	public static final int ID = 22678;

	@Inject
	protected GraveRobberSummonerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grave Robber Summoner";
