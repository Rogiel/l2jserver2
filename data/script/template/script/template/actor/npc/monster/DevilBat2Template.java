 ...
 */
public class DevilBat2Template extends MonsterNPCTemplate {
	public static final int ID = 21569;

	@Inject
	protected DevilBat2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
