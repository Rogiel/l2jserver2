 ...
 */
public class LesserDarkHorrorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20025;

	@Inject
	protected LesserDarkHorrorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lesser Dark Horror";
