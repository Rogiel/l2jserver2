 ...
 */
public class DarionsFaithfulServantTemplate extends MonsterNPCTemplate {
	public static final int ID = 22405;

	@Inject
	protected DarionsFaithfulServantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
