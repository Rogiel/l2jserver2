 ...
 */
public class VarkasProphetTemplate extends MonsterNPCTemplate {
	public static final int ID = 18659;

	@Inject
	protected VarkasProphetTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
