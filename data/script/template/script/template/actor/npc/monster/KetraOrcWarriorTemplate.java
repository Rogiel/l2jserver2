 ...
 */
public class KetraOrcWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21331;

	@Inject
	protected KetraOrcWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ketra Orc Warrior";
