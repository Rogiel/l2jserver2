 ...
 */
public class DragonSteedTroopCommander3Template extends MonsterNPCTemplate {
	public static final int ID = 22586;

	@Inject
	protected DragonSteedTroopCommander3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
