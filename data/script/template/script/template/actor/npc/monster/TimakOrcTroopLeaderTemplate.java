 ...
 */
public class TimakOrcTroopLeaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20767;

	@Inject
	protected TimakOrcTroopLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Timak Orc Troop Leader";
