 ...
 */
public class MusverenTemplate extends MonsterNPCTemplate {
	public static final int ID = 20842;

	@Inject
	protected MusverenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
