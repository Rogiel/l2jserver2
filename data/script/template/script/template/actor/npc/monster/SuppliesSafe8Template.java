 ...
 */
public class SuppliesSafe8Template extends MonsterNPCTemplate {
	public static final int ID = 36598;

	@Inject
	protected SuppliesSafe8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
