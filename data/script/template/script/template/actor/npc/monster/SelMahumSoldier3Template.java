 ...
 */
public class SelMahumSoldier3Template extends MonsterNPCTemplate {
	public static final int ID = 22785;

	@Inject
	protected SelMahumSoldier3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sel Mahum Soldier";
