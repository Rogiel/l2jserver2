 ...
 */
public class VeelanBugbearTemplate extends MonsterNPCTemplate {
	public static final int ID = 20401;

	@Inject
	protected VeelanBugbearTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Veelan Bugbear";
