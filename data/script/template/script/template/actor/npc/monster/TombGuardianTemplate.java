 ...
 */
public class TombGuardianTemplate extends MonsterNPCTemplate {
	public static final int ID = 21250;

	@Inject
	protected TombGuardianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tomb Guardian";
