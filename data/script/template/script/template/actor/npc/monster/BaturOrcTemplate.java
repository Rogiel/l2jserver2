 ...
 */
public class BaturOrcTemplate extends MonsterNPCTemplate {
	public static final int ID = 20255;

	@Inject
	protected BaturOrcTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
