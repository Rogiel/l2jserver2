 ...
 */
public class Trap142Template extends MonsterNPCTemplate {
	public static final int ID = 18699;

	@Inject
	protected Trap142Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
