 ...
 */
public class DismalPoleTemplate extends MonsterNPCTemplate {
	public static final int ID = 21004;

	@Inject
	protected DismalPoleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dismal Pole";
