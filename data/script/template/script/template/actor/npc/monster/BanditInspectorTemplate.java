 ...
 */
public class BanditInspectorTemplate extends MonsterNPCTemplate {
	public static final int ID = 22024;

	@Inject
	protected BanditInspectorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bandit Inspector";
