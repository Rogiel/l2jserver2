 ...
 */
public class TumranOrcBrigandTemplate extends MonsterNPCTemplate {
	public static final int ID = 27070;

	@Inject
	protected TumranOrcBrigandTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tumran Orc Brigand";
