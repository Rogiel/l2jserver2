 ...
 */
public class CharmOfCorner2Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18197;

	@Inject
	protected CharmOfCorner2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
