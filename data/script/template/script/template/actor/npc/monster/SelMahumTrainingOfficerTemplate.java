 ...
 */
public class SelMahumTrainingOfficerTemplate extends MonsterNPCTemplate {
	public static final int ID = 22776;

	@Inject
	protected SelMahumTrainingOfficerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sel Mahum Training Officer";
