 ...
 */
public class DietrichTemplate extends MonsterNPCTemplate {
	public static final int ID = 35408;

	@Inject
	protected DietrichTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
