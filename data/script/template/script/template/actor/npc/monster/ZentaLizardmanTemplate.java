 ...
 */
public class ZentaLizardmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20299;

	@Inject
	protected ZentaLizardmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Zenta Lizardman";
