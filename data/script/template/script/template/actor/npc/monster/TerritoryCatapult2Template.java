 ...
 */
public class TerritoryCatapult2Template extends MonsterNPCTemplate {
	public static final int ID = 36500;

	@Inject
	protected TerritoryCatapult2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
