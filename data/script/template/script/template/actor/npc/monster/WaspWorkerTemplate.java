 ...
 */
public class WaspWorkerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20934;

	@Inject
	protected WaspWorkerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Wasp Worker";
