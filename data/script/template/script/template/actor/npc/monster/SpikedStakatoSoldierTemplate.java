 ...
 */
public class SpikedStakatoSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 22115;

	@Inject
	protected SpikedStakatoSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
