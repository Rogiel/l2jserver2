 ...
 */
public class VarkaSilenosHunter2Template extends MonsterNPCTemplate {
	public static final int ID = 21354;

	@Inject
	protected VarkaSilenosHunter2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Varka Silenos Hunter";
		...
		this.experience = 24846;
		this.sp = 2618;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(6917);
		this.leftHand = null;
		this.enchantLevel = 0;
