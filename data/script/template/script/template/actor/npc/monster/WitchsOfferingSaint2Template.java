 ...
 */
public class WitchsOfferingSaint2Template extends FestivalMonsterNPCTemplate {
	public static final int ID = 18088;

	@Inject
	protected WitchsOfferingSaint2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Witch's Offering Saint";
