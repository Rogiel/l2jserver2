 ...
 */
public class FarmBanditTemplate extends MonsterNPCTemplate {
	public static final int ID = 18906;

	@Inject
	protected FarmBanditTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Farm Bandit";
