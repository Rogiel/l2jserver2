 ...
 */
public class TriolsPriest4Template extends MonsterNPCTemplate {
	public static final int ID = 22157;

	@Inject
	protected TriolsPriest4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
