 ...
 */
public class SukarWereratTemplate extends MonsterNPCTemplate {
	public static final int ID = 20040;

	@Inject
	protected SukarWereratTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sukar Wererat";
