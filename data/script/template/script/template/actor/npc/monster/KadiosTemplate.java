 ...
 */
public class KadiosTemplate extends MonsterNPCTemplate {
	public static final int ID = 20671;

	@Inject
	protected KadiosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
