 ...
 */
public class PrisonGuard2Template extends MonsterNPCTemplate {
	public static final int ID = 18368;

	@Inject
	protected PrisonGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Prison Guard";
