 ...
 */
public class TimakOrcArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20584;

	@Inject
	protected TimakOrcArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Timak Orc Archer";
