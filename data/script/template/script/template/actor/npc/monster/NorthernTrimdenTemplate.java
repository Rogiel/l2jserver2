 ...
 */
public class NorthernTrimdenTemplate extends MonsterNPCTemplate {
	public static final int ID = 21125;

	@Inject
	protected NorthernTrimdenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Northern Trimden";
