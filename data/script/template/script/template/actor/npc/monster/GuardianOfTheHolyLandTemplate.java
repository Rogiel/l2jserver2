 ...
 */
public class GuardianOfTheHolyLandTemplate extends MonsterNPCTemplate {
	public static final int ID = 22134;

	@Inject
	protected GuardianOfTheHolyLandTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guardian of the Holy Land";
