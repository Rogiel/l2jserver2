 ...
 */
public class GreenFungusTemplate extends MonsterNPCTemplate {
	public static final int ID = 20007;

	@Inject
	protected GreenFungusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Green Fungus";
