 ...
 */
public class TimakOrcRangerTemplate extends MonsterNPCTemplate {
	public static final int ID = 25086;

	@Inject
	protected TimakOrcRangerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.maxHP = 15819.164953264300000;
