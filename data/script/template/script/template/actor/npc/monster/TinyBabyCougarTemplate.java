 ...
 */
public class TinyBabyCougarTemplate extends MonsterNPCTemplate {
	public static final int ID = 16021;

	@Inject
	protected TinyBabyCougarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tiny Baby Cougar";
