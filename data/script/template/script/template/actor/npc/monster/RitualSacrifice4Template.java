 ...
 */
public class RitualSacrifice4Template extends MonsterNPCTemplate {
	public static final int ID = 22169;

	@Inject
	protected RitualSacrifice4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
