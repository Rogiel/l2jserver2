 ...
 */
public class TurekOrcShamanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20501;

	@Inject
	protected TurekOrcShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Turek Orc Shaman";
