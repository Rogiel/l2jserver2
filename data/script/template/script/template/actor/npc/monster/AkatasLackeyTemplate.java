 ...
 */
public class AkatasLackeyTemplate extends MonsterNPCTemplate {
	public static final int ID = 25503;

	@Inject
	protected AkatasLackeyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Akata's Lackey";
		...
		this.attackRange = 40;
		this.maxHP = 4295.202695080850000;
