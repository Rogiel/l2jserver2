 ...
 */
public class HitchkarshiekTemplate extends MonsterNPCTemplate {
	public static final int ID = 25639;

	@Inject
	protected HitchkarshiekTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hitchkarshiek";
		this.serverSideName = false;
		this.title = "Wise Retainer of Suffering";
