 ...
 */
public class HotSpringsAntelopeTemplate extends MonsterNPCTemplate {
	public static final int ID = 21318;

	@Inject
	protected HotSpringsAntelopeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hot Springs Antelope";
