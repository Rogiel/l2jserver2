 ...
 */
public class KetraOrcScoutTemplate extends MonsterNPCTemplate {
	public static final int ID = 21328;

	@Inject
	protected KetraOrcScoutTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ketra Orc Scout";
