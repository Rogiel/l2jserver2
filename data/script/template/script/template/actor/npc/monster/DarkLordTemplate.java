 ...
 */
public class DarkLordTemplate extends MonsterNPCTemplate {
	public static final int ID = 20753;

	@Inject
	protected DarkLordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
