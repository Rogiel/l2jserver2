 ...
 */
public class ValentineBlueTemplate extends MonsterNPCTemplate {
	public static final int ID = 31013;

	@Inject
	protected ValentineBlueTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Valentine Blue";
