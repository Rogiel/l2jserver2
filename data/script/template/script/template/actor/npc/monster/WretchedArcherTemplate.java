 ...
 */
public class WretchedArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 21001;

	@Inject
	protected WretchedArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Wretched Archer";
