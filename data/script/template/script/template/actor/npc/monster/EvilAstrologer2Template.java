 ...
 */
public class EvilAstrologer2Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18186;

	@Inject
	protected EvilAstrologer2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
