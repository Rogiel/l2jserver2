 ...
 */
public class MuertosArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 22236;

	@Inject
	protected MuertosArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Muertos Archer";
