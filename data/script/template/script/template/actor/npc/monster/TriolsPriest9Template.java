 ...
 */
public class TriolsPriest9Template extends MonsterNPCTemplate {
	public static final int ID = 22174;

	@Inject
	protected TriolsPriest9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
