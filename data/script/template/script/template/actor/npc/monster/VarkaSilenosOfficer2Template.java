 ...
 */
public class VarkaSilenosOfficer2Template extends MonsterNPCTemplate {
	public static final int ID = 21362;

	@Inject
	protected VarkaSilenosOfficer2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
