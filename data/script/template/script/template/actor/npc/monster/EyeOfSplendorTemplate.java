 ...
 */
public class EyeOfSplendorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21520;

	@Inject
	protected EyeOfSplendorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Eye of Splendor";
