 ...
 */
public class ObeliskTemplate extends MonsterNPCTemplate {
	public static final int ID = 18776;

	@Inject
	protected ObeliskTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
