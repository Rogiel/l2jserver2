 ...
 */
public class KetraOrcFootmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 21324;

	@Inject
	protected KetraOrcFootmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ketra Orc Footman";
