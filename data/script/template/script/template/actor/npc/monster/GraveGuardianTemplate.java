 ...
 */
public class GraveGuardianTemplate extends MonsterNPCTemplate {
	public static final int ID = 21234;

	@Inject
	protected GraveGuardianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grave Guardian";
