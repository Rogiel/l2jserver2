 ...
 */
public class MagmaGolem2Template extends MonsterNPCTemplate {
	public static final int ID = 22643;

	@Inject
	protected MagmaGolem2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
