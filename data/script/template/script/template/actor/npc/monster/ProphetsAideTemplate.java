 ...
 */
public class ProphetsAideTemplate extends MonsterNPCTemplate {
	public static final int ID = 21349;

	@Inject
	protected ProphetsAideTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Prophet's Aide";
