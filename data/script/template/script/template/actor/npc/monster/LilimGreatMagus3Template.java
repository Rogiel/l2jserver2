 ...
 */
public class LilimGreatMagus3Template extends MonsterNPCTemplate {
	public static final int ID = 27378;

	@Inject
	protected LilimGreatMagus3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
