 ...
 */
public class HexaBeetle2Template extends MonsterNPCTemplate {
	public static final int ID = 21401;

	@Inject
	protected HexaBeetle2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hexa Beetle";
