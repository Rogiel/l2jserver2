 ...
 */
public class WhiteWingCommanderTemplate extends MonsterNPCTemplate {
	public static final int ID = 27290;

	@Inject
	protected WhiteWingCommanderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "White Wing Commander";
