 ...
 */
public class MarshStakatoSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 20232;

	@Inject
	protected MarshStakatoSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Marsh Stakato Soldier";
