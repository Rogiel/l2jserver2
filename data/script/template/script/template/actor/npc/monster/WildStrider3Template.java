 ...
 */
public class WildStrider3Template extends MonsterNPCTemplate {
	public static final int ID = 22213;

	@Inject
	protected WildStrider3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
