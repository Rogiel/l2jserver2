 ...
 */
public class GraveTemplate extends MonsterNPCTemplate {
	public static final int ID = 20305;

	@Inject
	protected GraveTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
