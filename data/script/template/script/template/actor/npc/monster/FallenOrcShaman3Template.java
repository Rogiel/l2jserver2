 ...
 */
public class FallenOrcShaman3Template extends MonsterNPCTemplate {
	public static final int ID = 21259;

	@Inject
	protected FallenOrcShaman3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
