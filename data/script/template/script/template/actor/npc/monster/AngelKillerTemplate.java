 ...
 */
public class AngelKillerTemplate extends MonsterNPCTemplate {
	public static final int ID = 27184;

	@Inject
	protected AngelKillerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Angel Killer";
