 ...
 */
public class FreyasDogTemplate extends MonsterNPCTemplate {
	public static final int ID = 22104;

	@Inject
	protected FreyasDogTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Freya's Dog";
