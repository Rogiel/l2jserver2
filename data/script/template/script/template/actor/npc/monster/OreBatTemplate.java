 ...
 */
public class OreBatTemplate extends MonsterNPCTemplate {
	public static final int ID = 20541;

	@Inject
	protected OreBatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
