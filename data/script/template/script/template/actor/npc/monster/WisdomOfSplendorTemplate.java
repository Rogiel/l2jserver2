 ...
 */
public class WisdomOfSplendorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21526;

	@Inject
	protected WisdomOfSplendorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Wisdom of Splendor";
