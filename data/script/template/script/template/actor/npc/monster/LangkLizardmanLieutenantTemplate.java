 ...
 */
public class LangkLizardmanLieutenantTemplate extends MonsterNPCTemplate {
	public static final int ID = 20357;

	@Inject
	protected LangkLizardmanLieutenantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Langk Lizardman Lieutenant";
