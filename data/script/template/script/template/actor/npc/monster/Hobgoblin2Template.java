 ...
 */
public class Hobgoblin2Template extends MonsterNPCTemplate {
	public static final int ID = 21119;

	@Inject
	protected Hobgoblin2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
