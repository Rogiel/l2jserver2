 ...
 */
public class BeastSeerTemplate extends MonsterNPCTemplate {
	public static final int ID = 21060;

	@Inject
	protected BeastSeerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Beast Seer";
