 ...
 */
public class RoxideTemplate extends MonsterNPCTemplate {
	public static final int ID = 20747;

	@Inject
	protected RoxideTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
