 ...
 */
public class AngelTemplate extends MonsterNPCTemplate {
	public static final int ID = 20858;

	@Inject
	protected AngelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
