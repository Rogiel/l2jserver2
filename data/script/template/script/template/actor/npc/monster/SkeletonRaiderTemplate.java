 ...
 */
public class SkeletonRaiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20191;

	@Inject
	protected SkeletonRaiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Skeleton Raider";
