 ...
 */
public class CrokianLadWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20806;

	@Inject
	protected CrokianLadWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Crokian Lad Warrior";
