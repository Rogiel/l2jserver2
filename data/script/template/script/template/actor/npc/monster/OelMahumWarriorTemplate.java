 ...
 */
public class OelMahumWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20575;

	@Inject
	protected OelMahumWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Oel Mahum Warrior";
