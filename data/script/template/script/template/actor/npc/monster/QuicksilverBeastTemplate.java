 ...
 */
public class QuicksilverBeastTemplate extends MonsterNPCTemplate {
	public static final int ID = 20489;

	@Inject
	protected QuicksilverBeastTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Quicksilver Beast";
