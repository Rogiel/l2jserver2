 ...
 */
public class WaterDragonDetractorTemplate extends MonsterNPCTemplate {
	public static final int ID = 22270;

	@Inject
	protected WaterDragonDetractorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
