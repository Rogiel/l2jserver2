 ...
 */
public class TepraScarabTemplate extends MonsterNPCTemplate {
	public static final int ID = 21380;

	@Inject
	protected TepraScarabTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
