 ...
 */
public class HorrifyingCannonGolemIvTemplate extends MonsterNPCTemplate {
	public static final int ID = 22054;

	@Inject
	protected HorrifyingCannonGolemIvTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Horrifying Cannon Golem IV";
