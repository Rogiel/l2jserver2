 ...
 */
public class DarkCorpseTemplate extends MonsterNPCTemplate {
	public static final int ID = 22045;

	@Inject
	protected DarkCorpseTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Corpse";
