 ...
 */
public class DivineEmissaryTemplate extends MonsterNPCTemplate {
	public static final int ID = 27323;

	@Inject
	protected DivineEmissaryTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Divine Emissary";
