 ...
 */
public class GrazingKookaburraTemplate extends MonsterNPCTemplate {
	public static final int ID = 21326;

	@Inject
	protected GrazingKookaburraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grazing Kookaburra";
