 ...
 */
public class GilliensDaughterTemplate extends MonsterNPCTemplate {
	public static final int ID = 25583;

	@Inject
	protected GilliensDaughterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gillien's Daughter";
