 ...
 */
public class Malcom8Template extends MonsterNPCTemplate {
	public static final int ID = 30943;

	@Inject
	protected Malcom8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Malcom8";
		this.serverSideName = false;
		this.title = "Rabbit Prince";
