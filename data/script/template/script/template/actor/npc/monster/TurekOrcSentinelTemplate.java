 ...
 */
public class TurekOrcSentinelTemplate extends MonsterNPCTemplate {
	public static final int ID = 20500;

	@Inject
	protected TurekOrcSentinelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Turek Orc Sentinel";
