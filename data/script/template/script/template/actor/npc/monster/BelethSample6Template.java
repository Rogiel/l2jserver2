 ...
 */
public class BelethSample6Template extends MonsterNPCTemplate {
	public static final int ID = 18376;

	@Inject
	protected BelethSample6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
