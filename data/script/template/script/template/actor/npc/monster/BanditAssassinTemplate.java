 ...
 */
public class BanditAssassinTemplate extends MonsterNPCTemplate {
	public static final int ID = 22022;

	@Inject
	protected BanditAssassinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bandit Assassin";
