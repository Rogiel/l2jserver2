 ...
 */
public class NephilimPriestTemplate extends MonsterNPCTemplate {
	public static final int ID = 21197;

	@Inject
	protected NephilimPriestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nephilim Priest";
