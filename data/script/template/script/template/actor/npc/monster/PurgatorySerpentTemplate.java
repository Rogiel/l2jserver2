 ...
 */
public class PurgatorySerpentTemplate extends MonsterNPCTemplate {
	public static final int ID = 21153;

	@Inject
	protected PurgatorySerpentTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Purgatory Serpent";
