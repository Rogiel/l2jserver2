 ...
 */
public class SharuksMarksmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 25364;

	@Inject
	protected SharuksMarksmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sharuk's Marksman";
