 ...
 */
public class VampireWarlord2Template extends MonsterNPCTemplate {
	public static final int ID = 21594;

	@Inject
	protected VampireWarlord2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
