 ...
 */
public class SmallCrystalCore2Template extends MonsterNPCTemplate {
	public static final int ID = 22555;

	@Inject
	protected SmallCrystalCore2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
