 ...
 */
public class HalishasForemanTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18173;

	@Inject
	protected HalishasForemanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
