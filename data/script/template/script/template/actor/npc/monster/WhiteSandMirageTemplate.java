 ...
 */
public class WhiteSandMirageTemplate extends MonsterNPCTemplate {
	public static final int ID = 22258;

	@Inject
	protected WhiteSandMirageTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "White Sand Mirage";
