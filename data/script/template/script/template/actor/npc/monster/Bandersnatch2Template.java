 ...
 */
public class Bandersnatch2Template extends MonsterNPCTemplate {
	public static final int ID = 21283;

	@Inject
	protected Bandersnatch2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
