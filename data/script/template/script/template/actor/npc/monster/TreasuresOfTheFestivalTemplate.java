 ...
 */
public class TreasuresOfTheFestivalTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18109;

	@Inject
	protected TreasuresOfTheFestivalTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
