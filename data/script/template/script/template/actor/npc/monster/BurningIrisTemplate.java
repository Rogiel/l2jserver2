 ...
 */
public class BurningIrisTemplate extends MonsterNPCTemplate {
	public static final int ID = 22418;

	@Inject
	protected BurningIrisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Burning Iris";
