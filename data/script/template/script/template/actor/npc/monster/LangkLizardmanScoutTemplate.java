 ...
 */
public class LangkLizardmanScoutTemplate extends MonsterNPCTemplate {
	public static final int ID = 20027;

	@Inject
	protected LangkLizardmanScoutTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Langk Lizardman Scout";
