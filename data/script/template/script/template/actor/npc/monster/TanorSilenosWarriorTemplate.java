 ...
 */
public class TanorSilenosWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20939;

	@Inject
	protected TanorSilenosWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tanor Silenos Warrior";
