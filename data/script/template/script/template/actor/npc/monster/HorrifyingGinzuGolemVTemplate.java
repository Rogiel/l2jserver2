 ...
 */
public class HorrifyingGinzuGolemVTemplate extends MonsterNPCTemplate {
	public static final int ID = 22065;

	@Inject
	protected HorrifyingGinzuGolemVTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Horrifying Ginzu Golem V";
