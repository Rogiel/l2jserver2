 ...
 */
public class FerventKanabionTemplate extends MonsterNPCTemplate {
	public static final int ID = 22476;

	@Inject
	protected FerventKanabionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fervent Kanabion";
		...
		this.experience = 6733;
		this.sp = 625;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(85);
		this.leftHand = null;
		this.enchantLevel = 0;
