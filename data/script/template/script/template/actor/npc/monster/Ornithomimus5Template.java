 ...
 */
public class Ornithomimus5Template extends MonsterNPCTemplate {
	public static final int ID = 22224;

	@Inject
	protected Ornithomimus5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
