 ...
 */
public class CrokianLadTemplate extends MonsterNPCTemplate {
	public static final int ID = 20804;

	@Inject
	protected CrokianLadTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Crokian Lad";
