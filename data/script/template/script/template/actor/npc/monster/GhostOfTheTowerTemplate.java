 ...
 */
public class GhostOfTheTowerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20809;

	@Inject
	protected GhostOfTheTowerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ghost of the Tower";
