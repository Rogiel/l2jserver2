 ...
 */
public class DireWolfTemplate extends MonsterNPCTemplate {
	public static final int ID = 20205;

	@Inject
	protected DireWolfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
