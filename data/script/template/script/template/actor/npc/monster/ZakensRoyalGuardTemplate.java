 ...
 */
public class ZakensRoyalGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 20843;

	@Inject
	protected ZakensRoyalGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Zaken's Royal Guard";
