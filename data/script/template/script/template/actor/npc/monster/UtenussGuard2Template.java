 ...
 */
public class UtenussGuard2Template extends MonsterNPCTemplate {
	public static final int ID = 25686;

	@Inject
	protected UtenussGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
