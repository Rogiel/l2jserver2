 ...
 */
public class GardenGuard2Template extends MonsterNPCTemplate {
	public static final int ID = 18348;

	@Inject
	protected GardenGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
