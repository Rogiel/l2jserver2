 ...
 */
public class TasabaLizardman2Template extends MonsterNPCTemplate {
	public static final int ID = 21639;

	@Inject
	protected TasabaLizardman2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tasaba Lizardman";
