 ...
 */
public class Unicorn2Template extends MonsterNPCTemplate {
	public static final int ID = 20593;

	@Inject
	protected Unicorn2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
