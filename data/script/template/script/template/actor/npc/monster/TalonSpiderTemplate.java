 ...
 */
public class TalonSpiderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20106;

	@Inject
	protected TalonSpiderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Talon Spider";
