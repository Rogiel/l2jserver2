 ...
 */
public class RagnaOrcHealerTemplate extends MonsterNPCTemplate {
	public static final int ID = 22037;

	@Inject
	protected RagnaOrcHealerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
