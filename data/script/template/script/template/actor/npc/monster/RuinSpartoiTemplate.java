 ...
 */
public class RuinSpartoiTemplate extends MonsterNPCTemplate {
	public static final int ID = 20054;

	@Inject
	protected RuinSpartoiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ruin Spartoi";
