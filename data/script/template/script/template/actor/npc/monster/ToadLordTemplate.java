 ...
 */
public class ToadLordTemplate extends MonsterNPCTemplate {
	public static final int ID = 20231;

	@Inject
	protected ToadLordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
