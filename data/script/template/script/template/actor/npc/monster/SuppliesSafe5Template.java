 ...
 */
public class SuppliesSafe5Template extends MonsterNPCTemplate {
	public static final int ID = 36595;

	@Inject
	protected SuppliesSafe5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
