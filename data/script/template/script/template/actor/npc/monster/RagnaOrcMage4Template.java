 ...
 */
public class RagnaOrcMage4Template extends MonsterNPCTemplate {
	public static final int ID = 22036;

	@Inject
	protected RagnaOrcMage4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
