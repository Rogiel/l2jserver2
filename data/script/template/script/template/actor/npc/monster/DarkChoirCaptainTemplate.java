 ...
 */
public class DarkChoirCaptainTemplate extends MonsterNPCTemplate {
	public static final int ID = 18334;

	@Inject
	protected DarkChoirCaptainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Choir Captain";
