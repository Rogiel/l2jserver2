 ...
 */
public class MastersGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 22381;

	@Inject
	protected MastersGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
