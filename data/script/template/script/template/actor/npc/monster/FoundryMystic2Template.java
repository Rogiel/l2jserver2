 ...
 */
public class FoundryMystic2Template extends MonsterNPCTemplate {
	public static final int ID = 22387;

	@Inject
	protected FoundryMystic2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Foundry Mystic";
