 ...
 */
public class RodenpiculasGatekeeperTemplate extends MonsterNPCTemplate {
	public static final int ID = 18357;

	@Inject
	protected RodenpiculasGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rodenpicula's Gatekeeper";
