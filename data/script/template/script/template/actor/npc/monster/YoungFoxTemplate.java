 ...
 */
public class YoungFoxTemplate extends MonsterNPCTemplate {
	public static final int ID = 20091;

	@Inject
	protected YoungFoxTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
