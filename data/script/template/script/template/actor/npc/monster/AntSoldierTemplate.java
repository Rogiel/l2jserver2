 ...
 */
public class AntSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 20087;

	@Inject
	protected AntSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ant Soldier";
