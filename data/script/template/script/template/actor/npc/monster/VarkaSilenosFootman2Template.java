 ...
 */
public class VarkaSilenosFootman2Template extends MonsterNPCTemplate {
	public static final int ID = 21351;

	@Inject
	protected VarkaSilenosFootman2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
