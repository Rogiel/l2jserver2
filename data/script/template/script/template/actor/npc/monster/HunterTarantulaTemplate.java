 ...
 */
public class HunterTarantulaTemplate extends MonsterNPCTemplate {
	public static final int ID = 20403;

	@Inject
	protected HunterTarantulaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hunter Tarantula";
