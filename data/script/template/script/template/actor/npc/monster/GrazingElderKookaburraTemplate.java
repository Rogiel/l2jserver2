 ...
 */
public class GrazingElderKookaburraTemplate extends MonsterNPCTemplate {
	public static final int ID = 21341;

	@Inject
	protected GrazingElderKookaburraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grazing Elder Kookaburra";
