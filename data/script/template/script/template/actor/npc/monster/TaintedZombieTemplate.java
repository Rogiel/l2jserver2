 ...
 */
public class TaintedZombieTemplate extends MonsterNPCTemplate {
	public static final int ID = 20041;

	@Inject
	protected TaintedZombieTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tainted Zombie";
