 ...
 */
public class LostWatcher5Template extends MonsterNPCTemplate {
	public static final int ID = 22489;

	@Inject
	protected LostWatcher5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
