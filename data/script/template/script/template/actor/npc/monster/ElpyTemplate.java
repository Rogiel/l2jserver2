 ...
 */
public class ElpyTemplate extends MonsterNPCTemplate {
	public static final int ID = 20432;

	@Inject
	protected ElpyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
