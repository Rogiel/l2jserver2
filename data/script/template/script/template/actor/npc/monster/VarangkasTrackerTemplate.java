 ...
 */
public class VarangkasTrackerTemplate extends MonsterNPCTemplate {
	public static final int ID = 27043;

	@Inject
	protected VarangkasTrackerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Varangka's Tracker";
