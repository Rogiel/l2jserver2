 ...
 */
public class FlameIrisTemplate extends MonsterNPCTemplate {
	public static final int ID = 22419;

	@Inject
	protected FlameIrisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Flame Iris";
