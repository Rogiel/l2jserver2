 ...
 */
public class SebeksPriestTemplate extends MonsterNPCTemplate {
	public static final int ID = 25212;

	@Inject
	protected SebeksPriestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sebek's Priest";
		...
		this.maxHP = 7444.993738334790000;
