 ...
 */
public class ChrysocollaTemplate extends MonsterNPCTemplate {
	public static final int ID = 22265;

	@Inject
	protected ChrysocollaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
