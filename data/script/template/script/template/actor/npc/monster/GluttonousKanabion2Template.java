 ...
 */
public class GluttonousKanabion2Template extends MonsterNPCTemplate {
	public static final int ID = 22462;

	@Inject
	protected GluttonousKanabion2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
