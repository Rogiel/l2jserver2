 ...
 */
public class ArchonOfHalisha2Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18213;

	@Inject
	protected ArchonOfHalisha2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
