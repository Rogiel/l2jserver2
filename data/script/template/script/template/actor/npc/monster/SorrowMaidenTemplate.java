 ...
 */
public class SorrowMaidenTemplate extends MonsterNPCTemplate {
	public static final int ID = 20197;

	@Inject
	protected SorrowMaidenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sorrow Maiden";
