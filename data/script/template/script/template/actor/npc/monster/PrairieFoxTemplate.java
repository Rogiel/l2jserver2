 ...
 */
public class PrairieFoxTemplate extends MonsterNPCTemplate {
	public static final int ID = 20465;

	@Inject
	protected PrairieFoxTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Prairie Fox";
