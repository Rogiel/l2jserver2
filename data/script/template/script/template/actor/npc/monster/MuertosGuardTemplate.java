 ...
 */
public class MuertosGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 22239;

	@Inject
	protected MuertosGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Muertos Guard";
