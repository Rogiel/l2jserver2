 ...
 */
public class MuddyCoralTemplate extends MonsterNPCTemplate {
	public static final int ID = 22259;

	@Inject
	protected MuddyCoralTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Muddy Coral";
