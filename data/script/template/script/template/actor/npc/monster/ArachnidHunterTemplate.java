 ...
 */
public class ArachnidHunterTemplate extends MonsterNPCTemplate {
	public static final int ID = 20383;

	@Inject
	protected ArachnidHunterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Arachnid Hunter";
