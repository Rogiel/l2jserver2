 ...
 */
public class ZakensSeerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20835;

	@Inject
	protected ZakensSeerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Zaken's Seer";
