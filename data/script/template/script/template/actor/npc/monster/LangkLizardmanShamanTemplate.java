 ...
 */
public class LangkLizardmanShamanTemplate extends MonsterNPCTemplate {
	public static final int ID = 21101;

	@Inject
	protected LangkLizardmanShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Langk Lizardman Shaman";
		...
		this.experience = 1123;
		this.sp = 55;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(6);
		this.leftHand = null;
		this.enchantLevel = 0;
