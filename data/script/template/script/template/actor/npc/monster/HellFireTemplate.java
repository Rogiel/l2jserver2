 ...
 */
public class HellFireTemplate extends MonsterNPCTemplate {
	public static final int ID = 27253;

	@Inject
	protected HellFireTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
