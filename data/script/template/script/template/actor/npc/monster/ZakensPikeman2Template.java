 ...
 */
public class ZakensPikeman2Template extends MonsterNPCTemplate {
	public static final int ID = 21602;

	@Inject
	protected ZakensPikeman2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
