 ...
 */
public class ShilensEvilThoughts2Template extends MonsterNPCTemplate {
	public static final int ID = 27342;

	@Inject
	protected ShilensEvilThoughts2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
