 ...
 */
public class ShieldSkeletonTemplate extends MonsterNPCTemplate {
	public static final int ID = 20514;

	@Inject
	protected ShieldSkeletonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shield Skeleton";
