 ...
 */
public class HamrutTemplate extends MonsterNPCTemplate {
	public static final int ID = 20649;

	@Inject
	protected HamrutTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
