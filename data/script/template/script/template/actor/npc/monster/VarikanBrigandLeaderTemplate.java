 ...
 */
public class VarikanBrigandLeaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 20376;

	@Inject
	protected VarikanBrigandLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Varikan Brigand Leader";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 10.00;
		this.collisionHeight = 21.40;
		this.level = 10;
