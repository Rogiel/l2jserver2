 ...
 */
public class DeathWaveTemplate extends MonsterNPCTemplate {
	public static final int ID = 20621;

	@Inject
	protected DeathWaveTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Death Wave";
