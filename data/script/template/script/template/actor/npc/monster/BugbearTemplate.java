 ...
 */
public class BugbearTemplate extends MonsterNPCTemplate {
	public static final int ID = 20133;

	@Inject
	protected BugbearTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
