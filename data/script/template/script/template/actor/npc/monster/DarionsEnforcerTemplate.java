 ...
 */
public class DarionsEnforcerTemplate extends MonsterNPCTemplate {
	public static final int ID = 22342;

	@Inject
	protected DarionsEnforcerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Darion's Enforcer";
