 ...
 */
public class HamesOrcFootmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 21112;

	@Inject
	protected HamesOrcFootmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hames Orc Footman";
		...
		this.experience = 10470;
		this.sp = 1050;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(233);
