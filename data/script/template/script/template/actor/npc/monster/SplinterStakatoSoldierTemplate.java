 ...
 */
public class SplinterStakatoSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 21510;

	@Inject
	protected SplinterStakatoSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Splinter Stakato Soldier";
