 ...
 */
public class PowerOfSealIsolation2Template extends MonsterNPCTemplate {
	public static final int ID = 27383;

	@Inject
	protected PowerOfSealIsolation2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
