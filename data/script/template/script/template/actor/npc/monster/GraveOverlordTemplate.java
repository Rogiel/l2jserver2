 ...
 */
public class GraveOverlordTemplate extends MonsterNPCTemplate {
	public static final int ID = 21242;

	@Inject
	protected GraveOverlordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grave Overlord";
