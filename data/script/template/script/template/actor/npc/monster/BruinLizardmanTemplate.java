 ...
 */
public class BruinLizardmanTemplate extends MonsterNPCTemplate {
	public static final int ID = 27321;

	@Inject
	protected BruinLizardmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bruin Lizardman";
