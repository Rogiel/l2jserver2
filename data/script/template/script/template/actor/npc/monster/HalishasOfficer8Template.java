 ...
 */
public class HalishasOfficer8Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18127;

	@Inject
	protected HalishasOfficer8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
