 ...
 */
public class GravePriestTemplate extends MonsterNPCTemplate {
	public static final int ID = 21243;

	@Inject
	protected GravePriestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Grave Priest";
