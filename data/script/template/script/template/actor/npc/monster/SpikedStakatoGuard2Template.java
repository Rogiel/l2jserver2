 ...
 */
public class SpikedStakatoGuard2Template extends MonsterNPCTemplate {
	public static final int ID = 22619;

	@Inject
	protected SpikedStakatoGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Spiked Stakato Guard";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 16.00;
		this.collisionHeight = 22.80;
		this.level = 82;
