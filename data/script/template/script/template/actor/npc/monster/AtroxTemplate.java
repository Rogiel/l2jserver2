 ...
 */
public class AtroxTemplate extends MonsterNPCTemplate {
	public static final int ID = 21573;

	@Inject
	protected AtroxTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
