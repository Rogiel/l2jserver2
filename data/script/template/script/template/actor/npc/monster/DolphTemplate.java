 ...
 */
public class DolphTemplate extends MonsterNPCTemplate {
	public static final int ID = 22299;

	@Inject
	protected DolphTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
