 ...
 */
public class HalishasOfficerTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18120;

	@Inject
	protected HalishasOfficerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
