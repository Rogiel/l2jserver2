 ...
 */
public class AnakimsGuardianTemplate extends MonsterNPCTemplate {
	public static final int ID = 25287;

	@Inject
	protected AnakimsGuardianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
