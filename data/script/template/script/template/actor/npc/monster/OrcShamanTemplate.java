 ...
 */
public class OrcShamanTemplate extends MonsterNPCTemplate {
	public static final int ID = 20261;

	@Inject
	protected OrcShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
