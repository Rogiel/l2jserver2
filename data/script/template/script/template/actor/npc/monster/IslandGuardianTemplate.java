 ...
 */
public class IslandGuardianTemplate extends MonsterNPCTemplate {
	public static final int ID = 22257;

	@Inject
	protected IslandGuardianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Island Guardian";
