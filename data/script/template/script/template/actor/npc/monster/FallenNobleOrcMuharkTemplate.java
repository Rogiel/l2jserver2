 ...
 */
public class FallenNobleOrcMuharkTemplate extends MonsterNPCTemplate {
	public static final int ID = 27292;

	@Inject
	protected FallenNobleOrcMuharkTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fallen Noble Orc Muhark";
		...
		this.rightHand = itemProvider.createID(7834);
		this.leftHand = null;
		this.enchantLevel = 0;
