 ...
 */
public class EvilEyePatrollerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20428;

	@Inject
	protected EvilEyePatrollerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Evil Eye Patroller";
