 ...
 */
public class LetoLizardmanArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 20578;

	@Inject
	protected LetoLizardmanArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Leto Lizardman Archer";
