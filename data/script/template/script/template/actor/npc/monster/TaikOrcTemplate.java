 ...
 */
public class TaikOrcTemplate extends MonsterNPCTemplate {
	public static final int ID = 20630;

	@Inject
	protected TaikOrcTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
