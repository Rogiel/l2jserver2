 ...
 */
public class DoomGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 21007;

	@Inject
	protected DoomGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
