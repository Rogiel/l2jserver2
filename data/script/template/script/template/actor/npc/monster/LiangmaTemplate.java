 ...
 */
public class LiangmaTemplate extends MonsterNPCTemplate {
	public static final int ID = 21038;

	@Inject
	protected LiangmaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
