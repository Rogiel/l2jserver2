 ...
 */
public class LetoLizardmanAssassinTemplate extends MonsterNPCTemplate {
	public static final int ID = 27124;

	@Inject
	protected LetoLizardmanAssassinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Leto Lizardman Assassin";
