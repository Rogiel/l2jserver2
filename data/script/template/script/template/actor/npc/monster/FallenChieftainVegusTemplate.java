 ...
 */
public class FallenChieftainVegusTemplate extends MonsterNPCTemplate {
	public static final int ID = 27316;

	@Inject
	protected FallenChieftainVegusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fallen Chieftain Vegus";
