 ...
 */
public class Malcom7Template extends MonsterNPCTemplate {
	public static final int ID = 30942;

	@Inject
	protected Malcom7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Malcom7";
		this.serverSideName = false;
		this.title = "Monster Eye Prince";
