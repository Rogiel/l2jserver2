 ...
 */
public class GrazingAntelopeTemplate extends MonsterNPCTemplate {
	public static final int ID = 18637;

	@Inject
	protected GrazingAntelopeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
