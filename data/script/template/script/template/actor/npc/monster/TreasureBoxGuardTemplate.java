 ...
 */
public class TreasureBoxGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 18694;

	@Inject
	protected TreasureBoxGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
