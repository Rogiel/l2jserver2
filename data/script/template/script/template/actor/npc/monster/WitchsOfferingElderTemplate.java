 ...
 */
public class WitchsOfferingElderTemplate extends FestivalMonsterNPCTemplate {
	public static final int ID = 18029;

	@Inject
	protected WitchsOfferingElderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
