 ...
 */
public class WitchOfDust2Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18192;

	@Inject
	protected WitchOfDust2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
