 ...
 */
public class BizarreCocoon5Template extends MonsterNPCTemplate {
	public static final int ID = 18797;

	@Inject
	protected BizarreCocoon5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
