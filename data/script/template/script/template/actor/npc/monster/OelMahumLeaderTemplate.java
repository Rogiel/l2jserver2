 ...
 */
public class OelMahumLeaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 35430;

	@Inject
	protected OelMahumLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Oel Mahum Leader";
