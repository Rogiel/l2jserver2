 ...
 */
public class SolinaBrotherTemplate extends MonsterNPCTemplate {
	public static final int ID = 22124;

	@Inject
	protected SolinaBrotherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Solina Brother";
