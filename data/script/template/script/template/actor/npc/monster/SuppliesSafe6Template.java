 ...
 */
public class SuppliesSafe6Template extends MonsterNPCTemplate {
	public static final int ID = 36596;

	@Inject
	protected SuppliesSafe6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Supplies Safe";
