 ...
 */
public class LilimSlaveKnight3Template extends MonsterNPCTemplate {
	public static final int ID = 27373;

	@Inject
	protected LilimSlaveKnight3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
