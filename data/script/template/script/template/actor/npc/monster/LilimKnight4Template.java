 ...
 */
public class LilimKnight4Template extends MonsterNPCTemplate {
	public static final int ID = 27367;

	@Inject
	protected LilimKnight4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
