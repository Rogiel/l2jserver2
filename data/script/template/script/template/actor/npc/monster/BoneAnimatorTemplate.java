 ...
 */
public class BoneAnimatorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21565;

	@Inject
	protected BoneAnimatorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bone Animator";
