 ...
 */
public class GreedyGeistTemplate extends MonsterNPCTemplate {
	public static final int ID = 21138;

	@Inject
	protected GreedyGeistTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Greedy Geist";
