 ...
 */
public class NerkasTemplate extends MonsterNPCTemplate {
	public static final int ID = 27016;

	@Inject
	protected NerkasTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
