 ...
 */
public class RodoKnightTemplate extends MonsterNPCTemplate {
	public static final int ID = 22280;

	@Inject
	protected RodoKnightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rodo Knight";
