 ...
 */
public class GluttonousKanabionTemplate extends MonsterNPCTemplate {
	public static final int ID = 22461;

	@Inject
	protected GluttonousKanabionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gluttonous Kanabion";
