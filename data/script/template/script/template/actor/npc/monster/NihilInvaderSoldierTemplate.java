 ...
 */
public class NihilInvaderSoldierTemplate extends MonsterNPCTemplate {
	public static final int ID = 22726;

	@Inject
	protected NihilInvaderSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
