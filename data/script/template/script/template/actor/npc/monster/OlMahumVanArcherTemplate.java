 ...
 */
public class OlMahumVanArcherTemplate extends MonsterNPCTemplate {
	public static final int ID = 21013;

	@Inject
	protected OlMahumVanArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ol Mahum Van Archer";
