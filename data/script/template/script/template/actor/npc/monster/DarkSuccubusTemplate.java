 ...
 */
public class DarkSuccubusTemplate extends MonsterNPCTemplate {
	public static final int ID = 20776;

	@Inject
	protected DarkSuccubusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Succubus";
