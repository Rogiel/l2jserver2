 ...
 */
public class MonumentDefenderAzrael5Template extends MonsterNPCTemplate {
	public static final int ID = 27306;

	@Inject
	protected MonumentDefenderAzrael5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
