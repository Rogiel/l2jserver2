 ...
 */
public class DoomGuard2Template extends MonsterNPCTemplate {
	public static final int ID = 35412;

	@Inject
	protected DoomGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
