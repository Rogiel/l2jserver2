 ...
 */
public class MonasticCrusaderTemplate extends MonsterNPCTemplate {
	public static final int ID = 22123;

	@Inject
	protected MonasticCrusaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Monastic Crusader";
