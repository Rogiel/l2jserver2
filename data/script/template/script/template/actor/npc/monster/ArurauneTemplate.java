 ...
 */
public class ArurauneTemplate extends MonsterNPCTemplate {
	public static final int ID = 27128;

	@Inject
	protected ArurauneTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
