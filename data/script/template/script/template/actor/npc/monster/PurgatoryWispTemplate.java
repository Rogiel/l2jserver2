 ...
 */
public class PurgatoryWispTemplate extends MonsterNPCTemplate {
	public static final int ID = 21152;

	@Inject
	protected PurgatoryWispTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Purgatory Wisp";
