 ...
 */
public class SavageKanabion3Template extends MonsterNPCTemplate {
	public static final int ID = 22469;

	@Inject
	protected SavageKanabion3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Savage Kanabion";
		...
		attributes.magicalDefense = 146.52580;
