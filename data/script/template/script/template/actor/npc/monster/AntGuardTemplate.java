 ...
 */
public class AntGuardTemplate extends MonsterNPCTemplate {
	public static final int ID = 20086;

	@Inject
	protected AntGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
