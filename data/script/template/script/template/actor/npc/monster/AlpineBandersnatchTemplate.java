 ...
 */
public class AlpineBandersnatchTemplate extends MonsterNPCTemplate {
	public static final int ID = 21445;

	@Inject
	protected AlpineBandersnatchTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Alpine Bandersnatch";
