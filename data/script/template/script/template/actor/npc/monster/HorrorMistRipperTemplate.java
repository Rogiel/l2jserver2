 ...
 */
public class HorrorMistRipperTemplate extends MonsterNPCTemplate {
	public static final int ID = 20227;

	@Inject
	protected HorrorMistRipperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Horror Mist Ripper";
