 ...
 */
public class DoomWarrior2Template extends MonsterNPCTemplate {
	public static final int ID = 35415;

	@Inject
	protected DoomWarrior2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
