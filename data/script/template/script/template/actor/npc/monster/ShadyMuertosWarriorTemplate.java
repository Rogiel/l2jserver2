 ...
 */
public class ShadyMuertosWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 22253;

	@Inject
	protected ShadyMuertosWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shady Muertos Warrior";
