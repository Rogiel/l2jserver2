 ...
 */
public class LightBringerTemplate extends MonsterNPCTemplate {
	public static final int ID = 20848;

	@Inject
	protected LightBringerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Light Bringer";
