 ...
 */
public class SwampWarriorTemplate extends MonsterNPCTemplate {
	public static final int ID = 20993;

	@Inject
	protected SwampWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Swamp Warrior";
