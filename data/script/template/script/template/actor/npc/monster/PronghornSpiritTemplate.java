 ...
 */
public class PronghornSpiritTemplate extends MonsterNPCTemplate {
	public static final int ID = 22087;

	@Inject
	protected PronghornSpiritTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Pronghorn Spirit";
