 ...
 */
public class NakondasSlaveTemplate extends MonsterNPCTemplate {
	public static final int ID = 25416;

	@Inject
	protected NakondasSlaveTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nakondas' Slave";
