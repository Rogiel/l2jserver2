 ...
 */
public class RedKeltirTemplate extends MonsterNPCTemplate {
	public static final int ID = 20534;

	@Inject
	protected RedKeltirTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Red Keltir";
