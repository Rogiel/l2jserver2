 ...
 */
public class SkullCollectorTemplate extends MonsterNPCTemplate {
	public static final int ID = 21564;

	@Inject
	protected SkullCollectorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Skull Collector";
