 ...
 */
public class NellisFollowerTemplate extends MonsterNPCTemplate {
	public static final int ID = 25505;

	@Inject
	protected NellisFollowerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nellis' Follower";
