 ...
 */
public class RagnaOrcSorcerer4Template extends MonsterNPCTemplate {
	public static final int ID = 22044;

	@Inject
	protected RagnaOrcSorcerer4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
