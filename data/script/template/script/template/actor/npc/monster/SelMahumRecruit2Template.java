 ...
 */
public class SelMahumRecruit2Template extends MonsterNPCTemplate {
	public static final int ID = 22782;

	@Inject
	protected SelMahumRecruit2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sel Mahum Recruit";
