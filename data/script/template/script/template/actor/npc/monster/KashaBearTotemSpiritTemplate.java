 ...
 */
public class KashaBearTotemSpiritTemplate extends MonsterNPCTemplate {
	public static final int ID = 27044;

	@Inject
	protected KashaBearTotemSpiritTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kasha Bear Totem Spirit";
