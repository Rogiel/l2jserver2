 ...
 */
public class BasiliskTemplate extends MonsterNPCTemplate {
	public static final int ID = 20072;

	@Inject
	protected BasiliskTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
