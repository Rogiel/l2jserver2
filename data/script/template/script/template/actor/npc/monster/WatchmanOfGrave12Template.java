 ...
 */
public class WatchmanOfGrave12Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 18255;

	@Inject
	protected WatchmanOfGrave12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Watchman of Grave";
