 ...
 */
public class EmeraldBoarTemplate extends MonsterNPCTemplate {
	public static final int ID = 22288;

	@Inject
	protected EmeraldBoarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Emerald Boar";
