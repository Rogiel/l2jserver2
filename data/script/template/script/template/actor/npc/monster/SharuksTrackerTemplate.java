 ...
 */
public class SharuksTrackerTemplate extends MonsterNPCTemplate {
	public static final int ID = 25363;

	@Inject
	protected SharuksTrackerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sharuk's Tracker";
		...
		this.attackRange = 40;
		this.maxHP = 3123.592393977280000;
		...
		attributes.physicalAttack = 115.59311;
		attributes.magicalAttack = 14.54447;
