 ...
 */
public class Shade2Template extends MonsterNPCTemplate {
	public static final int ID = 22269;

	@Inject
	protected Shade2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
