 ...
 */
public class BoundElfPanaceaTemplate extends MonsterNPCTemplate {
	public static final int ID = 27287;

	@Inject
	protected BoundElfPanaceaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bound Elf Panacea";
