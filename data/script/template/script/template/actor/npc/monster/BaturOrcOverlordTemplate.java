 ...
 */
public class BaturOrcOverlordTemplate extends MonsterNPCTemplate {
	public static final int ID = 20259;

	@Inject
	protected BaturOrcOverlordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Batur Orc Overlord";
