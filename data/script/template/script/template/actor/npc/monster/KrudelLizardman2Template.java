 ...
 */
public class KrudelLizardman2Template extends MonsterNPCTemplate {
	public static final int ID = 27200;

	@Inject
	protected KrudelLizardman2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Krudel Lizardman";
