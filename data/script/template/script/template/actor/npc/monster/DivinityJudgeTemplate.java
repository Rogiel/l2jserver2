 ...
 */
public class DivinityJudgeTemplate extends MonsterNPCTemplate {
	public static final int ID = 22794;

	@Inject
	protected DivinityJudgeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Divinity Judge";
