 ...
 */
public class TimoraOrcTemplate extends MonsterNPCTemplate {
	public static final int ID = 27320;

	@Inject
	protected TimoraOrcTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Timora Orc";
