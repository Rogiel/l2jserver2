 ...
 */
public class DelusionManager26Template extends NPCTemplate {
	public static final int ID = 32689;

	@Inject
	protected DelusionManager26Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
