 ...
 */
public class SteveShyagelTemplate extends NPCTemplate {
	public static final int ID = 4306;

	@Inject
	protected SteveShyagelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Steve Shyagel";
		this.serverSideName = false;
		this.title = "Eva's High Priest";
