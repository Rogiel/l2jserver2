 ...
 */
public class HeadquartersTemplate extends NPCTemplate {
	public static final int ID = 35062;

	@Inject
	protected HeadquartersTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
