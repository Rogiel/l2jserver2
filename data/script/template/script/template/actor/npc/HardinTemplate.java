 ...
 */
public class HardinTemplate extends NPCTemplate {
	public static final int ID = 30832;

	@Inject
	protected HardinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
