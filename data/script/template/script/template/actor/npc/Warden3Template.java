 ...
 */
public class Warden3Template extends NPCTemplate {
	public static final int ID = 36405;

	@Inject
	protected Warden3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
