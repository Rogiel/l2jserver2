 ...
 */
public class StatueOfOfferingTemplate extends NPCTemplate {
	public static final int ID = 30757;

	@Inject
	protected StatueOfOfferingTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Statue Of Offering";
