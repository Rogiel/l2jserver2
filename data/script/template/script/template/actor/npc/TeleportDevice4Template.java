 ...
 */
public class TeleportDevice4Template extends NPCTemplate {
	public static final int ID = 32748;

	@Inject
	protected TeleportDevice4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
