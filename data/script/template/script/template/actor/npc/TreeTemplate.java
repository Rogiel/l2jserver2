 ...
 */
public class TreeTemplate extends NPCTemplate {
	public static final int ID = 30627;

	@Inject
	protected TreeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
