 ...
 */
public class FarmRavagerTemplate extends NPCTemplate {
	public static final int ID = 18905;

	@Inject
	protected FarmRavagerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Farm Ravager";
