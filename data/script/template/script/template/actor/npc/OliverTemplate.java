 ...
 */
public class OliverTemplate extends NPCTemplate {
	public static final int ID = 30974;

	@Inject
	protected OliverTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
