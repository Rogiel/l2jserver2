 ...
 */
package script.template.actor.npc.famemanager;

import com.google.inject.Inject;
import com.l2jserver.model.id.template.provider.ItemTemplateIDProvider;
import com.l2jserver.model.id.template.provider.NPCTemplateIDProvider;
import com.l2jserver.model.template.npc.FameManagerNPCTemplate;
import com.l2jserver.model.world.Actor.ActorSex;

/**
 * @author <a href="http://www.rogiel.com">Rogiel</a>
 */
public class RapidusTemplate extends FameManagerNPCTemplate {
	public static final int ID = 36479;

	@Inject
	protected RapidusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
