 ...
 */
public class KazkinZuGandiTemplate extends NPCTemplate {
	public static final int ID = 30589;

	@Inject
	protected KazkinZuGandiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kazkin Zu Gandi";
