 ...
 */
public class WarmHeartedSno6Template extends NPCTemplate {
	public static final int ID = 18;

	@Inject
	protected WarmHeartedSno6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
