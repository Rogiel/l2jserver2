 ...
 */
public class PromiseOfMammonTemplate extends NPCTemplate {
	public static final int ID = 32585;

	@Inject
	protected PromiseOfMammonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Promise of Mammon";
		this.serverSideName = false;
		this.title = "Teleporter";
