 ...
 */
public class GalionTemplate extends NPCTemplate {
	public static final int ID = 30958;

	@Inject
	protected GalionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
