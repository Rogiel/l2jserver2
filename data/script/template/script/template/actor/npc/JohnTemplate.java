 ...
 */
public class JohnTemplate extends NPCTemplate {
	public static final int ID = 32576;

	@Inject
	protected JohnTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "John";
		this.serverSideName = false;
		this.title = "Captain of the Dawn";
