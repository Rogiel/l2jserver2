 ...
 */
public class TeleportDevice3Template extends NPCTemplate {
	public static final int ID = 32747;

	@Inject
	protected TeleportDevice3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
