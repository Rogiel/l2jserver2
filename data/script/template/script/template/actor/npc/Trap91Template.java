 ...
 */
public class Trap91Template extends NPCTemplate {
	public static final int ID = 13255;

	@Inject
	protected Trap91Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
