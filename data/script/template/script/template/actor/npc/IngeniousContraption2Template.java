 ...
 */
public class IngeniousContraption2Template extends NPCTemplate {
	public static final int ID = 18495;

	@Inject
	protected IngeniousContraption2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
