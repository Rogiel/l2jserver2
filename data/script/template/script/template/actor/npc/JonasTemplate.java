 ...
 */
public class JonasTemplate extends NPCTemplate {
	public static final int ID = 30469;

	@Inject
	protected JonasTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
