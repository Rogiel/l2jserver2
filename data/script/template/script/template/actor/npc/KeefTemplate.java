 ...
 */
public class KeefTemplate extends NPCTemplate {
	public static final int ID = 30534;

	@Inject
	protected KeefTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Keef";
		this.serverSideName = false;
		this.title = "Bronze Key's";
