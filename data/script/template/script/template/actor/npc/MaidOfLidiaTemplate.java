 ...
 */
public class MaidOfLidiaTemplate extends NPCTemplate {
	public static final int ID = 31532;

	@Inject
	protected MaidOfLidiaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Maid of Lidia";
