 ...
 */
public class PathfinderWorker3Template extends NPCTemplate {
	public static final int ID = 32713;

	@Inject
	protected PathfinderWorker3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
