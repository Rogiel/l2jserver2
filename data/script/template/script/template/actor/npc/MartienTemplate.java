 ...
 */
public class MartienTemplate extends NPCTemplate {
	public static final int ID = 30645;

	@Inject
	protected MartienTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
