 ...
 */
public class HighQualitySquashTemplate extends NPCTemplate {
	public static final int ID = 12775;

	@Inject
	protected HighQualitySquashTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "High Quality Squash";
