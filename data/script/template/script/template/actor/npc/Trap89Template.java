 ...
 */
public class Trap89Template extends NPCTemplate {
	public static final int ID = 13253;

	@Inject
	protected Trap89Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
