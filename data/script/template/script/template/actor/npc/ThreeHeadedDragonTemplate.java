 ...
 */
public class ThreeHeadedDragonTemplate extends NPCTemplate {
	public static final int ID = 1575;

	@Inject
	protected ThreeHeadedDragonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Three-headed Dragon";
