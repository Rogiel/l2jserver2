 ...
 */
public class Trap33Template extends NPCTemplate {
	public static final int ID = 13069;

	@Inject
	protected Trap33Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
