 ...
 */
public class SupplyBox13Template extends NPCTemplate {
	public static final int ID = 36080;

	@Inject
	protected SupplyBox13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Supply Box";
