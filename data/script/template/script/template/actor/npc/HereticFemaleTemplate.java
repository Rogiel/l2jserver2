 ...
 */
public class HereticFemaleTemplate extends NPCTemplate {
	public static final int ID = 13107;

	@Inject
	protected HereticFemaleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Heretic Female";
