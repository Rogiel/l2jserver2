 ...
 */
public class Mark2Template extends NPCTemplate {
	public static final int ID = 32488;

	@Inject
	protected Mark2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
