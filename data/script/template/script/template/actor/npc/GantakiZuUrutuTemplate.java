 ...
 */
public class GantakiZuUrutuTemplate extends NPCTemplate {
	public static final int ID = 30587;

	@Inject
	protected GantakiZuUrutuTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gantaki Zu Urutu";
