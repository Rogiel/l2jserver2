 ...
 */
public class DetentionCampWarden2Template extends NPCTemplate {
	public static final int ID = 35698;

	@Inject
	protected DetentionCampWarden2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
