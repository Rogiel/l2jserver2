 ...
 */
public class MisaTemplate extends NPCTemplate {
	public static final int ID = 32018;

	@Inject
	protected MisaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
