 ...
 */
public class SpironTemplate extends NPCTemplate {
	public static final int ID = 30532;

	@Inject
	protected SpironTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Spiron";
		this.serverSideName = false;
		this.title = "Golden Wheel's";
