 ...
 */
public class KahmanTemplate extends NPCTemplate {
	public static final int ID = 31554;

	@Inject
	protected KahmanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
