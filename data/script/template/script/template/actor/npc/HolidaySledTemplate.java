 ...
 */
public class HolidaySledTemplate extends NPCTemplate {
	public static final int ID = 6;

	@Inject
	protected HolidaySledTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Holiday Sled";
