 ...
 */
public class Trap86Template extends NPCTemplate {
	public static final int ID = 13250;

	@Inject
	protected Trap86Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
