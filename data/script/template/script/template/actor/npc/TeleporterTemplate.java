 ...
 */
public class TeleporterTemplate extends NPCTemplate {
	public static final int ID = 13129;

	@Inject
	protected TeleporterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
