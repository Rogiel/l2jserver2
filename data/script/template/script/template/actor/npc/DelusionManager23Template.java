 ...
 */
public class DelusionManager23Template extends NPCTemplate {
	public static final int ID = 32686;

	@Inject
	protected DelusionManager23Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
