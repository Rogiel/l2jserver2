 ...
 */
public class GedrikTemplate extends NPCTemplate {
	public static final int ID = 31587;

	@Inject
	protected GedrikTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gedrik";
		this.serverSideName = false;
		this.title = "Gemcutter";
