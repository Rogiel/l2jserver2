 ...
 */
public class HudeTemplate extends NPCTemplate {
	public static final int ID = 32298;

	@Inject
	protected HudeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hude";
		this.serverSideName = false;
		this.title = "Caravan Merchant";
