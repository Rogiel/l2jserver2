 ...
 */
public class ThyimiTemplate extends NPCTemplate {
	public static final int ID = 32618;

	@Inject
	protected ThyimiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
