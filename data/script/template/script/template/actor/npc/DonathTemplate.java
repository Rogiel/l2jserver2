 ...
 */
public class DonathTemplate extends NPCTemplate {
	public static final int ID = 31624;

	@Inject
	protected DonathTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Donath";
		this.serverSideName = false;
		this.title = "Master Chef";
