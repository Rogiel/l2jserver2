 ...
 */
public class MercenaryCaptain5Template extends NPCTemplate {
	public static final int ID = 35824;

	@Inject
	protected MercenaryCaptain5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
