 ...
 */
public class Frog2Template extends NPCTemplate {
	public static final int ID = 32572;

	@Inject
	protected Frog2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Frog";
		this.serverSideName = false;
		this.title = "Great King";
