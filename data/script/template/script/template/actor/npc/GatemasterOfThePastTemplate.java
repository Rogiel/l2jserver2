 ...
 */
public class GatemasterOfThePastTemplate extends NPCTemplate {
	public static final int ID = 32260;

	@Inject
	protected GatemasterOfThePastTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gatemaster of the Past";
