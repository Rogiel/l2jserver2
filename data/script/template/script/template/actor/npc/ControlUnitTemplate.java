 ...
 */
public class ControlUnitTemplate extends NPCTemplate {
	public static final int ID = 35709;

	@Inject
	protected ControlUnitTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
