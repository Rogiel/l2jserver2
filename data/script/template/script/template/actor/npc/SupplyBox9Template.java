 ...
 */
public class SupplyBox9Template extends NPCTemplate {
	public static final int ID = 35935;

	@Inject
	protected SupplyBox9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
