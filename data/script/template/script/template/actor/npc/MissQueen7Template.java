 ...
 */
public class MissQueen7Template extends NPCTemplate {
	public static final int ID = 31765;

	@Inject
	protected MissQueen7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
