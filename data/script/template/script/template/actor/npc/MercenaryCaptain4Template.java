 ...
 */
public class MercenaryCaptain4Template extends NPCTemplate {
	public static final int ID = 35793;

	@Inject
	protected MercenaryCaptain4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
