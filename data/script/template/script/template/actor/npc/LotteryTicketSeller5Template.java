 ...
 */
public class LotteryTicketSeller5Template extends NPCTemplate {
	public static final int ID = 30994;

	@Inject
	protected LotteryTicketSeller5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
