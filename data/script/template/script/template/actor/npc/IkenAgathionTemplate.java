 ...
 */
public class IkenAgathionTemplate extends NPCTemplate {
	public static final int ID = 1539;

	@Inject
	protected IkenAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Iken Agathion";
