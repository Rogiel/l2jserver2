 ...
 */
public class DummyBoyBTemplate extends NPCTemplate {
	public static final int ID = 31391;

	@Inject
	protected DummyBoyBTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dummy  - Boy B";
