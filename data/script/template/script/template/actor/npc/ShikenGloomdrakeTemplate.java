 ...
 */
public class ShikenGloomdrakeTemplate extends NPCTemplate {
	public static final int ID = 31610;

	@Inject
	protected ShikenGloomdrakeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shiken Gloomdrake";
