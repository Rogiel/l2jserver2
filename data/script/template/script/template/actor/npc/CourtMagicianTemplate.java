 ...
 */
public class CourtMagicianTemplate extends NPCTemplate {
	public static final int ID = 32598;

	@Inject
	protected CourtMagicianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Court Magician";
		this.serverSideName = false;
		this.title = "Elmore-Aden's";
