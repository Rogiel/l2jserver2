 ...
 */
public class Trap50Template extends NPCTemplate {
	public static final int ID = 13214;

	@Inject
	protected Trap50Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
