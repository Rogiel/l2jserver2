 ...
 */
public class MesellaTemplate extends NPCTemplate {
	public static final int ID = 30407;

	@Inject
	protected MesellaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
