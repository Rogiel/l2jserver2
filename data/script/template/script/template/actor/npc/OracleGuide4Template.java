 ...
 */
public class OracleGuide4Template extends NPCTemplate {
	public static final int ID = 32276;

	@Inject
	protected OracleGuide4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
