 ...
 */
public class SeducedMage2Template extends NPCTemplate {
	public static final int ID = 36568;

	@Inject
	protected SeducedMage2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Seduced Mage";
