 ...
 */
public class MonsterRaceGuide8Template extends NPCTemplate {
	public static final int ID = 31411;

	@Inject
	protected MonsterRaceGuide8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Monster Race Guide";
		this.serverSideName = false;
		this.title = "Town of Goddard";
