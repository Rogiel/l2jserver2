 ...
 */
public class TullysGatekeeperTemplate extends NPCTemplate {
	public static final int ID = 18445;

	@Inject
	protected TullysGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
