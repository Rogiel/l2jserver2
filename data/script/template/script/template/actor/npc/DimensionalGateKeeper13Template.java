 ...
 */
public class DimensionalGateKeeper13Template extends NPCTemplate {
	public static final int ID = 31506;

	@Inject
	protected DimensionalGateKeeper13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dimensional Gate Keeper";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 38.00;
		this.collisionHeight = 120.50;
		this.level = 70;
