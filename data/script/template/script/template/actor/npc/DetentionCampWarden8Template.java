 ...
 */
public class DetentionCampWarden8Template extends NPCTemplate {
	public static final int ID = 35904;

	@Inject
	protected DetentionCampWarden8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
