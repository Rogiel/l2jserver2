 ...
 */
package script.template.actor.npc.doormen;

import com.google.inject.Inject;
import com.l2jserver.model.id.template.provider.ItemTemplateIDProvider;
import com.l2jserver.model.id.template.provider.NPCTemplateIDProvider;
import com.l2jserver.model.template.npc.DoormenNPCTemplate;
import com.l2jserver.model.world.Actor.ActorSex;

/**
 * @author <a href="http://www.rogiel.com">Rogiel</a>
 */
public class FlemingVanIssenTemplate extends DoormenNPCTemplate {
	public static final int ID = 31680;

	@Inject
	protected FlemingVanIssenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fleming Van Issen";
		this.serverSideName = false;
		this.title = "Frontier Guard Captain";
		...
		this.leftHand = itemProvider.createID(632);
		this.enchantLevel = 0;
