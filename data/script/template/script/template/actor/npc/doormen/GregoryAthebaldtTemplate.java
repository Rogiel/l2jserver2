 ...
 */
public class GregoryAthebaldtTemplate extends DoormenNPCTemplate {
	public static final int ID = 31676;

	@Inject
	protected GregoryAthebaldtTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gregory Athebaldt";
