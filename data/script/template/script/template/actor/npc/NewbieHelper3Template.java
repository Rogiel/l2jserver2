 ...
 */
public class NewbieHelper3Template extends NPCTemplate {
	public static final int ID = 30131;

	@Inject
	protected NewbieHelper3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
