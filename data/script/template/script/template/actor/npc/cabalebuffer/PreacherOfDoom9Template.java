 ...
 */
public class PreacherOfDoom9Template extends CabaleBufferNPCTemplate {
	public static final int ID = 31186;

	@Inject
	protected PreacherOfDoom9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
