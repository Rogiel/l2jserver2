 ...
 */
public class PreacherOfDoom8Template extends CabaleBufferNPCTemplate {
	public static final int ID = 31184;

	@Inject
	protected PreacherOfDoom8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
