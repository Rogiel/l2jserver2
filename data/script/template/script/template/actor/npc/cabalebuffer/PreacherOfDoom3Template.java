 ...
 */
public class PreacherOfDoom3Template extends CabaleBufferNPCTemplate {
	public static final int ID = 31174;

	@Inject
	protected PreacherOfDoom3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
