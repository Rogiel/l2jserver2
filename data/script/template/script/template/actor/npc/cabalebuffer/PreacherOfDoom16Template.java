 ...
 */
public class PreacherOfDoom16Template extends CabaleBufferNPCTemplate {
	public static final int ID = 31200;

	@Inject
	protected PreacherOfDoom16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
