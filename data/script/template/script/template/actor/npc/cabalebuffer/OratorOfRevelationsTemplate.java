 ...
 */
public class OratorOfRevelationsTemplate extends CabaleBufferNPCTemplate {
	public static final int ID = 31094;

	@Inject
	protected OratorOfRevelationsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
