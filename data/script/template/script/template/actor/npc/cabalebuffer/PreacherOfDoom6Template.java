 ...
 */
public class PreacherOfDoom6Template extends CabaleBufferNPCTemplate {
	public static final int ID = 31180;

	@Inject
	protected PreacherOfDoom6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
