 ...
 */
public class OratorOfRevelations9Template extends CabaleBufferNPCTemplate {
	public static final int ID = 31187;

	@Inject
	protected OratorOfRevelations9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
