 ...
 */
public class PreacherOfDoom2Template extends CabaleBufferNPCTemplate {
	public static final int ID = 31172;

	@Inject
	protected PreacherOfDoom2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
