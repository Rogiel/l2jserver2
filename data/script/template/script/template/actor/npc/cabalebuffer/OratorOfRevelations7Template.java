 ...
 */
public class OratorOfRevelations7Template extends CabaleBufferNPCTemplate {
	public static final int ID = 31183;

	@Inject
	protected OratorOfRevelations7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
