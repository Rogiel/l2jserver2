 ...
 */
public class PreacherOfDoom5Template extends CabaleBufferNPCTemplate {
	public static final int ID = 31178;

	@Inject
	protected PreacherOfDoom5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
