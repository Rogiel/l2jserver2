 ...
 */
public class PreacherOfDoom12Template extends CabaleBufferNPCTemplate {
	public static final int ID = 31192;

	@Inject
	protected PreacherOfDoom12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Preacher of Doom";
