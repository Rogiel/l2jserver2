 ...
 */
public class OratorOfRevelations8Template extends CabaleBufferNPCTemplate {
	public static final int ID = 31185;

	@Inject
	protected OratorOfRevelations8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
