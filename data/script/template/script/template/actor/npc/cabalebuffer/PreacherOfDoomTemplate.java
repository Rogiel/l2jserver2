 ...
 */
public class PreacherOfDoomTemplate extends CabaleBufferNPCTemplate {
	public static final int ID = 31093;

	@Inject
	protected PreacherOfDoomTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
