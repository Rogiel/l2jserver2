 ...
 */
public class OratorOfRevelations3Template extends CabaleBufferNPCTemplate {
	public static final int ID = 31175;

	@Inject
	protected OratorOfRevelations3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
