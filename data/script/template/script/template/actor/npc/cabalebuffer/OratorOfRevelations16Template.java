 ...
 */
public class OratorOfRevelations16Template extends CabaleBufferNPCTemplate {
	public static final int ID = 31201;

	@Inject
	protected OratorOfRevelations16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
