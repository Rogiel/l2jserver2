 ...
 */
public class OratorOfRevelations5Template extends CabaleBufferNPCTemplate {
	public static final int ID = 31179;

	@Inject
	protected OratorOfRevelations5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
