 ...
 */
package script.template.actor.npc.cabalebuffer;

import com.google.inject.Inject;
import com.l2jserver.model.id.template.provider.ItemTemplateIDProvider;
import com.l2jserver.model.id.template.provider.NPCTemplateIDProvider;
import com.l2jserver.model.template.npc.CabaleBufferNPCTemplate;
import com.l2jserver.model.world.Actor.ActorSex;

/**
 * @author <a href="http://www.rogiel.com">Rogiel</a>
 */
public class OratorOfRevelations14Template extends CabaleBufferNPCTemplate {
	public static final int ID = 31197;

	@Inject
	protected OratorOfRevelations14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Orator of Revelations";
