 ...
 */
public class PreacherOfDoom7Template extends CabaleBufferNPCTemplate {
	public static final int ID = 31182;

	@Inject
	protected PreacherOfDoom7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
