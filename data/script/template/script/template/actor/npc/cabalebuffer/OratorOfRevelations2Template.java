 ...
 */
public class OratorOfRevelations2Template extends CabaleBufferNPCTemplate {
	public static final int ID = 31173;

	@Inject
	protected OratorOfRevelations2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
