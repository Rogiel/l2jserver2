 ...
 */
public class PreacherOfDoom4Template extends CabaleBufferNPCTemplate {
	public static final int ID = 31176;

	@Inject
	protected PreacherOfDoom4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
