 ...
 */
public class OratorOfRevelations6Template extends CabaleBufferNPCTemplate {
	public static final int ID = 31181;

	@Inject
	protected OratorOfRevelations6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
