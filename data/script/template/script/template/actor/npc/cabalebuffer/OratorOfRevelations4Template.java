 ...
 */
public class OratorOfRevelations4Template extends CabaleBufferNPCTemplate {
	public static final int ID = 31177;

	@Inject
	protected OratorOfRevelations4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
