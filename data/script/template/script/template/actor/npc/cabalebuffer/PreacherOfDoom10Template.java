 ...
 */
public class PreacherOfDoom10Template extends CabaleBufferNPCTemplate {
	public static final int ID = 31188;

	@Inject
	protected PreacherOfDoom10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
