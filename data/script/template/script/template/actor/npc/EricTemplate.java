 ...
 */
public class EricTemplate extends NPCTemplate {
	public static final int ID = 32570;

	@Inject
	protected EricTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Eric";
		this.serverSideName = false;
		this.title = "Herb Collector";
