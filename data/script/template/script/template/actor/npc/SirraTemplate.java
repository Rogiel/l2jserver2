 ...
 */
public class SirraTemplate extends NPCTemplate {
	public static final int ID = 18852;

	@Inject
	protected SirraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
