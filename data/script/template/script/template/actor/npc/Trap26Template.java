 ...
 */
public class Trap26Template extends NPCTemplate {
	public static final int ID = 13062;

	@Inject
	protected Trap26Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
