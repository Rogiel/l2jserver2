 ...
 */
public class IlvenisTemplate extends NPCTemplate {
	public static final int ID = 32766;

	@Inject
	protected IlvenisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
