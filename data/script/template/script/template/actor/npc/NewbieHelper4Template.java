 ...
 */
public class NewbieHelper4Template extends NPCTemplate {
	public static final int ID = 30400;

	@Inject
	protected NewbieHelper4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
