 ...
 */
public class Trap52Template extends NPCTemplate {
	public static final int ID = 13216;

	@Inject
	protected Trap52Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
