 ...
 */
public class Jinia2Template extends NPCTemplate {
	public static final int ID = 32760;

	@Inject
	protected Jinia2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
