 ...
 */
public class MediumJarTemplate extends NPCTemplate {
	public static final int ID = 30973;

	@Inject
	protected MediumJarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Medium Jar";
