 ...
 */
public class VarkasHolyAltarTemplate extends NPCTemplate {
	public static final int ID = 31560;

	@Inject
	protected VarkasHolyAltarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Varka's Holy Altar";
