 ...
 */
public class EuclieTemplate extends NPCTemplate {
	public static final int ID = 30950;

	@Inject
	protected EuclieTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
