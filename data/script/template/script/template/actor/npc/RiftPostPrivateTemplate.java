 ...
 */
public class RiftPostPrivateTemplate extends NPCTemplate {
	public static final int ID = 31489;

	@Inject
	protected RiftPostPrivateTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rift Post Private";
