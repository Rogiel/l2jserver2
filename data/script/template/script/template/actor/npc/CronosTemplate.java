 ...
 */
public class CronosTemplate extends NPCTemplate {
	public static final int ID = 30610;

	@Inject
	protected CronosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
