 ...
 */
public class SupplyBox19Template extends NPCTemplate {
	public static final int ID = 36293;

	@Inject
	protected SupplyBox19Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
