 ...
 */
public class SaintsFollower4Template extends NPCTemplate {
	public static final int ID = 31703;

	@Inject
	protected SaintsFollower4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
