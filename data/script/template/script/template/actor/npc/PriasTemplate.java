 ...
 */
public class PriasTemplate extends NPCTemplate {
	public static final int ID = 30426;

	@Inject
	protected PriasTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
