 ...
 */
public class RupinaTemplate extends NPCTemplate {
	public static final int ID = 30742;

	@Inject
	protected RupinaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rupina";
		this.serverSideName = false;
		this.title = "Fairy of Love";
