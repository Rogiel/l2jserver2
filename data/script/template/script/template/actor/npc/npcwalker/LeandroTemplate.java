 ...
 */
public class LeandroTemplate extends WalkerNPCTemplate {
	public static final int ID = 31357;

	@Inject
	protected LeandroTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
