 ...
 */
public class RemyTemplate extends WalkerNPCTemplate {
	public static final int ID = 31356;

	@Inject
	protected RemyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
