 ...
 */
public class RokarTemplate extends WalkerNPCTemplate {
	public static final int ID = 31364;

	@Inject
	protected RokarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
