 ...
 */
public class KreedTemplate extends WalkerNPCTemplate {
	public static final int ID = 31361;

	@Inject
	protected KreedTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kreed";
		this.serverSideName = false;
		this.title = "Tetrarch Executioner";
