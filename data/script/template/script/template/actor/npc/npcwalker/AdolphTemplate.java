 ...
 */
public class AdolphTemplate extends WalkerNPCTemplate {
	public static final int ID = 32070;

	@Inject
	protected AdolphTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
