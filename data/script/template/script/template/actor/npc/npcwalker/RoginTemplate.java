 ...
 */
public class RoginTemplate extends WalkerNPCTemplate {
	public static final int ID = 31363;

	@Inject
	protected RoginTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rogin";
		this.serverSideName = false;
		this.title = "Deliveryman";
