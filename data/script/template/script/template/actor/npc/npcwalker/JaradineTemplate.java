 ...
 */
public class JaradineTemplate extends WalkerNPCTemplate {
	public static final int ID = 31359;

	@Inject
	protected JaradineTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Jaradine";
		this.serverSideName = false;
		this.title = "Mother Tree Guardian";
		...
		this.rightHand = itemProvider.createID(189);
		this.leftHand = null;
		this.enchantLevel = 0;
