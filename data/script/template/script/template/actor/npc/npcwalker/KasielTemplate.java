 ...
 */
public class KasielTemplate extends WalkerNPCTemplate {
	public static final int ID = 31358;

	@Inject
	protected KasielTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.rightHand = itemProvider.createID(4202);
		this.leftHand = null;
		this.enchantLevel = 0;
