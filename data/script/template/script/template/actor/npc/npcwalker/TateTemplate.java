 ...
 */
public class TateTemplate extends WalkerNPCTemplate {
	public static final int ID = 31362;

	@Inject
	protected TateTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
