 ...
 */
public class AlhenaTemplate extends WalkerNPCTemplate {
	public static final int ID = 31360;

	@Inject
	protected AlhenaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Alhena";
		this.serverSideName = false;
		this.title = "Tetrarch Agent";
		...
		this.rightHand = itemProvider.createID(315);
		this.leftHand = null;
		this.enchantLevel = 0;
