 ...
 */
public class YakandTemplate extends WalkerNPCTemplate {
	public static final int ID = 31365;

	@Inject
	protected YakandTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Yakand";
		this.serverSideName = false;
		this.title = "Guardian of Flame";
		...
		this.rightHand = itemProvider.createID(203);
		this.leftHand = null;
		this.enchantLevel = 0;
