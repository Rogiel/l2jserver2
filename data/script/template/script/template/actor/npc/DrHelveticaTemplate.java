 ...
 */
public class DrHelveticaTemplate extends NPCTemplate {
	public static final int ID = 32641;

	@Inject
	protected DrHelveticaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dr. Helvetica";
