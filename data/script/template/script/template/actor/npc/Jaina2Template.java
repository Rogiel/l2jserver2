 ...
 */
public class Jaina2Template extends NPCTemplate {
	public static final int ID = 32617;

	@Inject
	protected Jaina2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
