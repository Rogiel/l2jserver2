 ...
 */
public class SukiTemplate extends NPCTemplate {
	public static final int ID = 32013;

	@Inject
	protected SukiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Suki";
		this.serverSideName = false;
		this.title = "Wild Maiden";
