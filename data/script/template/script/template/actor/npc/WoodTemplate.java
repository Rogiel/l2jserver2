 ...
 */
public class WoodTemplate extends NPCTemplate {
	public static final int ID = 32593;

	@Inject
	protected WoodTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
