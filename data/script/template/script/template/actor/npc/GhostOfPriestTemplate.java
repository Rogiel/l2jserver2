 ...
 */
public class GhostOfPriestTemplate extends NPCTemplate {
	public static final int ID = 31528;

	@Inject
	protected GhostOfPriestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ghost of Priest";
