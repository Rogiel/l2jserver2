 ...
 */
public class UruhaTemplate extends NPCTemplate {
	public static final int ID = 30652;

	@Inject
	protected UruhaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
