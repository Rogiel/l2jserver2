 ...
 */
public class Trap92Template extends NPCTemplate {
	public static final int ID = 13256;

	@Inject
	protected Trap92Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
