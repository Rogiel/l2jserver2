 ...
 */
public class GuardianOfBorder2Template extends NPCTemplate {
	public static final int ID = 31866;

	@Inject
	protected GuardianOfBorder2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
