 ...
 */
public class DummyBoyDTemplate extends NPCTemplate {
	public static final int ID = 31393;

	@Inject
	protected DummyBoyDTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dummy - Boy D";
