 ...
 */
public class PiperLongbowTemplate extends NPCTemplate {
	public static final int ID = 30662;

	@Inject
	protected PiperLongbowTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Piper Longbow";
