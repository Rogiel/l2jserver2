 ...
 */
public class EntranceManager3Template extends NPCTemplate {
	public static final int ID = 32522;

	@Inject
	protected EntranceManager3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Entrance Manager";
		this.serverSideName = false;
		this.title = "Handy's Block Checker - Arena 2";
