 ...
 */
public class DummyLadyGTemplate extends NPCTemplate {
	public static final int ID = 31396;

	@Inject
	protected DummyLadyGTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dummy - Lady G";
