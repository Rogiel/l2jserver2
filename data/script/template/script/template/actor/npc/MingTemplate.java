 ...
 */
public class MingTemplate extends NPCTemplate {
	public static final int ID = 32308;

	@Inject
	protected MingTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
