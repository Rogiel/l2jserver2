 ...
 */
public class Katenar5Template extends NPCTemplate {
	public static final int ID = 32333;

	@Inject
	protected Katenar5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
