 ...
 */
public class MainRoleATemplate extends NPCTemplate {
	public static final int ID = 13167;

	@Inject
	protected MainRoleATemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Main Role A";
