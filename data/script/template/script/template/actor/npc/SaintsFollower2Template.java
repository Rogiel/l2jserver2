 ...
 */
public class SaintsFollower2Template extends NPCTemplate {
	public static final int ID = 31701;

	@Inject
	protected SaintsFollower2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
