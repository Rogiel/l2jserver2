 ...
 */
public class GeneralTemplate extends NPCTemplate {
	public static final int ID = 35693;

	@Inject
	protected GeneralTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
