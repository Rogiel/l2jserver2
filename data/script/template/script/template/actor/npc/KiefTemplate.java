 ...
 */
public class KiefTemplate extends NPCTemplate {
	public static final int ID = 32354;

	@Inject
	protected KiefTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
