 ...
 */
public class VaultDoorControllerTemplate extends NPCTemplate {
	public static final int ID = 32259;

	@Inject
	protected VaultDoorControllerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vault Door Controller";
