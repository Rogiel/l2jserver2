 ...
 */
public class DetentionCampWarden21Template extends NPCTemplate {
	public static final int ID = 36364;

	@Inject
	protected DetentionCampWarden21Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
