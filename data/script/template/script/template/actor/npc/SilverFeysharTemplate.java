 ...
 */
public class SilverFeysharTemplate extends NPCTemplate {
	public static final int ID = 31643;

	@Inject
	protected SilverFeysharTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Silver Feyshar";
