 ...
 */
public class ControlUnit2Template extends NPCTemplate {
	public static final int ID = 35778;

	@Inject
	protected ControlUnit2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
