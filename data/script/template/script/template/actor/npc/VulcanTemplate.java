 ...
 */
public class VulcanTemplate extends NPCTemplate {
	public static final int ID = 31539;

	@Inject
	protected VulcanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vulcan";
		this.serverSideName = false;
		this.title = "Blacksmith of Flame";
