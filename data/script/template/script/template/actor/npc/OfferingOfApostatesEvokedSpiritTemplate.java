 ...
 */
public class OfferingOfApostatesEvokedSpiritTemplate extends NPCTemplate {
	public static final int ID = 18302;

	@Inject
	protected OfferingOfApostatesEvokedSpiritTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
