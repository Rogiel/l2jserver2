 ...
 */
public class HolyGrailTemplate extends NPCTemplate {
	public static final int ID = 32028;

	@Inject
	protected HolyGrailTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Holy Grail";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 6.20;
