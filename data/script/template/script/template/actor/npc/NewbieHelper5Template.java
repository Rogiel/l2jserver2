 ...
 */
public class NewbieHelper5Template extends NPCTemplate {
	public static final int ID = 30401;

	@Inject
	protected NewbieHelper5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
