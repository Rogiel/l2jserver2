 ...
 */
public class MercenaryPrivate3Template extends NPCTemplate {
	public static final int ID = 35756;

	@Inject
	protected MercenaryPrivate3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
