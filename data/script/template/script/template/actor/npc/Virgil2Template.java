 ...
 */
public class Virgil2Template extends NPCTemplate {
	public static final int ID = 31742;

	@Inject
	protected Virgil2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
