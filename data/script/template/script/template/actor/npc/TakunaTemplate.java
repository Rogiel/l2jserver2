 ...
 */
public class TakunaTemplate extends NPCTemplate {
	public static final int ID = 30641;

	@Inject
	protected TakunaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Takuna";
		this.serverSideName = false;
		this.title = "Duda-Mara Chief";
