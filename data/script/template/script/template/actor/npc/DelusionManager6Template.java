 ...
 */
public class DelusionManager6Template extends NPCTemplate {
	public static final int ID = 32669;

	@Inject
	protected DelusionManager6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
