 ...
 */
public class MysteriousDarkKnightTemplate extends NPCTemplate {
	public static final int ID = 31751;

	@Inject
	protected MysteriousDarkKnightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mysterious Dark Knight";
