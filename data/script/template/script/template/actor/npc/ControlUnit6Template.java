 ...
 */
public class ControlUnit6Template extends NPCTemplate {
	public static final int ID = 36054;

	@Inject
	protected ControlUnit6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
