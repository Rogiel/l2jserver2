 ...
 */
public class RudolphAgathion2Template extends NPCTemplate {
	public static final int ID = 16073;

	@Inject
	protected RudolphAgathion2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rudolph Agathion";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 0.01;
		this.collisionHeight = 5.27;
		this.level = 55;
