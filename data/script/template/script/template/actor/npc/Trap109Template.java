 ...
 */
public class Trap109Template extends NPCTemplate {
	public static final int ID = 18394;

	@Inject
	protected Trap109Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
