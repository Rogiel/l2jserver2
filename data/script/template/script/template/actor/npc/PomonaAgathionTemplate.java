 ...
 */
public class PomonaAgathionTemplate extends NPCTemplate {
	public static final int ID = 1527;

	@Inject
	protected PomonaAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Pomona Agathion";
