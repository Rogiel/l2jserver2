 ...
 */
public class KnightLevelMercenaryTemplate extends NPCTemplate {
	public static final int ID = 13175;

	@Inject
	protected KnightLevelMercenaryTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Knight Level Mercenary";
