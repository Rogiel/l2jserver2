 ...
 */
public class YellowFlagTemplate extends NPCTemplate {
	public static final int ID = 35424;

	@Inject
	protected YellowFlagTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
