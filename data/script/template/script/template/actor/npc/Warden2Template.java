 ...
 */
public class Warden2Template extends NPCTemplate {
	public static final int ID = 36404;

	@Inject
	protected Warden2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
