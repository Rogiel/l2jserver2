 ...
 */
public class RedStarStone2Template extends FlyNPCTemplate {
	public static final int ID = 18685;

	@Inject
	protected RedStarStone2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Red Star Stone";
