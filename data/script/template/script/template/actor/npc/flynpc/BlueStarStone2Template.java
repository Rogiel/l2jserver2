 ...
 */
public class BlueStarStone2Template extends FlyNPCTemplate {
	public static final int ID = 18688;

	@Inject
	protected BlueStarStone2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
