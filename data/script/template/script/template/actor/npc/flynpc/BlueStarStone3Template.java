 ...
 */
public class BlueStarStone3Template extends FlyNPCTemplate {
	public static final int ID = 18689;

	@Inject
	protected BlueStarStone3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
