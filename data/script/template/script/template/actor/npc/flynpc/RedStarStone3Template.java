 ...
 */
public class RedStarStone3Template extends FlyNPCTemplate {
	public static final int ID = 18686;

	@Inject
	protected RedStarStone3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
