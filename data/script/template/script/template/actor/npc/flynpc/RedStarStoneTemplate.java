 ...
 */
public class RedStarStoneTemplate extends FlyNPCTemplate {
	public static final int ID = 18684;

	@Inject
	protected RedStarStoneTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
