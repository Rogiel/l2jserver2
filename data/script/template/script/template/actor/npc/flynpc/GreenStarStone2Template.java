 ...
 */
public class GreenStarStone2Template extends FlyNPCTemplate {
	public static final int ID = 18691;

	@Inject
	protected GreenStarStone2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Green Star Stone";
