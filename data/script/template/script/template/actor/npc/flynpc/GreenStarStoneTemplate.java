 ...
 */
public class GreenStarStoneTemplate extends FlyNPCTemplate {
	public static final int ID = 18690;

	@Inject
	protected GreenStarStoneTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
