 ...
 */
public class GreenStarStone3Template extends FlyNPCTemplate {
	public static final int ID = 18692;

	@Inject
	protected GreenStarStone3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
