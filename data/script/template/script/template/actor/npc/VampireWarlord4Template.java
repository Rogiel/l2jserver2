 ...
 */
public class VampireWarlord4Template extends NPCTemplate {
	public static final int ID = 35636;

	@Inject
	protected VampireWarlord4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 80;
		this.maxHP = 8570.306176894800000;
		...
		attributes.physicalAttack = 1712.88112;
