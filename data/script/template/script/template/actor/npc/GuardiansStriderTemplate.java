 ...
 */
public class GuardiansStriderTemplate extends NPCTemplate {
	public static final int ID = 13197;

	@Inject
	protected GuardiansStriderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guardian's Strider";
