 ...
 */
public class MatchManager2Template extends NPCTemplate {
	public static final int ID = 32505;

	@Inject
	protected MatchManager2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Match Manager";
