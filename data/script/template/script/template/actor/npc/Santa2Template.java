 ...
 */
public class Santa2Template extends NPCTemplate {
	public static final int ID = 4304;

	@Inject
	protected Santa2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Santa";
		this.serverSideName = false;
		this.title = "Merry Christmas";
