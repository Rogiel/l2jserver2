 ...
 */
public class DimensionalMerchantTemplate extends NPCTemplate {
	public static final int ID = 32478;

	@Inject
	protected DimensionalMerchantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dimensional Merchant";
