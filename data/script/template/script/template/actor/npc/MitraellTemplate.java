 ...
 */
public class MitraellTemplate extends NPCTemplate {
	public static final int ID = 30129;

	@Inject
	protected MitraellTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
