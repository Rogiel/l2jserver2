 ...
 */
public class VulkusTemplate extends NPCTemplate {
	public static final int ID = 30573;

	@Inject
	protected VulkusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vulkus";
		this.serverSideName = false;
		this.title = "Flame Guardian";
