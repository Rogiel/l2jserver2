 ...
 */
public class OldDwarvenGhostTemplate extends NPCTemplate {
	public static final int ID = 32370;

	@Inject
	protected OldDwarvenGhostTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Old Dwarven Ghost";
