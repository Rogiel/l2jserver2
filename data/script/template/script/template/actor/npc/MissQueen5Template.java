 ...
 */
public class MissQueen5Template extends NPCTemplate {
	public static final int ID = 31763;

	@Inject
	protected MissQueen5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Miss Queen";
		this.serverSideName = false;
		this.title = "Adventurers' Guide";
