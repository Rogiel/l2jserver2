 ...
 */
public class General9Template extends NPCTemplate {
	public static final int ID = 35969;

	@Inject
	protected General9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
