 ...
 */
public class DominicTemplate extends NPCTemplate {
	public static final int ID = 31350;

	@Inject
	protected DominicTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
