 ...
 */
public class GuardCaptain39Template extends NPCTemplate {
	public static final int ID = 36319;

	@Inject
	protected GuardCaptain39Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
