 ...
 */
public class WinterHunterKadyth2Template extends NPCTemplate {
	public static final int ID = 31634;

	@Inject
	protected WinterHunterKadyth2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
