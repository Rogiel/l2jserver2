 ...
 */
public class OracleGuide7Template extends NPCTemplate {
	public static final int ID = 32279;

	@Inject
	protected OracleGuide7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
