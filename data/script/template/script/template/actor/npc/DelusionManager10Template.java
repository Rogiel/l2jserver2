 ...
 */
public class DelusionManager10Template extends NPCTemplate {
	public static final int ID = 32673;

	@Inject
	protected DelusionManager10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
