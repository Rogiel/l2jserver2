 ...
 */
public class KristinaTemplate extends NPCTemplate {
	public static final int ID = 30665;

	@Inject
	protected KristinaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
