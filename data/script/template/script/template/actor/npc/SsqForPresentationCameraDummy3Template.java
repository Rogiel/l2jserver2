 ...
 */
public class SsqForPresentationCameraDummy3Template extends NPCTemplate {
	public static final int ID = 18832;

	@Inject
	protected SsqForPresentationCameraDummy3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "ssq For Presentation Camera Dummy 3";
