 ...
 */
public class HalloweenEventManagerTemplate extends NPCTemplate {
	public static final int ID = 26;

	@Inject
	protected HalloweenEventManagerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Halloween Event Manager";
