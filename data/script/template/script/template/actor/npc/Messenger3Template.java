 ...
 */
public class Messenger3Template extends NPCTemplate {
	public static final int ID = 35627;

	@Inject
	protected Messenger3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
