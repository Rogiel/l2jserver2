 ...
 */
public class MorganTemplate extends NPCTemplate {
	public static final int ID = 30737;

	@Inject
	protected MorganTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Morgan";
		this.serverSideName = false;
		this.title = "Guildsman";
