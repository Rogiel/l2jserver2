 ...
 */
public class DolmenTemplate extends NPCTemplate {
	public static final int ID = 32307;

	@Inject
	protected DolmenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dolmen";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 220.00;
		this.collisionHeight = 450.00;
		this.level = 70;
