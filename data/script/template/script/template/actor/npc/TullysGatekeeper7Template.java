 ...
 */
public class TullysGatekeeper7Template extends NPCTemplate {
	public static final int ID = 18451;

	@Inject
	protected TullysGatekeeper7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
