 ...
 */
public class TabletOfVision2Template extends NPCTemplate {
	public static final int ID = 31647;

	@Inject
	protected TabletOfVision2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
