 ...
 */
public class RiftPostHeroTemplate extends NPCTemplate {
	public static final int ID = 31493;

	@Inject
	protected RiftPostHeroTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rift Post Hero";
