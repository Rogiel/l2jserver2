 ...
 */
public class SeyoTemplate extends NPCTemplate {
	public static final int ID = 32737;

	@Inject
	protected SeyoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
