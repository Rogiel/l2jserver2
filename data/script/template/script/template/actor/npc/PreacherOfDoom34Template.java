 ...
 */
public class PreacherOfDoom34Template extends NPCTemplate {
	public static final int ID = 31714;

	@Inject
	protected PreacherOfDoom34Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
