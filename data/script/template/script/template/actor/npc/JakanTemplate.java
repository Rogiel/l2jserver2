 ...
 */
public class JakanTemplate extends NPCTemplate {
	public static final int ID = 32773;

	@Inject
	protected JakanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
