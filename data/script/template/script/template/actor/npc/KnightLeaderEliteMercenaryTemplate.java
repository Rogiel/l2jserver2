 ...
 */
public class KnightLeaderEliteMercenaryTemplate extends NPCTemplate {
	public static final int ID = 13179;

	@Inject
	protected KnightLeaderEliteMercenaryTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Knight Leader Elite Mercenary";
