 ...
 */
public class Kurstin2Template extends NPCTemplate {
	public static final int ID = 31387;

	@Inject
	protected Kurstin2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
