 ...
 */
public class WindSylphTemplate extends NPCTemplate {
	public static final int ID = 30412;

	@Inject
	protected WindSylphTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Wind Sylph";
