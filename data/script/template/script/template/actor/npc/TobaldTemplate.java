 ...
 */
public class TobaldTemplate extends NPCTemplate {
	public static final int ID = 31596;

	@Inject
	protected TobaldTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
