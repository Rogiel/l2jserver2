 ...
 */
public class OpixTemplate extends DwarfVillageMasterNPCTemplate {
	public static final int ID = 30595;

	@Inject
	protected OpixTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
