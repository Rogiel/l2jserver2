 ...
 */
public class GestoTemplate extends DwarfVillageMasterNPCTemplate {
	public static final int ID = 30511;

	@Inject
	protected GestoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
