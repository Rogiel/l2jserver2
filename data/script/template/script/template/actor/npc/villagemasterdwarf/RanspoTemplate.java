 ...
 */
public class RanspoTemplate extends DwarfVillageMasterNPCTemplate {
	public static final int ID = 30594;

	@Inject
	protected RanspoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
