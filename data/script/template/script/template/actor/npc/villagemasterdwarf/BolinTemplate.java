 ...
 */
public class BolinTemplate extends DwarfVillageMasterNPCTemplate {
	public static final int ID = 32093;

	@Inject
	protected BolinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
