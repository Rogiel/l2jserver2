 ...
 */
public class BaxtTemplate extends DwarfVillageMasterNPCTemplate {
	public static final int ID = 30685;

	@Inject
	protected BaxtTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
