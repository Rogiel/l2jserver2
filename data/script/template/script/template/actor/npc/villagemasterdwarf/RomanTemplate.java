 ...
 */
public class RomanTemplate extends DwarfVillageMasterNPCTemplate {
	public static final int ID = 30897;

	@Inject
	protected RomanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
