 ...
 */
public class NoelTemplate extends DwarfVillageMasterNPCTemplate {
	public static final int ID = 31272;

	@Inject
	protected NoelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
