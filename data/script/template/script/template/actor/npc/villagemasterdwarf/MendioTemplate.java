 ...
 */
public class MendioTemplate extends DwarfVillageMasterNPCTemplate {
	public static final int ID = 30504;

	@Inject
	protected MendioTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
