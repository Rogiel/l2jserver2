 ...
 */
public class ReedTemplate extends DwarfVillageMasterNPCTemplate {
	public static final int ID = 30520;

	@Inject
	protected ReedTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
