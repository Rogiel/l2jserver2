 ...
 */
public class MokaTemplate extends DwarfVillageMasterNPCTemplate {
	public static final int ID = 32157;

	@Inject
	protected MokaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
