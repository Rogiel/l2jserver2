 ...
 */
public class AlderTemplate extends DwarfVillageMasterNPCTemplate {
	public static final int ID = 32092;

	@Inject
	protected AlderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
