 ...
 */
public class DonalTemplate extends DwarfVillageMasterNPCTemplate {
	public static final int ID = 31314;

	@Inject
	protected DonalTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
