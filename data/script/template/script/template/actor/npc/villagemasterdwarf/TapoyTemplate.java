 ...
 */
public class TapoyTemplate extends DwarfVillageMasterNPCTemplate {
	public static final int ID = 30499;

	@Inject
	protected TapoyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
