 ...
 */
public class BronkTemplate extends DwarfVillageMasterNPCTemplate {
	public static final int ID = 30525;

	@Inject
	protected BronkTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
