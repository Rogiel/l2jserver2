 ...
 */
public class FerrisTemplate extends DwarfVillageMasterNPCTemplate {
	public static final int ID = 30847;

	@Inject
	protected FerrisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
