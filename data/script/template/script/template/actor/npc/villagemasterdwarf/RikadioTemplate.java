 ...
 */
public class RikadioTemplate extends DwarfVillageMasterNPCTemplate {
	public static final int ID = 30503;

	@Inject
	protected RikadioTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
