 ...
 */
public class VergaraTemplate extends DwarfVillageMasterNPCTemplate {
	public static final int ID = 30687;

	@Inject
	protected VergaraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vergara";
		this.serverSideName = false;
		this.title = "Head Blacksmith";
