 ...
 */
public class NatoolsTemplate extends DwarfVillageMasterNPCTemplate {
	public static final int ID = 30894;

	@Inject
	protected NatoolsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
