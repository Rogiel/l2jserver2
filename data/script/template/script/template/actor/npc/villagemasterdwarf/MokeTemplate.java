 ...
 */
public class MokeTemplate extends DwarfVillageMasterNPCTemplate {
	public static final int ID = 30498;

	@Inject
	protected MokeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
