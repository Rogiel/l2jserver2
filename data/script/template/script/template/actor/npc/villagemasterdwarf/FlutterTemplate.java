 ...
 */
public class FlutterTemplate extends DwarfVillageMasterNPCTemplate {
	public static final int ID = 30677;

	@Inject
	protected FlutterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
