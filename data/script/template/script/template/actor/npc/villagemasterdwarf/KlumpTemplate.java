 ...
 */
public class KlumpTemplate extends DwarfVillageMasterNPCTemplate {
	public static final int ID = 30845;

	@Inject
	protected KlumpTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
