 ...
 */
public class LombertTemplate extends DwarfVillageMasterNPCTemplate {
	public static final int ID = 31317;

	@Inject
	protected LombertTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
