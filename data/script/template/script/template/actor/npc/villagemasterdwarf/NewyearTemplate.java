 ...
 */
public class NewyearTemplate extends DwarfVillageMasterNPCTemplate {
	public static final int ID = 31961;

	@Inject
	protected NewyearTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
