 ...
 */
public class YasheniTemplate extends DwarfVillageMasterNPCTemplate {
	public static final int ID = 31958;

	@Inject
	protected YasheniTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
