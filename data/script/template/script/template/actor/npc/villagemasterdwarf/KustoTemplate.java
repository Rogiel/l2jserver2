 ...
 */
public class KustoTemplate extends DwarfVillageMasterNPCTemplate {
	public static final int ID = 30512;

	@Inject
	protected KustoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
