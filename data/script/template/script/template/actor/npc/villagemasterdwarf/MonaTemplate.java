 ...
 */
public class MonaTemplate extends DwarfVillageMasterNPCTemplate {
	public static final int ID = 31269;

	@Inject
	protected MonaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
