 ...
 */
public class HoffaTemplate extends DwarfVillageMasterNPCTemplate {
	public static final int ID = 32171;

	@Inject
	protected HoffaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
