 ...
 */
public class CroopTemplate extends DwarfVillageMasterNPCTemplate {
	public static final int ID = 30676;

	@Inject
	protected CroopTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
