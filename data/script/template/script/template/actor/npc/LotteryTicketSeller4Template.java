 ...
 */
public class LotteryTicketSeller4Template extends NPCTemplate {
	public static final int ID = 30993;

	@Inject
	protected LotteryTicketSeller4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
