 ...
 */
public class MariusTemplate extends NPCTemplate {
	public static final int ID = 30405;

	@Inject
	protected MariusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
