 ...
 */
public class Trap146Template extends NPCTemplate {
	public static final int ID = 18723;

	@Inject
	protected Trap146Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
