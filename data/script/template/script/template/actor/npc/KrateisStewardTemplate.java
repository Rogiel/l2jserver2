 ...
 */
public class KrateisStewardTemplate extends NPCTemplate {
	public static final int ID = 18592;

	@Inject
	protected KrateisStewardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
