 ...
 */
public class KeltirTemplate extends NPCTemplate {
	public static final int ID = 30739;

	@Inject
	protected KeltirTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
