 ...
 */
public class Flagpole9Template extends NPCTemplate {
	public static final int ID = 35926;

	@Inject
	protected Flagpole9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
