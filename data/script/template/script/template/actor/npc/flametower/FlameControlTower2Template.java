 ...
 */
package script.template.actor.npc.flametower;

import com.google.inject.Inject;
import com.l2jserver.model.id.template.provider.ItemTemplateIDProvider;
import com.l2jserver.model.id.template.provider.NPCTemplateIDProvider;
import com.l2jserver.model.template.npc.FlameTowerNPCTemplate;

/**
 * @author <a href="http://www.rogiel.com">Rogiel</a>
 */
public class FlameControlTower2Template extends FlameTowerNPCTemplate {
	public static final int ID = 13005;

	@Inject
	protected FlameControlTower2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Flame Control Tower";
