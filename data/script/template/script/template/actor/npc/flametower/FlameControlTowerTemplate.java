 ...
 */
public class FlameControlTowerTemplate extends FlameTowerNPCTemplate {
	public static final int ID = 13004;

	@Inject
	protected FlameControlTowerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
