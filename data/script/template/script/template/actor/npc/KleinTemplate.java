 ...
 */
public class KleinTemplate extends NPCTemplate {
	public static final int ID = 31540;

	@Inject
	protected KleinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Klein";
		this.serverSideName = false;
		this.title = "Watcher of Valakas";
