 ...
 */
public class PithgonTemplate extends NPCTemplate {
	public static final int ID = 30951;

	@Inject
	protected PithgonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
