 ...
 */
public class Trap123Template extends NPCTemplate {
	public static final int ID = 18408;

	@Inject
	protected Trap123Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
