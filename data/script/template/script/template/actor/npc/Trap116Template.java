 ...
 */
public class Trap116Template extends NPCTemplate {
	public static final int ID = 18401;

	@Inject
	protected Trap116Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
