 ...
 */
public class TeleportationCubic3Template extends NPCTemplate {
	public static final int ID = 31759;

	@Inject
	protected TeleportationCubic3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
