 ...
 */
public class RaldoTemplate extends NPCTemplate {
	public static final int ID = 30646;

	@Inject
	protected RaldoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
