 ...
 */
public class GuardianOfBorder32Template extends NPCTemplate {
	public static final int ID = 31896;

	@Inject
	protected GuardianOfBorder32Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
