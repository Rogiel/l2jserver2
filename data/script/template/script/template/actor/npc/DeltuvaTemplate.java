 ...
 */
public class DeltuvaTemplate extends NPCTemplate {
	public static final int ID = 32313;

	@Inject
	protected DeltuvaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
