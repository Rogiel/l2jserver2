 ...
 */
public class CorpseOfFritzTemplate extends NPCTemplate {
	public static final int ID = 30761;

	@Inject
	protected CorpseOfFritzTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Corpse Of Fritz";
