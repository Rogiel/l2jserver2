 ...
 */
public class MonsterRaceGuide4Template extends NPCTemplate {
	public static final int ID = 31407;

	@Inject
	protected MonsterRaceGuide4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
