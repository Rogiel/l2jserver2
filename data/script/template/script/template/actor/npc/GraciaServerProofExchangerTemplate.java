 ...
 */
public class GraciaServerProofExchangerTemplate extends NPCTemplate {
	public static final int ID = 32631;

	@Inject
	protected GraciaServerProofExchangerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gracia Server Proof Exchanger";
