 ...
 */
public class DelusionManager12Template extends NPCTemplate {
	public static final int ID = 32675;

	@Inject
	protected DelusionManager12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
