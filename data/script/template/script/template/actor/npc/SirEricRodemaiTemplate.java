 ...
 */
public class SirEricRodemaiTemplate extends NPCTemplate {
	public static final int ID = 30868;

	@Inject
	protected SirEricRodemaiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sir Eric Rodemai";
