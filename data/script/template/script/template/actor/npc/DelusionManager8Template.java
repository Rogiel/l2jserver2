 ...
 */
public class DelusionManager8Template extends NPCTemplate {
	public static final int ID = 32671;

	@Inject
	protected DelusionManager8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
