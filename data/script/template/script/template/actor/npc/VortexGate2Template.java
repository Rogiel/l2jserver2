 ...
 */
public class VortexGate2Template extends NPCTemplate {
	public static final int ID = 32519;

	@Inject
	protected VortexGate2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vortex Gate";
		this.serverSideName = false;
		this.title = "Aerial Cleft";
		this.serverSideTitle = false;
		this.collisionRadius = 300.00;
		this.collisionHeight = 130.00;
		this.level = 70;
