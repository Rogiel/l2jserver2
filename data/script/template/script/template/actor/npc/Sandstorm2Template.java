 ...
 */
public class Sandstorm2Template extends NPCTemplate {
	public static final int ID = 32350;

	@Inject
	protected Sandstorm2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
