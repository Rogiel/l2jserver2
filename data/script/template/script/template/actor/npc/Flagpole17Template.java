 ...
 */
public class Flagpole17Template extends NPCTemplate {
	public static final int ID = 36209;

	@Inject
	protected Flagpole17Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
