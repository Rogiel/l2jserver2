 ...
 */
public class VarikaTemplate extends NPCTemplate {
	public static final int ID = 30421;

	@Inject
	protected VarikaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
