 ...
 */
public class KirilSparkystoneTemplate extends NPCTemplate {
	public static final int ID = 30552;

	@Inject
	protected KirilSparkystoneTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kiril Sparkystone";
