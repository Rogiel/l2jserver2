 ...
 */
package script.template.actor.npc.block;

import com.google.inject.Inject;
import com.l2jserver.model.id.template.provider.ItemTemplateIDProvider;
import com.l2jserver.model.id.template.provider.NPCTemplateIDProvider;
import com.l2jserver.model.template.npc.BlockNPCTemplate;
import com.l2jserver.model.world.Actor.ActorSex;

/**
 * @author <a href="http://www.rogiel.com">Rogiel</a>
 */
public class Block2Template extends BlockNPCTemplate {
	public static final int ID = 18672;

	@Inject
	protected Block2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
