 ...
 */
public class OtherworldlyInvaderEliteSoldier8Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21679;

	@Inject
	protected OtherworldlyInvaderEliteSoldier8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
