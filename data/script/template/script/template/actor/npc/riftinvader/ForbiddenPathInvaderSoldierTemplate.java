 ...
 */
public class ForbiddenPathInvaderSoldierTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21737;

	@Inject
	protected ForbiddenPathInvaderSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Forbidden Path Invader Soldier";
