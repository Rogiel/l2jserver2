 ...
 */
public class PurgatoryInvaderArcherTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21707;

	@Inject
	protected PurgatoryInvaderArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Purgatory Invader Archer";
