 ...
 */
public class DarkOmenInvaderDiscipleTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21761;

	@Inject
	protected DarkOmenInvaderDiscipleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Omen Invader Disciple";
