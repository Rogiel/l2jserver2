 ...
 */
public class MessengerInvaderArcherTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21776;

	@Inject
	protected MessengerInvaderArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Messenger Invader Archer";
