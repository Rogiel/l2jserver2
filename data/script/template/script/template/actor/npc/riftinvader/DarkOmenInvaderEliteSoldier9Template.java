 ...
 */
public class DarkOmenInvaderEliteSoldier9Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21772;

	@Inject
	protected DarkOmenInvaderEliteSoldier9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Omen Invader Elite Soldier";
