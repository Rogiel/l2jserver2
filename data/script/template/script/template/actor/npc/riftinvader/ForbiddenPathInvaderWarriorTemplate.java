 ...
 */
public class ForbiddenPathInvaderWarriorTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21736;

	@Inject
	protected ForbiddenPathInvaderWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
