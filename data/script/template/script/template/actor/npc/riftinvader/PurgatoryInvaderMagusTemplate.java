 ...
 */
public class PurgatoryInvaderMagusTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21711;

	@Inject
	protected PurgatoryInvaderMagusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
