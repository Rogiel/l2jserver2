 ...
 */
public class OtherworldlyInvaderWarrior2Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21676;

	@Inject
	protected OtherworldlyInvaderWarrior2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Otherworldly Invader Warrior";
