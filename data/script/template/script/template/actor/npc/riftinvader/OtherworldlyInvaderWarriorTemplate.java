 ...
 */
public class OtherworldlyInvaderWarriorTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21667;

	@Inject
	protected OtherworldlyInvaderWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
