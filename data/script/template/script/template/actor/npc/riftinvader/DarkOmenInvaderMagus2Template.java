 ...
 */
public class DarkOmenInvaderMagus2Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21773;

	@Inject
	protected DarkOmenInvaderMagus2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
