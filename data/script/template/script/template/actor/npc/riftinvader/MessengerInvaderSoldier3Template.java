 ...
 */
public class MessengerInvaderSoldier3Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21783;

	@Inject
	protected MessengerInvaderSoldier3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Messenger Invader Soldier";
