 ...
 */
public class MessengerInvaderShamanTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21778;

	@Inject
	protected MessengerInvaderShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Messenger Invader Shaman";
