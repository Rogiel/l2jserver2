 ...
 */
public class PurgatoryInvaderEliteSoldier2Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21718;

	@Inject
	protected PurgatoryInvaderEliteSoldier2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Purgatory Invader Elite Soldier";
