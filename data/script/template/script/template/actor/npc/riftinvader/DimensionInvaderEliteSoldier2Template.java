 ...
 */
public class DimensionInvaderEliteSoldier2Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21695;

	@Inject
	protected DimensionInvaderEliteSoldier2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
