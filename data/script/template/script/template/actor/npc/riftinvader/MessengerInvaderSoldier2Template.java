 ...
 */
public class MessengerInvaderSoldier2Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21775;

	@Inject
	protected MessengerInvaderSoldier2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
