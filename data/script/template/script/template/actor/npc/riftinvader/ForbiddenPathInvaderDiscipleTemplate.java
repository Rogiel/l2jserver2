 ...
 */
public class ForbiddenPathInvaderDiscipleTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21738;

	@Inject
	protected ForbiddenPathInvaderDiscipleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Forbidden Path Invader Disciple";
