 ...
 */
public class DarkOmenInvaderMagusTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21757;

	@Inject
	protected DarkOmenInvaderMagusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Omen Invader Magus";
