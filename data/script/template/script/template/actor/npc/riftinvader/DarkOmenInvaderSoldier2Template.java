 ...
 */
public class DarkOmenInvaderSoldier2Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21752;

	@Inject
	protected DarkOmenInvaderSoldier2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
