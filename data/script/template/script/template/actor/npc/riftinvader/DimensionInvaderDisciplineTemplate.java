 ...
 */
public class DimensionInvaderDisciplineTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21692;

	@Inject
	protected DimensionInvaderDisciplineTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dimension Invader Discipline";
