 ...
 */
public class ForbiddenPathInvaderMartyrsTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21735;

	@Inject
	protected ForbiddenPathInvaderMartyrsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Forbidden Path Invader Martyrs";
