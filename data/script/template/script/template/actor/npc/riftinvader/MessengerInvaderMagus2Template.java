 ...
 */
public class MessengerInvaderMagus2Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21796;

	@Inject
	protected MessengerInvaderMagus2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Messenger Invader Magus";
