 ...
 */
public class OtherworldlyInvaderMartyrsTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21666;

	@Inject
	protected OtherworldlyInvaderMartyrsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Otherworldly Invader Martyrs";
