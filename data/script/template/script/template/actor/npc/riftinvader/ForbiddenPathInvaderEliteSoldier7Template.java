 ...
 */
public class ForbiddenPathInvaderEliteSoldier7Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21744;

	@Inject
	protected ForbiddenPathInvaderEliteSoldier7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
