 ...
 */
public class PurgatoryInvaderWarrior2Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21722;

	@Inject
	protected PurgatoryInvaderWarrior2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Purgatory Invader Warrior";
