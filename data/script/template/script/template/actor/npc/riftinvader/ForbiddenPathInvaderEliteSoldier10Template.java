 ...
 */
public class ForbiddenPathInvaderEliteSoldier10Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21748;

	@Inject
	protected ForbiddenPathInvaderEliteSoldier10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
