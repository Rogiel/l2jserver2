 ...
 */
public class MessengerInvaderEliteSoldier3Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21788;

	@Inject
	protected MessengerInvaderEliteSoldier3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
