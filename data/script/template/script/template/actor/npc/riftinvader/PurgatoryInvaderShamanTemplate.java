 ...
 */
public class PurgatoryInvaderShamanTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21709;

	@Inject
	protected PurgatoryInvaderShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Purgatory Invader Shaman";
