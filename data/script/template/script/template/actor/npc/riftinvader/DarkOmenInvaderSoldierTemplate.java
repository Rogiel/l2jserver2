 ...
 */
public class DarkOmenInvaderSoldierTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21751;

	@Inject
	protected DarkOmenInvaderSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
