 ...
 */
public class OtherworldlyInvaderMagusTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21665;

	@Inject
	protected OtherworldlyInvaderMagusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
