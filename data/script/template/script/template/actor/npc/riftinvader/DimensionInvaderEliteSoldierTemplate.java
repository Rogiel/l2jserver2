 ...
 */
public class DimensionInvaderEliteSoldierTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21685;

	@Inject
	protected DimensionInvaderEliteSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
