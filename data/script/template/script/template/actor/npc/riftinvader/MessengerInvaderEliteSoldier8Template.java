 ...
 */
public class MessengerInvaderEliteSoldier8Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21794;

	@Inject
	protected MessengerInvaderEliteSoldier8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
