 ...
 */
public class OtherworldlyInvaderEliteSoldier2Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21672;

	@Inject
	protected OtherworldlyInvaderEliteSoldier2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
