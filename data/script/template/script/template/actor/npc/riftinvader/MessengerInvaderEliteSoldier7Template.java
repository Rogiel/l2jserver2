 ...
 */
public class MessengerInvaderEliteSoldier7Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21793;

	@Inject
	protected MessengerInvaderEliteSoldier7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
