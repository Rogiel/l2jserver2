 ...
 */
public class OtherworldlyInvaderSoldierTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21659;

	@Inject
	protected OtherworldlyInvaderSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
