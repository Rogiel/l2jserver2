 ...
 */
public class DarkOmenInvaderPriestTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21756;

	@Inject
	protected DarkOmenInvaderPriestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Omen Invader Priest";
