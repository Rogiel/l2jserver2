 ...
 */
public class MessengerInvaderMartyrsTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21781;

	@Inject
	protected MessengerInvaderMartyrsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Messenger Invader Martyrs";
