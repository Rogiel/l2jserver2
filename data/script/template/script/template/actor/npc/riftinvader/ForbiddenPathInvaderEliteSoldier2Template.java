 ...
 */
public class ForbiddenPathInvaderEliteSoldier2Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21729;

	@Inject
	protected ForbiddenPathInvaderEliteSoldier2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Forbidden Path Invader Elite Soldier";
