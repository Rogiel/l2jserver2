 ...
 */
public class ForbiddenPathInvaderEliteSoldierTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21728;

	@Inject
	protected ForbiddenPathInvaderEliteSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
