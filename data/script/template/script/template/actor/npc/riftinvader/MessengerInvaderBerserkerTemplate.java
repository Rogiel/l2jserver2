 ...
 */
public class MessengerInvaderBerserkerTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21785;

	@Inject
	protected MessengerInvaderBerserkerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Messenger Invader Berserker";
