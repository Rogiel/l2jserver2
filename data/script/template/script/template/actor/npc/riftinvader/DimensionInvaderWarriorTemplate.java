 ...
 */
public class DimensionInvaderWarriorTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21690;

	@Inject
	protected DimensionInvaderWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
