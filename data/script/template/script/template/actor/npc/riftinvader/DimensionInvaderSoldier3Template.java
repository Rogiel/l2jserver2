 ...
 */
public class DimensionInvaderSoldier3Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21691;

	@Inject
	protected DimensionInvaderSoldier3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
