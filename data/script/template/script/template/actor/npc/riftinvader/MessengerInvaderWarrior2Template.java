 ...
 */
public class MessengerInvaderWarrior2Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21791;

	@Inject
	protected MessengerInvaderWarrior2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Messenger Invader Warrior";
