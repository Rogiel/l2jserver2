 ...
 */
public class PurgatoryInvaderMartyrsTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21712;

	@Inject
	protected PurgatoryInvaderMartyrsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Purgatory Invader Martyrs";
