 ...
 */
public class MessengerInvaderEliteSoldier6Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21792;

	@Inject
	protected MessengerInvaderEliteSoldier6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
