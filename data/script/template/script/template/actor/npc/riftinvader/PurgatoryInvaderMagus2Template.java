 ...
 */
public class PurgatoryInvaderMagus2Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21727;

	@Inject
	protected PurgatoryInvaderMagus2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Purgatory Invader Magus";
