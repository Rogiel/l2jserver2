 ...
 */
public class ForbiddenPathInvaderMagus2Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21750;

	@Inject
	protected ForbiddenPathInvaderMagus2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Forbidden Path Invader Magus";
