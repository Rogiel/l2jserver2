 ...
 */
public class MessengerInvaderMagusTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21780;

	@Inject
	protected MessengerInvaderMagusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
