 ...
 */
public class DarkOmenInvaderWarriorTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21759;

	@Inject
	protected DarkOmenInvaderWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
