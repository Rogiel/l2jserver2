 ...
 */
public class ForbiddenPathInvaderMagusTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21734;

	@Inject
	protected ForbiddenPathInvaderMagusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
