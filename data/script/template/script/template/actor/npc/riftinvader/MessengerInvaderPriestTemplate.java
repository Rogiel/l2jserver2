 ...
 */
public class MessengerInvaderPriestTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21779;

	@Inject
	protected MessengerInvaderPriestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Messenger Invader Priest";
