 ...
 */
public class DimensionInvaderEliteSoldier8Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21702;

	@Inject
	protected DimensionInvaderEliteSoldier8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
