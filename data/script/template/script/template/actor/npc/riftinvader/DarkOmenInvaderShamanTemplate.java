 ...
 */
public class DarkOmenInvaderShamanTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21755;

	@Inject
	protected DarkOmenInvaderShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Omen Invader Shaman";
