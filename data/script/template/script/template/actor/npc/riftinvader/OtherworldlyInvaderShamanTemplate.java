 ...
 */
public class OtherworldlyInvaderShamanTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21663;

	@Inject
	protected OtherworldlyInvaderShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Otherworldly Invader Shaman";
