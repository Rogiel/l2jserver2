 ...
 */
public class DimensionInvaderMagusTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21688;

	@Inject
	protected DimensionInvaderMagusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
