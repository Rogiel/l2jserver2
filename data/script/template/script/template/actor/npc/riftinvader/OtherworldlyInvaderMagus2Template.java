 ...
 */
public class OtherworldlyInvaderMagus2Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21681;

	@Inject
	protected OtherworldlyInvaderMagus2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Otherworldly Invader Magus";
