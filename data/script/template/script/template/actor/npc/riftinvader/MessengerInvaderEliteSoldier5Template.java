 ...
 */
public class MessengerInvaderEliteSoldier5Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21790;

	@Inject
	protected MessengerInvaderEliteSoldier5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
