 ...
 */
public class OtherworldlyInvaderBerserkerTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21670;

	@Inject
	protected OtherworldlyInvaderBerserkerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Otherworldly Invader Berserker";
