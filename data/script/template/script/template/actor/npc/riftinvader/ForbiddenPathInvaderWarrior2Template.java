 ...
 */
public class ForbiddenPathInvaderWarrior2Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21745;

	@Inject
	protected ForbiddenPathInvaderWarrior2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Forbidden Path Invader Warrior";
