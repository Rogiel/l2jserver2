 ...
 */
public class MessengerInvaderSoldierTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21774;

	@Inject
	protected MessengerInvaderSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
