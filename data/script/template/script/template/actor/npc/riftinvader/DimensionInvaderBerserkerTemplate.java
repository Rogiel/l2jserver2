 ...
 */
public class DimensionInvaderBerserkerTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21693;

	@Inject
	protected DimensionInvaderBerserkerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dimension Invader Berserker";
