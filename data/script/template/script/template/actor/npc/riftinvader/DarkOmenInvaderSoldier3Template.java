 ...
 */
public class DarkOmenInvaderSoldier3Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21760;

	@Inject
	protected DarkOmenInvaderSoldier3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Omen Invader Soldier";
