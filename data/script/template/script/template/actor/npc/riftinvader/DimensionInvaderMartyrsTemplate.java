 ...
 */
public class DimensionInvaderMartyrsTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21689;

	@Inject
	protected DimensionInvaderMartyrsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dimension Invader Martyrs";
