 ...
 */
public class DimensionInvaderEliteSoldier6Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21700;

	@Inject
	protected DimensionInvaderEliteSoldier6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
