 ...
 */
public class PurgatoryInvaderDisciplesTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21715;

	@Inject
	protected PurgatoryInvaderDisciplesTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Purgatory Invader Disciples";
