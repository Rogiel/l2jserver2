 ...
 */
public class OtherworldlyInvaderPriestTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21664;

	@Inject
	protected OtherworldlyInvaderPriestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Otherworldly Invader Priest";
