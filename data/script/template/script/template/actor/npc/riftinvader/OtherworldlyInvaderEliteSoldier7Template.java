 ...
 */
public class OtherworldlyInvaderEliteSoldier7Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21678;

	@Inject
	protected OtherworldlyInvaderEliteSoldier7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
