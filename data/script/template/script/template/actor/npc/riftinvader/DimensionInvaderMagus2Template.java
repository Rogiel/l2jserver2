 ...
 */
public class DimensionInvaderMagus2Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21704;

	@Inject
	protected DimensionInvaderMagus2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dimension Invader Magus";
