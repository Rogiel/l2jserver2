 ...
 */
public class ForbiddenPathInvaderEliteSoldier6Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21743;

	@Inject
	protected ForbiddenPathInvaderEliteSoldier6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
