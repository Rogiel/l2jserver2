 ...
 */
public class PurgatoryInvaderSoldier2Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21706;

	@Inject
	protected PurgatoryInvaderSoldier2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Purgatory Invader Soldier";
