 ...
 */
public class OtherworldlyInvaderDisciplineTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21669;

	@Inject
	protected OtherworldlyInvaderDisciplineTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Otherworldly Invader Discipline";
		...
		this.experience = 3828;
		this.sp = 220;
		this.aggressive = false;
		this.rightHand = itemProvider.createID(220);
		this.leftHand = null;
		this.enchantLevel = 0;
