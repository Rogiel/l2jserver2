 ...
 */
public class PurgatoryInvaderWarriorTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21713;

	@Inject
	protected PurgatoryInvaderWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
