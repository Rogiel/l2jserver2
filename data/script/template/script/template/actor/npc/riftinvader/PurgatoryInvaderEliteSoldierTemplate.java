 ...
 */
public class PurgatoryInvaderEliteSoldierTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21708;

	@Inject
	protected PurgatoryInvaderEliteSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
