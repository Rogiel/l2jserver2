 ...
 */
public class OtherworldlyInvaderEliteSoldier6Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21677;

	@Inject
	protected OtherworldlyInvaderEliteSoldier6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
