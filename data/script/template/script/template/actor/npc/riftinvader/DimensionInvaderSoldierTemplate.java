 ...
 */
public class DimensionInvaderSoldierTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21682;

	@Inject
	protected DimensionInvaderSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
