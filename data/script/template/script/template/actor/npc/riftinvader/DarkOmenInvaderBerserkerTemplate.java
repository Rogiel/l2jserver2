 ...
 */
public class DarkOmenInvaderBerserkerTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21762;

	@Inject
	protected DarkOmenInvaderBerserkerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Omen Invader Berserker";
