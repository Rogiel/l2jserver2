 ...
 */
public class DimensionInvaderShamanTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21686;

	@Inject
	protected DimensionInvaderShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dimension Invader Shaman";
