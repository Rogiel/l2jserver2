 ...
 */
public class ForbiddenPathInvaderPriestTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21733;

	@Inject
	protected ForbiddenPathInvaderPriestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Forbidden Path Invader Priest";
