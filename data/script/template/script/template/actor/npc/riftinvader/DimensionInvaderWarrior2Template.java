 ...
 */
public class DimensionInvaderWarrior2Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21699;

	@Inject
	protected DimensionInvaderWarrior2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dimension Invader Warrior";
