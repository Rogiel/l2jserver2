 ...
 */
public class OtherworldlyInvaderEliteSoldierTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21662;

	@Inject
	protected OtherworldlyInvaderEliteSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
