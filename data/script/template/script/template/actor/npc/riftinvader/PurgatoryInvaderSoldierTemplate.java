 ...
 */
public class PurgatoryInvaderSoldierTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21705;

	@Inject
	protected PurgatoryInvaderSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
