 ...
 */
public class ForbiddenPathInvaderShamanTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21732;

	@Inject
	protected ForbiddenPathInvaderShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Forbidden Path Invader Shaman";
