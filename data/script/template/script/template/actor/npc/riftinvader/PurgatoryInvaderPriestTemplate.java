 ...
 */
public class PurgatoryInvaderPriestTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21710;

	@Inject
	protected PurgatoryInvaderPriestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Purgatory Invader Priest";
