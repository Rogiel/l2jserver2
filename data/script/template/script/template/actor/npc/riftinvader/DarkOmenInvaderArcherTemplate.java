 ...
 */
public class DarkOmenInvaderArcherTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21753;

	@Inject
	protected DarkOmenInvaderArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Omen Invader Archer";
