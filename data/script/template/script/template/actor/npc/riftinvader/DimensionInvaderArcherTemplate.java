 ...
 */
public class DimensionInvaderArcherTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21684;

	@Inject
	protected DimensionInvaderArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dimension Invader Archer";
