 ...
 */
public class MessengerInvaderWarriorTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21782;

	@Inject
	protected MessengerInvaderWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
