 ...
 */
public class PurgatoryInvaderSoldier3Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21714;

	@Inject
	protected PurgatoryInvaderSoldier3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
