 ...
 */
public class DarkOmenInvaderWarrior2Template extends RiftInvaderNPCTemplate {
	public static final int ID = 21768;

	@Inject
	protected DarkOmenInvaderWarrior2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Omen Invader Warrior";
