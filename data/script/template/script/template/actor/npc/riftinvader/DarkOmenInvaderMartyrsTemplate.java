 ...
 */
public class DarkOmenInvaderMartyrsTemplate extends RiftInvaderNPCTemplate {
	public static final int ID = 21758;

	@Inject
	protected DarkOmenInvaderMartyrsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Omen Invader Martyrs";
