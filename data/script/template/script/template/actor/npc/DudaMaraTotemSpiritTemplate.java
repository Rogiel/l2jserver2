 ...
 */
public class DudaMaraTotemSpiritTemplate extends NPCTemplate {
	public static final int ID = 30593;

	@Inject
	protected DudaMaraTotemSpiritTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
