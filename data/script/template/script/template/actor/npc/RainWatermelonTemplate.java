 ...
 */
public class RainWatermelonTemplate extends NPCTemplate {
	public static final int ID = 13273;

	@Inject
	protected RainWatermelonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rain Watermelon";
