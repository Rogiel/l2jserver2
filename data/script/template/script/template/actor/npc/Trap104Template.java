 ...
 */
public class Trap104Template extends NPCTemplate {
	public static final int ID = 18389;

	@Inject
	protected Trap104Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
