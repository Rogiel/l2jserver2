 ...
 */
public class ParinaTemplate extends NPCTemplate {
	public static final int ID = 30391;

	@Inject
	protected ParinaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
