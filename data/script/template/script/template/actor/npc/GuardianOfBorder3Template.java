 ...
 */
public class GuardianOfBorder3Template extends NPCTemplate {
	public static final int ID = 31867;

	@Inject
	protected GuardianOfBorder3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
