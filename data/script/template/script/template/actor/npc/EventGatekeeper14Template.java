 ...
 */
public class EventGatekeeper14Template extends NPCTemplate {
	public static final int ID = 31767;

	@Inject
	protected EventGatekeeper14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
