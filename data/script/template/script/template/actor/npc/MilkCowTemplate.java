 ...
 */
public class MilkCowTemplate extends NPCTemplate {
	public static final int ID = 13187;

	@Inject
	protected MilkCowTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
