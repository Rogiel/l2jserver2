 ...
 */
public class SsqForPresentationCameraDummy2Template extends NPCTemplate {
	public static final int ID = 18831;

	@Inject
	protected SsqForPresentationCameraDummy2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "ssq For Presentation Camera Dummy 2";
