 ...
 */
public class ColinTemplate extends NPCTemplate {
	public static final int ID = 30703;

	@Inject
	protected ColinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
