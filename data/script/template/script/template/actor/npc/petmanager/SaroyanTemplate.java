 ...
 */
public class SaroyanTemplate extends PetManagerNPCTemplate {
	public static final int ID = 31954;

	@Inject
	protected SaroyanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
