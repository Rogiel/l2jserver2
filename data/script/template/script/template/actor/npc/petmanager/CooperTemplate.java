 ...
 */
public class CooperTemplate extends PetManagerNPCTemplate {
	public static final int ID = 30829;

	@Inject
	protected CooperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
