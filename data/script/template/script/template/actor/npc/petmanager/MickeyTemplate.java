 ...
 */
public class MickeyTemplate extends PetManagerNPCTemplate {
	public static final int ID = 36478;

	@Inject
	protected MickeyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mickey";
		this.serverSideName = false;
		this.title = "Pet Trader";
