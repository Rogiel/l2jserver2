 ...
 */
public class RoodTemplate extends PetManagerNPCTemplate {
	public static final int ID = 31067;

	@Inject
	protected RoodTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
