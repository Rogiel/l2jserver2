 ...
 */
public class WoodsTemplate extends PetManagerNPCTemplate {
	public static final int ID = 31309;

	@Inject
	protected WoodsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
