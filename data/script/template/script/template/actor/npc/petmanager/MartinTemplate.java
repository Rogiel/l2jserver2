 ...
 */
public class MartinTemplate extends PetManagerNPCTemplate {
	public static final int ID = 30731;

	@Inject
	protected MartinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
