 ...
 */
public class NelsonTemplate extends PetManagerNPCTemplate {
	public static final int ID = 30831;

	@Inject
	protected NelsonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
