 ...
 */
public class LundyTemplate extends PetManagerNPCTemplate {
	public static final int ID = 30827;

	@Inject
	protected LundyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
