 ...
 */
public class WatersTemplate extends PetManagerNPCTemplate {
	public static final int ID = 30828;

	@Inject
	protected WatersTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
