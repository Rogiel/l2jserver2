 ...
 */
public class LemperTemplate extends PetManagerNPCTemplate {
	public static final int ID = 30869;

	@Inject
	protected LemperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
