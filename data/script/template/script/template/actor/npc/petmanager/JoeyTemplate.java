 ...
 */
public class JoeyTemplate extends PetManagerNPCTemplate {
	public static final int ID = 30830;

	@Inject
	protected JoeyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
