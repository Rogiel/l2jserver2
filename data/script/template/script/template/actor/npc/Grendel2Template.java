 ...
 */
public class Grendel2Template extends NPCTemplate {
	public static final int ID = 18904;

	@Inject
	protected Grendel2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
