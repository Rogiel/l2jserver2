 ...
 */
public class GuardianOfBorder9Template extends NPCTemplate {
	public static final int ID = 31873;

	@Inject
	protected GuardianOfBorder9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
