 ...
 */
public class MonsterRaceGuide3Template extends NPCTemplate {
	public static final int ID = 31406;

	@Inject
	protected MonsterRaceGuide3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Monster Race Guide";
		this.serverSideName = false;
		this.title = "Town of Giran";
