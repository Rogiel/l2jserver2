 ...
 */
public class MissQueen3Template extends NPCTemplate {
	public static final int ID = 31761;

	@Inject
	protected MissQueen3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
