 ...
 */
public class TorrantTemplate extends NPCTemplate {
	public static final int ID = 32016;

	@Inject
	protected TorrantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Torrant";
		this.serverSideName = false;
		this.title = "Beacon Tower Manager";
