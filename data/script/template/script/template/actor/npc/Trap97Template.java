 ...
 */
public class Trap97Template extends NPCTemplate {
	public static final int ID = 18382;

	@Inject
	protected Trap97Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
