 ...
 */
public class LightOfDawn2Template extends NPCTemplate {
	public static final int ID = 32575;

	@Inject
	protected LightOfDawn2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
