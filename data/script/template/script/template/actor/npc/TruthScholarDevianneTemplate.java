 ...
 */
public class TruthScholarDevianneTemplate extends NPCTemplate {
	public static final int ID = 31590;

	@Inject
	protected TruthScholarDevianneTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Truth Scholar Devianne";
