 ...
 */
public class Trap30Template extends NPCTemplate {
	public static final int ID = 13066;

	@Inject
	protected Trap30Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
