 ...
 */
public class DestroyedDeviceTemplate extends NPCTemplate {
	public static final int ID = 32366;

	@Inject
	protected DestroyedDeviceTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Destroyed Device";
