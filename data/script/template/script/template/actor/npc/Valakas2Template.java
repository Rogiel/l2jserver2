 ...
 */
public class Valakas2Template extends NPCTemplate {
	public static final int ID = 32123;

	@Inject
	protected Valakas2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
