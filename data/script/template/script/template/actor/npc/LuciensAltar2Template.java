 ...
 */
public class LuciensAltar2Template extends NPCTemplate {
	public static final int ID = 32707;

	@Inject
	protected LuciensAltar2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lucien's Altar";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 90.00;
