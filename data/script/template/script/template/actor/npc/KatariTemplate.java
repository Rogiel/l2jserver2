 ...
 */
public class KatariTemplate extends NPCTemplate {
	public static final int ID = 30668;

	@Inject
	protected KatariTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
