 ...
 */
public class TarkaiZuDudaMaraTemplate extends NPCTemplate {
	public static final int ID = 31642;

	@Inject
	protected TarkaiZuDudaMaraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tarkai Zu Duda-Mara";
