 ...
 */
public class MissQueen8Template extends NPCTemplate {
	public static final int ID = 31766;

	@Inject
	protected MissQueen8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
