 ...
 */
public class GhostOfAdventurerTemplate extends NPCTemplate {
	public static final int ID = 31529;

	@Inject
	protected GhostOfAdventurerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
