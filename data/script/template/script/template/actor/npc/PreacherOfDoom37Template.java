 ...
 */
public class PreacherOfDoom37Template extends NPCTemplate {
	public static final int ID = 31717;

	@Inject
	protected PreacherOfDoom37Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
