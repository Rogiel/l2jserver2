 ...
 */
public class YoungChildTemplate extends NPCTemplate {
	public static final int ID = 13158;

	@Inject
	protected YoungChildTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
