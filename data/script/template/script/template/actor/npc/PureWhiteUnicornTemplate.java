 ...
 */
public class PureWhiteUnicornTemplate extends NPCTemplate {
	public static final int ID = 31747;

	@Inject
	protected PureWhiteUnicornTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Pure White Unicorn";
