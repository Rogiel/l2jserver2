 ...
 */
public class ParmeTemplate extends NPCTemplate {
	public static final int ID = 32271;

	@Inject
	protected ParmeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
