 ...
 */
public class PranaTemplate extends PriestVillageMasterNPCTemplate {
	public static final int ID = 32153;

	@Inject
	protected PranaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
