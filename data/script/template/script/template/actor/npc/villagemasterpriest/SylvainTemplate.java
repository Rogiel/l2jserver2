 ...
 */
public class SylvainTemplate extends PriestVillageMasterNPCTemplate {
	public static final int ID = 30070;

	@Inject
	protected SylvainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
