 ...
 */
public class BarylTemplate extends PriestVillageMasterNPCTemplate {
	public static final int ID = 31968;

	@Inject
	protected BarylTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
