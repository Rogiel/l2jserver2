 ...
 */
public class HollintTemplate extends PriestVillageMasterNPCTemplate {
	public static final int ID = 30191;

	@Inject
	protected HollintTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
