 ...
 */
public class LevianTemplate extends PriestVillageMasterNPCTemplate {
	public static final int ID = 30037;

	@Inject
	protected LevianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Levian";
		this.serverSideName = false;
		this.title = "High Priestess";
