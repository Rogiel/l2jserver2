 ...
 */
public class SquillariTemplate extends PriestVillageMasterNPCTemplate {
	public static final int ID = 30905;

	@Inject
	protected SquillariTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
