 ...
 */
public class MarieTemplate extends PriestVillageMasterNPCTemplate {
	public static final int ID = 32095;

	@Inject
	protected MarieTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
