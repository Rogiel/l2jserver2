 ...
 */
public class GregoryTemplate extends PriestVillageMasterNPCTemplate {
	public static final int ID = 31279;

	@Inject
	protected GregoryTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
