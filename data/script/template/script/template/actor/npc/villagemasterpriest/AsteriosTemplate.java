 ...
 */
public class AsteriosTemplate extends PriestVillageMasterNPCTemplate {
	public static final int ID = 30154;

	@Inject
	protected AsteriosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
