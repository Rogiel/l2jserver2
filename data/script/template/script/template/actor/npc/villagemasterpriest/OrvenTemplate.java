 ...
 */
public class OrvenTemplate extends PriestVillageMasterNPCTemplate {
	public static final int ID = 30857;

	@Inject
	protected OrvenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
