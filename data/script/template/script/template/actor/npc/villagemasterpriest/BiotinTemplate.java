 ...
 */
public class BiotinTemplate extends PriestVillageMasterNPCTemplate {
	public static final int ID = 30031;

	@Inject
	protected BiotinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
