 ...
 */
public class MaximilianTemplate extends PriestVillageMasterNPCTemplate {
	public static final int ID = 30120;

	@Inject
	protected MaximilianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
