 ...
 */
public class RaymondTemplate extends PriestVillageMasterNPCTemplate {
	public static final int ID = 30289;

	@Inject
	protected RaymondTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
