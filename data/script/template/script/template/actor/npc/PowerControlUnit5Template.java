 ...
 */
public class PowerControlUnit5Template extends NPCTemplate {
	public static final int ID = 35813;

	@Inject
	protected PowerControlUnit5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
