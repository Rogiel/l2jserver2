 ...
 */
public class GeraldTemplate extends NPCTemplate {
	public static final int ID = 30650;

	@Inject
	protected GeraldTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
