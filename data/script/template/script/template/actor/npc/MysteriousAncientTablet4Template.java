 ...
 */
public class MysteriousAncientTablet4Template extends NPCTemplate {
	public static final int ID = 31551;

	@Inject
	protected MysteriousAncientTablet4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
