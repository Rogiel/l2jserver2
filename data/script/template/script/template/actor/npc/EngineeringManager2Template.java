 ...
 */
public class EngineeringManager2Template extends NPCTemplate {
	public static final int ID = 35695;

	@Inject
	protected EngineeringManager2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
