 ...
 */
public class DimensionalGateKeeper8Template extends NPCTemplate {
	public static final int ID = 31501;

	@Inject
	protected DimensionalGateKeeper8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
