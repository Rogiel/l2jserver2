 ...
 */
public class TrainingDummyTemplate extends NPCTemplate {
	public static final int ID = 31691;

	@Inject
	protected TrainingDummyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
