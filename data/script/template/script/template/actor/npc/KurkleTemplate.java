 ...
 */
public class KurkleTemplate extends NPCTemplate {
	public static final int ID = 32545;

	@Inject
	protected KurkleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
