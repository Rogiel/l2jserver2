 ...
 */
public class SeedOfGenerationTemplate extends NPCTemplate {
	public static final int ID = 32544;

	@Inject
	protected SeedOfGenerationTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Seed of Generation";
		this.serverSideName = false;
		this.title = "Artificial";
