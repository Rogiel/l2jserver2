 ...
 */
public class SolomonTemplate extends NPCTemplate {
	public static final int ID = 32355;

	@Inject
	protected SolomonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
