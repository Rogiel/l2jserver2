 ...
 */
public class CrestOfDuskTemplate extends NPCTemplate {
	public static final int ID = 31171;

	@Inject
	protected CrestOfDuskTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Crest of Dusk";
