 ...
 */
public class DivineWizardTemplate extends NPCTemplate {
	public static final int ID = 13116;

	@Inject
	protected DivineWizardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Divine Wizard";
