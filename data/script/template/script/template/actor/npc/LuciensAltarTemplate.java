 ...
 */
public class LuciensAltarTemplate extends NPCTemplate {
	public static final int ID = 32706;

	@Inject
	protected LuciensAltarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
