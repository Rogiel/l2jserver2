 ...
 */
public class NoilessTemplate extends NPCTemplate {
	public static final int ID = 32551;

	@Inject
	protected NoilessTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
