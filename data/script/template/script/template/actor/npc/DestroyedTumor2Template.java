 ...
 */
public class DestroyedTumor2Template extends NPCTemplate {
	public static final int ID = 32531;

	@Inject
	protected DestroyedTumor2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
