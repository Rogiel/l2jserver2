 ...
 */
public class KamaelGatekeeperTemplate extends NPCTemplate {
	public static final int ID = 18441;

	@Inject
	protected KamaelGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kamael Gatekeeper";
