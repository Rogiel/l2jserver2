 ...
 */
public class HeavenlyBridgeKeeperTemplate extends NPCTemplate {
	public static final int ID = 32728;

	@Inject
	protected HeavenlyBridgeKeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Heavenly Bridge Keeper";
