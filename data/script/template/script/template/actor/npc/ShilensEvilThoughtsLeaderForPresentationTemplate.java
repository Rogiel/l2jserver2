 ...
 */
public class ShilensEvilThoughtsLeaderForPresentationTemplate extends NPCTemplate {
	public static final int ID = 18829;

	@Inject
	protected ShilensEvilThoughtsLeaderForPresentationTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shilen's Evil Thoughts Leader For Presentation";
