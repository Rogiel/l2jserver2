 ...
 */
public class NepalSnowAgathionTemplate extends NPCTemplate {
	public static final int ID = 1557;

	@Inject
	protected NepalSnowAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nepal Snow Agathion";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 10.50;
