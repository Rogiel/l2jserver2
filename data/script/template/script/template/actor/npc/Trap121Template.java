 ...
 */
public class Trap121Template extends NPCTemplate {
	public static final int ID = 18406;

	@Inject
	protected Trap121Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
