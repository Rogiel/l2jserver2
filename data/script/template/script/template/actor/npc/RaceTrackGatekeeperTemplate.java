 ...
 */
public class RaceTrackGatekeeperTemplate extends NPCTemplate {
	public static final int ID = 31210;

	@Inject
	protected RaceTrackGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Race Track Gatekeeper";
