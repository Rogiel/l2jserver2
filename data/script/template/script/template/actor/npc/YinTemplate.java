 ...
 */
public class YinTemplate extends NPCTemplate {
	public static final int ID = 32325;

	@Inject
	protected YinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
