 ...
 */
public class HellboundInsurgentTemplate extends NPCTemplate {
	public static final int ID = 32363;

	@Inject
	protected HellboundInsurgentTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Hellbound Insurgent";
