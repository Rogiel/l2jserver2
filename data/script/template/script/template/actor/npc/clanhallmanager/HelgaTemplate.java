 ...
 */
public class HelgaTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35463;

	@Inject
	protected HelgaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
