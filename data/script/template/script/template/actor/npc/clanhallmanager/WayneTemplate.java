 ...
 */
public class WayneTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35568;

	@Inject
	protected WayneTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
