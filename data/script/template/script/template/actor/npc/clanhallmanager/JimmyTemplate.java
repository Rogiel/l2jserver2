 ...
 */
public class JimmyTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35572;

	@Inject
	protected JimmyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
