 ...
 */
public class SethTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35407;

	@Inject
	protected SethTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
