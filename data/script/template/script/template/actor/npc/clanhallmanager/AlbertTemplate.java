 ...
 */
public class AlbertTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35445;

	@Inject
	protected AlbertTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
