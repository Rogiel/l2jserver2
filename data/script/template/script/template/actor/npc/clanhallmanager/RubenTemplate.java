 ...
 */
public class RubenTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35398;

	@Inject
	protected RubenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
