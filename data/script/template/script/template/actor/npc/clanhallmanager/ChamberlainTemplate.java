 ...
 */
public class ChamberlainTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35438;

	@Inject
	protected ChamberlainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
