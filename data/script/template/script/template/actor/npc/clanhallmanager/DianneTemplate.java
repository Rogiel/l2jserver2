 ...
 */
public class DianneTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35441;

	@Inject
	protected DianneTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
