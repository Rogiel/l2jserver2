 ...
 */
public class SerenaTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35586;

	@Inject
	protected SerenaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
