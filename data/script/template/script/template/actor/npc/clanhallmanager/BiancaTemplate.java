 ...
 */
public class BiancaTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35455;

	@Inject
	protected BiancaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
