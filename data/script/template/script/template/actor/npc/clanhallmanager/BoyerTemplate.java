 ...
 */
public class BoyerTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35386;

	@Inject
	protected BoyerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
