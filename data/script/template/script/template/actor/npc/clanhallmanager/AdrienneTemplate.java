 ...
 */
public class AdrienneTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35453;

	@Inject
	protected AdrienneTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
