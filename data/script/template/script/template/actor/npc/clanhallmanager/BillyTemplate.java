 ...
 */
public class BillyTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35584;

	@Inject
	protected BillyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
