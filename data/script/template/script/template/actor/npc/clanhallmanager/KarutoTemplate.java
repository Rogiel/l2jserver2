 ...
 */
public class KarutoTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35578;

	@Inject
	protected KarutoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
