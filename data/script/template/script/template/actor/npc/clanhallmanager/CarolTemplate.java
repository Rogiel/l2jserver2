 ...
 */
public class CarolTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35580;

	@Inject
	protected CarolTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
