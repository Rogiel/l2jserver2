 ...
 */
public class MichaelTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35574;

	@Inject
	protected MichaelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
