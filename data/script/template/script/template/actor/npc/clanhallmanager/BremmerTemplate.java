 ...
 */
public class BremmerTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35392;

	@Inject
	protected BremmerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
