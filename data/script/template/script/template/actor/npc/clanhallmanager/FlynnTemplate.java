 ...
 */
public class FlynnTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35405;

	@Inject
	protected FlynnTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
