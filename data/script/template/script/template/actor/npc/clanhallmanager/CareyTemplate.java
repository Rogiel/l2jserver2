 ...
 */
public class CareyTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35439;

	@Inject
	protected CareyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
