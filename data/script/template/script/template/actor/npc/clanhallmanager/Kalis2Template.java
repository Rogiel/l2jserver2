 ...
 */
public class Kalis2Template extends ClanhallManagerNPCTemplate {
	public static final int ID = 35394;

	@Inject
	protected Kalis2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
