 ...
 */
public class RonTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35403;

	@Inject
	protected RonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
