 ...
 */
public class RonaldTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35566;

	@Inject
	protected RonaldTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
