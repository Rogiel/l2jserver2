 ...
 */
public class KorgenTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35447;

	@Inject
	protected KorgenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
