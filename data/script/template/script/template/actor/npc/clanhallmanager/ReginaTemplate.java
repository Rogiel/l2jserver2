 ...
 */
public class ReginaTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35459;

	@Inject
	protected ReginaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
