 ...
 */
public class EmmaTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35451;

	@Inject
	protected EmmaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
