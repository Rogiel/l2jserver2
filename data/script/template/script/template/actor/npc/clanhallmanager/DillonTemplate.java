 ...
 */
public class DillonTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35390;

	@Inject
	protected DillonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
