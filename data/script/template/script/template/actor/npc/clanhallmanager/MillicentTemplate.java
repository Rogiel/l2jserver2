 ...
 */
public class MillicentTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35465;

	@Inject
	protected MillicentTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
