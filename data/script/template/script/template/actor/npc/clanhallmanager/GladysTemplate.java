 ...
 */
public class GladysTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35457;

	@Inject
	protected GladysTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
