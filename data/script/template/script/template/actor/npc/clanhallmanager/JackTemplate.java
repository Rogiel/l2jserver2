 ...
 */
public class JackTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35576;

	@Inject
	protected JackTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
