 ...
 */
public class DimaggioTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35449;

	@Inject
	protected DimaggioTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
