 ...
 */
public class Black2Template extends ClanhallManagerNPCTemplate {
	public static final int ID = 35384;

	@Inject
	protected Black2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
