 ...
 */
public class StanleyTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35582;

	@Inject
	protected StanleyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
