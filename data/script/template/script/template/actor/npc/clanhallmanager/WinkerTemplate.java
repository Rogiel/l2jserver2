 ...
 */
public class WinkerTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35396;

	@Inject
	protected WinkerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
