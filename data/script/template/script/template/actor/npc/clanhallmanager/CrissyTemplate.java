 ...
 */
public class CrissyTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35443;

	@Inject
	protected CrissyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
