 ...
 */
public class HornerTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35400;

	@Inject
	protected HornerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
