 ...
 */
public class TimTemplate extends ClanhallManagerNPCTemplate {
	public static final int ID = 35388;

	@Inject
	protected TimTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
