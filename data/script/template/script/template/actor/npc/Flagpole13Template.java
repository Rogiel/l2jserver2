 ...
 */
public class Flagpole13Template extends NPCTemplate {
	public static final int ID = 36071;

	@Inject
	protected Flagpole13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
