 ...
 */
public class DummyBoyCTemplate extends NPCTemplate {
	public static final int ID = 31392;

	@Inject
	protected DummyBoyCTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dummy  - Boy C";
