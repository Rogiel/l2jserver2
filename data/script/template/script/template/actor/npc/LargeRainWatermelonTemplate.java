 ...
 */
public class LargeRainWatermelonTemplate extends NPCTemplate {
	public static final int ID = 13274;

	@Inject
	protected LargeRainWatermelonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Large Rain Watermelon";
