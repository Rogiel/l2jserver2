 ...
 */
public class WingTowTemplate extends NPCTemplate {
	public static final int ID = 13166;

	@Inject
	protected WingTowTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
