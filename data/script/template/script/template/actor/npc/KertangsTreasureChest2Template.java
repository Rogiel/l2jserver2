 ...
 */
public class KertangsTreasureChest2Template extends NPCTemplate {
	public static final int ID = 18535;

	@Inject
	protected KertangsTreasureChest2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
