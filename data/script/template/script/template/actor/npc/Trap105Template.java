 ...
 */
public class Trap105Template extends NPCTemplate {
	public static final int ID = 18390;

	@Inject
	protected Trap105Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
