 ...
 */
public class InspectorSinaiTemplate extends NPCTemplate {
	public static final int ID = 32500;

	@Inject
	protected InspectorSinaiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Inspector Sinai";
