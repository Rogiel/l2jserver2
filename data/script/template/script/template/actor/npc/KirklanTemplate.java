 ...
 */
public class KirklanTemplate extends NPCTemplate {
	public static final int ID = 32550;

	@Inject
	protected KirklanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kirklan";
		this.serverSideName = false;
		this.title = "Special Product Broker";
