 ...
 */
public class SpecialEnvoyTemplate extends FortEnvoyNPCTemplate {
	public static final int ID = 36393;

	@Inject
	protected SpecialEnvoyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
