 ...
 */
public class Foreman10Template extends FortManagerNPCTemplate {
	public static final int ID = 35965;

	@Inject
	protected Foreman10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
