 ...
 */
public class Doorman28Template extends FortDoormenNPCTemplate {
	public static final int ID = 35905;

	@Inject
	protected Doorman28Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
