 ...
 */
public class Doorman43Template extends FortDoormenNPCTemplate {
	public static final int ID = 36082;

	@Inject
	protected Doorman43Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
