 ...
 */
public class Doorman31Template extends FortDoormenNPCTemplate {
	public static final int ID = 35937;

	@Inject
	protected Doorman31Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
