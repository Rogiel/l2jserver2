 ...
 */
public class SupportUnitCaptainTemplate extends FortSupportCaptainNPCTemplate {
	public static final int ID = 35662;

	@Inject
	protected SupportUnitCaptainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
