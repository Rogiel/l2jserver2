 ...
 */
public class Doorman22Template extends FortDoormenNPCTemplate {
	public static final int ID = 35836;

	@Inject
	protected Doorman22Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
