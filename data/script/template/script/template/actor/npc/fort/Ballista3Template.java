 ...
 */
public class Ballista3Template extends FortBallistaNPCTemplate {
	public static final int ID = 35754;

	@Inject
	protected Ballista3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
