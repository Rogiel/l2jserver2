 ...
 */
public class LogisticsOfficer7Template extends FortLogisticsNPCTemplate {
	public static final int ID = 35865;

	@Inject
	protected LogisticsOfficer7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
