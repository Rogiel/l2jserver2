 ...
 */
public class Doorman56Template extends FortDoormenNPCTemplate {
	public static final int ID = 36221;

	@Inject
	protected Doorman56Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
