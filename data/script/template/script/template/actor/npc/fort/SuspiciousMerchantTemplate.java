 ...
 */
public class SuspiciousMerchantTemplate extends FortSiegeNPCTemplate {
	public static final int ID = 35659;

	@Inject
	protected SuspiciousMerchantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
