 ...
 */
public class SupportUnitCaptain9Template extends FortSupportCaptainNPCTemplate {
	public static final int ID = 35800;

	@Inject
	protected SupportUnitCaptain9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
