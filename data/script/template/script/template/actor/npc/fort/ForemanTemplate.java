 ...
 */
public class ForemanTemplate extends FortManagerNPCTemplate {
	public static final int ID = 35658;

	@Inject
	protected ForemanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
