 ...
 */
public class WyvernManager6Template extends FortWyvernManagerNPCTemplate {
	public static final int ID = 36462;

	@Inject
	protected WyvernManager6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
