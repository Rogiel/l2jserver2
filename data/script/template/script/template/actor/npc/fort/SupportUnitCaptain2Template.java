 ...
 */
public class SupportUnitCaptain2Template extends FortCommanderNPCTemplate {
	public static final int ID = 35680;

	@Inject
	protected SupportUnitCaptain2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
