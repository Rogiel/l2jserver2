 ...
 */
public class ArcherCaptain6Template extends FortCommanderNPCTemplate {
	public static final int ID = 35752;

	@Inject
	protected ArcherCaptain6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
