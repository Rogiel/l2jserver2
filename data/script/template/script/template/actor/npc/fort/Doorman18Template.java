 ...
 */
public class Doorman18Template extends FortDoormenNPCTemplate {
	public static final int ID = 35770;

	@Inject
	protected Doorman18Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
