 ...
 */
public class SpecialEnvoy16Template extends FortEnvoyNPCTemplate {
	public static final int ID = 36439;

	@Inject
	protected SpecialEnvoy16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
