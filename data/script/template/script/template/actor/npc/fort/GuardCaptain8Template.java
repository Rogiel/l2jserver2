 ...
 */
public class GuardCaptain8Template extends FortCommanderNPCTemplate {
	public static final int ID = 35782;

	@Inject
	protected GuardCaptain8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
