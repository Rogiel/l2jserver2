 ...
 */
public class Doorman67Template extends FortDoormenNPCTemplate {
	public static final int ID = 36365;

	@Inject
	protected Doorman67Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
