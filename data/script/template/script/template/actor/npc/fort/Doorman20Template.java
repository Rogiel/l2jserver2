 ...
 */
public class Doorman20Template extends FortDoormenNPCTemplate {
	public static final int ID = 35806;

	@Inject
	protected Doorman20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
