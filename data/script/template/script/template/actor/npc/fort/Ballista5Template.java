 ...
 */
public class Ballista5Template extends FortBallistaNPCTemplate {
	public static final int ID = 35823;

	@Inject
	protected Ballista5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
