 ...
 */
public class ArcherCaptain4Template extends FortCommanderNPCTemplate {
	public static final int ID = 35719;

	@Inject
	protected ArcherCaptain4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
