...
import com.l2jserver.model.template.npc.FortLogisticsNPCTemplate;
import com.l2jserver.model.world.Actor.ActorSex;

/**
 * @author <a href="http://www.rogiel.com">Rogiel</a>
 */
public class LogisticsOfficer19Template extends FortLogisticsNPCTemplate {
	public static final int ID = 36292;

	@Inject
	protected LogisticsOfficer19Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Logistics Officer";
