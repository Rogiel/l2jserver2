 ...
 */
public class Doorman14Template extends FortDoormenNPCTemplate {
	public static final int ID = 35737;

	@Inject
	protected Doorman14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
