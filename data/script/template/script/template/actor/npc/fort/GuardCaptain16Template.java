 ...
 */
public class GuardCaptain16Template extends FortCommanderNPCTemplate {
	public static final int ID = 35915;

	@Inject
	protected GuardCaptain16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
