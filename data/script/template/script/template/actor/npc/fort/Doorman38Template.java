 ...
 */
public class Doorman38Template extends FortDoormenNPCTemplate {
	public static final int ID = 36013;

	@Inject
	protected Doorman38Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
