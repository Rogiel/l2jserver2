 ...
 */
public class ArcherCaptain2Template extends FortCommanderNPCTemplate {
	public static final int ID = 35683;

	@Inject
	protected ArcherCaptain2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
