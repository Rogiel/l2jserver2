 ...
 */
public class Doorman17Template extends FortDoormenNPCTemplate {
	public static final int ID = 35769;

	@Inject
	protected Doorman17Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
