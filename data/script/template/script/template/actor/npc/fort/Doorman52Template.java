 ...
 */
public class Doorman52Template extends FortDoormenNPCTemplate {
	public static final int ID = 36182;

	@Inject
	protected Doorman52Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
