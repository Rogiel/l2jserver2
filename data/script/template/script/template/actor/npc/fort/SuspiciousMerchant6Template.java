 ...
 */
public class SuspiciousMerchant6Template extends FortSiegeNPCTemplate {
	public static final int ID = 35828;

	@Inject
	protected SuspiciousMerchant6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
