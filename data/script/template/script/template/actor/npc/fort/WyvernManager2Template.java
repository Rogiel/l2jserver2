 ...
 */
public class WyvernManager2Template extends FortWyvernManagerNPCTemplate {
	public static final int ID = 36458;

	@Inject
	protected WyvernManager2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
