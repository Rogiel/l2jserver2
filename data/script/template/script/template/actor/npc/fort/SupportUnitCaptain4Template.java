 ...
 */
public class SupportUnitCaptain4Template extends FortCommanderNPCTemplate {
	public static final int ID = 35716;

	@Inject
	protected SupportUnitCaptain4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
