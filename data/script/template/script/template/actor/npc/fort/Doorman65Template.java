 ...
 */
public class Doorman65Template extends FortDoormenNPCTemplate {
	public static final int ID = 36328;

	@Inject
	protected Doorman65Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
