 ...
 */
public class Foreman9Template extends FortManagerNPCTemplate {
	public static final int ID = 35927;

	@Inject
	protected Foreman9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
