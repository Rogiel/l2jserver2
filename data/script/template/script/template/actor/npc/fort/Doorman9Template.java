 ...
 */
public class Doorman9Template extends FortDoormenNPCTemplate {
	public static final int ID = 35669;

	@Inject
	protected Doorman9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
