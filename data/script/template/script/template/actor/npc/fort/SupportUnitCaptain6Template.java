 ...
 */
public class SupportUnitCaptain6Template extends FortCommanderNPCTemplate {
	public static final int ID = 35749;

	@Inject
	protected SupportUnitCaptain6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
