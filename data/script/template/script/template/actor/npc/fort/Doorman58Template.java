 ...
 */
public class Doorman58Template extends FortDoormenNPCTemplate {
	public static final int ID = 36258;

	@Inject
	protected Doorman58Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
