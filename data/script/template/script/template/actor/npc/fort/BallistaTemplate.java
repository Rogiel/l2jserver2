 ...
 */
public class BallistaTemplate extends FortBallistaNPCTemplate {
	public static final int ID = 35685;

	@Inject
	protected BallistaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
