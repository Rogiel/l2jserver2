 ...
 */
public class SpecialEnvoy6Template extends FortEnvoyNPCTemplate {
	public static final int ID = 36398;

	@Inject
	protected SpecialEnvoy6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
