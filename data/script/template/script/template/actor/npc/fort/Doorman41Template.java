 ...
 */
public class Doorman41Template extends FortDoormenNPCTemplate {
	public static final int ID = 36045;

	@Inject
	protected Doorman41Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
