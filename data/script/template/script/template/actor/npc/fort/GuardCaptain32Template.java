 ...
 */
public class GuardCaptain32Template extends FortCommanderNPCTemplate {
	public static final int ID = 36196;

	@Inject
	protected GuardCaptain32Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
