 ...
 */
public class General24Template extends FortCommanderNPCTemplate {
	public static final int ID = 36387;

	@Inject
	protected General24Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
