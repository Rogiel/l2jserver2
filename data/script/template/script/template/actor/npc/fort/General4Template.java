 ...
 */
public class General4Template extends FortCommanderNPCTemplate {
	public static final int ID = 35790;

	@Inject
	protected General4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
