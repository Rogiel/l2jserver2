 ...
 */
public class WyvernManager7Template extends FortWyvernManagerNPCTemplate {
	public static final int ID = 36463;

	@Inject
	protected WyvernManager7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
