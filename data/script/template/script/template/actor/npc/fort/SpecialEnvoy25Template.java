 ...
 */
public class SpecialEnvoy25Template extends FortEnvoyNPCTemplate {
	public static final int ID = 36448;

	@Inject
	protected SpecialEnvoy25Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
