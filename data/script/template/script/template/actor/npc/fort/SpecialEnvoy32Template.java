 ...
 */
public class SpecialEnvoy32Template extends FortEnvoyNPCTemplate {
	public static final int ID = 36455;

	@Inject
	protected SpecialEnvoy32Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
