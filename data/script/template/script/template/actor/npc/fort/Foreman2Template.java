 ...
 */
public class Foreman2Template extends FortManagerNPCTemplate {
	public static final int ID = 35689;

	@Inject
	protected Foreman2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
