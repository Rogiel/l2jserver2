 ...
 */
public class SpecialEnvoy2Template extends FortEnvoyNPCTemplate {
	public static final int ID = 36394;

	@Inject
	protected SpecialEnvoy2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
