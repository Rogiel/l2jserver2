 ...
 */
public class WyvernManager3Template extends FortWyvernManagerNPCTemplate {
	public static final int ID = 36459;

	@Inject
	protected WyvernManager3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
