 ...
 */
public class SuspiciousMerchant9Template extends FortSiegeNPCTemplate {
	public static final int ID = 35928;

	@Inject
	protected SuspiciousMerchant9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
