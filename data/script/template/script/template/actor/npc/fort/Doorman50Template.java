 ...
 */
public class Doorman50Template extends FortDoormenNPCTemplate {
	public static final int ID = 36151;

	@Inject
	protected Doorman50Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
