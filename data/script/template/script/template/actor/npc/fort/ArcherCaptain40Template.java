 ...
 */
public class ArcherCaptain40Template extends FortCommanderNPCTemplate {
	public static final int ID = 36347;

	@Inject
	protected ArcherCaptain40Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
