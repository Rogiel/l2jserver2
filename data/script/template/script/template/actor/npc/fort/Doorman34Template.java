 ...
 */
public class Doorman34Template extends FortDoormenNPCTemplate {
	public static final int ID = 35975;

	@Inject
	protected Doorman34Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
