...
import com.l2jserver.model.template.npc.FortWyvernManagerNPCTemplate;
import com.l2jserver.model.world.Actor.ActorSex;

/**
 * @author <a href="http://www.rogiel.com">Rogiel</a>
 */
public class WyvernManager16Template extends FortWyvernManagerNPCTemplate {
	public static final int ID = 36472;

	@Inject
	protected WyvernManager16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Wyvern Manager";
