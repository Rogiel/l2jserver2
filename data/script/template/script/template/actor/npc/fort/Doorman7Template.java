 ...
 */
public class Doorman7Template extends FortDoormenNPCTemplate {
	public static final int ID = 35667;

	@Inject
	protected Doorman7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
