 ...
 */
public class Ballista2Template extends FortBallistaNPCTemplate {
	public static final int ID = 35723;

	@Inject
	protected Ballista2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
