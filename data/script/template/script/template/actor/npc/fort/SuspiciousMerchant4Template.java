 ...
 */
public class SuspiciousMerchant4Template extends FortSiegeNPCTemplate {
	public static final int ID = 35759;

	@Inject
	protected SuspiciousMerchant4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
