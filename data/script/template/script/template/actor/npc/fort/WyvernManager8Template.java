 ...
 */
public class WyvernManager8Template extends FortWyvernManagerNPCTemplate {
	public static final int ID = 36464;

	@Inject
	protected WyvernManager8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
