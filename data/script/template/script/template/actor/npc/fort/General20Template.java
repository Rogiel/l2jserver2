 ...
 */
public class General20Template extends FortCommanderNPCTemplate {
	public static final int ID = 36280;

	@Inject
	protected General20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
