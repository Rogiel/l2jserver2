 ...
 */
public class GuardCaptain22Template extends FortCommanderNPCTemplate {
	public static final int ID = 36022;

	@Inject
	protected GuardCaptain22Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
