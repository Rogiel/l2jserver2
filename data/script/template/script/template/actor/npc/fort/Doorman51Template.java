 ...
 */
public class Doorman51Template extends FortDoormenNPCTemplate {
	public static final int ID = 36152;

	@Inject
	protected Doorman51Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
