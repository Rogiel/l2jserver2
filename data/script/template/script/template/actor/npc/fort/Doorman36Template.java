 ...
 */
public class Doorman36Template extends FortDoormenNPCTemplate {
	public static final int ID = 35977;

	@Inject
	protected Doorman36Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
