 ...
 */
public class SupportUnitCaptain8Template extends FortCommanderNPCTemplate {
	public static final int ID = 35785;

	@Inject
	protected SupportUnitCaptain8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
