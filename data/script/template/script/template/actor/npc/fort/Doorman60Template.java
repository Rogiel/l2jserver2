 ...
 */
public class Doorman60Template extends FortDoormenNPCTemplate {
	public static final int ID = 36260;

	@Inject
	protected Doorman60Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
