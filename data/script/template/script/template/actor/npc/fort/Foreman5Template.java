 ...
 */
public class Foreman5Template extends FortManagerNPCTemplate {
	public static final int ID = 35796;

	@Inject
	protected Foreman5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
