 ...
 */
public class Ballista9Template extends FortBallistaNPCTemplate {
	public static final int ID = 35961;

	@Inject
	protected Ballista9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
