 ...
 */
public class Foreman8Template extends FortManagerNPCTemplate {
	public static final int ID = 35896;

	@Inject
	protected Foreman8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
