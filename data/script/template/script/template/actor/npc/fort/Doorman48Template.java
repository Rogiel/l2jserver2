 ...
 */
public class Doorman48Template extends FortDoormenNPCTemplate {
	public static final int ID = 36121;

	@Inject
	protected Doorman48Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
