...
import com.l2jserver.model.template.npc.FortSupportCaptainNPCTemplate;
import com.l2jserver.model.world.Actor.ActorSex;

/**
 * @author <a href="http://www.rogiel.com">Rogiel</a>
 */
public class SupportUnitCaptain41Template extends FortSupportCaptainNPCTemplate {
	public static final int ID = 36360;

	@Inject
	protected SupportUnitCaptain41Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Support Unit Captain";
