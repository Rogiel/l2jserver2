 ...
 */
public class General12Template extends FortCommanderNPCTemplate {
	public static final int ID = 36066;

	@Inject
	protected General12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
