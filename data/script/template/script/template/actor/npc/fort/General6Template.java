 ...
 */
public class General6Template extends FortCommanderNPCTemplate {
	public static final int ID = 35890;

	@Inject
	protected General6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
