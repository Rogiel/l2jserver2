 ...
 */
public class Doorman8Template extends FortDoormenNPCTemplate {
	public static final int ID = 35668;

	@Inject
	protected Doorman8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
