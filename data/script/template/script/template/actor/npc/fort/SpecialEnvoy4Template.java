 ...
 */
public class SpecialEnvoy4Template extends FortEnvoyNPCTemplate {
	public static final int ID = 36396;

	@Inject
	protected SpecialEnvoy4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
