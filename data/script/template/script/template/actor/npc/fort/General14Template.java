 ...
 */
public class General14Template extends FortCommanderNPCTemplate {
	public static final int ID = 36104;

	@Inject
	protected General14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
