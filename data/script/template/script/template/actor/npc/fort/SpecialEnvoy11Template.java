...
import com.l2jserver.model.template.npc.FortEnvoyNPCTemplate;
import com.l2jserver.model.world.Actor.ActorSex;

/**
 * @author <a href="http://www.rogiel.com">Rogiel</a>
 */
public class SpecialEnvoy11Template extends FortEnvoyNPCTemplate {
	public static final int ID = 36434;

	@Inject
	protected SpecialEnvoy11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Special Envoy";
