 ...
 */
public class LogisticsOfficerTemplate extends FortLogisticsNPCTemplate {
	public static final int ID = 35664;

	@Inject
	protected LogisticsOfficerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
