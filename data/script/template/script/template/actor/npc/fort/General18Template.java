 ...
 */
public class General18Template extends FortCommanderNPCTemplate {
	public static final int ID = 36242;

	@Inject
	protected General18Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
