 ...
 */
public class General8Template extends FortCommanderNPCTemplate {
	public static final int ID = 35959;

	@Inject
	protected General8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
