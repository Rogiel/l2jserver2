 ...
 */
public class Foreman7Template extends FortManagerNPCTemplate {
	public static final int ID = 35858;

	@Inject
	protected Foreman7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
