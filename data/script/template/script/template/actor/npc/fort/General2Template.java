 ...
 */
public class General2Template extends FortCommanderNPCTemplate {
	public static final int ID = 35721;

	@Inject
	protected General2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
