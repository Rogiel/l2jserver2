 ...
 */
public class SupportUnitCaptain5Template extends FortSupportCaptainNPCTemplate {
	public static final int ID = 35731;

	@Inject
	protected SupportUnitCaptain5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
