 ...
 */
public class Doorman45Template extends FortDoormenNPCTemplate {
	public static final int ID = 36084;

	@Inject
	protected Doorman45Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
