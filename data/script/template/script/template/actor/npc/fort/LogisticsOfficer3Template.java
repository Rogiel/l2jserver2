 ...
 */
public class LogisticsOfficer3Template extends FortLogisticsNPCTemplate {
	public static final int ID = 35733;

	@Inject
	protected LogisticsOfficer3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
