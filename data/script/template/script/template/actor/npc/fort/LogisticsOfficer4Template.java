 ...
 */
public class LogisticsOfficer4Template extends FortLogisticsNPCTemplate {
	public static final int ID = 35765;

	@Inject
	protected LogisticsOfficer4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
