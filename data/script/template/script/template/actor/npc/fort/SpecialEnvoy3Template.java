 ...
 */
public class SpecialEnvoy3Template extends FortEnvoyNPCTemplate {
	public static final int ID = 36395;

	@Inject
	protected SpecialEnvoy3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
