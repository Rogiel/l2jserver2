 ...
 */
public class GuardCaptain20Template extends FortCommanderNPCTemplate {
	public static final int ID = 35989;

	@Inject
	protected GuardCaptain20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
