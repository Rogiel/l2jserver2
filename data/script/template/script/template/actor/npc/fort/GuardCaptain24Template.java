 ...
 */
public class GuardCaptain24Template extends FortCommanderNPCTemplate {
	public static final int ID = 36058;

	@Inject
	protected GuardCaptain24Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
