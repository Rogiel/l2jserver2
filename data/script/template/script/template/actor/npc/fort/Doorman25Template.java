 ...
 */
public class Doorman25Template extends FortDoormenNPCTemplate {
	public static final int ID = 35868;

	@Inject
	protected Doorman25Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
