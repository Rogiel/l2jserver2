 ...
 */
public class GuardCaptain6Template extends FortCommanderNPCTemplate {
	public static final int ID = 35746;

	@Inject
	protected GuardCaptain6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
