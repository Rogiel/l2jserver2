 ...
 */
public class SpecialEnvoy22Template extends FortEnvoyNPCTemplate {
	public static final int ID = 36445;

	@Inject
	protected SpecialEnvoy22Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
