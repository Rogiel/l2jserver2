 ...
 */
public class Doorman39Template extends FortDoormenNPCTemplate {
	public static final int ID = 36014;

	@Inject
	protected Doorman39Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
