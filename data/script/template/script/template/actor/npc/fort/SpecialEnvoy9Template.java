 ...
 */
public class SpecialEnvoy9Template extends FortEnvoyNPCTemplate {
	public static final int ID = 36401;

	@Inject
	protected SpecialEnvoy9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
