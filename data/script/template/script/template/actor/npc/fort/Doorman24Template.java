 ...
 */
public class Doorman24Template extends FortDoormenNPCTemplate {
	public static final int ID = 35838;

	@Inject
	protected Doorman24Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
