 ...
 */
public class LogisticsOfficer9Template extends FortLogisticsNPCTemplate {
	public static final int ID = 35934;

	@Inject
	protected LogisticsOfficer9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
