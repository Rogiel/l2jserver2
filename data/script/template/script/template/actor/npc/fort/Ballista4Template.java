 ...
 */
public class Ballista4Template extends FortBallistaNPCTemplate {
	public static final int ID = 35792;

	@Inject
	protected Ballista4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
