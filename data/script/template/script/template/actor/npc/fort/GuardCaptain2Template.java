 ...
 */
public class GuardCaptain2Template extends FortCommanderNPCTemplate {
	public static final int ID = 35677;

	@Inject
	protected GuardCaptain2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
