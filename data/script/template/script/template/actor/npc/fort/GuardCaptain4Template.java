 ...
 */
public class GuardCaptain4Template extends FortCommanderNPCTemplate {
	public static final int ID = 35713;

	@Inject
	protected GuardCaptain4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
