 ...
 */
public class WyvernManagerTemplate extends FortWyvernManagerNPCTemplate {
	public static final int ID = 36457;

	@Inject
	protected WyvernManagerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
