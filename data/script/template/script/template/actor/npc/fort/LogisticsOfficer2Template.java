 ...
 */
public class LogisticsOfficer2Template extends FortLogisticsNPCTemplate {
	public static final int ID = 35696;

	@Inject
	protected LogisticsOfficer2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
