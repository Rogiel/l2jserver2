 ...
 */
public class WyvernManager4Template extends FortWyvernManagerNPCTemplate {
	public static final int ID = 36460;

	@Inject
	protected WyvernManager4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
