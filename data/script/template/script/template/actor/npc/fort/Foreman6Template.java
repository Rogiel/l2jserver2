 ...
 */
public class Foreman6Template extends FortManagerNPCTemplate {
	public static final int ID = 35827;

	@Inject
	protected Foreman6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
