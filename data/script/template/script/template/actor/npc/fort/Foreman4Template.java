 ...
 */
public class Foreman4Template extends FortManagerNPCTemplate {
	public static final int ID = 35758;

	@Inject
	protected Foreman4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
