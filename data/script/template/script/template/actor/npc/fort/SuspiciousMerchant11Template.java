...
import com.l2jserver.model.template.npc.FortSiegeNPCTemplate;
import com.l2jserver.model.world.Actor.ActorSex;

/**
 * @author <a href="http://www.rogiel.com">Rogiel</a>
 */
public class SuspiciousMerchant11Template extends FortSiegeNPCTemplate {
	public static final int ID = 36004;

	@Inject
	protected SuspiciousMerchant11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Suspicious Merchant";
