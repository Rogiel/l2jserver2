 ...
 */
public class Doorman59Template extends FortDoormenNPCTemplate {
	public static final int ID = 36259;

	@Inject
	protected Doorman59Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
