 ...
 */
public class Foreman3Template extends FortManagerNPCTemplate {
	public static final int ID = 35727;

	@Inject
	protected Foreman3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
