 ...
 */
public class Doorman69Template extends FortDoormenNPCTemplate {
	public static final int ID = 36367;

	@Inject
	protected Doorman69Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
