 ...
 */
public class General10Template extends FortCommanderNPCTemplate {
	public static final int ID = 35997;

	@Inject
	protected General10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
