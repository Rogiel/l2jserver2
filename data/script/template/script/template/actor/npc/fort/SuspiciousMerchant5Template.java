 ...
 */
public class SuspiciousMerchant5Template extends FortSiegeNPCTemplate {
	public static final int ID = 35797;

	@Inject
	protected SuspiciousMerchant5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
