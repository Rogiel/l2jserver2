 ...
 */
public class SpecialEnvoy24Template extends FortEnvoyNPCTemplate {
	public static final int ID = 36447;

	@Inject
	protected SpecialEnvoy24Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
