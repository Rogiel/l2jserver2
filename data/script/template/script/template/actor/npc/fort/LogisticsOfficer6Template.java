 ...
 */
public class LogisticsOfficer6Template extends FortLogisticsNPCTemplate {
	public static final int ID = 35833;

	@Inject
	protected LogisticsOfficer6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
