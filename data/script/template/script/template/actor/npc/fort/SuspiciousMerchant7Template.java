 ...
 */
public class SuspiciousMerchant7Template extends FortSiegeNPCTemplate {
	public static final int ID = 35859;

	@Inject
	protected SuspiciousMerchant7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
