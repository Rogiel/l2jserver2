 ...
 */
public class Doorman40Template extends FortDoormenNPCTemplate {
	public static final int ID = 36044;

	@Inject
	protected Doorman40Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
