 ...
 */
public class SupportUnitCaptain7Template extends FortSupportCaptainNPCTemplate {
	public static final int ID = 35763;

	@Inject
	protected SupportUnitCaptain7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
