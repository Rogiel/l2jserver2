 ...
 */
public class Doorman46Template extends FortDoormenNPCTemplate {
	public static final int ID = 36119;

	@Inject
	protected Doorman46Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
