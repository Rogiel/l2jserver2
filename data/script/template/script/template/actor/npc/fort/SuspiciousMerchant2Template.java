 ...
 */
public class SuspiciousMerchant2Template extends FortSiegeNPCTemplate {
	public static final int ID = 35690;

	@Inject
	protected SuspiciousMerchant2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
