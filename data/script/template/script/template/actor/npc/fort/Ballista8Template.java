 ...
 */
public class Ballista8Template extends FortBallistaNPCTemplate {
	public static final int ID = 35923;

	@Inject
	protected Ballista8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
