 ...
 */
public class SpecialEnvoy5Template extends FortEnvoyNPCTemplate {
	public static final int ID = 36397;

	@Inject
	protected SpecialEnvoy5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
