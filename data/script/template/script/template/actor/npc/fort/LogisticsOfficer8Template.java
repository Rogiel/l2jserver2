 ...
 */
public class LogisticsOfficer8Template extends FortLogisticsNPCTemplate {
	public static final int ID = 35902;

	@Inject
	protected LogisticsOfficer8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
