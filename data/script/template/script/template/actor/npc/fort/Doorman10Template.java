 ...
 */
public class Doorman10Template extends FortDoormenNPCTemplate {
	public static final int ID = 35699;

	@Inject
	protected Doorman10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
