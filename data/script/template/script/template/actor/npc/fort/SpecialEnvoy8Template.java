 ...
 */
public class SpecialEnvoy8Template extends FortEnvoyNPCTemplate {
	public static final int ID = 36400;

	@Inject
	protected SpecialEnvoy8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
