 ...
 */
public class Doorman30Template extends FortDoormenNPCTemplate {
	public static final int ID = 35907;

	@Inject
	protected Doorman30Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
