 ...
 */
public class SpecialEnvoy7Template extends FortEnvoyNPCTemplate {
	public static final int ID = 36399;

	@Inject
	protected SpecialEnvoy7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
