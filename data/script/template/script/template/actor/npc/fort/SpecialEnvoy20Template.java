 ...
 */
public class SpecialEnvoy20Template extends FortEnvoyNPCTemplate {
	public static final int ID = 36443;

	@Inject
	protected SpecialEnvoy20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
