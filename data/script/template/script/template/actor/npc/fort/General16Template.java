 ...
 */
public class General16Template extends FortCommanderNPCTemplate {
	public static final int ID = 36204;

	@Inject
	protected General16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
