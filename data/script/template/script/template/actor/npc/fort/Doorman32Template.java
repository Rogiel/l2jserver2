 ...
 */
public class Doorman32Template extends FortDoormenNPCTemplate {
	public static final int ID = 35938;

	@Inject
	protected Doorman32Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
