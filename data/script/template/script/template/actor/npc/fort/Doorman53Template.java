 ...
 */
public class Doorman53Template extends FortDoormenNPCTemplate {
	public static final int ID = 36183;

	@Inject
	protected Doorman53Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
