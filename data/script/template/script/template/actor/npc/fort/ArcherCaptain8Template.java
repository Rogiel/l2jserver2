 ...
 */
public class ArcherCaptain8Template extends FortCommanderNPCTemplate {
	public static final int ID = 35788;

	@Inject
	protected ArcherCaptain8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
