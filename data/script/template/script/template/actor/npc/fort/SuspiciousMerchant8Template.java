 ...
 */
public class SuspiciousMerchant8Template extends FortSiegeNPCTemplate {
	public static final int ID = 35897;

	@Inject
	protected SuspiciousMerchant8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
