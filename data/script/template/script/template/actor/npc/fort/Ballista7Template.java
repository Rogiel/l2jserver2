 ...
 */
public class Ballista7Template extends FortBallistaNPCTemplate {
	public static final int ID = 35892;

	@Inject
	protected Ballista7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
