 ...
 */
public class GuardCaptain40Template extends FortCommanderNPCTemplate {
	public static final int ID = 36341;

	@Inject
	protected GuardCaptain40Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
