 ...
 */
public class LogisticsOfficer5Template extends FortLogisticsNPCTemplate {
	public static final int ID = 35802;

	@Inject
	protected LogisticsOfficer5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
