 ...
 */
public class Ballista6Template extends FortBallistaNPCTemplate {
	public static final int ID = 35854;

	@Inject
	protected Ballista6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
