 ...
 */
public class WyvernManager9Template extends FortWyvernManagerNPCTemplate {
	public static final int ID = 36465;

	@Inject
	protected WyvernManager9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
