 ...
 */
public class WyvernManager5Template extends FortWyvernManagerNPCTemplate {
	public static final int ID = 36461;

	@Inject
	protected WyvernManager5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
