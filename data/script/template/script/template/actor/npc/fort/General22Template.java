 ...
 */
public class General22Template extends FortCommanderNPCTemplate {
	public static final int ID = 36349;

	@Inject
	protected General22Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
