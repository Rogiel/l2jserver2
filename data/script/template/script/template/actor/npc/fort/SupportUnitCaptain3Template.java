 ...
 */
public class SupportUnitCaptain3Template extends FortSupportCaptainNPCTemplate {
	public static final int ID = 35694;

	@Inject
	protected SupportUnitCaptain3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
