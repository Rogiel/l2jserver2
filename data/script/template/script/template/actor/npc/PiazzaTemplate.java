 ...
 */
public class PiazzaTemplate extends NPCTemplate {
	public static final int ID = 32644;

	@Inject
	protected PiazzaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Piazza";
		this.serverSideName = false;
		this.title = "Expert Summoner";
