 ...
 */
public class MaronTemplate extends NPCTemplate {
	public static final int ID = 30529;

	@Inject
	protected MaronTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
