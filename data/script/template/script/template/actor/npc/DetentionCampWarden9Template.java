 ...
 */
public class DetentionCampWarden9Template extends NPCTemplate {
	public static final int ID = 35936;

	@Inject
	protected DetentionCampWarden9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
