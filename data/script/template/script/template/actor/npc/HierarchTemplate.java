 ...
 */
public class HierarchTemplate extends NPCTemplate {
	public static final int ID = 31517;

	@Inject
	protected HierarchTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
