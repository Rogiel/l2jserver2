 ...
 */
public class DrikoTemplate extends NPCTemplate {
	public static final int ID = 30619;

	@Inject
	protected DrikoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Driko";
		this.serverSideName = false;
		this.title = "Vuku Chief";
