 ...
 */
public class GariachinTemplate extends NPCTemplate {
	public static final int ID = 32112;

	@Inject
	protected GariachinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
