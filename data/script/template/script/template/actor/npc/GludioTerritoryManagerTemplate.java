 ...
 */
public class GludioTerritoryManagerTemplate extends NPCTemplate {
	public static final int ID = 32074;

	@Inject
	protected GludioTerritoryManagerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gludio Territory Manager";
