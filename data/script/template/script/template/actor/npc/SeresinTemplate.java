 ...
 */
public class SeresinTemplate extends NPCTemplate {
	public static final int ID = 30657;

	@Inject
	protected SeresinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
