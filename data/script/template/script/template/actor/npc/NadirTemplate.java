 ...
 */
public class NadirTemplate extends NPCTemplate {
	public static final int ID = 32187;

	@Inject
	protected NadirTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
