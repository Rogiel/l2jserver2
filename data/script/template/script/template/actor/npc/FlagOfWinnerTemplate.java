 ...
 */
public class FlagOfWinnerTemplate extends NPCTemplate {
	public static final int ID = 35422;

	@Inject
	protected FlagOfWinnerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Flag of Winner";
