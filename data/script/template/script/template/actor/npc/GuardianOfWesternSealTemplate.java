 ...
 */
public class GuardianOfWesternSealTemplate extends NPCTemplate {
	public static final int ID = 32659;

	@Inject
	protected GuardianOfWesternSealTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guardian of Western Seal";
