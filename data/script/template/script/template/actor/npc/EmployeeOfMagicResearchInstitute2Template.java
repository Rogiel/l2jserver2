 ...
 */
public class EmployeeOfMagicResearchInstitute2Template extends NPCTemplate {
	public static final int ID = 32476;

	@Inject
	protected EmployeeOfMagicResearchInstitute2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Employee of Magic Research Institute";
		...
		this.rightHand = itemProvider.createID(313);
		this.leftHand = null;
		this.enchantLevel = 0;
