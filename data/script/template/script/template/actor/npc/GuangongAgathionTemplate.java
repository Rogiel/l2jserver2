 ...
 */
public class GuangongAgathionTemplate extends NPCTemplate {
	public static final int ID = 1551;

	@Inject
	protected GuangongAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guangong Agathion";
