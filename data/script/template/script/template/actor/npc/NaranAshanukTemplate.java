 ...
 */
public class NaranAshanukTemplate extends NPCTemplate {
	public static final int ID = 31378;

	@Inject
	protected NaranAshanukTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Naran Ashanuk";
		this.serverSideName = false;
		this.title = "Varka's Messenger";
		...
		this.rightHand = itemProvider.createID(173);
		this.leftHand = null;
		this.enchantLevel = 0;
