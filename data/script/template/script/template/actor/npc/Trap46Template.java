 ...
 */
public class Trap46Template extends NPCTemplate {
	public static final int ID = 13210;

	@Inject
	protected Trap46Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
