 ...
 */
public class TullysGatekeeper10Template extends NPCTemplate {
	public static final int ID = 18454;

	@Inject
	protected TullysGatekeeper10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
