 ...
 */
public class DaichirTemplate extends NPCTemplate {
	public static final int ID = 30537;

	@Inject
	protected DaichirTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Daichir";
		this.serverSideName = false;
		this.title = "Priest of the Earth";
		this.serverSideTitle = false;
		this.collisionRadius = 8.00;
		this.collisionHeight = 19.50;
		this.level = 70;
