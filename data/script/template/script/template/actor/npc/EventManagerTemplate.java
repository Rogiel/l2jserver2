 ...
 */
public class EventManagerTemplate extends NPCTemplate {
	public static final int ID = 31854;

	@Inject
	protected EventManagerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
