 ...
 */
public class PioturTemplate extends NPCTemplate {
	public static final int ID = 30597;

	@Inject
	protected PioturTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
