 ...
 */
public class DeadLeopardsCarcassTemplate extends NPCTemplate {
	public static final int ID = 32090;

	@Inject
	protected DeadLeopardsCarcassTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dead Leopard's Carcass";
