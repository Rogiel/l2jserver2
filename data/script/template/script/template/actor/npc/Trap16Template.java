 ...
 */
public class Trap16Template extends NPCTemplate {
	public static final int ID = 13052;

	@Inject
	protected Trap16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
