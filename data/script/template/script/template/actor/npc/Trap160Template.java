 ...
 */
public class Trap160Template extends NPCTemplate {
	public static final int ID = 18737;

	@Inject
	protected Trap160Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
