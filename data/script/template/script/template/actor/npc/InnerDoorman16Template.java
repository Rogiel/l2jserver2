 ...
 */
public class InnerDoorman16Template extends NPCTemplate {
	public static final int ID = 35623;

	@Inject
	protected InnerDoorman16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
