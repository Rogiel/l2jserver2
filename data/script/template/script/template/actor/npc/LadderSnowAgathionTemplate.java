 ...
 */
public class LadderSnowAgathionTemplate extends NPCTemplate {
	public static final int ID = 1559;

	@Inject
	protected LadderSnowAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ladder Snow Agathion";
