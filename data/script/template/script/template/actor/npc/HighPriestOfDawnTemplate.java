 ...
 */
public class HighPriestOfDawnTemplate extends NPCTemplate {
	public static final int ID = 18828;

	@Inject
	protected HighPriestOfDawnTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "High Priest of Dawn";
