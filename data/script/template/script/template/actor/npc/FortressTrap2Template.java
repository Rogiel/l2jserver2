 ...
 */
public class FortressTrap2Template extends NPCTemplate {
	public static final int ID = 36413;

	@Inject
	protected FortressTrap2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
