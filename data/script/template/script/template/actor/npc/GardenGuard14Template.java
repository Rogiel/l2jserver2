 ...
 */
public class GardenGuard14Template extends NPCTemplate {
	public static final int ID = 32330;

	@Inject
	protected GardenGuard14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Garden Guard";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = true;
