 ...
 */
public class TawnyManedLionTemplate extends NPCTemplate {
	public static final int ID = 13146;

	@Inject
	protected TawnyManedLionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tawny-Maned Lion";
