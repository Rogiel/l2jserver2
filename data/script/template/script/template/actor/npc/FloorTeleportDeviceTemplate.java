 ...
 */
public class FloorTeleportDeviceTemplate extends NPCTemplate {
	public static final int ID = 32753;

	@Inject
	protected FloorTeleportDeviceTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
