 ...
 */
public class Jinia3Template extends NPCTemplate {
	public static final int ID = 32781;

	@Inject
	protected Jinia3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
