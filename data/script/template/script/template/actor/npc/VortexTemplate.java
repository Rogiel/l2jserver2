 ...
 */
public class VortexTemplate extends NPCTemplate {
	public static final int ID = 36571;

	@Inject
	protected VortexTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
