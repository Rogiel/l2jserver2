 ...
 */
public class DuncanTemplate extends NPCTemplate {
	public static final int ID = 31626;

	@Inject
	protected DuncanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
