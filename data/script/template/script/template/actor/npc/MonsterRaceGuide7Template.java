 ...
 */
public class MonsterRaceGuide7Template extends NPCTemplate {
	public static final int ID = 31410;

	@Inject
	protected MonsterRaceGuide7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Monster Race Guide";
		this.serverSideName = false;
		this.title = "Town of Aden";
