 ...
 */
public class MainMachineTemplate extends NPCTemplate {
	public static final int ID = 35707;

	@Inject
	protected MainMachineTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
