 ...
 */
public class SymbolOfAdventureTemplate extends NPCTemplate {
	public static final int ID = 32290;

	@Inject
	protected SymbolOfAdventureTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Symbol of Adventure";
