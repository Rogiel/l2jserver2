 ...
 */
public class SantaTraineeTemplate extends NPCTemplate {
	public static final int ID = 31863;

	@Inject
	protected SantaTraineeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
