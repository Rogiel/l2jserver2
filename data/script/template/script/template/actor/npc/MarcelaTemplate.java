 ...
 */
public class MarcelaTemplate extends NPCTemplate {
	public static final int ID = 32173;

	@Inject
	protected MarcelaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Marcela";
		this.serverSideName = false;
		this.title = "Zerstorer";
