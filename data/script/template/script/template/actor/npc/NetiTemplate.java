 ...
 */
public class NetiTemplate extends NPCTemplate {
	public static final int ID = 30425;

	@Inject
	protected NetiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
