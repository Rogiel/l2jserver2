 ...
 */
public class GuardianOfBorderTemplate extends NPCTemplate {
	public static final int ID = 31865;

	@Inject
	protected GuardianOfBorderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
