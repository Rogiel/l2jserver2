 ...
 */
public class TabletOfVision3Template extends NPCTemplate {
	public static final int ID = 31648;

	@Inject
	protected TabletOfVision3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
