 ...
 */
public class FortressTrap7Template extends NPCTemplate {
	public static final int ID = 36418;

	@Inject
	protected FortressTrap7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
