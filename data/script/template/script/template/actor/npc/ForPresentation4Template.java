 ...
 */
public class ForPresentation4Template extends NPCTemplate {
	public static final int ID = 13152;

	@Inject
	protected ForPresentation4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "For Presentation 4";
