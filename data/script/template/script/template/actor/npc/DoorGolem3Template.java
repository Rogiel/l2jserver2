 ...
 */
public class DoorGolem3Template extends NPCTemplate {
	public static final int ID = 18924;

	@Inject
	protected DoorGolem3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Door Golem";
