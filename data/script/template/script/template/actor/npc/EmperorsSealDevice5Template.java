 ...
 */
public class EmperorsSealDevice5Template extends NPCTemplate {
	public static final int ID = 32591;

	@Inject
	protected EmperorsSealDevice5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Emperor's Seal Device";
