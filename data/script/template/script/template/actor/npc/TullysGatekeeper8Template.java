 ...
 */
public class TullysGatekeeper8Template extends NPCTemplate {
	public static final int ID = 18452;

	@Inject
	protected TullysGatekeeper8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
