 ...
 */
public class GolemGuardianTemplate extends NPCTemplate {
	public static final int ID = 13083;

	@Inject
	protected GolemGuardianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Golem Guardian";
