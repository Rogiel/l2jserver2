 ...
 */
public class Flagpole12Template extends NPCTemplate {
	public static final int ID = 36033;

	@Inject
	protected Flagpole12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
