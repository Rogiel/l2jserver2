 ...
 */
public class InstantMovingDeviceTemplate extends NPCTemplate {
	public static final int ID = 32601;

	@Inject
	protected InstantMovingDeviceTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Instant Moving Device";
