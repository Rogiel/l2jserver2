 ...
 */
public class MainMachine9Template extends NPCTemplate {
	public static final int ID = 36228;

	@Inject
	protected MainMachine9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
