 ...
 */
public class Trap68Template extends NPCTemplate {
	public static final int ID = 13232;

	@Inject
	protected Trap68Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
