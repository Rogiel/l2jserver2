 ...
 */
public class OlMahumPilgrimTemplate extends NPCTemplate {
	public static final int ID = 30732;

	@Inject
	protected OlMahumPilgrimTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ol Mahum Pilgrim";
