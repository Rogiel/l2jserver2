 ...
 */
public class GuardianOfBorder40Template extends NPCTemplate {
	public static final int ID = 31904;

	@Inject
	protected GuardianOfBorder40Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
