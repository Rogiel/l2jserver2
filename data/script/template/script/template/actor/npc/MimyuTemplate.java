 ...
 */
public class MimyuTemplate extends NPCTemplate {
	public static final int ID = 30747;

	@Inject
	protected MimyuTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
