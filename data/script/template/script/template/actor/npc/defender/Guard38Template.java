 ...
 */
public class Guard38Template extends DefenderNPCTemplate {
	public static final int ID = 35162;

	@Inject
	protected Guard38Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
