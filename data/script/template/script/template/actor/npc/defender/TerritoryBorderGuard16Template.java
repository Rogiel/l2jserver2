 ...
 */
public class TerritoryBorderGuard16Template extends DefenderNPCTemplate {
	public static final int ID = 36554;

	@Inject
	protected TerritoryBorderGuard16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
