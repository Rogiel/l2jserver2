 ...
 */
public class Guard125Template extends DefenderNPCTemplate {
	public static final int ID = 35525;

	@Inject
	protected Guard125Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
