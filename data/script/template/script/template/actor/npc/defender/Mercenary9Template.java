 ...
 */
public class Mercenary9Template extends DefenderNPCTemplate {
	public static final int ID = 35016;

	@Inject
	protected Mercenary9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
