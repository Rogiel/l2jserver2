 ...
 */
public class Healer2Template extends DefenderNPCTemplate {
	public static final int ID = 35718;

	@Inject
	protected Healer2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
