 ...
 */
public class RebelCommander18Template extends DefenderNPCTemplate {
	public static final int ID = 36261;

	@Inject
	protected RebelCommander18Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
