 ...
 */
public class MercenaryOfDawn2Template extends DefenderNPCTemplate {
	public static final int ID = 35021;

	@Inject
	protected MercenaryOfDawn2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
