 ...
 */
public class Wizard15Template extends DefenderNPCTemplate {
	public static final int ID = 36164;

	@Inject
	protected Wizard15Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
