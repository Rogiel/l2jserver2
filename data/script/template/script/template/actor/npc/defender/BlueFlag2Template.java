 ...
 */
public class BlueFlag2Template extends DefenderNPCTemplate {
	public static final int ID = 35610;

	@Inject
	protected BlueFlag2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
