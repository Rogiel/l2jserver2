 ...
 */
public class ScoutGolem12Template extends DefenderNPCTemplate {
	public static final int ID = 36378;

	@Inject
	protected ScoutGolem12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Scout Golem";
