 ...
 */
public class CourtSorcerer12Template extends DefenderNPCTemplate {
	public static final int ID = 35165;

	@Inject
	protected CourtSorcerer12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
