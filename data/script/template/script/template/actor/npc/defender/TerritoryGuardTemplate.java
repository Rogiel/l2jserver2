 ...
 */
public class TerritoryGuardTemplate extends DefenderNPCTemplate {
	public static final int ID = 36511;

	@Inject
	protected TerritoryGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
