 ...
 */
public class Guard185Template extends DefenderNPCTemplate {
	public static final int ID = 36189;

	@Inject
	protected Guard185Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
