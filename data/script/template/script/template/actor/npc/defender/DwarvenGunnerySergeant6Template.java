 ...
 */
public class DwarvenGunnerySergeant6Template extends DefenderNPCTemplate {
	public static final int ID = 35845;

	@Inject
	protected DwarvenGunnerySergeant6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
