 ...
 */
public class GreaterRecruit4Template extends DefenderNPCTemplate {
	public static final int ID = 35043;

	@Inject
	protected GreaterRecruit4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
