 ...
 */
public class CourtSorcerer29Template extends DefenderNPCTemplate {
	public static final int ID = 35472;

	@Inject
	protected CourtSorcerer29Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
