 ...
 */
public class Guard201Template extends DefenderNPCTemplate {
	public static final int ID = 36380;

	@Inject
	protected Guard201Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
