 ...
 */
public class DwarvenGunnerySergeant14Template extends DefenderNPCTemplate {
	public static final int ID = 36128;

	@Inject
	protected DwarvenGunnerySergeant14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
