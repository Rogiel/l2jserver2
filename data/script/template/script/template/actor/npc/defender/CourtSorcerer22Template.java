 ...
 */
public class CourtSorcerer22Template extends DefenderNPCTemplate {
	public static final int ID = 35284;

	@Inject
	protected CourtSorcerer22Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
