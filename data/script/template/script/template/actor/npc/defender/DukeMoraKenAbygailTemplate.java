 ...
 */
public class DukeMoraKenAbygailTemplate extends DefenderNPCTemplate {
	public static final int ID = 35325;

	@Inject
	protected DukeMoraKenAbygailTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Duke Mora Ken Abygail";
