 ...
 */
public class CourtGuard42Template extends DefenderNPCTemplate {
	public static final int ID = 36226;

	@Inject
	protected CourtGuard42Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
