 ...
 */
public class Guard117Template extends DefenderNPCTemplate {
	public static final int ID = 35492;

	@Inject
	protected Guard117Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
