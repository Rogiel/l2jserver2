 ...
 */
public class ReligiousAssociationLeader5Template extends DefenderNPCTemplate {
	public static final int ID = 36534;

	@Inject
	protected ReligiousAssociationLeader5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
