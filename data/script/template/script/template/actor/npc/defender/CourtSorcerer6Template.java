 ...
 */
public class CourtSorcerer6Template extends DefenderNPCTemplate {
	public static final int ID = 35110;

	@Inject
	protected CourtSorcerer6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
