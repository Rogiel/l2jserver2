 ...
 */
public class CourtSorcerer10Template extends DefenderNPCTemplate {
	public static final int ID = 35152;

	@Inject
	protected CourtSorcerer10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
