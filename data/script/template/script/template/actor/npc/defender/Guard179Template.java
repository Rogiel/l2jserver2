 ...
 */
public class Guard179Template extends DefenderNPCTemplate {
	public static final int ID = 36126;

	@Inject
	protected Guard179Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
