 ...
 */
public class Guard133Template extends DefenderNPCTemplate {
	public static final int ID = 35537;

	@Inject
	protected Guard133Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
