 ...
 */
public class RebelPrivate4Template extends DefenderNPCTemplate {
	public static final int ID = 35773;

	@Inject
	protected RebelPrivate4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
