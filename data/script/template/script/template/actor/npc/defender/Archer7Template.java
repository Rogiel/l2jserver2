 ...
 */
public class Archer7Template extends DefenderNPCTemplate {
	public static final int ID = 35889;

	@Inject
	protected Archer7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
