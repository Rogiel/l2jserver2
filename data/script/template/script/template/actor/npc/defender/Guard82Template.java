 ...
 */
public class Guard82Template extends DefenderNPCTemplate {
	public static final int ID = 35259;

	@Inject
	protected Guard82Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
