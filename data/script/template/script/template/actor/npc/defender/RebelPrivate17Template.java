 ...
 */
public class RebelPrivate17Template extends DefenderNPCTemplate {
	public static final int ID = 36225;

	@Inject
	protected RebelPrivate17Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
