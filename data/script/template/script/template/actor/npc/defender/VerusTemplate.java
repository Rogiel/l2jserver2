 ...
 */
public class VerusTemplate extends DefenderNPCTemplate {
	public static final int ID = 35516;

	@Inject
	protected VerusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
