 ...
 */
public class Guard140Template extends DefenderNPCTemplate {
	public static final int ID = 35674;

	@Inject
	protected Guard140Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
