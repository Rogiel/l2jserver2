 ...
 */
public class CourtSorcerer32Template extends DefenderNPCTemplate {
	public static final int ID = 35486;

	@Inject
	protected CourtSorcerer32Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
