 ...
 */
public class TerritoryGuard2Template extends DefenderNPCTemplate {
	public static final int ID = 36517;

	@Inject
	protected TerritoryGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
