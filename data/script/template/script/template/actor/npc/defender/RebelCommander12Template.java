 ...
 */
public class RebelCommander12Template extends DefenderNPCTemplate {
	public static final int ID = 36047;

	@Inject
	protected RebelCommander12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
