 ...
 */
public class ReligiousAssociationLeader2Template extends DefenderNPCTemplate {
	public static final int ID = 36516;

	@Inject
	protected ReligiousAssociationLeader2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
