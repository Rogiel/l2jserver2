 ...
 */
public class RebelCommander4Template extends DefenderNPCTemplate {
	public static final int ID = 35771;

	@Inject
	protected RebelCommander4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
