 ...
 */
public class Healer3Template extends DefenderNPCTemplate {
	public static final int ID = 35751;

	@Inject
	protected Healer3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
