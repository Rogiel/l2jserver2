 ...
 */
public class CourtSorcerer8Template extends DefenderNPCTemplate {
	public static final int ID = 35123;

	@Inject
	protected CourtSorcerer8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
