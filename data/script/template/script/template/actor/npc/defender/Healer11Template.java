 ...
 */
public class Healer11Template extends DefenderNPCTemplate {
	public static final int ID = 36027;

	@Inject
	protected Healer11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
