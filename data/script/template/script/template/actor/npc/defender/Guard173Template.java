 ...
 */
public class Guard173Template extends DefenderNPCTemplate {
	public static final int ID = 36051;

	@Inject
	protected Guard173Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
