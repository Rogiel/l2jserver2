 ...
 */
public class CourtGuard23Template extends DefenderNPCTemplate {
	public static final int ID = 35487;

	@Inject
	protected CourtGuard23Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
