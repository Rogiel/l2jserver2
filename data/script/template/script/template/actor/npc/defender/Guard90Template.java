 ...
 */
public class Guard90Template extends DefenderNPCTemplate {
	public static final int ID = 35292;

	@Inject
	protected Guard90Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
