 ...
 */
public class Wizard5Template extends DefenderNPCTemplate {
	public static final int ID = 35819;

	@Inject
	protected Wizard5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
