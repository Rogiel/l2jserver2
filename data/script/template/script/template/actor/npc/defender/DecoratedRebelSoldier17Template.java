 ...
 */
public class DecoratedRebelSoldier17Template extends DefenderNPCTemplate {
	public static final int ID = 36224;

	@Inject
	protected DecoratedRebelSoldier17Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
