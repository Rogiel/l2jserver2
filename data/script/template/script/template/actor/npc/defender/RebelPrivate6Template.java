 ...
 */
public class RebelPrivate6Template extends DefenderNPCTemplate {
	public static final int ID = 35841;

	@Inject
	protected RebelPrivate6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
