 ...
 */
public class Guard19Template extends DefenderNPCTemplate {
	public static final int ID = 35090;

	@Inject
	protected Guard19Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
