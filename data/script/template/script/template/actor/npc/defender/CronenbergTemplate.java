 ...
 */
public class CronenbergTemplate extends DefenderNPCTemplate {
	public static final int ID = 35065;

	@Inject
	protected CronenbergTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cronenberg";
