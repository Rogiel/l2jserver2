 ...
 */
public class GreaterRecruit3Template extends DefenderNPCTemplate {
	public static final int ID = 35042;

	@Inject
	protected GreaterRecruit3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
