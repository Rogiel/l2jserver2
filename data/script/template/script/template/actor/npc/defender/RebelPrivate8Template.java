 ...
 */
public class RebelPrivate8Template extends DefenderNPCTemplate {
	public static final int ID = 35910;

	@Inject
	protected RebelPrivate8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
