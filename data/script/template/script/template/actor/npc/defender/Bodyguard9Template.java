 ...
 */
public class Bodyguard9Template extends DefenderNPCTemplate {
	public static final int ID = 35338;

	@Inject
	protected Bodyguard9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
