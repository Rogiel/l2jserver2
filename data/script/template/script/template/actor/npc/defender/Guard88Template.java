 ...
 */
public class Guard88Template extends DefenderNPCTemplate {
	public static final int ID = 35290;

	@Inject
	protected Guard88Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
