 ...
 */
public class Guard86Template extends DefenderNPCTemplate {
	public static final int ID = 35288;

	@Inject
	protected Guard86Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
