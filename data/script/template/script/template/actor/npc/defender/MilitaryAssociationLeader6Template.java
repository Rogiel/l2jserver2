 ...
 */
public class MilitaryAssociationLeader6Template extends DefenderNPCTemplate {
	public static final int ID = 36538;

	@Inject
	protected MilitaryAssociationLeader6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
