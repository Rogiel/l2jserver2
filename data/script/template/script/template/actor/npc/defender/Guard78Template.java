 ...
 */
public class Guard78Template extends DefenderNPCTemplate {
	public static final int ID = 35255;

	@Inject
	protected Guard78Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
