 ...
 */
public class Archer6Template extends DefenderNPCTemplate {
	public static final int ID = 35853;

	@Inject
	protected Archer6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
