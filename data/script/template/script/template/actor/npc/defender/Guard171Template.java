 ...
 */
public class Guard171Template extends DefenderNPCTemplate {
	public static final int ID = 36023;

	@Inject
	protected Guard171Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
