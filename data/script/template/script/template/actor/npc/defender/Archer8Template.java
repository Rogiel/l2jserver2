 ...
 */
public class Archer8Template extends DefenderNPCTemplate {
	public static final int ID = 35922;

	@Inject
	protected Archer8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
