 ...
 */
public class CourtSorcerer28Template extends DefenderNPCTemplate {
	public static final int ID = 35341;

	@Inject
	protected CourtSorcerer28Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
