 ...
 */
public class Guard189Template extends DefenderNPCTemplate {
	public static final int ID = 36235;

	@Inject
	protected Guard189Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
