 ...
 */
public class Guard3Template extends DefenderNPCTemplate {
	public static final int ID = 35070;

	@Inject
	protected Guard3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
