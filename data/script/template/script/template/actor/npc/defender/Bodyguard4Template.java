 ...
 */
public class Bodyguard4Template extends DefenderNPCTemplate {
	public static final int ID = 35333;

	@Inject
	protected Bodyguard4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
