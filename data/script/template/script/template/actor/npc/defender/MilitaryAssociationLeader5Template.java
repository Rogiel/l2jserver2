 ...
 */
public class MilitaryAssociationLeader5Template extends DefenderNPCTemplate {
	public static final int ID = 36532;

	@Inject
	protected MilitaryAssociationLeader5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
