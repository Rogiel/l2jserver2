 ...
 */
public class CourtGuard27Template extends DefenderNPCTemplate {
	public static final int ID = 35705;

	@Inject
	protected CourtGuard27Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
