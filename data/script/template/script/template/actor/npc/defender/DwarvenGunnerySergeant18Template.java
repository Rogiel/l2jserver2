 ...
 */
public class DwarvenGunnerySergeant18Template extends DefenderNPCTemplate {
	public static final int ID = 36270;

	@Inject
	protected DwarvenGunnerySergeant18Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
