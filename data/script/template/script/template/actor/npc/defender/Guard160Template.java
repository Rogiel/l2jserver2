 ...
 */
public class Guard160Template extends DefenderNPCTemplate {
	public static final int ID = 35884;

	@Inject
	protected Guard160Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
