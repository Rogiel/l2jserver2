 ...
 */
public class Guard26Template extends DefenderNPCTemplate {
	public static final int ID = 35117;

	@Inject
	protected Guard26Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
