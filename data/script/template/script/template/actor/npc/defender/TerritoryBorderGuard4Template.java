 ...
 */
public class TerritoryBorderGuard4Template extends DefenderNPCTemplate {
	public static final int ID = 36518;

	@Inject
	protected TerritoryBorderGuard4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
