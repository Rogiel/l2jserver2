 ...
 */
public class ScoutGolem6Template extends DefenderNPCTemplate {
	public static final int ID = 36057;

	@Inject
	protected ScoutGolem6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
