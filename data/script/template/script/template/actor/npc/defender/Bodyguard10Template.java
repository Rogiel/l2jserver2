 ...
 */
public class Bodyguard10Template extends DefenderNPCTemplate {
	public static final int ID = 35343;

	@Inject
	protected Bodyguard10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
