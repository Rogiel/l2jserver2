 ...
 */
public class Wizard20Template extends DefenderNPCTemplate {
	public static final int ID = 36345;

	@Inject
	protected Wizard20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
