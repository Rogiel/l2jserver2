 ...
 */
public class TerritoryBorderGuard5Template extends DefenderNPCTemplate {
	public static final int ID = 36521;

	@Inject
	protected TerritoryBorderGuard5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
