 ...
 */
public class RebelPrivate11Template extends DefenderNPCTemplate {
	public static final int ID = 36017;

	@Inject
	protected RebelPrivate11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
