 ...
 */
public class Guard10Template extends DefenderNPCTemplate {
	public static final int ID = 35077;

	@Inject
	protected Guard10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
