 ...
 */
public class Healer13Template extends DefenderNPCTemplate {
	public static final int ID = 36101;

	@Inject
	protected Healer13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
