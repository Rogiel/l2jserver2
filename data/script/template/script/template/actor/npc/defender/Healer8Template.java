 ...
 */
public class Healer8Template extends DefenderNPCTemplate {
	public static final int ID = 35920;

	@Inject
	protected Healer8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
