 ...
 */
public class CourtGuard44Template extends DefenderNPCTemplate {
	public static final int ID = 36301;

	@Inject
	protected CourtGuard44Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
