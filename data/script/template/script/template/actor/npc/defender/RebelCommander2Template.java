 ...
 */
public class RebelCommander2Template extends DefenderNPCTemplate {
	public static final int ID = 35702;

	@Inject
	protected RebelCommander2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
