 ...
 */
public class Archer12Template extends DefenderNPCTemplate {
	public static final int ID = 36065;

	@Inject
	protected Archer12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
