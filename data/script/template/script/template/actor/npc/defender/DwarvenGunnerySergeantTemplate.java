 ...
 */
public class DwarvenGunnerySergeantTemplate extends DefenderNPCTemplate {
	public static final int ID = 35676;

	@Inject
	protected DwarvenGunnerySergeantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
