 ...
 */
public class TerritoryGuard5Template extends DefenderNPCTemplate {
	public static final int ID = 36535;

	@Inject
	protected TerritoryGuard5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
