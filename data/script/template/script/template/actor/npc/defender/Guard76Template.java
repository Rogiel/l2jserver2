 ...
 */
public class Guard76Template extends DefenderNPCTemplate {
	public static final int ID = 35253;

	@Inject
	protected Guard76Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
