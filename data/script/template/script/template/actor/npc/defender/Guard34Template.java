 ...
 */
public class Guard34Template extends DefenderNPCTemplate {
	public static final int ID = 35158;

	@Inject
	protected Guard34Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
