 ...
 */
public class Guard186Template extends DefenderNPCTemplate {
	public static final int ID = 36197;

	@Inject
	protected Guard186Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
