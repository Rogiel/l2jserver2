 ...
 */
public class Minister4Template extends DefenderNPCTemplate {
	public static final int ID = 35960;

	@Inject
	protected Minister4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
