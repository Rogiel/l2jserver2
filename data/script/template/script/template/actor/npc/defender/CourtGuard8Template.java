 ...
 */
public class CourtGuard8Template extends DefenderNPCTemplate {
	public static final int ID = 35128;

	@Inject
	protected CourtGuard8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
