 ...
 */
public class GroupGatekeeper3Template extends DefenderNPCTemplate {
	public static final int ID = 35612;

	@Inject
	protected GroupGatekeeper3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
