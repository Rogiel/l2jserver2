 ...
 */
public class DecoratedRebelSoldier16Template extends DefenderNPCTemplate {
	public static final int ID = 36186;

	@Inject
	protected DecoratedRebelSoldier16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
