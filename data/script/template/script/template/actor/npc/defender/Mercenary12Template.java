 ...
 */
public class Mercenary12Template extends DefenderNPCTemplate {
	public static final int ID = 35019;

	@Inject
	protected Mercenary12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
