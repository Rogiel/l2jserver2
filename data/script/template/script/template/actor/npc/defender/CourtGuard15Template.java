 ...
 */
public class CourtGuard15Template extends DefenderNPCTemplate {
	public static final int ID = 35166;

	@Inject
	protected CourtGuard15Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
