 ...
 */
public class Guard64Template extends DefenderNPCTemplate {
	public static final int ID = 35216;

	@Inject
	protected Guard64Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
