 ...
 */
public class BodyguardTemplate extends DefenderNPCTemplate {
	public static final int ID = 35330;

	@Inject
	protected BodyguardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
