 ...
 */
public class DwarvenGunnerySergeant17Template extends DefenderNPCTemplate {
	public static final int ID = 36232;

	@Inject
	protected DwarvenGunnerySergeant17Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
