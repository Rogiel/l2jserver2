 ...
 */
public class TerritoryBorderGuard10Template extends DefenderNPCTemplate {
	public static final int ID = 36536;

	@Inject
	protected TerritoryBorderGuard10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
