 ...
 */
public class Mercenary10Template extends DefenderNPCTemplate {
	public static final int ID = 35017;

	@Inject
	protected Mercenary10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
