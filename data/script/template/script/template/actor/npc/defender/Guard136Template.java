 ...
 */
public class Guard136Template extends DefenderNPCTemplate {
	public static final int ID = 35540;

	@Inject
	protected Guard136Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
