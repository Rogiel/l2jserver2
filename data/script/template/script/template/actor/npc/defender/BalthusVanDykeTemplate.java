 ...
 */
public class BalthusVanDykeTemplate extends DefenderNPCTemplate {
	public static final int ID = 35190;

	@Inject
	protected BalthusVanDykeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Balthus Van Dyke";
