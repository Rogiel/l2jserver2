 ...
 */
public class Guard59Template extends DefenderNPCTemplate {
	public static final int ID = 35211;

	@Inject
	protected Guard59Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
