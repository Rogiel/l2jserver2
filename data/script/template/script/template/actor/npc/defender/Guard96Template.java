 ...
 */
public class Guard96Template extends DefenderNPCTemplate {
	public static final int ID = 35302;

	@Inject
	protected Guard96Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
