 ...
 */
public class Wizard7Template extends DefenderNPCTemplate {
	public static final int ID = 35886;

	@Inject
	protected Wizard7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
