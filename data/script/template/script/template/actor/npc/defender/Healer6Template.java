 ...
 */
public class Healer6Template extends DefenderNPCTemplate {
	public static final int ID = 35851;

	@Inject
	protected Healer6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
