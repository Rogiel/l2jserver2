 ...
 */
public class TerritoryGuard4Template extends DefenderNPCTemplate {
	public static final int ID = 36529;

	@Inject
	protected TerritoryGuard4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
