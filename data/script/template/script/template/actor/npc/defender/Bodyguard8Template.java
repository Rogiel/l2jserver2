 ...
 */
public class Bodyguard8Template extends DefenderNPCTemplate {
	public static final int ID = 35337;

	@Inject
	protected Bodyguard8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
