 ...
 */
public class Wizard6Template extends DefenderNPCTemplate {
	public static final int ID = 35850;

	@Inject
	protected Wizard6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
