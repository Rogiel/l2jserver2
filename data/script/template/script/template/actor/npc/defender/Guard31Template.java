 ...
 */
public class Guard31Template extends DefenderNPCTemplate {
	public static final int ID = 35155;

	@Inject
	protected Guard31Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
