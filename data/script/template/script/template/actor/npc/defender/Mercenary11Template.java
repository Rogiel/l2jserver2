 ...
 */
public class Mercenary11Template extends DefenderNPCTemplate {
	public static final int ID = 35018;

	@Inject
	protected Mercenary11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
