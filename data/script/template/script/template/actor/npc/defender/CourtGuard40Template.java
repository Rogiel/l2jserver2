 ...
 */
public class CourtGuard40Template extends DefenderNPCTemplate {
	public static final int ID = 36156;

	@Inject
	protected CourtGuard40Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
