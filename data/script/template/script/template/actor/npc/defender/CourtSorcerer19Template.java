 ...
 */
public class CourtSorcerer19Template extends DefenderNPCTemplate {
	public static final int ID = 35249;

	@Inject
	protected CourtSorcerer19Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
