 ...
 */
public class CourtGuard37Template extends DefenderNPCTemplate {
	public static final int ID = 36050;

	@Inject
	protected CourtGuard37Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
