 ...
 */
public class MercenaryOfDawn10Template extends DefenderNPCTemplate {
	public static final int ID = 35029;

	@Inject
	protected MercenaryOfDawn10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mercenary of Dawn";
