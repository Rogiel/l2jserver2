 ...
 */
public class Recruit4Template extends DefenderNPCTemplate {
	public static final int ID = 35053;

	@Inject
	protected Recruit4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
