 ...
 */
public class Minister5Template extends DefenderNPCTemplate {
	public static final int ID = 35998;

	@Inject
	protected Minister5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
