 ...
 */
public class DwarvenGunnerySergeant2Template extends DefenderNPCTemplate {
	public static final int ID = 35711;

	@Inject
	protected DwarvenGunnerySergeant2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
