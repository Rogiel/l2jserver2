 ...
 */
public class CourtGuard25Template extends DefenderNPCTemplate {
	public static final int ID = 35534;

	@Inject
	protected CourtGuard25Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
