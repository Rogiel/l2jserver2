 ...
 */
public class CourtSorcerer5Template extends DefenderNPCTemplate {
	public static final int ID = 35109;

	@Inject
	protected CourtSorcerer5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
