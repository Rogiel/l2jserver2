 ...
 */
public class Healer9Template extends DefenderNPCTemplate {
	public static final int ID = 35956;

	@Inject
	protected Healer9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
