 ...
 */
public class Archer4Template extends DefenderNPCTemplate {
	public static final int ID = 35789;

	@Inject
	protected Archer4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
