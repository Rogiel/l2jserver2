 ...
 */
public class DecoratedRebelSoldier8Template extends DefenderNPCTemplate {
	public static final int ID = 35909;

	@Inject
	protected DecoratedRebelSoldier8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
