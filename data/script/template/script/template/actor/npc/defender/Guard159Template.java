 ...
 */
public class Guard159Template extends DefenderNPCTemplate {
	public static final int ID = 35883;

	@Inject
	protected Guard159Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
