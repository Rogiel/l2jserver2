 ...
 */
public class Guard181Template extends DefenderNPCTemplate {
	public static final int ID = 36131;

	@Inject
	protected Guard181Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
