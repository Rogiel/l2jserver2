 ...
 */
public class Guard154Template extends DefenderNPCTemplate {
	public static final int ID = 35817;

	@Inject
	protected Guard154Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
