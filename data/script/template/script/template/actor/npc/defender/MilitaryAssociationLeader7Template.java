 ...
 */
public class MilitaryAssociationLeader7Template extends DefenderNPCTemplate {
	public static final int ID = 36544;

	@Inject
	protected MilitaryAssociationLeader7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
