 ...
 */
public class Guard149Template extends DefenderNPCTemplate {
	public static final int ID = 35775;

	@Inject
	protected Guard149Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
