 ...
 */
public class Guard195Template extends DefenderNPCTemplate {
	public static final int ID = 36306;

	@Inject
	protected Guard195Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
