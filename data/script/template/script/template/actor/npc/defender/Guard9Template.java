 ...
 */
public class Guard9Template extends DefenderNPCTemplate {
	public static final int ID = 35076;

	@Inject
	protected Guard9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
