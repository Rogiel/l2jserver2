 ...
 */
public class RebelPrivate16Template extends DefenderNPCTemplate {
	public static final int ID = 36187;

	@Inject
	protected RebelPrivate16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
