 ...
 */
public class Guard40Template extends DefenderNPCTemplate {
	public static final int ID = 35168;

	@Inject
	protected Guard40Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
