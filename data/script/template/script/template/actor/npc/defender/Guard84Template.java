 ...
 */
public class Guard84Template extends DefenderNPCTemplate {
	public static final int ID = 35286;

	@Inject
	protected Guard84Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
