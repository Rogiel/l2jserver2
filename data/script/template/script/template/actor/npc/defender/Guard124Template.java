 ...
 */
public class Guard124Template extends DefenderNPCTemplate {
	public static final int ID = 35524;

	@Inject
	protected Guard124Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
