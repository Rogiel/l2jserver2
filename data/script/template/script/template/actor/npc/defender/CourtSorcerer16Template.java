 ...
 */
public class CourtSorcerer16Template extends DefenderNPCTemplate {
	public static final int ID = 35207;

	@Inject
	protected CourtSorcerer16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
