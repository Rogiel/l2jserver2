 ...
 */
public class CourtSorcerer4Template extends DefenderNPCTemplate {
	public static final int ID = 35081;

	@Inject
	protected CourtSorcerer4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
