 ...
 */
public class Mercenary4Template extends DefenderNPCTemplate {
	public static final int ID = 35011;

	@Inject
	protected Mercenary4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
