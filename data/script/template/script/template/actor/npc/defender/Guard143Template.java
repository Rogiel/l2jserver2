 ...
 */
public class Guard143Template extends DefenderNPCTemplate {
	public static final int ID = 35706;

	@Inject
	protected Guard143Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
