 ...
 */
public class Guard127Template extends DefenderNPCTemplate {
	public static final int ID = 35527;

	@Inject
	protected Guard127Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
