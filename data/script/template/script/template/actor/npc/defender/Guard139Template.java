 ...
 */
public class Guard139Template extends DefenderNPCTemplate {
	public static final int ID = 35543;

	@Inject
	protected Guard139Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
