 ...
 */
public class DukeByronAshtonTemplate extends DefenderNPCTemplate {
	public static final int ID = 35106;

	@Inject
	protected DukeByronAshtonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Duke Byron Ashton";
