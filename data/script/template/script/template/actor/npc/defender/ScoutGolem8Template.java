 ...
 */
public class ScoutGolem8Template extends DefenderNPCTemplate {
	public static final int ID = 36195;

	@Inject
	protected ScoutGolem8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
