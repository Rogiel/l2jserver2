 ...
 */
public class DwarvenGunnerySergeant20Template extends DefenderNPCTemplate {
	public static final int ID = 36339;

	@Inject
	protected DwarvenGunnerySergeant20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
