 ...
 */
public class CourtGuard45Template extends DefenderNPCTemplate {
	public static final int ID = 36333;

	@Inject
	protected CourtGuard45Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
