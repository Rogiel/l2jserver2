 ...
 */
public class CourtGuard11Template extends DefenderNPCTemplate {
	public static final int ID = 35131;

	@Inject
	protected CourtGuard11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
