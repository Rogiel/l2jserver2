 ...
 */
public class Guard7Template extends DefenderNPCTemplate {
	public static final int ID = 35074;

	@Inject
	protected Guard7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
