 ...
 */
public class Guard128Template extends DefenderNPCTemplate {
	public static final int ID = 35528;

	@Inject
	protected Guard128Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
