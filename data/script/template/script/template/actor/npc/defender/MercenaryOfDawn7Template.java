 ...
 */
public class MercenaryOfDawn7Template extends DefenderNPCTemplate {
	public static final int ID = 35026;

	@Inject
	protected MercenaryOfDawn7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
