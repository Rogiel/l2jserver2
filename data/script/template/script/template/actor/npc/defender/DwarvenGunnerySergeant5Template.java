 ...
 */
public class DwarvenGunnerySergeant5Template extends DefenderNPCTemplate {
	public static final int ID = 35814;

	@Inject
	protected DwarvenGunnerySergeant5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
