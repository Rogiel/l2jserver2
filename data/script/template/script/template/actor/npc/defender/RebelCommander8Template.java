 ...
 */
public class RebelCommander8Template extends DefenderNPCTemplate {
	public static final int ID = 35908;

	@Inject
	protected RebelCommander8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
