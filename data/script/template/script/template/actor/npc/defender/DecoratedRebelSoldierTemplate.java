 ...
 */
public class DecoratedRebelSoldierTemplate extends DefenderNPCTemplate {
	public static final int ID = 35671;

	@Inject
	protected DecoratedRebelSoldierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
