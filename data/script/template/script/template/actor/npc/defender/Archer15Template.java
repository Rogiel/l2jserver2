 ...
 */
public class Archer15Template extends DefenderNPCTemplate {
	public static final int ID = 36167;

	@Inject
	protected Archer15Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
