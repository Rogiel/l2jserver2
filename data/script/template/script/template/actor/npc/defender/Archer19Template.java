 ...
 */
public class Archer19Template extends DefenderNPCTemplate {
	public static final int ID = 36312;

	@Inject
	protected Archer19Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
