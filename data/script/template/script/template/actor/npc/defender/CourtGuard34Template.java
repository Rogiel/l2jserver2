 ...
 */
public class CourtGuard34Template extends DefenderNPCTemplate {
	public static final int ID = 35943;

	@Inject
	protected CourtGuard34Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
