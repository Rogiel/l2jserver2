 ...
 */
public class TerritoryBorderGuard18Template extends DefenderNPCTemplate {
	public static final int ID = 36560;

	@Inject
	protected TerritoryBorderGuard18Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Territory Border Guard";
		...
		this.rightHand = itemProvider.createID(8684);
		this.leftHand = null;
		this.enchantLevel = 0;
