 ...
 */
public class ArcherTemplate extends DefenderNPCTemplate {
	public static final int ID = 35684;

	@Inject
	protected ArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
