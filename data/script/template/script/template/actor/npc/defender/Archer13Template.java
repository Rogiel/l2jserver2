 ...
 */
public class Archer13Template extends DefenderNPCTemplate {
	public static final int ID = 36103;

	@Inject
	protected Archer13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
