 ...
 */
public class Guard51Template extends DefenderNPCTemplate {
	public static final int ID = 35199;

	@Inject
	protected Guard51Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
