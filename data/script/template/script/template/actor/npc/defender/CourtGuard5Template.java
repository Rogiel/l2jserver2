 ...
 */
public class CourtGuard5Template extends DefenderNPCTemplate {
	public static final int ID = 35125;

	@Inject
	protected CourtGuard5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
