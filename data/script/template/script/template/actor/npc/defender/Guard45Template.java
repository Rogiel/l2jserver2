 ...
 */
public class Guard45Template extends DefenderNPCTemplate {
	public static final int ID = 35173;

	@Inject
	protected Guard45Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
