 ...
 */
public class Guard115Template extends DefenderNPCTemplate {
	public static final int ID = 35490;

	@Inject
	protected Guard115Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
