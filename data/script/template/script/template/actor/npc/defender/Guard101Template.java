 ...
 */
public class Guard101Template extends DefenderNPCTemplate {
	public static final int ID = 35307;

	@Inject
	protected Guard101Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
