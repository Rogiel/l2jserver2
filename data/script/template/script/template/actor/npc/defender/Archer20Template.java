 ...
 */
public class Archer20Template extends DefenderNPCTemplate {
	public static final int ID = 36348;

	@Inject
	protected Archer20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
