 ...
 */
public class Wizard11Template extends DefenderNPCTemplate {
	public static final int ID = 36026;

	@Inject
	protected Wizard11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
