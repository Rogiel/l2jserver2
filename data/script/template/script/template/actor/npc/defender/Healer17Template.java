 ...
 */
public class Healer17Template extends DefenderNPCTemplate {
	public static final int ID = 36239;

	@Inject
	protected Healer17Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
