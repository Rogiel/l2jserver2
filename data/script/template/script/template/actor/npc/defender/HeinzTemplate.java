 ...
 */
public class HeinzTemplate extends DefenderNPCTemplate {
	public static final int ID = 35324;

	@Inject
	protected HeinzTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Heinz";
		this.serverSideName = false;
		this.title = "Royal Guard Captain";
