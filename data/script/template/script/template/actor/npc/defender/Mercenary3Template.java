 ...
 */
public class Mercenary3Template extends DefenderNPCTemplate {
	public static final int ID = 35010;

	@Inject
	protected Mercenary3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
