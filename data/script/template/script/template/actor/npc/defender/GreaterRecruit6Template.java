 ...
 */
public class GreaterRecruit6Template extends DefenderNPCTemplate {
	public static final int ID = 35045;

	@Inject
	protected GreaterRecruit6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
