 ...
 */
public class TerritoryBorderGuard12Template extends DefenderNPCTemplate {
	public static final int ID = 36542;

	@Inject
	protected TerritoryBorderGuard12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
