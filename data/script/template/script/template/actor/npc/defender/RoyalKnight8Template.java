 ...
 */
public class RoyalKnight8Template extends DefenderNPCTemplate {
	public static final int ID = 35205;

	@Inject
	protected RoyalKnight8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
