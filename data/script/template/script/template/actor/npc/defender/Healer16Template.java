 ...
 */
public class Healer16Template extends DefenderNPCTemplate {
	public static final int ID = 36201;

	@Inject
	protected Healer16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
