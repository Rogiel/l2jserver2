 ...
 */
public class Guard11Template extends DefenderNPCTemplate {
	public static final int ID = 35078;

	@Inject
	protected Guard11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
