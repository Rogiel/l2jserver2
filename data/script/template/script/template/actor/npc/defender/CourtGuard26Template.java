 ...
 */
public class CourtGuard26Template extends DefenderNPCTemplate {
	public static final int ID = 35673;

	@Inject
	protected CourtGuard26Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
