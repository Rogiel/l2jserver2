 ...
 */
public class GreaterRecruit9Template extends DefenderNPCTemplate {
	public static final int ID = 35048;

	@Inject
	protected GreaterRecruit9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
