 ...
 */
public class TerritoryBorderGuard11Template extends DefenderNPCTemplate {
	public static final int ID = 36539;

	@Inject
	protected TerritoryBorderGuard11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
