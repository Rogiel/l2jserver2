 ...
 */
public class DwarvenGunnerySergeant21Template extends DefenderNPCTemplate {
	public static final int ID = 36377;

	@Inject
	protected DwarvenGunnerySergeant21Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
