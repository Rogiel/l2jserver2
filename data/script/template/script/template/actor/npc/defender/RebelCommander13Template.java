 ...
 */
public class RebelCommander13Template extends DefenderNPCTemplate {
	public static final int ID = 36085;

	@Inject
	protected RebelCommander13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
