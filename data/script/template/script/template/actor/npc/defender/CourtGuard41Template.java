 ...
 */
public class CourtGuard41Template extends DefenderNPCTemplate {
	public static final int ID = 36188;

	@Inject
	protected CourtGuard41Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
