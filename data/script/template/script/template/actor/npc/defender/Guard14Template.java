 ...
 */
public class Guard14Template extends DefenderNPCTemplate {
	public static final int ID = 35085;

	@Inject
	protected Guard14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
