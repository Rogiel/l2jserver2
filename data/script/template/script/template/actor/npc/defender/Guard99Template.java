 ...
 */
public class Guard99Template extends DefenderNPCTemplate {
	public static final int ID = 35305;

	@Inject
	protected Guard99Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
