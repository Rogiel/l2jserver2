 ...
 */
public class RebelPrivate20Template extends DefenderNPCTemplate {
	public static final int ID = 36332;

	@Inject
	protected RebelPrivate20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
