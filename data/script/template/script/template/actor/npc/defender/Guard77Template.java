 ...
 */
public class Guard77Template extends DefenderNPCTemplate {
	public static final int ID = 35254;

	@Inject
	protected Guard77Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
