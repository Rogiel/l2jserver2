 ...
 */
public class RebelPrivate9Template extends DefenderNPCTemplate {
	public static final int ID = 35942;

	@Inject
	protected RebelPrivate9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
