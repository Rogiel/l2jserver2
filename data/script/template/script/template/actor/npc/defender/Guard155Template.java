 ...
 */
public class Guard155Template extends DefenderNPCTemplate {
	public static final int ID = 35843;

	@Inject
	protected Guard155Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
