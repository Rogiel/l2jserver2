 ...
 */
public class Guard16Template extends DefenderNPCTemplate {
	public static final int ID = 35087;

	@Inject
	protected Guard16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
