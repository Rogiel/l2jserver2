 ...
 */
public class ScoutGolem11Template extends DefenderNPCTemplate {
	public static final int ID = 36340;

	@Inject
	protected ScoutGolem11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
