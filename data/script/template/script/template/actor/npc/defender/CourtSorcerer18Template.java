 ...
 */
public class CourtSorcerer18Template extends DefenderNPCTemplate {
	public static final int ID = 35237;

	@Inject
	protected CourtSorcerer18Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
