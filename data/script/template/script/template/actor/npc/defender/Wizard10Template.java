 ...
 */
public class Wizard10Template extends DefenderNPCTemplate {
	public static final int ID = 35993;

	@Inject
	protected Wizard10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
