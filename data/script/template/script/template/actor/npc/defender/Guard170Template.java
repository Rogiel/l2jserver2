 ...
 */
public class Guard170Template extends DefenderNPCTemplate {
	public static final int ID = 36019;

	@Inject
	protected Guard170Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
