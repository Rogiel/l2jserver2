 ...
 */
public class Recruit2Template extends DefenderNPCTemplate {
	public static final int ID = 35051;

	@Inject
	protected Recruit2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
