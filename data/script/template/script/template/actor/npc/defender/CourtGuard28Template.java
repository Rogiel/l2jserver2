 ...
 */
public class CourtGuard28Template extends DefenderNPCTemplate {
	public static final int ID = 35742;

	@Inject
	protected CourtGuard28Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
