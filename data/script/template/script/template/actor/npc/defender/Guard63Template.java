 ...
 */
public class Guard63Template extends DefenderNPCTemplate {
	public static final int ID = 35215;

	@Inject
	protected Guard63Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
