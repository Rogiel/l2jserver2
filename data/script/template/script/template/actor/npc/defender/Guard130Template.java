 ...
 */
public class Guard130Template extends DefenderNPCTemplate {
	public static final int ID = 35530;

	@Inject
	protected Guard130Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
