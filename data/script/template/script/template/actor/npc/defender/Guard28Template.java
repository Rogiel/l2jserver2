 ...
 */
public class Guard28Template extends DefenderNPCTemplate {
	public static final int ID = 35119;

	@Inject
	protected Guard28Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
