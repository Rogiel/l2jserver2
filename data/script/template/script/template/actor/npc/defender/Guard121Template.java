 ...
 */
public class Guard121Template extends DefenderNPCTemplate {
	public static final int ID = 35496;

	@Inject
	protected Guard121Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
