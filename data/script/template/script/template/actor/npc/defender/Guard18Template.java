 ...
 */
public class Guard18Template extends DefenderNPCTemplate {
	public static final int ID = 35089;

	@Inject
	protected Guard18Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
