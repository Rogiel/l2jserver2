 ...
 */
public class Guard48Template extends DefenderNPCTemplate {
	public static final int ID = 35196;

	@Inject
	protected Guard48Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
