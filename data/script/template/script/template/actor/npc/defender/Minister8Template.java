 ...
 */
public class Minister8Template extends DefenderNPCTemplate {
	public static final int ID = 36205;

	@Inject
	protected Minister8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
