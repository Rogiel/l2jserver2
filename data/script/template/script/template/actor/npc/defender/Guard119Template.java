 ...
 */
public class Guard119Template extends DefenderNPCTemplate {
	public static final int ID = 35494;

	@Inject
	protected Guard119Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
