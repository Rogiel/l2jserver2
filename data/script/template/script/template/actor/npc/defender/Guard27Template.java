 ...
 */
public class Guard27Template extends DefenderNPCTemplate {
	public static final int ID = 35118;

	@Inject
	protected Guard27Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
