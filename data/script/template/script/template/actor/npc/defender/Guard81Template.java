 ...
 */
public class Guard81Template extends DefenderNPCTemplate {
	public static final int ID = 35258;

	@Inject
	protected Guard81Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
