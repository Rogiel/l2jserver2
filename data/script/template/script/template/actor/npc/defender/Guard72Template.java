 ...
 */
public class Guard72Template extends DefenderNPCTemplate {
	public static final int ID = 35245;

	@Inject
	protected Guard72Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
