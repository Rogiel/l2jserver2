 ...
 */
public class MilitaryAssociationLeader4Template extends DefenderNPCTemplate {
	public static final int ID = 36526;

	@Inject
	protected MilitaryAssociationLeader4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
