 ...
 */
public class CourtSorcerer25Template extends DefenderNPCTemplate {
	public static final int ID = 35327;

	@Inject
	protected CourtSorcerer25Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
