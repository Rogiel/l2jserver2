 ...
 */
public class Guard129Template extends DefenderNPCTemplate {
	public static final int ID = 35529;

	@Inject
	protected Guard129Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
