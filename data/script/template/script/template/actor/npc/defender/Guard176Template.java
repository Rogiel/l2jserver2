 ...
 */
public class Guard176Template extends DefenderNPCTemplate {
	public static final int ID = 36089;

	@Inject
	protected Guard176Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
