 ...
 */
public class MercenaryOfDawn5Template extends DefenderNPCTemplate {
	public static final int ID = 35024;

	@Inject
	protected MercenaryOfDawn5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
