 ...
 */
public class CourtGuard30Template extends DefenderNPCTemplate {
	public static final int ID = 35811;

	@Inject
	protected CourtGuard30Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
