 ...
 */
public class CourtGuard6Template extends DefenderNPCTemplate {
	public static final int ID = 35126;

	@Inject
	protected CourtGuard6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.rightHand = itemProvider.createID(2499);
		this.leftHand = null;
		this.enchantLevel = 0;
