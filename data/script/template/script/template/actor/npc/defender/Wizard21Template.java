 ...
 */
public class Wizard21Template extends DefenderNPCTemplate {
	public static final int ID = 36383;

	@Inject
	protected Wizard21Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
