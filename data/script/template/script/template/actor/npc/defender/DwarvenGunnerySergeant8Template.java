 ...
 */
public class DwarvenGunnerySergeant8Template extends DefenderNPCTemplate {
	public static final int ID = 35914;

	@Inject
	protected DwarvenGunnerySergeant8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
