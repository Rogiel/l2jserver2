 ...
 */
public class RebelCommander21Template extends DefenderNPCTemplate {
	public static final int ID = 36368;

	@Inject
	protected RebelCommander21Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
