 ...
 */
public class SchahtTemplate extends DefenderNPCTemplate {
	public static final int ID = 35281;

	@Inject
	protected SchahtTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
