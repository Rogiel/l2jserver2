 ...
 */
public class Healer21Template extends DefenderNPCTemplate {
	public static final int ID = 36384;

	@Inject
	protected Healer21Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
