 ...
 */
public class Bodyguard2Template extends DefenderNPCTemplate {
	public static final int ID = 35331;

	@Inject
	protected Bodyguard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
