 ...
 */
public class CourtGuard16Template extends DefenderNPCTemplate {
	public static final int ID = 35195;

	@Inject
	protected CourtGuard16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
