 ...
 */
public class Guard73Template extends DefenderNPCTemplate {
	public static final int ID = 35246;

	@Inject
	protected Guard73Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
