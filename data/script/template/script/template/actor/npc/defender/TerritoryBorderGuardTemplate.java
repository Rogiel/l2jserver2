 ...
 */
public class TerritoryBorderGuardTemplate extends DefenderNPCTemplate {
	public static final int ID = 36509;

	@Inject
	protected TerritoryBorderGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
