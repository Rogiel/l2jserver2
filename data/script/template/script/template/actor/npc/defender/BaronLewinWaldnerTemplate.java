 ...
 */
public class BaronLewinWaldnerTemplate extends DefenderNPCTemplate {
	public static final int ID = 35064;

	@Inject
	protected BaronLewinWaldnerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Baron Lewin Waldner";
