 ...
 */
public class RebelCommander14Template extends DefenderNPCTemplate {
	public static final int ID = 36122;

	@Inject
	protected RebelCommander14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
