 ...
 */
public class Bodyguard12Template extends DefenderNPCTemplate {
	public static final int ID = 35345;

	@Inject
	protected Bodyguard12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
