 ...
 */
public class CourtGuard13Template extends DefenderNPCTemplate {
	public static final int ID = 35133;

	@Inject
	protected CourtGuard13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
