 ...
 */
public class CourtGuard43Template extends DefenderNPCTemplate {
	public static final int ID = 36264;

	@Inject
	protected CourtGuard43Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
