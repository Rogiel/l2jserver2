 ...
 */
public class Recruit3Template extends DefenderNPCTemplate {
	public static final int ID = 35052;

	@Inject
	protected Recruit3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
