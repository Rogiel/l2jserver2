 ...
 */
public class PurpleFlag2Template extends DefenderNPCTemplate {
	public static final int ID = 35611;

	@Inject
	protected PurpleFlag2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Purple Flag";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 51.80;
		this.collisionHeight = 108.25;
		this.level = 75;
		this.sex = null;
		this.attackRange = 40;
