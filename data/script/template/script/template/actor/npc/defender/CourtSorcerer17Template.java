 ...
 */
public class CourtSorcerer17Template extends DefenderNPCTemplate {
	public static final int ID = 35236;

	@Inject
	protected CourtSorcerer17Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
