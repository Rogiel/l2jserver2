 ...
 */
public class Guard47Template extends DefenderNPCTemplate {
	public static final int ID = 35175;

	@Inject
	protected Guard47Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
