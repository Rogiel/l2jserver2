 ...
 */
public class TerritoryBorderGuard2Template extends DefenderNPCTemplate {
	public static final int ID = 36512;

	@Inject
	protected TerritoryBorderGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
