 ...
 */
public class Guard113Template extends DefenderNPCTemplate {
	public static final int ID = 35488;

	@Inject
	protected Guard113Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
