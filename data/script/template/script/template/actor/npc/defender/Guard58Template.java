 ...
 */
public class Guard58Template extends DefenderNPCTemplate {
	public static final int ID = 35210;

	@Inject
	protected Guard58Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
