 ...
 */
public class MilitaryAssociationLeader8Template extends DefenderNPCTemplate {
	public static final int ID = 36550;

	@Inject
	protected MilitaryAssociationLeader8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
