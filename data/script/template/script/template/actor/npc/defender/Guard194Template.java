 ...
 */
public class Guard194Template extends DefenderNPCTemplate {
	public static final int ID = 36302;

	@Inject
	protected Guard194Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
