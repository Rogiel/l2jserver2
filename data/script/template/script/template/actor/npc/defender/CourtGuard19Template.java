 ...
 */
public class CourtGuard19Template extends DefenderNPCTemplate {
	public static final int ID = 35251;

	@Inject
	protected CourtGuard19Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
