 ...
 */
public class Mercenary7Template extends DefenderNPCTemplate {
	public static final int ID = 35014;

	@Inject
	protected Mercenary7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
