 ...
 */
public class Guard15Template extends DefenderNPCTemplate {
	public static final int ID = 35086;

	@Inject
	protected Guard15Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
