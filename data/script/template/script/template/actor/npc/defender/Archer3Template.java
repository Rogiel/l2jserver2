 ...
 */
public class Archer3Template extends DefenderNPCTemplate {
	public static final int ID = 35753;

	@Inject
	protected Archer3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
