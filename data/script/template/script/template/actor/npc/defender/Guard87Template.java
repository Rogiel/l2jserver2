 ...
 */
public class Guard87Template extends DefenderNPCTemplate {
	public static final int ID = 35289;

	@Inject
	protected Guard87Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
