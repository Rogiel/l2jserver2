 ...
 */
public class ReligiousAssociationLeader8Template extends DefenderNPCTemplate {
	public static final int ID = 36552;

	@Inject
	protected ReligiousAssociationLeader8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
