 ...
 */
public class EliteMercenaryGuildMember10Template extends DefenderNPCTemplate {
	public static final int ID = 35039;

	@Inject
	protected EliteMercenaryGuildMember10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
