 ...
 */
public class Guard29Template extends DefenderNPCTemplate {
	public static final int ID = 35120;

	@Inject
	protected Guard29Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
