 ...
 */
public class Recruit8Template extends DefenderNPCTemplate {
	public static final int ID = 35057;

	@Inject
	protected Recruit8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
