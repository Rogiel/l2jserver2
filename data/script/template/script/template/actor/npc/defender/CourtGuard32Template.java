 ...
 */
public class CourtGuard32Template extends DefenderNPCTemplate {
	public static final int ID = 35874;

	@Inject
	protected CourtGuard32Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
