 ...
 */
public class Bodyguard7Template extends DefenderNPCTemplate {
	public static final int ID = 35336;

	@Inject
	protected Bodyguard7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
