 ...
 */
public class RebelCommander10Template extends DefenderNPCTemplate {
	public static final int ID = 35978;

	@Inject
	protected RebelCommander10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
