 ...
 */
public class RebelCommander5Template extends DefenderNPCTemplate {
	public static final int ID = 35808;

	@Inject
	protected RebelCommander5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
