 ...
 */
public class RebelPrivate19Template extends DefenderNPCTemplate {
	public static final int ID = 36300;

	@Inject
	protected RebelPrivate19Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
