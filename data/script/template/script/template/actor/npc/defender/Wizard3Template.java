 ...
 */
public class Wizard3Template extends DefenderNPCTemplate {
	public static final int ID = 35750;

	@Inject
	protected Wizard3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
