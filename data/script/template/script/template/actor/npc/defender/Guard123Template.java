 ...
 */
public class Guard123Template extends DefenderNPCTemplate {
	public static final int ID = 35523;

	@Inject
	protected Guard123Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
