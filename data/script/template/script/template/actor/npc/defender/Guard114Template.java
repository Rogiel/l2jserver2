 ...
 */
public class Guard114Template extends DefenderNPCTemplate {
	public static final int ID = 35489;

	@Inject
	protected Guard114Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
