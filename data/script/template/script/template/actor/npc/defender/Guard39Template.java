 ...
 */
public class Guard39Template extends DefenderNPCTemplate {
	public static final int ID = 35167;

	@Inject
	protected Guard39Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
