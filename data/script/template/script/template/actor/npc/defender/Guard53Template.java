 ...
 */
public class Guard53Template extends DefenderNPCTemplate {
	public static final int ID = 35201;

	@Inject
	protected Guard53Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
