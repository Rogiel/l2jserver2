 ...
 */
public class RebelPrivate5Template extends DefenderNPCTemplate {
	public static final int ID = 35810;

	@Inject
	protected RebelPrivate5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
