 ...
 */
public class Minister2Template extends DefenderNPCTemplate {
	public static final int ID = 35791;

	@Inject
	protected Minister2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
