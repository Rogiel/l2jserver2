 ...
 */
public class Guard55Template extends DefenderNPCTemplate {
	public static final int ID = 35203;

	@Inject
	protected Guard55Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
