 ...
 */
public class Recruit9Template extends DefenderNPCTemplate {
	public static final int ID = 35058;

	@Inject
	protected Recruit9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
