 ...
 */
public class Guard108Template extends DefenderNPCTemplate {
	public static final int ID = 35479;

	@Inject
	protected Guard108Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
