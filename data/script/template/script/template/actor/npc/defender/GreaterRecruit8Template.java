 ...
 */
public class GreaterRecruit8Template extends DefenderNPCTemplate {
	public static final int ID = 35047;

	@Inject
	protected GreaterRecruit8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
