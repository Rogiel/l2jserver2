 ...
 */
public class Healer15Template extends DefenderNPCTemplate {
	public static final int ID = 36165;

	@Inject
	protected Healer15Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
