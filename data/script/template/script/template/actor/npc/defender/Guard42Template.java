 ...
 */
public class Guard42Template extends DefenderNPCTemplate {
	public static final int ID = 35170;

	@Inject
	protected Guard42Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
