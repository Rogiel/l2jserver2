 ...
 */
public class DwarvenGunnerySergeant10Template extends DefenderNPCTemplate {
	public static final int ID = 35987;

	@Inject
	protected DwarvenGunnerySergeant10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dwarven Gunnery Sergeant";
