 ...
 */
public class Guard92Template extends DefenderNPCTemplate {
	public static final int ID = 35294;

	@Inject
	protected Guard92Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
