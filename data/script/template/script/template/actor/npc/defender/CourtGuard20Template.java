 ...
 */
public class CourtGuard20Template extends DefenderNPCTemplate {
	public static final int ID = 35285;

	@Inject
	protected CourtGuard20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
