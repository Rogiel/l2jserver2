 ...
 */
public class Guard80Template extends DefenderNPCTemplate {
	public static final int ID = 35257;

	@Inject
	protected Guard80Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
