 ...
 */
public class Guard93Template extends DefenderNPCTemplate {
	public static final int ID = 35299;

	@Inject
	protected Guard93Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
