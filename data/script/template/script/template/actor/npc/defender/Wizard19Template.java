 ...
 */
public class Wizard19Template extends DefenderNPCTemplate {
	public static final int ID = 36309;

	@Inject
	protected Wizard19Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
