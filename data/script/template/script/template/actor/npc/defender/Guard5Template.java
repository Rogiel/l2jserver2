 ...
 */
public class Guard5Template extends DefenderNPCTemplate {
	public static final int ID = 35072;

	@Inject
	protected Guard5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
