 ...
 */
public class DecoratedRebelSoldier5Template extends DefenderNPCTemplate {
	public static final int ID = 35809;

	@Inject
	protected DecoratedRebelSoldier5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
