 ...
 */
public class Mercenary6Template extends DefenderNPCTemplate {
	public static final int ID = 35013;

	@Inject
	protected Mercenary6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
