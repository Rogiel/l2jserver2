 ...
 */
public class Bodyguard13Template extends DefenderNPCTemplate {
	public static final int ID = 35346;

	@Inject
	protected Bodyguard13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
