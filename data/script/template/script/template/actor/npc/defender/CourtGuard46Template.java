 ...
 */
public class CourtGuard46Template extends DefenderNPCTemplate {
	public static final int ID = 36371;

	@Inject
	protected CourtGuard46Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
