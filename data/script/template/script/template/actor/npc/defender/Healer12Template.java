 ...
 */
public class Healer12Template extends DefenderNPCTemplate {
	public static final int ID = 36063;

	@Inject
	protected Healer12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
