 ...
 */
public class DwarvenGunnerySergeant7Template extends DefenderNPCTemplate {
	public static final int ID = 35880;

	@Inject
	protected DwarvenGunnerySergeant7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
