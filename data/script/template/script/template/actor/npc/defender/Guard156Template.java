 ...
 */
public class Guard156Template extends DefenderNPCTemplate {
	public static final int ID = 35847;

	@Inject
	protected Guard156Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
