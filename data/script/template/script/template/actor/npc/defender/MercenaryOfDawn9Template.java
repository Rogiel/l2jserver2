 ...
 */
public class MercenaryOfDawn9Template extends DefenderNPCTemplate {
	public static final int ID = 35028;

	@Inject
	protected MercenaryOfDawn9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
