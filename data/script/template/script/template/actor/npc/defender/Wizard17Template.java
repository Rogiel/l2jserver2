 ...
 */
public class Wizard17Template extends DefenderNPCTemplate {
	public static final int ID = 36238;

	@Inject
	protected Wizard17Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
