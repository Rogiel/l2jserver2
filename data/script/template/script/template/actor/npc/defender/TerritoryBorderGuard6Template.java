 ...
 */
public class TerritoryBorderGuard6Template extends DefenderNPCTemplate {
	public static final int ID = 36524;

	@Inject
	protected TerritoryBorderGuard6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
