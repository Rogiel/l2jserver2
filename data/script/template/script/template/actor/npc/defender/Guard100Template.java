 ...
 */
public class Guard100Template extends DefenderNPCTemplate {
	public static final int ID = 35306;

	@Inject
	protected Guard100Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
