 ...
 */
public class RoyalKnight9Template extends DefenderNPCTemplate {
	public static final int ID = 35235;

	@Inject
	protected RoyalKnight9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
