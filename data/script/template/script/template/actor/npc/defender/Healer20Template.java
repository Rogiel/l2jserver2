 ...
 */
public class Healer20Template extends DefenderNPCTemplate {
	public static final int ID = 36346;

	@Inject
	protected Healer20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
