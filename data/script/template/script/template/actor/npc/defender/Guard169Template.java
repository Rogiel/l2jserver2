 ...
 */
public class Guard169Template extends DefenderNPCTemplate {
	public static final int ID = 35991;

	@Inject
	protected Guard169Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
