 ...
 */
public class CourtGuard3Template extends DefenderNPCTemplate {
	public static final int ID = 35111;

	@Inject
	protected CourtGuard3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
