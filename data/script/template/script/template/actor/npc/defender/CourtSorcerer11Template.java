 ...
 */
public class CourtSorcerer11Template extends DefenderNPCTemplate {
	public static final int ID = 35164;

	@Inject
	protected CourtSorcerer11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
