 ...
 */
public class Guard198Template extends DefenderNPCTemplate {
	public static final int ID = 36342;

	@Inject
	protected Guard198Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
