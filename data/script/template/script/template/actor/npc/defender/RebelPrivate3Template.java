 ...
 */
public class RebelPrivate3Template extends DefenderNPCTemplate {
	public static final int ID = 35741;

	@Inject
	protected RebelPrivate3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
