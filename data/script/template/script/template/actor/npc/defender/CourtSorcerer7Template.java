 ...
 */
public class CourtSorcerer7Template extends DefenderNPCTemplate {
	public static final int ID = 35122;

	@Inject
	protected CourtSorcerer7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
