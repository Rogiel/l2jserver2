 ...
 */
public class Archer14Template extends DefenderNPCTemplate {
	public static final int ID = 36136;

	@Inject
	protected Archer14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
