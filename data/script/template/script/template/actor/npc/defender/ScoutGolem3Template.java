 ...
 */
public class ScoutGolem3Template extends DefenderNPCTemplate {
	public static final int ID = 35881;

	@Inject
	protected ScoutGolem3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
