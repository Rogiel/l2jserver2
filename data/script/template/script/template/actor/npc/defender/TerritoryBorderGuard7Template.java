 ...
 */
public class TerritoryBorderGuard7Template extends DefenderNPCTemplate {
	public static final int ID = 36527;

	@Inject
	protected TerritoryBorderGuard7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
