 ...
 */
public class RebelPrivate13Template extends DefenderNPCTemplate {
	public static final int ID = 36087;

	@Inject
	protected RebelPrivate13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
