 ...
 */
public class Guard103Template extends DefenderNPCTemplate {
	public static final int ID = 35342;

	@Inject
	protected Guard103Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
