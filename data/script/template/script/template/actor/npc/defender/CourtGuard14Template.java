 ...
 */
public class CourtGuard14Template extends DefenderNPCTemplate {
	public static final int ID = 35153;

	@Inject
	protected CourtGuard14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
