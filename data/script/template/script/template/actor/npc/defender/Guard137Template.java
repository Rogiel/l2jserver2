 ...
 */
public class Guard137Template extends DefenderNPCTemplate {
	public static final int ID = 35541;

	@Inject
	protected Guard137Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
