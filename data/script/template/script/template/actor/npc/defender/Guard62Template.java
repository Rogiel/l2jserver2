 ...
 */
public class Guard62Template extends DefenderNPCTemplate {
	public static final int ID = 35214;

	@Inject
	protected Guard62Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
