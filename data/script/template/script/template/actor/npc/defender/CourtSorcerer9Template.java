 ...
 */
public class CourtSorcerer9Template extends DefenderNPCTemplate {
	public static final int ID = 35151;

	@Inject
	protected CourtSorcerer9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
