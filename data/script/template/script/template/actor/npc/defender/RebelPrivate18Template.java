 ...
 */
public class RebelPrivate18Template extends DefenderNPCTemplate {
	public static final int ID = 36263;

	@Inject
	protected RebelPrivate18Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
