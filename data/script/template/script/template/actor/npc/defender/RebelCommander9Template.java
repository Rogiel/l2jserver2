 ...
 */
public class RebelCommander9Template extends DefenderNPCTemplate {
	public static final int ID = 35940;

	@Inject
	protected RebelCommander9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
