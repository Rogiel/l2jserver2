 ...
 */
public class Healer5Template extends DefenderNPCTemplate {
	public static final int ID = 35820;

	@Inject
	protected Healer5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
