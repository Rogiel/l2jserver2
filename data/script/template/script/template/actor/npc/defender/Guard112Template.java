 ...
 */
public class Guard112Template extends DefenderNPCTemplate {
	public static final int ID = 35483;

	@Inject
	protected Guard112Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
