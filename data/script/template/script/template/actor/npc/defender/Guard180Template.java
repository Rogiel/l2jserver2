 ...
 */
public class Guard180Template extends DefenderNPCTemplate {
	public static final int ID = 36130;

	@Inject
	protected Guard180Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
