 ...
 */
public class Guard102Template extends DefenderNPCTemplate {
	public static final int ID = 35329;

	@Inject
	protected Guard102Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
