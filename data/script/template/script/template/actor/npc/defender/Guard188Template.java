 ...
 */
public class Guard188Template extends DefenderNPCTemplate {
	public static final int ID = 36227;

	@Inject
	protected Guard188Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
