 ...
 */
public class Guard67Template extends DefenderNPCTemplate {
	public static final int ID = 35240;

	@Inject
	protected Guard67Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
