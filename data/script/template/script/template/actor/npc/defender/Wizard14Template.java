 ...
 */
public class Wizard14Template extends DefenderNPCTemplate {
	public static final int ID = 36133;

	@Inject
	protected Wizard14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
