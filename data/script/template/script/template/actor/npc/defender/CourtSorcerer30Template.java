 ...
 */
public class CourtSorcerer30Template extends DefenderNPCTemplate {
	public static final int ID = 35473;

	@Inject
	protected CourtSorcerer30Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
