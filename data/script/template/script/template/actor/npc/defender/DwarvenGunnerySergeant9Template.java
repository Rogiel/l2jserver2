 ...
 */
public class DwarvenGunnerySergeant9Template extends DefenderNPCTemplate {
	public static final int ID = 35949;

	@Inject
	protected DwarvenGunnerySergeant9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
