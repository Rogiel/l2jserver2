 ...
 */
public class CourtSorcerer21Template extends DefenderNPCTemplate {
	public static final int ID = 35283;

	@Inject
	protected CourtSorcerer21Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
