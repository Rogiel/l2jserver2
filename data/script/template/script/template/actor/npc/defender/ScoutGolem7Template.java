 ...
 */
public class ScoutGolem7Template extends DefenderNPCTemplate {
	public static final int ID = 36095;

	@Inject
	protected ScoutGolem7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
