 ...
 */
public class Recruit6Template extends DefenderNPCTemplate {
	public static final int ID = 35055;

	@Inject
	protected Recruit6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
