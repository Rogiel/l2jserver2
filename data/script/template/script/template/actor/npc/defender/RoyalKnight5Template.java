 ...
 */
public class RoyalKnight5Template extends DefenderNPCTemplate {
	public static final int ID = 35150;

	@Inject
	protected RoyalKnight5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
