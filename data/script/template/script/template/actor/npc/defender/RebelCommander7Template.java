 ...
 */
public class RebelCommander7Template extends DefenderNPCTemplate {
	public static final int ID = 35871;

	@Inject
	protected RebelCommander7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
