 ...
 */
public class Guard105Template extends DefenderNPCTemplate {
	public static final int ID = 35476;

	@Inject
	protected Guard105Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
