 ...
 */
public class Wizard12Template extends DefenderNPCTemplate {
	public static final int ID = 36062;

	@Inject
	protected Wizard12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
