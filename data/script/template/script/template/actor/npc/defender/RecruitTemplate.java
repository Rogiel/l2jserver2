 ...
 */
public class RecruitTemplate extends DefenderNPCTemplate {
	public static final int ID = 35050;

	@Inject
	protected RecruitTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
