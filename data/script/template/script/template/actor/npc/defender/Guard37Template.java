 ...
 */
public class Guard37Template extends DefenderNPCTemplate {
	public static final int ID = 35161;

	@Inject
	protected Guard37Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
