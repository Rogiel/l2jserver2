 ...
 */
public class Guard6Template extends DefenderNPCTemplate {
	public static final int ID = 35073;

	@Inject
	protected Guard6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
