 ...
 */
public class Guard177Template extends DefenderNPCTemplate {
	public static final int ID = 36097;

	@Inject
	protected Guard177Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
