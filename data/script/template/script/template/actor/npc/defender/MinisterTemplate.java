 ...
 */
public class MinisterTemplate extends DefenderNPCTemplate {
	public static final int ID = 35722;

	@Inject
	protected MinisterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
