 ...
 */
public class Guard111Template extends DefenderNPCTemplate {
	public static final int ID = 35482;

	@Inject
	protected Guard111Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
