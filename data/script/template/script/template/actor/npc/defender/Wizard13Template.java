 ...
 */
public class Wizard13Template extends DefenderNPCTemplate {
	public static final int ID = 36100;

	@Inject
	protected Wizard13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
