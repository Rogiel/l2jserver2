 ...
 */
public class Guard191Template extends DefenderNPCTemplate {
	public static final int ID = 36265;

	@Inject
	protected Guard191Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
