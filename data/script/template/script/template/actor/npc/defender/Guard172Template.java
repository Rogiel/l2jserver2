 ...
 */
public class Guard172Template extends DefenderNPCTemplate {
	public static final int ID = 36024;

	@Inject
	protected Guard172Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
