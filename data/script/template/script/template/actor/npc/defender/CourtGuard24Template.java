 ...
 */
public class CourtGuard24Template extends DefenderNPCTemplate {
	public static final int ID = 35521;

	@Inject
	protected CourtGuard24Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
