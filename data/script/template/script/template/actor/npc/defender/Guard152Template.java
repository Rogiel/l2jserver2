 ...
 */
public class Guard152Template extends DefenderNPCTemplate {
	public static final int ID = 35812;

	@Inject
	protected Guard152Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
