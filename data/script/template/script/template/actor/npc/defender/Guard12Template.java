 ...
 */
public class Guard12Template extends DefenderNPCTemplate {
	public static final int ID = 35083;

	@Inject
	protected Guard12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
