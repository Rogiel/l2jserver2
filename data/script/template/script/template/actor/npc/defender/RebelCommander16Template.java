 ...
 */
public class RebelCommander16Template extends DefenderNPCTemplate {
	public static final int ID = 36185;

	@Inject
	protected RebelCommander16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
