 ...
 */
public class Minister6Template extends DefenderNPCTemplate {
	public static final int ID = 36067;

	@Inject
	protected Minister6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
