 ...
 */
public class Archer2Template extends DefenderNPCTemplate {
	public static final int ID = 35720;

	@Inject
	protected Archer2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
