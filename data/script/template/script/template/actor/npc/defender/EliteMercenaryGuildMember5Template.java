 ...
 */
public class EliteMercenaryGuildMember5Template extends DefenderNPCTemplate {
	public static final int ID = 35034;

	@Inject
	protected EliteMercenaryGuildMember5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
