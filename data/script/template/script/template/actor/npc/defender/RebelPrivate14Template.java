 ...
 */
public class RebelPrivate14Template extends DefenderNPCTemplate {
	public static final int ID = 36124;

	@Inject
	protected RebelPrivate14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
