 ...
 */
public class ScoutGolem5Template extends DefenderNPCTemplate {
	public static final int ID = 35988;

	@Inject
	protected ScoutGolem5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
