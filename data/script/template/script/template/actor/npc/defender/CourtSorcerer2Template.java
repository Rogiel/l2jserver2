 ...
 */
public class CourtSorcerer2Template extends DefenderNPCTemplate {
	public static final int ID = 35068;

	@Inject
	protected CourtSorcerer2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
