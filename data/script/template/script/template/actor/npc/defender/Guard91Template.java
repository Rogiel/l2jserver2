 ...
 */
public class Guard91Template extends DefenderNPCTemplate {
	public static final int ID = 35293;

	@Inject
	protected Guard91Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
