 ...
 */
public class DwarvenGunnerySergeant4Template extends DefenderNPCTemplate {
	public static final int ID = 35780;

	@Inject
	protected DwarvenGunnerySergeant4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
