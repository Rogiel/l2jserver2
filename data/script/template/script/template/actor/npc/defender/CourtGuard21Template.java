 ...
 */
public class CourtGuard21Template extends DefenderNPCTemplate {
	public static final int ID = 35298;

	@Inject
	protected CourtGuard21Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
