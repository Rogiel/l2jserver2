 ...
 */
public class Bodyguard16Template extends DefenderNPCTemplate {
	public static final int ID = 35349;

	@Inject
	protected Bodyguard16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
