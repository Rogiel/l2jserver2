 ...
 */
public class Wizard8Template extends DefenderNPCTemplate {
	public static final int ID = 35919;

	@Inject
	protected Wizard8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
