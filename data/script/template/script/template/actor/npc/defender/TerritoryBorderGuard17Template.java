 ...
 */
public class TerritoryBorderGuard17Template extends DefenderNPCTemplate {
	public static final int ID = 36557;

	@Inject
	protected TerritoryBorderGuard17Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
