 ...
 */
public class Bodyguard6Template extends DefenderNPCTemplate {
	public static final int ID = 35335;

	@Inject
	protected Bodyguard6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
