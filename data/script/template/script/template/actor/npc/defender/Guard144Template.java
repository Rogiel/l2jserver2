 ...
 */
public class Guard144Template extends DefenderNPCTemplate {
	public static final int ID = 35714;

	@Inject
	protected Guard144Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
