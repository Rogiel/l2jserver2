 ...
 */
public class CourtSorcerer15Template extends DefenderNPCTemplate {
	public static final int ID = 35206;

	@Inject
	protected CourtSorcerer15Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
