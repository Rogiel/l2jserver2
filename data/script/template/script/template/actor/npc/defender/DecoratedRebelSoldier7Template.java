 ...
 */
public class DecoratedRebelSoldier7Template extends DefenderNPCTemplate {
	public static final int ID = 35872;

	@Inject
	protected DecoratedRebelSoldier7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
