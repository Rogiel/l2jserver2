 ...
 */
public class CourtGuard9Template extends DefenderNPCTemplate {
	public static final int ID = 35129;

	@Inject
	protected CourtGuard9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
