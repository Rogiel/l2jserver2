 ...
 */
public class Guard30Template extends DefenderNPCTemplate {
	public static final int ID = 35154;

	@Inject
	protected Guard30Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
