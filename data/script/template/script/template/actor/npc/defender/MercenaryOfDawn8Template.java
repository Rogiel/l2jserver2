 ...
 */
public class MercenaryOfDawn8Template extends DefenderNPCTemplate {
	public static final int ID = 35027;

	@Inject
	protected MercenaryOfDawn8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
