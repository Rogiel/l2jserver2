 ...
 */
public class CourtGuard10Template extends DefenderNPCTemplate {
	public static final int ID = 35130;

	@Inject
	protected CourtGuard10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
