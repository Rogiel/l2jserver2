 ...
 */
public class Guard94Template extends DefenderNPCTemplate {
	public static final int ID = 35300;

	@Inject
	protected Guard94Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
