 ...
 */
public class ReligiousAssociationLeader7Template extends DefenderNPCTemplate {
	public static final int ID = 36546;

	@Inject
	protected ReligiousAssociationLeader7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
