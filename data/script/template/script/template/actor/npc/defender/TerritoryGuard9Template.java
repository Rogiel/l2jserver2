 ...
 */
public class TerritoryGuard9Template extends DefenderNPCTemplate {
	public static final int ID = 36559;

	@Inject
	protected TerritoryGuard9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Territory Guard";
