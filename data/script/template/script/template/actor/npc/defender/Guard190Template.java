 ...
 */
public class Guard190Template extends DefenderNPCTemplate {
	public static final int ID = 36236;

	@Inject
	protected Guard190Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
