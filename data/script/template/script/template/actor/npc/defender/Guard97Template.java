 ...
 */
public class Guard97Template extends DefenderNPCTemplate {
	public static final int ID = 35303;

	@Inject
	protected Guard97Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
