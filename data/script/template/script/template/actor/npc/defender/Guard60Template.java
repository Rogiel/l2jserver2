 ...
 */
public class Guard60Template extends DefenderNPCTemplate {
	public static final int ID = 35212;

	@Inject
	protected Guard60Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
