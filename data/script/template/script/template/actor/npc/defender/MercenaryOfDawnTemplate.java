 ...
 */
public class MercenaryOfDawnTemplate extends DefenderNPCTemplate {
	public static final int ID = 35020;

	@Inject
	protected MercenaryOfDawnTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
