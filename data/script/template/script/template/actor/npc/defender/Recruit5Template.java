 ...
 */
public class Recruit5Template extends DefenderNPCTemplate {
	public static final int ID = 35054;

	@Inject
	protected Recruit5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
