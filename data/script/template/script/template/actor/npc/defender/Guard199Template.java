 ...
 */
public class Guard199Template extends DefenderNPCTemplate {
	public static final int ID = 36343;

	@Inject
	protected Guard199Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
