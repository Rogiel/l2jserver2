 ...
 */
public class TerritoryBorderGuard9Template extends DefenderNPCTemplate {
	public static final int ID = 36533;

	@Inject
	protected TerritoryBorderGuard9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
