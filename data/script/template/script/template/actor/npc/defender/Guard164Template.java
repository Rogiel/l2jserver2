 ...
 */
public class Guard164Template extends DefenderNPCTemplate {
	public static final int ID = 35944;

	@Inject
	protected Guard164Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
