 ...
 */
public class EliteMercenaryGuildMember2Template extends DefenderNPCTemplate {
	public static final int ID = 35031;

	@Inject
	protected EliteMercenaryGuildMember2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
