 ...
 */
public class Guard75Template extends DefenderNPCTemplate {
	public static final int ID = 35252;

	@Inject
	protected Guard75Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
