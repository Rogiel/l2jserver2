 ...
 */
public class RebelPrivate21Template extends DefenderNPCTemplate {
	public static final int ID = 36370;

	@Inject
	protected RebelPrivate21Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
