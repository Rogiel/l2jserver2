 ...
 */
public class QuantTemplate extends DefenderNPCTemplate {
	public static final int ID = 35191;

	@Inject
	protected QuantTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
