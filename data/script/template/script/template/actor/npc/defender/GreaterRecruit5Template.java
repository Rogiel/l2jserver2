 ...
 */
public class GreaterRecruit5Template extends DefenderNPCTemplate {
	public static final int ID = 35044;

	@Inject
	protected GreaterRecruit5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
