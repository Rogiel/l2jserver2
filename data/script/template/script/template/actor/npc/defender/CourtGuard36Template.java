 ...
 */
public class CourtGuard36Template extends DefenderNPCTemplate {
	public static final int ID = 36018;

	@Inject
	protected CourtGuard36Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
