 ...
 */
public class RoyalKnight2Template extends DefenderNPCTemplate {
	public static final int ID = 35079;

	@Inject
	protected RoyalKnight2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
