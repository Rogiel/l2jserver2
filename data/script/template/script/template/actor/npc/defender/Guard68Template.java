 ...
 */
public class Guard68Template extends DefenderNPCTemplate {
	public static final int ID = 35241;

	@Inject
	protected Guard68Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
