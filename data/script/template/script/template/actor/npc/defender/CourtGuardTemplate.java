 ...
 */
public class CourtGuardTemplate extends DefenderNPCTemplate {
	public static final int ID = 35069;

	@Inject
	protected CourtGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
