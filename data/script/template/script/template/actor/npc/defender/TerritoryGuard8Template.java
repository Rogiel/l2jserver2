 ...
 */
public class TerritoryGuard8Template extends DefenderNPCTemplate {
	public static final int ID = 36553;

	@Inject
	protected TerritoryGuard8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
