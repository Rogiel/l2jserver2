 ...
 */
public class ReligiousAssociationLeaderTemplate extends DefenderNPCTemplate {
	public static final int ID = 36510;

	@Inject
	protected ReligiousAssociationLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
