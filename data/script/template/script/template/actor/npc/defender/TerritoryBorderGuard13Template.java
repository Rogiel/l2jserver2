 ...
 */
public class TerritoryBorderGuard13Template extends DefenderNPCTemplate {
	public static final int ID = 36545;

	@Inject
	protected TerritoryBorderGuard13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
