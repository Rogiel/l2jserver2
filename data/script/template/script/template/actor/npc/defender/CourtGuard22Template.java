 ...
 */
public class CourtGuard22Template extends DefenderNPCTemplate {
	public static final int ID = 35474;

	@Inject
	protected CourtGuard22Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
