 ...
 */
public class Guard43Template extends DefenderNPCTemplate {
	public static final int ID = 35171;

	@Inject
	protected Guard43Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
