 ...
 */
public class Archer9Template extends DefenderNPCTemplate {
	public static final int ID = 35958;

	@Inject
	protected Archer9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
