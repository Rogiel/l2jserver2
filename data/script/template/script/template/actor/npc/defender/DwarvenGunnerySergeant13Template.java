 ...
 */
public class DwarvenGunnerySergeant13Template extends DefenderNPCTemplate {
	public static final int ID = 36094;

	@Inject
	protected DwarvenGunnerySergeant13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
