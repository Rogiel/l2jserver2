 ...
 */
public class Guard20Template extends DefenderNPCTemplate {
	public static final int ID = 35091;

	@Inject
	protected Guard20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
