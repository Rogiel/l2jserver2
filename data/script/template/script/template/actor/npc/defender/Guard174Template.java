 ...
 */
public class Guard174Template extends DefenderNPCTemplate {
	public static final int ID = 36059;

	@Inject
	protected Guard174Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
