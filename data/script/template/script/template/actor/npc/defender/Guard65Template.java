 ...
 */
public class Guard65Template extends DefenderNPCTemplate {
	public static final int ID = 35217;

	@Inject
	protected Guard65Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
