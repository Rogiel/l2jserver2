 ...
 */
public class Guard167Template extends DefenderNPCTemplate {
	public static final int ID = 35982;

	@Inject
	protected Guard167Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
