 ...
 */
public class Guard24Template extends DefenderNPCTemplate {
	public static final int ID = 35115;

	@Inject
	protected Guard24Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
