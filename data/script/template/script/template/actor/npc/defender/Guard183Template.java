 ...
 */
public class Guard183Template extends DefenderNPCTemplate {
	public static final int ID = 36161;

	@Inject
	protected Guard183Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
