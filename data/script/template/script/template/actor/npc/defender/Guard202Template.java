 ...
 */
public class Guard202Template extends DefenderNPCTemplate {
	public static final int ID = 36381;

	@Inject
	protected Guard202Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
