 ...
 */
public class EliteMercenaryGuildMember8Template extends DefenderNPCTemplate {
	public static final int ID = 35037;

	@Inject
	protected EliteMercenaryGuildMember8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
