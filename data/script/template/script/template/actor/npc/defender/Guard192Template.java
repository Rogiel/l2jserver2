 ...
 */
public class Guard192Template extends DefenderNPCTemplate {
	public static final int ID = 36273;

	@Inject
	protected Guard192Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
