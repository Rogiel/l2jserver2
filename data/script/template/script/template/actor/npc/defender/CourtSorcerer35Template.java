 ...
 */
public class CourtSorcerer35Template extends DefenderNPCTemplate {
	public static final int ID = 35532;

	@Inject
	protected CourtSorcerer35Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
