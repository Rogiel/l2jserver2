 ...
 */
public class CourtGuard29Template extends DefenderNPCTemplate {
	public static final int ID = 35774;

	@Inject
	protected CourtGuard29Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
