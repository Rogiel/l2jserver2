 ...
 */
public class SwainKenOrwenTemplate extends DefenderNPCTemplate {
	public static final int ID = 35517;

	@Inject
	protected SwainKenOrwenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Swain Ken Orwen";
