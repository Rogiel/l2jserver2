 ...
 */
public class ReligiousAssociationLeader9Template extends DefenderNPCTemplate {
	public static final int ID = 36558;

	@Inject
	protected ReligiousAssociationLeader9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Religious Association Leader";
