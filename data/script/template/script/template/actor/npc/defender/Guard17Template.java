 ...
 */
public class Guard17Template extends DefenderNPCTemplate {
	public static final int ID = 35088;

	@Inject
	protected Guard17Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
