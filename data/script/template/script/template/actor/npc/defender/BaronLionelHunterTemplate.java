 ...
 */
public class BaronLionelHunterTemplate extends DefenderNPCTemplate {
	public static final int ID = 35280;

	@Inject
	protected BaronLionelHunterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Baron Lionel Hunter";
