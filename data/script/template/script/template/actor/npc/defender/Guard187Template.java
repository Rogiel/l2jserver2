 ...
 */
public class Guard187Template extends DefenderNPCTemplate {
	public static final int ID = 36198;

	@Inject
	protected Guard187Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
