 ...
 */
public class CourtGuard17Template extends DefenderNPCTemplate {
	public static final int ID = 35208;

	@Inject
	protected CourtGuard17Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
