 ...
 */
public class ScoutGolem2Template extends DefenderNPCTemplate {
	public static final int ID = 35781;

	@Inject
	protected ScoutGolem2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
