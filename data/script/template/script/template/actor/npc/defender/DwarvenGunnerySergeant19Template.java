 ...
 */
public class DwarvenGunnerySergeant19Template extends DefenderNPCTemplate {
	public static final int ID = 36304;

	@Inject
	protected DwarvenGunnerySergeant19Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
