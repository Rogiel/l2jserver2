 ...
 */
public class Guard148Template extends DefenderNPCTemplate {
	public static final int ID = 35748;

	@Inject
	protected Guard148Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
