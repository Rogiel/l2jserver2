 ...
 */
public class MercenaryOfDawn3Template extends DefenderNPCTemplate {
	public static final int ID = 35022;

	@Inject
	protected MercenaryOfDawn3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
