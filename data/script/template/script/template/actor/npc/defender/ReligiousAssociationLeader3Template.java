 ...
 */
public class ReligiousAssociationLeader3Template extends DefenderNPCTemplate {
	public static final int ID = 36522;

	@Inject
	protected ReligiousAssociationLeader3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
