 ...
 */
public class EliteMercenaryGuildMemberTemplate extends DefenderNPCTemplate {
	public static final int ID = 35030;

	@Inject
	protected EliteMercenaryGuildMemberTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
