 ...
 */
public class WizardTemplate extends DefenderNPCTemplate {
	public static final int ID = 35681;

	@Inject
	protected WizardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
