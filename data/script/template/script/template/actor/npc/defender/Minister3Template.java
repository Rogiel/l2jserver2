 ...
 */
public class Minister3Template extends DefenderNPCTemplate {
	public static final int ID = 35891;

	@Inject
	protected Minister3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
