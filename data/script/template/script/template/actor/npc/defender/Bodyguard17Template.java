 ...
 */
public class Bodyguard17Template extends DefenderNPCTemplate {
	public static final int ID = 35350;

	@Inject
	protected Bodyguard17Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
