 ...
 */
public class TerritoryGuard6Template extends DefenderNPCTemplate {
	public static final int ID = 36541;

	@Inject
	protected TerritoryGuard6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
