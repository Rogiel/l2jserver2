 ...
 */
public class DecoratedRebelSoldier20Template extends DefenderNPCTemplate {
	public static final int ID = 36331;

	@Inject
	protected DecoratedRebelSoldier20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Decorated Rebel Soldier";
