 ...
 */
public class AstairVanHalterTemplate extends DefenderNPCTemplate {
	public static final int ID = 35470;

	@Inject
	protected AstairVanHalterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Astair van Halter";
