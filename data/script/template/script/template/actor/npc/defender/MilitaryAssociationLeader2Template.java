 ...
 */
public class MilitaryAssociationLeader2Template extends DefenderNPCTemplate {
	public static final int ID = 36514;

	@Inject
	protected MilitaryAssociationLeader2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
