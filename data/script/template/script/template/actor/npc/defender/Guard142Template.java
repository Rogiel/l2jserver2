 ...
 */
public class Guard142Template extends DefenderNPCTemplate {
	public static final int ID = 35679;

	@Inject
	protected Guard142Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
