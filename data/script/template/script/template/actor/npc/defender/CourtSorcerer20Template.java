 ...
 */
public class CourtSorcerer20Template extends DefenderNPCTemplate {
	public static final int ID = 35250;

	@Inject
	protected CourtSorcerer20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
