 ...
 */
public class Guard69Template extends DefenderNPCTemplate {
	public static final int ID = 35242;

	@Inject
	protected Guard69Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
