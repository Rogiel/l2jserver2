 ...
 */
public class RebelPrivate15Template extends DefenderNPCTemplate {
	public static final int ID = 36155;

	@Inject
	protected RebelPrivate15Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
