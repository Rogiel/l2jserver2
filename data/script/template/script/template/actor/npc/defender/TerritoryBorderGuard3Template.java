 ...
 */
public class TerritoryBorderGuard3Template extends DefenderNPCTemplate {
	public static final int ID = 36515;

	@Inject
	protected TerritoryBorderGuard3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
