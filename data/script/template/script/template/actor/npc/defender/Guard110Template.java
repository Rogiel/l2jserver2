 ...
 */
public class Guard110Template extends DefenderNPCTemplate {
	public static final int ID = 35481;

	@Inject
	protected Guard110Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
