 ...
 */
public class CourtSorcerer3Template extends DefenderNPCTemplate {
	public static final int ID = 35080;

	@Inject
	protected CourtSorcerer3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
