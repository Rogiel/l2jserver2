 ...
 */
public class DecoratedRebelSoldier4Template extends DefenderNPCTemplate {
	public static final int ID = 35772;

	@Inject
	protected DecoratedRebelSoldier4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
