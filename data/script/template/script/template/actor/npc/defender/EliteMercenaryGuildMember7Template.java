 ...
 */
public class EliteMercenaryGuildMember7Template extends DefenderNPCTemplate {
	public static final int ID = 35036;

	@Inject
	protected EliteMercenaryGuildMember7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
