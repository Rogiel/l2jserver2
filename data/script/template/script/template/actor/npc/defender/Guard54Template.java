 ...
 */
public class Guard54Template extends DefenderNPCTemplate {
	public static final int ID = 35202;

	@Inject
	protected Guard54Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
