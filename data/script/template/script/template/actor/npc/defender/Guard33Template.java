 ...
 */
public class Guard33Template extends DefenderNPCTemplate {
	public static final int ID = 35157;

	@Inject
	protected Guard33Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
