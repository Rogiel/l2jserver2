 ...
 */
public class CourtGuard33Template extends DefenderNPCTemplate {
	public static final int ID = 35911;

	@Inject
	protected CourtGuard33Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
