 ...
 */
public class DecoratedRebelSoldier3Template extends DefenderNPCTemplate {
	public static final int ID = 35740;

	@Inject
	protected DecoratedRebelSoldier3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
