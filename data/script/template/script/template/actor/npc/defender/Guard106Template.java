 ...
 */
public class Guard106Template extends DefenderNPCTemplate {
	public static final int ID = 35477;

	@Inject
	protected Guard106Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
