 ...
 */
public class Archer10Template extends DefenderNPCTemplate {
	public static final int ID = 35996;

	@Inject
	protected Archer10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
