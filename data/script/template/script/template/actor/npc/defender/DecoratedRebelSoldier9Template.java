 ...
 */
public class DecoratedRebelSoldier9Template extends DefenderNPCTemplate {
	public static final int ID = 35941;

	@Inject
	protected DecoratedRebelSoldier9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
