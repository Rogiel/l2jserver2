 ...
 */
public class TerritoryBorderGuard15Template extends DefenderNPCTemplate {
	public static final int ID = 36551;

	@Inject
	protected TerritoryBorderGuard15Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
