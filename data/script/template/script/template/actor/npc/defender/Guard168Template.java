 ...
 */
public class Guard168Template extends DefenderNPCTemplate {
	public static final int ID = 35990;

	@Inject
	protected Guard168Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
