 ...
 */
public class RebelCommander19Template extends DefenderNPCTemplate {
	public static final int ID = 36298;

	@Inject
	protected RebelCommander19Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
