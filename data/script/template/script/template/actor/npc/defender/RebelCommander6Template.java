 ...
 */
public class RebelCommander6Template extends DefenderNPCTemplate {
	public static final int ID = 35839;

	@Inject
	protected RebelCommander6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
