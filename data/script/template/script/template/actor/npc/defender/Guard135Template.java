 ...
 */
public class Guard135Template extends DefenderNPCTemplate {
	public static final int ID = 35539;

	@Inject
	protected Guard135Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
