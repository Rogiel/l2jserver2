 ...
 */
public class RebelCommander3Template extends DefenderNPCTemplate {
	public static final int ID = 35739;

	@Inject
	protected RebelCommander3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
