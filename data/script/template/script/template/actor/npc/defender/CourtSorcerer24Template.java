 ...
 */
public class CourtSorcerer24Template extends DefenderNPCTemplate {
	public static final int ID = 35297;

	@Inject
	protected CourtSorcerer24Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
