 ...
 */
public class RoyalKnight4Template extends DefenderNPCTemplate {
	public static final int ID = 35121;

	@Inject
	protected RoyalKnight4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
