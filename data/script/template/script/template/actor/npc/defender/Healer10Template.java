 ...
 */
public class Healer10Template extends DefenderNPCTemplate {
	public static final int ID = 35994;

	@Inject
	protected Healer10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
