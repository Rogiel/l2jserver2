 ...
 */
public class Bodyguard5Template extends DefenderNPCTemplate {
	public static final int ID = 35334;

	@Inject
	protected Bodyguard5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
