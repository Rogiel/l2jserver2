 ...
 */
public class Healer4Template extends DefenderNPCTemplate {
	public static final int ID = 35787;

	@Inject
	protected Healer4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
