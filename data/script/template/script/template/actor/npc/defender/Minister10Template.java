 ...
 */
public class Minister10Template extends DefenderNPCTemplate {
	public static final int ID = 36281;

	@Inject
	protected Minister10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Minister";
		this.serverSideName = false;
		this.title = "Officer's Barracks";
		...
		this.rightHand = itemProvider.createID(7895);
		this.leftHand = null;
		this.enchantLevel = 0;
