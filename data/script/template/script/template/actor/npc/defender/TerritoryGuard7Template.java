 ...
 */
public class TerritoryGuard7Template extends DefenderNPCTemplate {
	public static final int ID = 36547;

	@Inject
	protected TerritoryGuard7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
