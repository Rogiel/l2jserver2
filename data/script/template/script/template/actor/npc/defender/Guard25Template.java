 ...
 */
public class Guard25Template extends DefenderNPCTemplate {
	public static final int ID = 35116;

	@Inject
	protected Guard25Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
