 ...
 */
public class Guard163Template extends DefenderNPCTemplate {
	public static final int ID = 35917;

	@Inject
	protected Guard163Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
