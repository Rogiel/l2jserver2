 ...
 */
public class Archer17Template extends DefenderNPCTemplate {
	public static final int ID = 36241;

	@Inject
	protected Archer17Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
