 ...
 */
public class TerritoryBorderGuard8Template extends DefenderNPCTemplate {
	public static final int ID = 36530;

	@Inject
	protected TerritoryBorderGuard8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
