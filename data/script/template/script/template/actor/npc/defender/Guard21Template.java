 ...
 */
public class Guard21Template extends DefenderNPCTemplate {
	public static final int ID = 35112;

	@Inject
	protected Guard21Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
