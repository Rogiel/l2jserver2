 ...
 */
public class RebelCommander20Template extends DefenderNPCTemplate {
	public static final int ID = 36330;

	@Inject
	protected RebelCommander20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
