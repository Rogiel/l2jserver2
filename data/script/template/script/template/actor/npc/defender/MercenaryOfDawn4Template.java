 ...
 */
public class MercenaryOfDawn4Template extends DefenderNPCTemplate {
	public static final int ID = 35023;

	@Inject
	protected MercenaryOfDawn4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
