 ...
 */
public class ScoutGolem9Template extends DefenderNPCTemplate {
	public static final int ID = 36233;

	@Inject
	protected ScoutGolem9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
