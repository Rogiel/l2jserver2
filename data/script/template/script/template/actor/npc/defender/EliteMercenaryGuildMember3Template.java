 ...
 */
public class EliteMercenaryGuildMember3Template extends DefenderNPCTemplate {
	public static final int ID = 35032;

	@Inject
	protected EliteMercenaryGuildMember3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Elite Mercenary Guild Member";
		...
		this.rightHand = itemProvider.createID(280);
		this.leftHand = null;
		this.enchantLevel = 0;
