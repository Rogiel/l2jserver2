 ...
 */
public class Wizard16Template extends DefenderNPCTemplate {
	public static final int ID = 36200;

	@Inject
	protected Wizard16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
