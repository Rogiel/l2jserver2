 ...
 */
public class Wizard2Template extends DefenderNPCTemplate {
	public static final int ID = 35717;

	@Inject
	protected Wizard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
