 ...
 */
public class RebelCommanderTemplate extends DefenderNPCTemplate {
	public static final int ID = 35670;

	@Inject
	protected RebelCommanderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
