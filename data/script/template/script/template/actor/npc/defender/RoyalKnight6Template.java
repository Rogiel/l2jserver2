 ...
 */
public class RoyalKnight6Template extends DefenderNPCTemplate {
	public static final int ID = 35163;

	@Inject
	protected RoyalKnight6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
