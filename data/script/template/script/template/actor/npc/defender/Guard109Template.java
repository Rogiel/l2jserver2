 ...
 */
public class Guard109Template extends DefenderNPCTemplate {
	public static final int ID = 35480;

	@Inject
	protected Guard109Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
