 ...
 */
public class Guard50Template extends DefenderNPCTemplate {
	public static final int ID = 35198;

	@Inject
	protected Guard50Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
