 ...
 */
public class Guard8Template extends DefenderNPCTemplate {
	public static final int ID = 35075;

	@Inject
	protected Guard8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
