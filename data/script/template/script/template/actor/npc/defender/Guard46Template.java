 ...
 */
public class Guard46Template extends DefenderNPCTemplate {
	public static final int ID = 35174;

	@Inject
	protected Guard46Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
