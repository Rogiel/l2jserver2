 ...
 */
public class MercenaryOfDawn6Template extends DefenderNPCTemplate {
	public static final int ID = 35025;

	@Inject
	protected MercenaryOfDawn6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
