 ...
 */
public class Guard79Template extends DefenderNPCTemplate {
	public static final int ID = 35256;

	@Inject
	protected Guard79Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
