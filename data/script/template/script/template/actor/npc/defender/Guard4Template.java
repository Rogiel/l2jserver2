 ...
 */
public class Guard4Template extends DefenderNPCTemplate {
	public static final int ID = 35071;

	@Inject
	protected Guard4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
