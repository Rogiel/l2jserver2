 ...
 */
public class Guard158Template extends DefenderNPCTemplate {
	public static final int ID = 35875;

	@Inject
	protected Guard158Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
