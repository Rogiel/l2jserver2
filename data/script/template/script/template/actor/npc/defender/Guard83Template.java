 ...
 */
public class Guard83Template extends DefenderNPCTemplate {
	public static final int ID = 35260;

	@Inject
	protected Guard83Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
