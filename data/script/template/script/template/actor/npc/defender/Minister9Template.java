 ...
 */
public class Minister9Template extends DefenderNPCTemplate {
	public static final int ID = 36243;

	@Inject
	protected Minister9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
