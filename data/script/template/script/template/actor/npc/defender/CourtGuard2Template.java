 ...
 */
public class CourtGuard2Template extends DefenderNPCTemplate {
	public static final int ID = 35082;

	@Inject
	protected CourtGuard2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
