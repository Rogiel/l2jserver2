 ...
 */
public class EliteMercenaryGuildMember9Template extends DefenderNPCTemplate {
	public static final int ID = 35038;

	@Inject
	protected EliteMercenaryGuildMember9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
