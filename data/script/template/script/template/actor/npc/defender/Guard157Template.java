 ...
 */
public class Guard157Template extends DefenderNPCTemplate {
	public static final int ID = 35848;

	@Inject
	protected Guard157Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
