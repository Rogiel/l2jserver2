 ...
 */
public class DwarvenGunnerySergeant3Template extends DefenderNPCTemplate {
	public static final int ID = 35745;

	@Inject
	protected DwarvenGunnerySergeant3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
