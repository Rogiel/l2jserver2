 ...
 */
public class GreaterRecruit7Template extends DefenderNPCTemplate {
	public static final int ID = 35046;

	@Inject
	protected GreaterRecruit7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
