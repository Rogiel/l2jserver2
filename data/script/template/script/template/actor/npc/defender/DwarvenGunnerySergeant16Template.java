 ...
 */
public class DwarvenGunnerySergeant16Template extends DefenderNPCTemplate {
	public static final int ID = 36194;

	@Inject
	protected DwarvenGunnerySergeant16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
