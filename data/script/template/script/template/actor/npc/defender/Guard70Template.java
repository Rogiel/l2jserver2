 ...
 */
public class Guard70Template extends DefenderNPCTemplate {
	public static final int ID = 35243;

	@Inject
	protected Guard70Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
