 ...
 */
public class Healer14Template extends DefenderNPCTemplate {
	public static final int ID = 36134;

	@Inject
	protected Healer14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
