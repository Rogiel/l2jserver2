 ...
 */
public class MilitaryAssociationLeaderTemplate extends DefenderNPCTemplate {
	public static final int ID = 36508;

	@Inject
	protected MilitaryAssociationLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
