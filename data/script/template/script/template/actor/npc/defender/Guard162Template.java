 ...
 */
public class Guard162Template extends DefenderNPCTemplate {
	public static final int ID = 35916;

	@Inject
	protected Guard162Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
