 ...
 */
public class ScoutGolem4Template extends DefenderNPCTemplate {
	public static final int ID = 35950;

	@Inject
	protected ScoutGolem4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
