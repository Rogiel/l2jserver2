 ...
 */
public class Archer11Template extends DefenderNPCTemplate {
	public static final int ID = 36029;

	@Inject
	protected Archer11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
