 ...
 */
public class Recruit7Template extends DefenderNPCTemplate {
	public static final int ID = 35056;

	@Inject
	protected Recruit7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
