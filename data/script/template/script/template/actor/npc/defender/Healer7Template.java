 ...
 */
public class Healer7Template extends DefenderNPCTemplate {
	public static final int ID = 35887;

	@Inject
	protected Healer7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
