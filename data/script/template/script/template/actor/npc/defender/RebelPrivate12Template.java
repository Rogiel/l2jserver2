 ...
 */
public class RebelPrivate12Template extends DefenderNPCTemplate {
	public static final int ID = 36049;

	@Inject
	protected RebelPrivate12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
