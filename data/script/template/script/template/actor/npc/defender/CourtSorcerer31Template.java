 ...
 */
public class CourtSorcerer31Template extends DefenderNPCTemplate {
	public static final int ID = 35485;

	@Inject
	protected CourtSorcerer31Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
