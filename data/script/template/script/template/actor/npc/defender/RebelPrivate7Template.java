 ...
 */
public class RebelPrivate7Template extends DefenderNPCTemplate {
	public static final int ID = 35873;

	@Inject
	protected RebelPrivate7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
