 ...
 */
public class TerritoryGuard3Template extends DefenderNPCTemplate {
	public static final int ID = 36523;

	@Inject
	protected TerritoryGuard3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
