 ...
 */
public class Guard56Template extends DefenderNPCTemplate {
	public static final int ID = 35204;

	@Inject
	protected Guard56Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
