 ...
 */
public class ReligiousAssociationLeader6Template extends DefenderNPCTemplate {
	public static final int ID = 36540;

	@Inject
	protected ReligiousAssociationLeader6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
