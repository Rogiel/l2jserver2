 ...
 */
public class CourtSorcerer26Template extends DefenderNPCTemplate {
	public static final int ID = 35328;

	@Inject
	protected CourtSorcerer26Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
