 ...
 */
public class Guard36Template extends DefenderNPCTemplate {
	public static final int ID = 35160;

	@Inject
	protected Guard36Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
