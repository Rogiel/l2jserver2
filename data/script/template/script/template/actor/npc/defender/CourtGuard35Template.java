 ...
 */
public class CourtGuard35Template extends DefenderNPCTemplate {
	public static final int ID = 35981;

	@Inject
	protected CourtGuard35Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
