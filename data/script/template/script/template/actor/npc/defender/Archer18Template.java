 ...
 */
public class Archer18Template extends DefenderNPCTemplate {
	public static final int ID = 36279;

	@Inject
	protected Archer18Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
