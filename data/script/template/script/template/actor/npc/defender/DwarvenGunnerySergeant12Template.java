 ...
 */
public class DwarvenGunnerySergeant12Template extends DefenderNPCTemplate {
	public static final int ID = 36056;

	@Inject
	protected DwarvenGunnerySergeant12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
