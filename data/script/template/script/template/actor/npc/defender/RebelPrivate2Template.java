 ...
 */
public class RebelPrivate2Template extends DefenderNPCTemplate {
	public static final int ID = 35704;

	@Inject
	protected RebelPrivate2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
