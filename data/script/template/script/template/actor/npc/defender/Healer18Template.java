 ...
 */
public class Healer18Template extends DefenderNPCTemplate {
	public static final int ID = 36277;

	@Inject
	protected Healer18Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
