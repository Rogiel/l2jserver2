 ...
 */
public class Bodyguard3Template extends DefenderNPCTemplate {
	public static final int ID = 35332;

	@Inject
	protected Bodyguard3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
