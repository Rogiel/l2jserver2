 ...
 */
public class RoyalKnight3Template extends DefenderNPCTemplate {
	public static final int ID = 35108;

	@Inject
	protected RoyalKnight3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
