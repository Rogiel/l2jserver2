 ...
 */
public class IvanoTemplate extends DefenderNPCTemplate {
	public static final int ID = 35107;

	@Inject
	protected IvanoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
