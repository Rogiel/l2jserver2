 ...
 */
public class Bodyguard15Template extends DefenderNPCTemplate {
	public static final int ID = 35348;

	@Inject
	protected Bodyguard15Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
