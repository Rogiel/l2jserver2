 ...
 */
public class Guard193Template extends DefenderNPCTemplate {
	public static final int ID = 36274;

	@Inject
	protected Guard193Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
