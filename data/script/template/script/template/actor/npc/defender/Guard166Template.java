 ...
 */
public class Guard166Template extends DefenderNPCTemplate {
	public static final int ID = 35953;

	@Inject
	protected Guard166Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
