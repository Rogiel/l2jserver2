 ...
 */
public class CourtGuard7Template extends DefenderNPCTemplate {
	public static final int ID = 35127;

	@Inject
	protected CourtGuard7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.rightHand = itemProvider.createID(276);
		this.leftHand = null;
		this.enchantLevel = 0;
