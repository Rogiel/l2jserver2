 ...
 */
public class Archer16Template extends DefenderNPCTemplate {
	public static final int ID = 36203;

	@Inject
	protected Archer16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
