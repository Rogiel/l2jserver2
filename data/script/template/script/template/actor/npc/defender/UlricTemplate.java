 ...
 */
public class UlricTemplate extends DefenderNPCTemplate {
	public static final int ID = 35149;

	@Inject
	protected UlricTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
