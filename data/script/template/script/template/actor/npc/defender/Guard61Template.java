 ...
 */
public class Guard61Template extends DefenderNPCTemplate {
	public static final int ID = 35213;

	@Inject
	protected Guard61Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
