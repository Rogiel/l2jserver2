 ...
 */
public class Minister7Template extends DefenderNPCTemplate {
	public static final int ID = 36105;

	@Inject
	protected Minister7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
