 ...
 */
public class Guard161Template extends DefenderNPCTemplate {
	public static final int ID = 35912;

	@Inject
	protected Guard161Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
