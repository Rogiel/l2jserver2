 ...
 */
public class DecoratedRebelSoldier10Template extends DefenderNPCTemplate {
	public static final int ID = 35979;

	@Inject
	protected DecoratedRebelSoldier10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
