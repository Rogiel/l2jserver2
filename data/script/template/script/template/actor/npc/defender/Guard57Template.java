 ...
 */
public class Guard57Template extends DefenderNPCTemplate {
	public static final int ID = 35209;

	@Inject
	protected Guard57Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
