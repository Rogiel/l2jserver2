 ...
 */
public class Guard32Template extends DefenderNPCTemplate {
	public static final int ID = 35156;

	@Inject
	protected Guard32Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
