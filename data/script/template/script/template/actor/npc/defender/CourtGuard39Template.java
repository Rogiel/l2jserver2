 ...
 */
public class CourtGuard39Template extends DefenderNPCTemplate {
	public static final int ID = 36125;

	@Inject
	protected CourtGuard39Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
