 ...
 */
public class TerritoryBorderGuard14Template extends DefenderNPCTemplate {
	public static final int ID = 36548;

	@Inject
	protected TerritoryBorderGuard14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
