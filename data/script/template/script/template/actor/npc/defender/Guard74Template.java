 ...
 */
public class Guard74Template extends DefenderNPCTemplate {
	public static final int ID = 35247;

	@Inject
	protected Guard74Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
