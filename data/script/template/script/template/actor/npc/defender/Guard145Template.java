 ...
 */
public class Guard145Template extends DefenderNPCTemplate {
	public static final int ID = 35715;

	@Inject
	protected Guard145Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
