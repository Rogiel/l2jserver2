 ...
 */
public class MilitaryAssociationLeader3Template extends DefenderNPCTemplate {
	public static final int ID = 36520;

	@Inject
	protected MilitaryAssociationLeader3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
