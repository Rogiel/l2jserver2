 ...
 */
public class RebelPrivateTemplate extends DefenderNPCTemplate {
	public static final int ID = 35672;

	@Inject
	protected RebelPrivateTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
