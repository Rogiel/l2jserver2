 ...
 */
public class RebelCommander15Template extends DefenderNPCTemplate {
	public static final int ID = 36153;

	@Inject
	protected RebelCommander15Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
