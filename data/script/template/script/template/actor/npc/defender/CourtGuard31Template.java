 ...
 */
public class CourtGuard31Template extends DefenderNPCTemplate {
	public static final int ID = 35842;

	@Inject
	protected CourtGuard31Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
