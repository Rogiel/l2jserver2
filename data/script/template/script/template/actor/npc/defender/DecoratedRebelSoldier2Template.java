 ...
 */
public class DecoratedRebelSoldier2Template extends DefenderNPCTemplate {
	public static final int ID = 35703;

	@Inject
	protected DecoratedRebelSoldier2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
