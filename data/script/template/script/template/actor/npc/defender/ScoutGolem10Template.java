 ...
 */
public class ScoutGolem10Template extends DefenderNPCTemplate {
	public static final int ID = 36271;

	@Inject
	protected ScoutGolem10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
