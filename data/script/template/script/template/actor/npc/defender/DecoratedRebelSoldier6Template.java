 ...
 */
public class DecoratedRebelSoldier6Template extends DefenderNPCTemplate {
	public static final int ID = 35840;

	@Inject
	protected DecoratedRebelSoldier6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
