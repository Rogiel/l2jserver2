 ...
 */
public class GreaterRecruitTemplate extends DefenderNPCTemplate {
	public static final int ID = 35040;

	@Inject
	protected GreaterRecruitTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
