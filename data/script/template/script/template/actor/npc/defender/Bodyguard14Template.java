 ...
 */
public class Bodyguard14Template extends DefenderNPCTemplate {
	public static final int ID = 35347;

	@Inject
	protected Bodyguard14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
