 ...
 */
public class ReligiousAssociationLeader4Template extends DefenderNPCTemplate {
	public static final int ID = 36528;

	@Inject
	protected ReligiousAssociationLeader4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
