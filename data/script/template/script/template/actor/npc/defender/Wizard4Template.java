 ...
 */
public class Wizard4Template extends DefenderNPCTemplate {
	public static final int ID = 35786;

	@Inject
	protected Wizard4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
