 ...
 */
public class CourtGuard38Template extends DefenderNPCTemplate {
	public static final int ID = 36088;

	@Inject
	protected CourtGuard38Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
