 ...
 */
public class Mercenary8Template extends DefenderNPCTemplate {
	public static final int ID = 35015;

	@Inject
	protected Mercenary8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
