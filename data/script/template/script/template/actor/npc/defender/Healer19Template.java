 ...
 */
public class Healer19Template extends DefenderNPCTemplate {
	public static final int ID = 36310;

	@Inject
	protected Healer19Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
