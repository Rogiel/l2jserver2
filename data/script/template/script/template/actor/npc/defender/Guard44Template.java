 ...
 */
public class Guard44Template extends DefenderNPCTemplate {
	public static final int ID = 35172;

	@Inject
	protected Guard44Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
