 ...
 */
public class Guard71Template extends DefenderNPCTemplate {
	public static final int ID = 35244;

	@Inject
	protected Guard71Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
