 ...
 */
public class Archer5Template extends DefenderNPCTemplate {
	public static final int ID = 35822;

	@Inject
	protected Archer5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
