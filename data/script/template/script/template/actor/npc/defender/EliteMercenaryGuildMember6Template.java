 ...
 */
public class EliteMercenaryGuildMember6Template extends DefenderNPCTemplate {
	public static final int ID = 35035;

	@Inject
	protected EliteMercenaryGuildMember6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
