 ...
 */
public class Mercenary5Template extends DefenderNPCTemplate {
	public static final int ID = 35012;

	@Inject
	protected Mercenary5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
