 ...
 */
public class ScoutGolemTemplate extends DefenderNPCTemplate {
	public static final int ID = 35712;

	@Inject
	protected ScoutGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
