 ...
 */
public class Guard126Template extends DefenderNPCTemplate {
	public static final int ID = 35526;

	@Inject
	protected Guard126Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
