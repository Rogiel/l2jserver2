 ...
 */
public class EliteMercenaryGuildMember4Template extends DefenderNPCTemplate {
	public static final int ID = 35033;

	@Inject
	protected EliteMercenaryGuildMember4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
