 ...
 */
public class Archer21Template extends DefenderNPCTemplate {
	public static final int ID = 36386;

	@Inject
	protected Archer21Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
