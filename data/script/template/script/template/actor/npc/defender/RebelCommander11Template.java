 ...
 */
public class RebelCommander11Template extends DefenderNPCTemplate {
	public static final int ID = 36015;

	@Inject
	protected RebelCommander11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
