 ...
 */
public class CourtGuard12Template extends DefenderNPCTemplate {
	public static final int ID = 35132;

	@Inject
	protected CourtGuard12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
