 ...
 */
public class CourtSorcerer13Template extends DefenderNPCTemplate {
	public static final int ID = 35193;

	@Inject
	protected CourtSorcerer13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
