 ...
 */
public class Guard175Template extends DefenderNPCTemplate {
	public static final int ID = 36060;

	@Inject
	protected Guard175Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
