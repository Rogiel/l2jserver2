 ...
 */
public class GreaterRecruit10Template extends DefenderNPCTemplate {
	public static final int ID = 35049;

	@Inject
	protected GreaterRecruit10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.rightHand = itemProvider.createID(154);
		this.leftHand = null;
		this.enchantLevel = 0;
