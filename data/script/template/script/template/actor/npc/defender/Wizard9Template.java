 ...
 */
public class Wizard9Template extends DefenderNPCTemplate {
	public static final int ID = 35955;

	@Inject
	protected Wizard9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
