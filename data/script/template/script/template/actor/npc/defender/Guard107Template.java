 ...
 */
public class Guard107Template extends DefenderNPCTemplate {
	public static final int ID = 35478;

	@Inject
	protected Guard107Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
