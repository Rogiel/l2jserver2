 ...
 */
public class RoyalKnight7Template extends DefenderNPCTemplate {
	public static final int ID = 35192;

	@Inject
	protected RoyalKnight7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
