 ...
 */
public class Guard98Template extends DefenderNPCTemplate {
	public static final int ID = 35304;

	@Inject
	protected Guard98Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
