 ...
 */
public class Guard141Template extends DefenderNPCTemplate {
	public static final int ID = 35678;

	@Inject
	protected Guard141Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
