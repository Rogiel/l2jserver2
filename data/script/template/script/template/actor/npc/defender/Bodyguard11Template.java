 ...
 */
public class Bodyguard11Template extends DefenderNPCTemplate {
	public static final int ID = 35344;

	@Inject
	protected Bodyguard11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
