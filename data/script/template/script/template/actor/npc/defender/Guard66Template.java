 ...
 */
public class Guard66Template extends DefenderNPCTemplate {
	public static final int ID = 35239;

	@Inject
	protected Guard66Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
