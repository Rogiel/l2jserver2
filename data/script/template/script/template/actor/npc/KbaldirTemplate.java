 ...
 */
public class KbaldirTemplate extends NPCTemplate {
	public static final int ID = 32733;

	@Inject
	protected KbaldirTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
