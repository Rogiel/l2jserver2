 ...
 */
public class SupplyBoxOnWharfTemplate extends NPCTemplate {
	public static final int ID = 30734;

	@Inject
	protected SupplyBoxOnWharfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Supply Box On Wharf";
