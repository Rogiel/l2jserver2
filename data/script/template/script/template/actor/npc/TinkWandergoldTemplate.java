 ...
 */
public class TinkWandergoldTemplate extends NPCTemplate {
	public static final int ID = 30551;

	@Inject
	protected TinkWandergoldTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tink Wandergold";
