 ...
 */
public class GloomyMilkCowTemplate extends NPCTemplate {
	public static final int ID = 13191;

	@Inject
	protected GloomyMilkCowTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gloomy Milk Cow";
