 ...
 */
public class WindyShaoringTemplate extends NPCTemplate {
	public static final int ID = 30660;

	@Inject
	protected WindyShaoringTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Windy Shaoring";
