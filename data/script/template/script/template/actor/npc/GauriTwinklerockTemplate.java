 ...
 */
public class GauriTwinklerockTemplate extends NPCTemplate {
	public static final int ID = 30550;

	@Inject
	protected GauriTwinklerockTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gauri Twinklerock";
