 ...
 */
public class Trap74Template extends NPCTemplate {
	public static final int ID = 13238;

	@Inject
	protected Trap74Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
