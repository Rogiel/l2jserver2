 ...
 */
public class YetiTemplate extends NPCTemplate {
	public static final int ID = 13091;

	@Inject
	protected YetiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
