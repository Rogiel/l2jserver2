 ...
 */
public class MercenaryArcherTemplate extends NPCTemplate {
	public static final int ID = 18926;

	@Inject
	protected MercenaryArcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mercenary Archer";
