 ...
 */
public class ControlUnit12Template extends NPCTemplate {
	public static final int ID = 36375;

	@Inject
	protected ControlUnit12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
