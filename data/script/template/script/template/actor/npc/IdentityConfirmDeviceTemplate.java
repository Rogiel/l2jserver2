 ...
 */
public class IdentityConfirmDeviceTemplate extends NPCTemplate {
	public static final int ID = 32578;

	@Inject
	protected IdentityConfirmDeviceTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Identity Confirm Device";
