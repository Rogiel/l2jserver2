 ...
 */
public class DelusionManager17Template extends NPCTemplate {
	public static final int ID = 32680;

	@Inject
	protected DelusionManager17Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
