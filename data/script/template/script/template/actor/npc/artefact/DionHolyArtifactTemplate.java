 ...
 */
public class DionHolyArtifactTemplate extends ArtefactNPCTemplate {
	public static final int ID = 35105;

	@Inject
	protected DionHolyArtifactTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dion Holy Artifact";
