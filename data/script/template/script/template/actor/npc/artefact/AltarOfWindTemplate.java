 ...
 */
public class AltarOfWindTemplate extends ArtefactNPCTemplate {
	public static final int ID = 35514;

	@Inject
	protected AltarOfWindTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Altar of Wind";
