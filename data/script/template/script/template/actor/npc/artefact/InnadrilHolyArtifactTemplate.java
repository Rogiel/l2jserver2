 ...
 */
package script.template.actor.npc.artefact;

import com.google.inject.Inject;
import com.l2jserver.model.id.template.provider.ItemTemplateIDProvider;
import com.l2jserver.model.id.template.provider.NPCTemplateIDProvider;
import com.l2jserver.model.template.npc.ArtefactNPCTemplate;

/**
 * @author <a href="http://www.rogiel.com">Rogiel</a>
 */
public class InnadrilHolyArtifactTemplate extends ArtefactNPCTemplate {
	public static final int ID = 35279;

	@Inject
	protected InnadrilHolyArtifactTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Innadril Holy Artifact";
