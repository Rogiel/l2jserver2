 ...
 */
public class AltarOfWaterTemplate extends ArtefactNPCTemplate {
	public static final int ID = 35323;

	@Inject
	protected AltarOfWaterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Altar of Water";
