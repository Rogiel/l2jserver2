 ...
 */
public class GodsAltarTemplate extends ArtefactNPCTemplate {
	public static final int ID = 35469;

	@Inject
	protected GodsAltarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gods' Altar";
