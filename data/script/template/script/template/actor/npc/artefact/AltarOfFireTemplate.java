 ...
 */
public class AltarOfFireTemplate extends ArtefactNPCTemplate {
	public static final int ID = 35322;

	@Inject
	protected AltarOfFireTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Altar of Fire";
