 ...
 */
public class GiranHolyArtifactTemplate extends ArtefactNPCTemplate {
	public static final int ID = 35147;

	@Inject
	protected GiranHolyArtifactTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Giran Holy Artifact";
