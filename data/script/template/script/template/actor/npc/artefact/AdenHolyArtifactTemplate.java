 ...
 */
public class AdenHolyArtifactTemplate extends ArtefactNPCTemplate {
	public static final int ID = 35233;

	@Inject
	protected AdenHolyArtifactTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Aden Holy Artifact";
