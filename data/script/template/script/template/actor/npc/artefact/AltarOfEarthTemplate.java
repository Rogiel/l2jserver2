 ...
 */
public class AltarOfEarthTemplate extends ArtefactNPCTemplate {
	public static final int ID = 35515;

	@Inject
	protected AltarOfEarthTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Altar of Earth";
