 ...
 */
public class OrenHolyArtifactTemplate extends ArtefactNPCTemplate {
	public static final int ID = 35189;

	@Inject
	protected OrenHolyArtifactTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Oren Holy Artifact";
