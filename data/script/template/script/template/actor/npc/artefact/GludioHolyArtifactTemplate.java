 ...
 */
public class GludioHolyArtifactTemplate extends ArtefactNPCTemplate {
	public static final int ID = 35063;

	@Inject
	protected GludioHolyArtifactTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gludio Holy Artifact";
