 ...
 */
public class ToroccoTemplate extends NPCTemplate {
	public static final int ID = 30555;

	@Inject
	protected ToroccoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
