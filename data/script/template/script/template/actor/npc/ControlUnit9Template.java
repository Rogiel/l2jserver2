 ...
 */
public class ControlUnit9Template extends NPCTemplate {
	public static final int ID = 36230;

	@Inject
	protected ControlUnit9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
