 ...
 */
public class OinkOinkTemplate extends NPCTemplate {
	public static final int ID = 16065;

	@Inject
	protected OinkOinkTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
