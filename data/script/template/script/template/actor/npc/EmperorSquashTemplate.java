 ...
 */
public class EmperorSquashTemplate extends NPCTemplate {
	public static final int ID = 13017;

	@Inject
	protected EmperorSquashTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Emperor Squash";
