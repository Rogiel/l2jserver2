 ...
 */
public class OracleGuide9Template extends NPCTemplate {
	public static final int ID = 32281;

	@Inject
	protected OracleGuide9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Oracle Guide";
