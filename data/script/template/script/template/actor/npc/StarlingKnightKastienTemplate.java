 ...
 */
public class StarlingKnightKastienTemplate extends NPCTemplate {
	public static final int ID = 31638;

	@Inject
	protected StarlingKnightKastienTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Starling Knight Kastien";
