 ...
 */
public class LorainTemplate extends NPCTemplate {
	public static final int ID = 30673;

	@Inject
	protected LorainTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
