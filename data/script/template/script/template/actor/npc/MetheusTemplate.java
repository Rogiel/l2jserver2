 ...
 */
public class MetheusTemplate extends NPCTemplate {
	public static final int ID = 30614;

	@Inject
	protected MetheusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
