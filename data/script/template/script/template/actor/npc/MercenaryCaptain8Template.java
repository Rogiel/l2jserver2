 ...
 */
public class MercenaryCaptain8Template extends NPCTemplate {
	public static final int ID = 35924;

	@Inject
	protected MercenaryCaptain8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
