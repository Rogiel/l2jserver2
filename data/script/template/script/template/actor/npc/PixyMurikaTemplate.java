 ...
 */
public class PixyMurikaTemplate extends NPCTemplate {
	public static final int ID = 31852;

	@Inject
	protected PixyMurikaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Pixy Murika";
