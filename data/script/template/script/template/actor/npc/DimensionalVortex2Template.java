 ...
 */
public class DimensionalVortex2Template extends NPCTemplate {
	public static final int ID = 30953;

	@Inject
	protected DimensionalVortex2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dimensional Vortex 2";
