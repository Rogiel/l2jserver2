 ...
 */
public class Doorman5Template extends NPCTemplate {
	public static final int ID = 35601;

	@Inject
	protected Doorman5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
