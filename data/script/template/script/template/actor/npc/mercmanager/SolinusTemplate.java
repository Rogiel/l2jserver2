 ...
 */
public class SolinusTemplate extends MercManagerNPCTemplate {
	public static final int ID = 35318;

	@Inject
	protected SolinusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
