 ...
 */
public class GreenspanTemplate extends MercManagerNPCTemplate {
	public static final int ID = 35102;

	@Inject
	protected GreenspanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
