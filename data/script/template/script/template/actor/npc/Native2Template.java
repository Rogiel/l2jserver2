 ...
 */
public class Native2Template extends NPCTemplate {
	public static final int ID = 13198;

	@Inject
	protected Native2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
