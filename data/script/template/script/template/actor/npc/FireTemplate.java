 ...
 */
public class FireTemplate extends NPCTemplate {
	public static final int ID = 18927;

	@Inject
	protected FireTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
