 ...
 */
public class TamanZeLapatuiAgathionTemplate extends NPCTemplate {
	public static final int ID = 1547;

	@Inject
	protected TamanZeLapatuiAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Taman ze Lapatui Agathion";
