 ...
 */
public class RiftPostOfficerTemplate extends NPCTemplate {
	public static final int ID = 31490;

	@Inject
	protected RiftPostOfficerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rift Post Officer";
