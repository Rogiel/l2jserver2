 ...
 */
public class Trap103Template extends NPCTemplate {
	public static final int ID = 18388;

	@Inject
	protected Trap103Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
