 ...
 */
public class WarpgateTemplate extends NPCTemplate {
	public static final int ID = 32314;

	@Inject
	protected WarpgateTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
