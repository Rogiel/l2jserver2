 ...
 */
public class KaurinAgathionTemplate extends NPCTemplate {
	public static final int ID = 1548;

	@Inject
	protected KaurinAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kaurin Agathion";
