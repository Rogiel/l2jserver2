 ...
 */
public class CursedHeadMaidTemplate extends NPCTemplate {
	public static final int ID = 18598;

	@Inject
	protected CursedHeadMaidTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cursed Head Maid";
