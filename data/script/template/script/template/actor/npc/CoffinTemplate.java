 ...
 */
public class CoffinTemplate extends NPCTemplate {
	public static final int ID = 31536;

	@Inject
	protected CoffinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
