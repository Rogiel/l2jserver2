 ...
 */
public class DryadAgathionTemplate extends NPCTemplate {
	public static final int ID = 1524;

	@Inject
	protected DryadAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dryad Agathion";
