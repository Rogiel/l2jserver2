 ...
 */
public class ShiningWhiteTemplate extends NPCTemplate {
	public static final int ID = 13295;

	@Inject
	protected ShiningWhiteTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shining White";
