 ...
 */
public class GuardianOfBorder31Template extends NPCTemplate {
	public static final int ID = 31895;

	@Inject
	protected GuardianOfBorder31Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
