 ...
 */
public class CorpseOfKamurTemplate extends NPCTemplate {
	public static final int ID = 30675;

	@Inject
	protected CorpseOfKamurTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Corpse Of Kamur";
