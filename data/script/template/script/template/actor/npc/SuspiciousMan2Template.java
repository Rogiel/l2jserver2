 ...
 */
public class SuspiciousMan2Template extends NPCTemplate {
	public static final int ID = 32244;

	@Inject
	protected SuspiciousMan2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Suspicious Man";
