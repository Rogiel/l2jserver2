 ...
 */
public class FlagpoleTemplate extends NPCTemplate {
	public static final int ID = 35657;

	@Inject
	protected FlagpoleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
