 ...
 */
public class OnyxBeastTemplate extends NPCTemplate {
	public static final int ID = 13077;

	@Inject
	protected OnyxBeastTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Onyx Beast";
