 ...
 */
public class LegionnaireTemplate extends NPCTemplate {
	public static final int ID = 18849;

	@Inject
	protected LegionnaireTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
