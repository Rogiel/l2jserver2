 ...
 */
public class Trap78Template extends NPCTemplate {
	public static final int ID = 13242;

	@Inject
	protected Trap78Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
