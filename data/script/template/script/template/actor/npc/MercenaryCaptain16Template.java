 ...
 */
public class MercenaryCaptain16Template extends NPCTemplate {
	public static final int ID = 36207;

	@Inject
	protected MercenaryCaptain16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
