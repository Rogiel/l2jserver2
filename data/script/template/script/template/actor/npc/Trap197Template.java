 ...
 */
public class Trap197Template extends NPCTemplate {
	public static final int ID = 18774;

	@Inject
	protected Trap197Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
