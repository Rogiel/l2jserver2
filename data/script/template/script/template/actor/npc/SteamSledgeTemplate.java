 ...
 */
public class SteamSledgeTemplate extends NPCTemplate {
	public static final int ID = 13147;

	@Inject
	protected SteamSledgeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Steam Sledge";
