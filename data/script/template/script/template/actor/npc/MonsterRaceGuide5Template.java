 ...
 */
public class MonsterRaceGuide5Template extends NPCTemplate {
	public static final int ID = 31408;

	@Inject
	protected MonsterRaceGuide5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Monster Race Guide";
		this.serverSideName = false;
		this.title = "Town of Oren";
