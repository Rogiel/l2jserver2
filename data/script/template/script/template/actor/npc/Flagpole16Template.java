 ...
 */
public class Flagpole16Template extends NPCTemplate {
	public static final int ID = 36171;

	@Inject
	protected Flagpole16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
