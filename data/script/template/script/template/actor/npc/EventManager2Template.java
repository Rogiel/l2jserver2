 ...
 */
public class EventManager2Template extends NPCTemplate {
	public static final int ID = 31855;

	@Inject
	protected EventManager2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
