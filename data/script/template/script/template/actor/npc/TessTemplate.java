 ...
 */
public class TessTemplate extends NPCTemplate {
	public static final int ID = 32573;

	@Inject
	protected TessTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
