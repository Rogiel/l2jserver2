 ...
 */
public class KainVanHalterTemplate extends NPCTemplate {
	public static final int ID = 31639;

	@Inject
	protected KainVanHalterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kain Van Halter";
		...
		this.rightHand = itemProvider.createID(2626);
		this.leftHand = null;
		this.enchantLevel = 0;
