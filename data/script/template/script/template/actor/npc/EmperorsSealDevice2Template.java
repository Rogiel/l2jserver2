 ...
 */
public class EmperorsSealDevice2Template extends NPCTemplate {
	public static final int ID = 32588;

	@Inject
	protected EmperorsSealDevice2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
