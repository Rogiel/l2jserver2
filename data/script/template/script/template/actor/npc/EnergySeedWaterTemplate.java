 ...
 */
public class EnergySeedWaterTemplate extends NPCTemplate {
	public static final int ID = 18678;

	@Inject
	protected EnergySeedWaterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Energy Seed - Water";
