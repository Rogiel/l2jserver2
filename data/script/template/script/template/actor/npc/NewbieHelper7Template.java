 ...
 */
public class NewbieHelper7Template extends NPCTemplate {
	public static final int ID = 30403;

	@Inject
	protected NewbieHelper7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
