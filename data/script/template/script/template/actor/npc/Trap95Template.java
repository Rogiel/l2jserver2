 ...
 */
public class Trap95Template extends NPCTemplate {
	public static final int ID = 18380;

	@Inject
	protected Trap95Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
