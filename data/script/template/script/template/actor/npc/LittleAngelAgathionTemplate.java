 ...
 */
public class LittleAngelAgathionTemplate extends NPCTemplate {
	public static final int ID = 16031;

	@Inject
	protected LittleAngelAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Little Angel Agathion";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 0.01;
		this.collisionHeight = 4.55;
		this.level = 55;
