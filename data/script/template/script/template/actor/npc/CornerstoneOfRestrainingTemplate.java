 ...
 */
public class CornerstoneOfRestrainingTemplate extends NPCTemplate {
	public static final int ID = 31748;

	@Inject
	protected CornerstoneOfRestrainingTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cornerstone of Restraining";
