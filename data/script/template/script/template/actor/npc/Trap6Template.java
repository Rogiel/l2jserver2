 ...
 */
public class Trap6Template extends NPCTemplate {
	public static final int ID = 13042;

	@Inject
	protected Trap6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
