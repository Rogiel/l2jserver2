 ...
 */
public class GuardCaptain5Template extends NPCTemplate {
	public static final int ID = 35729;

	@Inject
	protected GuardCaptain5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
