 ...
 */
public class HolidaySanta2Template extends NPCTemplate {
	public static final int ID = 5;

	@Inject
	protected HolidaySanta2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Holiday Santa";
		this.serverSideName = false;
		this.title = "Happy Holidays!";
