 ...
 */
public class IceShelfTemplate extends NPCTemplate {
	public static final int ID = 32023;

	@Inject
	protected IceShelfTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
