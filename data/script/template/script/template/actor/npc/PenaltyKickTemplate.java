 ...
 */
public class PenaltyKickTemplate extends NPCTemplate {
	public static final int ID = 1578;

	@Inject
	protected PenaltyKickTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Penalty Kick";
