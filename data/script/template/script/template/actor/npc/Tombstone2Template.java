 ...
 */
public class Tombstone2Template extends NPCTemplate {
	public static final int ID = 31531;

	@Inject
	protected Tombstone2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
