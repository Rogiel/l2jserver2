 ...
 */
public class IceSculptureTemplate extends NPCTemplate {
	public static final int ID = 32021;

	@Inject
	protected IceSculptureTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
