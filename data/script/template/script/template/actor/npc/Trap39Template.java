 ...
 */
public class Trap39Template extends NPCTemplate {
	public static final int ID = 13203;

	@Inject
	protected Trap39Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
