 ...
 */
public class SymbolOfFaithTemplate extends NPCTemplate {
	public static final int ID = 32288;

	@Inject
	protected SymbolOfFaithTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Symbol of Faith";
