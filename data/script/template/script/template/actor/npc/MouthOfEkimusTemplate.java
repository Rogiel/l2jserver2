 ...
 */
public class MouthOfEkimusTemplate extends NPCTemplate {
	public static final int ID = 32537;

	@Inject
	protected MouthOfEkimusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mouth of Ekimus";
