 ...
 */
public class PreacherOfDoom40Template extends NPCTemplate {
	public static final int ID = 31720;

	@Inject
	protected PreacherOfDoom40Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
