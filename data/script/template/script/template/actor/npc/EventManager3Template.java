 ...
 */
public class EventManager3Template extends NPCTemplate {
	public static final int ID = 31856;

	@Inject
	protected EventManager3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
