 ...
 */
public class GreatPigTemplate extends NPCTemplate {
	public static final int ID = 13196;

	@Inject
	protected GreatPigTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Great Pig";
		this.serverSideName = false;
		this.title = "Mis-summoned";
		this.serverSideTitle = false;
		this.collisionRadius = 15.00;
		this.collisionHeight = 18.30;
		this.level = 85;
