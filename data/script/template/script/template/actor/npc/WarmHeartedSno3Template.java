 ...
 */
public class WarmHeartedSno3Template extends NPCTemplate {
	public static final int ID = 15;

	@Inject
	protected WarmHeartedSno3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Warm Hearted Sno";
		this.serverSideName = false;
		this.title = "Beginner Supporter";
