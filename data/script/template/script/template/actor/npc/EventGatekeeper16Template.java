 ...
 */
public class EventGatekeeper16Template extends NPCTemplate {
	public static final int ID = 32048;

	@Inject
	protected EventGatekeeper16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
