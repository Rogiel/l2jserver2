 ...
 */
public class EventGatekeeper17Template extends NPCTemplate {
	public static final int ID = 32353;

	@Inject
	protected EventGatekeeper17Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
