 ...
 */
public class WeatheredRockTemplate extends NPCTemplate {
	public static final int ID = 32368;

	@Inject
	protected WeatheredRockTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Weathered Rock";
