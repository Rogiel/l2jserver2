 ...
 */
public class KetraOrcSupporter2Template extends NPCTemplate {
	public static final int ID = 32512;

	@Inject
	protected KetraOrcSupporter2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
