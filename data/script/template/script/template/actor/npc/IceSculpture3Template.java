 ...
 */
public class IceSculpture3Template extends NPCTemplate {
	public static final int ID = 32078;

	@Inject
	protected IceSculpture3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
