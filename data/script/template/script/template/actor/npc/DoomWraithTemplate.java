 ...
 */
public class DoomWraithTemplate extends NPCTemplate {
	public static final int ID = 13078;

	@Inject
	protected DoomWraithTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
