 ...
 */
public class Trap174Template extends NPCTemplate {
	public static final int ID = 18751;

	@Inject
	protected Trap174Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
