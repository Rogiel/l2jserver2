 ...
 */
public class SumariTemplate extends NPCTemplate {
	public static final int ID = 30564;

	@Inject
	protected SumariTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
