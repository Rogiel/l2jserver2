 ...
 */
public class EvilAltar3Template extends NPCTemplate {
	public static final int ID = 31514;

	@Inject
	protected EvilAltar3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
