 ...
 */
public class DetentionCampWarden3Template extends NPCTemplate {
	public static final int ID = 35735;

	@Inject
	protected DetentionCampWarden3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
