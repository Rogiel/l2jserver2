 ...
 */
public class TreykanTemplate extends NPCTemplate {
	public static final int ID = 13283;

	@Inject
	protected TreykanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
