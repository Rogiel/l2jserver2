 ...
 */
public class ShermanTemplate extends SiegeNPCTemplate {
	public static final int ID = 35513;

	@Inject
	protected ShermanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
