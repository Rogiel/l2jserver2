 ...
 */
public class Katenar4Template extends NPCTemplate {
	public static final int ID = 32332;

	@Inject
	protected Katenar4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
