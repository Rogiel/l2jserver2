 ...
 */
public class SaeromTemplate extends NPCTemplate {
	public static final int ID = 16063;

	@Inject
	protected SaeromTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
