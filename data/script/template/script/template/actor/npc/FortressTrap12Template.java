 ...
 */
public class FortressTrap12Template extends NPCTemplate {
	public static final int ID = 36423;

	@Inject
	protected FortressTrap12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
