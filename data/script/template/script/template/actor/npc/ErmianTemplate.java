 ...
 */
public class ErmianTemplate extends NPCTemplate {
	public static final int ID = 32736;

	@Inject
	protected ErmianTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
