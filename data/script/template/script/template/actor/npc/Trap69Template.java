 ...
 */
public class Trap69Template extends NPCTemplate {
	public static final int ID = 13233;

	@Inject
	protected Trap69Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
