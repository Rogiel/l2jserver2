 ...
 */
public class TabletOfVision7Template extends NPCTemplate {
	public static final int ID = 31652;

	@Inject
	protected TabletOfVision7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
