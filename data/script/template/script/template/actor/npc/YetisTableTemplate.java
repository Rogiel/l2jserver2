 ...
 */
public class YetisTableTemplate extends NPCTemplate {
	public static final int ID = 31542;

	@Inject
	protected YetisTableTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Yeti's Table";
