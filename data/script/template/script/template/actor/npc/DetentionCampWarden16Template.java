 ...
 */
public class DetentionCampWarden16Template extends NPCTemplate {
	public static final int ID = 36181;

	@Inject
	protected DetentionCampWarden16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
