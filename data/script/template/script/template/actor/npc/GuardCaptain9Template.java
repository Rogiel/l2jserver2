 ...
 */
public class GuardCaptain9Template extends NPCTemplate {
	public static final int ID = 35798;

	@Inject
	protected GuardCaptain9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
