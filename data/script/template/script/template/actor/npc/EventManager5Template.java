 ...
 */
public class EventManager5Template extends NPCTemplate {
	public static final int ID = 31858;

	@Inject
	protected EventManager5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
