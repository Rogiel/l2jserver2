 ...
 */
public class MercenaryPrivate14Template extends NPCTemplate {
	public static final int ID = 36139;

	@Inject
	protected MercenaryPrivate14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
