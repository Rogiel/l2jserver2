 ...
 */
public class Flagpole10Template extends NPCTemplate {
	public static final int ID = 35964;

	@Inject
	protected Flagpole10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
