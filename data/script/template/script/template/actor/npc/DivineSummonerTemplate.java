 ...
 */
public class DivineSummonerTemplate extends NPCTemplate {
	public static final int ID = 13118;

	@Inject
	protected DivineSummonerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Divine Summoner";
