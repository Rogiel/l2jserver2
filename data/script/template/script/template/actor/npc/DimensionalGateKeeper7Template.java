 ...
 */
public class DimensionalGateKeeper7Template extends NPCTemplate {
	public static final int ID = 31500;

	@Inject
	protected DimensionalGateKeeper7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
