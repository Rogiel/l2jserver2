 ...
 */
public class MineTemplate extends NPCTemplate {
	public static final int ID = 32616;

	@Inject
	protected MineTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
