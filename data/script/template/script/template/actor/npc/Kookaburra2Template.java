 ...
 */
public class Kookaburra2Template extends NPCTemplate {
	public static final int ID = 18901;

	@Inject
	protected Kookaburra2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
