 ...
 */
public class ForgottenMonument4Template extends NPCTemplate {
	public static final int ID = 31664;

	@Inject
	protected ForgottenMonument4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
