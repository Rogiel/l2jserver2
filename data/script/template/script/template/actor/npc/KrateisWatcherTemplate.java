 ...
 */
public class KrateisWatcherTemplate extends NPCTemplate {
	public static final int ID = 18601;

	@Inject
	protected KrateisWatcherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
