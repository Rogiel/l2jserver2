 ...
 */
public class GriffonTemplate extends NPCTemplate {
	public static final int ID = 16055;

	@Inject
	protected GriffonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
