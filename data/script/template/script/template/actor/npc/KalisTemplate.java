 ...
 */
public class KalisTemplate extends NPCTemplate {
	public static final int ID = 30759;

	@Inject
	protected KalisTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
