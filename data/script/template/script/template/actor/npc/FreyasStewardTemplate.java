 ...
 */
public class FreyasStewardTemplate extends NPCTemplate {
	public static final int ID = 32029;

	@Inject
	protected FreyasStewardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Freya's Steward";
