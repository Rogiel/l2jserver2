 ...
 */
public class FinalForm4Template extends NPCTemplate {
	public static final int ID = 13143;

	@Inject
	protected FinalForm4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Final Form";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 10.00;
		this.collisionHeight = 32.70;
		this.level = 55;
