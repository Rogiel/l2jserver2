 ...
 */
public class GutenhagenTemplate extends NPCTemplate {
	public static final int ID = 32069;

	@Inject
	protected GutenhagenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gutenhagen";
