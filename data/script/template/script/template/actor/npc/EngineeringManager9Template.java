 ...
 */
public class EngineeringManager9Template extends NPCTemplate {
	public static final int ID = 35933;

	@Inject
	protected EngineeringManager9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
