 ...
 */
public class Trap8Template extends NPCTemplate {
	public static final int ID = 13044;

	@Inject
	protected Trap8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
