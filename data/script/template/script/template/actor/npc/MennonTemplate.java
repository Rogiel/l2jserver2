 ...
 */
public class MennonTemplate extends NPCTemplate {
	public static final int ID = 31369;

	@Inject
	protected MennonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
