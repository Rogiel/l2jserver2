 ...
 */
public class FlowerFairySpiritTemplate extends NPCTemplate {
	public static final int ID = 1586;

	@Inject
	protected FlowerFairySpiritTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Flower Fairy Spirit";
