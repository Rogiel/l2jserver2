 ...
 */
public class PowerControlUnit2Template extends NPCTemplate {
	public static final int ID = 35710;

	@Inject
	protected PowerControlUnit2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
