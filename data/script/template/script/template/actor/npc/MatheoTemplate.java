 ...
 */
public class MatheoTemplate extends NPCTemplate {
	public static final int ID = 30406;

	@Inject
	protected MatheoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
