 ...
 */
public class Trap61Template extends NPCTemplate {
	public static final int ID = 13225;

	@Inject
	protected Trap61Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
