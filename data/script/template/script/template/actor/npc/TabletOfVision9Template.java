 ...
 */
public class TabletOfVision9Template extends NPCTemplate {
	public static final int ID = 31654;

	@Inject
	protected TabletOfVision9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
