 ...
 */
public class KetraVanShamanTemplate extends NPCTemplate {
	public static final int ID = 31708;

	@Inject
	protected KetraVanShamanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
