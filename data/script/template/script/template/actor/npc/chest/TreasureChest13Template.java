 ...
 */
public class TreasureChest13Template extends ChestNPCTemplate {
	public static final int ID = 18269;

	@Inject
	protected TreasureChest13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 724.871874675055000;
		this.maxMP = 372.960000000000000;
		this.hpRegeneration = 1.800000000000000;
		...
		attributes.physicalDefense = 133.40254;
		attributes.magicalDefense = 80.81247;
