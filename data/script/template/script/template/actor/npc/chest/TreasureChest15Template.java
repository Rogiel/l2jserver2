 ...
 */
public class TreasureChest15Template extends ChestNPCTemplate {
	public static final int ID = 18271;

	@Inject
	protected TreasureChest15Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 955.745616539336000;
		...
		attributes.magicalDefense = 95.34309;
