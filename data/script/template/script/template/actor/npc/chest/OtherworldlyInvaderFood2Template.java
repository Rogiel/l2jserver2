 ...
 */
public class OtherworldlyInvaderFood2Template extends ChestNPCTemplate {
	public static final int ID = 18288;

	@Inject
	protected OtherworldlyInvaderFood2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
