 ...
 */
public class TreasureBox2Template extends ChestNPCTemplate {
	public static final int ID = 32495;

	@Inject
	protected TreasureBox2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Treasure Box";
