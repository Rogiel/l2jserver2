 ...
 */
public class TreasureChest39Template extends ChestNPCTemplate {
	public static final int ID = 21809;

	@Inject
	protected TreasureChest39Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
