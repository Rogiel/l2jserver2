 ...
 */
public class ForbiddenPathInvaderFoodTemplate extends ChestNPCTemplate {
	public static final int ID = 18293;

	@Inject
	protected ForbiddenPathInvaderFoodTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Forbidden Path Invader Food";
		...
		attributes.magicalDefense = 158.83181;
