 ...
 */
public class TreasureChest20Template extends ChestNPCTemplate {
	public static final int ID = 18276;

	@Inject
	protected TreasureChest20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 1674.106655538360000;
		...
		attributes.physicalDefense = 225.96187;
		attributes.magicalDefense = 136.88298;
