 ...
 */
public class PurgatoryInvaderFoodTemplate extends ChestNPCTemplate {
	public static final int ID = 18291;

	@Inject
	protected PurgatoryInvaderFoodTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.magicalDefense = 129.74774;
