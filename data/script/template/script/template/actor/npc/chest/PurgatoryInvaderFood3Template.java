 ...
 */
public class PurgatoryInvaderFood3Template extends ChestNPCTemplate {
	public static final int ID = 21717;

	@Inject
	protected PurgatoryInvaderFood3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
