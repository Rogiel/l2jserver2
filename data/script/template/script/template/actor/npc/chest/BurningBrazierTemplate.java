 ...
 */
public class BurningBrazierTemplate extends ChestNPCTemplate {
	public static final int ID = 32493;

	@Inject
	protected BurningBrazierTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Burning Brazier";
