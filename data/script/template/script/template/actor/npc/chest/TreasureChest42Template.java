 ...
 */
public class TreasureChest42Template extends ChestNPCTemplate {
	public static final int ID = 21812;

	@Inject
	protected TreasureChest42Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
