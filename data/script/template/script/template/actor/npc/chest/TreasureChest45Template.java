 ...
 */
public class TreasureChest45Template extends ChestNPCTemplate {
	public static final int ID = 21815;

	@Inject
	protected TreasureChest45Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
