 ...
 */
public class DarkOmenInvaderFood2Template extends ChestNPCTemplate {
	public static final int ID = 18296;

	@Inject
	protected DarkOmenInvaderFood2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.magicalDefense = 193.39269;
