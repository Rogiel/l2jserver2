 ...
 */
public class DarkOmenInvaderFood3Template extends ChestNPCTemplate {
	public static final int ID = 21763;

	@Inject
	protected DarkOmenInvaderFood3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dark Omen Invader Food";
