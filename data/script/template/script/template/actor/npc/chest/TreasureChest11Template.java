 ...
 */
public class TreasureChest11Template extends ChestNPCTemplate {
	public static final int ID = 18267;

	@Inject
	protected TreasureChest11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 531.808581237041000;
		...
		attributes.physicalDefense = 111.78321;
		attributes.magicalDefense = 67.71594;
