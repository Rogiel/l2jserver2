 ...
 */
public class TreasureChest32Template extends ChestNPCTemplate {
	public static final int ID = 21802;

	@Inject
	protected TreasureChest32Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
