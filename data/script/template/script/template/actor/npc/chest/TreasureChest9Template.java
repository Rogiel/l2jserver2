 ...
 */
public class TreasureChest9Template extends ChestNPCTemplate {
	public static final int ID = 18265;

	@Inject
	protected TreasureChest9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 376.063268689487000;
		...
		attributes.physicalDefense = 92.62710;
		attributes.magicalDefense = 56.11156;
