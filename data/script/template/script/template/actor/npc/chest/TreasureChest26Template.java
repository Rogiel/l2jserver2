 ...
 */
public class TreasureChest26Template extends ChestNPCTemplate {
	public static final int ID = 18282;

	@Inject
	protected TreasureChest26Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 2622.149751643740000;
		...
		attributes.physicalDefense = 315.21651;
		attributes.magicalDefense = 190.95158;
