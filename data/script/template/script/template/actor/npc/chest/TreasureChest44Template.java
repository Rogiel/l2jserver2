 ...
 */
public class TreasureChest44Template extends ChestNPCTemplate {
	public static final int ID = 21814;

	@Inject
	protected TreasureChest44Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
