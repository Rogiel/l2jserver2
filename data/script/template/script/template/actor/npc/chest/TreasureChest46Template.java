 ...
 */
public class TreasureChest46Template extends ChestNPCTemplate {
	public static final int ID = 21816;

	@Inject
	protected TreasureChest46Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
