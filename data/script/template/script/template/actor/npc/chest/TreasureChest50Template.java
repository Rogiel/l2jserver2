 ...
 */
public class TreasureChest50Template extends ChestNPCTemplate {
	public static final int ID = 21820;

	@Inject
	protected TreasureChest50Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
