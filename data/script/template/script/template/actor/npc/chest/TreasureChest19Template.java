 ...
 */
public class TreasureChest19Template extends ChestNPCTemplate {
	public static final int ID = 18275;

	@Inject
	protected TreasureChest19Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 1517.881155021460000;
		...
		attributes.physicalDefense = 211.46458;
		attributes.magicalDefense = 128.10083;
