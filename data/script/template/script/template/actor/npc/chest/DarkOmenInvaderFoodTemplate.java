 ...
 */
public class DarkOmenInvaderFoodTemplate extends ChestNPCTemplate {
	public static final int ID = 18295;

	@Inject
	protected DarkOmenInvaderFoodTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.magicalDefense = 187.80945;
