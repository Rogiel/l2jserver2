 ...
 */
public class TreasureChest47Template extends ChestNPCTemplate {
	public static final int ID = 21817;

	@Inject
	protected TreasureChest47Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
