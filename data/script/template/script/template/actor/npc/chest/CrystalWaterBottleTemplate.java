 ...
 */
public class CrystalWaterBottleTemplate extends ChestNPCTemplate {
	public static final int ID = 32492;

	@Inject
	protected CrystalWaterBottleTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Crystal Water Bottle";
