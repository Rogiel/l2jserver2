 ...
 */
public class OtherworldlyInvaderFoodTemplate extends ChestNPCTemplate {
	public static final int ID = 18287;

	@Inject
	protected OtherworldlyInvaderFoodTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
