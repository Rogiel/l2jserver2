 ...
 */
public class TreasureChest23Template extends ChestNPCTemplate {
	public static final int ID = 18279;

	@Inject
	protected TreasureChest23Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 2157.385688769940000;
		...
		attributes.physicalDefense = 270.65792;
		attributes.magicalDefense = 163.95891;
