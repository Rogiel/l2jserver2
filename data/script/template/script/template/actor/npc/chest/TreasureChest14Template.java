 ...
 */
public class TreasureChest14Template extends ChestNPCTemplate {
	public static final int ID = 18270;

	@Inject
	protected TreasureChest14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 835.657991997797000;
		...
		attributes.physicalDefense = 145.11049;
		attributes.magicalDefense = 87.90490;
