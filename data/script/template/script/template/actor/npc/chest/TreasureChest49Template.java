 ...
 */
public class TreasureChest49Template extends ChestNPCTemplate {
	public static final int ID = 21819;

	@Inject
	protected TreasureChest49Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
