 ...
 */
public class TreasureChest17Template extends ChestNPCTemplate {
	public static final int ID = 18273;

	@Inject
	protected TreasureChest17Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 1222.019337117610000;
		...
		attributes.physicalDefense = 183.52646;
		attributes.magicalDefense = 111.17649;
