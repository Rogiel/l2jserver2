 ...
 */
public class TreasureChest34Template extends ChestNPCTemplate {
	public static final int ID = 21804;

	@Inject
	protected TreasureChest34Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
