 ...
 */
public class ForbiddenPathInvaderFood3Template extends ChestNPCTemplate {
	public static final int ID = 21740;

	@Inject
	protected ForbiddenPathInvaderFood3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
