 ...
 */
public class PurgatoryInvaderFood2Template extends ChestNPCTemplate {
	public static final int ID = 18292;

	@Inject
	protected PurgatoryInvaderFood2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Purgatory Invader Food";
