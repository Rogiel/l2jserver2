 ...
 */
public class TreasureChest48Template extends ChestNPCTemplate {
	public static final int ID = 21818;

	@Inject
	protected TreasureChest48Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
