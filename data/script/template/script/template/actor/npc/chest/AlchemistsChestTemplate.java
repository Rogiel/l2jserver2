 ...
 */
public class AlchemistsChestTemplate extends ChestNPCTemplate {
	public static final int ID = 13036;

	@Inject
	protected AlchemistsChestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Alchemist's Chest";
