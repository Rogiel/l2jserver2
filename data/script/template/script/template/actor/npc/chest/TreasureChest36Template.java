 ...
 */
public class TreasureChest36Template extends ChestNPCTemplate {
	public static final int ID = 21806;

	@Inject
	protected TreasureChest36Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
