 ...
 */
public class DimensionInvaderFoodTemplate extends ChestNPCTemplate {
	public static final int ID = 18289;

	@Inject
	protected DimensionInvaderFoodTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
