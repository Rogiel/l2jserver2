 ...
 */
public class TreasureChest25Template extends ChestNPCTemplate {
	public static final int ID = 18281;

	@Inject
	protected TreasureChest25Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 2472.780909750590000;
		...
		attributes.physicalDefense = 300.54900;
		attributes.magicalDefense = 182.06631;
