 ...
 */
public class TreasureChest21Template extends ChestNPCTemplate {
	public static final int ID = 18277;

	@Inject
	protected TreasureChest21Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 1833.928389807800000;
		this.maxMP = 948.000000000000000;
		this.hpRegeneration = 2.400000000000000;
		...
		attributes.physicalDefense = 240.71574;
		attributes.magicalDefense = 145.82057;
