 ...
 */
public class TreasureChest12Template extends ChestNPCTemplate {
	public static final int ID = 18268;

	@Inject
	protected TreasureChest12Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 623.584092631874000;
		...
		attributes.physicalDefense = 122.28832;
		attributes.magicalDefense = 74.07971;
