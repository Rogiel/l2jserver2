 ...
 */
public class TreasureChest18Template extends ChestNPCTemplate {
	public static final int ID = 18274;

	@Inject
	protected TreasureChest18Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 1366.755622004030000;
		...
		attributes.physicalDefense = 197.29766;
		attributes.magicalDefense = 119.51880;
