 ...
 */
public class MessengerInvaderFood3Template extends ChestNPCTemplate {
	public static final int ID = 21786;

	@Inject
	protected MessengerInvaderFood3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
