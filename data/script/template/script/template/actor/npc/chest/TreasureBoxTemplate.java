 ...
 */
public class TreasureBoxTemplate extends ChestNPCTemplate {
	public static final int ID = 13181;

	@Inject
	protected TreasureBoxTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
