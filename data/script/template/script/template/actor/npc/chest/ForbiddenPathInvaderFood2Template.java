 ...
 */
public class ForbiddenPathInvaderFood2Template extends ChestNPCTemplate {
	public static final int ID = 18294;

	@Inject
	protected ForbiddenPathInvaderFood2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
