 ...
 */
public class TreasureChest10Template extends ChestNPCTemplate {
	public static final int ID = 18266;

	@Inject
	protected TreasureChest10Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 449.397334531729000;
		this.maxMP = 245.520000000000000;
		this.hpRegeneration = 1.500000000000000;
		...
		attributes.physicalDefense = 101.89554;
		attributes.magicalDefense = 61.72619;
