 ...
 */
public class TreasureChest22Template extends ChestNPCTemplate {
	public static final int ID = 18278;

	@Inject
	protected TreasureChest22Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.attackRange = 40;
		this.maxHP = 1995.645661705970000;
		...
		attributes.physicalDefense = 255.64426;
		attributes.magicalDefense = 154.86395;
