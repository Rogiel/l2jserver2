 ...
 */
public class TreasureChest40Template extends ChestNPCTemplate {
	public static final int ID = 21810;

	@Inject
	protected TreasureChest40Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
