 ...
 */
public class TreasureChest37Template extends ChestNPCTemplate {
	public static final int ID = 21807;

	@Inject
	protected TreasureChest37Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
