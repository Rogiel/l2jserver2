 ...
 */
public class DimensionInvaderFood3Template extends ChestNPCTemplate {
	public static final int ID = 21694;

	@Inject
	protected DimensionInvaderFood3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
