 ...
 */
public class CoralTreasureChestTemplate extends ChestNPCTemplate {
	public static final int ID = 18477;

	@Inject
	protected CoralTreasureChestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Coral Treasure Chest";
