 ...
 */
public class SupplyBox14Template extends NPCTemplate {
	public static final int ID = 36117;

	@Inject
	protected SupplyBox14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
