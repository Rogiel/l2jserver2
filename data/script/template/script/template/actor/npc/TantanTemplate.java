 ...
 */
public class TantanTemplate extends NPCTemplate {
	public static final int ID = 32012;

	@Inject
	protected TantanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tantan";
		this.serverSideName = false;
		this.title = "Retired Adventurer";
