 ...
 */
public class GuardianOfBorder20Template extends NPCTemplate {
	public static final int ID = 31884;

	@Inject
	protected GuardianOfBorder20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
