 ...
 */
public class PenaltyKickBlueTemplate extends NPCTemplate {
	public static final int ID = 1581;

	@Inject
	protected PenaltyKickBlueTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Penalty Kick (blue)";
