 ...
 */
public class TeleportDevice5Template extends NPCTemplate {
	public static final int ID = 32749;

	@Inject
	protected TeleportDevice5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
