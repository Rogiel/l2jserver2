 ...
 */
public class ControlUnit7Template extends NPCTemplate {
	public static final int ID = 36092;

	@Inject
	protected ControlUnit7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
