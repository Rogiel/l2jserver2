 ...
 */
public class OperaAgathionTemplate extends NPCTemplate {
	public static final int ID = 1555;

	@Inject
	protected OperaAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Opera Agathion";
