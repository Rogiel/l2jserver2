 ...
 */
public class SupplyBox4Template extends NPCTemplate {
	public static final int ID = 35766;

	@Inject
	protected SupplyBox4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
