 ...
 */
public class DwarfAdventurer2Template extends NPCTemplate {
	public static final int ID = 32511;

	@Inject
	protected DwarfAdventurer2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dwarf Adventurer";
