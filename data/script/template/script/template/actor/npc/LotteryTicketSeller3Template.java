 ...
 */
public class LotteryTicketSeller3Template extends NPCTemplate {
	public static final int ID = 30992;

	@Inject
	protected LotteryTicketSeller3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
