 ...
 */
public class GalateTemplate extends NPCTemplate {
	public static final int ID = 32292;

	@Inject
	protected GalateTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
