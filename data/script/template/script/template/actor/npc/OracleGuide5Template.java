 ...
 */
public class OracleGuide5Template extends NPCTemplate {
	public static final int ID = 32277;

	@Inject
	protected OracleGuide5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
