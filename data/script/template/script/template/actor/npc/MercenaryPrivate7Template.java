 ...
 */
public class MercenaryPrivate7Template extends NPCTemplate {
	public static final int ID = 35894;

	@Inject
	protected MercenaryPrivate7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
