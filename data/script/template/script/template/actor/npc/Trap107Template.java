 ...
 */
public class Trap107Template extends NPCTemplate {
	public static final int ID = 18392;

	@Inject
	protected Trap107Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
