 ...
 */
public class RamusTemplate extends NPCTemplate {
	public static final int ID = 30667;

	@Inject
	protected RamusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
