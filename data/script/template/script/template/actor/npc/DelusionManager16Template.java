 ...
 */
public class DelusionManager16Template extends NPCTemplate {
	public static final int ID = 32679;

	@Inject
	protected DelusionManager16Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
