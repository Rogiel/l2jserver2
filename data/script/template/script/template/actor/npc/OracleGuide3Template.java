 ...
 */
public class OracleGuide3Template extends NPCTemplate {
	public static final int ID = 32275;

	@Inject
	protected OracleGuide3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
