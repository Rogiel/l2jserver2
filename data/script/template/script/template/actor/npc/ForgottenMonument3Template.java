 ...
 */
public class ForgottenMonument3Template extends NPCTemplate {
	public static final int ID = 31663;

	@Inject
	protected ForgottenMonument3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Forgotten Monument";
