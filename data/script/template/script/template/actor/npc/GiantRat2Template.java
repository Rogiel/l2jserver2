 ...
 */
public class GiantRat2Template extends NPCTemplate {
	public static final int ID = 13121;

	@Inject
	protected GiantRat2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
