 ...
 */
public class MerurilAgathionTemplate extends NPCTemplate {
	public static final int ID = 1546;

	@Inject
	protected MerurilAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Meruril Agathion";
