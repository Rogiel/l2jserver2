 ...
 */
public class TepiosTemplate extends NPCTemplate {
	public static final int ID = 32530;

	@Inject
	protected TepiosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
