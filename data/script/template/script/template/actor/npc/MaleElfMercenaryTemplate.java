 ...
 */
public class MaleElfMercenaryTemplate extends NPCTemplate {
	public static final int ID = 13170;

	@Inject
	protected MaleElfMercenaryTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Male Elf Mercenary";
