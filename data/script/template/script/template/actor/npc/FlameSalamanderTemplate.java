 ...
 */
public class FlameSalamanderTemplate extends NPCTemplate {
	public static final int ID = 30411;

	@Inject
	protected FlameSalamanderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Flame Salamander";
