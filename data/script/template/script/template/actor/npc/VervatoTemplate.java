 ...
 */
public class VervatoTemplate extends NPCTemplate {
	public static final int ID = 32104;

	@Inject
	protected VervatoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
