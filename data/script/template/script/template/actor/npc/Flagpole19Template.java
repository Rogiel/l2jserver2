 ...
 */
public class Flagpole19Template extends NPCTemplate {
	public static final int ID = 36285;

	@Inject
	protected Flagpole19Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
