 ...
 */
public class OrenWardTemplate extends TerritoryWardNPCTemplate {
	public static final int ID = 36575;

	@Inject
	protected OrenWardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
