 ...
 */
public class RuneWardTemplate extends TerritoryWardNPCTemplate {
	public static final int ID = 36579;

	@Inject
	protected RuneWardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
