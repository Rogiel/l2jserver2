 ...
 */
public class DionWardTemplate extends TerritoryWardNPCTemplate {
	public static final int ID = 36573;

	@Inject
	protected DionWardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
