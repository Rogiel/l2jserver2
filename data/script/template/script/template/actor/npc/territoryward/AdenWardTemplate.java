 ...
 */
public class AdenWardTemplate extends TerritoryWardNPCTemplate {
	public static final int ID = 36576;

	@Inject
	protected AdenWardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
