 ...
 */
public class SomulitanTemplate extends NPCTemplate {
	public static final int ID = 32704;

	@Inject
	protected SomulitanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Somulitan";
		this.serverSideName = false;
		this.title = "Soul Fragment Annex";
