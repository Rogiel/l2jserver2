 ...
 */
public class OmegasCatTemplate extends NPCTemplate {
	public static final int ID = 32091;

	@Inject
	protected OmegasCatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Omega's Cat";
