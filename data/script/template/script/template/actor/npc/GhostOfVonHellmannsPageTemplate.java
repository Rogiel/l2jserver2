 ...
 */
public class GhostOfVonHellmannsPageTemplate extends NPCTemplate {
	public static final int ID = 31525;

	@Inject
	protected GhostOfVonHellmannsPageTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ghost of von Hellmann's Page";
