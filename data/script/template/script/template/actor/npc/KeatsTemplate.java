 ...
 */
public class KeatsTemplate extends NPCTemplate {
	public static final int ID = 31622;

	@Inject
	protected KeatsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Keats";
		this.serverSideName = false;
		this.title = "Cursed Summoner";
