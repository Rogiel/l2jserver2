 ...
 */
public class DestroyedTumor3Template extends NPCTemplate {
	public static final int ID = 32535;

	@Inject
	protected DestroyedTumor3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
