 ...
 */
public class BaronsHallGatekeeperTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31925;

	@Inject
	protected BaronsHallGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
