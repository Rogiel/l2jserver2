 ...
 */
public class DukesHallGatekeeper2Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31934;

	@Inject
	protected DukesHallGatekeeper2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
