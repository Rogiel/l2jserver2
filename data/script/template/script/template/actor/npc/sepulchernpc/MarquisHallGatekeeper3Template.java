 ...
 */
public class MarquisHallGatekeeper3Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31938;

	@Inject
	protected MarquisHallGatekeeper3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
