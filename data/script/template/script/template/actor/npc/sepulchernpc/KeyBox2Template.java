 ...
 */
public class KeyBox2Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31456;

	@Inject
	protected KeyBox2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
