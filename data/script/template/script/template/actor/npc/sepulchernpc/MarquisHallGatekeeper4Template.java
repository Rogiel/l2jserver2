 ...
 */
public class MarquisHallGatekeeper4Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31943;

	@Inject
	protected MarquisHallGatekeeper4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Marquis' Hall Gatekeeper";
