 ...
 */
public class MysteriousBox8Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31475;

	@Inject
	protected MysteriousBox8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
