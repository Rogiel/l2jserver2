 ...
 */
public class KeyBox6Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31460;

	@Inject
	protected KeyBox6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
