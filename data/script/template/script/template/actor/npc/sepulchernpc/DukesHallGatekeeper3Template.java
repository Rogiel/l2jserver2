 ...
 */
public class DukesHallGatekeeper3Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31939;

	@Inject
	protected DukesHallGatekeeper3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Duke's Hall Gatekeeper";
