 ...
 */
public class KeyBox9Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31463;

	@Inject
	protected KeyBox9Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
