 ...
 */
public class BaronsHallGatekeeper3Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31935;

	@Inject
	protected BaronsHallGatekeeper3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
