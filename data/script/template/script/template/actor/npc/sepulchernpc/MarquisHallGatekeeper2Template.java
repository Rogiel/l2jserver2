 ...
 */
public class MarquisHallGatekeeper2Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31933;

	@Inject
	protected MarquisHallGatekeeper2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
