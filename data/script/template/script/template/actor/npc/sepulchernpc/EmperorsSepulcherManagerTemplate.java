 ...
 */
public class EmperorsSepulcherManagerTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31922;

	@Inject
	protected EmperorsSepulcherManagerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Emperors' Sepulcher Manager";
