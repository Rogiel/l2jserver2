 ...
 */
public class DukesHallGatekeeper4Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31944;

	@Inject
	protected DukesHallGatekeeper4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
