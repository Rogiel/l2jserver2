 ...
 */
public class BaronsHallGatekeeper4Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31940;

	@Inject
	protected BaronsHallGatekeeper4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Baron's Hall Gatekeeper";
