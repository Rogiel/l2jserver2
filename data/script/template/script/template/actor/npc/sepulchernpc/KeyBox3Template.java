 ...
 */
public class KeyBox3Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31457;

	@Inject
	protected KeyBox3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
