 ...
 */
public class CountsHallGatekeeper2Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31932;

	@Inject
	protected CountsHallGatekeeper2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
