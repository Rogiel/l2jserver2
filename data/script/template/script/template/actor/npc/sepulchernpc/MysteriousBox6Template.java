 ...
 */
public class MysteriousBox6Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31473;

	@Inject
	protected MysteriousBox6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
