 ...
 */
public class KeyBox8Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31462;

	@Inject
	protected KeyBox8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
