 ...
 */
package script.template.actor.npc.sepulchernpc;
 ...
 */
public class GhostChamberlainOfElmoreden2Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31920;

	@Inject
	protected GhostChamberlainOfElmoreden2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ghost Chamberlain of Elmoreden";
