 ...
 */
public class GhostOfWigoth2Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31454;

	@Inject
	protected GhostOfWigoth2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ghost of Wigoth";
