 ...
 */
public class MarquisHallGatekeeperTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31928;

	@Inject
	protected MarquisHallGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
