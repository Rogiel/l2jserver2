 ...
 */
public class GhostChamberlainOfElmoredenTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31919;

	@Inject
	protected GhostChamberlainOfElmoredenTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
