 ...
 */
public class GreatSagesSepulcherManagerTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31923;

	@Inject
	protected GreatSagesSepulcherManagerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Great Sages' Sepulcher Manager";
