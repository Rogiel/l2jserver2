 ...
 */
public class KeyBox4Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31458;

	@Inject
	protected KeyBox4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
