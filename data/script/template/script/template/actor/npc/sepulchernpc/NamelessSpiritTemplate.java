 ...
 */
public class NamelessSpiritTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31453;

	@Inject
	protected NamelessSpiritTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Nameless Spirit";
