 ...
 */
public class CountsHallGatekeeperTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31927;

	@Inject
	protected CountsHallGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
