 ...
 */
public class MysteriousBox14Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31481;

	@Inject
	protected MysteriousBox14Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mysterious Box";
