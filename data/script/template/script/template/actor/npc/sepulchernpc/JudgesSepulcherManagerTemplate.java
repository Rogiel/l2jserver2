 ...
 */
public class JudgesSepulcherManagerTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31924;

	@Inject
	protected JudgesSepulcherManagerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Judges' Sepulcher Manager";
