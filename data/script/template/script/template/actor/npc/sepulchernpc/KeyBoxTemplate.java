 ...
 */
public class KeyBoxTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31455;

	@Inject
	protected KeyBoxTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
