 ...
 */
public class MysteriousBox2Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31469;

	@Inject
	protected MysteriousBox2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
