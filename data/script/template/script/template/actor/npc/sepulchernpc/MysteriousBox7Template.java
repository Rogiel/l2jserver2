 ...
 */
public class MysteriousBox7Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31474;

	@Inject
	protected MysteriousBox7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
