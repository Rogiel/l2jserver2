 ...
 */
public class MysteriousBox4Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31471;

	@Inject
	protected MysteriousBox4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
