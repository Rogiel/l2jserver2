 ...
 */
public class CountsHallGatekeeper4Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31942;

	@Inject
	protected CountsHallGatekeeper4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Count's Hall Gatekeeper";
