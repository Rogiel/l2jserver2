 ...
 */
public class GhostOfWigothTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31452;

	@Inject
	protected GhostOfWigothTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
