 ...
 */
public class CountsHallGatekeeper3Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31937;

	@Inject
	protected CountsHallGatekeeper3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
