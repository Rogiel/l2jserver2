 ...
 */
public class ConquerorsSepulcherManagerTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31921;

	@Inject
	protected ConquerorsSepulcherManagerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Conquerors' Sepulcher Manager";
