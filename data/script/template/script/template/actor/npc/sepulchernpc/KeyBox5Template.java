 ...
 */
public class KeyBox5Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31459;

	@Inject
	protected KeyBox5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
