 ...
 */
public class DukesHallGatekeeperTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31929;

	@Inject
	protected DukesHallGatekeeperTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
