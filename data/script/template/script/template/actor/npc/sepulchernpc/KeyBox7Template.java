 ...
 */
public class KeyBox7Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31461;

	@Inject
	protected KeyBox7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
