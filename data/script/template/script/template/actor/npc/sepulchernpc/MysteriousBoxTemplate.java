 ...
 */
public class MysteriousBoxTemplate extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31468;

	@Inject
	protected MysteriousBoxTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
