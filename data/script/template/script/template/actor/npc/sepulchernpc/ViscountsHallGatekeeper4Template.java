 ...
 */
public class ViscountsHallGatekeeper4Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31941;

	@Inject
	protected ViscountsHallGatekeeper4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Viscount's Hall Gatekeeper";
