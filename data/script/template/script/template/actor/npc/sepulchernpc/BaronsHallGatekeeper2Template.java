 ...
 */
public class BaronsHallGatekeeper2Template extends SepulcherMonsterNPCTemplate {
	public static final int ID = 31930;

	@Inject
	protected BaronsHallGatekeeper2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
