 ...
 */
public class Trap34Template extends NPCTemplate {
	public static final int ID = 13070;

	@Inject
	protected Trap34Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
