 ...
 */
public class LeikarTemplate extends NPCTemplate {
	public static final int ID = 31520;

	@Inject
	protected LeikarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
