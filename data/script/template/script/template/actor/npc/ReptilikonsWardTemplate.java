 ...
 */
public class ReptilikonsWardTemplate extends NPCTemplate {
	public static final int ID = 18844;

	@Inject
	protected ReptilikonsWardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Reptilikon's Ward";
