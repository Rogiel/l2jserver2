 ...
 */
public class DoorGolem2Template extends NPCTemplate {
	public static final int ID = 18923;

	@Inject
	protected DoorGolem2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
