 ...
 */
public class DetentionCampWarden13Template extends NPCTemplate {
	public static final int ID = 36081;

	@Inject
	protected DetentionCampWarden13Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
