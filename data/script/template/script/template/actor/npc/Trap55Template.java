 ...
 */
public class Trap55Template extends NPCTemplate {
	public static final int ID = 13219;

	@Inject
	protected Trap55Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
