 ...
 */
public class Trap193Template extends NPCTemplate {
	public static final int ID = 18770;

	@Inject
	protected Trap193Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
