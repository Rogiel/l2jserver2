 ...
 */
public class SalesCatOfIvoryTowerTemplate extends NPCTemplate {
	public static final int ID = 31075;

	@Inject
	protected SalesCatOfIvoryTowerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sales Cat of Ivory Tower";
