 ...
 */
package script.template.actor.npc.misc;
 ...
 */
public class SpecialChristmasTreeTemplate extends NPCTemplate {
	public static final int ID = 13007;

	@Inject
	protected SpecialChristmasTreeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Special Christmas Tree";
