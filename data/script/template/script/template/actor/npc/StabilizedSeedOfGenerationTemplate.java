 ...
 */
public class StabilizedSeedOfGenerationTemplate extends NPCTemplate {
	public static final int ID = 32542;

	@Inject
	protected StabilizedSeedOfGenerationTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Stabilized Seed of Generation";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 57.75;
		this.collisionHeight = 65.63;
		this.level = 70;
