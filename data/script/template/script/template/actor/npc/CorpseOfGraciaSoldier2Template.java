 ...
 */
public class CorpseOfGraciaSoldier2Template extends NPCTemplate {
	public static final int ID = 32770;

	@Inject
	protected CorpseOfGraciaSoldier2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Corpse of Gracia Soldier";
