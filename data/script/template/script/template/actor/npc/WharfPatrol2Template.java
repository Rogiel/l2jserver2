 ...
 */
public class WharfPatrol2Template extends NPCTemplate {
	public static final int ID = 32629;

	@Inject
	protected WharfPatrol2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Wharf Patrol";
