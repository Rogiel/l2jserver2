 ...
 */
public class QuarrySlaveTemplate extends NPCTemplate {
	public static final int ID = 32299;

	@Inject
	protected QuarrySlaveTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Quarry Slave";
