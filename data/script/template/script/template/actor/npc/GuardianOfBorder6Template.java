 ...
 */
public class GuardianOfBorder6Template extends NPCTemplate {
	public static final int ID = 31870;

	@Inject
	protected GuardianOfBorder6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
