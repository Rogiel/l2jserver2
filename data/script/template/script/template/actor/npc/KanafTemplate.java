 ...
 */
public class KanafTemplate extends NPCTemplate {
	public static final int ID = 32346;

	@Inject
	protected KanafTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
