 ...
 */
public class TullysGatekeeper11Template extends NPCTemplate {
	public static final int ID = 18455;

	@Inject
	protected TullysGatekeeper11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tully's Gatekeeper";
