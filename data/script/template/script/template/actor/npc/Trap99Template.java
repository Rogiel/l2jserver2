 ...
 */
public class Trap99Template extends NPCTemplate {
	public static final int ID = 18384;

	@Inject
	protected Trap99Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
