 ...
 */
public class SuperGiantRatTemplate extends NPCTemplate {
	public static final int ID = 13123;

	@Inject
	protected SuperGiantRatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Super giant rat";
		...
		this.attackRange = 40;
		this.maxHP = 3400.000000000000000;
		this.maxMP = 6000.000000000000000;
