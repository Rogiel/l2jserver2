 ...
 */
public class WonbosoAgathionTemplate extends NPCTemplate {
	public static final int ID = 1525;

	@Inject
	protected WonbosoAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Wonboso Agathion";
