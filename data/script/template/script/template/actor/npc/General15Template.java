 ...
 */
public class General15Template extends NPCTemplate {
	public static final int ID = 36176;

	@Inject
	protected General15Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
