 ...
 */
public class LanaAgathionTemplate extends NPCTemplate {
	public static final int ID = 1540;

	@Inject
	protected LanaAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lana Agathion";
