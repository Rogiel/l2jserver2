 ...
 */
public class PurpleFlagTemplate extends NPCTemplate {
	public static final int ID = 35427;

	@Inject
	protected PurpleFlagTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
