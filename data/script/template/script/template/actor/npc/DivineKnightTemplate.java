 ...
 */
public class DivineKnightTemplate extends NPCTemplate {
	public static final int ID = 13112;

	@Inject
	protected DivineKnightTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Divine Knight";
