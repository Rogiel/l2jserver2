 ...
 */
public class CorpseOfKurtzTemplate extends NPCTemplate {
	public static final int ID = 30763;

	@Inject
	protected CorpseOfKurtzTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Corpse Of Kurtz";
