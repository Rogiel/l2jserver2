 ...
 */
public class HallGuardTemplate extends NPCTemplate {
	public static final int ID = 18469;

	@Inject
	protected HallGuardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
