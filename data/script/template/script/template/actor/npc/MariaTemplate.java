 ...
 */
public class MariaTemplate extends NPCTemplate {
	public static final int ID = 30608;

	@Inject
	protected MariaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
