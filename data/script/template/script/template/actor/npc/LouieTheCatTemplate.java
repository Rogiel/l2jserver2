 ...
 */
public class LouieTheCatTemplate extends NPCTemplate {
	public static final int ID = 31230;

	@Inject
	protected LouieTheCatTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Louie the Cat";
