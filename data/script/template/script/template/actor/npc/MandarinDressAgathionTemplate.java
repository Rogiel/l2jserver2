 ...
 */
public class MandarinDressAgathionTemplate extends NPCTemplate {
	public static final int ID = 1556;

	@Inject
	protected MandarinDressAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mandarin Dress Agathion";
