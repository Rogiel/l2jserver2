 ...
 */
public class GwanwooHwamaeAgathionTemplate extends NPCTemplate {
	public static final int ID = 1537;

	@Inject
	protected GwanwooHwamaeAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gwanwoo Hwamae Agathion";
