 ...
 */
public class LargeYoungSquashTemplate extends NPCTemplate {
	public static final int ID = 12777;

	@Inject
	protected LargeYoungSquashTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Large Young Squash";
