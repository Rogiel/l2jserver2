 ...
 */
public class GrannyTigerTemplate extends NPCTemplate {
	public static final int ID = 1585;

	@Inject
	protected GrannyTigerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Granny Tiger";
