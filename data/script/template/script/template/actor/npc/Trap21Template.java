 ...
 */
public class Trap21Template extends NPCTemplate {
	public static final int ID = 13057;

	@Inject
	protected Trap21Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
