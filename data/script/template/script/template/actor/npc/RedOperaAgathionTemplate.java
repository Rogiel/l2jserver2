 ...
 */
public class RedOperaAgathionTemplate extends NPCTemplate {
	public static final int ID = 1554;

	@Inject
	protected RedOperaAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Red Opera Agathion";
