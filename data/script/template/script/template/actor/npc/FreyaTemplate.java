 ...
 */
public class FreyaTemplate extends NPCTemplate {
	public static final int ID = 13296;

	@Inject
	protected FreyaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
