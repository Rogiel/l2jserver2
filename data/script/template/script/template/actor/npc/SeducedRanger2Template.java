 ...
 */
public class SeducedRanger2Template extends NPCTemplate {
	public static final int ID = 36567;

	@Inject
	protected SeducedRanger2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
