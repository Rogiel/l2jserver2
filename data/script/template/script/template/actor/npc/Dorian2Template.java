 ...
 */
public class Dorian2Template extends NPCTemplate {
	public static final int ID = 31389;

	@Inject
	protected Dorian2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
