 ...
 */
public class DelusionManager11Template extends NPCTemplate {
	public static final int ID = 32674;

	@Inject
	protected DelusionManager11Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
