 ...
 */
public class LavaGolemTemplate extends NPCTemplate {
	public static final int ID = 13133;

	@Inject
	protected LavaGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lava Golem";
