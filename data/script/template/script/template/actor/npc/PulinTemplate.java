 ...
 */
public class PulinTemplate extends NPCTemplate {
	public static final int ID = 31543;

	@Inject
	protected PulinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
