 ...
 */
public class Kegor3Template extends NPCTemplate {
	public static final int ID = 32761;

	@Inject
	protected Kegor3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
