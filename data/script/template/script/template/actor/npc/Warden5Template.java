 ...
 */
public class Warden5Template extends NPCTemplate {
	public static final int ID = 36407;

	@Inject
	protected Warden5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
