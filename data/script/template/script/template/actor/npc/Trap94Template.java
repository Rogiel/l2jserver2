 ...
 */
public class Trap94Template extends NPCTemplate {
	public static final int ID = 18379;

	@Inject
	protected Trap94Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
