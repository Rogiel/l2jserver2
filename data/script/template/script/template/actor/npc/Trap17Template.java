 ...
 */
public class Trap17Template extends NPCTemplate {
	public static final int ID = 13053;

	@Inject
	protected Trap17Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
