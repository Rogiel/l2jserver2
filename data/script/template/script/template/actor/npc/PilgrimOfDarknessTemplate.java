 ...
 */
public class PilgrimOfDarknessTemplate extends NPCTemplate {
	public static final int ID = 31640;

	@Inject
	protected PilgrimOfDarknessTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
