 ...
 */
public class LillyTemplate extends NPCTemplate {
	public static final int ID = 31628;

	@Inject
	protected LillyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
