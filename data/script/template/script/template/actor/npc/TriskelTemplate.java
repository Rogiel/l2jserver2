 ...
 */
public class TriskelTemplate extends NPCTemplate {
	public static final int ID = 30416;

	@Inject
	protected TriskelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
