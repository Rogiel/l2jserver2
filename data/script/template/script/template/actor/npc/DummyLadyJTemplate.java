 ...
 */
public class DummyLadyJTemplate extends NPCTemplate {
	public static final int ID = 31399;

	@Inject
	protected DummyLadyJTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dummy - Lady J";
