 ...
 */
public class Trap48Template extends NPCTemplate {
	public static final int ID = 13212;

	@Inject
	protected Trap48Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
