 ...
 */
public class Trap73Template extends NPCTemplate {
	public static final int ID = 13237;

	@Inject
	protected Trap73Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
