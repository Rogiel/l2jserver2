 ...
 */
public class KegorTemplate extends NPCTemplate {
	public static final int ID = 18846;

	@Inject
	protected KegorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
