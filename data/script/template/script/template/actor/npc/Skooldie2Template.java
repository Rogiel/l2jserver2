 ...
 */
public class Skooldie2Template extends NPCTemplate {
	public static final int ID = 13282;

	@Inject
	protected Skooldie2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
