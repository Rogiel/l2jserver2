 ...
 */
public class Furnace2Template extends NPCTemplate {
	public static final int ID = 18914;

	@Inject
	protected Furnace2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
