 ...
 */
public class InfernoDrakeTemplate extends NPCTemplate {
	public static final int ID = 13084;

	@Inject
	protected InfernoDrakeTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Inferno Drake";
