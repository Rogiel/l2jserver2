 ...
 */
public class TonyTheCat3Template extends NPCTemplate {
	public static final int ID = 32101;

	@Inject
	protected TonyTheCat3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
