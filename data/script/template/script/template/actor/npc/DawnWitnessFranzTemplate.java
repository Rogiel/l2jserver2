 ...
 */
public class DawnWitnessFranzTemplate extends NPCTemplate {
	public static final int ID = 31644;

	@Inject
	protected DawnWitnessFranzTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dawn Witness Franz";
		this.serverSideName = false;
		this.title = "Witness of Dawn";
