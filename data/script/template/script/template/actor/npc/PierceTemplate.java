 ...
 */
public class PierceTemplate extends NPCTemplate {
	public static final int ID = 31553;

	@Inject
	protected PierceTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Pierce";
		this.serverSideName = false;
		this.title = "Mercenary Captain";
