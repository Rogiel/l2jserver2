 ...
 */
public class WaterCouatleAtekaTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25208;

	@Inject
	protected WaterCouatleAtekaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Water Couatle Ateka";
