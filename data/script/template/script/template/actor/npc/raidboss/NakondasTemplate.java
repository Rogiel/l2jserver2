 ...
 */
public class NakondasTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25415;

	@Inject
	protected NakondasTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
