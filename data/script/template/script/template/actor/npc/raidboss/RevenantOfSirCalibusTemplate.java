 ...
 */
public class RevenantOfSirCalibusTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25383;

	@Inject
	protected RevenantOfSirCalibusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Revenant of Sir Calibus";
