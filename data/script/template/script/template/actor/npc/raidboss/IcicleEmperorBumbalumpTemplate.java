 ...
 */
public class IcicleEmperorBumbalumpTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25296;

	@Inject
	protected IcicleEmperorBumbalumpTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Icicle Emperor Bumbalump";
