 ...
 */
public class CarnamakosTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25273;

	@Inject
	protected CarnamakosTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Carnamakos";
