 ...
 */
public class TeslaTheDeceiverTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25549;

	@Inject
	protected TeslaTheDeceiverTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tesla the Deceiver";
