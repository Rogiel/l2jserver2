 ...
 */
public class RemmelTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25041;

	@Inject
	protected RemmelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
