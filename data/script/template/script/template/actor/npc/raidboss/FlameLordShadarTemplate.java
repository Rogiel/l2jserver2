 ...
 */
public class FlameLordShadarTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25152;

	@Inject
	protected FlameLordShadarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Flame Lord Shadar";
