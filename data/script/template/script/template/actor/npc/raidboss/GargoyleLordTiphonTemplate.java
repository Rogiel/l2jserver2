 ...
 */
public class GargoyleLordTiphonTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25255;

	@Inject
	protected GargoyleLordTiphonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Gargoyle Lord Tiphon";
