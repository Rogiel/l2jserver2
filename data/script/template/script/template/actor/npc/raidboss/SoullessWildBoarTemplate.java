 ...
 */
public class SoullessWildBoarTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25089;

	@Inject
	protected SoullessWildBoarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Soulless Wild Boar";
