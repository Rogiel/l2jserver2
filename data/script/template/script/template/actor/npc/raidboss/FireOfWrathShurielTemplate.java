 ...
 */
public class FireOfWrathShurielTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25143;

	@Inject
	protected FireOfWrathShurielTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fire of Wrath Shuriel";
