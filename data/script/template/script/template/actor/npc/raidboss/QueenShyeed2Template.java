 ...
 */
public class QueenShyeed2Template extends RaidBossNPCTemplate {
	public static final int ID = 25671;

	@Inject
	protected QueenShyeed2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.magicalAttack = 298.22125;
