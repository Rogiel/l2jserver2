 ...
 */
public class SoulCollectorAcheronTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25223;

	@Inject
	protected SoulCollectorAcheronTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Soul Collector Acheron";
		...
		this.rightHand = itemProvider.createID(192);
		this.leftHand = null;
		this.enchantLevel = 0;
