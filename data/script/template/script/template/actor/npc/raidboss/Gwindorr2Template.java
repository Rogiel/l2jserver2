 ...
 */
public class Gwindorr2Template extends RaidBossNPCTemplate {
	public static final int ID = 25674;

	@Inject
	protected Gwindorr2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.magicalAttack = 294.62845;
