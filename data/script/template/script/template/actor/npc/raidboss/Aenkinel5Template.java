 ...
 */
public class Aenkinel5Template extends RaidBossNPCTemplate {
	public static final int ID = 25694;

	@Inject
	protected Aenkinel5Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
