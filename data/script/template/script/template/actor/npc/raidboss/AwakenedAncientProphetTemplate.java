 ...
 */
public class AwakenedAncientProphetTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25651;

	@Inject
	protected AwakenedAncientProphetTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
