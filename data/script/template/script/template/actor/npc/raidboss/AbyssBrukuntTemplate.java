 ...
 */
public class AbyssBrukuntTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25238;

	@Inject
	protected AbyssBrukuntTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Abyss Brukunt";
