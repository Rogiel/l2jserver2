 ...
 */
public class LetoChiefTalkinTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25134;

	@Inject
	protected LetoChiefTalkinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Leto Chief Talkin";
		this.serverSideName = false;
		this.title = "Raid Boss";
		this.serverSideTitle = false;
		this.collisionRadius = 37.50;
