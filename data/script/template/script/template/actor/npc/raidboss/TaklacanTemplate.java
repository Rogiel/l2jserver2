 ...
 */
public class TaklacanTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25696;

	@Inject
	protected TaklacanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
