 ...
 */
public class KuroborosPriestTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25366;

	@Inject
	protected KuroborosPriestTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kuroboros' Priest";
