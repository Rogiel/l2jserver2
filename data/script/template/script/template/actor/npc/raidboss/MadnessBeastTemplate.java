 ...
 */
public class MadnessBeastTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25378;

	@Inject
	protected MadnessBeastTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Madness Beast";
