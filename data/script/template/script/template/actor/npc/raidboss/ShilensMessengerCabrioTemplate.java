 ...
 */
public class ShilensMessengerCabrioTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25035;

	@Inject
	protected ShilensMessengerCabrioTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shilen's Messenger Cabrio";
