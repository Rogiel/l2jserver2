 ...
 */
public class RottenTreeRepiroTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25099;

	@Inject
	protected RottenTreeRepiroTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rotten Tree Repiro";
