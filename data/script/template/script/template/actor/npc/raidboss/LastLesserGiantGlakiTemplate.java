 ...
 */
public class LastLesserGiantGlakiTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25245;

	@Inject
	protected LastLesserGiantGlakiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Last Lesser Giant Glaki";
