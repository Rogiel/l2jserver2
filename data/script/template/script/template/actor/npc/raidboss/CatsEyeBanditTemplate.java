 ...
 */
public class CatsEyeBanditTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25079;

	@Inject
	protected CatsEyeBanditTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
