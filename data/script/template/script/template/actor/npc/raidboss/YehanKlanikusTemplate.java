 ...
 */
public class YehanKlanikusTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25666;

	@Inject
	protected YehanKlanikusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Yehan Klanikus";
		this.serverSideName = false;
		this.title = "Guide of Darkness";
