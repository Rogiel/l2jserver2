 ...
 */
public class EvasSpiritNinielTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25493;

	@Inject
	protected EvasSpiritNinielTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Eva's Spirit Niniel";
