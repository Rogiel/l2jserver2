 ...
 */
public class MalexHeraldOfDagonielTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25373;

	@Inject
	protected MalexHeraldOfDagonielTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Malex Herald of Dagoniel";
