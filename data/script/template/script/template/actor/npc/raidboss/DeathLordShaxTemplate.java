 ...
 */
public class DeathLordShaxTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25282;

	@Inject
	protected DeathLordShaxTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Death Lord Shax";
		this.serverSideName = false;
		this.title = "Raid Boss";
		this.serverSideTitle = false;
		this.collisionRadius = 31.00;
		this.collisionHeight = 61.50;
		this.level = 75;
