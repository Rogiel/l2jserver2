 ...
 */
public class LordIshkaTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25407;

	@Inject
	protected LordIshkaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lord Ishka";
