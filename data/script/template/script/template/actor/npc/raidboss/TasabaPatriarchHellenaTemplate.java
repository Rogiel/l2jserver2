 ...
 */
public class TasabaPatriarchHellenaTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25185;

	@Inject
	protected TasabaPatriarchHellenaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tasaba Patriarch Hellena";
