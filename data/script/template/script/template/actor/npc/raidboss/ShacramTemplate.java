 ...
 */
public class ShacramTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25102;

	@Inject
	protected ShacramTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		this.rightHand = itemProvider.createID(300);
		this.leftHand = null;
		this.enchantLevel = 0;
