 ...
 */
public class SoulScavengerTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25369;

	@Inject
	protected SoulScavengerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Soul Scavenger";
