 ...
 */
public class BetrayerOfUrutuFrekiTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25426;

	@Inject
	protected BetrayerOfUrutuFrekiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Betrayer of Urutu Freki";
