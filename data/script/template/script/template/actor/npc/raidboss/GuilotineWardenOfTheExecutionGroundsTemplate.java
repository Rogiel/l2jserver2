 ...
 */
public class GuilotineWardenOfTheExecutionGroundsTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25118;

	@Inject
	protected GuilotineWardenOfTheExecutionGroundsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guilotine Warden of the Execution Grounds";
