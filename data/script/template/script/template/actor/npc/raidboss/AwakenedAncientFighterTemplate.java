 ...
 */
public class AwakenedAncientFighterTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25647;

	@Inject
	protected AwakenedAncientFighterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
