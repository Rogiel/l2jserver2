 ...
 */
public class EnchantedForestWatcherRuellTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25070;

	@Inject
	protected EnchantedForestWatcherRuellTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Enchanted Forest Watcher Ruell";
