 ...
 */
public class ThiefKelbarTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25438;

	@Inject
	protected ThiefKelbarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Thief Kelbar";
		...
		this.rightHand = itemProvider.createID(239);
		this.leftHand = null;
		this.enchantLevel = 0;
