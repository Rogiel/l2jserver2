 ...
 */
public class GwindorrTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25490;

	@Inject
	protected GwindorrTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
