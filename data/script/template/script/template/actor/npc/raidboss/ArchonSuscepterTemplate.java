 ...
 */
public class ArchonSuscepterTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25395;

	@Inject
	protected ArchonSuscepterTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Archon Suscepter";
