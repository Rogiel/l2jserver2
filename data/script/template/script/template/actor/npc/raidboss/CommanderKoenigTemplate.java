 ...
 */
public class CommanderKoenigTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25592;

	@Inject
	protected CommanderKoenigTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Commander Koenig";
		...
		this.attackRange = 40;
		this.maxHP = 415001.005949950000000;
		this.maxMP = 1641.000000000000000;
		this.hpRegeneration = 177.399768233612000;
