 ...
 */
public class AwakenedAncientSoulDevourerTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25646;

	@Inject
	protected AwakenedAncientSoulDevourerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Awakened Ancient Soul Devourer";
