 ...
 */
public class GuardianOfTheStatueOfGiantKarumTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25179;

	@Inject
	protected GuardianOfTheStatueOfGiantKarumTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Guardian of the Statue of Giant Karum";
