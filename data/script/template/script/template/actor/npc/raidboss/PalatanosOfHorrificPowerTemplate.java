 ...
 */
public class PalatanosOfHorrificPowerTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25249;

	@Inject
	protected PalatanosOfHorrificPowerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Palatanos of Horrific Power";
