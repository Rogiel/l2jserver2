 ...
 */
public class SoulHunterChakundelTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25552;

	@Inject
	protected SoulHunterChakundelTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Soul Hunter Chakundel";
