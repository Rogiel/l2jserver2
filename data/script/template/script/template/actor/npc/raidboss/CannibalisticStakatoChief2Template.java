 ...
 */
public class CannibalisticStakatoChief2Template extends RaidBossNPCTemplate {
	public static final int ID = 25668;

	@Inject
	protected CannibalisticStakatoChief2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
