 ...
 */
public class CarnageLordGatoTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25131;

	@Inject
	protected CarnageLordGatoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Carnage Lord Gato";
