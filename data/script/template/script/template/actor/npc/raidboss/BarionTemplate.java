 ...
 */
public class BarionTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25044;

	@Inject
	protected BarionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
