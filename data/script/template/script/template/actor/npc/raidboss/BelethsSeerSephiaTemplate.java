 ...
 */
public class BelethsSeerSephiaTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25137;

	@Inject
	protected BelethsSeerSephiaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Beleth's Seer Sephia";
