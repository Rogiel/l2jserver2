 ...
 */
public class GreyclawKutusTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25001;

	@Inject
	protected GreyclawKutusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Greyclaw Kutus";
