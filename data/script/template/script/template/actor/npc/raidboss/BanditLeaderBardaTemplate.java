 ...
 */
public class BanditLeaderBardaTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25434;

	@Inject
	protected BanditLeaderBardaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bandit Leader Barda";
