 ...
 */
public class BeastLordBehemothTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25269;

	@Inject
	protected BeastLordBehemothTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Beast Lord Behemoth";
