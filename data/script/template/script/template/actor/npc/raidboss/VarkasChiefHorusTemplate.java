 ...
 */
public class VarkasChiefHorusTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25315;

	@Inject
	protected VarkasChiefHorusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Varka's Chief Horus";
