 ...
 */
public class WizardOfStormTerukTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25064;

	@Inject
	protected WizardOfStormTerukTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Wizard of Storm Teruk";
