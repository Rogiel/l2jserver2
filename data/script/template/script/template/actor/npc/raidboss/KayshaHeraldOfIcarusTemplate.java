 ...
 */
public class KayshaHeraldOfIcarusTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25380;

	@Inject
	protected KayshaHeraldOfIcarusTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Kaysha Herald of Icarus";
