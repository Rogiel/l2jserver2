 ...
 */
public class ShamanKingSeluTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25155;

	@Inject
	protected ShamanKingSeluTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Shaman King Selu";
