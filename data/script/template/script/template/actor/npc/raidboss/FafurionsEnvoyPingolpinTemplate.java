 ...
 */
public class FafurionsEnvoyPingolpinTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25496;

	@Inject
	protected FafurionsEnvoyPingolpinTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fafurion's Envoy Pingolpin";
