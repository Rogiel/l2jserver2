 ...
 */
public class CannibalisticStakatoChief3Template extends RaidBossNPCTemplate {
	public static final int ID = 25669;

	@Inject
	protected CannibalisticStakatoChief3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
