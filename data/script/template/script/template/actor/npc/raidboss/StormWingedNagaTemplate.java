 ...
 */
public class StormWingedNagaTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25229;

	@Inject
	protected StormWingedNagaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Storm Winged Naga";
		this.serverSideName = false;
		this.title = "Raid Boss";
		this.serverSideTitle = false;
		this.collisionRadius = 58.00;
		this.collisionHeight = 108.00;
		this.level = 75;
