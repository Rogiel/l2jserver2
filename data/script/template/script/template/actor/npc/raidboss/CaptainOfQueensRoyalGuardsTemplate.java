 ...
 */
public class CaptainOfQueensRoyalGuardsTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25392;

	@Inject
	protected CaptainOfQueensRoyalGuardsTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Captain of Queen's Royal Guards";
