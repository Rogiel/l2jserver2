 ...
 */
public class LilithsWitchMarilionTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25277;

	@Inject
	protected LilithsWitchMarilionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Lilith's Witch Marilion";
