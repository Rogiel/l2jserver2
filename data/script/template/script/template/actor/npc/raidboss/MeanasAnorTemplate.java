 ...
 */
public class MeanasAnorTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25453;

	@Inject
	protected MeanasAnorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Meanas Anor";
