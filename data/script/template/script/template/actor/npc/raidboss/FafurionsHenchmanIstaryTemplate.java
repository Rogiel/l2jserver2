 ...
 */
public class FafurionsHenchmanIstaryTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25498;

	@Inject
	protected FafurionsHenchmanIstaryTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fafurion's Henchman Istary";
