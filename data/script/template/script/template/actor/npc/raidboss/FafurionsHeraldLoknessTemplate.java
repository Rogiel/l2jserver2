 ...
 */
public class FafurionsHeraldLoknessTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25198;

	@Inject
	protected FafurionsHeraldLoknessTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fafurion's Herald Lokness";
