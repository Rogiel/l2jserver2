 ...
 */
public class BloodyEmpressDecarbiaTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25266;

	@Inject
	protected BloodyEmpressDecarbiaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Bloody Empress Decarbia";
