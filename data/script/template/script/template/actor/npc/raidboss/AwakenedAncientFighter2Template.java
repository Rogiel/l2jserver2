 ...
 */
public class AwakenedAncientFighter2Template extends RaidBossNPCTemplate {
	public static final int ID = 25648;

	@Inject
	protected AwakenedAncientFighter2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Awakened Ancient Fighter";
