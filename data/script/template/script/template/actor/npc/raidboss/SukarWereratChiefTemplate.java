 ...
 */
public class SukarWereratChiefTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25357;

	@Inject
	protected SukarWereratChiefTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sukar Wererat Chief";
