 ...
 */
public class RhiannaTheTraitorTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25546;

	@Inject
	protected RhiannaTheTraitorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Rhianna the Traitor";
