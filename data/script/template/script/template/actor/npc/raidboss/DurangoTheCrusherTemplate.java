 ...
 */
public class DurangoTheCrusherTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25553;

	@Inject
	protected DurangoTheCrusherTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Durango the Crusher";
