 ...
 */
public class MessengerOfFairyQueenBerunTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25119;

	@Inject
	protected MessengerOfFairyQueenBerunTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Messenger of Fairy Queen Berun";
