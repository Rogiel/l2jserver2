 ...
 */
public class RoadScavengerLeaderTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25410;

	@Inject
	protected RoadScavengerLeaderTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Road Scavenger Leader";
