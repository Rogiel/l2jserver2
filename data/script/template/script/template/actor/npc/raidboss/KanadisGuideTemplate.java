 ...
 */
public class KanadisGuideTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25659;

	@Inject
	protected KanadisGuideTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 1632.09847;
