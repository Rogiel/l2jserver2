 ...
 */
public class AwakenedAncientSevererTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25644;

	@Inject
	protected AwakenedAncientSevererTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Awakened Ancient Severer";
