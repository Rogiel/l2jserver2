 ...
 */
public class BlackLilyTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25176;

	@Inject
	protected BlackLilyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Black Lily";
