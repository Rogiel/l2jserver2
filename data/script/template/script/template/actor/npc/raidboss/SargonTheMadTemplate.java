 ...
 */
public class SargonTheMadTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25560;

	@Inject
	protected SargonTheMadTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sargon the Mad";
