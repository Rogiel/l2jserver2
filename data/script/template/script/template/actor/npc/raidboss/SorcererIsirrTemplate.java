 ...
 */
public class SorcererIsirrTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25103;

	@Inject
	protected SorcererIsirrTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sorcerer Isirr";
