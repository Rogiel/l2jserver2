 ...
 */
public class MirrorOfOblivionTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25456;

	@Inject
	protected MirrorOfOblivionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mirror of Oblivion";
		this.serverSideName = false;
		this.title = "Raid Boss";
		this.serverSideTitle = false;
		this.collisionRadius = 45.00;
		this.collisionHeight = 78.00;
		this.level = 49;
