 ...
 */
public class KetrasCommanderTayrTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25302;

	@Inject
	protected KetrasCommanderTayrTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Ketra's Commander Tayr";
