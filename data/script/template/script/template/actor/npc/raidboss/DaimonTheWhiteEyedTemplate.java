 ...
 */
public class DaimonTheWhiteEyedTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25290;

	@Inject
	protected DaimonTheWhiteEyedTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Daimon the White-Eyed";
