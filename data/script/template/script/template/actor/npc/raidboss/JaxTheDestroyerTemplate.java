 ...
 */
public class JaxTheDestroyerTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25569;

	@Inject
	protected JaxTheDestroyerTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Jax the Destroyer";
