 ...
 */
public class FlamestoneGolemTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25431;

	@Inject
	protected FlamestoneGolemTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Flamestone Golem";
