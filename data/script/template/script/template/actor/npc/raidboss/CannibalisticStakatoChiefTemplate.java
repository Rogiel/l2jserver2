 ...
 */
public class CannibalisticStakatoChiefTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25667;

	@Inject
	protected CannibalisticStakatoChiefTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
