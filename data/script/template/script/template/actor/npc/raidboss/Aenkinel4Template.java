 ...
 */
public class Aenkinel4Template extends RaidBossNPCTemplate {
	public static final int ID = 25693;

	@Inject
	protected Aenkinel4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
