 ...
 */
public class ZombieLordCrowlTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25149;

	@Inject
	protected ZombieLordCrowlTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Zombie Lord Crowl";
