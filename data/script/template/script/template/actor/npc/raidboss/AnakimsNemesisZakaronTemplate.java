 ...
 */
public class AnakimsNemesisZakaronTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25281;

	@Inject
	protected AnakimsNemesisZakaronTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Anakim's Nemesis Zakaron";
		this.serverSideName = false;
		this.title = "Raid Boss";
		this.serverSideTitle = false;
		this.collisionRadius = 37.00;
		this.collisionHeight = 136.50;
		this.level = 70;
