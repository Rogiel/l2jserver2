 ...
 */
public class Epidos4Template extends RaidBossNPCTemplate {
	public static final int ID = 25612;

	@Inject
	protected Epidos4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
