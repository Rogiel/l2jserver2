 ...
 */
public class Epidos3Template extends RaidBossNPCTemplate {
	public static final int ID = 25611;

	@Inject
	protected Epidos3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
