 ...
 */
public class WaterDragonSeerShesharkTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25199;

	@Inject
	protected WaterDragonSeerShesharkTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Water Dragon Seer Sheshark";
		...
		this.rightHand = itemProvider.createID(181);
		this.leftHand = null;
		this.enchantLevel = 0;
