 ...
 */
public class DeathLordIposTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25276;

	@Inject
	protected DeathLordIposTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Death Lord Ipos";
