 ...
 */
public class AwakenedAncientExecutor2Template extends RaidBossNPCTemplate {
	public static final int ID = 25650;

	@Inject
	protected AwakenedAncientExecutor2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
