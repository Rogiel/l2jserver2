 ...
 */
public class GiantWastelandBasiliskTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25352;

	@Inject
	protected GiantWastelandBasiliskTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
