 ...
 */
public class SoulOfFireNastronTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25306;

	@Inject
	protected SoulOfFireNastronTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Soul of Fire Nastron";
