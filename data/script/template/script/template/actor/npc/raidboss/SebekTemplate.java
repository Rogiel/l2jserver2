 ...
 */
public class SebekTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25211;

	@Inject
	protected SebekTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
