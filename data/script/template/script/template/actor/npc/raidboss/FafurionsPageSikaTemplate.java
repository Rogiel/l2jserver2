 ...
 */
public class FafurionsPageSikaTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25214;

	@Inject
	protected FafurionsPageSikaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fafurion's Page Sika";
		...
		this.rightHand = itemProvider.createID(5132);
		this.leftHand = null;
		this.enchantLevel = 0;
