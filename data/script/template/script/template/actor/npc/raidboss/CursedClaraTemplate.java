 ...
 */
public class CursedClaraTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25217;

	@Inject
	protected CursedClaraTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cursed Clara";
