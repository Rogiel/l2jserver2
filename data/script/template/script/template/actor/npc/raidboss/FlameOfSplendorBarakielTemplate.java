 ...
 */
public class FlameOfSplendorBarakielTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25325;

	@Inject
	protected FlameOfSplendorBarakielTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Flame of Splendor Barakiel";
