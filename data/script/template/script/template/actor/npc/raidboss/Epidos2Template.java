 ...
 */
public class Epidos2Template extends RaidBossNPCTemplate {
	public static final int ID = 25610;

	@Inject
	protected Epidos2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
