 ...
 */
public class KatuVanLeaderAtuiTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25026;

	@Inject
	protected KatuVanLeaderAtuiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Katu Van Leader Atui";
