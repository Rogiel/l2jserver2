 ...
 */
public class AwakenedAncientSoulExtractorTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25645;

	@Inject
	protected AwakenedAncientSoulExtractorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Awakened Ancient Soul Extractor";
		this.serverSideName = false;
		this.title = "Raid Boss";
		this.serverSideTitle = false;
		this.collisionRadius = 27.60;
