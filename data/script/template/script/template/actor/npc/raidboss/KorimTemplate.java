 ...
 */
public class KorimTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25092;

	@Inject
	protected KorimTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
