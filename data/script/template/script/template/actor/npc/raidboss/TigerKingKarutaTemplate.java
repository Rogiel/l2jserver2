 ...
 */
public class TigerKingKarutaTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25173;

	@Inject
	protected TigerKingKarutaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Tiger King Karuta";
