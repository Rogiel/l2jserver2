 ...
 */
public class SejarrsServitorTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25098;

	@Inject
	protected SejarrsServitorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sejarr's Servitor";
