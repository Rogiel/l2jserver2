 ...
 */
public class ZakensButcherKrantzTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25259;

	@Inject
	protected ZakensButcherKrantzTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Zaken's Butcher Krantz";
