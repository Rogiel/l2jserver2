 ...
 */
public class HekatonPrime2Template extends RaidBossNPCTemplate {
	public static final int ID = 25687;

	@Inject
	protected HekatonPrime2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		...
		attributes.physicalAttack = 2752.51481;
		attributes.magicalAttack = 4038.11496;
