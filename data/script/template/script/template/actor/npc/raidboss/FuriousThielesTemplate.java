 ...
 */
public class FuriousThielesTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25010;

	@Inject
	protected FuriousThielesTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Furious Thieles";
