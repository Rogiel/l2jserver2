 ...
 */
public class Aenkinel3Template extends RaidBossNPCTemplate {
	public static final int ID = 25692;

	@Inject
	protected Aenkinel3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
