 ...
 */
public class VukuGrandSeerGharmashTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25128;

	@Inject
	protected VukuGrandSeerGharmashTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Vuku Grand Seer Gharmash";
		...
		this.rightHand = itemProvider.createID(195);
		this.leftHand = null;
		this.enchantLevel = 0;
