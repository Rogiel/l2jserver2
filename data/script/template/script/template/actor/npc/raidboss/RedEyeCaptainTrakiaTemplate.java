 ...
 */
public class RedEyeCaptainTrakiaTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25388;

	@Inject
	protected RedEyeCaptainTrakiaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Red Eye Captain Trakia";
