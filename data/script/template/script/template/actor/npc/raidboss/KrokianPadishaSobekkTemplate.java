 ...
 */
public class KrokianPadishaSobekkTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25202;

	@Inject
	protected KrokianPadishaSobekkTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Krokian Padisha Sobekk";
		this.serverSideName = false;
		this.title = "Raid Boss";
		this.serverSideTitle = false;
		this.collisionRadius = 52.00;
		this.collisionHeight = 86.00;
		this.level = 74;
