 ...
 */
public class Aenkinel2Template extends RaidBossNPCTemplate {
	public static final int ID = 25691;

	@Inject
	protected Aenkinel2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
