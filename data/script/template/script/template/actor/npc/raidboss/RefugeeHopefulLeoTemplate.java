 ...
 */
public class RefugeeHopefulLeoTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25122;

	@Inject
	protected RefugeeHopefulLeoTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Refugee Hopeful Leo";
