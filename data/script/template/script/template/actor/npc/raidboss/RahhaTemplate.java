 ...
 */
public class RahhaTemplate extends RaidBossNPCTemplate {
	public static final int ID = 25051;

	@Inject
	protected RahhaTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
