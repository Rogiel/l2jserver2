 ...
 */
public class CursedGirl2Template extends NPCTemplate {
	public static final int ID = 18585;

	@Inject
	protected CursedGirl2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Cursed Girl";
