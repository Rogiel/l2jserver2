 ...
 */
public class Trap38Template extends NPCTemplate {
	public static final int ID = 13202;

	@Inject
	protected Trap38Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
