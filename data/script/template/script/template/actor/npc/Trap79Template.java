 ...
 */
public class Trap79Template extends NPCTemplate {
	public static final int ID = 13243;

	@Inject
	protected Trap79Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
