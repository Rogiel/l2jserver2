 ...
 */
public class Native3Template extends NPCTemplate {
	public static final int ID = 13199;

	@Inject
	protected Native3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
