 ...
 */
public class Doorman6Template extends NPCTemplate {
	public static final int ID = 35602;

	@Inject
	protected Doorman6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
