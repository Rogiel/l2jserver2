 ...
 */
public class VarkeesTemplate extends NPCTemplate {
	public static final int ID = 30566;

	@Inject
	protected VarkeesTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Varkees";
		this.serverSideName = false;
		this.title = "Atuba Chief";
