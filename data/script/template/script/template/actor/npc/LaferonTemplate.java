 ...
 */
public class LaferonTemplate extends NPCTemplate {
	public static final int ID = 30528;

	@Inject
	protected LaferonTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
