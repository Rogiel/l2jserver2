 ...
 */
public class MercenaryPrivate18Template extends NPCTemplate {
	public static final int ID = 36284;

	@Inject
	protected MercenaryPrivate18Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
