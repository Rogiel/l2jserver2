 ...
 */
public class UluKaimuTemplate extends NPCTemplate {
	public static final int ID = 32119;

	@Inject
	protected UluKaimuTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
