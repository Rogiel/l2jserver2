 ...
 */
public class DummyLadyFTemplate extends NPCTemplate {
	public static final int ID = 31395;

	@Inject
	protected DummyLadyFTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Dummy - Lady F";
