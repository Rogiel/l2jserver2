 ...
 */
public class MysteriousWizardTemplate extends NPCTemplate {
	public static final int ID = 31522;

	@Inject
	protected MysteriousWizardTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Mysterious Wizard";
