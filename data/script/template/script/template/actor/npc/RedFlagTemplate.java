 ...
 */
public class RedFlagTemplate extends NPCTemplate {
	public static final int ID = 35423;

	@Inject
	protected RedFlagTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
