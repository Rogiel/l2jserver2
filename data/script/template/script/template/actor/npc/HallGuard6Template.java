 ...
 */
public class HallGuard6Template extends NPCTemplate {
	public static final int ID = 18476;

	@Inject
	protected HallGuard6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
