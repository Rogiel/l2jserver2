 ...
 */
public class IceSculpture4Template extends NPCTemplate {
	public static final int ID = 32079;

	@Inject
	protected IceSculpture4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
