 ...
 */
public class Cougar2Template extends NPCTemplate {
	public static final int ID = 18902;

	@Inject
	protected Cougar2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
