 ...
 */
public class SirAronTanfordTemplate extends NPCTemplate {
	public static final int ID = 30653;

	@Inject
	protected SirAronTanfordTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sir Aron Tanford";
