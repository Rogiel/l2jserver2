 ...
 */
public class NewbieGuide6Template extends NPCTemplate {
	public static final int ID = 31076;

	@Inject
	protected NewbieGuide6Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
