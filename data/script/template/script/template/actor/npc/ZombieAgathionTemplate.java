 ...
 */
public class ZombieAgathionTemplate extends NPCTemplate {
	public static final int ID = 1535;

	@Inject
	protected ZombieAgathionTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Zombie Agathion";
