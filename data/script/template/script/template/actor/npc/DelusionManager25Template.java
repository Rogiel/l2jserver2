 ...
 */
public class DelusionManager25Template extends NPCTemplate {
	public static final int ID = 32688;

	@Inject
	protected DelusionManager25Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
