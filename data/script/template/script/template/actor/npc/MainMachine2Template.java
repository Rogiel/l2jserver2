 ...
 */
public class MainMachine2Template extends NPCTemplate {
	public static final int ID = 35776;

	@Inject
	protected MainMachine2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
