 ...
 */
public class SakeDunZuHestuiTemplate extends NPCTemplate {
	public static final int ID = 31607;

	@Inject
	protected SakeDunZuHestuiTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Sake Dun Zu Hestui";
