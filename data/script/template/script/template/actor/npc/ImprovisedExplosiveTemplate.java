 ...
 */
public class ImprovisedExplosiveTemplate extends NPCTemplate {
	public static final int ID = 36392;

	@Inject
	protected ImprovisedExplosiveTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
