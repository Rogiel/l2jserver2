 ...
 */
public class PerwanTemplate extends NPCTemplate {
	public static final int ID = 32133;

	@Inject
	protected PerwanTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
