 ...
 */
public class Dorian3Template extends NPCTemplate {
	public static final int ID = 32373;

	@Inject
	protected Dorian3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
