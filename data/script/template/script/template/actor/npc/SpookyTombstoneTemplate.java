 ...
 */
public class SpookyTombstoneTemplate extends NPCTemplate {
	public static final int ID = 32344;

	@Inject
	protected SpookyTombstoneTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Spooky Tombstone";
