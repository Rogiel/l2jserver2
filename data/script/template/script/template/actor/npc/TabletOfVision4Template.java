 ...
 */
public class TabletOfVision4Template extends NPCTemplate {
	public static final int ID = 31649;

	@Inject
	protected TabletOfVision4Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
