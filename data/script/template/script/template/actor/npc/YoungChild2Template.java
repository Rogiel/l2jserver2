 ...
 */
public class YoungChild2Template extends NPCTemplate {
	public static final int ID = 13200;

	@Inject
	protected YoungChild2Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Young Child";
