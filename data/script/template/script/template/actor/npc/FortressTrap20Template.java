 ...
 */
public class FortressTrap20Template extends NPCTemplate {
	public static final int ID = 36431;

	@Inject
	protected FortressTrap20Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Fortress Trap";
		this.serverSideName = false;
		this.title = "";
		this.serverSideTitle = false;
		this.collisionRadius = 1.00;
