 ...
 */
public class Trap156Template extends NPCTemplate {
	public static final int ID = 18733;

	@Inject
	protected Trap156Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
