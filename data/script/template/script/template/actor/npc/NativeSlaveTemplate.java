 ...
 */
public class NativeSlaveTemplate extends NPCTemplate {
	public static final int ID = 32357;

	@Inject
	protected NativeSlaveTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Native Slave";
