 ...
 */
public class IngeniousContraption8Template extends NPCTemplate {
	public static final int ID = 18501;

	@Inject
	protected IngeniousContraption8Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
