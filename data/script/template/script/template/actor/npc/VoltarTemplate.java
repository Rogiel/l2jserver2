 ...
 */
public class VoltarTemplate extends NPCTemplate {
	public static final int ID = 30615;

	@Inject
	protected VoltarTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
		super(provider.createID(ID));
		this.name = "Voltar";
		this.serverSideName = false;
		this.title = "Breka Chief";
