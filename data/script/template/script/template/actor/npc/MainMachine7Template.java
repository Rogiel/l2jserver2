 ...
 */
public class MainMachine7Template extends NPCTemplate {
	public static final int ID = 36090;

	@Inject
	protected MainMachine7Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
