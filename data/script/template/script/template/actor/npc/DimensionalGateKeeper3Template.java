 ...
 */
public class DimensionalGateKeeper3Template extends NPCTemplate {
	public static final int ID = 31496;

	@Inject
	protected DimensionalGateKeeper3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
