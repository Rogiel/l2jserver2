 ...
 */
public class Harkilgamed3Template extends NPCTemplate {
	public static final int ID = 32254;

	@Inject
	protected Harkilgamed3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
