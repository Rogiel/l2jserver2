 ...
 */
public class KashTemplate extends NPCTemplate {
	public static final int ID = 30644;

	@Inject
	protected KashTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
