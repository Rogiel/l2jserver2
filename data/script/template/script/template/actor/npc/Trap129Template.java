 ...
 */
public class Trap129Template extends NPCTemplate {
	public static final int ID = 18420;

	@Inject
	protected Trap129Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
