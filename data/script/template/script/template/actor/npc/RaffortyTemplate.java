 ...
 */
public class RaffortyTemplate extends NPCTemplate {
	public static final int ID = 32020;

	@Inject
	protected RaffortyTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
