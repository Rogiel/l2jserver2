 ...
 */
public class SeducedWarriorTemplate extends NPCTemplate {
	public static final int ID = 36565;

	@Inject
	protected SeducedWarriorTemplate(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
