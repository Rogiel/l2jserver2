 ...
 */
public class GraveRobberWarrior3Template extends NPCTemplate {
	public static final int ID = 32651;

	@Inject
	protected GraveRobberWarrior3Template(NPCTemplateIDProvider provider, ItemTemplateIDProvider itemProvider) {
